...
class UScriptStruct* FElementID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ElementID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FElementID, Z_Construct_UPackage__Script_MeshDescription(), TEXT("ElementID"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FElementID_Statics::NewProp_IDValue = { "IDValue", nullptr, (EPropertyFlags)0x0020080000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FElementID, IDValue), METADATA_PARAMS(Z_Construct_UScriptStruct_FElementID_Statics::NewProp_IDValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FElementID_Statics::NewProp_IDValue_MetaData)) };
...
class UScriptStruct* FVertexID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_VertexID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVertexID, Z_Construct_UPackage__Script_MeshDescription(), TEXT("VertexID"));
	}
...
class UScriptStruct* FVertexInstanceID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_VertexInstanceID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVertexInstanceID, Z_Construct_UPackage__Script_MeshDescription(), TEXT("VertexInstanceID"));
	}
...
class UScriptStruct* FEdgeID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EdgeID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEdgeID, Z_Construct_UPackage__Script_MeshDescription(), TEXT("EdgeID"));
	}
...
class UScriptStruct* FUVID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_UVID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUVID, Z_Construct_UPackage__Script_MeshDescription(), TEXT("UVID"));
	}
...
class UScriptStruct* FTriangleID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TriangleID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTriangleID, Z_Construct_UPackage__Script_MeshDescription(), TEXT("TriangleID"));
	}
...
class UScriptStruct* FPolygonGroupID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PolygonGroupID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPolygonGroupID, Z_Construct_UPackage__Script_MeshDescription(), TEXT("PolygonGroupID"));
	}
...
class UScriptStruct* FPolygonID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PolygonID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPolygonID, Z_Construct_UPackage__Script_MeshDescription(), TEXT("PolygonID"));
	}
...
template<> MESHDESCRIPTION_API UScriptStruct* StaticStruct<FPolygonID>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MeshDescription_Public_MeshTypes_h_Statics::ScriptStructInfo[] = {
		{ FElementID::StaticStruct, Z_Construct_UScriptStruct_FElementID_Statics::NewStructOps, TEXT("ElementID"), &Z_Registration_Info_UScriptStruct_ElementID, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FElementID), 1166436638U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MeshDescription_Public_MeshTypes_h_1611973222(TEXT("/Script/MeshDescription"),
		nullptr, 0,
