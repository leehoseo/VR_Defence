...
#include "MeshDescription/Public/MeshDescriptionBaseBulkData.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMeshDescriptionBaseBulkData_Statics::NewProp_PreallocatedMeshDescription = { "PreallocatedMeshDescription", nullptr, (EPropertyFlags)0x0026080800082008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMeshDescriptionBaseBulkData, PreallocatedMeshDescription), Z_Construct_UClass_UMeshDescriptionBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMeshDescriptionBaseBulkData_Statics::NewProp_PreallocatedMeshDescription_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMeshDescriptionBaseBulkData_Statics::NewProp_PreallocatedMeshDescription_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMeshDescriptionBaseBulkData_Statics::NewProp_MeshDescription = { "MeshDescription", nullptr, (EPropertyFlags)0x0024080800002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMeshDescriptionBaseBulkData, MeshDescription), Z_Construct_UClass_UMeshDescriptionBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMeshDescriptionBaseBulkData_Statics::NewProp_MeshDescription_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMeshDescriptionBaseBulkData_Statics::NewProp_MeshDescription_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MeshDescription_Public_MeshDescriptionBaseBulkData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMeshDescriptionBaseBulkData, UMeshDescriptionBaseBulkData::StaticClass, TEXT("UMeshDescriptionBaseBulkData"), &Z_Registration_Info_UClass_UMeshDescriptionBaseBulkData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMeshDescriptionBaseBulkData), 3213969461U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MeshDescription_Public_MeshDescriptionBaseBulkData_h_2336849623(TEXT("/Script/MeshDescription"),
