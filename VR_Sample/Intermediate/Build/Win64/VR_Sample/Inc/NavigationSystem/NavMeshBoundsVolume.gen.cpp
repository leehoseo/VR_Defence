...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ANavMeshBoundsVolume_Statics::NewProp_SupportedAgents = { "SupportedAgents", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANavMeshBoundsVolume, SupportedAgents), Z_Construct_UScriptStruct_FNavAgentSelector, METADATA_PARAMS(Z_Construct_UClass_ANavMeshBoundsVolume_Statics::NewProp_SupportedAgents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANavMeshBoundsVolume_Statics::NewProp_SupportedAgents_MetaData)) }; // 2734138122
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavMesh_NavMeshBoundsVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANavMeshBoundsVolume, ANavMeshBoundsVolume::StaticClass, TEXT("ANavMeshBoundsVolume"), &Z_Registration_Info_UClass_ANavMeshBoundsVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANavMeshBoundsVolume), 279497450U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavMesh_NavMeshBoundsVolume_h_1839928411(TEXT("/Script/NavigationSystem"),
