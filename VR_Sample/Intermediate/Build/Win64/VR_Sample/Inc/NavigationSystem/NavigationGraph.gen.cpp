...
class UScriptStruct* FNavGraphEdge::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NavGraphEdge.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNavGraphEdge, Z_Construct_UPackage__Script_NavigationSystem(), TEXT("NavGraphEdge"));
	}
...
class UScriptStruct* FNavGraphNode::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NavGraphNode.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNavGraphNode, Z_Construct_UPackage__Script_NavigationSystem(), TEXT("NavGraphNode"));
	}
...
template<> NAVIGATIONSYSTEM_API UScriptStruct* StaticStruct<FNavGraphNode>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNavGraphNode_Statics::NewProp_Owner = { "Owner", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNavGraphNode, Owner), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FNavGraphNode_Statics::NewProp_Owner_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNavGraphNode_Statics::NewProp_Owner_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavGraph_NavigationGraph_h_Statics::ScriptStructInfo[] = {
		...
		{ FNavGraphNode::StaticStruct, Z_Construct_UScriptStruct_FNavGraphNode_Statics::NewStructOps, TEXT("NavGraphNode"), &Z_Registration_Info_UScriptStruct_NavGraphNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNavGraphNode), 3687968836U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavGraph_NavigationGraph_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANavigationGraph, ANavigationGraph::StaticClass, TEXT("ANavigationGraph"), &Z_Registration_Info_UClass_ANavigationGraph, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANavigationGraph), 1405241493U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_NavigationSystem_Public_NavGraph_NavigationGraph_h_1290735770(TEXT("/Script/NavigationSystem"),
