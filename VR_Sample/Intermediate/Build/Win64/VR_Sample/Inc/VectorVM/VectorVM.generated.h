...
#define FOREACH_ENUM_EVECTORVMOP(op) \
	...
	op(EVectorVMOp::i2b) \
	op(EVectorVMOp::b2i) \
	op(EVectorVMOp::inputdata_float) \
	op(EVectorVMOp::inputdata_int32) \
	op(EVectorVMOp::inputdata_half) \
	op(EVectorVMOp::inputdata_noadvance_float) \
	op(EVectorVMOp::inputdata_noadvance_int32) \
	op(EVectorVMOp::inputdata_noadvance_half) \
	op(EVectorVMOp::outputdata_float) \
	op(EVectorVMOp::outputdata_int32) \
