...
class UScriptStruct* FMyPluginStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MyPluginStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMyPluginStruct, Z_Construct_UPackage__Script_UObjectPlugin(), TEXT("MyPluginStruct"));
	}
...
template<> UOBJECTPLUGIN_API UScriptStruct* StaticStruct<FMyPluginStruct>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMyPluginStruct_Statics::NewProp_TestString = { "TestString", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMyPluginStruct, TestString), METADATA_PARAMS(Z_Construct_UScriptStruct_FMyPluginStruct_Statics::NewProp_TestString_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMyPluginStruct_Statics::NewProp_TestString_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_UObjectPlugin_Source_UObjectPlugin_Classes_MyPluginObject_h_Statics::ScriptStructInfo[] = {
		{ FMyPluginStruct::StaticStruct, Z_Construct_UScriptStruct_FMyPluginStruct_Statics::NewStructOps, TEXT("MyPluginStruct"), &Z_Registration_Info_UScriptStruct_MyPluginStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMyPluginStruct), 4225442073U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_UObjectPlugin_Source_UObjectPlugin_Classes_MyPluginObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMyPluginObject, UMyPluginObject::StaticClass, TEXT("UMyPluginObject"), &Z_Registration_Info_UClass_UMyPluginObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMyPluginObject), 2123867032U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Developer_UObjectPlugin_Source_UObjectPlugin_Classes_MyPluginObject_h_1035552149(TEXT("/Script/UObjectPlugin"),
