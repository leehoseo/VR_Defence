...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::NewProp_Codec = { "Codec", nullptr, (EPropertyFlags)0x0014000000020001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCacheTrackStreamable, Codec), Z_Construct_UClass_UGeometryCacheCodecBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::NewProp_Codec_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::NewProp_Codec_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::NewProp_StartSampleTime = { "StartSampleTime", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCacheTrackStreamable, StartSampleTime), METADATA_PARAMS(Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::NewProp_StartSampleTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrackStreamable_Statics::NewProp_StartSampleTime_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheTrackStreamable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCacheTrackStreamable, UGeometryCacheTrackStreamable::StaticClass, TEXT("UGeometryCacheTrackStreamable"), &Z_Registration_Info_UClass_UGeometryCacheTrackStreamable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCacheTrackStreamable), 246514903U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheTrackStreamable_h_3777540899(TEXT("/Script/GeometryCache"),
