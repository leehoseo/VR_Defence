...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UGeometryCacheTrack_Statics::NewProp_Duration = { "Duration", nullptr, (EPropertyFlags)0x0020080000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCacheTrack, Duration), METADATA_PARAMS(Z_Construct_UClass_UGeometryCacheTrack_Statics::NewProp_Duration_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheTrack_Statics::NewProp_Duration_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCacheTrack, UGeometryCacheTrack::StaticClass, TEXT("UGeometryCacheTrack"), &Z_Registration_Info_UClass_UGeometryCacheTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCacheTrack), 890433796U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheTrack_h_4278287808(TEXT("/Script/GeometryCache"),
