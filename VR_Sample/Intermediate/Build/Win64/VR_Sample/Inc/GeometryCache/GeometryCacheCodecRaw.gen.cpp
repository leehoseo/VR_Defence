...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UGeometryCacheCodecRaw_Statics::NewProp_DummyProperty = { "DummyProperty", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCacheCodecRaw, DummyProperty), METADATA_PARAMS(Z_Construct_UClass_UGeometryCacheCodecRaw_Statics::NewProp_DummyProperty_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCacheCodecRaw_Statics::NewProp_DummyProperty_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheCodecRaw_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCacheCodecRaw, UGeometryCacheCodecRaw::StaticClass, TEXT("UGeometryCacheCodecRaw"), &Z_Registration_Info_UClass_UGeometryCacheCodecRaw, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCacheCodecRaw), 1414920830U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheCodecRaw_h_3928611909(TEXT("/Script/GeometryCache"),
