...
class UScriptStruct* FGeometryCacheMeshBatchInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GeometryCacheMeshBatchInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGeometryCacheMeshBatchInfo, Z_Construct_UPackage__Script_GeometryCache(), TEXT("GeometryCacheMeshBatchInfo"));
	}
...
class UScriptStruct* FGeometryCacheVertexInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GeometryCacheVertexInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGeometryCacheVertexInfo, Z_Construct_UPackage__Script_GeometryCache(), TEXT("GeometryCacheVertexInfo"));
	}
...
class UScriptStruct* FGeometryCacheMeshData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GeometryCacheMeshData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGeometryCacheMeshData, Z_Construct_UPackage__Script_GeometryCache(), TEXT("GeometryCacheMeshData"));
	}
