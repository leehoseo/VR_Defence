...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UGeometryCacheCodecBase_Statics::NewProp_TopologyRanges_Inner = { "TopologyRanges", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheCodecBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCacheCodecBase, UGeometryCacheCodecBase::StaticClass, TEXT("UGeometryCacheCodecBase"), &Z_Registration_Info_UClass_UGeometryCacheCodecBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCacheCodecBase), 3848325687U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_GeometryCacheCodecBase_h_3468035286(TEXT("/Script/GeometryCache"),
