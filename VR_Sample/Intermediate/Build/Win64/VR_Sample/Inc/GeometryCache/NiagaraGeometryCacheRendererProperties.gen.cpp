...
class UScriptStruct* FNiagaraGeometryCacheReference::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraGeometryCacheReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraGeometryCacheReference, Z_Construct_UPackage__Script_GeometryCache(), TEXT("NiagaraGeometryCacheReference"));
	}
...
template<> GEOMETRYCACHE_API UScriptStruct* StaticStruct<FNiagaraGeometryCacheReference>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraGeometryCacheRendererProperties_Statics::NewProp_GeometryCaches_Inner = { "GeometryCaches", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNiagaraGeometryCacheReference, METADATA_PARAMS(nullptr, 0) }; // 1918781908
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNiagaraGeometryCacheRendererProperties_Statics::NewProp_bIsLooping = { "bIsLooping", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UNiagaraGeometryCacheRendererProperties), &Z_Construct_UClass_UNiagaraGeometryCacheRendererProperties_Statics::NewProp_bIsLooping_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNiagaraGeometryCacheRendererProperties_Statics::NewProp_bIsLooping_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraGeometryCacheRendererProperties_Statics::NewProp_bIsLooping_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNiagaraGeometryCacheRendererProperties_Statics::NewProp_bAssignComponentsOnParticleID = { "bAssignComponentsOnParticleID", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UNiagaraGeometryCacheRendererProperties), &Z_Construct_UClass_UNiagaraGeometryCacheRendererProperties_Statics::NewProp_bAssignComponentsOnParticleID_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNiagaraGeometryCacheRendererProperties_Statics::NewProp_bAssignComponentsOnParticleID_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraGeometryCacheRendererProperties_Statics::NewProp_bAssignComponentsOnParticleID_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_NiagaraGeometryCacheRendererProperties_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraGeometryCacheRendererProperties, UNiagaraGeometryCacheRendererProperties::StaticClass, TEXT("UNiagaraGeometryCacheRendererProperties"), &Z_Registration_Info_UClass_UNiagaraGeometryCacheRendererProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraGeometryCacheRendererProperties), 2492123557U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCache_Classes_NiagaraGeometryCacheRendererProperties_h_1171513967(TEXT("/Script/GeometryCache"),
