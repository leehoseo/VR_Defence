...
// End Cross Module References
	...
	{
		P_GET_OBJECT(UMovieSceneSequence,Z_Param_MasterSequence);
		P_GET_STRUCT(FMovieSceneObjectBindingID,Z_Param_InObjectBindingID);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FSequencerBindingProxy*)Z_Param__Result=UMovieSceneSequenceExtensions::ResolveBindingID(Z_Param_MasterSequence,Z_Param_InObjectBindingID);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMovieSceneSequenceExtensions::execGetPortableBindingID)
	{
		...
		P_GET_STRUCT_REF(FSequencerBindingProxy,Z_Param_Out_InBinding);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FMovieSceneObjectBindingID*)Z_Param__Result=UMovieSceneSequenceExtensions::GetPortableBindingID(Z_Param_MasterSequence,Z_Param_DestinationSequence,Z_Param_Out_InBinding);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(UMovieSceneSequenceExtensions::execMakeBindingID)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FMovieSceneObjectBindingID*)Z_Param__Result=UMovieSceneSequenceExtensions::MakeBindingID(Z_Param_MasterSequence,Z_Param_Out_InBinding,EMovieSceneObjectBindingSpace(Z_Param_Space));
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(UMovieSceneSequenceExtensions::execAddSpawnableFromClass)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FSequencerBindingProxy*)Z_Param__Result=UMovieSceneSequenceExtensions::AddSpawnableFromClass(Z_Param_Sequence,Z_Param_ClassToSpawn);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMovieSceneSequenceExtensions::execAddSpawnableFromInstance)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FSequencerBindingProxy*)Z_Param__Result=UMovieSceneSequenceExtensions::AddSpawnableFromInstance(Z_Param_Sequence,Z_Param_ObjectToSpawn);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMovieSceneSequenceExtensions::execAddPossessable)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FSequencerBindingProxy*)Z_Param__Result=UMovieSceneSequenceExtensions::AddPossessable(Z_Param_Sequence,Z_Param_ObjectToPossess);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMovieSceneSequenceExtensions::execGetPossessables)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<FSequencerBindingProxy>*)Z_Param__Result=UMovieSceneSequenceExtensions::GetPossessables(Z_Param_Sequence);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMovieSceneSequenceExtensions::execGetSpawnables)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<FSequencerBindingProxy>*)Z_Param__Result=UMovieSceneSequenceExtensions::GetSpawnables(Z_Param_Sequence);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMovieSceneSequenceExtensions::execGetBindings)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<FSequencerBindingProxy>*)Z_Param__Result=UMovieSceneSequenceExtensions::GetBindings(Z_Param_Sequence);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMovieSceneSequenceExtensions::execFindBindingById)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FSequencerBindingProxy*)Z_Param__Result=UMovieSceneSequenceExtensions::FindBindingById(Z_Param_Sequence,Z_Param_BindingId);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMovieSceneSequenceExtensions::execFindBindingByName)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FSequencerBindingProxy*)Z_Param__Result=UMovieSceneSequenceExtensions::FindBindingByName(Z_Param_Sequence,Z_Param_Name);
		P_NATIVE_END;
	}
	...
	{
		P_GET_OBJECT(UMovieSceneSequence,Z_Param_Sequence);
		P_GET_OBJECT(UMovieSceneTrack,Z_Param_MasterTrack);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=UMovieSceneSequenceExtensions::RemoveMasterTrack(Z_Param_Sequence,Z_Param_MasterTrack);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddMarkedFrame_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddMarkedFrame_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddMasterTrack_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddMasterTrack_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddMasterTrack_Statics::NewProp_TrackType = { "TrackType", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddMasterTrack_Parms, TrackType), Z_Construct_UClass_UMovieSceneTrack_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddMasterTrack_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddMasterTrack_Parms, ReturnValue), Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddMasterTrack_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddMasterTrack_Statics::NewProp_ReturnValue_MetaData)) };
	...
	struct Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddPossessable_Statics
	{
		struct MovieSceneSequenceExtensions_eventAddPossessable_Parms
		{
			...
			FSequencerBindingProxy ReturnValue;
		};
		static const UECodeGen_Private::FObjectPropertyParams NewProp_Sequence;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddPossessable_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddPossessable_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddPossessable_Statics::NewProp_ObjectToPossess = { "ObjectToPossess", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddPossessable_Parms, ObjectToPossess), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddPossessable_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddPossessable_Parms, ReturnValue), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddRootFolderToSequence_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddRootFolderToSequence_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddRootFolderToSequence_Statics::NewProp_NewFolderName = { "NewFolderName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddRootFolderToSequence_Parms, NewFolderName), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddRootFolderToSequence_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddRootFolderToSequence_Parms, ReturnValue), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddRootFolderToSequence_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddRootFolderToSequence_Statics::NewProp_ReturnValue_MetaData)) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddSpawnableFromClass_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddSpawnableFromClass_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddSpawnableFromClass_Statics::NewProp_ClassToSpawn = { "ClassToSpawn", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddSpawnableFromClass_Parms, ClassToSpawn), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddSpawnableFromClass_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddSpawnableFromClass_Parms, ReturnValue), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddSpawnableFromInstance_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddSpawnableFromInstance_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddSpawnableFromInstance_Statics::NewProp_ObjectToSpawn = { "ObjectToSpawn", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddSpawnableFromInstance_Parms, ObjectToSpawn), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddSpawnableFromInstance_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventAddSpawnableFromInstance_Parms, ReturnValue), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_DeleteMarkedFrame_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventDeleteMarkedFrame_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_DeleteMarkedFrame_Statics::NewProp_DeleteIndex = { "DeleteIndex", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventDeleteMarkedFrame_Parms, DeleteIndex), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_DeleteMarkedFrames_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventDeleteMarkedFrames_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindBindingById_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindBindingById_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindBindingById_Statics::NewProp_BindingId = { "BindingId", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindBindingById_Parms, BindingId), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindBindingById_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindBindingById_Parms, ReturnValue), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindBindingByName_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindBindingByName_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindBindingByName_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindBindingByName_Parms, Name), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindBindingByName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindBindingByName_Parms, ReturnValue), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMarkedFrameByFrameNumber_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindMarkedFrameByFrameNumber_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMarkedFrameByFrameNumber_Statics::NewProp_InFrameNumber = { "InFrameNumber", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindMarkedFrameByFrameNumber_Parms, InFrameNumber), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMarkedFrameByFrameNumber_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindMarkedFrameByFrameNumber_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMarkedFrameByLabel_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindMarkedFrameByLabel_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMasterTracksByExactType_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindMasterTracksByExactType_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMasterTracksByExactType_Statics::NewProp_TrackType = { "TrackType", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindMasterTracksByExactType_Parms, TrackType), Z_Construct_UClass_UMovieSceneTrack_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMasterTracksByExactType_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMasterTracksByType_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindMasterTracksByType_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMasterTracksByType_Statics::NewProp_TrackType = { "TrackType", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindMasterTracksByType_Parms, TrackType), Z_Construct_UClass_UMovieSceneTrack_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMasterTracksByType_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindNextMarkedFrame_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindNextMarkedFrame_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindNextMarkedFrame_Statics::NewProp_InFrameNumber = { "InFrameNumber", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindNextMarkedFrame_Parms, InFrameNumber), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindNextMarkedFrame_Statics::NewProp_bForward = { "bForward", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneSequenceExtensions_eventFindNextMarkedFrame_Parms), &Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindNextMarkedFrame_Statics::NewProp_bForward_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindNextMarkedFrame_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventFindNextMarkedFrame_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetBindingID_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetBindingID_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetBindingID_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetBindingID_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetBindingID_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetBindingID_Parms, ReturnValue), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(nullptr, 0) }; // 3055205823
	...
	struct Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetBindings_Statics
	{
		...
		{
			UMovieSceneSequence* Sequence;
			TArray<FSequencerBindingProxy> ReturnValue;
		};
		static const UECodeGen_Private::FObjectPropertyParams NewProp_Sequence;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetBindings_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetBindings_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetBindings_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetBindings_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetBindings_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetClockSource_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetClockSource_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetClockSource_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetClockSource_Parms, ReturnValue), Z_Construct_UEnum_MovieScene_EUpdateClockSource, METADATA_PARAMS(nullptr, 0) }; // 3237436252
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetDisplayRate_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetDisplayRate_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetDisplayRate_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetDisplayRate_Parms, ReturnValue), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetEvaluationType_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetEvaluationType_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetEvaluationType_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetEvaluationType_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetEvaluationType_Parms, ReturnValue), Z_Construct_UEnum_MovieScene_EMovieSceneEvaluationType, METADATA_PARAMS(nullptr, 0) }; // 2615994803
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMarkedFrames_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetMarkedFrames_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMarkedFrames_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FMovieSceneMarkedFrame, METADATA_PARAMS(nullptr, 0) }; // 3844809400
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMarkedFrames_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetMarkedFrames_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 3844809400
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMasterTracks_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetMasterTracks_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMasterTracks_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMasterTracks_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010008000000588, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetMasterTracks_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMasterTracks_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMasterTracks_Statics::NewProp_ReturnValue_MetaData)) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMasterTracks_Statics::Function_MetaDataParams[] = {
		{ "Category", "Sequencer|Sequence" },
		{ "Comment", "/**\n\x09 * Get all master tracks\n\x09 *\n\x09 * @param Sequence        The sequence to use\n\x09 * @return An array containing all master tracks in this sequence\n\x09 */" },
		{ "ModuleRelativePath", "Public/ExtensionLibraries/MovieSceneSequenceExtensions.h" },
		{ "ScriptMethod", "" },
		{ "ToolTip", "Get all master tracks\n\n@param Sequence        The sequence to use\n@return An array containing all master tracks in this sequence" },
	};
#endif
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMovieScene_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetMovieScene_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackEnd_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPlaybackEnd_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackEnd_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPlaybackEnd_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackEndSeconds_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPlaybackEndSeconds_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackEndSeconds_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPlaybackEndSeconds_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackRange_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPlaybackRange_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackRange_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPlaybackRange_Parms, ReturnValue), Z_Construct_UScriptStruct_FSequencerScriptingRange, METADATA_PARAMS(nullptr, 0) }; // 1600813035
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackStart_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPlaybackStart_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackStart_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPlaybackStart_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackStartSeconds_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPlaybackStartSeconds_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackStartSeconds_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPlaybackStartSeconds_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	struct Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPortableBindingID_Statics
	{
		...
		static const UECodeGen_Private::FObjectPropertyParams NewProp_MasterSequence;
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPortableBindingID_Statics::NewProp_MasterSequence = { "MasterSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPortableBindingID_Parms, MasterSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPortableBindingID_Statics::NewProp_DestinationSequence = { "DestinationSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPortableBindingID_Parms, DestinationSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPortableBindingID_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPortableBindingID_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPortableBindingID_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPortableBindingID_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPortableBindingID_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPortableBindingID_Parms, ReturnValue), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(nullptr, 0) }; // 3055205823
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPortableBindingID_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPortableBindingID_Statics::NewProp_MasterSequence,
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPossessables_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPossessables_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPossessables_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPossessables_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetPossessables_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetRootFoldersInSequence_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetRootFoldersInSequence_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetRootFoldersInSequence_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetSpawnables_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetSpawnables_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetSpawnables_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetSpawnables_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetSpawnables_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetTickResolution_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetTickResolution_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetTickResolution_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetTickResolution_Parms, ReturnValue), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetTimecodeSource_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetTimecodeSource_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetTimecodeSource_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetTimecodeSource_Parms, ReturnValue), Z_Construct_UScriptStruct_FTimecode, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetViewRangeEnd_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetViewRangeEnd_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetViewRangeEnd_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetViewRangeEnd_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetViewRangeStart_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetViewRangeStart_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetViewRangeStart_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetViewRangeStart_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetWorkRangeEnd_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetWorkRangeEnd_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetWorkRangeEnd_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetWorkRangeEnd_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetWorkRangeStart_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetWorkRangeStart_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetWorkRangeStart_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventGetWorkRangeStart_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_IsReadOnly_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventIsReadOnly_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_IsReadOnly_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneSequenceExtensions_eventIsReadOnly_Parms), &Z_Construct_UFunction_UMovieSceneSequenceExtensions_IsReadOnly_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_LocateBoundObjects_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventLocateBoundObjects_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_LocateBoundObjects_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventLocateBoundObjects_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneSequenceExtensions_LocateBoundObjects_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneSequenceExtensions_LocateBoundObjects_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_LocateBoundObjects_Statics::NewProp_Context = { "Context", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventLocateBoundObjects_Parms, Context), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_LocateBoundObjects_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_LocateBoundObjects_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventLocateBoundObjects_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeBindingID_Statics::NewProp_MasterSequence = { "MasterSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeBindingID_Parms, MasterSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeBindingID_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeBindingID_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeBindingID_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeBindingID_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeBindingID_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeBindingID_Parms, Space), Z_Construct_UEnum_MovieScene_EMovieSceneObjectBindingSpace, METADATA_PARAMS(nullptr, 0) }; // 3772622621
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeBindingID_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeBindingID_Parms, ReturnValue), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(nullptr, 0) }; // 3055205823
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeBindingID_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeBindingID_Statics::NewProp_MasterSequence,
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeRange_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeRange_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeRange_Statics::NewProp_StartFrame = { "StartFrame", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeRange_Parms, StartFrame), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeRange_Statics::NewProp_Duration = { "Duration", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeRange_Parms, Duration), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeRange_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeRange_Parms, ReturnValue), Z_Construct_UScriptStruct_FSequencerScriptingRange, METADATA_PARAMS(nullptr, 0) }; // 1600813035
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeRangeSeconds_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeRangeSeconds_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeRangeSeconds_Statics::NewProp_StartTime = { "StartTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeRangeSeconds_Parms, StartTime), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeRangeSeconds_Statics::NewProp_Duration = { "Duration", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeRangeSeconds_Parms, Duration), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeRangeSeconds_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventMakeRangeSeconds_Parms, ReturnValue), Z_Construct_UScriptStruct_FSequencerScriptingRange, METADATA_PARAMS(nullptr, 0) }; // 1600813035
	...
	struct Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics
	{
		...
		static const UECodeGen_Private::FObjectPropertyParams NewProp_Sequence;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_MasterTrack_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_MasterTrack;
		static void NewProp_ReturnValue_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventRemoveMasterTrack_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics::NewProp_MasterTrack_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics::NewProp_MasterTrack = { "MasterTrack", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventRemoveMasterTrack_Parms, MasterTrack), Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics::NewProp_MasterTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics::NewProp_MasterTrack_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneSequenceExtensions_eventRemoveMasterTrack_Parms), &Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics::NewProp_MasterTrack,
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack_Statics::Function_MetaDataParams[] = {
		{ "Category", "Sequencer|Sequence" },
		{ "Comment", "/**\n\x09 * Removes a master track\n\x09 *\n\x09 * @param Sequence        The sequence to use\n\x09 * @param MasterTrack     The master track to remove\n\x09 * @return Whether the master track was successfully removed\n\x09 */" },
		{ "ModuleRelativePath", "Public/ExtensionLibraries/MovieSceneSequenceExtensions.h" },
		{ "ScriptMethod", "" },
		{ "ToolTip", "Removes a master track\n\n@param Sequence        The sequence to use\n@param MasterTrack     The master track to remove\n@return Whether the master track was successfully removed" },
	};
#endif
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_ResolveBindingID_Statics::NewProp_MasterSequence = { "MasterSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventResolveBindingID_Parms, MasterSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_ResolveBindingID_Statics::NewProp_InObjectBindingID = { "InObjectBindingID", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventResolveBindingID_Parms, InObjectBindingID), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(nullptr, 0) }; // 3055205823
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_ResolveBindingID_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventResolveBindingID_Parms, ReturnValue), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMovieSceneSequenceExtensions_ResolveBindingID_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMovieSceneSequenceExtensions_ResolveBindingID_Statics::NewProp_MasterSequence,
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetClockSource_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetClockSource_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetDisplayRate_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetDisplayRate_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetDisplayRate_Statics::NewProp_DisplayRate = { "DisplayRate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetDisplayRate_Parms, DisplayRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetEvaluationType_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetEvaluationType_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetEvaluationType_Statics::NewProp_InEvaluationType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetEvaluationType_Statics::NewProp_InEvaluationType = { "InEvaluationType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetEvaluationType_Parms, InEvaluationType), Z_Construct_UEnum_MovieScene_EMovieSceneEvaluationType, METADATA_PARAMS(nullptr, 0) }; // 2615994803
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetMarkedFrame_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetMarkedFrame_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetMarkedFrame_Statics::NewProp_InMarkIndex = { "InMarkIndex", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetMarkedFrame_Parms, InMarkIndex), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetMarkedFrame_Statics::NewProp_InFrameNumber = { "InFrameNumber", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetMarkedFrame_Parms, InFrameNumber), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackEnd_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetPlaybackEnd_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackEnd_Statics::NewProp_EndFrame = { "EndFrame", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetPlaybackEnd_Parms, EndFrame), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackEndSeconds_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetPlaybackEndSeconds_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackEndSeconds_Statics::NewProp_EndTime = { "EndTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetPlaybackEndSeconds_Parms, EndTime), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackStart_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetPlaybackStart_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackStart_Statics::NewProp_StartFrame = { "StartFrame", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetPlaybackStart_Parms, StartFrame), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackStartSeconds_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetPlaybackStartSeconds_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackStartSeconds_Statics::NewProp_StartTime = { "StartTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetPlaybackStartSeconds_Parms, StartTime), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetReadOnly_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetReadOnly_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetReadOnly_Statics::NewProp_bInReadOnly = { "bInReadOnly", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneSequenceExtensions_eventSetReadOnly_Parms), &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetReadOnly_Statics::NewProp_bInReadOnly_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetTickResolution_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetTickResolution_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetTickResolution_Statics::NewProp_TickResolution = { "TickResolution", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetTickResolution_Parms, TickResolution), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetTickResolutionDirectly_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetTickResolutionDirectly_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetTickResolutionDirectly_Statics::NewProp_TickResolution = { "TickResolution", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetTickResolutionDirectly_Parms, TickResolution), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetViewRangeEnd_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetViewRangeEnd_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetViewRangeEnd_Statics::NewProp_EndTimeInSeconds = { "EndTimeInSeconds", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetViewRangeEnd_Parms, EndTimeInSeconds), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetViewRangeStart_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetViewRangeStart_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetViewRangeStart_Statics::NewProp_StartTimeInSeconds = { "StartTimeInSeconds", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetViewRangeStart_Parms, StartTimeInSeconds), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetWorkRangeEnd_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetWorkRangeEnd_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetWorkRangeEnd_Statics::NewProp_EndTimeInSeconds = { "EndTimeInSeconds", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetWorkRangeEnd_Parms, EndTimeInSeconds), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetWorkRangeStart_Statics::NewProp_InSequence = { "InSequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetWorkRangeStart_Parms, InSequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetWorkRangeStart_Statics::NewProp_StartTimeInSeconds = { "StartTimeInSeconds", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSetWorkRangeStart_Parms, StartTimeInSeconds), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneSequenceExtensions_SortMarkedFrames_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequenceExtensions_eventSortMarkedFrames_Parms, Sequence), Z_Construct_UClass_UMovieSceneSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneSequenceExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddMarkedFrame, "AddMarkedFrame" }, // 1505461313
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddMasterTrack, "AddMasterTrack" }, // 3441406602
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddPossessable, "AddPossessable" }, // 3212690241
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddRootFolderToSequence, "AddRootFolderToSequence" }, // 2461188830
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddSpawnableFromClass, "AddSpawnableFromClass" }, // 3252272746
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_AddSpawnableFromInstance, "AddSpawnableFromInstance" }, // 2714423927
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_DeleteMarkedFrame, "DeleteMarkedFrame" }, // 2909709496
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_DeleteMarkedFrames, "DeleteMarkedFrames" }, // 102114749
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindBindingById, "FindBindingById" }, // 360205973
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindBindingByName, "FindBindingByName" }, // 2362366229
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMarkedFrameByFrameNumber, "FindMarkedFrameByFrameNumber" }, // 2992955176
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMarkedFrameByLabel, "FindMarkedFrameByLabel" }, // 241059552
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMasterTracksByExactType, "FindMasterTracksByExactType" }, // 1286949537
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindMasterTracksByType, "FindMasterTracksByType" }, // 3755313489
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_FindNextMarkedFrame, "FindNextMarkedFrame" }, // 173271226
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetBindingID, "GetBindingID" }, // 3671726616
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetBindings, "GetBindings" }, // 1597698449
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetClockSource, "GetClockSource" }, // 168429686
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetDisplayRate, "GetDisplayRate" }, // 3392737082
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetEvaluationType, "GetEvaluationType" }, // 1022425060
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMarkedFrames, "GetMarkedFrames" }, // 1131742827
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMasterTracks, "GetMasterTracks" }, // 4174271448
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetMovieScene, "GetMovieScene" }, // 4199184872
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackEnd, "GetPlaybackEnd" }, // 4038987480
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackEndSeconds, "GetPlaybackEndSeconds" }, // 910104024
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackRange, "GetPlaybackRange" }, // 4223405755
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackStart, "GetPlaybackStart" }, // 347761939
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPlaybackStartSeconds, "GetPlaybackStartSeconds" }, // 3407651690
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPortableBindingID, "GetPortableBindingID" }, // 2579181586
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetPossessables, "GetPossessables" }, // 3533883747
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetRootFoldersInSequence, "GetRootFoldersInSequence" }, // 3459567149
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetSpawnables, "GetSpawnables" }, // 878518145
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetTickResolution, "GetTickResolution" }, // 3846347229
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetTimecodeSource, "GetTimecodeSource" }, // 395174608
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetViewRangeEnd, "GetViewRangeEnd" }, // 279718194
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetViewRangeStart, "GetViewRangeStart" }, // 3815149636
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetWorkRangeEnd, "GetWorkRangeEnd" }, // 2082715335
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_GetWorkRangeStart, "GetWorkRangeStart" }, // 4127810972
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_IsReadOnly, "IsReadOnly" }, // 1458648991
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_LocateBoundObjects, "LocateBoundObjects" }, // 567611830
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeBindingID, "MakeBindingID" }, // 1820507631
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeRange, "MakeRange" }, // 3390480777
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_MakeRangeSeconds, "MakeRangeSeconds" }, // 1899690022
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_RemoveMasterTrack, "RemoveMasterTrack" }, // 1018469848
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_ResolveBindingID, "ResolveBindingID" }, // 2351166972
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetClockSource, "SetClockSource" }, // 2541268659
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetDisplayRate, "SetDisplayRate" }, // 3566435626
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetEvaluationType, "SetEvaluationType" }, // 2469616221
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetMarkedFrame, "SetMarkedFrame" }, // 2219136802
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackEnd, "SetPlaybackEnd" }, // 2544576311
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackEndSeconds, "SetPlaybackEndSeconds" }, // 3203329574
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackStart, "SetPlaybackStart" }, // 617603102
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetPlaybackStartSeconds, "SetPlaybackStartSeconds" }, // 1242132445
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetReadOnly, "SetReadOnly" }, // 4041968510
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetTickResolution, "SetTickResolution" }, // 3734953442
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetTickResolutionDirectly, "SetTickResolutionDirectly" }, // 1105913134
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetViewRangeEnd, "SetViewRangeEnd" }, // 832228202
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetViewRangeStart, "SetViewRangeStart" }, // 1915483560
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetWorkRangeEnd, "SetWorkRangeEnd" }, // 4194121316
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SetWorkRangeStart, "SetWorkRangeStart" }, // 2235810321
		{ &Z_Construct_UFunction_UMovieSceneSequenceExtensions_SortMarkedFrames, "SortMarkedFrames" }, // 923507210
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneSequenceExtensions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneSequenceExtensions, UMovieSceneSequenceExtensions::StaticClass, TEXT("UMovieSceneSequenceExtensions"), &Z_Registration_Info_UClass_UMovieSceneSequenceExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneSequenceExtensions), 3941419311U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneSequenceExtensions_h_3021621473(TEXT("/Script/SequencerScripting"),
