...
// End Cross Module References
	DEFINE_FUNCTION(UMovieSceneFolderExtensions::execRemoveChildObjectBinding)
	{
		...
		P_GET_STRUCT(FSequencerBindingProxy,Z_Param_InObjectBinding);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UMovieSceneFolderExtensions::execGetChildObjectBindings)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<FSequencerBindingProxy>*)Z_Param__Result=UMovieSceneFolderExtensions::GetChildObjectBindings(Z_Param_Folder);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMovieSceneFolderExtensions::execRemoveChildMasterTrack)
	{
		P_GET_OBJECT(UMovieSceneFolder,Z_Param_Folder);
		P_GET_OBJECT(UMovieSceneTrack,Z_Param_InMasterTrack);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=UMovieSceneFolderExtensions::RemoveChildMasterTrack(Z_Param_Folder,Z_Param_InMasterTrack);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMovieSceneFolderExtensions::execAddChildMasterTrack)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(bool*)Z_Param__Result=UMovieSceneFolderExtensions::AddChildMasterTrack(Z_Param_Folder,Z_Param_InMasterTrack);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildFolder_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneFolderExtensions_eventAddChildFolder_Parms), &Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildFolder_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_InMasterTrack_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_InMasterTrack;
		static void NewProp_ReturnValue_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_ReturnValue;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::NewProp_Folder = { "Folder", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventAddChildMasterTrack_Parms, Folder), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::NewProp_Folder_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::NewProp_Folder_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::NewProp_InMasterTrack_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::NewProp_InMasterTrack = { "InMasterTrack", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventAddChildMasterTrack_Parms, InMasterTrack), Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::NewProp_InMasterTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::NewProp_InMasterTrack_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneFolderExtensions_eventAddChildMasterTrack_Parms), &Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::NewProp_InMasterTrack,
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack_Statics::Function_MetaDataParams[] = {
		{ "Category", "Sequencer|Sequence" },
		{ "Comment", "/**\n\x09 * Add a master track to this folder\n\x09 *\n\x09 * @param Folder\x09\x09\x09The folder to add a child master track to\n\x09 * @param InMasterTrack\x09\x09The master track to add to the folder\n\x09 * @return True if the addition is successful\n\x09 */" },
		{ "ModuleRelativePath", "Public/ExtensionLibraries/MovieSceneFolderExtensions.h" },
		{ "ScriptMethod", "" },
		{ "ToolTip", "Add a master track to this folder\n\n@param Folder                        The folder to add a child master track to\n@param InMasterTrack         The master track to add to the folder\n@return True if the addition is successful" },
	};
#endif
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildObjectBinding_Statics::NewProp_Folder = { "Folder", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventAddChildObjectBinding_Parms, Folder), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildObjectBinding_Statics::NewProp_Folder_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildObjectBinding_Statics::NewProp_Folder_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildObjectBinding_Statics::NewProp_InObjectBinding = { "InObjectBinding", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventAddChildObjectBinding_Parms, InObjectBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildObjectBinding_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneFolderExtensions_eventAddChildObjectBinding_Parms), &Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildObjectBinding_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildFolders_Statics::NewProp_Folder = { "Folder", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventGetChildFolders_Parms, Folder), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildFolders_Statics::NewProp_Folder_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildFolders_Statics::NewProp_Folder_MetaData)) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildFolders_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildMasterTracks_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010008000000588, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventGetChildMasterTracks_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildMasterTracks_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildMasterTracks_Statics::NewProp_ReturnValue_MetaData)) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildMasterTracks_Statics::Function_MetaDataParams[] = {
		{ "Category", "Sequencer|Sequence" },
		{ "Comment", "/**\n\x09 * Get the master tracks contained by this folder\n\x09 *\n\x09 * @param Folder\x09The folder to get the master tracks of\n\x09 * @return The master tracks under the given folder\n\x09 */" },
		{ "ModuleRelativePath", "Public/ExtensionLibraries/MovieSceneFolderExtensions.h" },
		{ "ScriptMethod", "" },
		{ "ToolTip", "Get the master tracks contained by this folder\n\n@param Folder        The folder to get the master tracks of\n@return The master tracks under the given folder" },
	};
#endif
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildObjectBindings_Statics::NewProp_Folder = { "Folder", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventGetChildObjectBindings_Parms, Folder), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildObjectBindings_Statics::NewProp_Folder_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildObjectBindings_Statics::NewProp_Folder_MetaData)) };
	...
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildObjectBindings_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventGetChildObjectBindings_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 2674632323
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_GetFolderColor_Statics::NewProp_Folder = { "Folder", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventGetFolderColor_Parms, Folder), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_GetFolderColor_Statics::NewProp_Folder_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_GetFolderColor_Statics::NewProp_Folder_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_GetFolderColor_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventGetFolderColor_Parms, ReturnValue), Z_Construct_UScriptStruct_FColor, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_GetFolderName_Statics::NewProp_Folder = { "Folder", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventGetFolderName_Parms, Folder), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_GetFolderName_Statics::NewProp_Folder_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_GetFolderName_Statics::NewProp_Folder_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_GetFolderName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventGetFolderName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildFolder_Statics::NewProp_TargetFolder = { "TargetFolder", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventRemoveChildFolder_Parms, TargetFolder), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildFolder_Statics::NewProp_TargetFolder_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildFolder_Statics::NewProp_TargetFolder_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildFolder_Statics::NewProp_FolderToRemove = { "FolderToRemove", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventRemoveChildFolder_Parms, FolderToRemove), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildFolder_Statics::NewProp_FolderToRemove_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildFolder_Statics::NewProp_FolderToRemove_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildFolder_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneFolderExtensions_eventRemoveChildFolder_Parms), &Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildFolder_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::NewProp_Folder = { "Folder", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventRemoveChildMasterTrack_Parms, Folder), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::NewProp_Folder_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::NewProp_Folder_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::NewProp_InMasterTrack_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::NewProp_InMasterTrack = { "InMasterTrack", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventRemoveChildMasterTrack_Parms, InMasterTrack), Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::NewProp_InMasterTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::NewProp_InMasterTrack_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneFolderExtensions_eventRemoveChildMasterTrack_Parms), &Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack_Statics::NewProp_InMasterTrack,
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildObjectBinding_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneFolderExtensions_eventRemoveChildObjectBinding_Parms), &Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildObjectBinding_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderColor_Statics::NewProp_Folder = { "Folder", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventSetFolderColor_Parms, Folder), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderColor_Statics::NewProp_Folder_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderColor_Statics::NewProp_Folder_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderColor_Statics::NewProp_InFolderColor = { "InFolderColor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventSetFolderColor_Parms, InFolderColor), Z_Construct_UScriptStruct_FColor, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderColor_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneFolderExtensions_eventSetFolderColor_Parms), &Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderColor_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderName_Statics::NewProp_Folder = { "Folder", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventSetFolderName_Parms, Folder), Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderName_Statics::NewProp_Folder_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderName_Statics::NewProp_Folder_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderName_Statics::NewProp_InFolderName = { "InFolderName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneFolderExtensions_eventSetFolderName_Parms, InFolderName), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneFolderExtensions_eventSetFolderName_Parms), &Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderName_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneFolderExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildFolder, "AddChildFolder" }, // 3240426250
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildMasterTrack, "AddChildMasterTrack" }, // 2661294149
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_AddChildObjectBinding, "AddChildObjectBinding" }, // 2453718536
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildFolders, "GetChildFolders" }, // 2318336474
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildMasterTracks, "GetChildMasterTracks" }, // 1222414808
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_GetChildObjectBindings, "GetChildObjectBindings" }, // 3972018047
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_GetFolderColor, "GetFolderColor" }, // 3349000884
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_GetFolderName, "GetFolderName" }, // 3515407746
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildFolder, "RemoveChildFolder" }, // 895387668
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildMasterTrack, "RemoveChildMasterTrack" }, // 2584781047
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_RemoveChildObjectBinding, "RemoveChildObjectBinding" }, // 962850233
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderColor, "SetFolderColor" }, // 894727862
		{ &Z_Construct_UFunction_UMovieSceneFolderExtensions_SetFolderName, "SetFolderName" }, // 438391803
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneFolderExtensions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFolderExtensions, UMovieSceneFolderExtensions::StaticClass, TEXT("UMovieSceneFolderExtensions"), &Z_Registration_Info_UClass_UMovieSceneFolderExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFolderExtensions), 4086887140U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneFolderExtensions_h_1701913813(TEXT("/Script/SequencerScripting"),
