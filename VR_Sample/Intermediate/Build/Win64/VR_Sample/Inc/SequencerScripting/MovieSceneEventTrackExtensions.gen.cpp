...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection_Statics::NewProp_InTrack = { "InTrack", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneEventTrackExtensions_eventAddEventRepeaterSection_Parms, InTrack), Z_Construct_UClass_UMovieSceneEventTrack_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection_Statics::NewProp_InTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection_Statics::NewProp_InTrack_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneEventTrackExtensions_eventAddEventRepeaterSection_Parms, ReturnValue), Z_Construct_UClass_UMovieSceneEventRepeaterSection_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection_Statics::NewProp_ReturnValue_MetaData)) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventTriggerSection_Statics::NewProp_InTrack = { "InTrack", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneEventTrackExtensions_eventAddEventTriggerSection_Parms, InTrack), Z_Construct_UClass_UMovieSceneEventTrack_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventTriggerSection_Statics::NewProp_InTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventTriggerSection_Statics::NewProp_InTrack_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneEventTrackExtensions_GetBoundObjectPropertyClass_Statics::NewProp_EventKey = { "EventKey", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneEventTrackExtensions_eventGetBoundObjectPropertyClass_Parms, EventKey), Z_Construct_UScriptStruct_FMovieSceneEvent, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneEventTrackExtensions_GetBoundObjectPropertyClass_Statics::NewProp_EventKey_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneEventTrackExtensions_GetBoundObjectPropertyClass_Statics::NewProp_EventKey_MetaData)) }; // 56673498
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UMovieSceneEventTrackExtensions_GetBoundObjectPropertyClass_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneEventTrackExtensions_eventGetBoundObjectPropertyClass_Parms, ReturnValue), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneEventTrackExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventRepeaterSection, "AddEventRepeaterSection" }, // 3733431407
		{ &Z_Construct_UFunction_UMovieSceneEventTrackExtensions_AddEventTriggerSection, "AddEventTriggerSection" }, // 3171099026
		{ &Z_Construct_UFunction_UMovieSceneEventTrackExtensions_GetBoundObjectPropertyClass, "GetBoundObjectPropertyClass" }, // 1807934415
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneEventTrackExtensions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEventTrackExtensions, UMovieSceneEventTrackExtensions::StaticClass, TEXT("UMovieSceneEventTrackExtensions"), &Z_Registration_Info_UClass_UMovieSceneEventTrackExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEventTrackExtensions), 788092105U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneEventTrackExtensions_h_2820290144(TEXT("/Script/SequencerScripting"),
