...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMovieSceneScriptingChannel_Statics::NewProp_ChannelName = { "ChannelName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneScriptingChannel, ChannelName), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneScriptingChannel_Statics::NewProp_ChannelName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneScriptingChannel_Statics::NewProp_ChannelName_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Private_KeysAndChannels_MovieSceneScriptingChannel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneScriptingKey, UMovieSceneScriptingKey::StaticClass, TEXT("UMovieSceneScriptingKey"), &Z_Registration_Info_UClass_UMovieSceneScriptingKey, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneScriptingKey), 1140613337U) },
		{ Z_Construct_UClass_UMovieSceneScriptingChannel, UMovieSceneScriptingChannel::StaticClass, TEXT("UMovieSceneScriptingChannel"), &Z_Registration_Info_UClass_UMovieSceneScriptingChannel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneScriptingChannel), 3182034486U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Private_KeysAndChannels_MovieSceneScriptingChannel_h_629851136(TEXT("/Script/SequencerScripting"),
