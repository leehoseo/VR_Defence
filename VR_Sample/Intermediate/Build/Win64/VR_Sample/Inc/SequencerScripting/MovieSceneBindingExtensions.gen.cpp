...
// End Cross Module References
	...
	{
		P_GET_STRUCT_REF(FSequencerBindingProxy,Z_Param_Out_SourceBindingId);
		P_GET_STRUCT_REF(FSequencerBindingProxy,Z_Param_Out_DestinationBindingId);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UMovieSceneBindingExtensions::execSetParent)
	{
		...
		P_GET_STRUCT_REF(FSequencerBindingProxy,Z_Param_Out_InParentBinding);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UMovieSceneBindingExtensions::execGetParent)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(FSequencerBindingProxy*)Z_Param__Result=UMovieSceneBindingExtensions::GetParent(Z_Param_Out_InBinding);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(UMovieSceneBindingExtensions::execGetChildPossessables)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(TArray<FSequencerBindingProxy>*)Z_Param__Result=UMovieSceneBindingExtensions::GetChildPossessables(Z_Param_Out_InBinding);
		P_NATIVE_END;
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_AddTrack_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventAddTrack_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_AddTrack_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_AddTrack_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_AddTrack_Statics::NewProp_TrackType = { "TrackType", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventAddTrack_Parms, TrackType), Z_Construct_UClass_UMovieSceneTrack_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_AddTrack_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventAddTrack_Parms, ReturnValue), Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_AddTrack_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_AddTrack_Statics::NewProp_ReturnValue_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByExactType_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventFindTracksByExactType_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByExactType_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByExactType_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByExactType_Statics::NewProp_TrackType = { "TrackType", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventFindTracksByExactType_Parms, TrackType), Z_Construct_UClass_UMovieSceneTrack_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByExactType_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByType_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventFindTracksByType_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByType_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByType_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByType_Statics::NewProp_TrackType = { "TrackType", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventFindTracksByType_Parms, TrackType), Z_Construct_UClass_UMovieSceneTrack_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetChildPossessables_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetChildPossessables_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetChildPossessables_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetChildPossessables_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetChildPossessables_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetChildPossessables_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetChildPossessables_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 2674632323
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetDisplayName_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetDisplayName_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetDisplayName_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetDisplayName_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetDisplayName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetDisplayName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetId_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetId_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetId_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetId_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetId_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetId_Parms, ReturnValue), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetName_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetName_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetName_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetName_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetObjectTemplate_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetObjectTemplate_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetObjectTemplate_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetObjectTemplate_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetObjectTemplate_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetObjectTemplate_Parms, ReturnValue), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetParent_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetParent_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetParent_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetParent_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetParent_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetParent_Parms, ReturnValue), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(nullptr, 0) }; // 2674632323
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetPossessedObjectClass_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetPossessedObjectClass_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetPossessedObjectClass_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetPossessedObjectClass_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetPossessedObjectClass_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetPossessedObjectClass_Parms, ReturnValue), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetTracks_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventGetTracks_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetTracks_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_GetTracks_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_GetTracks_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_IsValid_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventIsValid_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_IsValid_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_IsValid_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_IsValid_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneBindingExtensions_eventIsValid_Parms), &Z_Construct_UFunction_UMovieSceneBindingExtensions_IsValid_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_MoveBindingContents_Statics::NewProp_SourceBindingId = { "SourceBindingId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventMoveBindingContents_Parms, SourceBindingId), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_MoveBindingContents_Statics::NewProp_SourceBindingId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_MoveBindingContents_Statics::NewProp_SourceBindingId_MetaData)) }; // 2674632323
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_MoveBindingContents_Statics::NewProp_DestinationBindingId = { "DestinationBindingId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventMoveBindingContents_Parms, DestinationBindingId), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_MoveBindingContents_Statics::NewProp_DestinationBindingId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_MoveBindingContents_Statics::NewProp_DestinationBindingId_MetaData)) }; // 2674632323
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_Remove_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventRemove_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_Remove_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_Remove_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_RemoveTrack_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventRemoveTrack_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_RemoveTrack_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_RemoveTrack_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_RemoveTrack_Statics::NewProp_TrackToRemove = { "TrackToRemove", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventRemoveTrack_Parms, TrackToRemove), Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_RemoveTrack_Statics::NewProp_TrackToRemove_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_RemoveTrack_Statics::NewProp_TrackToRemove_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_SetDisplayName_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventSetDisplayName_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetDisplayName_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetDisplayName_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_SetDisplayName_Statics::NewProp_InDisplayName = { "InDisplayName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventSetDisplayName_Parms, InDisplayName), METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetDisplayName_Statics::NewProp_InDisplayName_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetDisplayName_Statics::NewProp_InDisplayName_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_SetName_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventSetName_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetName_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetName_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_SetName_Statics::NewProp_InName = { "InName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventSetName_Parms, InName), METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetName_Statics::NewProp_InName_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetName_Statics::NewProp_InName_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_SetParent_Statics::NewProp_InBinding = { "InBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventSetParent_Parms, InBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetParent_Statics::NewProp_InBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetParent_Statics::NewProp_InBinding_MetaData)) }; // 2674632323
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneBindingExtensions_SetParent_Statics::NewProp_InParentBinding = { "InParentBinding", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneBindingExtensions_eventSetParent_Parms, InParentBinding), Z_Construct_UScriptStruct_FSequencerBindingProxy, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetParent_Statics::NewProp_InParentBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneBindingExtensions_SetParent_Statics::NewProp_InParentBinding_MetaData)) }; // 2674632323
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneBindingExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_AddTrack, "AddTrack" }, // 2023617984
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByExactType, "FindTracksByExactType" }, // 3097141188
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_FindTracksByType, "FindTracksByType" }, // 10871989
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_GetChildPossessables, "GetChildPossessables" }, // 2839723837
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_GetDisplayName, "GetDisplayName" }, // 1469955432
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_GetId, "GetId" }, // 1682128277
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_GetName, "GetName" }, // 3612525693
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_GetObjectTemplate, "GetObjectTemplate" }, // 3629276975
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_GetParent, "GetParent" }, // 567952026
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_GetPossessedObjectClass, "GetPossessedObjectClass" }, // 3718956649
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_GetTracks, "GetTracks" }, // 464084159
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_IsValid, "IsValid" }, // 2126922432
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_MoveBindingContents, "MoveBindingContents" }, // 2573306365
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_Remove, "Remove" }, // 3898374125
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_RemoveTrack, "RemoveTrack" }, // 1046649288
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_SetDisplayName, "SetDisplayName" }, // 3442768465
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_SetName, "SetName" }, // 4180722821
		{ &Z_Construct_UFunction_UMovieSceneBindingExtensions_SetParent, "SetParent" }, // 4287505996
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneBindingExtensions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneBindingExtensions, UMovieSceneBindingExtensions::StaticClass, TEXT("UMovieSceneBindingExtensions"), &Z_Registration_Info_UClass_UMovieSceneBindingExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneBindingExtensions), 770998084U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_ExtensionLibraries_MovieSceneBindingExtensions_h_674060099(TEXT("/Script/SequencerScripting"),
