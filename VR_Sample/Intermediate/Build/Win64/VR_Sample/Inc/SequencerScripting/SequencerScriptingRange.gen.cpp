...
class UScriptStruct* FSequencerScriptingRange::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SequencerScriptingRange.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSequencerScriptingRange, Z_Construct_UPackage__Script_SequencerScripting(), TEXT("SequencerScriptingRange"));
	}
...
template<> SEQUENCERSCRIPTING_API UScriptStruct* StaticStruct<FSequencerScriptingRange>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewProp_bHasEnd = { "bHasEnd", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FSequencerScriptingRange), &Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewProp_bHasEnd_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewProp_bHasEnd_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewProp_bHasEnd_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewProp_InclusiveStart = { "InclusiveStart", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequencerScriptingRange, InclusiveStart), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewProp_InclusiveStart_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewProp_InclusiveStart_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewProp_ExclusiveEnd = { "ExclusiveEnd", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequencerScriptingRange, ExclusiveEnd), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewProp_ExclusiveEnd_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewProp_ExclusiveEnd_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_SequencerScriptingRange_h_Statics::ScriptStructInfo[] = {
		{ FSequencerScriptingRange::StaticStruct, Z_Construct_UScriptStruct_FSequencerScriptingRange_Statics::NewStructOps, TEXT("SequencerScriptingRange"), &Z_Registration_Info_UScriptStruct_SequencerScriptingRange, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSequencerScriptingRange), 1600813035U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_SequencerScripting_Source_SequencerScripting_Public_SequencerScriptingRange_h_1561508128(TEXT("/Script/SequencerScripting"),
		nullptr, 0,
