...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMoviePlayerSettings_Statics::NewProp_bMoviesAreSkippable = { "bMoviesAreSkippable", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMoviePlayerSettings), &Z_Construct_UClass_UMoviePlayerSettings_Statics::NewProp_bMoviesAreSkippable_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMoviePlayerSettings_Statics::NewProp_bMoviesAreSkippable_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMoviePlayerSettings_Statics::NewProp_bMoviesAreSkippable_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMoviePlayerSettings_Statics::NewProp_StartupMovies_Inner = { "StartupMovies", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MoviePlayer_Public_MoviePlayerSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMoviePlayerSettings, UMoviePlayerSettings::StaticClass, TEXT("UMoviePlayerSettings"), &Z_Registration_Info_UClass_UMoviePlayerSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMoviePlayerSettings), 2191134270U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MoviePlayer_Public_MoviePlayerSettings_h_3197089189(TEXT("/Script/MoviePlayer"),
