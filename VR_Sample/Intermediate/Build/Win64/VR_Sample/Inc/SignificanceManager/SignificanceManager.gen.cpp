...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USignificanceManager_Statics::NewProp_SignificanceManagerClassName = { "SignificanceManagerClassName", nullptr, (EPropertyFlags)0x0040000002044001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USignificanceManager, SignificanceManagerClassName), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(Z_Construct_UClass_USignificanceManager_Statics::NewProp_SignificanceManagerClassName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USignificanceManager_Statics::NewProp_SignificanceManagerClassName_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SignificanceManager_Source_SignificanceManager_Public_SignificanceManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USignificanceManager, USignificanceManager::StaticClass, TEXT("USignificanceManager"), &Z_Registration_Info_UClass_USignificanceManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USignificanceManager), 402075008U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_SignificanceManager_Source_SignificanceManager_Public_SignificanceManager_h_365876421(TEXT("/Script/SignificanceManager"),
