...
class UScriptStruct* FOverlayItem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_OverlayItem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FOverlayItem, Z_Construct_UPackage__Script_Overlay(), TEXT("OverlayItem"));
	}
...
template<> OVERLAY_API UScriptStruct* StaticStruct<FOverlayItem>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_StartTime = { "StartTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FOverlayItem, StartTime), Z_Construct_UScriptStruct_FTimespan, METADATA_PARAMS(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_StartTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_StartTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_EndTime = { "EndTime", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FOverlayItem, EndTime), Z_Construct_UScriptStruct_FTimespan, METADATA_PARAMS(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_EndTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_EndTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Text = { "Text", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FOverlayItem, Text), METADATA_PARAMS(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Text_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Text_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FOverlayItem, Position), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Position_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOverlayItem_Statics::NewProp_Position_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Overlay_Public_Overlays_h_Statics::ScriptStructInfo[] = {
		{ FOverlayItem::StaticStruct, Z_Construct_UScriptStruct_FOverlayItem_Statics::NewStructOps, TEXT("OverlayItem"), &Z_Registration_Info_UScriptStruct_OverlayItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOverlayItem), 1835043341U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Overlay_Public_Overlays_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOverlays, UOverlays::StaticClass, TEXT("UOverlays"), &Z_Registration_Info_UClass_UOverlays, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOverlays), 1267524867U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Overlay_Public_Overlays_h_3594715447(TEXT("/Script/Overlay"),
