...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBasicOverlays_Statics::NewProp_Overlays_Inner = { "Overlays", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FOverlayItem, METADATA_PARAMS(nullptr, 0) }; // 1835043341
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBasicOverlays_Statics::NewProp_Overlays = { "Overlays", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBasicOverlays, Overlays), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBasicOverlays_Statics::NewProp_Overlays_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBasicOverlays_Statics::NewProp_Overlays_MetaData)) }; // 1835043341
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBasicOverlays_Statics::NewProp_AssetImportData = { "AssetImportData", nullptr, (EPropertyFlags)0x00160008000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBasicOverlays, AssetImportData), Z_Construct_UClass_UAssetImportData_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBasicOverlays_Statics::NewProp_AssetImportData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBasicOverlays_Statics::NewProp_AssetImportData_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Overlay_Public_BasicOverlays_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBasicOverlays, UBasicOverlays::StaticClass, TEXT("UBasicOverlays"), &Z_Registration_Info_UClass_UBasicOverlays, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBasicOverlays), 4268944219U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Overlay_Public_BasicOverlays_h_3516727483(TEXT("/Script/Overlay"),
