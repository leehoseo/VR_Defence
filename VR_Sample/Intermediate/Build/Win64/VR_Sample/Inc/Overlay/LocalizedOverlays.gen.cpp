...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_DefaultOverlays = { "DefaultOverlays", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULocalizedOverlays, DefaultOverlays), Z_Construct_UClass_UBasicOverlays_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_DefaultOverlays_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_DefaultOverlays_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_LocaleToOverlaysMap_ValueProp = { "LocaleToOverlaysMap", nullptr, (EPropertyFlags)0x0004000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_UBasicOverlays_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_LocaleToOverlaysMap_Key_KeyProp = { "LocaleToOverlaysMap_Key", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_LocaleToOverlaysMap = { "LocaleToOverlaysMap", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULocalizedOverlays, LocaleToOverlaysMap), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_LocaleToOverlaysMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_LocaleToOverlaysMap_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_AssetImportData = { "AssetImportData", nullptr, (EPropertyFlags)0x00160008000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULocalizedOverlays, AssetImportData), Z_Construct_UClass_UAssetImportData_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_AssetImportData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULocalizedOverlays_Statics::NewProp_AssetImportData_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Overlay_Public_LocalizedOverlays_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULocalizedOverlays, ULocalizedOverlays::StaticClass, TEXT("ULocalizedOverlays"), &Z_Registration_Info_UClass_ULocalizedOverlays, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULocalizedOverlays), 2423525658U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Overlay_Public_LocalizedOverlays_h_3848376439(TEXT("/Script/Overlay"),
