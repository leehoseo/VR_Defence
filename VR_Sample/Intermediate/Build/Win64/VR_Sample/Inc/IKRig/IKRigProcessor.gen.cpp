...
#include "IKRig/Public/IKRigProcessor.h"
...
class UScriptStruct* FGoalBone::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GoalBone.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGoalBone, Z_Construct_UPackage__Script_IKRig(), TEXT("GoalBone"));
	}
...
template<> IKRIG_API UScriptStruct* StaticStruct<FGoalBone>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UIKRigProcessor_Statics::NewProp_Solvers_Inner = { "Solvers", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UIKRigSolver_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UIKRigProcessor_Statics::NewProp_Solvers = { "Solvers", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIKRigProcessor, Solvers), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UIKRigProcessor_Statics::NewProp_Solvers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UIKRigProcessor_Statics::NewProp_Solvers_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_IKRigProcessor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIKRigProcessor, UIKRigProcessor::StaticClass, TEXT("UIKRigProcessor"), &Z_Registration_Info_UClass_UIKRigProcessor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIKRigProcessor), 2756476528U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_IKRigProcessor_h_4263832951(TEXT("/Script/IKRig"),
