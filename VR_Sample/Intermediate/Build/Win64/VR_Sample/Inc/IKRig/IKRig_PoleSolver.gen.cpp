...
#include "IKRig/Public/Solvers/IKRig_PoleSolver.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UIKRig_PoleSolverEffector_Statics::NewProp_GoalName = { "GoalName", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIKRig_PoleSolverEffector, GoalName), METADATA_PARAMS(Z_Construct_UClass_UIKRig_PoleSolverEffector_Statics::NewProp_GoalName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_PoleSolverEffector_Statics::NewProp_GoalName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UIKRig_PoleSolver_Statics::NewProp_RootName = { "RootName", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIKRig_PoleSolver, RootName), METADATA_PARAMS(Z_Construct_UClass_UIKRig_PoleSolver_Statics::NewProp_RootName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_PoleSolver_Statics::NewProp_RootName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UIKRig_PoleSolver_Statics::NewProp_EndName = { "EndName", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIKRig_PoleSolver, EndName), METADATA_PARAMS(Z_Construct_UClass_UIKRig_PoleSolver_Statics::NewProp_EndName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_PoleSolver_Statics::NewProp_EndName_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UIKRig_PoleSolver_Statics::NewProp_Effector_MetaData[] = {
		{ "ModuleRelativePath", "Public/Solvers/IKRig_PoleSolver.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UIKRig_PoleSolver_Statics::NewProp_Effector = { "Effector", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UIKRig_PoleSolver, Effector), Z_Construct_UClass_UIKRig_PoleSolverEffector_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UIKRig_PoleSolver_Statics::NewProp_Effector_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UIKRig_PoleSolver_Statics::NewProp_Effector_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Solvers_IKRig_PoleSolver_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIKRig_PoleSolverEffector, UIKRig_PoleSolverEffector::StaticClass, TEXT("UIKRig_PoleSolverEffector"), &Z_Registration_Info_UClass_UIKRig_PoleSolverEffector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIKRig_PoleSolverEffector), 3871412400U) },
		{ Z_Construct_UClass_UIKRig_PoleSolver, UIKRig_PoleSolver::StaticClass, TEXT("UIKRig_PoleSolver"), &Z_Registration_Info_UClass_UIKRig_PoleSolver, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIKRig_PoleSolver), 4152090346U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Solvers_IKRig_PoleSolver_h_3553367158(TEXT("/Script/IKRig"),
