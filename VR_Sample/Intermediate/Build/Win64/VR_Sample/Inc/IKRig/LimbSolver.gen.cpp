...
#include "IKRig/Public/Solvers/LimbSolver.h"
...
class UScriptStruct* FLimbSolverSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LimbSolverSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLimbSolverSettings, Z_Construct_UPackage__Script_IKRig(), TEXT("LimbSolverSettings"));
	}
...
class UScriptStruct* FLimbLink::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LimbLink.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLimbLink, Z_Construct_UPackage__Script_IKRig(), TEXT("LimbLink"));
	}
...
class UScriptStruct* FLimbSolver::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LimbSolver.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLimbSolver, Z_Construct_UPackage__Script_IKRig(), TEXT("LimbSolver"));
	}
...
template<> IKRIG_API UScriptStruct* StaticStruct<FLimbSolver>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Solvers_LimbSolver_h_Statics::ScriptStructInfo[] = {
		{ FLimbSolverSettings::StaticStruct, Z_Construct_UScriptStruct_FLimbSolverSettings_Statics::NewStructOps, TEXT("LimbSolverSettings"), &Z_Registration_Info_UScriptStruct_LimbSolverSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLimbSolverSettings), 3268690567U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_IKRig_Source_IKRig_Public_Solvers_LimbSolver_h_2824716570(TEXT("/Script/IKRig"),
		nullptr, 0,
