...
// End Cross Module References
	...
	static UEnum* ESpectatorReservationResult_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESpectatorReservationResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemUtils_ESpectatorReservationResult, Z_Construct_UPackage__Script_OnlineSubsystemUtils(), TEXT("ESpectatorReservationResult"));
		}
...
class UScriptStruct* FSpectatorReservation::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SpectatorReservation.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSpectatorReservation, Z_Construct_UPackage__Script_OnlineSubsystemUtils(), TEXT("SpectatorReservation"));
	}
...
template<> ONLINESUBSYSTEMUTILS_API UScriptStruct* StaticStruct<FSpectatorReservation>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSpectatorReservation_Statics::NewProp_SpectatorId = { "SpectatorId", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSpectatorReservation, SpectatorId), Z_Construct_UScriptStruct_FUniqueNetIdRepl, METADATA_PARAMS(Z_Construct_UScriptStruct_FSpectatorReservation_Statics::NewProp_SpectatorId_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpectatorReservation_Statics::NewProp_SpectatorId_MetaData)) }; // 3508419189
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSpectatorReservation_Statics::NewProp_Spectator = { "Spectator", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSpectatorReservation, Spectator), Z_Construct_UScriptStruct_FPlayerReservation, METADATA_PARAMS(Z_Construct_UScriptStruct_FSpectatorReservation_Statics::NewProp_Spectator_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpectatorReservation_Statics::NewProp_Spectator_MetaData)) }; // 3152648930
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_SessionName = { "SessionName", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USpectatorBeaconState, SessionName), METADATA_PARAMS(Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_SessionName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_SessionName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_NumConsumedReservations = { "NumConsumedReservations", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USpectatorBeaconState, NumConsumedReservations), METADATA_PARAMS(Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_NumConsumedReservations_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_NumConsumedReservations_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_bRestrictCrossConsole = { "bRestrictCrossConsole", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USpectatorBeaconState), &Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_bRestrictCrossConsole_SetBit, METADATA_PARAMS(Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_bRestrictCrossConsole_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_bRestrictCrossConsole_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_Reservations_Inner = { "Reservations", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSpectatorReservation, METADATA_PARAMS(nullptr, 0) }; // 4163969723
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_Reservations = { "Reservations", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USpectatorBeaconState, Reservations), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_Reservations_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USpectatorBeaconState_Statics::NewProp_Reservations_MetaData)) }; // 4163969723
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconState_h_Statics::ScriptStructInfo[] = {
		{ FSpectatorReservation::StaticStruct, Z_Construct_UScriptStruct_FSpectatorReservation_Statics::NewStructOps, TEXT("SpectatorReservation"), &Z_Registration_Info_UScriptStruct_SpectatorReservation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSpectatorReservation), 4163969723U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconState_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USpectatorBeaconState, USpectatorBeaconState::StaticClass, TEXT("USpectatorBeaconState"), &Z_Registration_Info_UClass_USpectatorBeaconState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USpectatorBeaconState), 3186569365U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconState_h_1870449081(TEXT("/Script/OnlineSubsystemUtils"),
