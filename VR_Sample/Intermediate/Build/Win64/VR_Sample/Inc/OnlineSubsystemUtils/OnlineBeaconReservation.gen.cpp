...
class UScriptStruct* FPlayerReservation::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PlayerReservation.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPlayerReservation, Z_Construct_UPackage__Script_OnlineSubsystemUtils(), TEXT("PlayerReservation"));
	}
...
template<> ONLINESUBSYSTEMUTILS_API UScriptStruct* StaticStruct<FPlayerReservation>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_UniqueId = { "UniqueId", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlayerReservation, UniqueId), Z_Construct_UScriptStruct_FUniqueNetIdRepl, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_UniqueId_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_UniqueId_MetaData)) }; // 3508419189
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ValidationStr = { "ValidationStr", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlayerReservation, ValidationStr), METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ValidationStr_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ValidationStr_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_Platform = { "Platform", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlayerReservation, Platform), METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_Platform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_Platform_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_bAllowCrossplay = { "bAllowCrossplay", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPlayerReservation), &Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_bAllowCrossplay_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_bAllowCrossplay_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_bAllowCrossplay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ElapsedTime = { "ElapsedTime", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlayerReservation, ElapsedTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ElapsedTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewProp_ElapsedTime_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconReservation_h_Statics::ScriptStructInfo[] = {
		{ FPlayerReservation::StaticStruct, Z_Construct_UScriptStruct_FPlayerReservation_Statics::NewStructOps, TEXT("PlayerReservation"), &Z_Registration_Info_UScriptStruct_PlayerReservation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlayerReservation), 3152648930U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconReservation_h_1240004936(TEXT("/Script/OnlineSubsystemUtils"),
		nullptr, 0,
