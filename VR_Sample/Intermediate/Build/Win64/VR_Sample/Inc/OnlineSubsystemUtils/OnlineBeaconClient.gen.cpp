...
// End Cross Module References
	...
	static UEnum* EBeaconConnectionState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EBeaconConnectionState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemUtils_EBeaconConnectionState, Z_Construct_UPackage__Script_OnlineSubsystemUtils(), TEXT("EBeaconConnectionState"));
		}
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_BeaconConnection = { "BeaconConnection", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeaconClient, BeaconConnection), Z_Construct_UClass_UNetConnection_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_BeaconConnection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_BeaconConnection_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_ConnectionState_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_ConnectionState = { "ConnectionState", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeaconClient, ConnectionState), Z_Construct_UEnum_OnlineSubsystemUtils_EBeaconConnectionState, METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_ConnectionState_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconClient_Statics::NewProp_ConnectionState_MetaData)) }; // 808705229
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AOnlineBeaconClient, AOnlineBeaconClient::StaticClass, TEXT("AOnlineBeaconClient"), &Z_Registration_Info_UClass_AOnlineBeaconClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOnlineBeaconClient), 4060424184U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconClient_h_2462720855(TEXT("/Script/OnlineSubsystemUtils"),
