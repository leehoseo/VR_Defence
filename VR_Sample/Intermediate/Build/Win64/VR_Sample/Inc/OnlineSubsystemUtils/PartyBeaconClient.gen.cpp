...
// End Cross Module References
	...
	static UEnum* EClientRequestType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EClientRequestType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemUtils_EClientRequestType, Z_Construct_UPackage__Script_OnlineSubsystemUtils(), TEXT("EClientRequestType"));
		}
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_APartyBeaconClient_ClientReservationResponse_Statics::NewProp_ReservationResponse = { "ReservationResponse", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PartyBeaconClient_eventClientReservationResponse_Parms, ReservationResponse), Z_Construct_UEnum_OnlineSubsystemUtils_EPartyReservationResult, METADATA_PARAMS(nullptr, 0) }; // 3325762825
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_APartyBeaconClient_ClientSendReservationUpdates_Statics::NewProp_NumRemainingReservations = { "NumRemainingReservations", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PartyBeaconClient_eventClientSendReservationUpdates_Parms, NumRemainingReservations), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_SessionId = { "SessionId", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PartyBeaconClient_eventServerAddOrUpdateReservationRequest_Parms, SessionId), METADATA_PARAMS(Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_SessionId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_SessionId_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_Reservation = { "Reservation", nullptr, (EPropertyFlags)0x0010000008000082, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PartyBeaconClient_eventServerAddOrUpdateReservationRequest_Parms, Reservation), Z_Construct_UScriptStruct_FPartyReservation, METADATA_PARAMS(Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_Reservation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest_Statics::NewProp_Reservation_MetaData)) }; // 1353442533
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_APartyBeaconClient_ServerCancelReservationRequest_Statics::NewProp_PartyLeader = { "PartyLeader", nullptr, (EPropertyFlags)0x0010000008000082, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PartyBeaconClient_eventServerCancelReservationRequest_Parms, PartyLeader), Z_Construct_UScriptStruct_FUniqueNetIdRepl, METADATA_PARAMS(Z_Construct_UFunction_APartyBeaconClient_ServerCancelReservationRequest_Statics::NewProp_PartyLeader_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_APartyBeaconClient_ServerCancelReservationRequest_Statics::NewProp_PartyLeader_MetaData)) }; // 3508419189
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_APartyBeaconClient_ServerReservationRequest_Statics::NewProp_SessionId = { "SessionId", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PartyBeaconClient_eventServerReservationRequest_Parms, SessionId), METADATA_PARAMS(Z_Construct_UFunction_APartyBeaconClient_ServerReservationRequest_Statics::NewProp_SessionId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_APartyBeaconClient_ServerReservationRequest_Statics::NewProp_SessionId_MetaData)) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APartyBeaconClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_APartyBeaconClient_ClientCancelReservationResponse, "ClientCancelReservationResponse" }, // 2548767168
		{ &Z_Construct_UFunction_APartyBeaconClient_ClientReservationResponse, "ClientReservationResponse" }, // 2917427595
		{ &Z_Construct_UFunction_APartyBeaconClient_ClientSendReservationFull, "ClientSendReservationFull" }, // 3133320018
		{ &Z_Construct_UFunction_APartyBeaconClient_ClientSendReservationUpdates, "ClientSendReservationUpdates" }, // 18028611
		{ &Z_Construct_UFunction_APartyBeaconClient_ServerAddOrUpdateReservationRequest, "ServerAddOrUpdateReservationRequest" }, // 2068092873
		{ &Z_Construct_UFunction_APartyBeaconClient_ServerCancelReservationRequest, "ServerCancelReservationRequest" }, // 3237906375
		{ &Z_Construct_UFunction_APartyBeaconClient_ServerRemoveMemberFromReservationRequest, "ServerRemoveMemberFromReservationRequest" }, // 1698630295
		{ &Z_Construct_UFunction_APartyBeaconClient_ServerReservationRequest, "ServerReservationRequest" }, // 740364842
		{ &Z_Construct_UFunction_APartyBeaconClient_ServerUpdateReservationRequest, "ServerUpdateReservationRequest" }, // 2968286642
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_DestSessionId = { "DestSessionId", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APartyBeaconClient, DestSessionId), METADATA_PARAMS(Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_DestSessionId_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_DestSessionId_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_PendingReservation = { "PendingReservation", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APartyBeaconClient, PendingReservation), Z_Construct_UScriptStruct_FPartyReservation, METADATA_PARAMS(Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_PendingReservation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_PendingReservation_MetaData)) }; // 1353442533
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_RequestType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_RequestType = { "RequestType", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APartyBeaconClient, RequestType), Z_Construct_UEnum_OnlineSubsystemUtils_EClientRequestType, METADATA_PARAMS(Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_RequestType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_RequestType_MetaData)) }; // 3501230932
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_bPendingReservationSent = { "bPendingReservationSent", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(APartyBeaconClient), &Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_bPendingReservationSent_SetBit, METADATA_PARAMS(Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_bPendingReservationSent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_bPendingReservationSent_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_bCancelReservation = { "bCancelReservation", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(APartyBeaconClient), &Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_bCancelReservation_SetBit, METADATA_PARAMS(Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_bCancelReservation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APartyBeaconClient_Statics::NewProp_bCancelReservation_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_PartyBeaconClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APartyBeaconClient, APartyBeaconClient::StaticClass, TEXT("APartyBeaconClient"), &Z_Registration_Info_UClass_APartyBeaconClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APartyBeaconClient), 3277849473U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_PartyBeaconClient_h_1614460495(TEXT("/Script/OnlineSubsystemUtils"),
