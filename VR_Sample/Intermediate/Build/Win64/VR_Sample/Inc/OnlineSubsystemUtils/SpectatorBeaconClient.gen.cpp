...
// End Cross Module References
	...
	static UEnum* ESpectatorClientRequestType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESpectatorClientRequestType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemUtils_ESpectatorClientRequestType, Z_Construct_UPackage__Script_OnlineSubsystemUtils(), TEXT("ESpectatorClientRequestType"));
		}
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ASpectatorBeaconClient_ClientReservationResponse_Statics::NewProp_ReservationResponse = { "ReservationResponse", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SpectatorBeaconClient_eventClientReservationResponse_Parms, ReservationResponse), Z_Construct_UEnum_OnlineSubsystemUtils_ESpectatorReservationResult, METADATA_PARAMS(nullptr, 0) }; // 3705599655
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ASpectatorBeaconClient_ClientSendReservationUpdates_Statics::NewProp_NumRemainingReservations = { "NumRemainingReservations", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SpectatorBeaconClient_eventClientSendReservationUpdates_Parms, NumRemainingReservations), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ASpectatorBeaconClient_ServerCancelReservationRequest_Statics::NewProp_Spectator = { "Spectator", nullptr, (EPropertyFlags)0x0010000008000082, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SpectatorBeaconClient_eventServerCancelReservationRequest_Parms, Spectator), Z_Construct_UScriptStruct_FUniqueNetIdRepl, METADATA_PARAMS(Z_Construct_UFunction_ASpectatorBeaconClient_ServerCancelReservationRequest_Statics::NewProp_Spectator_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ASpectatorBeaconClient_ServerCancelReservationRequest_Statics::NewProp_Spectator_MetaData)) }; // 3508419189
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::NewProp_SessionId = { "SessionId", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SpectatorBeaconClient_eventServerReservationRequest_Parms, SessionId), METADATA_PARAMS(Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::NewProp_SessionId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::NewProp_SessionId_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::NewProp_Reservation = { "Reservation", nullptr, (EPropertyFlags)0x0010000008000082, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SpectatorBeaconClient_eventServerReservationRequest_Parms, Reservation), Z_Construct_UScriptStruct_FSpectatorReservation, METADATA_PARAMS(Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::NewProp_Reservation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest_Statics::NewProp_Reservation_MetaData)) }; // 4163969723
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASpectatorBeaconClient_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientCancelReservationResponse, "ClientCancelReservationResponse" }, // 603401439
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientReservationResponse, "ClientReservationResponse" }, // 1947316758
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientSendReservationFull, "ClientSendReservationFull" }, // 1621915589
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientSendReservationUpdates, "ClientSendReservationUpdates" }, // 475051506
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ServerCancelReservationRequest, "ServerCancelReservationRequest" }, // 3201115355
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest, "ServerReservationRequest" }, // 2568492477
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_DestSessionId = { "DestSessionId", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASpectatorBeaconClient, DestSessionId), METADATA_PARAMS(Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_DestSessionId_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_DestSessionId_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_PendingReservation = { "PendingReservation", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASpectatorBeaconClient, PendingReservation), Z_Construct_UScriptStruct_FSpectatorReservation, METADATA_PARAMS(Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_PendingReservation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_PendingReservation_MetaData)) }; // 4163969723
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_RequestType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_bPendingReservationSent = { "bPendingReservationSent", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ASpectatorBeaconClient), &Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_bPendingReservationSent_SetBit, METADATA_PARAMS(Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_bPendingReservationSent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_bPendingReservationSent_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_bCancelReservation = { "bCancelReservation", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ASpectatorBeaconClient), &Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_bCancelReservation_SetBit, METADATA_PARAMS(Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_bCancelReservation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASpectatorBeaconClient_Statics::NewProp_bCancelReservation_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASpectatorBeaconClient, ASpectatorBeaconClient::StaticClass, TEXT("ASpectatorBeaconClient"), &Z_Registration_Info_UClass_ASpectatorBeaconClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpectatorBeaconClient), 960564993U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconClient_h_840108369(TEXT("/Script/OnlineSubsystemUtils"),
