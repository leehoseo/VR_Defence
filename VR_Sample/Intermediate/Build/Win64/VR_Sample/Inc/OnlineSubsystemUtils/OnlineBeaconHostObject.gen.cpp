...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_BeaconTypeName = { "BeaconTypeName", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeaconHostObject, BeaconTypeName), METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_BeaconTypeName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_BeaconTypeName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_ClientActors = { "ClientActors", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeaconHostObject, ClientActors), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_ClientActors_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeaconHostObject_Statics::NewProp_ClientActors_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconHostObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AOnlineBeaconHostObject, AOnlineBeaconHostObject::StaticClass, TEXT("AOnlineBeaconHostObject"), &Z_Registration_Info_UClass_AOnlineBeaconHostObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOnlineBeaconHostObject), 221646658U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeaconHostObject_h_2446483319(TEXT("/Script/OnlineSubsystemUtils"),
