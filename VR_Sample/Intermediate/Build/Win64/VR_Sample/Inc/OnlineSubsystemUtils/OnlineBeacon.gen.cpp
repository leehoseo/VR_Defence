...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionInitialTimeout = { "BeaconConnectionInitialTimeout", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeacon, BeaconConnectionInitialTimeout), METADATA_PARAMS(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionInitialTimeout_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionInitialTimeout_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionTimeout = { "BeaconConnectionTimeout", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeacon, BeaconConnectionTimeout), METADATA_PARAMS(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionTimeout_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_BeaconConnectionTimeout_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_NetDriver = { "NetDriver", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AOnlineBeacon, NetDriver), Z_Construct_UClass_UNetDriver_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_NetDriver_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AOnlineBeacon_Statics::NewProp_NetDriver_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeacon_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AOnlineBeacon, AOnlineBeacon::StaticClass, TEXT("AOnlineBeacon"), &Z_Registration_Info_UClass_AOnlineBeacon, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOnlineBeacon), 772067704U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_OnlineBeacon_h_4089350450(TEXT("/Script/OnlineSubsystemUtils"),
