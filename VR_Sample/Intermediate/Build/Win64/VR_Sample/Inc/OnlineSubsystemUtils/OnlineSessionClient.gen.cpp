...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bIsFromInvite = { "bIsFromInvite", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UOnlineSessionClient), &Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bIsFromInvite_SetBit, METADATA_PARAMS(Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bIsFromInvite_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bIsFromInvite_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bHandlingDisconnect = { "bHandlingDisconnect", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UOnlineSessionClient), &Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bHandlingDisconnect_SetBit, METADATA_PARAMS(Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bHandlingDisconnect_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOnlineSessionClient_Statics::NewProp_bHandlingDisconnect_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_OnlineSessionClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOnlineSessionClient, UOnlineSessionClient::StaticClass, TEXT("UOnlineSessionClient"), &Z_Registration_Info_UClass_UOnlineSessionClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOnlineSessionClient), 478831309U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Classes_OnlineSessionClient_h_3037815562(TEXT("/Script/OnlineSubsystemUtils"),
