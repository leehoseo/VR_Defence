...
// End Cross Module References
	...
	static UEnum* EPartyReservationResult_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPartyReservationResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_OnlineSubsystemUtils_EPartyReservationResult, Z_Construct_UPackage__Script_OnlineSubsystemUtils(), TEXT("EPartyReservationResult"));
		}
...
class UScriptStruct* FPartyReservation::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PartyReservation.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPartyReservation, Z_Construct_UPackage__Script_OnlineSubsystemUtils(), TEXT("PartyReservation"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_PartyLeader = { "PartyLeader", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPartyReservation, PartyLeader), Z_Construct_UScriptStruct_FUniqueNetIdRepl, METADATA_PARAMS(Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_PartyLeader_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_PartyLeader_MetaData)) }; // 3508419189
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_PartyMembers_Inner = { "PartyMembers", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPlayerReservation, METADATA_PARAMS(nullptr, 0) }; // 3152648930
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_PartyMembers = { "PartyMembers", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPartyReservation, PartyMembers), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_PartyMembers_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_PartyMembers_MetaData)) }; // 3152648930
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_RemovedPartyMembers_Inner = { "RemovedPartyMembers", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPlayerReservation, METADATA_PARAMS(nullptr, 0) }; // 3152648930
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_RemovedPartyMembers = { "RemovedPartyMembers", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPartyReservation, RemovedPartyMembers), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_RemovedPartyMembers_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyReservation_Statics::NewProp_RemovedPartyMembers_MetaData)) }; // 3152648930
...
class UScriptStruct* FPartyBeaconCrossplayPlatformMapping::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PartyBeaconCrossplayPlatformMapping.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping, Z_Construct_UPackage__Script_OnlineSubsystemUtils(), TEXT("PartyBeaconCrossplayPlatformMapping"));
	}
...
template<> ONLINESUBSYSTEMUTILS_API UScriptStruct* StaticStruct<FPartyBeaconCrossplayPlatformMapping>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformName = { "PlatformName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPartyBeaconCrossplayPlatformMapping, PlatformName), METADATA_PARAMS(Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformType = { "PlatformType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPartyBeaconCrossplayPlatformMapping, PlatformType), METADATA_PARAMS(Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewProp_PlatformType_MetaData)) };
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_SessionName = { "SessionName", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, SessionName), METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_SessionName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_SessionName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_NumConsumedReservations = { "NumConsumedReservations", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, NumConsumedReservations), METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_NumConsumedReservations_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_NumConsumedReservations_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_NumTeams = { "NumTeams", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, NumTeams), METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_NumTeams_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_NumTeams_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_NumPlayersPerTeam = { "NumPlayersPerTeam", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, NumPlayersPerTeam), METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_NumPlayersPerTeam_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_NumPlayersPerTeam_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_TeamAssignmentMethod = { "TeamAssignmentMethod", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, TeamAssignmentMethod), METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_TeamAssignmentMethod_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_TeamAssignmentMethod_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_ForceTeamNum = { "ForceTeamNum", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, ForceTeamNum), METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_ForceTeamNum_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_ForceTeamNum_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_bRestrictCrossConsole = { "bRestrictCrossConsole", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPartyBeaconState), &Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_bRestrictCrossConsole_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_bRestrictCrossConsole_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_bRestrictCrossConsole_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions_Inner = { "PlatformCrossplayRestrictions", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions = { "PlatformCrossplayRestrictions", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, PlatformCrossplayRestrictions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformCrossplayRestrictions_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping_Inner = { "PlatformTypeMapping", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping, METADATA_PARAMS(nullptr, 0) }; // 4122541189
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping = { "PlatformTypeMapping", nullptr, (EPropertyFlags)0x0020080000004000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, PlatformTypeMapping), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_PlatformTypeMapping_MetaData)) }; // 4122541189
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_bEnableRemovalRequests = { "bEnableRemovalRequests", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPartyBeaconState), &Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_bEnableRemovalRequests_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_bEnableRemovalRequests_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_bEnableRemovalRequests_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_Reservations_Inner = { "Reservations", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPartyReservation, METADATA_PARAMS(nullptr, 0) }; // 1353442533
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_Reservations = { "Reservations", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPartyBeaconState, Reservations), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_Reservations_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPartyBeaconState_Statics::NewProp_Reservations_MetaData)) }; // 1353442533
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_PartyBeaconState_h_Statics::ScriptStructInfo[] = {
		{ FPartyReservation::StaticStruct, Z_Construct_UScriptStruct_FPartyReservation_Statics::NewStructOps, TEXT("PartyReservation"), &Z_Registration_Info_UScriptStruct_PartyReservation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPartyReservation), 1353442533U) },
		{ FPartyBeaconCrossplayPlatformMapping::StaticStruct, Z_Construct_UScriptStruct_FPartyBeaconCrossplayPlatformMapping_Statics::NewStructOps, TEXT("PartyBeaconCrossplayPlatformMapping"), &Z_Registration_Info_UScriptStruct_PartyBeaconCrossplayPlatformMapping, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPartyBeaconCrossplayPlatformMapping), 4122541189U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_PartyBeaconState_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPartyBeaconState, UPartyBeaconState::StaticClass, TEXT("UPartyBeaconState"), &Z_Registration_Info_UClass_UPartyBeaconState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPartyBeaconState), 1435095393U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_PartyBeaconState_h_744659140(TEXT("/Script/OnlineSubsystemUtils"),
