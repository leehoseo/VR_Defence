...
class UScriptStruct* FPerPlatformSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PerPlatformSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPerPlatformSettings, Z_Construct_UPackage__Script_DeveloperSettings(), TEXT("PerPlatformSettings"));
	}
...
template<> DEVELOPERSETTINGS_API UScriptStruct* StaticStruct<FPerPlatformSettings>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPerPlatformSettings_Statics::NewProp_Settings_Inner = { "Settings", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UPlatformSettings_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FPerPlatformSettings_Statics::NewProp_Settings_Inner_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerPlatformSettings_Statics::NewProp_Settings_Inner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPerPlatformSettings_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0044008000002049, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPerPlatformSettings, Settings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPerPlatformSettings_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerPlatformSettings_Statics::NewProp_Settings_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_DeveloperSettings_Public_Engine_PlatformSettings_h_Statics::ScriptStructInfo[] = {
		{ FPerPlatformSettings::StaticStruct, Z_Construct_UScriptStruct_FPerPlatformSettings_Statics::NewStructOps, TEXT("PerPlatformSettings"), &Z_Registration_Info_UScriptStruct_PerPlatformSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPerPlatformSettings), 2153393741U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_DeveloperSettings_Public_Engine_PlatformSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlatformSettings, UPlatformSettings::StaticClass, TEXT("UPlatformSettings"), &Z_Registration_Info_UClass_UPlatformSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlatformSettings), 615708447U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_DeveloperSettings_Public_Engine_PlatformSettings_h_298634568(TEXT("/Script/DeveloperSettings"),
