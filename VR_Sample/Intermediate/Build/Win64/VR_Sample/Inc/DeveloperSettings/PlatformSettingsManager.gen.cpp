...
#include "DeveloperSettings/Public/Engine/PlatformSettingsManager.h"
...
class UScriptStruct* FPlatformSettingsInstances::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PlatformSettingsInstances.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPlatformSettingsInstances, Z_Construct_UPackage__Script_DeveloperSettings(), TEXT("PlatformSettingsInstances"));
	}
...
template<> DEVELOPERSETTINGS_API UScriptStruct* StaticStruct<FPlatformSettingsInstances>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPlatformSettingsInstances_Statics::NewProp_PlatformInstance = { "PlatformInstance", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlatformSettingsInstances, PlatformInstance), Z_Construct_UClass_UPlatformSettings_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlatformSettingsInstances_Statics::NewProp_PlatformInstance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlatformSettingsInstances_Statics::NewProp_PlatformInstance_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPlatformSettingsInstances_Statics::NewProp_OtherPlatforms_ValueProp = { "OtherPlatforms", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_UPlatformSettings_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FPlatformSettingsInstances_Statics::NewProp_OtherPlatforms = { "OtherPlatforms", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlatformSettingsInstances, OtherPlatforms), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlatformSettingsInstances_Statics::NewProp_OtherPlatforms_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlatformSettingsInstances_Statics::NewProp_OtherPlatforms_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_DeveloperSettings_Public_Engine_PlatformSettingsManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlatformSettingsManager, UPlatformSettingsManager::StaticClass, TEXT("UPlatformSettingsManager"), &Z_Registration_Info_UClass_UPlatformSettingsManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlatformSettingsManager), 1928794401U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_DeveloperSettings_Public_Engine_PlatformSettingsManager_h_741764750(TEXT("/Script/DeveloperSettings"),
