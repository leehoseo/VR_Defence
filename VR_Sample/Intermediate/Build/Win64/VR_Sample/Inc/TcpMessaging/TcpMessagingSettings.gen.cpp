...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_EnableTransport = { "EnableTransport", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UTcpMessagingSettings), &Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_EnableTransport_SetBit, METADATA_PARAMS(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_EnableTransport_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_EnableTransport_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ListenEndpoint = { "ListenEndpoint", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTcpMessagingSettings, ListenEndpoint), METADATA_PARAMS(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ListenEndpoint_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ListenEndpoint_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectToEndpoints_Inner = { "ConnectToEndpoints", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectToEndpoints = { "ConnectToEndpoints", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTcpMessagingSettings, ConnectToEndpoints), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectToEndpoints_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectToEndpoints_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectionRetryDelay = { "ConnectionRetryDelay", nullptr, (EPropertyFlags)0x0040000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTcpMessagingSettings, ConnectionRetryDelay), METADATA_PARAMS(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectionRetryDelay_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_ConnectionRetryDelay_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_bStopServiceWhenAppDeactivates = { "bStopServiceWhenAppDeactivates", nullptr, (EPropertyFlags)0x0040000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UTcpMessagingSettings), &Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_bStopServiceWhenAppDeactivates_SetBit, METADATA_PARAMS(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_bStopServiceWhenAppDeactivates_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTcpMessagingSettings_Statics::NewProp_bStopServiceWhenAppDeactivates_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_TcpMessaging_Source_TcpMessaging_Private_Settings_TcpMessagingSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTcpMessagingSettings, UTcpMessagingSettings::StaticClass, TEXT("UTcpMessagingSettings"), &Z_Registration_Info_UClass_UTcpMessagingSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTcpMessagingSettings), 1045693208U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_TcpMessaging_Source_TcpMessaging_Private_Settings_TcpMessagingSettings_h_749251057(TEXT("/Script/TcpMessaging"),
