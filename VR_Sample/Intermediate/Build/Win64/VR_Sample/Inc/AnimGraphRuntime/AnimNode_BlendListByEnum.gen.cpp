...
class UScriptStruct* FAnimNode_BlendListByEnum::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_BlendListByEnum.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_BlendListByEnum, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_BlendListByEnum"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_BlendListByEnum>()
{
...
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNode_BlendListByEnum_Statics::NewProp_EnumToPoseIndex_Inner = { "EnumToPoseIndex", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_BlendListByEnum_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_BlendListByEnum::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_BlendListByEnum_Statics::NewStructOps, TEXT("AnimNode_BlendListByEnum"), &Z_Registration_Info_UScriptStruct_AnimNode_BlendListByEnum, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_BlendListByEnum), 4089445071U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_BlendListByEnum_h_1924010596(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
