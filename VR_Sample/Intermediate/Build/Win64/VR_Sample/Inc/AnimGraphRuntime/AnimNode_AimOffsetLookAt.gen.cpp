...
class UScriptStruct* FAnimNode_AimOffsetLookAt::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_AimOffsetLookAt.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_AimOffsetLookAt"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_AimOffsetLookAt>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_BasePose = { "BasePose", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_AimOffsetLookAt, BasePose), Z_Construct_UScriptStruct_FPoseLink, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_BasePose_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_BasePose_MetaData)) }; // 2393943538
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_LODThreshold = { "LODThreshold", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_AimOffsetLookAt, LODThreshold), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_LODThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_LODThreshold_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_PivotSocketName_MetaData[] = {
		{ "Category", "LookAt" },
		{ "Comment", "/** Socket to treat as the look at pivot (optional). This will overwrite the translation of the source socket transform to better match the lookat direction */" },
		{ "ModuleRelativePath", "Public/AnimNodes/AnimNode_AimOffsetLookAt.h" },
		{ "PinHiddenByDefault", "" },
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_PivotSocketName = { "PivotSocketName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_AimOffsetLookAt, PivotSocketName), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_PivotSocketName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_PivotSocketName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_LookAtLocation = { "LookAtLocation", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_AimOffsetLookAt, LookAtLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_LookAtLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_LookAtLocation_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_SocketAxis_MetaData[] = {
		{ "Category", "LookAt" },
		{ "Comment", "/** Axis in the socket transform to consider the 'forward' or look at axis */" },
		{ "ModuleRelativePath", "Public/AnimNodes/AnimNode_AimOffsetLookAt.h" },
		{ "PinHiddenByDefault", "" },
		{ "ToolTip", "Axis in the socket transform to consider the 'forward' or look at axis" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_SocketAxis = { "SocketAxis", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_AimOffsetLookAt, SocketAxis), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_SocketAxis_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_SocketAxis_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_Alpha = { "Alpha", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_AimOffsetLookAt, Alpha), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_Alpha_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewProp_Alpha_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_AimOffsetLookAt_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_AimOffsetLookAt::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_AimOffsetLookAt_Statics::NewStructOps, TEXT("AnimNode_AimOffsetLookAt"), &Z_Registration_Info_UScriptStruct_AnimNode_AimOffsetLookAt, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_AimOffsetLookAt), 173578967U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_AimOffsetLookAt_h_269059063(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
