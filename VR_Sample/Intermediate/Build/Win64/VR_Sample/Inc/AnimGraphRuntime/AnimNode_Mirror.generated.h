...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<struct FAnimNode_MirrorBase>();

#define FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_Mirror_h_95_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FAnimNode_Mirror_Statics; \
	static class UScriptStruct* StaticStruct(); \
	typedef FAnimNode_MirrorBase Super;


template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<struct FAnimNode_Mirror>();

#define FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_Mirror_h_150_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FAnimNode_Mirror_Standalone_Statics; \
	static class UScriptStruct* StaticStruct(); \
	typedef FAnimNode_MirrorBase Super;


template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<struct FAnimNode_Mirror_Standalone>();
