...
class UScriptStruct* FAnimNode_PoseBlendNode::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_PoseBlendNode.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_PoseBlendNode, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_PoseBlendNode"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_PoseBlendNode>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_PoseBlendNode_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_PoseBlendNode::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_PoseBlendNode_Statics::NewStructOps, TEXT("AnimNode_PoseBlendNode"), &Z_Registration_Info_UScriptStruct_AnimNode_PoseBlendNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_PoseBlendNode), 2511719623U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_PoseBlendNode_h_2518843987(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
