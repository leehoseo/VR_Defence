...
// End Cross Module References
	...
	static UEnum* ERefPoseType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERefPoseType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AnimGraphRuntime_ERefPoseType, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("ERefPoseType"));
		}
...
class UScriptStruct* FAnimNode_RefPose::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_RefPose.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_RefPose, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_RefPose"));
	}
...
class UScriptStruct* FAnimNode_MeshSpaceRefPose::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_MeshSpaceRefPose.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_MeshSpaceRefPose, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_MeshSpaceRefPose"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_MeshSpaceRefPose>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_RefPose_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_RefPose::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_RefPose_Statics::NewStructOps, TEXT("AnimNode_RefPose"), &Z_Registration_Info_UScriptStruct_AnimNode_RefPose, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_RefPose), 4083063019U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_RefPose_h_130347378(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
