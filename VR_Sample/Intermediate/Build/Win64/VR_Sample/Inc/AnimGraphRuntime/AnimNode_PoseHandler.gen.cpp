...
class UScriptStruct* FAnimNode_PoseHandler::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_PoseHandler.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_PoseHandler, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_PoseHandler"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_PoseHandler>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAnimNode_PoseHandler_Statics::NewProp_PoseAsset = { "PoseAsset", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_PoseHandler, PoseAsset), Z_Construct_UClass_UPoseAsset_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_PoseHandler_Statics::NewProp_PoseAsset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_PoseHandler_Statics::NewProp_PoseAsset_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_PoseHandler_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_PoseHandler::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_PoseHandler_Statics::NewStructOps, TEXT("AnimNode_PoseHandler"), &Z_Registration_Info_UScriptStruct_AnimNode_PoseHandler, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_PoseHandler), 3825786327U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_PoseHandler_h_4244913765(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
