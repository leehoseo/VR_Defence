...
#include "AnimGraphRuntime/Public/BoneControllers/BoneControllerTypes.h"
...
// End Cross Module References
	...
	static UEnum* EWarpingEvaluationMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWarpingEvaluationMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AnimGraphRuntime_EWarpingEvaluationMode, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("EWarpingEvaluationMode"));
		}
	...
	static UEnum* EWarpingVectorMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWarpingVectorMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AnimGraphRuntime_EWarpingVectorMode, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("EWarpingVectorMode"));
		}
...
class UScriptStruct* FWarpingVectorValue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WarpingVectorValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWarpingVectorValue, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("WarpingVectorValue"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FWarpingVectorValue>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FWarpingVectorValue_Statics::NewProp_Mode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BoneControllers_BoneControllerTypes_h_Statics::ScriptStructInfo[] = {
		{ FWarpingVectorValue::StaticStruct, Z_Construct_UScriptStruct_FWarpingVectorValue_Statics::NewStructOps, TEXT("WarpingVectorValue"), &Z_Registration_Info_UScriptStruct_WarpingVectorValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWarpingVectorValue), 1554563661U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BoneControllers_BoneControllerTypes_h_2216743533(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
