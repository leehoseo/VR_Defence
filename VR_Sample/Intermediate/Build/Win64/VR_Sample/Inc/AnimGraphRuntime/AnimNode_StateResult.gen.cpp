...
class UScriptStruct* FAnimNode_StateResult::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_StateResult.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_StateResult, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_StateResult"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_StateResult>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNode_StateResult_Statics::NewProp_StateIndex = { "StateIndex", nullptr, (EPropertyFlags)0x0020080800000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_StateResult, StateIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_StateResult_Statics::NewProp_StateIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_StateResult_Statics::NewProp_StateIndex_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_StateResult_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_StateResult::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_StateResult_Statics::NewStructOps, TEXT("AnimNode_StateResult"), &Z_Registration_Info_UScriptStruct_AnimNode_StateResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_StateResult), 1844220424U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_StateResult_h_21859948(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
