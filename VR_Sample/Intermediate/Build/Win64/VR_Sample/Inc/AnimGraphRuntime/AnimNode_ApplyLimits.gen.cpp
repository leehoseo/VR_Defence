...
class UScriptStruct* FAngularRangeLimit::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AngularRangeLimit.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAngularRangeLimit, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AngularRangeLimit"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::NewProp_Bone = { "Bone", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAngularRangeLimit, Bone), Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::NewProp_Bone_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::NewProp_Bone_MetaData)) }; // 831728502
...
class UScriptStruct* FAnimNode_ApplyLimits::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_ApplyLimits.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_ApplyLimits"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_ApplyLimits>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularRangeLimits_Inner = { "AngularRangeLimits", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FAngularRangeLimit, METADATA_PARAMS(nullptr, 0) }; // 2743192453
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularRangeLimits = { "AngularRangeLimits", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ApplyLimits, AngularRangeLimits), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularRangeLimits_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularRangeLimits_MetaData)) }; // 2743192453
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets_Inner = { "AngularOffsets", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets = { "AngularOffsets", nullptr, (EPropertyFlags)0x0010000000000045, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ApplyLimits, AngularOffsets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewProp_AngularOffsets_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BoneControllers_AnimNode_ApplyLimits_h_Statics::ScriptStructInfo[] = {
		{ FAngularRangeLimit::StaticStruct, Z_Construct_UScriptStruct_FAngularRangeLimit_Statics::NewStructOps, TEXT("AngularRangeLimit"), &Z_Registration_Info_UScriptStruct_AngularRangeLimit, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAngularRangeLimit), 2743192453U) },
		{ FAnimNode_ApplyLimits::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_ApplyLimits_Statics::NewStructOps, TEXT("AnimNode_ApplyLimits"), &Z_Registration_Info_UScriptStruct_AnimNode_ApplyLimits, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_ApplyLimits), 440304231U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BoneControllers_AnimNode_ApplyLimits_h_1747481081(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
