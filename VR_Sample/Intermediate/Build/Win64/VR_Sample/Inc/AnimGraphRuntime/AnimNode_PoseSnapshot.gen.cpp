...
// End Cross Module References
	...
	static UEnum* ESnapshotSourceMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESnapshotSourceMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AnimGraphRuntime_ESnapshotSourceMode, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("ESnapshotSourceMode"));
		}
...
class UScriptStruct* FAnimNode_PoseSnapshot::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_PoseSnapshot.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_PoseSnapshot"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_PoseSnapshot>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewProp_Snapshot = { "Snapshot", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_PoseSnapshot, Snapshot), Z_Construct_UScriptStruct_FPoseSnapshot, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewProp_Snapshot_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewProp_Snapshot_MetaData)) }; // 1666854200
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewProp_Mode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_PoseSnapshot, Mode), Z_Construct_UEnum_AnimGraphRuntime_ESnapshotSourceMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewProp_Mode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewProp_Mode_MetaData)) }; // 2539971620
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_PoseSnapshot_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_PoseSnapshot::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_PoseSnapshot_Statics::NewStructOps, TEXT("AnimNode_PoseSnapshot"), &Z_Registration_Info_UScriptStruct_AnimNode_PoseSnapshot, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_PoseSnapshot), 2753751395U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_PoseSnapshot_h_252101397(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
