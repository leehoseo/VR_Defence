...
#include "AnimGraphRuntime/Public/AnimNodes/AnimNode_Sync.h"
...
class UScriptStruct* FAnimNode_Sync::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_Sync.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_Sync, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_Sync"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_Sync>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_Sync_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_Sync::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_Sync_Statics::NewStructOps, TEXT("AnimNode_Sync"), &Z_Registration_Info_UScriptStruct_AnimNode_Sync, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_Sync), 251868987U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_Sync_h_1126145544(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
