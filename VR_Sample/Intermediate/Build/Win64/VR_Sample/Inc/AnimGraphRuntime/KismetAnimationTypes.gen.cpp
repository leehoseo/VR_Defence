...
class UScriptStruct* FPositionHistory::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PositionHistory.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPositionHistory, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("PositionHistory"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FPositionHistory>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPositionHistory_Statics::NewProp_Positions_Inner = { "Positions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_KismetAnimationTypes_h_Statics::ScriptStructInfo[] = {
		{ FPositionHistory::StaticStruct, Z_Construct_UScriptStruct_FPositionHistory_Statics::NewStructOps, TEXT("PositionHistory"), &Z_Registration_Info_UScriptStruct_PositionHistory, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPositionHistory), 1895041095U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_KismetAnimationTypes_h_408789478(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
