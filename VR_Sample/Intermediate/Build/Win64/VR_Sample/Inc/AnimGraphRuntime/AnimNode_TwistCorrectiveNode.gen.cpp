...
class UScriptStruct* FReferenceBoneFrame::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ReferenceBoneFrame.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FReferenceBoneFrame, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("ReferenceBoneFrame"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FReferenceBoneFrame_Statics::NewProp_Axis = { "Axis", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FReferenceBoneFrame, Axis), Z_Construct_UScriptStruct_FAxis, METADATA_PARAMS(Z_Construct_UScriptStruct_FReferenceBoneFrame_Statics::NewProp_Axis_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FReferenceBoneFrame_Statics::NewProp_Axis_MetaData)) }; // 322279027
...
class UScriptStruct* FAnimNode_TwistCorrectiveNode::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_TwistCorrectiveNode.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_TwistCorrectiveNode, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_TwistCorrectiveNode"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_TwistCorrectiveNode>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BoneControllers_AnimNode_TwistCorrectiveNode_h_Statics::ScriptStructInfo[] = {
		{ FReferenceBoneFrame::StaticStruct, Z_Construct_UScriptStruct_FReferenceBoneFrame_Statics::NewStructOps, TEXT("ReferenceBoneFrame"), &Z_Registration_Info_UScriptStruct_ReferenceBoneFrame, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FReferenceBoneFrame), 252848031U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_BoneControllers_AnimNode_TwistCorrectiveNode_h_4056141461(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
