...
class UScriptStruct* FAnimNode_ResetRoot::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_ResetRoot.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_ResetRoot, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_ResetRoot"));
	}
