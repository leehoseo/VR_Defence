...
class UScriptStruct* FAnimNode_CurveSource::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_CurveSource.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_CurveSource, Z_Construct_UPackage__Script_AnimGraphRuntime(), TEXT("AnimNode_CurveSource"));
	}
...
template<> ANIMGRAPHRUNTIME_API UScriptStruct* StaticStruct<FAnimNode_CurveSource>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_SourceBinding = { "SourceBinding", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_CurveSource, SourceBinding), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_SourceBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_SourceBinding_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_Alpha = { "Alpha", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_CurveSource, Alpha), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_Alpha_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewProp_Alpha_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_CurveSource_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_CurveSource::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_CurveSource_Statics::NewStructOps, TEXT("AnimNode_CurveSource"), &Z_Registration_Info_UScriptStruct_AnimNode_CurveSource, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_CurveSource), 845035035U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimGraphRuntime_Public_AnimNodes_AnimNode_CurveSource_h_3721444717(TEXT("/Script/AnimGraphRuntime"),
		nullptr, 0,
