...
// End Cross Module References
	...
	static UEnum* ESplineModulationColorMask_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESplineModulationColorMask.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Landscape_ESplineModulationColorMask, Z_Construct_UPackage__Script_Landscape(), TEXT("ESplineModulationColorMask"));
		}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_MinimumCollisionRelevanceWeight = { "MinimumCollisionRelevanceWeight", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeLayerInfoObject, MinimumCollisionRelevanceWeight), METADATA_PARAMS(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_MinimumCollisionRelevanceWeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_MinimumCollisionRelevanceWeight_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_bNoWeightBlend = { "bNoWeightBlend", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ULandscapeLayerInfoObject), &Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_bNoWeightBlend_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_bNoWeightBlend_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_bNoWeightBlend_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_SplineFalloffModulationColorMask = { "SplineFalloffModulationColorMask", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeLayerInfoObject, SplineFalloffModulationColorMask), Z_Construct_UEnum_Landscape_ESplineModulationColorMask, METADATA_PARAMS(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_SplineFalloffModulationColorMask_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_SplineFalloffModulationColorMask_MetaData)) }; // 931231473
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_SplineFalloffModulationBias = { "SplineFalloffModulationBias", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeLayerInfoObject, SplineFalloffModulationBias), METADATA_PARAMS(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_SplineFalloffModulationBias_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_SplineFalloffModulationBias_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_SplineFalloffModulationScale = { "SplineFalloffModulationScale", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeLayerInfoObject, SplineFalloffModulationScale), METADATA_PARAMS(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_SplineFalloffModulationScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_SplineFalloffModulationScale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_LayerUsageDebugColor = { "LayerUsageDebugColor", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULandscapeLayerInfoObject, LayerUsageDebugColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_LayerUsageDebugColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULandscapeLayerInfoObject_Statics::NewProp_LayerUsageDebugColor_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeLayerInfoObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULandscapeLayerInfoObject, ULandscapeLayerInfoObject::StaticClass, TEXT("ULandscapeLayerInfoObject"), &Z_Registration_Info_UClass_ULandscapeLayerInfoObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULandscapeLayerInfoObject), 1515794341U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeLayerInfoObject_h_3240721139(TEXT("/Script/Landscape"),
