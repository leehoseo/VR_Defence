...
// End Cross Module References
	...
	static UEnum* ELandscapeGizmoType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELandscapeGizmoType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Landscape_ELandscapeGizmoType, Z_Construct_UPackage__Script_Landscape(), TEXT("ELandscapeGizmoType"));
		}
...
class UScriptStruct* FGizmoSelectData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GizmoSelectData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGizmoSelectData, Z_Construct_UPackage__Script_Landscape(), TEXT("GizmoSelectData"));
	}
...
template<> LANDSCAPE_API UScriptStruct* StaticStruct<FGizmoSelectData>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FGizmoSelectData_Statics::NewProp_Ratio = { "Ratio", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGizmoSelectData, Ratio), METADATA_PARAMS(Z_Construct_UScriptStruct_FGizmoSelectData_Statics::NewProp_Ratio_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGizmoSelectData_Statics::NewProp_Ratio_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FGizmoSelectData_Statics::NewProp_HeightData = { "HeightData", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGizmoSelectData, HeightData), METADATA_PARAMS(Z_Construct_UScriptStruct_FGizmoSelectData_Statics::NewProp_HeightData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGizmoSelectData_Statics::NewProp_HeightData_MetaData)) };
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bSnapToLandscapeGrid_MetaData[];
#endif
		static void NewProp_bSnapToLandscapeGrid_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bSnapToLandscapeGrid;
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_SampledHeight = { "SampledHeight", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALandscapeGizmoActiveActor, SampledHeight), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_SampledHeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_SampledHeight_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_SampledNormal_Inner = { "SampledNormal", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_CachedWidth = { "CachedWidth", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALandscapeGizmoActiveActor, CachedWidth), METADATA_PARAMS(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_CachedWidth_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_CachedWidth_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_CachedScaleXY = { "CachedScaleXY", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALandscapeGizmoActiveActor, CachedScaleXY), METADATA_PARAMS(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_CachedScaleXY_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_CachedScaleXY_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_GizmoMeshMaterial = { "GizmoMeshMaterial", nullptr, (EPropertyFlags)0x0014000800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALandscapeGizmoActiveActor, GizmoMeshMaterial), Z_Construct_UClass_UMaterial_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_GizmoMeshMaterial_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_GizmoMeshMaterial_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_LayerInfos_Inner = { "LayerInfos", nullptr, (EPropertyFlags)0x0004000800020000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_ULandscapeLayerInfoObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_LayerInfos = { "LayerInfos", nullptr, (EPropertyFlags)0x0014000800020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALandscapeGizmoActiveActor, LayerInfos), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_LayerInfos_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_LayerInfos_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid_MetaData[] = {
		{ "ModuleRelativePath", "Classes/LandscapeGizmoActiveActor.h" },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid = { "bSnapToLandscapeGrid", nullptr, (EPropertyFlags)0x0010000800002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ALandscapeGizmoActiveActor), &Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid_SetBit, METADATA_PARAMS(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALandscapeGizmoActiveActor_Statics::NewProp_bSnapToLandscapeGrid,
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeGizmoActiveActor_h_Statics::ScriptStructInfo[] = {
		{ FGizmoSelectData::StaticStruct, Z_Construct_UScriptStruct_FGizmoSelectData_Statics::NewStructOps, TEXT("GizmoSelectData"), &Z_Registration_Info_UScriptStruct_GizmoSelectData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGizmoSelectData), 3916499131U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeGizmoActiveActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALandscapeGizmoActiveActor, ALandscapeGizmoActiveActor::StaticClass, TEXT("ALandscapeGizmoActiveActor"), &Z_Registration_Info_UClass_ALandscapeGizmoActiveActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALandscapeGizmoActiveActor), 925394980U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_LandscapeGizmoActiveActor_h_565393375(TEXT("/Script/Landscape"),
