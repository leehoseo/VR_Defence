...
class UScriptStruct* FPhysicalMaterialInput::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PhysicalMaterialInput.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPhysicalMaterialInput, Z_Construct_UPackage__Script_Landscape(), TEXT("PhysicalMaterialInput"));
	}
...
template<> LANDSCAPE_API UScriptStruct* StaticStruct<FPhysicalMaterialInput>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPhysicalMaterialInput_Statics::NewProp_Input = { "Input", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPhysicalMaterialInput, Input), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UScriptStruct_FPhysicalMaterialInput_Statics::NewProp_Input_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicalMaterialInput_Statics::NewProp_Input_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionLandscapePhysicalMaterialOutput_Statics::NewProp_Inputs_Inner = { "Inputs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPhysicalMaterialInput, METADATA_PARAMS(nullptr, 0) }; // 653786408
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMaterialExpressionLandscapePhysicalMaterialOutput_Statics::NewProp_Inputs = { "Inputs", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionLandscapePhysicalMaterialOutput, Inputs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionLandscapePhysicalMaterialOutput_Statics::NewProp_Inputs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionLandscapePhysicalMaterialOutput_Statics::NewProp_Inputs_MetaData)) }; // 653786408
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_Materials_MaterialExpressionLandscapePhysicalMaterialOutput_h_Statics::ScriptStructInfo[] = {
		{ FPhysicalMaterialInput::StaticStruct, Z_Construct_UScriptStruct_FPhysicalMaterialInput_Statics::NewStructOps, TEXT("PhysicalMaterialInput"), &Z_Registration_Info_UScriptStruct_PhysicalMaterialInput, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPhysicalMaterialInput), 653786408U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_Materials_MaterialExpressionLandscapePhysicalMaterialOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionLandscapePhysicalMaterialOutput, UMaterialExpressionLandscapePhysicalMaterialOutput::StaticClass, TEXT("UMaterialExpressionLandscapePhysicalMaterialOutput"), &Z_Registration_Info_UClass_UMaterialExpressionLandscapePhysicalMaterialOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionLandscapePhysicalMaterialOutput), 3599438383U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_Materials_MaterialExpressionLandscapePhysicalMaterialOutput_h_2077786677(TEXT("/Script/Landscape"),
