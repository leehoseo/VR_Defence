...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AControlPointMeshActor_Statics::NewProp_ControlPointMeshComponent = { "ControlPointMeshComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AControlPointMeshActor, ControlPointMeshComponent), Z_Construct_UClass_UControlPointMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AControlPointMeshActor_Statics::NewProp_ControlPointMeshComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AControlPointMeshActor_Statics::NewProp_ControlPointMeshComponent_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_ControlPointMeshActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AControlPointMeshActor, AControlPointMeshActor::StaticClass, TEXT("AControlPointMeshActor"), &Z_Registration_Info_UClass_AControlPointMeshActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AControlPointMeshActor), 1812595389U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Landscape_Classes_ControlPointMeshActor_h_3951683403(TEXT("/Script/Landscape"),
