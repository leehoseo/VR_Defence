...
// End Cross Module References
	...
	static UEnum* ESelectionMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESelectionMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Slate_ESelectionMode, Z_Construct_UPackage__Script_Slate(), TEXT("ESelectionMode"));
		}
	...
	static UEnum* ETableViewMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETableViewMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Slate_ETableViewMode, Z_Construct_UPackage__Script_Slate(), TEXT("ETableViewMode"));
		}
