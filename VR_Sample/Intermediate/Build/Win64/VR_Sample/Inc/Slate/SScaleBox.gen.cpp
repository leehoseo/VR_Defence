...
// End Cross Module References
	...
	static UEnum* EStretchDirection_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EStretchDirection.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Slate_EStretchDirection, Z_Construct_UPackage__Script_Slate(), TEXT("EStretchDirection"));
		}
	...
	static UEnum* EStretch_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EStretch.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Slate_EStretch, Z_Construct_UPackage__Script_Slate(), TEXT("EStretch"));
		}
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_Widgets_Layout_SScaleBox_h_Statics::EnumInfo[] = {
		...
		{ EStretch_StaticEnum, TEXT("EStretch"), &Z_Registration_Info_UEnum_EStretch, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 284857949U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_Widgets_Layout_SScaleBox_h_1261663731(TEXT("/Script/Slate"),
		nullptr, 0,
		nullptr, 0,
