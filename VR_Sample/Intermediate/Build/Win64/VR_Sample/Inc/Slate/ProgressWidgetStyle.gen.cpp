...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UProgressWidgetStyle_Statics::NewProp_ProgressBarStyle = { "ProgressBarStyle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UProgressWidgetStyle, ProgressBarStyle), Z_Construct_UScriptStruct_FProgressBarStyle, METADATA_PARAMS(Z_Construct_UClass_UProgressWidgetStyle_Statics::NewProp_ProgressBarStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UProgressWidgetStyle_Statics::NewProp_ProgressBarStyle_MetaData)) }; // 3950708187
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_Framework_Styling_ProgressWidgetStyle_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UProgressWidgetStyle, UProgressWidgetStyle::StaticClass, TEXT("UProgressWidgetStyle"), &Z_Registration_Info_UClass_UProgressWidgetStyle, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UProgressWidgetStyle), 608543177U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_Framework_Styling_ProgressWidgetStyle_h_1064319733(TEXT("/Script/Slate"),
