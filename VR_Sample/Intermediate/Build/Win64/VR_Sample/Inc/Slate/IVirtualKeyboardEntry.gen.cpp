...
class UScriptStruct* FVirtualKeyboardOptions::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_VirtualKeyboardOptions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVirtualKeyboardOptions, Z_Construct_UPackage__Script_Slate(), TEXT("VirtualKeyboardOptions"));
	}
...
template<> SLATE_API UScriptStruct* StaticStruct<FVirtualKeyboardOptions>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_Widgets_Input_IVirtualKeyboardEntry_h_Statics::ScriptStructInfo[] = {
		{ FVirtualKeyboardOptions::StaticStruct, Z_Construct_UScriptStruct_FVirtualKeyboardOptions_Statics::NewStructOps, TEXT("VirtualKeyboardOptions"), &Z_Registration_Info_UScriptStruct_VirtualKeyboardOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVirtualKeyboardOptions), 568627260U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_Widgets_Input_IVirtualKeyboardEntry_h_496788680(TEXT("/Script/Slate"),
		nullptr, 0,
