...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USlateSettings_Statics::NewProp_bExplicitCanvasChildZOrder = { "bExplicitCanvasChildZOrder", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USlateSettings), &Z_Construct_UClass_USlateSettings_Statics::NewProp_bExplicitCanvasChildZOrder_SetBit, METADATA_PARAMS(Z_Construct_UClass_USlateSettings_Statics::NewProp_bExplicitCanvasChildZOrder_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlateSettings_Statics::NewProp_bExplicitCanvasChildZOrder_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_SlateSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USlateSettings, USlateSettings::StaticClass, TEXT("USlateSettings"), &Z_Registration_Info_UClass_USlateSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USlateSettings), 2276886055U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_SlateSettings_h_3626756127(TEXT("/Script/Slate"),
