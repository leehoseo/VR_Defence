...
class UScriptStruct* FAnchors::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Anchors.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnchors, Z_Construct_UPackage__Script_Slate(), TEXT("Anchors"));
	}
...
template<> SLATE_API UScriptStruct* StaticStruct<FAnchors>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnchors_Statics::NewProp_Maximum = { "Maximum", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnchors, Maximum), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnchors_Statics::NewProp_Maximum_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnchors_Statics::NewProp_Maximum_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_Widgets_Layout_Anchors_h_Statics::ScriptStructInfo[] = {
		{ FAnchors::StaticStruct, Z_Construct_UScriptStruct_FAnchors_Statics::NewStructOps, TEXT("Anchors"), &Z_Registration_Info_UScriptStruct_Anchors, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnchors), 3608874910U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Slate_Public_Widgets_Layout_Anchors_h_594148769(TEXT("/Script/Slate"),
		nullptr, 0,
