...
#include "SlateCore/Public/Styling/SegmentedControlStyle.h"
...
class UScriptStruct* FSegmentedControlStyle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SegmentedControlStyle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSegmentedControlStyle, Z_Construct_UPackage__Script_SlateCore(), TEXT("SegmentedControlStyle"));
	}
...
template<> SLATECORE_API UScriptStruct* StaticStruct<FSegmentedControlStyle>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSegmentedControlStyle_Statics::NewProp_BackgroundBrush = { "BackgroundBrush", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSegmentedControlStyle, BackgroundBrush), Z_Construct_UScriptStruct_FSlateBrush, METADATA_PARAMS(Z_Construct_UScriptStruct_FSegmentedControlStyle_Statics::NewProp_BackgroundBrush_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSegmentedControlStyle_Statics::NewProp_BackgroundBrush_MetaData)) }; // 852902259
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_SegmentedControlStyle_h_Statics::ScriptStructInfo[] = {
		{ FSegmentedControlStyle::StaticStruct, Z_Construct_UScriptStruct_FSegmentedControlStyle_Statics::NewStructOps, TEXT("SegmentedControlStyle"), &Z_Registration_Info_UScriptStruct_SegmentedControlStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSegmentedControlStyle), 3054126844U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_SegmentedControlStyle_h_3439634988(TEXT("/Script/SlateCore"),
		nullptr, 0,
