...
class UScriptStruct* FSlateSound::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SlateSound.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSlateSound, Z_Construct_UPackage__Script_SlateCore(), TEXT("SlateSound"));
	}
...
template<> SLATECORE_API UScriptStruct* StaticStruct<FSlateSound>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Sound_SlateSound_h_Statics::ScriptStructInfo[] = {
		{ FSlateSound::StaticStruct, Z_Construct_UScriptStruct_FSlateSound_Statics::NewStructOps, TEXT("SlateSound"), &Z_Registration_Info_UScriptStruct_SlateSound, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSlateSound), 759938092U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Sound_SlateSound_h_2246152832(TEXT("/Script/SlateCore"),
		nullptr, 0,
