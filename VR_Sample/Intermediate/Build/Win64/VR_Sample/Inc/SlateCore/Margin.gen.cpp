...
class UScriptStruct* FMargin::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Margin.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMargin, Z_Construct_UPackage__Script_SlateCore(), TEXT("Margin"));
	}
...
template<> SLATECORE_API UScriptStruct* StaticStruct<FMargin>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Left = { "Left", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMargin, Left), METADATA_PARAMS(Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Left_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Left_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Top = { "Top", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMargin, Top), METADATA_PARAMS(Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Top_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Top_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Right = { "Right", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMargin, Right), METADATA_PARAMS(Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Right_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Right_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Bottom = { "Bottom", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMargin, Bottom), METADATA_PARAMS(Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Bottom_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMargin_Statics::NewProp_Bottom_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Layout_Margin_h_Statics::ScriptStructInfo[] = {
		{ FMargin::StaticStruct, Z_Construct_UScriptStruct_FMargin_Statics::NewStructOps, TEXT("Margin"), &Z_Registration_Info_UScriptStruct_Margin, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMargin), 451581171U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Layout_Margin_h_368534456(TEXT("/Script/SlateCore"),
		nullptr, 0,
