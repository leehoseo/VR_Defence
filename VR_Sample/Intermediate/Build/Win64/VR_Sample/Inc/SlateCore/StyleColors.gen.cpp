...
#include "SlateCore/Public/Styling/StyleColors.h"
...
// End Cross Module References
	...
	static UEnum* EStyleColor_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EStyleColor.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SlateCore_EStyleColor, Z_Construct_UPackage__Script_SlateCore(), TEXT("EStyleColor"));
		}
...
class UScriptStruct* FStyleColorList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StyleColorList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStyleColorList, Z_Construct_UPackage__Script_SlateCore(), TEXT("StyleColorList"));
	}
...
class UScriptStruct* FStyleTheme::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StyleTheme.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStyleTheme, Z_Construct_UPackage__Script_SlateCore(), TEXT("StyleTheme"));
	}
...
template<> SLATECORE_API UScriptStruct* StaticStruct<FStyleTheme>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_StyleColors_h_Statics::ScriptStructInfo[] = {
		{ FStyleColorList::StaticStruct, Z_Construct_UScriptStruct_FStyleColorList_Statics::NewStructOps, TEXT("StyleColorList"), &Z_Registration_Info_UScriptStruct_StyleColorList, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStyleColorList), 1688348480U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_StyleColors_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USlateThemeManager, USlateThemeManager::StaticClass, TEXT("USlateThemeManager"), &Z_Registration_Info_UClass_USlateThemeManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USlateThemeManager), 499342579U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_StyleColors_h_1908765075(TEXT("/Script/SlateCore"),
