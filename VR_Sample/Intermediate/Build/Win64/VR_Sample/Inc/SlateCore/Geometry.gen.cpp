...
class UScriptStruct* FGeometry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Geometry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGeometry, Z_Construct_UPackage__Script_SlateCore(), TEXT("Geometry"));
	}
