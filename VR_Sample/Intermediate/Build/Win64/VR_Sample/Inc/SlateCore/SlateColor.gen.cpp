...
// End Cross Module References
	...
	static UEnum* ESlateColorStylingMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESlateColorStylingMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SlateCore_ESlateColorStylingMode, Z_Construct_UPackage__Script_SlateCore(), TEXT("ESlateColorStylingMode"));
		}
...
class UScriptStruct* FSlateColor::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SlateColor.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSlateColor, Z_Construct_UPackage__Script_SlateCore(), TEXT("SlateColor"));
	}
...
template<> SLATECORE_API UScriptStruct* StaticStruct<FSlateColor>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSlateColor_Statics::NewProp_SpecifiedColor = { "SpecifiedColor", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSlateColor, SpecifiedColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FSlateColor_Statics::NewProp_SpecifiedColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSlateColor_Statics::NewProp_SpecifiedColor_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSlateColor_Statics::NewProp_ColorUseRule_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_SlateColor_h_Statics::ScriptStructInfo[] = {
		{ FSlateColor::StaticStruct, Z_Construct_UScriptStruct_FSlateColor_Statics::NewStructOps, TEXT("SlateColor"), &Z_Registration_Info_UScriptStruct_SlateColor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSlateColor), 1767155899U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_SlateCore_Public_Styling_SlateColor_h_329449793(TEXT("/Script/SlateCore"),
		nullptr, 0,
