...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UAudioCurveSourceComponent_Statics::NewProp_CurveSourceBindingName = { "CurveSourceBindingName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAudioCurveSourceComponent, CurveSourceBindingName), METADATA_PARAMS(Z_Construct_UClass_UAudioCurveSourceComponent_Statics::NewProp_CurveSourceBindingName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAudioCurveSourceComponent_Statics::NewProp_CurveSourceBindingName_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAudioCurveSourceComponent_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UAudioCurveSourceComponent_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UCurveSourceInterface_NoRegister, (int32)VTABLE_OFFSET(UAudioCurveSourceComponent, ICurveSourceInterface), false },  // 2818741992
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_FacialAnimation_Source_FacialAnimation_Public_AudioCurveSourceComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioCurveSourceComponent, UAudioCurveSourceComponent::StaticClass, TEXT("UAudioCurveSourceComponent"), &Z_Registration_Info_UClass_UAudioCurveSourceComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioCurveSourceComponent), 2748091048U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Editor_FacialAnimation_Source_FacialAnimation_Public_AudioCurveSourceComponent_h_2122209179(TEXT("/Script/FacialAnimation"),
