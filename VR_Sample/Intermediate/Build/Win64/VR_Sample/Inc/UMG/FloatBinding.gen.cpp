...
// End Cross Module References
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UFloatBinding_GetValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FloatBinding_eventGetValue_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UFloatBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UFloatBinding_GetValue, "GetValue" }, // 1581014168
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_FloatBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFloatBinding, UFloatBinding::StaticClass, TEXT("UFloatBinding"), &Z_Registration_Info_UClass_UFloatBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFloatBinding), 4047709872U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_FloatBinding_h_1427730090(TEXT("/Script/UMG"),
