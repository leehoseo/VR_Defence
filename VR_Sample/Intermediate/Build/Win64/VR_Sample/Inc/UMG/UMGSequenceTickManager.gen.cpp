...
#include "UMG/Public/Animation/UMGSequenceTickManager.h"
...
class UScriptStruct* FSequenceTickManagerWidgetData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SequenceTickManagerWidgetData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSequenceTickManagerWidgetData, Z_Construct_UPackage__Script_UMG(), TEXT("SequenceTickManagerWidgetData"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FSequenceTickManagerWidgetData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUMGSequenceTickManager_Statics::NewProp_WeakUserWidgetData_ValueProp = { "WeakUserWidgetData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FSequenceTickManagerWidgetData, METADATA_PARAMS(nullptr, 0) }; // 3695919387
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UUMGSequenceTickManager_Statics::NewProp_WeakUserWidgetData_Key_KeyProp = { "WeakUserWidgetData_Key", nullptr, (EPropertyFlags)0x0004000000080000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UUMGSequenceTickManager_Statics::NewProp_WeakUserWidgetData = { "WeakUserWidgetData", nullptr, (EPropertyFlags)0x0040008000002000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGSequenceTickManager, WeakUserWidgetData), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UUMGSequenceTickManager_Statics::NewProp_WeakUserWidgetData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGSequenceTickManager_Statics::NewProp_WeakUserWidgetData_MetaData)) }; // 3695919387
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUMGSequenceTickManager_Statics::NewProp_Linker_MetaData[] = {
		{ "ModuleRelativePath", "Public/Animation/UMGSequenceTickManager.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUMGSequenceTickManager_Statics::NewProp_Linker = { "Linker", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGSequenceTickManager, Linker), Z_Construct_UClass_UMovieSceneEntitySystemLinker_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUMGSequenceTickManager_Statics::NewProp_Linker_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGSequenceTickManager_Statics::NewProp_Linker_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_UMGSequenceTickManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUMGSequenceTickManager, UUMGSequenceTickManager::StaticClass, TEXT("UUMGSequenceTickManager"), &Z_Registration_Info_UClass_UUMGSequenceTickManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUMGSequenceTickManager), 2111361630U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_UMGSequenceTickManager_h_475619806(TEXT("/Script/UMG"),
