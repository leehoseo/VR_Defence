...
class UScriptStruct* FMovieScene2DTransformMask::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieScene2DTransformMask.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieScene2DTransformMask, Z_Construct_UPackage__Script_UMG(), TEXT("MovieScene2DTransformMask"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FMovieScene2DTransformMask>()
{
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FMovieScene2DTransformMask_Statics::NewProp_Mask = { "Mask", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieScene2DTransformMask, Mask), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieScene2DTransformMask_Statics::NewProp_Mask_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScene2DTransformMask_Statics::NewProp_Mask_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieScene2DTransformSection_Statics::NewProp_TransformMask = { "TransformMask", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieScene2DTransformSection, TransformMask), Z_Construct_UScriptStruct_FMovieScene2DTransformMask, METADATA_PARAMS(Z_Construct_UClass_UMovieScene2DTransformSection_Statics::NewProp_TransformMask_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene2DTransformSection_Statics::NewProp_TransformMask_MetaData)) }; // 869777007
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieScene2DTransformSection_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieScene2DTransformSection, Rotation), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieScene2DTransformSection_Statics::NewProp_Rotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene2DTransformSection_Statics::NewProp_Rotation_MetaData)) }; // 312122321
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_MovieScene2DTransformSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieScene2DTransformSection, UMovieScene2DTransformSection::StaticClass, TEXT("UMovieScene2DTransformSection"), &Z_Registration_Info_UClass_UMovieScene2DTransformSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieScene2DTransformSection), 1567668612U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_MovieScene2DTransformSection_h_1719220834(TEXT("/Script/UMG"),
