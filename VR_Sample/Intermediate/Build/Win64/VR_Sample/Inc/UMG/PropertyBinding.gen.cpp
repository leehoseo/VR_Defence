...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPropertyBinding_Statics::NewProp_SourcePath = { "SourcePath", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyBinding, SourcePath), Z_Construct_UScriptStruct_FDynamicPropertyPath, METADATA_PARAMS(Z_Construct_UClass_UPropertyBinding_Statics::NewProp_SourcePath_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyBinding_Statics::NewProp_SourcePath_MetaData)) }; // 2842537116
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPropertyBinding_Statics::NewProp_DestinationProperty = { "DestinationProperty", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyBinding, DestinationProperty), METADATA_PARAMS(Z_Construct_UClass_UPropertyBinding_Statics::NewProp_DestinationProperty_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyBinding_Statics::NewProp_DestinationProperty_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_PropertyBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPropertyBinding, UPropertyBinding::StaticClass, TEXT("UPropertyBinding"), &Z_Registration_Info_UClass_UPropertyBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPropertyBinding), 2675203598U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_PropertyBinding_h_3440275741(TEXT("/Script/UMG"),
