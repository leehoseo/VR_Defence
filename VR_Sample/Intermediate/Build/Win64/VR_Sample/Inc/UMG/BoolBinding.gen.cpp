...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UBoolBinding_GetValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(BoolBinding_eventGetValue_Parms), &Z_Construct_UFunction_UBoolBinding_GetValue_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UBoolBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UBoolBinding_GetValue, "GetValue" }, // 524872227
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_BoolBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBoolBinding, UBoolBinding::StaticClass, TEXT("UBoolBinding"), &Z_Registration_Info_UClass_UBoolBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBoolBinding), 677652450U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_BoolBinding_h_2634141427(TEXT("/Script/UMG"),
