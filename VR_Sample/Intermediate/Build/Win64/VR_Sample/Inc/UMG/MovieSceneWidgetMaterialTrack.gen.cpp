...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMovieSceneWidgetMaterialTrack_Statics::NewProp_BrushPropertyNamePath_Inner = { "BrushPropertyNamePath", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMovieSceneWidgetMaterialTrack_Statics::NewProp_TrackName = { "TrackName", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneWidgetMaterialTrack, TrackName), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneWidgetMaterialTrack_Statics::NewProp_TrackName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneWidgetMaterialTrack_Statics::NewProp_TrackName_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneWidgetMaterialTrack_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneWidgetMaterialTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneWidgetMaterialTrack, IMovieSceneTrackTemplateProducer), false },  // 2931163055
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_MovieSceneWidgetMaterialTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneWidgetMaterialTrack, UMovieSceneWidgetMaterialTrack::StaticClass, TEXT("UMovieSceneWidgetMaterialTrack"), &Z_Registration_Info_UClass_UMovieSceneWidgetMaterialTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneWidgetMaterialTrack), 704917224U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_MovieSceneWidgetMaterialTrack_h_1280149145(TEXT("/Script/UMG"),
