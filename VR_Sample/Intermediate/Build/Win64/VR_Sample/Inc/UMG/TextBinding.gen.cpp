...
// End Cross Module References
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UTextBinding_GetStringValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(TextBinding_eventGetStringValue_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UTextBinding_GetTextValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(TextBinding_eventGetTextValue_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTextBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTextBinding_GetStringValue, "GetStringValue" }, // 3004287133
		{ &Z_Construct_UFunction_UTextBinding_GetTextValue, "GetTextValue" }, // 1405748033
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_TextBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTextBinding, UTextBinding::StaticClass, TEXT("UTextBinding"), &Z_Registration_Info_UClass_UTextBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTextBinding), 2569349853U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_TextBinding_h_26041697(TEXT("/Script/UMG"),
