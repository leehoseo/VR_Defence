...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UColorBinding_GetLinearValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ColorBinding_eventGetLinearValue_Parms, ReturnValue), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UColorBinding_GetSlateValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ColorBinding_eventGetSlateValue_Parms, ReturnValue), Z_Construct_UScriptStruct_FSlateColor, METADATA_PARAMS(nullptr, 0) }; // 1767155899
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UColorBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UColorBinding_GetLinearValue, "GetLinearValue" }, // 2852834201
		{ &Z_Construct_UFunction_UColorBinding_GetSlateValue, "GetSlateValue" }, // 1655171490
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_ColorBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UColorBinding, UColorBinding::StaticClass, TEXT("UColorBinding"), &Z_Registration_Info_UClass_UColorBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UColorBinding), 2840031150U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_ColorBinding_h_2920429912(TEXT("/Script/UMG"),
