...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UThrobber_SetAnimateHorizontally_Statics::NewProp_bInAnimateHorizontally = { "bInAnimateHorizontally", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Throbber_eventSetAnimateHorizontally_Parms), &Z_Construct_UFunction_UThrobber_SetAnimateHorizontally_Statics::NewProp_bInAnimateHorizontally_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UThrobber_SetAnimateOpacity_Statics::NewProp_bInAnimateOpacity = { "bInAnimateOpacity", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Throbber_eventSetAnimateOpacity_Parms), &Z_Construct_UFunction_UThrobber_SetAnimateOpacity_Statics::NewProp_bInAnimateOpacity_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UThrobber_SetNumberOfPieces_Statics::NewProp_InNumberOfPieces = { "InNumberOfPieces", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Throbber_eventSetNumberOfPieces_Parms, InNumberOfPieces), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UThrobber_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UThrobber_SetAnimateHorizontally, "SetAnimateHorizontally" }, // 1466226382
		{ &Z_Construct_UFunction_UThrobber_SetAnimateOpacity, "SetAnimateOpacity" }, // 2238817848
		{ &Z_Construct_UFunction_UThrobber_SetAnimateVertically, "SetAnimateVertically" }, // 1631493413
		{ &Z_Construct_UFunction_UThrobber_SetNumberOfPieces, "SetNumberOfPieces" }, // 1794389400
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UThrobber_Statics::NewProp_NumberOfPieces = { "NumberOfPieces", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UThrobber, NumberOfPieces), METADATA_PARAMS(Z_Construct_UClass_UThrobber_Statics::NewProp_NumberOfPieces_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UThrobber_Statics::NewProp_NumberOfPieces_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateHorizontally = { "bAnimateHorizontally", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UThrobber), &Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateHorizontally_SetBit, METADATA_PARAMS(Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateHorizontally_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateHorizontally_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateVertically = { "bAnimateVertically", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UThrobber), &Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateVertically_SetBit, METADATA_PARAMS(Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateVertically_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateVertically_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateOpacity = { "bAnimateOpacity", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UThrobber), &Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateOpacity_SetBit, METADATA_PARAMS(Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateOpacity_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UThrobber_Statics::NewProp_bAnimateOpacity_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UThrobber_Statics::NewProp_PieceImage_MetaData[] = {
		{ "Comment", "/** Image to use for each segment of the throbber */" },
		{ "ModuleRelativePath", "Public/Components/Throbber.h" },
		{ "ToolTip", "Image to use for each segment of the throbber" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UThrobber_Statics::NewProp_PieceImage = { "PieceImage", nullptr, (EPropertyFlags)0x0014000020000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UThrobber, PieceImage_DEPRECATED), Z_Construct_UClass_USlateBrushAsset_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UThrobber_Statics::NewProp_PieceImage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UThrobber_Statics::NewProp_PieceImage_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UThrobber_Statics::NewProp_Image = { "Image", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UThrobber, Image), Z_Construct_UScriptStruct_FSlateBrush, METADATA_PARAMS(Z_Construct_UClass_UThrobber_Statics::NewProp_Image_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UThrobber_Statics::NewProp_Image_MetaData)) }; // 852902259
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UThrobber_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UThrobber_Statics::NewProp_PieceImage,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_Throbber_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UThrobber, UThrobber::StaticClass, TEXT("UThrobber"), &Z_Registration_Info_UClass_UThrobber, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UThrobber), 690086930U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_Throbber_h_1154651687(TEXT("/Script/UMG"),
