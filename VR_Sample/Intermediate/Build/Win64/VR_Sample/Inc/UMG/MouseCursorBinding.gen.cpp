...
// End Cross Module References
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UMouseCursorBinding_GetValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MouseCursorBinding_eventGetValue_Parms, ReturnValue), Z_Construct_UEnum_CoreUObject_EMouseCursor, METADATA_PARAMS(nullptr, 0) }; // 396763658
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMouseCursorBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMouseCursorBinding_GetValue, "GetValue" }, // 1694170240
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_MouseCursorBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMouseCursorBinding, UMouseCursorBinding::StaticClass, TEXT("UMouseCursorBinding"), &Z_Registration_Info_UClass_UMouseCursorBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMouseCursorBinding), 331601338U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_MouseCursorBinding_h_3012333966(TEXT("/Script/UMG"),
