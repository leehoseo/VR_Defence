...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UWidgetBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UWidgetBinding_GetValue, "GetValue" }, // 2140600236
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_WidgetBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWidgetBinding, UWidgetBinding::StaticClass, TEXT("UWidgetBinding"), &Z_Registration_Info_UClass_UWidgetBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWidgetBinding), 1935468361U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_WidgetBinding_h_205096050(TEXT("/Script/UMG"),
