...
class UScriptStruct* FUserWidgetPool::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_UserWidgetPool.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUserWidgetPool, Z_Construct_UPackage__Script_UMG(), TEXT("UserWidgetPool"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FUserWidgetPool>()
{
	...
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUserWidgetPool_Statics::NewProp_ActiveWidgets_Inner = { "ActiveWidgets", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FUserWidgetPool_Statics::NewProp_ActiveWidgets = { "ActiveWidgets", nullptr, (EPropertyFlags)0x0044008000002008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FUserWidgetPool, ActiveWidgets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FUserWidgetPool_Statics::NewProp_ActiveWidgets_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUserWidgetPool_Statics::NewProp_ActiveWidgets_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FUserWidgetPool_Statics::NewProp_InactiveWidgets_Inner = { "InactiveWidgets", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_UserWidgetPool_h_Statics::ScriptStructInfo[] = {
		{ FUserWidgetPool::StaticStruct, Z_Construct_UScriptStruct_FUserWidgetPool_Statics::NewStructOps, TEXT("UserWidgetPool"), &Z_Registration_Info_UScriptStruct_UserWidgetPool, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUserWidgetPool), 1309823222U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_UserWidgetPool_h_1711560121(TEXT("/Script/UMG"),
		nullptr, 0,
