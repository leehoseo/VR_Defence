...
// End Cross Module References
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UUMGSequencePlayer_GetUserTag_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMGSequencePlayer_eventGetUserTag_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UUMGSequencePlayer_SetUserTag_Statics::NewProp_InUserTag = { "InUserTag", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMGSequencePlayer_eventSetUserTag_Parms, InUserTag), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UUMGSequencePlayer_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUMGSequencePlayer_GetUserTag, "GetUserTag" }, // 617007819
		{ &Z_Construct_UFunction_UUMGSequencePlayer_SetUserTag, "SetUserTag" }, // 2417611278
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUMGSequencePlayer_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUMGSequencePlayer, Animation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUMGSequencePlayer_Statics::NewProp_Animation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUMGSequencePlayer_Statics::NewProp_Animation_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_UMGSequencePlayer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUMGSequencePlayer, UUMGSequencePlayer::StaticClass, TEXT("UUMGSequencePlayer"), &Z_Registration_Info_UClass_UUMGSequencePlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUMGSequencePlayer), 3504079308U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_UMGSequencePlayer_h_33399709(TEXT("/Script/UMG"),
