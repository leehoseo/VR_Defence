...
// End Cross Module References
	...
	static UEnum* ESlateVisibility_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESlateVisibility.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UMG_ESlateVisibility, Z_Construct_UPackage__Script_UMG(), TEXT("ESlateVisibility"));
		}
	...
	static UEnum* ESlateAccessibleBehavior_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESlateAccessibleBehavior.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UMG_ESlateAccessibleBehavior, Z_Construct_UPackage__Script_UMG(), TEXT("ESlateAccessibleBehavior"));
		}
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UDelegateFunction_USlateAccessibleWidgetData_GetText__DelegateSignature_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SlateAccessibleWidgetData_eventGetText_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USlateAccessibleWidgetData_Statics::FuncInfo[] = {
		{ &Z_Construct_UDelegateFunction_USlateAccessibleWidgetData_GetText__DelegateSignature, "GetText__DelegateSignature" }, // 3655856821
	};
#endif //WITH_EDITOR
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_bCanChildrenBeAccessible = { "bCanChildrenBeAccessible", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USlateAccessibleWidgetData), &Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_bCanChildrenBeAccessible_SetBit, METADATA_PARAMS(Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_bCanChildrenBeAccessible_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_bCanChildrenBeAccessible_MetaData)) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleBehavior = { "AccessibleBehavior", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USlateAccessibleWidgetData, AccessibleBehavior), Z_Construct_UEnum_UMG_ESlateAccessibleBehavior, METADATA_PARAMS(Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleBehavior_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleBehavior_MetaData)) }; // 1191359995
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleSummaryBehavior_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleSummaryBehavior = { "AccessibleSummaryBehavior", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USlateAccessibleWidgetData, AccessibleSummaryBehavior), Z_Construct_UEnum_UMG_ESlateAccessibleBehavior, METADATA_PARAMS(Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleSummaryBehavior_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleSummaryBehavior_MetaData)) }; // 1191359995
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleText = { "AccessibleText", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USlateAccessibleWidgetData, AccessibleText), METADATA_PARAMS(Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleText_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleSummaryText = { "AccessibleSummaryText", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USlateAccessibleWidgetData, AccessibleSummaryText), METADATA_PARAMS(Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleSummaryText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USlateAccessibleWidgetData_Statics::NewProp_AccessibleSummaryText_MetaData)) };
#if WITH_METADATA
	...
	static UEnum* ESlateSizeRule_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESlateSizeRule.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UMG_ESlateSizeRule, Z_Construct_UPackage__Script_UMG(), TEXT("ESlateSizeRule"));
		}
...
class UScriptStruct* FEventReply::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EventReply.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEventReply, Z_Construct_UPackage__Script_UMG(), TEXT("EventReply"));
	}
...
class UScriptStruct* FSlateChildSize::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SlateChildSize.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSlateChildSize, Z_Construct_UPackage__Script_UMG(), TEXT("SlateChildSize"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FSlateChildSize>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSlateChildSize_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSlateChildSize, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FSlateChildSize_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSlateChildSize_Statics::NewProp_Value_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSlateChildSize_Statics::NewProp_SizeRule = { "SizeRule", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSlateChildSize, SizeRule), Z_Construct_UEnum_UMG_ESlateSizeRule, METADATA_PARAMS(Z_Construct_UScriptStruct_FSlateChildSize_Statics::NewProp_SizeRule_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSlateChildSize_Statics::NewProp_SizeRule_MetaData)) }; // 1349209407
	...
	static UEnum* EVirtualKeyboardType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EVirtualKeyboardType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UMG_EVirtualKeyboardType, Z_Construct_UPackage__Script_UMG(), TEXT("EVirtualKeyboardType"));
		}
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_SlateWrapperTypes_h_Statics::ScriptStructInfo[] = {
		...
		{ FSlateChildSize::StaticStruct, Z_Construct_UScriptStruct_FSlateChildSize_Statics::NewStructOps, TEXT("SlateChildSize"), &Z_Registration_Info_UScriptStruct_SlateChildSize, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSlateChildSize), 3750423179U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_SlateWrapperTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USlateAccessibleWidgetData, USlateAccessibleWidgetData::StaticClass, TEXT("USlateAccessibleWidgetData"), &Z_Registration_Info_UClass_USlateAccessibleWidgetData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USlateAccessibleWidgetData), 59649615U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_SlateWrapperTypes_h_1061239341(TEXT("/Script/UMG"),
