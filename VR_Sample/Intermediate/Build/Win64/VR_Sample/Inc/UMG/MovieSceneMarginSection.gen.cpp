...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_TopCurve = { "TopCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneMarginSection, TopCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_TopCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_TopCurve_MetaData)) }; // 312122321
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_LeftCurve = { "LeftCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneMarginSection, LeftCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_LeftCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_LeftCurve_MetaData)) }; // 312122321
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_RightCurve = { "RightCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneMarginSection, RightCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_RightCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_RightCurve_MetaData)) }; // 312122321
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_BottomCurve = { "BottomCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneMarginSection, BottomCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_BottomCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneMarginSection_Statics::NewProp_BottomCurve_MetaData)) }; // 312122321
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_MovieSceneMarginSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneMarginSection, UMovieSceneMarginSection::StaticClass, TEXT("UMovieSceneMarginSection"), &Z_Registration_Info_UClass_UMovieSceneMarginSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneMarginSection), 1862100117U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_MovieSceneMarginSection_h_3049747015(TEXT("/Script/UMG"),
