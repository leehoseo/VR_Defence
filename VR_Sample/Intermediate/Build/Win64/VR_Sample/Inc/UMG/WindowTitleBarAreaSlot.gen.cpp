...
// End Cross Module References
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UWindowTitleBarAreaSlot_SetHorizontalAlignment_Statics::NewProp_InHorizontalAlignment = { "InHorizontalAlignment", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(WindowTitleBarAreaSlot_eventSetHorizontalAlignment_Parms, InHorizontalAlignment), Z_Construct_UEnum_SlateCore_EHorizontalAlignment, METADATA_PARAMS(nullptr, 0) }; // 4247529014
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UWindowTitleBarAreaSlot_SetPadding_Statics::NewProp_InPadding = { "InPadding", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(WindowTitleBarAreaSlot_eventSetPadding_Parms, InPadding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(nullptr, 0) }; // 451581171
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UWindowTitleBarAreaSlot_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UWindowTitleBarAreaSlot_SetHorizontalAlignment, "SetHorizontalAlignment" }, // 3118413918
		{ &Z_Construct_UFunction_UWindowTitleBarAreaSlot_SetPadding, "SetPadding" }, // 631330802
		{ &Z_Construct_UFunction_UWindowTitleBarAreaSlot_SetVerticalAlignment, "SetVerticalAlignment" }, // 4125979174
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWindowTitleBarAreaSlot_Statics::NewProp_Padding = { "Padding", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWindowTitleBarAreaSlot, Padding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(Z_Construct_UClass_UWindowTitleBarAreaSlot_Statics::NewProp_Padding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWindowTitleBarAreaSlot_Statics::NewProp_Padding_MetaData)) }; // 451581171
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_WindowTitleBarAreaSlot_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWindowTitleBarAreaSlot, UWindowTitleBarAreaSlot::StaticClass, TEXT("UWindowTitleBarAreaSlot"), &Z_Registration_Info_UClass_UWindowTitleBarAreaSlot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWindowTitleBarAreaSlot), 1623442631U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_WindowTitleBarAreaSlot_h_4028121693(TEXT("/Script/UMG"),
