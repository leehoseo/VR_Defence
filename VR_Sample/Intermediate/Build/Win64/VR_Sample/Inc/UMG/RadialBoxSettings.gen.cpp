...
class UScriptStruct* FRadialBoxSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RadialBoxSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRadialBoxSettings, Z_Construct_UPackage__Script_UMG(), TEXT("RadialBoxSettings"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FRadialBoxSettings>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRadialBoxSettings_Statics::NewProp_bDistributeItemsEvenly = { "bDistributeItemsEvenly", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRadialBoxSettings), &Z_Construct_UScriptStruct_FRadialBoxSettings_Statics::NewProp_bDistributeItemsEvenly_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRadialBoxSettings_Statics::NewProp_bDistributeItemsEvenly_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRadialBoxSettings_Statics::NewProp_bDistributeItemsEvenly_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_RadialBoxSettings_h_Statics::ScriptStructInfo[] = {
		{ FRadialBoxSettings::StaticStruct, Z_Construct_UScriptStruct_FRadialBoxSettings_Statics::NewStructOps, TEXT("RadialBoxSettings"), &Z_Registration_Info_UScriptStruct_RadialBoxSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRadialBoxSettings), 210441176U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_RadialBoxSettings_h_3561278375(TEXT("/Script/UMG"),
		nullptr, 0,
