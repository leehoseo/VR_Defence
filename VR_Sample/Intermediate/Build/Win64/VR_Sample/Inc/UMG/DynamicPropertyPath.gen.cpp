...
class UScriptStruct* FDynamicPropertyPath::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DynamicPropertyPath.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDynamicPropertyPath, Z_Construct_UPackage__Script_UMG(), TEXT("DynamicPropertyPath"));
	}
