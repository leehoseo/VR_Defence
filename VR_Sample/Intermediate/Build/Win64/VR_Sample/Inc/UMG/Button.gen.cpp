...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UButton_IsPressed_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Button_eventIsPressed_Parms), &Z_Construct_UFunction_UButton_IsPressed_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UButton_SetBackgroundColor_Statics::NewProp_InBackgroundColor = { "InBackgroundColor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Button_eventSetBackgroundColor_Parms, InBackgroundColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UButton_SetClickMethod_Statics::NewProp_InClickMethod = { "InClickMethod", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Button_eventSetClickMethod_Parms, InClickMethod), Z_Construct_UEnum_SlateCore_EButtonClickMethod, METADATA_PARAMS(nullptr, 0) }; // 4238010345
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UButton_SetColorAndOpacity_Statics::NewProp_InColorAndOpacity = { "InColorAndOpacity", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Button_eventSetColorAndOpacity_Parms, InColorAndOpacity), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UButton_SetPressMethod_Statics::NewProp_InPressMethod = { "InPressMethod", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Button_eventSetPressMethod_Parms, InPressMethod), Z_Construct_UEnum_SlateCore_EButtonPressMethod, METADATA_PARAMS(nullptr, 0) }; // 73978870
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UButton_SetStyle_Statics::NewProp_InStyle = { "InStyle", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Button_eventSetStyle_Parms, InStyle), Z_Construct_UScriptStruct_FButtonStyle, METADATA_PARAMS(Z_Construct_UFunction_UButton_SetStyle_Statics::NewProp_InStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UButton_SetStyle_Statics::NewProp_InStyle_MetaData)) }; // 2266899118
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UButton_SetTouchMethod_Statics::NewProp_InTouchMethod = { "InTouchMethod", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Button_eventSetTouchMethod_Parms, InTouchMethod), Z_Construct_UEnum_SlateCore_EButtonTouchMethod, METADATA_PARAMS(nullptr, 0) }; // 922219495
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UButton_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UButton_IsPressed, "IsPressed" }, // 3684659729
		{ &Z_Construct_UFunction_UButton_SetBackgroundColor, "SetBackgroundColor" }, // 4162631292
		{ &Z_Construct_UFunction_UButton_SetClickMethod, "SetClickMethod" }, // 4287230149
		{ &Z_Construct_UFunction_UButton_SetColorAndOpacity, "SetColorAndOpacity" }, // 3861959668
		{ &Z_Construct_UFunction_UButton_SetPressMethod, "SetPressMethod" }, // 3473940533
		{ &Z_Construct_UFunction_UButton_SetStyle, "SetStyle" }, // 386198865
		{ &Z_Construct_UFunction_UButton_SetTouchMethod, "SetTouchMethod" }, // 4098213653
	};
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UButton_Statics::NewProp_Style_MetaData[] = {
		{ "Comment", "/** The template style asset, used to seed the mutable instance of the style. */" },
		{ "ModuleRelativePath", "Public/Components/Button.h" },
		{ "ToolTip", "The template style asset, used to seed the mutable instance of the style." },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UButton_Statics::NewProp_Style = { "Style", nullptr, (EPropertyFlags)0x0014000020000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, Style_DEPRECATED), Z_Construct_UClass_USlateWidgetStyleAsset_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_Style_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_Style_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UButton_Statics::NewProp_WidgetStyle = { "WidgetStyle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, WidgetStyle), Z_Construct_UScriptStruct_FButtonStyle, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_WidgetStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_WidgetStyle_MetaData)) }; // 2266899118
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UButton_Statics::NewProp_ColorAndOpacity = { "ColorAndOpacity", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, ColorAndOpacity), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_ColorAndOpacity_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_ColorAndOpacity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UButton_Statics::NewProp_BackgroundColor = { "BackgroundColor", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, BackgroundColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_BackgroundColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_BackgroundColor_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UButton_Statics::NewProp_ClickMethod = { "ClickMethod", nullptr, (EPropertyFlags)0x0010040000000015, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, ClickMethod), Z_Construct_UEnum_SlateCore_EButtonClickMethod, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_ClickMethod_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_ClickMethod_MetaData)) }; // 4238010345
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UButton_Statics::NewProp_TouchMethod = { "TouchMethod", nullptr, (EPropertyFlags)0x0010040000000015, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, TouchMethod), Z_Construct_UEnum_SlateCore_EButtonTouchMethod, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_TouchMethod_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_TouchMethod_MetaData)) }; // 922219495
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UButton_Statics::NewProp_PressMethod = { "PressMethod", nullptr, (EPropertyFlags)0x0010040000000015, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, PressMethod), Z_Construct_UEnum_SlateCore_EButtonPressMethod, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_PressMethod_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_PressMethod_MetaData)) }; // 73978870
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UButton_Statics::NewProp_IsFocusable = { "IsFocusable", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UButton), &Z_Construct_UClass_UButton_Statics::NewProp_IsFocusable_SetBit, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_IsFocusable_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_IsFocusable_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UButton_Statics::NewProp_OnClicked = { "OnClicked", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, OnClicked), Z_Construct_UDelegateFunction_UMG_OnButtonClickedEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_OnClicked_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_OnClicked_MetaData)) }; // 2358670591
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UButton_Statics::NewProp_OnPressed = { "OnPressed", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, OnPressed), Z_Construct_UDelegateFunction_UMG_OnButtonPressedEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_OnPressed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_OnPressed_MetaData)) }; // 454992865
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UButton_Statics::NewProp_OnReleased = { "OnReleased", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, OnReleased), Z_Construct_UDelegateFunction_UMG_OnButtonReleasedEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_OnReleased_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_OnReleased_MetaData)) }; // 2577069928
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UButton_Statics::NewProp_OnHovered = { "OnHovered", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, OnHovered), Z_Construct_UDelegateFunction_UMG_OnButtonHoverEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_OnHovered_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_OnHovered_MetaData)) }; // 2150841518
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UButton_Statics::NewProp_OnUnhovered = { "OnUnhovered", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UButton, OnUnhovered), Z_Construct_UDelegateFunction_UMG_OnButtonHoverEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UButton_Statics::NewProp_OnUnhovered_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UButton_Statics::NewProp_OnUnhovered_MetaData)) }; // 2150841518
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UButton_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UButton_Statics::NewProp_Style,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_Button_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UButton, UButton::StaticClass, TEXT("UButton"), &Z_Registration_Info_UClass_UButton, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UButton), 2393051342U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_Button_h_2211855585(TEXT("/Script/UMG"),
