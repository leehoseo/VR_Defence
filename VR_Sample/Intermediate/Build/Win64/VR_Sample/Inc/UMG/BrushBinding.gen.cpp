...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UBrushBinding_GetValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(BrushBinding_eventGetValue_Parms, ReturnValue), Z_Construct_UScriptStruct_FSlateBrush, METADATA_PARAMS(nullptr, 0) }; // 852902259
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UBrushBinding_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UBrushBinding_GetValue, "GetValue" }, // 694926309
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_BrushBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBrushBinding, UBrushBinding::StaticClass, TEXT("UBrushBinding"), &Z_Registration_Info_UClass_UBrushBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBrushBinding), 334827870U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Binding_BrushBinding_h_468733014(TEXT("/Script/UMG"),
