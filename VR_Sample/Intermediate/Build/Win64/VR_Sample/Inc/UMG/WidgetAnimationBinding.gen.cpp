...
class UScriptStruct* FWidgetAnimationBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WidgetAnimationBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWidgetAnimationBinding, Z_Construct_UPackage__Script_UMG(), TEXT("WidgetAnimationBinding"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FWidgetAnimationBinding>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_WidgetName = { "WidgetName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWidgetAnimationBinding, WidgetName), METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_WidgetName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_WidgetName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_SlotWidgetName = { "SlotWidgetName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWidgetAnimationBinding, SlotWidgetName), METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_SlotWidgetName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_SlotWidgetName_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_bIsRootWidget = { "bIsRootWidget", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FWidgetAnimationBinding), &Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_bIsRootWidget_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_bIsRootWidget_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewProp_bIsRootWidget_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_WidgetAnimationBinding_h_Statics::ScriptStructInfo[] = {
		{ FWidgetAnimationBinding::StaticStruct, Z_Construct_UScriptStruct_FWidgetAnimationBinding_Statics::NewStructOps, TEXT("WidgetAnimationBinding"), &Z_Registration_Info_UScriptStruct_WidgetAnimationBinding, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWidgetAnimationBinding), 80294032U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Animation_WidgetAnimationBinding_h_1870878810(TEXT("/Script/UMG"),
		nullptr, 0,
