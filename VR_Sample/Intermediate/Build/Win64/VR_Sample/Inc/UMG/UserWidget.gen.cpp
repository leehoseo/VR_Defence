...
// End Cross Module References
	...
	static UEnum* EWidgetTickFrequency_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWidgetTickFrequency.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UMG_EWidgetTickFrequency, Z_Construct_UPackage__Script_UMG(), TEXT("EWidgetTickFrequency"));
		}
	...
	static UEnum* EWidgetAnimationEvent_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWidgetAnimationEvent.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UMG_EWidgetAnimationEvent, Z_Construct_UPackage__Script_UMG(), TEXT("EWidgetAnimationEvent"));
		}
...
class UScriptStruct* FAnimationEventBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimationEventBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimationEventBinding, Z_Construct_UPackage__Script_UMG(), TEXT("AnimationEventBinding"));
	}
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimationEventBinding, Animation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewProp_Animation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewProp_Animation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewProp_Delegate = { "Delegate", nullptr, (EPropertyFlags)0x0010000000080000, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimationEventBinding, Delegate), Z_Construct_UDelegateFunction_UMG_WidgetAnimationDynamicEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewProp_Delegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewProp_Delegate_MetaData)) }; // 3582295326
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewProp_AnimationEvent_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewProp_AnimationEvent = { "AnimationEvent", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimationEventBinding, AnimationEvent), Z_Construct_UEnum_UMG_EWidgetAnimationEvent, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewProp_AnimationEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewProp_AnimationEvent_MetaData)) }; // 1444873952
#if WITH_METADATA
...
class UScriptStruct* FPaintContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PaintContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPaintContext, Z_Construct_UPackage__Script_UMG(), TEXT("PaintContext"));
	}
...
class UScriptStruct* FNamedSlotBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NamedSlotBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNamedSlotBinding, Z_Construct_UPackage__Script_UMG(), TEXT("NamedSlotBinding"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FNamedSlotBinding>()
{
	...
	static UEnum* EUMGSequencePlayMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EUMGSequencePlayMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UMG_EUMGSequencePlayMode, Z_Construct_UPackage__Script_UMG(), TEXT("EUMGSequencePlayMode"));
		}
	...
	static UEnum* EDesignPreviewSizeMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EDesignPreviewSizeMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_UMG_EDesignPreviewSizeMode, Z_Construct_UPackage__Script_UMG(), TEXT("EDesignPreviewSizeMode"));
		}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_UMG_OnConstructEvent__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//TODO UMG If you want to host a widget that's full screen there may need to be a SWindow equivalent that you spawn it into.\n" },
		{ "ModuleRelativePath", "Public/Blueprint/UserWidget.h" },
		{ "ToolTip", "TODO UMG If you want to host a widget that's full screen there may need to be a SWindow equivalent that you spawn it into." },
	};
#endif
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UDelegateFunction_UMG_OnVisibilityChangedEvent__DelegateSignature_Statics::NewProp_InVisibility = { "InVisibility", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_UMG_eventOnVisibilityChangedEvent_Parms, InVisibility), Z_Construct_UEnum_UMG_ESlateVisibility, METADATA_PARAMS(nullptr, 0) }; // 2244982430
	...
	DEFINE_FUNCTION(UUserWidget::execIsInViewport)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	void UUserWidget::StaticRegisterNativesUUserWidget()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "IsInViewport", &UUserWidget::execIsInViewport },
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UUserWidget_AddToPlayerScreen_Statics::NewProp_ZOrder = { "ZOrder", nullptr, (EPropertyFlags)0x0010040000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventAddToPlayerScreen_Parms, ZOrder), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_AddToPlayerScreen_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventAddToPlayerScreen_Parms), &Z_Construct_UFunction_UUserWidget_AddToPlayerScreen_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_BindToAnimationEvent_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventBindToAnimationEvent_Parms, Animation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UUserWidget_BindToAnimationEvent_Statics::NewProp_Delegate = { "Delegate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventBindToAnimationEvent_Parms, Delegate), Z_Construct_UDelegateFunction_UMG_WidgetAnimationDynamicEvent__DelegateSignature, METADATA_PARAMS(nullptr, 0) }; // 3582295326
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UUserWidget_BindToAnimationEvent_Statics::NewProp_AnimationEvent = { "AnimationEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventBindToAnimationEvent_Parms, AnimationEvent), Z_Construct_UEnum_UMG_EWidgetAnimationEvent, METADATA_PARAMS(nullptr, 0) }; // 1444873952
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UUserWidget_BindToAnimationEvent_Statics::NewProp_UserTag = { "UserTag", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventBindToAnimationEvent_Parms, UserTag), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_BindToAnimationFinished_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventBindToAnimationFinished_Parms, Animation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UUserWidget_BindToAnimationFinished_Statics::NewProp_Delegate = { "Delegate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventBindToAnimationFinished_Parms, Delegate), Z_Construct_UDelegateFunction_UMG_WidgetAnimationDynamicEvent__DelegateSignature, METADATA_PARAMS(nullptr, 0) }; // 3582295326
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_BindToAnimationStarted_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventBindToAnimationStarted_Parms, Animation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UUserWidget_BindToAnimationStarted_Statics::NewProp_Delegate = { "Delegate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventBindToAnimationStarted_Parms, Delegate), Z_Construct_UDelegateFunction_UMG_WidgetAnimationDynamicEvent__DelegateSignature, METADATA_PARAMS(nullptr, 0) }; // 3582295326
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_GetAlignmentInViewport_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventGetAlignmentInViewport_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_GetAnchorsInViewport_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventGetAnchorsInViewport_Parms, ReturnValue), Z_Construct_UScriptStruct_FAnchors, METADATA_PARAMS(nullptr, 0) }; // 3608874910
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_GetIsVisible_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventGetIsVisible_Parms), &Z_Construct_UFunction_UUserWidget_GetIsVisible_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_GetOwningPlayerCameraManager_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventGetOwningPlayerCameraManager_Parms, ReturnValue), Z_Construct_UClass_APlayerCameraManager_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_GetOwningPlayerPawn_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventGetOwningPlayerPawn_Parms, ReturnValue), Z_Construct_UClass_APawn_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_IsAnimationPlaying_Statics::NewProp_InAnimation = { "InAnimation", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventIsAnimationPlaying_Parms, InAnimation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_IsAnimationPlaying_Statics::NewProp_InAnimation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_IsAnimationPlaying_Statics::NewProp_InAnimation_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_IsAnimationPlaying_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventIsAnimationPlaying_Parms), &Z_Construct_UFunction_UUserWidget_IsAnimationPlaying_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_IsAnimationPlayingForward_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventIsAnimationPlayingForward_Parms), &Z_Construct_UFunction_UUserWidget_IsAnimationPlayingForward_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_IsAnyAnimationPlaying_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventIsAnyAnimationPlaying_Parms), &Z_Construct_UFunction_UUserWidget_IsAnyAnimationPlaying_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_IsInteractable_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventIsInteractable_Parms), &Z_Construct_UFunction_UUserWidget_IsInteractable_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	struct Z_Construct_UFunction_UUserWidget_IsInViewport_Statics
	{
	...
	void Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::NewProp_ReturnValue_SetBit(void* Obj)
	{
		((UserWidget_eventIsInViewport_Parms*)Obj)->ReturnValue = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventIsInViewport_Parms), &Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::Function_MetaDataParams[] = {
		{ "Category", "Appearance" },
		{ "Comment", "/* @return true if the widget was added to the viewport using AddToViewport. */" },
		{ "ModuleRelativePath", "Public/Blueprint/UserWidget.h" },
		{ "ToolTip", "@return true if the widget was added to the viewport using AddToViewport." },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UUserWidget, nullptr, "IsInViewport", nullptr, nullptr, sizeof(Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::UserWidget_eventIsInViewport_Parms), Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020409, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UUserWidget_IsInViewport()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UUserWidget_IsInViewport_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UUserWidget_IsListeningForInputAction_Statics::NewProp_ActionName = { "ActionName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventIsListeningForInputAction_Parms, ActionName), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_IsListeningForInputAction_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventIsListeningForInputAction_Parms), &Z_Construct_UFunction_UUserWidget_IsListeningForInputAction_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_IsPlayingAnimation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventIsPlayingAnimation_Parms), &Z_Construct_UFunction_UUserWidget_IsPlayingAnimation_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UUserWidget_ListenForInputAction_Statics::NewProp_ActionName = { "ActionName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventListenForInputAction_Parms, ActionName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UUserWidget_ListenForInputAction_Statics::NewProp_EventType = { "EventType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventListenForInputAction_Parms, EventType), Z_Construct_UEnum_Engine_EInputEvent, METADATA_PARAMS(nullptr, 0) }; // 1054153585
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnAddedToFocusPath_Statics::NewProp_InFocusEvent = { "InFocusEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnAddedToFocusPath_Parms, InFocusEvent), Z_Construct_UScriptStruct_FFocusEvent, METADATA_PARAMS(nullptr, 0) }; // 1366461117
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnAnalogValueChanged_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnAnalogValueChanged_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnAnalogValueChanged_Statics::NewProp_InAnalogInputEvent = { "InAnalogInputEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnAnalogValueChanged_Parms, InAnalogInputEvent), Z_Construct_UScriptStruct_FAnalogInputEvent, METADATA_PARAMS(nullptr, 0) }; // 4262370743
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnAnalogValueChanged_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnAnalogValueChanged_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_OnAnimationStarted_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnAnimationStarted_Parms, Animation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnAnimationStarted_Statics::NewProp_Animation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnAnimationStarted_Statics::NewProp_Animation_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnDragCancelled_Statics::NewProp_PointerEvent = { "PointerEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragCancelled_Parms, PointerEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnDragCancelled_Statics::NewProp_PointerEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnDragCancelled_Statics::NewProp_PointerEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_OnDragCancelled_Statics::NewProp_Operation = { "Operation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragCancelled_Parms, Operation), Z_Construct_UClass_UDragDropOperation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnDragDetected_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragDetected_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnDragDetected_Statics::NewProp_PointerEvent = { "PointerEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragDetected_Parms, PointerEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnDragDetected_Statics::NewProp_PointerEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnDragDetected_Statics::NewProp_PointerEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_OnDragDetected_Statics::NewProp_Operation = { "Operation", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragDetected_Parms, Operation), Z_Construct_UClass_UDragDropOperation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnDragEnter_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragEnter_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnDragEnter_Statics::NewProp_PointerEvent = { "PointerEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragEnter_Parms, PointerEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(nullptr, 0) }; // 3180245440
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_OnDragEnter_Statics::NewProp_Operation = { "Operation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragEnter_Parms, Operation), Z_Construct_UClass_UDragDropOperation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnDragLeave_Statics::NewProp_PointerEvent = { "PointerEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragLeave_Parms, PointerEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(nullptr, 0) }; // 3180245440
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_OnDragLeave_Statics::NewProp_Operation = { "Operation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragLeave_Parms, Operation), Z_Construct_UClass_UDragDropOperation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnDragOver_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragOver_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnDragOver_Statics::NewProp_PointerEvent = { "PointerEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragOver_Parms, PointerEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(nullptr, 0) }; // 3180245440
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_OnDragOver_Statics::NewProp_Operation = { "Operation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDragOver_Parms, Operation), Z_Construct_UClass_UDragDropOperation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_OnDragOver_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventOnDragOver_Parms), &Z_Construct_UFunction_UUserWidget_OnDragOver_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnDrop_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDrop_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnDrop_Statics::NewProp_PointerEvent = { "PointerEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDrop_Parms, PointerEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(nullptr, 0) }; // 3180245440
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_OnDrop_Statics::NewProp_Operation = { "Operation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnDrop_Parms, Operation), Z_Construct_UClass_UDragDropOperation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_OnDrop_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventOnDrop_Parms), &Z_Construct_UFunction_UUserWidget_OnDrop_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnFocusLost_Statics::NewProp_InFocusEvent = { "InFocusEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnFocusLost_Parms, InFocusEvent), Z_Construct_UScriptStruct_FFocusEvent, METADATA_PARAMS(nullptr, 0) }; // 1366461117
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnFocusReceived_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnFocusReceived_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnFocusReceived_Statics::NewProp_InFocusEvent = { "InFocusEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnFocusReceived_Parms, InFocusEvent), Z_Construct_UScriptStruct_FFocusEvent, METADATA_PARAMS(nullptr, 0) }; // 1366461117
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnFocusReceived_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnFocusReceived_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnKeyChar_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnKeyChar_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnKeyChar_Statics::NewProp_InCharacterEvent = { "InCharacterEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnKeyChar_Parms, InCharacterEvent), Z_Construct_UScriptStruct_FCharacterEvent, METADATA_PARAMS(nullptr, 0) }; // 379286313
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnKeyChar_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnKeyChar_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnKeyDown_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnKeyDown_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnKeyDown_Statics::NewProp_InKeyEvent = { "InKeyEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnKeyDown_Parms, InKeyEvent), Z_Construct_UScriptStruct_FKeyEvent, METADATA_PARAMS(nullptr, 0) }; // 1482041026
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnKeyDown_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnKeyDown_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnKeyUp_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnKeyUp_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnKeyUp_Statics::NewProp_InKeyEvent = { "InKeyEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnKeyUp_Parms, InKeyEvent), Z_Construct_UScriptStruct_FKeyEvent, METADATA_PARAMS(nullptr, 0) }; // 1482041026
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnKeyUp_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnKeyUp_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMotionDetected_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMotionDetected_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMotionDetected_Statics::NewProp_InMotionEvent = { "InMotionEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMotionDetected_Parms, InMotionEvent), Z_Construct_UScriptStruct_FMotionEvent, METADATA_PARAMS(nullptr, 0) }; // 2504140278
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMotionDetected_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMotionDetected_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseButtonDoubleClick_Statics::NewProp_InMyGeometry = { "InMyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseButtonDoubleClick_Parms, InMyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseButtonDoubleClick_Statics::NewProp_InMouseEvent = { "InMouseEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseButtonDoubleClick_Parms, InMouseEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnMouseButtonDoubleClick_Statics::NewProp_InMouseEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnMouseButtonDoubleClick_Statics::NewProp_InMouseEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseButtonDoubleClick_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseButtonDoubleClick_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseButtonDown_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseButtonDown_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseButtonDown_Statics::NewProp_MouseEvent = { "MouseEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseButtonDown_Parms, MouseEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnMouseButtonDown_Statics::NewProp_MouseEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnMouseButtonDown_Statics::NewProp_MouseEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseButtonDown_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseButtonDown_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseButtonUp_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseButtonUp_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseButtonUp_Statics::NewProp_MouseEvent = { "MouseEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseButtonUp_Parms, MouseEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnMouseButtonUp_Statics::NewProp_MouseEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnMouseButtonUp_Statics::NewProp_MouseEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseButtonUp_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseButtonUp_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseEnter_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseEnter_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseEnter_Statics::NewProp_MouseEvent = { "MouseEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseEnter_Parms, MouseEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnMouseEnter_Statics::NewProp_MouseEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnMouseEnter_Statics::NewProp_MouseEvent_MetaData)) }; // 3180245440
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseLeave_Statics::NewProp_MouseEvent = { "MouseEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseLeave_Parms, MouseEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnMouseLeave_Statics::NewProp_MouseEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnMouseLeave_Statics::NewProp_MouseEvent_MetaData)) }; // 3180245440
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseMove_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseMove_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseMove_Statics::NewProp_MouseEvent = { "MouseEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseMove_Parms, MouseEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnMouseMove_Statics::NewProp_MouseEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnMouseMove_Statics::NewProp_MouseEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseMove_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseMove_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseWheel_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseWheel_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseWheel_Statics::NewProp_MouseEvent = { "MouseEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseWheel_Parms, MouseEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnMouseWheel_Statics::NewProp_MouseEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnMouseWheel_Statics::NewProp_MouseEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnMouseWheel_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnMouseWheel_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnPaint_Statics::NewProp_Context = { "Context", nullptr, (EPropertyFlags)0x0010000008000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnPaint_Parms, Context), Z_Construct_UScriptStruct_FPaintContext, METADATA_PARAMS(nullptr, 0) }; // 2207669548
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnPreviewKeyDown_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnPreviewKeyDown_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnPreviewKeyDown_Statics::NewProp_InKeyEvent = { "InKeyEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnPreviewKeyDown_Parms, InKeyEvent), Z_Construct_UScriptStruct_FKeyEvent, METADATA_PARAMS(nullptr, 0) }; // 1482041026
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnPreviewKeyDown_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnPreviewKeyDown_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnPreviewMouseButtonDown_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnPreviewMouseButtonDown_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnPreviewMouseButtonDown_Statics::NewProp_MouseEvent = { "MouseEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnPreviewMouseButtonDown_Parms, MouseEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnPreviewMouseButtonDown_Statics::NewProp_MouseEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnPreviewMouseButtonDown_Statics::NewProp_MouseEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnPreviewMouseButtonDown_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnPreviewMouseButtonDown_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnRemovedFromFocusPath_Statics::NewProp_InFocusEvent = { "InFocusEvent", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnRemovedFromFocusPath_Parms, InFocusEvent), Z_Construct_UScriptStruct_FFocusEvent, METADATA_PARAMS(nullptr, 0) }; // 1366461117
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchEnded_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchEnded_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchEnded_Statics::NewProp_InTouchEvent = { "InTouchEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchEnded_Parms, InTouchEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnTouchEnded_Statics::NewProp_InTouchEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnTouchEnded_Statics::NewProp_InTouchEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchEnded_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchEnded_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchForceChanged_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchForceChanged_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchForceChanged_Statics::NewProp_InTouchEvent = { "InTouchEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchForceChanged_Parms, InTouchEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnTouchForceChanged_Statics::NewProp_InTouchEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnTouchForceChanged_Statics::NewProp_InTouchEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchForceChanged_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchForceChanged_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchGesture_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchGesture_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchGesture_Statics::NewProp_GestureEvent = { "GestureEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchGesture_Parms, GestureEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnTouchGesture_Statics::NewProp_GestureEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnTouchGesture_Statics::NewProp_GestureEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchGesture_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchGesture_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchMoved_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchMoved_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchMoved_Statics::NewProp_InTouchEvent = { "InTouchEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchMoved_Parms, InTouchEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnTouchMoved_Statics::NewProp_InTouchEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnTouchMoved_Statics::NewProp_InTouchEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchMoved_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchMoved_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchStarted_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchStarted_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchStarted_Statics::NewProp_InTouchEvent = { "InTouchEvent", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchStarted_Parms, InTouchEvent), Z_Construct_UScriptStruct_FPointerEvent, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_OnTouchStarted_Statics::NewProp_InTouchEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_OnTouchStarted_Statics::NewProp_InTouchEvent_MetaData)) }; // 3180245440
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_OnTouchStarted_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventOnTouchStarted_Parms, ReturnValue), Z_Construct_UScriptStruct_FEventReply, METADATA_PARAMS(nullptr, 0) }; // 2162511330
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_PauseAnimation_Statics::NewProp_InAnimation = { "InAnimation", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPauseAnimation_Parms, InAnimation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_PauseAnimation_Statics::NewProp_InAnimation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_PauseAnimation_Statics::NewProp_InAnimation_MetaData)) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_PauseAnimation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPauseAnimation_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimation_Statics::NewProp_InAnimation = { "InAnimation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimation_Parms, InAnimation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimation_Statics::NewProp_StartAtTime = { "StartAtTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimation_Parms, StartAtTime), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimation_Statics::NewProp_NumLoopsToPlay = { "NumLoopsToPlay", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimation_Parms, NumLoopsToPlay), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimation_Statics::NewProp_PlayMode = { "PlayMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimation_Parms, PlayMode), Z_Construct_UEnum_UMG_EUMGSequencePlayMode, METADATA_PARAMS(nullptr, 0) }; // 3644434193
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimation_Statics::NewProp_PlaybackSpeed = { "PlaybackSpeed", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimation_Parms, PlaybackSpeed), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimation_Statics::NewProp_bRestoreState = { "bRestoreState", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventPlayAnimation_Parms), &Z_Construct_UFunction_UUserWidget_PlayAnimation_Statics::NewProp_bRestoreState_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimation_Parms, ReturnValue), Z_Construct_UClass_UUMGSequencePlayer_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationForward_Statics::NewProp_InAnimation = { "InAnimation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationForward_Parms, InAnimation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationForward_Statics::NewProp_PlaybackSpeed = { "PlaybackSpeed", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationForward_Parms, PlaybackSpeed), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationForward_Statics::NewProp_bRestoreState = { "bRestoreState", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventPlayAnimationForward_Parms), &Z_Construct_UFunction_UUserWidget_PlayAnimationForward_Statics::NewProp_bRestoreState_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationForward_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationForward_Parms, ReturnValue), Z_Construct_UClass_UUMGSequencePlayer_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationReverse_Statics::NewProp_InAnimation = { "InAnimation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationReverse_Parms, InAnimation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationReverse_Statics::NewProp_PlaybackSpeed = { "PlaybackSpeed", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationReverse_Parms, PlaybackSpeed), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationReverse_Statics::NewProp_bRestoreState = { "bRestoreState", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventPlayAnimationReverse_Parms), &Z_Construct_UFunction_UUserWidget_PlayAnimationReverse_Statics::NewProp_bRestoreState_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationReverse_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationReverse_Parms, ReturnValue), Z_Construct_UClass_UUMGSequencePlayer_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationTimeRange_Statics::NewProp_InAnimation = { "InAnimation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationTimeRange_Parms, InAnimation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationTimeRange_Statics::NewProp_StartAtTime = { "StartAtTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationTimeRange_Parms, StartAtTime), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationTimeRange_Statics::NewProp_EndAtTime = { "EndAtTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationTimeRange_Parms, EndAtTime), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationTimeRange_Statics::NewProp_NumLoopsToPlay = { "NumLoopsToPlay", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationTimeRange_Parms, NumLoopsToPlay), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationTimeRange_Statics::NewProp_PlayMode = { "PlayMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationTimeRange_Parms, PlayMode), Z_Construct_UEnum_UMG_EUMGSequencePlayMode, METADATA_PARAMS(nullptr, 0) }; // 3644434193
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationTimeRange_Statics::NewProp_PlaybackSpeed = { "PlaybackSpeed", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationTimeRange_Parms, PlaybackSpeed), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationTimeRange_Statics::NewProp_bRestoreState = { "bRestoreState", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventPlayAnimationTimeRange_Parms), &Z_Construct_UFunction_UUserWidget_PlayAnimationTimeRange_Statics::NewProp_bRestoreState_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_PlayAnimationTimeRange_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlayAnimationTimeRange_Parms, ReturnValue), Z_Construct_UClass_UUMGSequencePlayer_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_PlaySound_Statics::NewProp_SoundToPlay = { "SoundToPlay", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventPlaySound_Parms, SoundToPlay), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_PreConstruct_Statics::NewProp_IsDesignTime = { "IsDesignTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventPreConstruct_Parms), &Z_Construct_UFunction_UUserWidget_PreConstruct_Statics::NewProp_IsDesignTime_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UUserWidget_RemoveFromViewport_Statics::Function_MetaDataParams[] = {
		{ "Category", "User Interface|Viewport" },
		{ "Comment", "/**\n\x09 * Removes the widget from the viewport.\n\x09 */" },
		{ "DeprecatedFunction", "" },
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_ReverseAnimation_Statics::NewProp_InAnimation = { "InAnimation", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventReverseAnimation_Parms, InAnimation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_ReverseAnimation_Statics::NewProp_InAnimation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_ReverseAnimation_Statics::NewProp_InAnimation_MetaData)) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_SetAlignmentInViewport_Statics::NewProp_Alignment = { "Alignment", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetAlignmentInViewport_Parms, Alignment), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_SetAnchorsInViewport_Statics::NewProp_Anchors = { "Anchors", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetAnchorsInViewport_Parms, Anchors), Z_Construct_UScriptStruct_FAnchors, METADATA_PARAMS(nullptr, 0) }; // 3608874910
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_SetAnimationCurrentTime_Statics::NewProp_InAnimation = { "InAnimation", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetAnimationCurrentTime_Parms, InAnimation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_SetAnimationCurrentTime_Statics::NewProp_InAnimation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_SetAnimationCurrentTime_Statics::NewProp_InAnimation_MetaData)) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_SetAnimationCurrentTime_Statics::NewProp_InTime = { "InTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetAnimationCurrentTime_Parms, InTime), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_SetColorAndOpacity_Statics::NewProp_InColorAndOpacity = { "InColorAndOpacity", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetColorAndOpacity_Parms, InColorAndOpacity), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_SetDesiredSizeInViewport_Statics::NewProp_Size = { "Size", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetDesiredSizeInViewport_Parms, Size), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_SetForegroundColor_Statics::NewProp_InForegroundColor = { "InForegroundColor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetForegroundColor_Parms, InForegroundColor), Z_Construct_UScriptStruct_FSlateColor, METADATA_PARAMS(nullptr, 0) }; // 1767155899
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_SetInputActionBlocking_Statics::NewProp_bShouldBlock = { "bShouldBlock", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventSetInputActionBlocking_Parms), &Z_Construct_UFunction_UUserWidget_SetInputActionBlocking_Statics::NewProp_bShouldBlock_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UUserWidget_SetInputActionPriority_Statics::NewProp_NewPriority = { "NewPriority", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetInputActionPriority_Parms, NewPriority), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_SetOwningPlayer_Statics::NewProp_LocalPlayerController = { "LocalPlayerController", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetOwningPlayer_Parms, LocalPlayerController), Z_Construct_UClass_APlayerController_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_SetPlaybackSpeed_Statics::NewProp_InAnimation = { "InAnimation", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetPlaybackSpeed_Parms, InAnimation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UUserWidget_SetPlaybackSpeed_Statics::NewProp_InAnimation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UUserWidget_SetPlaybackSpeed_Statics::NewProp_InAnimation_MetaData)) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_SetPlaybackSpeed_Statics::NewProp_PlaybackSpeed = { "PlaybackSpeed", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetPlaybackSpeed_Parms, PlaybackSpeed), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_SetPositionInViewport_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventSetPositionInViewport_Parms, Position), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UUserWidget_SetPositionInViewport_Statics::NewProp_bRemoveDPIScale = { "bRemoveDPIScale", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UserWidget_eventSetPositionInViewport_Parms), &Z_Construct_UFunction_UUserWidget_SetPositionInViewport_Statics::NewProp_bRemoveDPIScale_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UUserWidget_StopListeningForInputAction_Statics::NewProp_ActionName = { "ActionName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventStopListeningForInputAction_Parms, ActionName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UUserWidget_StopListeningForInputAction_Statics::NewProp_EventType = { "EventType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventStopListeningForInputAction_Parms, EventType), Z_Construct_UEnum_Engine_EInputEvent, METADATA_PARAMS(nullptr, 0) }; // 1054153585
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UUserWidget_Tick_Statics::NewProp_MyGeometry = { "MyGeometry", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventTick_Parms, MyGeometry), Z_Construct_UScriptStruct_FGeometry, METADATA_PARAMS(nullptr, 0) }; // 1967684469
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UUserWidget_Tick_Statics::NewProp_InDeltaTime = { "InDeltaTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventTick_Parms, InDeltaTime), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_UnbindAllFromAnimationFinished_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventUnbindAllFromAnimationFinished_Parms, Animation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_UnbindAllFromAnimationStarted_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventUnbindAllFromAnimationStarted_Parms, Animation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_UnbindFromAnimationFinished_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventUnbindFromAnimationFinished_Parms, Animation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UUserWidget_UnbindFromAnimationFinished_Statics::NewProp_Delegate = { "Delegate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventUnbindFromAnimationFinished_Parms, Delegate), Z_Construct_UDelegateFunction_UMG_WidgetAnimationDynamicEvent__DelegateSignature, METADATA_PARAMS(nullptr, 0) }; // 3582295326
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UUserWidget_UnbindFromAnimationStarted_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventUnbindFromAnimationStarted_Parms, Animation), Z_Construct_UClass_UWidgetAnimation_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_UUserWidget_UnbindFromAnimationStarted_Statics::NewProp_Delegate = { "Delegate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UserWidget_eventUnbindFromAnimationStarted_Parms, Delegate), Z_Construct_UDelegateFunction_UMG_WidgetAnimationDynamicEvent__DelegateSignature, METADATA_PARAMS(nullptr, 0) }; // 3582295326
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bSupportsKeyboardFocus_MetaData[];
#endif
		static void NewProp_bSupportsKeyboardFocus_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bSupportsKeyboardFocus;
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UUserWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UUserWidget_AddToPlayerScreen, "AddToPlayerScreen" }, // 3201730053
		{ &Z_Construct_UFunction_UUserWidget_AddToViewport, "AddToViewport" }, // 2268992474
		{ &Z_Construct_UFunction_UUserWidget_BindToAnimationEvent, "BindToAnimationEvent" }, // 4168632773
		{ &Z_Construct_UFunction_UUserWidget_BindToAnimationFinished, "BindToAnimationFinished" }, // 1408205682
		{ &Z_Construct_UFunction_UUserWidget_BindToAnimationStarted, "BindToAnimationStarted" }, // 1406212093
		...
		{ &Z_Construct_UFunction_UUserWidget_GetAlignmentInViewport, "GetAlignmentInViewport" }, // 1350687062
		{ &Z_Construct_UFunction_UUserWidget_GetAnchorsInViewport, "GetAnchorsInViewport" }, // 1998382497
		{ &Z_Construct_UFunction_UUserWidget_GetAnimationCurrentTime, "GetAnimationCurrentTime" }, // 3296946434
		{ &Z_Construct_UFunction_UUserWidget_GetIsVisible, "GetIsVisible" }, // 1902190315
		{ &Z_Construct_UFunction_UUserWidget_GetOwningPlayerCameraManager, "GetOwningPlayerCameraManager" }, // 2049752514
		{ &Z_Construct_UFunction_UUserWidget_GetOwningPlayerPawn, "GetOwningPlayerPawn" }, // 2357097163
		{ &Z_Construct_UFunction_UUserWidget_IsAnimationPlaying, "IsAnimationPlaying" }, // 1193154087
		{ &Z_Construct_UFunction_UUserWidget_IsAnimationPlayingForward, "IsAnimationPlayingForward" }, // 752458376
		{ &Z_Construct_UFunction_UUserWidget_IsAnyAnimationPlaying, "IsAnyAnimationPlaying" }, // 435390173
		{ &Z_Construct_UFunction_UUserWidget_IsInteractable, "IsInteractable" }, // 2341783344
		{ &Z_Construct_UFunction_UUserWidget_IsInViewport, "IsInViewport" }, // 1480622682
		{ &Z_Construct_UFunction_UUserWidget_IsListeningForInputAction, "IsListeningForInputAction" }, // 538970560
		{ &Z_Construct_UFunction_UUserWidget_IsPlayingAnimation, "IsPlayingAnimation" }, // 2969537592
		{ &Z_Construct_UFunction_UUserWidget_ListenForInputAction, "ListenForInputAction" }, // 840565119
		{ &Z_Construct_UFunction_UUserWidget_OnAddedToFocusPath, "OnAddedToFocusPath" }, // 3881502219
		{ &Z_Construct_UFunction_UUserWidget_OnAnalogValueChanged, "OnAnalogValueChanged" }, // 138033236
		{ &Z_Construct_UFunction_UUserWidget_OnAnimationFinished, "OnAnimationFinished" }, // 695071766
		{ &Z_Construct_UFunction_UUserWidget_OnAnimationStarted, "OnAnimationStarted" }, // 1279525568
		{ &Z_Construct_UFunction_UUserWidget_OnDragCancelled, "OnDragCancelled" }, // 740430990
		{ &Z_Construct_UFunction_UUserWidget_OnDragDetected, "OnDragDetected" }, // 870904294
		{ &Z_Construct_UFunction_UUserWidget_OnDragEnter, "OnDragEnter" }, // 2045986404
		{ &Z_Construct_UFunction_UUserWidget_OnDragLeave, "OnDragLeave" }, // 2878994227
		{ &Z_Construct_UFunction_UUserWidget_OnDragOver, "OnDragOver" }, // 2506159844
		{ &Z_Construct_UFunction_UUserWidget_OnDrop, "OnDrop" }, // 3334044236
		{ &Z_Construct_UFunction_UUserWidget_OnFocusLost, "OnFocusLost" }, // 765846154
		{ &Z_Construct_UFunction_UUserWidget_OnFocusReceived, "OnFocusReceived" }, // 4276026797
		{ &Z_Construct_UFunction_UUserWidget_OnInitialized, "OnInitialized" }, // 927910132
		{ &Z_Construct_UFunction_UUserWidget_OnKeyChar, "OnKeyChar" }, // 2961641377
		{ &Z_Construct_UFunction_UUserWidget_OnKeyDown, "OnKeyDown" }, // 1153835888
		{ &Z_Construct_UFunction_UUserWidget_OnKeyUp, "OnKeyUp" }, // 2375252993
		{ &Z_Construct_UFunction_UUserWidget_OnMotionDetected, "OnMotionDetected" }, // 4160527737
		{ &Z_Construct_UFunction_UUserWidget_OnMouseButtonDoubleClick, "OnMouseButtonDoubleClick" }, // 1642974683
		{ &Z_Construct_UFunction_UUserWidget_OnMouseButtonDown, "OnMouseButtonDown" }, // 2614614935
		{ &Z_Construct_UFunction_UUserWidget_OnMouseButtonUp, "OnMouseButtonUp" }, // 2572982060
		{ &Z_Construct_UFunction_UUserWidget_OnMouseCaptureLost, "OnMouseCaptureLost" }, // 1594210163
		{ &Z_Construct_UFunction_UUserWidget_OnMouseEnter, "OnMouseEnter" }, // 3846194206
		{ &Z_Construct_UFunction_UUserWidget_OnMouseLeave, "OnMouseLeave" }, // 235743151
		{ &Z_Construct_UFunction_UUserWidget_OnMouseMove, "OnMouseMove" }, // 3632492828
		{ &Z_Construct_UFunction_UUserWidget_OnMouseWheel, "OnMouseWheel" }, // 2748096510
		{ &Z_Construct_UFunction_UUserWidget_OnPaint, "OnPaint" }, // 4235882482
		{ &Z_Construct_UFunction_UUserWidget_OnPreviewKeyDown, "OnPreviewKeyDown" }, // 3727075215
		{ &Z_Construct_UFunction_UUserWidget_OnPreviewMouseButtonDown, "OnPreviewMouseButtonDown" }, // 1554429554
		{ &Z_Construct_UFunction_UUserWidget_OnRemovedFromFocusPath, "OnRemovedFromFocusPath" }, // 3394936669
		{ &Z_Construct_UFunction_UUserWidget_OnTouchEnded, "OnTouchEnded" }, // 3602104146
		{ &Z_Construct_UFunction_UUserWidget_OnTouchForceChanged, "OnTouchForceChanged" }, // 467144500
		{ &Z_Construct_UFunction_UUserWidget_OnTouchGesture, "OnTouchGesture" }, // 2048197774
		{ &Z_Construct_UFunction_UUserWidget_OnTouchMoved, "OnTouchMoved" }, // 3944856759
		{ &Z_Construct_UFunction_UUserWidget_OnTouchStarted, "OnTouchStarted" }, // 685788701
		{ &Z_Construct_UFunction_UUserWidget_PauseAnimation, "PauseAnimation" }, // 1824174079
		{ &Z_Construct_UFunction_UUserWidget_PlayAnimation, "PlayAnimation" }, // 3926186710
		{ &Z_Construct_UFunction_UUserWidget_PlayAnimationForward, "PlayAnimationForward" }, // 1552528180
		{ &Z_Construct_UFunction_UUserWidget_PlayAnimationReverse, "PlayAnimationReverse" }, // 4086527409
		{ &Z_Construct_UFunction_UUserWidget_PlayAnimationTimeRange, "PlayAnimationTimeRange" }, // 2935004258
		{ &Z_Construct_UFunction_UUserWidget_PlaySound, "PlaySound" }, // 4010175345
		{ &Z_Construct_UFunction_UUserWidget_PreConstruct, "PreConstruct" }, // 1755992154
		{ &Z_Construct_UFunction_UUserWidget_RegisterInputComponent, "RegisterInputComponent" }, // 2704272324
		{ &Z_Construct_UFunction_UUserWidget_RemoveFromViewport, "RemoveFromViewport" }, // 2988444673
		{ &Z_Construct_UFunction_UUserWidget_ReverseAnimation, "ReverseAnimation" }, // 799196986
		{ &Z_Construct_UFunction_UUserWidget_SetAlignmentInViewport, "SetAlignmentInViewport" }, // 519018954
		{ &Z_Construct_UFunction_UUserWidget_SetAnchorsInViewport, "SetAnchorsInViewport" }, // 2472596034
		{ &Z_Construct_UFunction_UUserWidget_SetAnimationCurrentTime, "SetAnimationCurrentTime" }, // 1586225221
		{ &Z_Construct_UFunction_UUserWidget_SetColorAndOpacity, "SetColorAndOpacity" }, // 1750707554
		{ &Z_Construct_UFunction_UUserWidget_SetDesiredSizeInViewport, "SetDesiredSizeInViewport" }, // 2104352663
		{ &Z_Construct_UFunction_UUserWidget_SetForegroundColor, "SetForegroundColor" }, // 388269241
		{ &Z_Construct_UFunction_UUserWidget_SetInputActionBlocking, "SetInputActionBlocking" }, // 3130206553
		{ &Z_Construct_UFunction_UUserWidget_SetInputActionPriority, "SetInputActionPriority" }, // 3896359065
		{ &Z_Construct_UFunction_UUserWidget_SetNumLoopsToPlay, "SetNumLoopsToPlay" }, // 3921763021
		{ &Z_Construct_UFunction_UUserWidget_SetOwningPlayer, "SetOwningPlayer" }, // 3064310790
		{ &Z_Construct_UFunction_UUserWidget_SetPadding, "SetPadding" }, // 1937190522
		{ &Z_Construct_UFunction_UUserWidget_SetPlaybackSpeed, "SetPlaybackSpeed" }, // 357252939
		{ &Z_Construct_UFunction_UUserWidget_SetPositionInViewport, "SetPositionInViewport" }, // 4140021278
		{ &Z_Construct_UFunction_UUserWidget_StopAllAnimations, "StopAllAnimations" }, // 1255342849
		{ &Z_Construct_UFunction_UUserWidget_StopAnimation, "StopAnimation" }, // 2914025638
		...
		{ &Z_Construct_UFunction_UUserWidget_StopListeningForInputAction, "StopListeningForInputAction" }, // 2284659306
		{ &Z_Construct_UFunction_UUserWidget_Tick, "Tick" }, // 3182787009
		{ &Z_Construct_UFunction_UUserWidget_UnbindAllFromAnimationFinished, "UnbindAllFromAnimationFinished" }, // 3173145486
		{ &Z_Construct_UFunction_UUserWidget_UnbindAllFromAnimationStarted, "UnbindAllFromAnimationStarted" }, // 1146019537
		{ &Z_Construct_UFunction_UUserWidget_UnbindFromAnimationFinished, "UnbindFromAnimationFinished" }, // 4070429266
		{ &Z_Construct_UFunction_UUserWidget_UnbindFromAnimationStarted, "UnbindFromAnimationStarted" }, // 1875122661
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_ColorAndOpacity = { "ColorAndOpacity", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, ColorAndOpacity), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_ColorAndOpacity_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_ColorAndOpacity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_ColorAndOpacityDelegate = { "ColorAndOpacityDelegate", nullptr, (EPropertyFlags)0x0010000000080000, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, ColorAndOpacityDelegate), Z_Construct_UDelegateFunction_UWidget_GetLinearColor__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_ColorAndOpacityDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_ColorAndOpacityDelegate_MetaData)) }; // 4237293081
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_ForegroundColor = { "ForegroundColor", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, ForegroundColor), Z_Construct_UScriptStruct_FSlateColor, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_ForegroundColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_ForegroundColor_MetaData)) }; // 1767155899
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_ForegroundColorDelegate = { "ForegroundColorDelegate", nullptr, (EPropertyFlags)0x0010000000080000, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, ForegroundColorDelegate), Z_Construct_UDelegateFunction_UWidget_GetSlateColor__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_ForegroundColorDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_ForegroundColorDelegate_MetaData)) }; // 2930233693
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_OnVisibilityChanged = { "OnVisibilityChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, OnVisibilityChanged), Z_Construct_UDelegateFunction_UMG_OnVisibilityChangedEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_OnVisibilityChanged_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_OnVisibilityChanged_MetaData)) }; // 1081461042
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_Padding = { "Padding", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, Padding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_Padding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_Padding_MetaData)) }; // 451581171
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_ActiveSequencePlayers_Inner = { "ActiveSequencePlayers", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UUMGSequencePlayer_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_ActiveSequencePlayers = { "ActiveSequencePlayers", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, ActiveSequencePlayers), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_ActiveSequencePlayers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_ActiveSequencePlayers_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUserWidget_Statics::NewProp_AnimationTickManager_MetaData[] = {
		{ "ModuleRelativePath", "Public/Blueprint/UserWidget.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_AnimationTickManager = { "AnimationTickManager", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, AnimationTickManager), Z_Construct_UClass_UUMGSequenceTickManager_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_AnimationTickManager_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_AnimationTickManager_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_NamedSlotBindings = { "NamedSlotBindings", nullptr, (EPropertyFlags)0x0040008000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, NamedSlotBindings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_NamedSlotBindings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_NamedSlotBindings_MetaData)) }; // 2120542265
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_WidgetTree = { "WidgetTree", nullptr, (EPropertyFlags)0x0014400000202000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, WidgetTree), Z_Construct_UClass_UWidgetTree_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_WidgetTree_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_WidgetTree_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_DesignTimeSize = { "DesignTimeSize", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, DesignTimeSize), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_DesignTimeSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_DesignTimeSize_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_DesignSizeMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUserWidget_Statics::NewProp_DesignSizeMode_MetaData[] = {
		{ "ModuleRelativePath", "Public/Blueprint/UserWidget.h" },
	};
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_DesignSizeMode = { "DesignSizeMode", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, DesignSizeMode), Z_Construct_UEnum_UMG_EDesignPreviewSizeMode, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_DesignSizeMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_DesignSizeMode_MetaData)) }; // 1910679653
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_PaletteCategory = { "PaletteCategory", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, PaletteCategory), METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_PaletteCategory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_PaletteCategory_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_PreviewBackground = { "PreviewBackground", nullptr, (EPropertyFlags)0x0014000800010001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, PreviewBackground), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_PreviewBackground_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_PreviewBackground_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_Priority = { "Priority", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, Priority), METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_Priority_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_Priority_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUserWidget_Statics::NewProp_bSupportsKeyboardFocus_MetaData[] = {
		{ "ModuleRelativePath", "Public/Blueprint/UserWidget.h" },
	};
#endif
	void Z_Construct_UClass_UUserWidget_Statics::NewProp_bSupportsKeyboardFocus_SetBit(void* Obj)
	{
		((UUserWidget*)Obj)->bSupportsKeyboardFocus_DEPRECATED = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_bSupportsKeyboardFocus = { "bSupportsKeyboardFocus", nullptr, (EPropertyFlags)0x0010000020000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UUserWidget), &Z_Construct_UClass_UUserWidget_Statics::NewProp_bSupportsKeyboardFocus_SetBit, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_bSupportsKeyboardFocus_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_bSupportsKeyboardFocus_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_bIsFocusable = { "bIsFocusable", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UUserWidget), &Z_Construct_UClass_UUserWidget_Statics::NewProp_bIsFocusable_SetBit, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_bIsFocusable_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_bIsFocusable_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_bStopAction = { "bStopAction", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UUserWidget), &Z_Construct_UClass_UUserWidget_Statics::NewProp_bStopAction_SetBit, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_bStopAction_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_bStopAction_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_bHasScriptImplementedTick = { "bHasScriptImplementedTick", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UUserWidget), &Z_Construct_UClass_UUserWidget_Statics::NewProp_bHasScriptImplementedTick_SetBit, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_bHasScriptImplementedTick_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_bHasScriptImplementedTick_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_bHasScriptImplementedPaint = { "bHasScriptImplementedPaint", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UUserWidget), &Z_Construct_UClass_UUserWidget_Statics::NewProp_bHasScriptImplementedPaint_SetBit, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_bHasScriptImplementedPaint_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_bHasScriptImplementedPaint_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_TickFrequency_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_InputComponent = { "InputComponent", nullptr, (EPropertyFlags)0x0024080000282008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, InputComponent), Z_Construct_UClass_UInputComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_InputComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_InputComponent_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_AnimationCallbacks_Inner = { "AnimationCallbacks", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FAnimationEventBinding, METADATA_PARAMS(nullptr, 0) }; // 511642666
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UUserWidget_Statics::NewProp_AnimationCallbacks_MetaData[] = {
		{ "ModuleRelativePath", "Public/Blueprint/UserWidget.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UUserWidget_Statics::NewProp_AnimationCallbacks = { "AnimationCallbacks", nullptr, (EPropertyFlags)0x0020088000202000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserWidget, AnimationCallbacks), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UUserWidget_Statics::NewProp_AnimationCallbacks_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserWidget_Statics::NewProp_AnimationCallbacks_MetaData)) }; // 511642666
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UUserWidget_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUserWidget_Statics::NewProp_bSupportsKeyboardFocus,
	...
	IMPLEMENT_FSTRUCTUREDARCHIVE_SERIALIZER(UUserWidget)
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_UserWidget_h_Statics::ScriptStructInfo[] = {
		{ FAnimationEventBinding::StaticStruct, Z_Construct_UScriptStruct_FAnimationEventBinding_Statics::NewStructOps, TEXT("AnimationEventBinding"), &Z_Registration_Info_UScriptStruct_AnimationEventBinding, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimationEventBinding), 511642666U) },
		...
		{ FNamedSlotBinding::StaticStruct, Z_Construct_UScriptStruct_FNamedSlotBinding_Statics::NewStructOps, TEXT("NamedSlotBinding"), &Z_Registration_Info_UScriptStruct_NamedSlotBinding, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNamedSlotBinding), 2120542265U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_UserWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUserWidget, UUserWidget::StaticClass, TEXT("UUserWidget"), &Z_Registration_Info_UClass_UUserWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUserWidget), 1594048569U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_UserWidget_h_2437696309(TEXT("/Script/UMG"),
