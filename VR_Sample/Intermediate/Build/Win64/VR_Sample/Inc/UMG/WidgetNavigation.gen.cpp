...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UDelegateFunction_UMG_CustomWidgetNavigationDelegate__DelegateSignature_Statics::NewProp_Navigation = { "Navigation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_UMG_eventCustomWidgetNavigationDelegate_Parms, Navigation), Z_Construct_UEnum_SlateCore_EUINavigation, METADATA_PARAMS(nullptr, 0) }; // 637548137
#if WITH_METADATA
...
class UScriptStruct* FWidgetNavigationData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WidgetNavigationData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWidgetNavigationData, Z_Construct_UPackage__Script_UMG(), TEXT("WidgetNavigationData"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FWidgetNavigationData>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FWidgetNavigationData_Statics::NewProp_Rule_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Up = { "Up", nullptr, (EPropertyFlags)0x0010008000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWidgetNavigation, Up), Z_Construct_UScriptStruct_FWidgetNavigationData, METADATA_PARAMS(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Up_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Up_MetaData)) }; // 3106560048
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Down = { "Down", nullptr, (EPropertyFlags)0x0010008000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWidgetNavigation, Down), Z_Construct_UScriptStruct_FWidgetNavigationData, METADATA_PARAMS(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Down_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Down_MetaData)) }; // 3106560048
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Left = { "Left", nullptr, (EPropertyFlags)0x0010008000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWidgetNavigation, Left), Z_Construct_UScriptStruct_FWidgetNavigationData, METADATA_PARAMS(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Left_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Left_MetaData)) }; // 3106560048
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Right = { "Right", nullptr, (EPropertyFlags)0x0010008000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWidgetNavigation, Right), Z_Construct_UScriptStruct_FWidgetNavigationData, METADATA_PARAMS(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Right_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Right_MetaData)) }; // 3106560048
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Next = { "Next", nullptr, (EPropertyFlags)0x0010008000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWidgetNavigation, Next), Z_Construct_UScriptStruct_FWidgetNavigationData, METADATA_PARAMS(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Next_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Next_MetaData)) }; // 3106560048
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Previous = { "Previous", nullptr, (EPropertyFlags)0x0010008000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWidgetNavigation, Previous), Z_Construct_UScriptStruct_FWidgetNavigationData, METADATA_PARAMS(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Previous_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWidgetNavigation_Statics::NewProp_Previous_MetaData)) }; // 3106560048
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_WidgetNavigation_h_Statics::ScriptStructInfo[] = {
		{ FWidgetNavigationData::StaticStruct, Z_Construct_UScriptStruct_FWidgetNavigationData_Statics::NewStructOps, TEXT("WidgetNavigationData"), &Z_Registration_Info_UScriptStruct_WidgetNavigationData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWidgetNavigationData), 3106560048U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_WidgetNavigation_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWidgetNavigation, UWidgetNavigation::StaticClass, TEXT("UWidgetNavigation"), &Z_Registration_Info_UClass_UWidgetNavigation, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWidgetNavigation), 1025590969U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Blueprint_WidgetNavigation_h_2215136088(TEXT("/Script/UMG"),
