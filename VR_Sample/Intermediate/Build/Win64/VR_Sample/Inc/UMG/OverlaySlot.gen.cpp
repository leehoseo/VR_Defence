...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UOverlaySlot_SetPadding_Statics::NewProp_InPadding = { "InPadding", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OverlaySlot_eventSetPadding_Parms, InPadding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(nullptr, 0) }; // 451581171
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment_Statics::NewProp_InVerticalAlignment = { "InVerticalAlignment", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(OverlaySlot_eventSetVerticalAlignment_Parms, InVerticalAlignment), Z_Construct_UEnum_SlateCore_EVerticalAlignment, METADATA_PARAMS(nullptr, 0) }; // 1453904578
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOverlaySlot_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOverlaySlot_SetHorizontalAlignment, "SetHorizontalAlignment" }, // 1932152347
		{ &Z_Construct_UFunction_UOverlaySlot_SetPadding, "SetPadding" }, // 597519426
		{ &Z_Construct_UFunction_UOverlaySlot_SetVerticalAlignment, "SetVerticalAlignment" }, // 2049323225
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOverlaySlot_Statics::NewProp_Padding = { "Padding", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOverlaySlot, Padding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(Z_Construct_UClass_UOverlaySlot_Statics::NewProp_Padding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOverlaySlot_Statics::NewProp_Padding_MetaData)) }; // 451581171
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_OverlaySlot_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOverlaySlot, UOverlaySlot::StaticClass, TEXT("UOverlaySlot"), &Z_Registration_Info_UClass_UOverlaySlot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOverlaySlot), 4063830472U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_OverlaySlot_h_3109614970(TEXT("/Script/UMG"),
