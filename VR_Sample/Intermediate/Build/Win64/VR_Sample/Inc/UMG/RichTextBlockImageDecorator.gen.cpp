...
class UScriptStruct* FRichImageRow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RichImageRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRichImageRow, Z_Construct_UPackage__Script_UMG(), TEXT("RichImageRow"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FRichImageRow>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRichImageRow_Statics::NewProp_Brush = { "Brush", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRichImageRow, Brush), Z_Construct_UScriptStruct_FSlateBrush, METADATA_PARAMS(Z_Construct_UScriptStruct_FRichImageRow_Statics::NewProp_Brush_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRichImageRow_Statics::NewProp_Brush_MetaData)) }; // 852902259
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_URichTextBlockImageDecorator_Statics::NewProp_ImageSet = { "ImageSet", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URichTextBlockImageDecorator, ImageSet), Z_Construct_UClass_UDataTable_NoRegister, METADATA_PARAMS(Z_Construct_UClass_URichTextBlockImageDecorator_Statics::NewProp_ImageSet_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URichTextBlockImageDecorator_Statics::NewProp_ImageSet_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_RichTextBlockImageDecorator_h_Statics::ScriptStructInfo[] = {
		{ FRichImageRow::StaticStruct, Z_Construct_UScriptStruct_FRichImageRow_Statics::NewStructOps, TEXT("RichImageRow"), &Z_Registration_Info_UScriptStruct_RichImageRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRichImageRow), 1985173264U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_RichTextBlockImageDecorator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URichTextBlockImageDecorator, URichTextBlockImageDecorator::StaticClass, TEXT("URichTextBlockImageDecorator"), &Z_Registration_Info_UClass_URichTextBlockImageDecorator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URichTextBlockImageDecorator), 766135915U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_RichTextBlockImageDecorator_h_863105770(TEXT("/Script/UMG"),
