...
class UScriptStruct* FShapedTextOptions::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ShapedTextOptions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FShapedTextOptions, Z_Construct_UPackage__Script_UMG(), TEXT("ShapedTextOptions"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FShapedTextOptions>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FShapedTextOptions_Statics::NewProp_TextShapingMethod_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FShapedTextOptions_Statics::NewProp_TextShapingMethod = { "TextShapingMethod", nullptr, (EPropertyFlags)0x0010040000000015, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FShapedTextOptions, TextShapingMethod), Z_Construct_UEnum_SlateCore_ETextShapingMethod, METADATA_PARAMS(Z_Construct_UScriptStruct_FShapedTextOptions_Statics::NewProp_TextShapingMethod_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FShapedTextOptions_Statics::NewProp_TextShapingMethod_MetaData)) }; // 2909449771
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FShapedTextOptions_Statics::NewProp_TextFlowDirection_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FShapedTextOptions_Statics::NewProp_TextFlowDirection = { "TextFlowDirection", nullptr, (EPropertyFlags)0x0010040000000015, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FShapedTextOptions, TextFlowDirection), Z_Construct_UEnum_Slate_ETextFlowDirection, METADATA_PARAMS(Z_Construct_UScriptStruct_FShapedTextOptions_Statics::NewProp_TextFlowDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FShapedTextOptions_Statics::NewProp_TextFlowDirection_MetaData)) }; // 236699407
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTextLayoutWidget_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTextLayoutWidget_SetJustification, "SetJustification" }, // 1967689280
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_ShapedTextOptions = { "ShapedTextOptions", nullptr, (EPropertyFlags)0x00200c0000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTextLayoutWidget, ShapedTextOptions), Z_Construct_UScriptStruct_FShapedTextOptions, METADATA_PARAMS(Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_ShapedTextOptions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_ShapedTextOptions_MetaData)) }; // 4255808757
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_Justification = { "Justification", nullptr, (EPropertyFlags)0x0020080000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTextLayoutWidget, Justification), Z_Construct_UEnum_Slate_ETextJustify, METADATA_PARAMS(Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_Justification_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_Justification_MetaData)) }; // 2107748386
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_WrappingPolicy_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_WrapTextAt = { "WrapTextAt", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTextLayoutWidget, WrapTextAt), METADATA_PARAMS(Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_WrapTextAt_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_WrapTextAt_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_Margin = { "Margin", nullptr, (EPropertyFlags)0x00200c0000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTextLayoutWidget, Margin), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_Margin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_Margin_MetaData)) }; // 451581171
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_LineHeightPercentage = { "LineHeightPercentage", nullptr, (EPropertyFlags)0x00200c0000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTextLayoutWidget, LineHeightPercentage), METADATA_PARAMS(Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_LineHeightPercentage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTextLayoutWidget_Statics::NewProp_LineHeightPercentage_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_TextWidgetTypes_h_Statics::ScriptStructInfo[] = {
		{ FShapedTextOptions::StaticStruct, Z_Construct_UScriptStruct_FShapedTextOptions_Statics::NewStructOps, TEXT("ShapedTextOptions"), &Z_Registration_Info_UScriptStruct_ShapedTextOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FShapedTextOptions), 4255808757U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_TextWidgetTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTextLayoutWidget, UTextLayoutWidget::StaticClass, TEXT("UTextLayoutWidget"), &Z_Registration_Info_UClass_UTextLayoutWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTextLayoutWidget), 2092001173U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_TextWidgetTypes_h_3479926422(TEXT("/Script/UMG"),
