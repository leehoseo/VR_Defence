...
class UScriptStruct* FWidgetTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WidgetTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWidgetTransform, Z_Construct_UPackage__Script_UMG(), TEXT("WidgetTransform"));
	}
...
template<> UMG_API UScriptStruct* StaticStruct<FWidgetTransform>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Scale = { "Scale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWidgetTransform, Scale), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Scale_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Scale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Shear = { "Shear", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWidgetTransform, Shear), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Shear_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Shear_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Angle = { "Angle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWidgetTransform, Angle), METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Angle_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewProp_Angle_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Slate_WidgetTransform_h_Statics::ScriptStructInfo[] = {
		{ FWidgetTransform::StaticStruct, Z_Construct_UScriptStruct_FWidgetTransform_Statics::NewStructOps, TEXT("WidgetTransform"), &Z_Registration_Info_UScriptStruct_WidgetTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWidgetTransform), 587243240U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Slate_WidgetTransform_h_1813499742(TEXT("/Script/UMG"),
		nullptr, 0,
