...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_VAlign = { "VAlign", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USafeZoneSlot, VAlign), Z_Construct_UEnum_SlateCore_EVerticalAlignment, METADATA_PARAMS(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_VAlign_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_VAlign_MetaData)) }; // 1453904578
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_Padding = { "Padding", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USafeZoneSlot, Padding), Z_Construct_UScriptStruct_FMargin, METADATA_PARAMS(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_Padding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USafeZoneSlot_Statics::NewProp_Padding_MetaData)) }; // 451581171
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_SafeZoneSlot_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USafeZoneSlot, USafeZoneSlot::StaticClass, TEXT("USafeZoneSlot"), &Z_Registration_Info_UClass_USafeZoneSlot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USafeZoneSlot), 2362640416U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_UMG_Public_Components_SafeZoneSlot_h_1600617480(TEXT("/Script/UMG"),
