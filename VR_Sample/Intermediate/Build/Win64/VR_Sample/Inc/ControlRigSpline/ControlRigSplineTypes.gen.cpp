...
// End Cross Module References
	...
	static UEnum* ESplineType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESplineType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ControlRigSpline_ESplineType, Z_Construct_UPackage__Script_ControlRigSpline(), TEXT("ESplineType"));
		}
...
class UScriptStruct* FControlRigSplineImpl::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigSplineImpl.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigSplineImpl, Z_Construct_UPackage__Script_ControlRigSpline(), TEXT("ControlRigSplineImpl"));
	}
...
class UScriptStruct* FControlRigSpline::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigSpline.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigSpline, Z_Construct_UPackage__Script_ControlRigSpline(), TEXT("ControlRigSpline"));
	}
