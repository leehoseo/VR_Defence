...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_Scene = { "Scene", nullptr, (EPropertyFlags)0x0014000000020001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADatasmithSceneActor, Scene), Z_Construct_UClass_UDatasmithScene_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_Scene_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_Scene_MetaData)) };
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_RelatedActors_ValueProp = { "RelatedActors", nullptr, (EPropertyFlags)0x0004000000020001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_RelatedActors_Key_KeyProp = { "RelatedActors_Key", nullptr, (EPropertyFlags)0x0000000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_RelatedActors = { "RelatedActors", nullptr, (EPropertyFlags)0x0014040000020001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ADatasmithSceneActor, RelatedActors), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_RelatedActors_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ADatasmithSceneActor_Statics::NewProp_RelatedActors_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_DatasmithSceneActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ADatasmithSceneActor, ADatasmithSceneActor::StaticClass, TEXT("ADatasmithSceneActor"), &Z_Registration_Info_UClass_ADatasmithSceneActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ADatasmithSceneActor), 3697592860U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_DatasmithSceneActor_h_2869310294(TEXT("/Script/DatasmithContent"),
