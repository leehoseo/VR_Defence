...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_StaticLightingLOD = { "StaticLightingLOD", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithLandscapeTemplate, StaticLightingLOD), METADATA_PARAMS(Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_StaticLightingLOD_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithLandscapeTemplate_Statics::NewProp_StaticLightingLOD_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithLandscapeTemplate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDatasmithLandscapeTemplate, UDatasmithLandscapeTemplate::StaticClass, TEXT("UDatasmithLandscapeTemplate"), &Z_Registration_Info_UClass_UDatasmithLandscapeTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDatasmithLandscapeTemplate), 3586246699U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithLandscapeTemplate_h_2220561434(TEXT("/Script/DatasmithContent"),
