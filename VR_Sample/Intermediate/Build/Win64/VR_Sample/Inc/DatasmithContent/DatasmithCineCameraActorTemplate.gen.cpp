...
class UScriptStruct* FDatasmithCameraLookatTrackingSettingsTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DatasmithCameraLookatTrackingSettingsTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDatasmithCameraLookatTrackingSettingsTemplate, Z_Construct_UPackage__Script_DatasmithContent(), TEXT("DatasmithCameraLookatTrackingSettingsTemplate"));
	}
...
template<> DATASMITHCONTENT_API UScriptStruct* StaticStruct<FDatasmithCameraLookatTrackingSettingsTemplate>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDatasmithCineCameraActorTemplate_Statics::NewProp_LookatTrackingSettings = { "LookatTrackingSettings", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDatasmithCineCameraActorTemplate, LookatTrackingSettings), Z_Construct_UScriptStruct_FDatasmithCameraLookatTrackingSettingsTemplate, METADATA_PARAMS(Z_Construct_UClass_UDatasmithCineCameraActorTemplate_Statics::NewProp_LookatTrackingSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDatasmithCineCameraActorTemplate_Statics::NewProp_LookatTrackingSettings_MetaData)) }; // 641769159
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_DatasmithContent_Source_DatasmithContent_Public_ObjectTemplates_DatasmithCineCameraActorTemplate_h_2555494116(TEXT("/Script/DatasmithContent"),
