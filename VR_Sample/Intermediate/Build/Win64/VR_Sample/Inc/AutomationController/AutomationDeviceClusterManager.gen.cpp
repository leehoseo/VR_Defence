...
#include "AutomationController/Private/AutomationDeviceClusterManager.h"
...
class UScriptStruct* FAutomationDeviceInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AutomationDeviceInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAutomationDeviceInfo, Z_Construct_UPackage__Script_AutomationController(), TEXT("AutomationDeviceInfo"));
	}
...
template<> AUTOMATIONCONTROLLER_API UScriptStruct* StaticStruct<FAutomationDeviceInfo>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_DeviceName = { "DeviceName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationDeviceInfo, DeviceName), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_DeviceName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_DeviceName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_Instance = { "Instance", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationDeviceInfo, Instance), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_Instance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_Instance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_OSVersion = { "OSVersion", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationDeviceInfo, OSVersion), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_OSVersion_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_OSVersion_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_Model = { "Model", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationDeviceInfo, Model), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_Model_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_Model_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_GPU = { "GPU", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationDeviceInfo, GPU), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_GPU_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_GPU_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_CPUModel = { "CPUModel", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationDeviceInfo, CPUModel), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_CPUModel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_CPUModel_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_RAMInGB = { "RAMInGB", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationDeviceInfo, RAMInGB), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_RAMInGB_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_RAMInGB_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_RenderMode = { "RenderMode", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationDeviceInfo, RenderMode), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_RenderMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_RenderMode_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_RHI = { "RHI", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationDeviceInfo, RHI), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_RHI_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewProp_RHI_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_AutomationController_Private_AutomationDeviceClusterManager_h_Statics::ScriptStructInfo[] = {
		{ FAutomationDeviceInfo::StaticStruct, Z_Construct_UScriptStruct_FAutomationDeviceInfo_Statics::NewStructOps, TEXT("AutomationDeviceInfo"), &Z_Registration_Info_UScriptStruct_AutomationDeviceInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAutomationDeviceInfo), 2036168049U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_AutomationController_Private_AutomationDeviceClusterManager_h_2566304659(TEXT("/Script/AutomationController"),
		nullptr, 0,
