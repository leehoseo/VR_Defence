...
class UScriptStruct* FConstraintNodeData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ConstraintNodeData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FConstraintNodeData, Z_Construct_UPackage__Script_ControlRig(), TEXT("ConstraintNodeData"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_RelativeParent = { "RelativeParent", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintNodeData, RelativeParent), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_RelativeParent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_RelativeParent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_ConstraintOffset = { "ConstraintOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintNodeData, ConstraintOffset), Z_Construct_UScriptStruct_FConstraintOffset, METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_ConstraintOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_ConstraintOffset_MetaData)) }; // 1545857309
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_LinkedNode = { "LinkedNode", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintNodeData, LinkedNode), METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_LinkedNode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_LinkedNode_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_Constraints_Inner = { "Constraints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FTransformConstraint, METADATA_PARAMS(nullptr, 0) }; // 909867105
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_Constraints = { "Constraints", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintNodeData, Constraints), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_Constraints_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewProp_Constraints_MetaData)) }; // 909867105
...
class UScriptStruct* FAnimationHierarchy::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimationHierarchy.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimationHierarchy, Z_Construct_UPackage__Script_ControlRig(), TEXT("AnimationHierarchy"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FAnimationHierarchy>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimationHierarchy_Statics::NewProp_UserData_Inner = { "UserData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FConstraintNodeData, METADATA_PARAMS(nullptr, 0) }; // 3933922369
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAnimationHierarchy_Statics::NewProp_UserData = { "UserData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimationHierarchy, UserData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimationHierarchy_Statics::NewProp_UserData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimationHierarchy_Statics::NewProp_UserData_MetaData)) }; // 3933922369
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_AnimationHierarchy_h_Statics::ScriptStructInfo[] = {
		{ FConstraintNodeData::StaticStruct, Z_Construct_UScriptStruct_FConstraintNodeData_Statics::NewStructOps, TEXT("ConstraintNodeData"), &Z_Registration_Info_UScriptStruct_ConstraintNodeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConstraintNodeData), 3933922369U) },
		{ FAnimationHierarchy::StaticStruct, Z_Construct_UScriptStruct_FAnimationHierarchy_Statics::NewStructOps, TEXT("AnimationHierarchy"), &Z_Registration_Info_UScriptStruct_AnimationHierarchy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimationHierarchy), 2755749050U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_AnimationHierarchy_h_4222360211(TEXT("/Script/ControlRig"),
		nullptr, 0,
