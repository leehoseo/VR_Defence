...
class UScriptStruct* FRigUnit_SetRelativeBoneTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_SetRelativeBoneTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_SetRelativeBoneTransform"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_SetRelativeBoneTransform::Execute"), &FRigUnit_SetRelativeBoneTransform::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_SetRelativeBoneTransform.OuterSingleton);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_SetRelativeBoneTransform>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_Weight = { "Weight", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SetRelativeBoneTransform, Weight), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_Weight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_Weight_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_bPropagateToChildren = { "bPropagateToChildren", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRigUnit_SetRelativeBoneTransform), &Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_bPropagateToChildren_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_bPropagateToChildren_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewProp_bPropagateToChildren_MetaData)) };
#if WITH_METADATA
...
void FRigUnit_SetRelativeBoneTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetRelativeBoneTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_SetRelativeBoneTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetRelativeBoneTransform_Statics::NewStructOps, TEXT("RigUnit_SetRelativeBoneTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_SetRelativeBoneTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetRelativeBoneTransform), 3194865919U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetRelativeBoneTransform_h_3836459319(TEXT("/Script/ControlRig"),
		nullptr, 0,
