...
// End Cross Module References
	...
	static UEnum* ERigSpaceType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERigSpaceType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ControlRig_ERigSpaceType, Z_Construct_UPackage__Script_ControlRig(), TEXT("ERigSpaceType"));
		}
...
class UScriptStruct* FRigSpace::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigSpace.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigSpace, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigSpace"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigSpace>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_SpaceType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_ParentName = { "ParentName", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigSpace, ParentName), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_ParentName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_ParentName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_ParentIndex = { "ParentIndex", nullptr, (EPropertyFlags)0x0010000000002014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigSpace, ParentIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_ParentIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_ParentIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_InitialTransform = { "InitialTransform", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigSpace, InitialTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_InitialTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_InitialTransform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_LocalTransform = { "LocalTransform", nullptr, (EPropertyFlags)0x0010000000002015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigSpace, LocalTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_LocalTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigSpace_Statics::NewProp_LocalTransform_MetaData)) };
...
class UScriptStruct* FRigSpaceHierarchy::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigSpaceHierarchy.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigSpaceHierarchy, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigSpaceHierarchy"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigSpaceHierarchy>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigSpaceHierarchy_Statics::NewProp_Spaces_Inner = { "Spaces", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FRigSpace, METADATA_PARAMS(nullptr, 0) }; // 811918145
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRigSpaceHierarchy_Statics::NewProp_Spaces = { "Spaces", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigSpaceHierarchy, Spaces), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigSpaceHierarchy_Statics::NewProp_Spaces_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigSpaceHierarchy_Statics::NewProp_Spaces_MetaData)) }; // 811918145
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigSpaceHierarchy_h_Statics::ScriptStructInfo[] = {
		{ FRigSpace::StaticStruct, Z_Construct_UScriptStruct_FRigSpace_Statics::NewStructOps, TEXT("RigSpace"), &Z_Registration_Info_UScriptStruct_RigSpace, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigSpace), 811918145U) },
		{ FRigSpaceHierarchy::StaticStruct, Z_Construct_UScriptStruct_FRigSpaceHierarchy_Statics::NewStructOps, TEXT("RigSpaceHierarchy"), &Z_Registration_Info_UScriptStruct_RigSpaceHierarchy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigSpaceHierarchy), 3121320629U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigSpaceHierarchy_h_319088998(TEXT("/Script/ControlRig"),
		nullptr, 0,
