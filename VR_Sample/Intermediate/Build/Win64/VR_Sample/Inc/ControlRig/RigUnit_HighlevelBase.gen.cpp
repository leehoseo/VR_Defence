...
// End Cross Module References
	...
	static UEnum* EControlRigVectorKind_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EControlRigVectorKind.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ControlRig_EControlRigVectorKind, Z_Construct_UPackage__Script_ControlRig(), TEXT("EControlRigVectorKind"));
		}
...
class UScriptStruct* FRigUnit_HighlevelBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_HighlevelBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_HighlevelBase, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_HighlevelBase"));
	}
...
class UScriptStruct* FRigUnit_HighlevelBaseMutable::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_HighlevelBaseMutable.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_HighlevelBaseMutable, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_HighlevelBaseMutable"));
	}
