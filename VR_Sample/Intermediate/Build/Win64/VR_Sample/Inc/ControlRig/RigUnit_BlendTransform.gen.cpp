...
#include "ControlRig/Private/Units/Deprecated/RigUnit_BlendTransform.h"
...
class UScriptStruct* FBlendTarget::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlendTarget.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlendTarget, Z_Construct_UPackage__Script_ControlRig(), TEXT("BlendTarget"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBlendTarget_Statics::NewProp_Weight = { "Weight", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlendTarget, Weight), METADATA_PARAMS(Z_Construct_UScriptStruct_FBlendTarget_Statics::NewProp_Weight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlendTarget_Statics::NewProp_Weight_MetaData)) };
...
class UScriptStruct* FRigUnit_BlendTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_BlendTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_BlendTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_BlendTransform"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_BlendTransform::Execute"), &FRigUnit_BlendTransform::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_BlendTransform.OuterSingleton);
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewProp_Source = { "Source", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_BlendTransform, Source), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewProp_Source_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewProp_Source_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewProp_Targets_Inner = { "Targets", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBlendTarget, METADATA_PARAMS(nullptr, 0) }; // 42489958
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewProp_Targets = { "Targets", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_BlendTransform, Targets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewProp_Targets_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewProp_Targets_MetaData)) }; // 42489958
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_BlendTransform, Result), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewProp_Result_MetaData)) };
...
void FRigUnit_BlendTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Deprecated_RigUnit_BlendTransform_h_Statics::ScriptStructInfo[] = {
		{ FBlendTarget::StaticStruct, Z_Construct_UScriptStruct_FBlendTarget_Statics::NewStructOps, TEXT("BlendTarget"), &Z_Registration_Info_UScriptStruct_BlendTarget, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlendTarget), 42489958U) },
		{ FRigUnit_BlendTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_BlendTransform_Statics::NewStructOps, TEXT("RigUnit_BlendTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_BlendTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_BlendTransform), 2675124066U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Deprecated_RigUnit_BlendTransform_h_1346127243(TEXT("/Script/ControlRig"),
		nullptr, 0,
