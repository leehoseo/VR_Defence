...
class UScriptStruct* FRigUnit_BinaryTransformOp::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_BinaryTransformOp.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_BinaryTransformOp"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewProp_Argument1 = { "Argument1", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_BinaryTransformOp, Argument1), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewProp_Argument1_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewProp_Argument1_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_BinaryTransformOp, Result), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewProp_Result_MetaData)) };
...
class UScriptStruct* FRigUnit_MultiplyTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_MultiplyTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_MultiplyTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_MultiplyTransform"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_MultiplyTransform::Execute"), &FRigUnit_MultiplyTransform::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_MultiplyTransform.OuterSingleton);
	}
...
class UScriptStruct* FRigUnit_GetRelativeTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_GetRelativeTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_GetRelativeTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_GetRelativeTransform"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_GetRelativeTransform::Execute"), &FRigUnit_GetRelativeTransform::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_GetRelativeTransform.OuterSingleton);
	}
...
void FRigUnit_GetRelativeTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Deprecated_Math_RigUnit_Transform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_BinaryTransformOp::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_BinaryTransformOp_Statics::NewStructOps, TEXT("RigUnit_BinaryTransformOp"), &Z_Registration_Info_UScriptStruct_RigUnit_BinaryTransformOp, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_BinaryTransformOp), 1206116198U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Deprecated_Math_RigUnit_Transform_h_1222405709(TEXT("/Script/ControlRig"),
		nullptr, 0,
