...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UControlRigPoseProjectSettings_Statics::NewProp_RootSaveDirs_Inner = { "RootSaveDirs", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Tools_ControlRigPoseProjectSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UControlRigPoseProjectSettings, UControlRigPoseProjectSettings::StaticClass, TEXT("UControlRigPoseProjectSettings"), &Z_Registration_Info_UClass_UControlRigPoseProjectSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigPoseProjectSettings), 1547792533U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Tools_ControlRigPoseProjectSettings_h_739160820(TEXT("/Script/ControlRig"),
