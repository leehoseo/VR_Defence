...
class UScriptStruct* FAnimNode_ControlRig_ExternalSource::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_ControlRig_ExternalSource.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_ControlRig_ExternalSource, Z_Construct_UPackage__Script_ControlRig(), TEXT("AnimNode_ControlRig_ExternalSource"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FAnimNode_ControlRig_ExternalSource>()
{
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRig_ExternalSource_Statics::NewProp_ControlRig = { "ControlRig", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ControlRig_ExternalSource, ControlRig), Z_Construct_UClass_UControlRig_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRig_ExternalSource_Statics::NewProp_ControlRig_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRig_ExternalSource_Statics::NewProp_ControlRig_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_AnimNode_ControlRig_ExternalSource_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_ControlRig_ExternalSource::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_ControlRig_ExternalSource_Statics::NewStructOps, TEXT("AnimNode_ControlRig_ExternalSource"), &Z_Registration_Info_UScriptStruct_AnimNode_ControlRig_ExternalSource, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_ControlRig_ExternalSource), 197510187U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_AnimNode_ControlRig_ExternalSource_h_2051008705(TEXT("/Script/ControlRig"),
		nullptr, 0,
