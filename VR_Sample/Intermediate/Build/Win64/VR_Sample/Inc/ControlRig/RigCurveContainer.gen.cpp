...
class UScriptStruct* FRigCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigCurve, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigCurve"));
	}
...
class UScriptStruct* FRigCurveContainer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigCurveContainer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigCurveContainer, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigCurveContainer"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigCurveContainer>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigCurveContainer_Statics::NewProp_Curves_Inner = { "Curves", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FRigCurve, METADATA_PARAMS(nullptr, 0) }; // 3576984761
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRigCurveContainer_Statics::NewProp_Curves = { "Curves", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigCurveContainer, Curves), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigCurveContainer_Statics::NewProp_Curves_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigCurveContainer_Statics::NewProp_Curves_MetaData)) }; // 3576984761
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigCurveContainer_h_Statics::ScriptStructInfo[] = {
		{ FRigCurve::StaticStruct, Z_Construct_UScriptStruct_FRigCurve_Statics::NewStructOps, TEXT("RigCurve"), &Z_Registration_Info_UScriptStruct_RigCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigCurve), 3576984761U) },
		{ FRigCurveContainer::StaticStruct, Z_Construct_UScriptStruct_FRigCurveContainer_Statics::NewStructOps, TEXT("RigCurveContainer"), &Z_Registration_Info_UScriptStruct_RigCurveContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigCurveContainer), 2853989559U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigCurveContainer_h_2317125219(TEXT("/Script/ControlRig"),
		nullptr, 0,
