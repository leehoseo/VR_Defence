...
class UScriptStruct* FControlRigShapeDefinition::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigShapeDefinition.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigShapeDefinition, Z_Construct_UPackage__Script_ControlRig(), TEXT("ControlRigShapeDefinition"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FControlRigShapeDefinition>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FControlRigShapeDefinition_Statics::NewProp_ShapeName = { "ShapeName", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FControlRigShapeDefinition, ShapeName), METADATA_PARAMS(Z_Construct_UScriptStruct_FControlRigShapeDefinition_Statics::NewProp_ShapeName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FControlRigShapeDefinition_Statics::NewProp_ShapeName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UScriptStruct_FControlRigShapeDefinition_Statics::NewProp_StaticMesh = { "StaticMesh", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FControlRigShapeDefinition, StaticMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FControlRigShapeDefinition_Statics::NewProp_StaticMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FControlRigShapeDefinition_Statics::NewProp_StaticMesh_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UControlRigShapeLibrary_Statics::NewProp_DefaultShape = { "DefaultShape", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UControlRigShapeLibrary, DefaultShape), Z_Construct_UScriptStruct_FControlRigShapeDefinition, METADATA_PARAMS(Z_Construct_UClass_UControlRigShapeLibrary_Statics::NewProp_DefaultShape_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigShapeLibrary_Statics::NewProp_DefaultShape_MetaData)) }; // 1467911259
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UControlRigShapeLibrary_Statics::NewProp_Shapes = { "Shapes", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UControlRigShapeLibrary, Shapes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UControlRigShapeLibrary_Statics::NewProp_Shapes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigShapeLibrary_Statics::NewProp_Shapes_MetaData)) }; // 1467911259
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_ControlRigGizmoLibrary_h_Statics::ScriptStructInfo[] = {
		{ FControlRigShapeDefinition::StaticStruct, Z_Construct_UScriptStruct_FControlRigShapeDefinition_Statics::NewStructOps, TEXT("ControlRigShapeDefinition"), &Z_Registration_Info_UScriptStruct_ControlRigShapeDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FControlRigShapeDefinition), 1467911259U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_ControlRigGizmoLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UControlRigShapeLibrary, UControlRigShapeLibrary::StaticClass, TEXT("UControlRigShapeLibrary"), &Z_Registration_Info_UClass_UControlRigShapeLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigShapeLibrary), 2482389910U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_ControlRigGizmoLibrary_h_676713780(TEXT("/Script/ControlRig"),
