...
class UScriptStruct* FRigHierarchyContainer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigHierarchyContainer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigHierarchyContainer, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigHierarchyContainer"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_BoneHierarchy = { "BoneHierarchy", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigHierarchyContainer, BoneHierarchy), Z_Construct_UScriptStruct_FRigBoneHierarchy, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_BoneHierarchy_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_BoneHierarchy_MetaData)) }; // 1520093236
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_SpaceHierarchy = { "SpaceHierarchy", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigHierarchyContainer, SpaceHierarchy), Z_Construct_UScriptStruct_FRigSpaceHierarchy, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_SpaceHierarchy_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_SpaceHierarchy_MetaData)) }; // 3121320629
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_ControlHierarchy = { "ControlHierarchy", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigHierarchyContainer, ControlHierarchy), Z_Construct_UScriptStruct_FRigControlHierarchy, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_ControlHierarchy_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_ControlHierarchy_MetaData)) }; // 4293370582
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_CurveContainer = { "CurveContainer", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigHierarchyContainer, CurveContainer), Z_Construct_UScriptStruct_FRigCurveContainer, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_CurveContainer_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewProp_CurveContainer_MetaData)) }; // 2853989559
...
class UScriptStruct* FRigHierarchyRef::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigHierarchyRef.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigHierarchyRef, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigHierarchyRef"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigHierarchyRef>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchyContainer_h_Statics::ScriptStructInfo[] = {
		{ FRigHierarchyContainer::StaticStruct, Z_Construct_UScriptStruct_FRigHierarchyContainer_Statics::NewStructOps, TEXT("RigHierarchyContainer"), &Z_Registration_Info_UScriptStruct_RigHierarchyContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigHierarchyContainer), 477156827U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Rigs_RigHierarchyContainer_h_979049299(TEXT("/Script/ControlRig"),
		nullptr, 0,
