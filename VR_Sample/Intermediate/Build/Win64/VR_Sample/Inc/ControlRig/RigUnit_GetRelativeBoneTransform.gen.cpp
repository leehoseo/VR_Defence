...
class UScriptStruct* FRigUnit_GetRelativeBoneTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_GetRelativeBoneTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_GetRelativeBoneTransform"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_GetRelativeBoneTransform::Execute"), &FRigUnit_GetRelativeBoneTransform::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_GetRelativeBoneTransform.OuterSingleton);
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetRelativeBoneTransform, Space), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Space_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetRelativeBoneTransform, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_Transform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedBone = { "CachedBone", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetRelativeBoneTransform, CachedBone), Z_Construct_UScriptStruct_FCachedRigElement, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedBone_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedBone_MetaData)) }; // 466782542
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedSpace = { "CachedSpace", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetRelativeBoneTransform, CachedSpace), Z_Construct_UScriptStruct_FCachedRigElement, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedSpace_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewProp_CachedSpace_MetaData)) }; // 466782542
...
void FRigUnit_GetRelativeBoneTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetRelativeBoneTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetRelativeBoneTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetRelativeBoneTransform_Statics::NewStructOps, TEXT("RigUnit_GetRelativeBoneTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetRelativeBoneTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetRelativeBoneTransform), 3353102829U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetRelativeBoneTransform_h_3423723842(TEXT("/Script/ControlRig"),
		nullptr, 0,
