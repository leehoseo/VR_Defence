...
class UScriptStruct* FRigUnit_SequenceExecution::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_SequenceExecution.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_SequenceExecution, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_SequenceExecution"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_SequenceExecution::Execute"), &FRigUnit_SequenceExecution::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_SequenceExecution.OuterSingleton);
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_ExecuteContext = { "ExecuteContext", nullptr, (EPropertyFlags)0x0010000000002001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SequenceExecution, ExecuteContext), Z_Construct_UScriptStruct_FControlRigExecuteContext, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_ExecuteContext_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_ExecuteContext_MetaData)) }; // 1688564855
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_B = { "B", nullptr, (EPropertyFlags)0x0010000000002001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SequenceExecution, B), Z_Construct_UScriptStruct_FControlRigExecuteContext, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_B_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_B_MetaData)) }; // 1688564855
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_C = { "C", nullptr, (EPropertyFlags)0x0010000000002001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SequenceExecution, C), Z_Construct_UScriptStruct_FControlRigExecuteContext, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_C_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_C_MetaData)) }; // 1688564855
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_D = { "D", nullptr, (EPropertyFlags)0x0010000000002001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SequenceExecution, D), Z_Construct_UScriptStruct_FControlRigExecuteContext, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_D_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SequenceExecution_Statics::NewProp_D_MetaData)) }; // 1688564855
...
void FRigUnit_SequenceExecution::Execute(const FRigUnitContext & Context)
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_SequenceExecution_h_1287680860(TEXT("/Script/ControlRig"),
		nullptr, 0,
