...
class UScriptStruct* FRigUnit_OffsetTransformForItem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_OffsetTransformForItem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_OffsetTransformForItem, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_OffsetTransformForItem"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_OffsetTransformForItem::Execute"), &FRigUnit_OffsetTransformForItem::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_OffsetTransformForItem.OuterSingleton);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_OffsetTransformForItem>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_OffsetTransformForItem_Statics::NewProp_bPropagateToChildren = { "bPropagateToChildren", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRigUnit_OffsetTransformForItem), &Z_Construct_UScriptStruct_FRigUnit_OffsetTransformForItem_Statics::NewProp_bPropagateToChildren_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_OffsetTransformForItem_Statics::NewProp_bPropagateToChildren_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_OffsetTransformForItem_Statics::NewProp_bPropagateToChildren_MetaData)) };
#if WITH_METADATA
...
void FRigUnit_OffsetTransformForItem::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_OffsetTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_OffsetTransformForItem::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_OffsetTransformForItem_Statics::NewStructOps, TEXT("RigUnit_OffsetTransformForItem"), &Z_Registration_Info_UScriptStruct_RigUnit_OffsetTransformForItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_OffsetTransformForItem), 4002178282U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_OffsetTransform_h_960388242(TEXT("/Script/ControlRig"),
		nullptr, 0,
