...
#include "ControlRig/Private/Units/Highlevel/Hierarchy/RigUnit_ModifyTransforms.h"
...
// End Cross Module References
	...
	static UEnum* EControlRigModifyBoneMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EControlRigModifyBoneMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ControlRig_EControlRigModifyBoneMode, Z_Construct_UPackage__Script_ControlRig(), TEXT("EControlRigModifyBoneMode"));
		}
...
class UScriptStruct* FRigUnit_ModifyTransforms_PerItem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_ModifyTransforms_PerItem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_PerItem, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_ModifyTransforms_PerItem"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_PerItem_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyTransforms_PerItem, Item), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_PerItem_Statics::NewProp_Item_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_PerItem_Statics::NewProp_Item_MetaData)) }; // 3202328731
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_PerItem_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyTransforms_PerItem, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_PerItem_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_PerItem_Statics::NewProp_Transform_MetaData)) };
...
class UScriptStruct* FRigUnit_ModifyTransforms_WorkData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_ModifyTransforms_WorkData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_WorkData, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_ModifyTransforms_WorkData"));
	}
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_WorkData_Statics::NewProp_CachedItems = { "CachedItems", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyTransforms_WorkData, CachedItems), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_WorkData_Statics::NewProp_CachedItems_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_WorkData_Statics::NewProp_CachedItems_MetaData)) }; // 466782542
...
class UScriptStruct* FRigUnit_ModifyTransforms::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_ModifyTransforms.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_ModifyTransforms"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_ModifyTransforms::Execute"), &FRigUnit_ModifyTransforms::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_ModifyTransforms.OuterSingleton);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_ModifyTransforms>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_ItemToModify_Inner = { "ItemToModify", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_PerItem, METADATA_PARAMS(nullptr, 0) }; // 2380232229
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_ItemToModify = { "ItemToModify", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyTransforms, ItemToModify), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_ItemToModify_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_ItemToModify_MetaData)) }; // 2380232229
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_WeightMaximum = { "WeightMaximum", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyTransforms, WeightMaximum), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_WeightMaximum_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_WeightMaximum_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_Mode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyTransforms, Mode), Z_Construct_UEnum_ControlRig_EControlRigModifyBoneMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_Mode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_Mode_MetaData)) }; // 3240575816
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_WorkData = { "WorkData", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyTransforms, WorkData), Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_WorkData, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_WorkData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewProp_WorkData_MetaData)) }; // 372215107
...
void FRigUnit_ModifyTransforms::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Hierarchy_RigUnit_ModifyTransforms_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_ModifyTransforms::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_ModifyTransforms_Statics::NewStructOps, TEXT("RigUnit_ModifyTransforms"), &Z_Registration_Info_UScriptStruct_RigUnit_ModifyTransforms, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_ModifyTransforms), 1329643296U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Hierarchy_RigUnit_ModifyTransforms_h_2259882917(TEXT("/Script/ControlRig"),
		nullptr, 0,
