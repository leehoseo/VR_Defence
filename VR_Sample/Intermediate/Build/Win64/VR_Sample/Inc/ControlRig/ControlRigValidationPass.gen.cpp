...
class UScriptStruct* FControlRigValidationContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigValidationContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigValidationContext, Z_Construct_UPackage__Script_ControlRig(), TEXT("ControlRigValidationContext"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FControlRigValidationContext>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UControlRigValidator_Statics::NewProp_Passes_Inner = { "Passes", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UControlRigValidationPass_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UControlRigValidator_Statics::NewProp_Passes_MetaData[] = {
		{ "ModuleRelativePath", "Public/ControlRigValidationPass.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UControlRigValidator_Statics::NewProp_Passes = { "Passes", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UControlRigValidator, Passes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UControlRigValidator_Statics::NewProp_Passes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigValidator_Statics::NewProp_Passes_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_ControlRigValidationPass_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UControlRigValidator, UControlRigValidator::StaticClass, TEXT("UControlRigValidator"), &Z_Registration_Info_UClass_UControlRigValidator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigValidator), 1151788587U) },
		{ Z_Construct_UClass_UControlRigValidationPass, UControlRigValidationPass::StaticClass, TEXT("UControlRigValidationPass"), &Z_Registration_Info_UClass_UControlRigValidationPass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigValidationPass), 738587337U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_ControlRigValidationPass_h_1550916140(TEXT("/Script/ControlRig"),
