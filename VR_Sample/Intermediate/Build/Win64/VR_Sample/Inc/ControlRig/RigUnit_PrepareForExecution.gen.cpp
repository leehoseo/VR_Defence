...
class UScriptStruct* FRigUnit_PrepareForExecution::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_PrepareForExecution.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_PrepareForExecution, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_PrepareForExecution"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_PrepareForExecution::Execute"), &FRigUnit_PrepareForExecution::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_PrepareForExecution.OuterSingleton);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_PrepareForExecution>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigUnit_PrepareForExecution_Statics::Struct_MetaDataParams[] = {
		...
		{ "DisplayName", "Setup Event" },
		{ "Keywords", "Setup,Init,Fit" },
		{ "ModuleRelativePath", "Private/Units/Execution/RigUnit_PrepareForExecution.h" },
		{ "NodeColor", "1, 0, 0" },
		{ "ToolTip", "Event to setup elements before all solves" },
	};
#endif
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_PrepareForExecution_Statics::NewProp_ExecuteContext = { "ExecuteContext", nullptr, (EPropertyFlags)0x0010000000002001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_PrepareForExecution, ExecuteContext), Z_Construct_UScriptStruct_FControlRigExecuteContext, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_PrepareForExecution_Statics::NewProp_ExecuteContext_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_PrepareForExecution_Statics::NewProp_ExecuteContext_MetaData)) }; // 1688564855
...
void FRigUnit_PrepareForExecution::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_PrepareForExecution_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_PrepareForExecution::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_PrepareForExecution_Statics::NewStructOps, TEXT("RigUnit_PrepareForExecution"), &Z_Registration_Info_UScriptStruct_RigUnit_PrepareForExecution, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_PrepareForExecution), 2026659250U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Execution_RigUnit_PrepareForExecution_h_891190158(TEXT("/Script/ControlRig"),
		nullptr, 0,
