...
class UScriptStruct* FControlRigSequenceObjectReference::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigSequenceObjectReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigSequenceObjectReference, Z_Construct_UPackage__Script_ControlRig(), TEXT("ControlRigSequenceObjectReference"));
	}
...
class UScriptStruct* FControlRigSequenceObjectReferences::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigSequenceObjectReferences.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigSequenceObjectReferences, Z_Construct_UPackage__Script_ControlRig(), TEXT("ControlRigSequenceObjectReferences"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FControlRigSequenceObjectReferences>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FControlRigSequenceObjectReferences_Statics::NewProp_Array_Inner = { "Array", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FControlRigSequenceObjectReference, METADATA_PARAMS(nullptr, 0) }; // 1998730519
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FControlRigSequenceObjectReferences_Statics::NewProp_Array = { "Array", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FControlRigSequenceObjectReferences, Array), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FControlRigSequenceObjectReferences_Statics::NewProp_Array_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FControlRigSequenceObjectReferences_Statics::NewProp_Array_MetaData)) }; // 1998730519
...
class UScriptStruct* FControlRigSequenceObjectReferenceMap::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigSequenceObjectReferenceMap.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigSequenceObjectReferenceMap, Z_Construct_UPackage__Script_ControlRig(), TEXT("ControlRigSequenceObjectReferenceMap"));
	}
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FControlRigSequenceObjectReferenceMap_Statics::NewProp_BindingIds = { "BindingIds", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FControlRigSequenceObjectReferenceMap, BindingIds), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FControlRigSequenceObjectReferenceMap_Statics::NewProp_BindingIds_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FControlRigSequenceObjectReferenceMap_Statics::NewProp_BindingIds_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FControlRigSequenceObjectReferenceMap_Statics::NewProp_References_Inner = { "References", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FControlRigSequenceObjectReferences, METADATA_PARAMS(nullptr, 0) }; // 3802484087
#if WITH_METADATA
