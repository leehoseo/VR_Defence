...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UControlRigObjectHolder_Statics::NewProp_Objects = { "Objects", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UControlRigObjectHolder, Objects), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UControlRigObjectHolder_Statics::NewProp_Objects_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigObjectHolder_Statics::NewProp_Objects_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Sequencer_ControlRigObjectSpawner_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UControlRigObjectHolder, UControlRigObjectHolder::StaticClass, TEXT("UControlRigObjectHolder"), &Z_Registration_Info_UClass_UControlRigObjectHolder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigObjectHolder), 1218736699U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Sequencer_ControlRigObjectSpawner_h_2185559276(TEXT("/Script/ControlRig"),
