...
class UScriptStruct* FRigUnit_GetInitialBoneTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_GetInitialBoneTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_GetInitialBoneTransform"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_GetInitialBoneTransform::Execute"), &FRigUnit_GetInitialBoneTransform::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_GetInitialBoneTransform.OuterSingleton);
	}
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetInitialBoneTransform, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetInitialBoneTransform, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_Transform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_CachedBone = { "CachedBone", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetInitialBoneTransform, CachedBone), Z_Construct_UScriptStruct_FCachedRigElement, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_CachedBone_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewProp_CachedBone_MetaData)) }; // 466782542
...
void FRigUnit_GetInitialBoneTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetInitialBoneTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetInitialBoneTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetInitialBoneTransform_Statics::NewStructOps, TEXT("RigUnit_GetInitialBoneTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetInitialBoneTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetInitialBoneTransform), 1034921559U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetInitialBoneTransform_h_2589926611(TEXT("/Script/ControlRig"),
		nullptr, 0,
