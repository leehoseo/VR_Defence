...
class UScriptStruct* FAnimNode_ControlRigInputPose::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_ControlRigInputPose.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_ControlRigInputPose, Z_Construct_UPackage__Script_ControlRig(), TEXT("AnimNode_ControlRigInputPose"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigInputPose_Statics::NewProp_InputPose = { "InputPose", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ControlRigInputPose, InputPose), Z_Construct_UScriptStruct_FPoseLink, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRigInputPose_Statics::NewProp_InputPose_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRigInputPose_Statics::NewProp_InputPose_MetaData)) }; // 2393943538
...
class UScriptStruct* FControlRigLayerInstanceProxy::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigLayerInstanceProxy.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigLayerInstanceProxy, Z_Construct_UPackage__Script_ControlRig(), TEXT("ControlRigLayerInstanceProxy"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FControlRigLayerInstanceProxy>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Sequencer_ControlRigLayerInstanceProxy_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_ControlRigInputPose::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_ControlRigInputPose_Statics::NewStructOps, TEXT("AnimNode_ControlRigInputPose"), &Z_Registration_Info_UScriptStruct_AnimNode_ControlRigInputPose, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_ControlRigInputPose), 3351992009U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Sequencer_ControlRigLayerInstanceProxy_h_432000411(TEXT("/Script/ControlRig"),
		nullptr, 0,
