...
class UScriptStruct* FRigUnit_ModifyBoneTransforms_PerBone::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_ModifyBoneTransforms_PerBone.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_PerBone, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_ModifyBoneTransforms_PerBone"));
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_PerBone_Statics::NewProp_Bone = { "Bone", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyBoneTransforms_PerBone, Bone), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_PerBone_Statics::NewProp_Bone_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_PerBone_Statics::NewProp_Bone_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_PerBone_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyBoneTransforms_PerBone, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_PerBone_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_PerBone_Statics::NewProp_Transform_MetaData)) };
...
class UScriptStruct* FRigUnit_ModifyBoneTransforms_WorkData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_ModifyBoneTransforms_WorkData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_WorkData, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_ModifyBoneTransforms_WorkData"));
	}
...
class UScriptStruct* FRigUnit_ModifyBoneTransforms::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_ModifyBoneTransforms.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_ModifyBoneTransforms"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_ModifyBoneTransforms::Execute"), &FRigUnit_ModifyBoneTransforms::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_ModifyBoneTransforms.OuterSingleton);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_ModifyBoneTransforms>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_Statics::NewProp_BoneToModify_Inner = { "BoneToModify", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_PerBone, METADATA_PARAMS(nullptr, 0) }; // 4183556299
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyBoneTransforms, Mode), Z_Construct_UEnum_ControlRig_EControlRigModifyBoneMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_Statics::NewProp_Mode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_Statics::NewProp_Mode_MetaData)) }; // 3240575816
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_Statics::NewProp_WorkData = { "WorkData", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_ModifyBoneTransforms, WorkData), Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_WorkData, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_Statics::NewProp_WorkData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_ModifyBoneTransforms_Statics::NewProp_WorkData_MetaData)) }; // 2702658096
...
void FRigUnit_ModifyBoneTransforms::Execute(const FRigUnitContext & Context)
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Highlevel_Hierarchy_RigUnit_ModifyBoneTransforms_h_4176812754(TEXT("/Script/ControlRig"),
		nullptr, 0,
