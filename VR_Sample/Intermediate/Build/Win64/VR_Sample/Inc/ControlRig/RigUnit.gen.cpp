...
class UScriptStruct* FRigUnit::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit"));
	}
...
class UScriptStruct* FRigUnitMutable::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnitMutable.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnitMutable, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnitMutable"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnitMutable>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnitMutable_Statics::NewProp_ExecuteContext = { "ExecuteContext", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnitMutable, ExecuteContext), Z_Construct_UScriptStruct_FControlRigExecuteContext, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnitMutable_Statics::NewProp_ExecuteContext_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnitMutable_Statics::NewProp_ExecuteContext_MetaData)) }; // 1688564855
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigUnit_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_Statics::NewStructOps, TEXT("RigUnit"), &Z_Registration_Info_UScriptStruct_RigUnit, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit), 247648638U) },
		{ FRigUnitMutable::StaticStruct, Z_Construct_UScriptStruct_FRigUnitMutable_Statics::NewStructOps, TEXT("RigUnitMutable"), &Z_Registration_Info_UScriptStruct_RigUnitMutable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnitMutable), 991370574U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_RigUnit_h_3612221768(TEXT("/Script/ControlRig"),
		nullptr, 0,
