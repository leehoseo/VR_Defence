...
class UScriptStruct* FRigUnit_SetBoneTranslation::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_SetBoneTranslation.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_SetBoneTranslation"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_SetBoneTranslation::Execute"), &FRigUnit_SetBoneTranslation::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_SetBoneTranslation.OuterSingleton);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_SetBoneTranslation>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_Bone = { "Bone", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SetBoneTranslation, Bone), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_Bone_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_Bone_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SetBoneTranslation, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_Weight = { "Weight", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SetBoneTranslation, Weight), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_Weight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_Weight_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_bPropagateToChildren = { "bPropagateToChildren", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRigUnit_SetBoneTranslation), &Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_bPropagateToChildren_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_bPropagateToChildren_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewProp_bPropagateToChildren_MetaData)) };
#if WITH_METADATA
...
void FRigUnit_SetBoneTranslation::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetBoneTranslation_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_SetBoneTranslation::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SetBoneTranslation_Statics::NewStructOps, TEXT("RigUnit_SetBoneTranslation"), &Z_Registration_Info_UScriptStruct_RigUnit_SetBoneTranslation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SetBoneTranslation), 2073504208U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SetBoneTranslation_h_139073088(TEXT("/Script/ControlRig"),
		nullptr, 0,
