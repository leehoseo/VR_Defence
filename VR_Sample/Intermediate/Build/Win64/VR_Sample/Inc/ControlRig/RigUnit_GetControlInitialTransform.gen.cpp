...
#include "ControlRig/Private/Units/Hierarchy/RigUnit_GetControlInitialTransform.h"
...
class UScriptStruct* FRigUnit_GetControlInitialTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_GetControlInitialTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_GetControlInitialTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_GetControlInitialTransform"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_GetControlInitialTransform::Execute"), &FRigUnit_GetControlInitialTransform::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_GetControlInitialTransform.OuterSingleton);
	}
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetControlInitialTransform_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetControlInitialTransform, Space), Z_Construct_UEnum_ControlRig_EBoneGetterSetterMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetControlInitialTransform_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetControlInitialTransform_Statics::NewProp_Space_MetaData)) }; // 899847808
#if WITH_METADATA
...
void FRigUnit_GetControlInitialTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetControlInitialTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetControlInitialTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetControlInitialTransform_Statics::NewStructOps, TEXT("RigUnit_GetControlInitialTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_GetControlInitialTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetControlInitialTransform), 2795296915U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetControlInitialTransform_h_2715471962(TEXT("/Script/ControlRig"),
		nullptr, 0,
