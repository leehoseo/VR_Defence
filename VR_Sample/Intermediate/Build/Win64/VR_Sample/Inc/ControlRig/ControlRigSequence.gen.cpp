...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UControlRigSequence_Statics::NewProp_LastExportedToAnimationSequence = { "LastExportedToAnimationSequence", nullptr, (EPropertyFlags)0x0014010000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UControlRigSequence, LastExportedToAnimationSequence), Z_Construct_UClass_UAnimSequence_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UControlRigSequence_Statics::NewProp_LastExportedToAnimationSequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigSequence_Statics::NewProp_LastExportedToAnimationSequence_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UControlRigSequence_Statics::NewProp_LastExportedFrameRate = { "LastExportedFrameRate", nullptr, (EPropertyFlags)0x0010010000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UControlRigSequence, LastExportedFrameRate), METADATA_PARAMS(Z_Construct_UClass_UControlRigSequence_Statics::NewProp_LastExportedFrameRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UControlRigSequence_Statics::NewProp_LastExportedFrameRate_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Sequencer_ControlRigSequence_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UControlRigSequence, UControlRigSequence::StaticClass, TEXT("UControlRigSequence"), &Z_Registration_Info_UClass_UControlRigSequence, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigSequence), 3432637026U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Sequencer_ControlRigSequence_h_3914802215(TEXT("/Script/ControlRig"),
