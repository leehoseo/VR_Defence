...
class UScriptStruct* FRigUnit_AddBoneTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_AddBoneTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_AddBoneTransform"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_AddBoneTransform::Execute"), &FRigUnit_AddBoneTransform::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_AddBoneTransform.OuterSingleton);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_AddBoneTransform>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_Weight = { "Weight", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_AddBoneTransform, Weight), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_Weight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_Weight_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_bPostMultiply = { "bPostMultiply", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRigUnit_AddBoneTransform), &Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_bPostMultiply_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_bPostMultiply_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_bPostMultiply_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_bPropagateToChildren = { "bPropagateToChildren", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRigUnit_AddBoneTransform), &Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_bPropagateToChildren_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_bPropagateToChildren_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewProp_bPropagateToChildren_MetaData)) };
#if WITH_METADATA
...
void FRigUnit_AddBoneTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Hierarchy_RigUnit_AddBoneTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_AddBoneTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_AddBoneTransform_Statics::NewStructOps, TEXT("RigUnit_AddBoneTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_AddBoneTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_AddBoneTransform), 2535949385U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Units_Hierarchy_RigUnit_AddBoneTransform_h_134690145(TEXT("/Script/ControlRig"),
		nullptr, 0,
