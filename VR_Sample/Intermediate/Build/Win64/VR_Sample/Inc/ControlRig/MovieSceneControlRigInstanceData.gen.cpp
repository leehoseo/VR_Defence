...
class UScriptStruct* FMovieSceneControlRigInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneControlRigInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData, Z_Construct_UPackage__Script_ControlRig(), TEXT("MovieSceneControlRigInstanceData"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FMovieSceneControlRigInstanceData>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_bAdditive = { "bAdditive", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMovieSceneControlRigInstanceData), &Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_bAdditive_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_bAdditive_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_bAdditive_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_bApplyBoneFilter = { "bApplyBoneFilter", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMovieSceneControlRigInstanceData), &Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_bApplyBoneFilter_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_bApplyBoneFilter_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_bApplyBoneFilter_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_BoneFilter = { "BoneFilter", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneControlRigInstanceData, BoneFilter), Z_Construct_UScriptStruct_FInputBlendPose, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_BoneFilter_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_BoneFilter_MetaData)) }; // 3313333549
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_Weight = { "Weight", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneControlRigInstanceData, Weight), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_Weight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_Weight_MetaData)) }; // 312122321
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_Operand = { "Operand", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneControlRigInstanceData, Operand), Z_Construct_UScriptStruct_FMovieSceneEvaluationOperand, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_Operand_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewProp_Operand_MetaData)) }; // 2794607995
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Sequencer_MovieSceneControlRigInstanceData_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneControlRigInstanceData::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneControlRigInstanceData_Statics::NewStructOps, TEXT("MovieSceneControlRigInstanceData"), &Z_Registration_Info_UScriptStruct_MovieSceneControlRigInstanceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneControlRigInstanceData), 3277433907U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Sequencer_MovieSceneControlRigInstanceData_h_3708884042(TEXT("/Script/ControlRig"),
		nullptr, 0,
