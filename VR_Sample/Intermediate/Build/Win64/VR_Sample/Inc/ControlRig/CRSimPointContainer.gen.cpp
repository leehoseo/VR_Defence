...
class UScriptStruct* FCRSimPointContainer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CRSimPointContainer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCRSimPointContainer, Z_Construct_UPackage__Script_ControlRig(), TEXT("CRSimPointContainer"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FCRSimPointContainer>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Points_Inner = { "Points", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FCRSimPoint, METADATA_PARAMS(nullptr, 0) }; // 3211597404
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Points = { "Points", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimPointContainer, Points), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Points_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Points_MetaData)) }; // 3211597404
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Springs_Inner = { "Springs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FCRSimLinearSpring, METADATA_PARAMS(nullptr, 0) }; // 2707267003
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Springs = { "Springs", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimPointContainer, Springs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Springs_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Springs_MetaData)) }; // 2707267003
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Forces_Inner = { "Forces", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FCRSimPointForce, METADATA_PARAMS(nullptr, 0) }; // 3597509540
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Forces = { "Forces", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimPointContainer, Forces), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Forces_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Forces_MetaData)) }; // 3597509540
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_CollisionVolumes_Inner = { "CollisionVolumes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FCRSimSoftCollision, METADATA_PARAMS(nullptr, 0) }; // 3679822969
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_CollisionVolumes = { "CollisionVolumes", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimPointContainer, CollisionVolumes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_CollisionVolumes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_CollisionVolumes_MetaData)) }; // 3679822969
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Constraints_Inner = { "Constraints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FCRSimPointConstraint, METADATA_PARAMS(nullptr, 0) }; // 1020401862
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Constraints = { "Constraints", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimPointContainer, Constraints), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Constraints_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_Constraints_MetaData)) }; // 1020401862
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_PreviousStep_Inner = { "PreviousStep", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FCRSimPoint, METADATA_PARAMS(nullptr, 0) }; // 3211597404
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_PreviousStep = { "PreviousStep", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimPointContainer, PreviousStep), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_PreviousStep_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewProp_PreviousStep_MetaData)) }; // 3211597404
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Math_Simulation_CRSimPointContainer_h_Statics::ScriptStructInfo[] = {
		{ FCRSimPointContainer::StaticStruct, Z_Construct_UScriptStruct_FCRSimPointContainer_Statics::NewStructOps, TEXT("CRSimPointContainer"), &Z_Registration_Info_UScriptStruct_CRSimPointContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCRSimPointContainer), 3773440436U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Math_Simulation_CRSimPointContainer_h_3168745470(TEXT("/Script/ControlRig"),
		nullptr, 0,
