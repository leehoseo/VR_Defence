...
class UScriptStruct* FRigUnit_DrawContainerGetInstruction::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerGetInstruction.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_DrawContainerGetInstruction, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_DrawContainerGetInstruction"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_DrawContainerGetInstruction::Execute"), &FRigUnit_DrawContainerGetInstruction::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerGetInstruction.OuterSingleton);
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_DrawContainerGetInstruction_Statics::NewProp_InstructionName = { "InstructionName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_DrawContainerGetInstruction, InstructionName), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_DrawContainerGetInstruction_Statics::NewProp_InstructionName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_DrawContainerGetInstruction_Statics::NewProp_InstructionName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_DrawContainerGetInstruction_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_DrawContainerGetInstruction, Color), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_DrawContainerGetInstruction_Statics::NewProp_Color_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_DrawContainerGetInstruction_Statics::NewProp_Color_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_DrawContainerGetInstruction_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_DrawContainerGetInstruction, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_DrawContainerGetInstruction_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_DrawContainerGetInstruction_Statics::NewProp_Transform_MetaData)) };
...
class UScriptStruct* FRigUnit_DrawContainerSetColor::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerSetColor.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_DrawContainerSetColor, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_DrawContainerSetColor"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_DrawContainerSetColor::Execute"), &FRigUnit_DrawContainerSetColor::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerSetColor.OuterSingleton);
	}
...
class UScriptStruct* FRigUnit_DrawContainerSetThickness::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerSetThickness.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_DrawContainerSetThickness, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_DrawContainerSetThickness"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_DrawContainerSetThickness::Execute"), &FRigUnit_DrawContainerSetThickness::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerSetThickness.OuterSingleton);
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_DrawContainerSetThickness_Statics::NewProp_InstructionName = { "InstructionName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_DrawContainerSetThickness, InstructionName), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_DrawContainerSetThickness_Statics::NewProp_InstructionName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_DrawContainerSetThickness_Statics::NewProp_InstructionName_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FRigUnit_DrawContainerSetTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerSetTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_DrawContainerSetTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_DrawContainerSetTransform"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_DrawContainerSetTransform::Execute"), &FRigUnit_DrawContainerSetTransform::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerSetTransform.OuterSingleton);
	}
...
void FRigUnit_DrawContainerSetTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Drawing_RigUnit_DrawContainer_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigUnit_DrawContainerSetTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_DrawContainerSetTransform_Statics::NewStructOps, TEXT("RigUnit_DrawContainerSetTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_DrawContainerSetTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_DrawContainerSetTransform), 2938295157U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Drawing_RigUnit_DrawContainer_h_783066201(TEXT("/Script/ControlRig"),
		nullptr, 0,
