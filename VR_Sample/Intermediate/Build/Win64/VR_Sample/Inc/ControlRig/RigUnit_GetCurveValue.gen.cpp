...
class UScriptStruct* FRigUnit_GetCurveValue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_GetCurveValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_GetCurveValue, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_GetCurveValue"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_GetCurveValue::Execute"), &FRigUnit_GetCurveValue::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_GetCurveValue.OuterSingleton);
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Curve = { "Curve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetCurveValue, Curve), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Curve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Curve_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetCurveValue, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_Value_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_CachedCurveIndex = { "CachedCurveIndex", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_GetCurveValue, CachedCurveIndex), Z_Construct_UScriptStruct_FCachedRigElement, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_CachedCurveIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewProp_CachedCurveIndex_MetaData)) }; // 466782542
...
void FRigUnit_GetCurveValue::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetCurveValue_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_GetCurveValue::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_GetCurveValue_Statics::NewStructOps, TEXT("RigUnit_GetCurveValue"), &Z_Registration_Info_UScriptStruct_RigUnit_GetCurveValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_GetCurveValue), 2153376698U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_GetCurveValue_h_2771515898(TEXT("/Script/ControlRig"),
		nullptr, 0,
