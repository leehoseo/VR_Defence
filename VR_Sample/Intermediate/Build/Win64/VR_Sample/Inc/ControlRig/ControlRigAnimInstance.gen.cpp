...
class UScriptStruct* FControlRigAnimInstanceProxy::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigAnimInstanceProxy.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigAnimInstanceProxy, Z_Construct_UPackage__Script_ControlRig(), TEXT("ControlRigAnimInstanceProxy"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FControlRigAnimInstanceProxy>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_ControlRigAnimInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UControlRigAnimInstance, UControlRigAnimInstance::StaticClass, TEXT("UControlRigAnimInstance"), &Z_Registration_Info_UClass_UControlRigAnimInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UControlRigAnimInstance), 190144603U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_ControlRigAnimInstance_h_339261041(TEXT("/Script/ControlRig"),
