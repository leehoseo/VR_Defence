...
class UScriptStruct* FRigUnit_SendEvent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_SendEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_SendEvent, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_SendEvent"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_SendEvent::Execute"), &FRigUnit_SendEvent::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_SendEvent.OuterSingleton);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_SendEvent>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Event_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Event = { "Event", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SendEvent, Event), Z_Construct_UEnum_ControlRig_ERigEvent, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Event_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Event_MetaData)) }; // 3018116079
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Item = { "Item", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SendEvent, Item), Z_Construct_UScriptStruct_FRigElementKey, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Item_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_Item_MetaData)) }; // 3202328731
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_OffsetInSeconds = { "OffsetInSeconds", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigUnit_SendEvent, OffsetInSeconds), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_OffsetInSeconds_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_OffsetInSeconds_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_bOnlyDuringInteraction = { "bOnlyDuringInteraction", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRigUnit_SendEvent), &Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_bOnlyDuringInteraction_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_bOnlyDuringInteraction_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewProp_bOnlyDuringInteraction_MetaData)) };
...
void FRigUnit_SendEvent::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SendEvent_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_SendEvent::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_SendEvent_Statics::NewStructOps, TEXT("RigUnit_SendEvent"), &Z_Registration_Info_UScriptStruct_RigUnit_SendEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_SendEvent), 2566188579U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_SendEvent_h_2736669313(TEXT("/Script/ControlRig"),
		nullptr, 0,
