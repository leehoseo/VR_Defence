...
// End Cross Module References
	...
	static UEnum* ECRSimSoftCollisionType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECRSimSoftCollisionType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ControlRig_ECRSimSoftCollisionType, Z_Construct_UPackage__Script_ControlRig(), TEXT("ECRSimSoftCollisionType"));
		}
...
class UScriptStruct* FCRSimSoftCollision::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CRSimSoftCollision.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCRSimSoftCollision, Z_Construct_UPackage__Script_ControlRig(), TEXT("CRSimSoftCollision"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FCRSimSoftCollision>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimSoftCollision, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_Transform_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_ShapeType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_ShapeType = { "ShapeType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimSoftCollision, ShapeType), Z_Construct_UEnum_ControlRig_ECRSimSoftCollisionType, METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_ShapeType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_ShapeType_MetaData)) }; // 3507775989
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_MinimumDistance = { "MinimumDistance", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimSoftCollision, MinimumDistance), METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_MinimumDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_MinimumDistance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_MaximumDistance = { "MaximumDistance", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimSoftCollision, MaximumDistance), METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_MaximumDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_MaximumDistance_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_FalloffType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_FalloffType = { "FalloffType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimSoftCollision, FalloffType), Z_Construct_UEnum_ControlRig_EControlRigAnimEasingType, METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_FalloffType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_FalloffType_MetaData)) }; // 3463141811
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_Coefficient = { "Coefficient", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCRSimSoftCollision, Coefficient), METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_Coefficient_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_Coefficient_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_bInverted = { "bInverted", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FCRSimSoftCollision), &Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_bInverted_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_bInverted_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewProp_bInverted_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Math_Simulation_CRSimSoftCollision_h_Statics::ScriptStructInfo[] = {
		{ FCRSimSoftCollision::StaticStruct, Z_Construct_UScriptStruct_FCRSimSoftCollision_Statics::NewStructOps, TEXT("CRSimSoftCollision"), &Z_Registration_Info_UScriptStruct_CRSimSoftCollision, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCRSimSoftCollision), 3679822969U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_Math_Simulation_CRSimSoftCollision_h_3009803226(TEXT("/Script/ControlRig"),
		nullptr, 0,
