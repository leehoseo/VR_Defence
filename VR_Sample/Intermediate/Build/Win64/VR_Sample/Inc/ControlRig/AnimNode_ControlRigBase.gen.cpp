...
class UScriptStruct* FControlRigIOSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ControlRigIOSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FControlRigIOSettings, Z_Construct_UPackage__Script_ControlRig(), TEXT("ControlRigIOSettings"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FControlRigIOSettings>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FControlRigIOSettings_Statics::NewProp_bUpdateCurves = { "bUpdateCurves", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FControlRigIOSettings), &Z_Construct_UScriptStruct_FControlRigIOSettings_Statics::NewProp_bUpdateCurves_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FControlRigIOSettings_Statics::NewProp_bUpdateCurves_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FControlRigIOSettings_Statics::NewProp_bUpdateCurves_MetaData)) };
...
class UScriptStruct* FAnimNode_ControlRigBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_ControlRigBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase, Z_Construct_UPackage__Script_ControlRig(), TEXT("AnimNode_ControlRigBase"));
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FAnimNode_ControlRigBase>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_Source = { "Source", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ControlRigBase, Source), Z_Construct_UScriptStruct_FPoseLink, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_Source_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_Source_MetaData)) }; // 2393943538
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bResetInputPoseToInitial = { "bResetInputPoseToInitial", nullptr, (EPropertyFlags)0x00200c0000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNode_ControlRigBase), &Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bResetInputPoseToInitial_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bResetInputPoseToInitial_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bResetInputPoseToInitial_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferInputPose = { "bTransferInputPose", nullptr, (EPropertyFlags)0x00200c0000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNode_ControlRigBase), &Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferInputPose_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferInputPose_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferInputPose_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferInputCurves = { "bTransferInputCurves", nullptr, (EPropertyFlags)0x00200c0000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNode_ControlRigBase), &Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferInputCurves_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferInputCurves_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferInputCurves_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferPoseInGlobalSpace = { "bTransferPoseInGlobalSpace", nullptr, (EPropertyFlags)0x00200c0000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNode_ControlRigBase), &Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferPoseInGlobalSpace_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferPoseInGlobalSpace_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bTransferPoseInGlobalSpace_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_InputBonesToTransfer_Inner = { "InputBonesToTransfer", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(nullptr, 0) }; // 831728502
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_InputBonesToTransfer = { "InputBonesToTransfer", nullptr, (EPropertyFlags)0x00200c0000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ControlRigBase, InputBonesToTransfer), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_InputBonesToTransfer_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_InputBonesToTransfer_MetaData)) }; // 831728502
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_InputSettings = { "InputSettings", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ControlRigBase, InputSettings), Z_Construct_UScriptStruct_FControlRigIOSettings, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_InputSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_InputSettings_MetaData)) }; // 2494571379
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_OutputSettings = { "OutputSettings", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ControlRigBase, OutputSettings), Z_Construct_UScriptStruct_FControlRigIOSettings, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_OutputSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_OutputSettings_MetaData)) }; // 2494571379
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bExecute = { "bExecute", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNode_ControlRigBase), &Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bExecute_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bExecute_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewProp_bExecute_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_AnimNode_ControlRigBase_h_Statics::ScriptStructInfo[] = {
		{ FControlRigIOSettings::StaticStruct, Z_Construct_UScriptStruct_FControlRigIOSettings_Statics::NewStructOps, TEXT("ControlRigIOSettings"), &Z_Registration_Info_UScriptStruct_ControlRigIOSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FControlRigIOSettings), 2494571379U) },
		{ FAnimNode_ControlRigBase::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_ControlRigBase_Statics::NewStructOps, TEXT("AnimNode_ControlRigBase"), &Z_Registration_Info_UScriptStruct_AnimNode_ControlRigBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_ControlRigBase), 372130792U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Public_AnimNode_ControlRigBase_h_3139740535(TEXT("/Script/ControlRig"),
		nullptr, 0,
