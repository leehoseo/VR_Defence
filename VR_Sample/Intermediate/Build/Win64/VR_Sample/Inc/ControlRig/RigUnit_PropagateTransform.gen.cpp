...
class UScriptStruct* FRigUnit_PropagateTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigUnit_PropagateTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigUnit_PropagateTransform, Z_Construct_UPackage__Script_ControlRig(), TEXT("RigUnit_PropagateTransform"));
		FRigVMRegistry::Get().Register(TEXT("FRigUnit_PropagateTransform::Execute"), &FRigUnit_PropagateTransform::RigVMExecute, Z_Registration_Info_UScriptStruct_RigUnit_PropagateTransform.OuterSingleton);
	}
...
template<> CONTROLRIG_API UScriptStruct* StaticStruct<FRigUnit_PropagateTransform>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRigUnit_PropagateTransform_Statics::NewProp_bRecomputeGlobal = { "bRecomputeGlobal", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRigUnit_PropagateTransform), &Z_Construct_UScriptStruct_FRigUnit_PropagateTransform_Statics::NewProp_bRecomputeGlobal_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigUnit_PropagateTransform_Statics::NewProp_bRecomputeGlobal_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigUnit_PropagateTransform_Statics::NewProp_bRecomputeGlobal_MetaData)) };
#if WITH_METADATA
...
void FRigUnit_PropagateTransform::Execute(const FRigUnitContext & Context)
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_PropagateTransform_h_Statics::ScriptStructInfo[] = {
		{ FRigUnit_PropagateTransform::StaticStruct, Z_Construct_UScriptStruct_FRigUnit_PropagateTransform_Statics::NewStructOps, TEXT("RigUnit_PropagateTransform"), &Z_Registration_Info_UScriptStruct_RigUnit_PropagateTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigUnit_PropagateTransform), 2926757671U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Animation_ControlRig_Source_ControlRig_Private_Units_Hierarchy_RigUnit_PropagateTransform_h_3679763287(TEXT("/Script/ControlRig"),
		nullptr, 0,
