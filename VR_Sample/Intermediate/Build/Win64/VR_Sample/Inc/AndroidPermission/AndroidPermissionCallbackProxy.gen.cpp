...
// End Cross Module References
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::NewProp_Permissions_Inner = { "Permissions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::NewProp_Permissions_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::NewProp_Permissions = { "Permissions", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_AndroidPermission_eventAndroidPermissionDynamicDelegate_Parms, Permissions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::NewProp_Permissions_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::NewProp_Permissions_MetaData)) };
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::NewProp_GrantResults_Inner = { "GrantResults", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::NewProp_GrantResults_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::NewProp_GrantResults = { "GrantResults", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_AndroidPermission_eventAndroidPermissionDynamicDelegate_Parms, GrantResults), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::NewProp_GrantResults_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::NewProp_GrantResults_MetaData)) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Classes/AndroidPermissionCallbackProxy.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_AndroidPermission, nullptr, "AndroidPermissionDynamicDelegate__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::_Script_AndroidPermission_eventAndroidPermissionDynamicDelegate_Parms), Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_OnPermissionsGrantedDynamicDelegate_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidPermissionCallbackProxy_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AndroidPermissionCallbackProxy.h" },
		{ "ModuleRelativePath", "Classes/AndroidPermissionCallbackProxy.h" },
	};
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidPermissionCallbackProxy_Statics::NewProp_OnPermissionsGrantedDynamicDelegate_MetaData[] = {
		{ "Category", "AndroidPermission" },
		{ "ModuleRelativePath", "Classes/AndroidPermissionCallbackProxy.h" },
	};
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAndroidPermissionCallbackProxy_Statics::NewProp_OnPermissionsGrantedDynamicDelegate = { "OnPermissionsGrantedDynamicDelegate", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidPermissionCallbackProxy, OnPermissionsGrantedDynamicDelegate), Z_Construct_UDelegateFunction_AndroidPermission_AndroidPermissionDynamicDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAndroidPermissionCallbackProxy_Statics::NewProp_OnPermissionsGrantedDynamicDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidPermissionCallbackProxy_Statics::NewProp_OnPermissionsGrantedDynamicDelegate_MetaData)) }; // 966949503
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UAndroidPermissionCallbackProxy_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UAndroidPermissionCallbackProxy_Statics::ClassParams = {
		...
		0,
		0x009000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UAndroidPermissionCallbackProxy_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidPermissionCallbackProxy_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AndroidPermission_Source_AndroidPermission_Classes_AndroidPermissionCallbackProxy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAndroidPermissionCallbackProxy, UAndroidPermissionCallbackProxy::StaticClass, TEXT("UAndroidPermissionCallbackProxy"), &Z_Registration_Info_UClass_UAndroidPermissionCallbackProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAndroidPermissionCallbackProxy), 3750714823U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AndroidPermission_Source_AndroidPermission_Classes_AndroidPermissionCallbackProxy_h_133496495(TEXT("/Script/AndroidPermission"),
