...
// End Cross Module References
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UVariantSet_GetDisplayText_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventGetDisplayText_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UVariantSet_GetNumVariants_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventGetNumVariants_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVariantSet_GetParent_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventGetParent_Parms, ReturnValue), Z_Construct_UClass_ULevelVariantSets_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVariantSet_GetThumbnail_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventGetThumbnail_Parms, ReturnValue), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UVariantSet_GetVariant_Statics::NewProp_VariantIndex = { "VariantIndex", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventGetVariant_Parms, VariantIndex), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVariantSet_GetVariant_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventGetVariant_Parms, ReturnValue), Z_Construct_UClass_UVariant_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::NewProp_VariantName = { "VariantName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventGetVariantByName_Parms, VariantName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVariantSet_GetVariantByName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventGetVariantByName_Parms, ReturnValue), Z_Construct_UClass_UVariant_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVariantSet_SetThumbnailFromCamera_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventSetThumbnailFromCamera_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UVariantSet_SetThumbnailFromCamera_Statics::NewProp_CameraTransform = { "CameraTransform", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventSetThumbnailFromCamera_Parms, CameraTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UFunction_UVariantSet_SetThumbnailFromCamera_Statics::NewProp_CameraTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UVariantSet_SetThumbnailFromCamera_Statics::NewProp_CameraTransform_MetaData)) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UVariantSet_SetThumbnailFromCamera_Statics::NewProp_FOVDegrees = { "FOVDegrees", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventSetThumbnailFromCamera_Parms, FOVDegrees), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UVariantSet_SetThumbnailFromCamera_Statics::NewProp_MinZ = { "MinZ", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventSetThumbnailFromCamera_Parms, MinZ), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UVariantSet_SetThumbnailFromCamera_Statics::NewProp_Gamma = { "Gamma", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventSetThumbnailFromCamera_Parms, Gamma), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UVariantSet_SetThumbnailFromFile_Statics::NewProp_FilePath = { "FilePath", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventSetThumbnailFromFile_Parms, FilePath), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UVariantSet_SetThumbnailFromTexture_Statics::NewProp_NewThumbnail = { "NewThumbnail", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(VariantSet_eventSetThumbnailFromTexture_Parms, NewThumbnail), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVariantSet_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVariantSet_GetDisplayText, "GetDisplayText" }, // 200611761
		{ &Z_Construct_UFunction_UVariantSet_GetNumVariants, "GetNumVariants" }, // 992567057
		{ &Z_Construct_UFunction_UVariantSet_GetParent, "GetParent" }, // 1903467100
		{ &Z_Construct_UFunction_UVariantSet_GetThumbnail, "GetThumbnail" }, // 1791224126
		{ &Z_Construct_UFunction_UVariantSet_GetVariant, "GetVariant" }, // 767790802
		{ &Z_Construct_UFunction_UVariantSet_GetVariantByName, "GetVariantByName" }, // 954940307
		{ &Z_Construct_UFunction_UVariantSet_SetDisplayText, "SetDisplayText" }, // 561580119
		{ &Z_Construct_UFunction_UVariantSet_SetThumbnailFromCamera, "SetThumbnailFromCamera" }, // 10945338
		{ &Z_Construct_UFunction_UVariantSet_SetThumbnailFromEditorViewport, "SetThumbnailFromEditorViewport" }, // 2369685428
		{ &Z_Construct_UFunction_UVariantSet_SetThumbnailFromFile, "SetThumbnailFromFile" }, // 876038251
		{ &Z_Construct_UFunction_UVariantSet_SetThumbnailFromTexture, "SetThumbnailFromTexture" }, // 525054239
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_VariantSet_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVariantSet, UVariantSet::StaticClass, TEXT("UVariantSet"), &Z_Registration_Info_UClass_UVariantSet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVariantSet), 1580021221U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_VariantSet_h_551235418(TEXT("/Script/VariantManagerContent"),
