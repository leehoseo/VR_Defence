...
// End Cross Module References
	...
	static UEnum* EPropertyValueCategory_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPropertyValueCategory.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_VariantManagerContent_EPropertyValueCategory, Z_Construct_UPackage__Script_VariantManagerContent(), TEXT("EPropertyValueCategory"));
		}
...
class UScriptStruct* FCapturedPropSegment::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CapturedPropSegment.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCapturedPropSegment, Z_Construct_UPackage__Script_VariantManagerContent(), TEXT("CapturedPropSegment"));
	}
...
template<> VARIANTMANAGERCONTENT_API UScriptStruct* StaticStruct<FCapturedPropSegment>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FCapturedPropSegment_Statics::NewProp_PropertyName = { "PropertyName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCapturedPropSegment, PropertyName), METADATA_PARAMS(Z_Construct_UScriptStruct_FCapturedPropSegment_Statics::NewProp_PropertyName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCapturedPropSegment_Statics::NewProp_PropertyName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FCapturedPropSegment_Statics::NewProp_PropertyIndex = { "PropertyIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCapturedPropSegment, PropertyIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FCapturedPropSegment_Statics::NewProp_PropertyIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCapturedPropSegment_Statics::NewProp_PropertyIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UPropertyValue_GetFullDisplayString_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PropertyValue_eventGetFullDisplayString_Parms, ReturnValue), METADATA_PARAMS(Z_Construct_UFunction_UPropertyValue_GetFullDisplayString_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UPropertyValue_GetFullDisplayString_Statics::NewProp_ReturnValue_MetaData)) };
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UPropertyValue_GetPropertyTooltip_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PropertyValue_eventGetPropertyTooltip_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPropertyValue_HasRecordedData_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PropertyValue_eventHasRecordedData_Parms), &Z_Construct_UFunction_UPropertyValue_HasRecordedData_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPropertyValue_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPropertyValue_GetFullDisplayString, "GetFullDisplayString" }, // 3785742700
		{ &Z_Construct_UFunction_UPropertyValue_GetPropertyTooltip, "GetPropertyTooltip" }, // 3531492064
		{ &Z_Construct_UFunction_UPropertyValue_HasRecordedData, "HasRecordedData" }, // 491645800
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFieldPathPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_Properties_Inner = { "Properties", nullptr, (EPropertyFlags)0x0000000020000000, UECodeGen_Private::EPropertyGenFlags::FieldPath, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, &FProperty::StaticClass, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_Properties = { "Properties", nullptr, (EPropertyFlags)0x0020080020000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyValue, Properties_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_Properties_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_Properties_MetaData)) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertyIndices_Inner = { "PropertyIndices", nullptr, (EPropertyFlags)0x0000000020000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertyIndices_MetaData[] = {
		{ "ModuleRelativePath", "Public/PropertyValue.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertyIndices = { "PropertyIndices", nullptr, (EPropertyFlags)0x0020080020000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyValue, PropertyIndices_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertyIndices_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertyIndices_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_CapturedPropSegments_Inner = { "CapturedPropSegments", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FCapturedPropSegment, METADATA_PARAMS(nullptr, 0) }; // 2167054408
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_CapturedPropSegments = { "CapturedPropSegments", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyValue, CapturedPropSegments), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_CapturedPropSegments_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_CapturedPropSegments_MetaData)) }; // 2167054408
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPropertyValue_Statics::NewProp_FullDisplayString_MetaData[] = {
		{ "ModuleRelativePath", "Public/PropertyValue.h" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_FullDisplayString = { "FullDisplayString", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyValue, FullDisplayString), METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_FullDisplayString_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_FullDisplayString_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertySetterName_MetaData[] = {
		{ "ModuleRelativePath", "Public/PropertyValue.h" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertySetterName = { "PropertySetterName", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyValue, PropertySetterName), METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertySetterName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertySetterName_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertySetterParameterDefaults_ValueProp = { "PropertySetterParameterDefaults", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertySetterParameterDefaults_Key_KeyProp = { "PropertySetterParameterDefaults_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertySetterParameterDefaults = { "PropertySetterParameterDefaults", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyValue, PropertySetterParameterDefaults), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertySetterParameterDefaults_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropertySetterParameterDefaults_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_bHasRecordedData = { "bHasRecordedData", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPropertyValue), &Z_Construct_UClass_UPropertyValue_Statics::NewProp_bHasRecordedData_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_bHasRecordedData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_bHasRecordedData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPtrPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_LeafPropertyClass = { "LeafPropertyClass", nullptr, (EPropertyFlags)0x0024080020000000, UECodeGen_Private::EPropertyGenFlags::Class | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyValue, LeafPropertyClass_DEPRECATED), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_LeafPropertyClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_LeafPropertyClass_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_ValueBytes_Inner = { "ValueBytes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPropertyValue_Statics::NewProp_ValueBytes_MetaData[] = {
		{ "ModuleRelativePath", "Public/PropertyValue.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_ValueBytes = { "ValueBytes", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyValue, ValueBytes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_ValueBytes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_ValueBytes_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropCategory_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropCategory_MetaData[] = {
		{ "ModuleRelativePath", "Public/PropertyValue.h" },
	};
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropCategory = { "PropCategory", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyValue, PropCategory), Z_Construct_UEnum_VariantManagerContent_EPropertyValueCategory, METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropCategory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_PropCategory_MetaData)) }; // 3588310662
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UPropertyValue_Statics::NewProp_DisplayOrder = { "DisplayOrder", nullptr, (EPropertyFlags)0x0020080800000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPropertyValue, DisplayOrder), METADATA_PARAMS(Z_Construct_UClass_UPropertyValue_Statics::NewProp_DisplayOrder_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPropertyValue_Statics::NewProp_DisplayOrder_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_PropertyValue_h_Statics::ScriptStructInfo[] = {
		{ FCapturedPropSegment::StaticStruct, Z_Construct_UScriptStruct_FCapturedPropSegment_Statics::NewStructOps, TEXT("CapturedPropSegment"), &Z_Registration_Info_UScriptStruct_CapturedPropSegment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCapturedPropSegment), 2167054408U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_PropertyValue_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPropertyValue, UPropertyValue::StaticClass, TEXT("UPropertyValue"), &Z_Registration_Info_UClass_UPropertyValue, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPropertyValue), 3788657526U) },
		{ Z_Construct_UClass_UPropertyValueTransform, UPropertyValueTransform::StaticClass, TEXT("UPropertyValueTransform"), &Z_Registration_Info_UClass_UPropertyValueTransform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPropertyValueTransform), 3008349150U) },
		{ Z_Construct_UClass_UPropertyValueVisibility, UPropertyValueVisibility::StaticClass, TEXT("UPropertyValueVisibility"), &Z_Registration_Info_UClass_UPropertyValueVisibility, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPropertyValueVisibility), 3351912975U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_PropertyValue_h_3246399115(TEXT("/Script/VariantManagerContent"),
