...
class UScriptStruct* FFunctionCaller::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FunctionCaller.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFunctionCaller, Z_Construct_UPackage__Script_VariantManagerContent(), TEXT("FunctionCaller"));
	}
...
template<> VARIANTMANAGERCONTENT_API UScriptStruct* StaticStruct<FFunctionCaller>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FFunctionCaller_Statics::NewProp_FunctionName = { "FunctionName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFunctionCaller, FunctionName), METADATA_PARAMS(Z_Construct_UScriptStruct_FFunctionCaller_Statics::NewProp_FunctionName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFunctionCaller_Statics::NewProp_FunctionName_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FFunctionCaller_Statics::NewProp_FunctionEntry = { "FunctionEntry", nullptr, (EPropertyFlags)0x0044000800000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFunctionCaller, FunctionEntry), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FFunctionCaller_Statics::NewProp_FunctionEntry_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFunctionCaller_Statics::NewProp_FunctionEntry_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_FunctionCaller_h_Statics::ScriptStructInfo[] = {
		{ FFunctionCaller::StaticStruct, Z_Construct_UScriptStruct_FFunctionCaller_Statics::NewStructOps, TEXT("FunctionCaller"), &Z_Registration_Info_UScriptStruct_FunctionCaller, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFunctionCaller), 2366746545U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Enterprise_VariantManagerContent_Source_VariantManagerContent_Public_FunctionCaller_h_3685650370(TEXT("/Script/VariantManagerContent"),
		nullptr, 0,
