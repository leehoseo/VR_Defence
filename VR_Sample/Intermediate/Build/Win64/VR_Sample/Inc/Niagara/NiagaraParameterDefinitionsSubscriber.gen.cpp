...
class UScriptStruct* FParameterDefinitionsSubscription::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ParameterDefinitionsSubscription.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FParameterDefinitionsSubscription, Z_Construct_UPackage__Script_Niagara(), TEXT("ParameterDefinitionsSubscription"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FParameterDefinitionsSubscription>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_Definitions = { "Definitions", nullptr, (EPropertyFlags)0x0014000800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FParameterDefinitionsSubscription, Definitions), Z_Construct_UClass_UNiagaraParameterDefinitionsBase_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_Definitions_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_Definitions_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_CachedChangeIdHash = { "CachedChangeIdHash", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FParameterDefinitionsSubscription, CachedChangeIdHash), METADATA_PARAMS(Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_CachedChangeIdHash_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewProp_CachedChangeIdHash_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraParameterDefinitionsSubscriber_h_Statics::ScriptStructInfo[] = {
		{ FParameterDefinitionsSubscription::StaticStruct, Z_Construct_UScriptStruct_FParameterDefinitionsSubscription_Statics::NewStructOps, TEXT("ParameterDefinitionsSubscription"), &Z_Registration_Info_UScriptStruct_ParameterDefinitionsSubscription, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FParameterDefinitionsSubscription), 1065979301U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraParameterDefinitionsSubscriber_h_1592107494(TEXT("/Script/Niagara"),
		nullptr, 0,
