...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceEmitterProperties_Statics::NewProp_EmitterBinding = { "EmitterBinding", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraDataInterfaceEmitterProperties, EmitterBinding), Z_Construct_UScriptStruct_FNiagaraDataInterfaceEmitterBinding, METADATA_PARAMS(Z_Construct_UClass_UNiagaraDataInterfaceEmitterProperties_Statics::NewProp_EmitterBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceEmitterProperties_Statics::NewProp_EmitterBinding_MetaData)) }; // 1963327109
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_DataInterface_NiagaraDataInterfaceEmitterProperties_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceEmitterProperties, UNiagaraDataInterfaceEmitterProperties::StaticClass, TEXT("UNiagaraDataInterfaceEmitterProperties"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceEmitterProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceEmitterProperties), 1145989302U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_DataInterface_NiagaraDataInterfaceEmitterProperties_h_3990878803(TEXT("/Script/Niagara"),
