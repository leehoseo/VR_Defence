...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceGrid2DCollectionReader_Statics::NewProp_DIName = { "DIName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraDataInterfaceGrid2DCollectionReader, DIName), METADATA_PARAMS(Z_Construct_UClass_UNiagaraDataInterfaceGrid2DCollectionReader_Statics::NewProp_DIName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceGrid2DCollectionReader_Statics::NewProp_DIName_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceGrid2DCollectionReader_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceGrid2DCollectionReader, UNiagaraDataInterfaceGrid2DCollectionReader::StaticClass, TEXT("UNiagaraDataInterfaceGrid2DCollectionReader"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceGrid2DCollectionReader, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceGrid2DCollectionReader), 2373655235U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceGrid2DCollectionReader_h_3466148374(TEXT("/Script/Niagara"),
