...
class UScriptStruct* FMovieSceneNiagaraColorParameterSectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneNiagaraColorParameterSectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate, Z_Construct_UPackage__Script_Niagara(), TEXT("MovieSceneNiagaraColorParameterSectionTemplate"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FMovieSceneNiagaraColorParameterSectionTemplate>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_RedChannel = { "RedChannel", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneNiagaraColorParameterSectionTemplate, RedChannel), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_RedChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_RedChannel_MetaData)) }; // 312122321
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_GreenChannel = { "GreenChannel", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneNiagaraColorParameterSectionTemplate, GreenChannel), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_GreenChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_GreenChannel_MetaData)) }; // 312122321
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_AlphaChannel = { "AlphaChannel", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneNiagaraColorParameterSectionTemplate, AlphaChannel), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_AlphaChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewProp_AlphaChannel_MetaData)) }; // 312122321
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraColorParameterSectionTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneNiagaraColorParameterSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneNiagaraColorParameterSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneNiagaraColorParameterSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneNiagaraColorParameterSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneNiagaraColorParameterSectionTemplate), 1976360078U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraColorParameterSectionTemplate_h_793068812(TEXT("/Script/Niagara"),
		nullptr, 0,
