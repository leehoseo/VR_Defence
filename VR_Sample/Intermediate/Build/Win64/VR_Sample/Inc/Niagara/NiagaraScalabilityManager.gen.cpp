...
class UScriptStruct* FNiagaraScalabilityManager::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraScalabilityManager.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraScalabilityManager, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraScalabilityManager"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraScalabilityManager>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNiagaraScalabilityManager_Statics::NewProp_EffectType = { "EffectType", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraScalabilityManager, EffectType), Z_Construct_UClass_UNiagaraEffectType_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraScalabilityManager_Statics::NewProp_EffectType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraScalabilityManager_Statics::NewProp_EffectType_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNiagaraScalabilityManager_Statics::NewProp_ManagedComponents_Inner = { "ManagedComponents", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UNiagaraComponent_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNiagaraScalabilityManager_Statics::NewProp_ManagedComponents = { "ManagedComponents", nullptr, (EPropertyFlags)0x0014008000002008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraScalabilityManager, ManagedComponents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraScalabilityManager_Statics::NewProp_ManagedComponents_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraScalabilityManager_Statics::NewProp_ManagedComponents_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraScalabilityManager_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraScalabilityManager::StaticStruct, Z_Construct_UScriptStruct_FNiagaraScalabilityManager_Statics::NewStructOps, TEXT("NiagaraScalabilityManager"), &Z_Registration_Info_UScriptStruct_NiagaraScalabilityManager, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraScalabilityManager), 4225549808U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraScalabilityManager_h_3988903004(TEXT("/Script/Niagara"),
		nullptr, 0,
