...
class UScriptStruct* FBasicParticleData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BasicParticleData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBasicParticleData, Z_Construct_UPackage__Script_Niagara(), TEXT("BasicParticleData"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FBasicParticleData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBasicParticleData_Statics::NewProp_Velocity = { "Velocity", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBasicParticleData, Velocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FBasicParticleData_Statics::NewProp_Velocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBasicParticleData_Statics::NewProp_Velocity_MetaData)) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UNiagaraParticleCallbackHandler_ReceiveParticleData_Statics::NewProp_Data_Inner = { "Data", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBasicParticleData, METADATA_PARAMS(nullptr, 0) }; // 3831264198
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UNiagaraParticleCallbackHandler_ReceiveParticleData_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(NiagaraParticleCallbackHandler_eventReceiveParticleData_Parms, Data), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UNiagaraParticleCallbackHandler_ReceiveParticleData_Statics::NewProp_Data_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UNiagaraParticleCallbackHandler_ReceiveParticleData_Statics::NewProp_Data_MetaData)) }; // 3831264198
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UNiagaraParticleCallbackHandler_ReceiveParticleData_Statics::NewProp_NiagaraSystem = { "NiagaraSystem", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(NiagaraParticleCallbackHandler_eventReceiveParticleData_Parms, NiagaraSystem), Z_Construct_UClass_UNiagaraSystem_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNiagaraParticleCallbackHandler_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNiagaraParticleCallbackHandler_ReceiveParticleData, "ReceiveParticleData" }, // 1675669168
	};
#if WITH_METADATA
	...
	static UEnum* ENDIExport_GPUAllocationMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENDIExport_GPUAllocationMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENDIExport_GPUAllocationMode, Z_Construct_UPackage__Script_Niagara(), TEXT("ENDIExport_GPUAllocationMode"));
		}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceExport_Statics::NewProp_CallbackHandlerParameter = { "CallbackHandlerParameter", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraDataInterfaceExport, CallbackHandlerParameter), Z_Construct_UScriptStruct_FNiagaraUserParameterBinding, METADATA_PARAMS(Z_Construct_UClass_UNiagaraDataInterfaceExport_Statics::NewProp_CallbackHandlerParameter_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceExport_Statics::NewProp_CallbackHandlerParameter_MetaData)) }; // 1397626713
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UNiagaraDataInterfaceExport_Statics::NewProp_GPUAllocationMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceExport_h_Statics::ScriptStructInfo[] = {
		{ FBasicParticleData::StaticStruct, Z_Construct_UScriptStruct_FBasicParticleData_Statics::NewStructOps, TEXT("BasicParticleData"), &Z_Registration_Info_UScriptStruct_BasicParticleData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBasicParticleData), 3831264198U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceExport_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraParticleCallbackHandler, UNiagaraParticleCallbackHandler::StaticClass, TEXT("UNiagaraParticleCallbackHandler"), &Z_Registration_Info_UClass_UNiagaraParticleCallbackHandler, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraParticleCallbackHandler), 1581782976U) },
		{ Z_Construct_UClass_UNiagaraDataInterfaceExport, UNiagaraDataInterfaceExport::StaticClass, TEXT("UNiagaraDataInterfaceExport"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceExport, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceExport), 1725332235U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceExport_h_4200921164(TEXT("/Script/Niagara"),
