...
class UScriptStruct* FNiagaraScriptExecutionPaddingInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraScriptExecutionPaddingInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraScriptExecutionPaddingInfo"));
	}
...
#endif
	const UECodeGen_Private::FFInt16PropertyParams Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo_Statics::NewProp_DestOffset = { "DestOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraScriptExecutionPaddingInfo, DestOffset), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo_Statics::NewProp_DestOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo_Statics::NewProp_DestOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFInt16PropertyParams Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo_Statics::NewProp_SrcSize = { "SrcSize", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraScriptExecutionPaddingInfo, SrcSize), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo_Statics::NewProp_SrcSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo_Statics::NewProp_SrcSize_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFInt16PropertyParams Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo_Statics::NewProp_DestSize = { "DestSize", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraScriptExecutionPaddingInfo, DestSize), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo_Statics::NewProp_DestSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo_Statics::NewProp_DestSize_MetaData)) };
...
class UScriptStruct* FNiagaraScriptExecutionParameterStore::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraScriptExecutionParameterStore.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraScriptExecutionParameterStore"));
	}
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddedParameterSize = { "PaddedParameterSize", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraScriptExecutionParameterStore, PaddedParameterSize), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddedParameterSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddedParameterSize_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddingInfo_Inner = { "PaddingInfo", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNiagaraScriptExecutionPaddingInfo, METADATA_PARAMS(nullptr, 0) }; // 494484122
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddingInfo = { "PaddingInfo", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraScriptExecutionParameterStore, PaddingInfo), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddingInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraScriptExecutionParameterStore_Statics::NewProp_PaddingInfo_MetaData)) }; // 494484122
#if WITH_METADATA
...
class UScriptStruct* FNiagaraScriptInstanceParameterStore::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraScriptInstanceParameterStore.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraScriptInstanceParameterStore, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraScriptInstanceParameterStore"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraScriptInstanceParameterStore>()
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraScriptExecutionParameterStore_h_365571495(TEXT("/Script/Niagara"),
		nullptr, 0,
