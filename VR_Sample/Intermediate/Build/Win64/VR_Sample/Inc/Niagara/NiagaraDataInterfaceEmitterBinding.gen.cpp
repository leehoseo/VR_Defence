...
// End Cross Module References
	...
	static UEnum* ENiagaraDataInterfaceEmitterBindingMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraDataInterfaceEmitterBindingMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraDataInterfaceEmitterBindingMode, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraDataInterfaceEmitterBindingMode"));
		}
...
class UScriptStruct* FNiagaraDataInterfaceEmitterBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraDataInterfaceEmitterBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraDataInterfaceEmitterBinding, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraDataInterfaceEmitterBinding"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraDataInterfaceEmitterBinding>()
{
	...
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UScriptStruct_FNiagaraDataInterfaceEmitterBinding_Statics::NewProp_BindingMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraDataInterfaceEmitterBinding_h_241339101(TEXT("/Script/Niagara"),
		nullptr, 0,
