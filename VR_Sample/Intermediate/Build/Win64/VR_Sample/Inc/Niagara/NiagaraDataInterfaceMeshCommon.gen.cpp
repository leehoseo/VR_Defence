...
class UScriptStruct* FMeshTriCoordinate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MeshTriCoordinate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMeshTriCoordinate, Z_Construct_UPackage__Script_Niagara(), TEXT("MeshTriCoordinate"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FMeshTriCoordinate>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceMeshCommon_h_Statics::ScriptStructInfo[] = {
		{ FMeshTriCoordinate::StaticStruct, Z_Construct_UScriptStruct_FMeshTriCoordinate_Statics::NewStructOps, TEXT("MeshTriCoordinate"), &Z_Registration_Info_UScriptStruct_MeshTriCoordinate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeshTriCoordinate), 1712687067U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceMeshCommon_h_1235609009(TEXT("/Script/Niagara"),
		nullptr, 0,
