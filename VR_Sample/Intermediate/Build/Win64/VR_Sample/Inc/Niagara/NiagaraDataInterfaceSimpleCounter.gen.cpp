...
#include "Niagara/Private/DataInterface/NiagaraDataInterfaceSimpleCounter.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceSimpleCounter_Statics::NewProp_InitialValue = { "InitialValue", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraDataInterfaceSimpleCounter, InitialValue), METADATA_PARAMS(Z_Construct_UClass_UNiagaraDataInterfaceSimpleCounter_Statics::NewProp_InitialValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceSimpleCounter_Statics::NewProp_InitialValue_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_DataInterface_NiagaraDataInterfaceSimpleCounter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceSimpleCounter, UNiagaraDataInterfaceSimpleCounter::StaticClass, TEXT("UNiagaraDataInterfaceSimpleCounter"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceSimpleCounter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceSimpleCounter), 42049130U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_DataInterface_NiagaraDataInterfaceSimpleCounter_h_1788014067(TEXT("/Script/Niagara"),
