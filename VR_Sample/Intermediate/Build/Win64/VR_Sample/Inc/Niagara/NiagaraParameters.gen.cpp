...
class UScriptStruct* FNiagaraParameters::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraParameters, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraParameters"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraParameters>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraParameters_Statics::NewProp_Parameters_Inner = { "Parameters", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNiagaraVariable, METADATA_PARAMS(nullptr, 0) }; // 2772216506
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraParameters_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraParameters::StaticStruct, Z_Construct_UScriptStruct_FNiagaraParameters_Statics::NewStructOps, TEXT("NiagaraParameters"), &Z_Registration_Info_UScriptStruct_NiagaraParameters, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraParameters), 1367174897U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraParameters_h_1542845268(TEXT("/Script/Niagara"),
		nullptr, 0,
