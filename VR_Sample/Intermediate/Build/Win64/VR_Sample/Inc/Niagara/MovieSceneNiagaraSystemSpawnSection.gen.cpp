...
// End Cross Module References
	...
	static UEnum* ENiagaraSystemSpawnSectionStartBehavior_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraSystemSpawnSectionStartBehavior.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraSystemSpawnSectionStartBehavior, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraSystemSpawnSectionStartBehavior"));
		}
	...
	static UEnum* ENiagaraSystemSpawnSectionEvaluateBehavior_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraSystemSpawnSectionEvaluateBehavior.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraSystemSpawnSectionEvaluateBehavior, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraSystemSpawnSectionEvaluateBehavior"));
		}
	...
	static UEnum* ENiagaraSystemSpawnSectionEndBehavior_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraSystemSpawnSectionEndBehavior.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraSystemSpawnSectionEndBehavior, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraSystemSpawnSectionEndBehavior"));
		}
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_SectionStartBehavior = { "SectionStartBehavior", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneNiagaraSystemSpawnSection, SectionStartBehavior), Z_Construct_UEnum_Niagara_ENiagaraSystemSpawnSectionStartBehavior, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_SectionStartBehavior_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_SectionStartBehavior_MetaData)) }; // 1911655987
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_SectionEvaluateBehavior_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_SectionEndBehavior = { "SectionEndBehavior", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneNiagaraSystemSpawnSection, SectionEndBehavior), Z_Construct_UEnum_Niagara_ENiagaraSystemSpawnSectionEndBehavior, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_SectionEndBehavior_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_SectionEndBehavior_MetaData)) }; // 1546558255
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_AgeUpdateMode = { "AgeUpdateMode", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneNiagaraSystemSpawnSection, AgeUpdateMode), Z_Construct_UEnum_Niagara_ENiagaraAgeUpdateMode, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_AgeUpdateMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_AgeUpdateMode_MetaData)) }; // 1189200022
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_bAllowScalability = { "bAllowScalability", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneNiagaraSystemSpawnSection), &Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_bAllowScalability_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_bAllowScalability_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection_Statics::NewProp_bAllowScalability_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_MovieScene_MovieSceneNiagaraSystemSpawnSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneNiagaraSystemSpawnSection, UMovieSceneNiagaraSystemSpawnSection::StaticClass, TEXT("UMovieSceneNiagaraSystemSpawnSection"), &Z_Registration_Info_UClass_UMovieSceneNiagaraSystemSpawnSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneNiagaraSystemSpawnSection), 2744249715U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_MovieScene_MovieSceneNiagaraSystemSpawnSection_h_2502697614(TEXT("/Script/Niagara"),
