...
// End Cross Module References
	...
	static UEnum* ENiagaraVariantMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENiagaraVariantMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Niagara_ENiagaraVariantMode, Z_Construct_UPackage__Script_Niagara(), TEXT("ENiagaraVariantMode"));
		}
...
class UScriptStruct* FNiagaraVariant::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraVariant.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraVariant, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraVariant"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraVariant>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_DataInterface = { "DataInterface", nullptr, (EPropertyFlags)0x0046000000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraVariant, DataInterface), Z_Construct_UClass_UNiagaraDataInterface_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_DataInterface_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_DataInterface_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Bytes_Inner = { "Bytes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Bytes = { "Bytes", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraVariant, Bytes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Bytes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_Bytes_MetaData)) };
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_CurrentMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_CurrentMode = { "CurrentMode", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraVariant, CurrentMode), Z_Construct_UEnum_Niagara_ENiagaraVariantMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_CurrentMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewProp_CurrentMode_MetaData)) }; // 343523793
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraVariant_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraVariant::StaticStruct, Z_Construct_UScriptStruct_FNiagaraVariant_Statics::NewStructOps, TEXT("NiagaraVariant"), &Z_Registration_Info_UScriptStruct_NiagaraVariant, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraVariant), 1220821475U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraVariant_h_1982906582(TEXT("/Script/Niagara"),
		nullptr, 0,
