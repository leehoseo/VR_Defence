...
class UScriptStruct* FNiagaraCollisionEventPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraCollisionEventPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraCollisionEventPayload"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraCollisionEventPayload>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_CollisionPos = { "CollisionPos", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraCollisionEventPayload, CollisionPos), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_CollisionPos_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_CollisionPos_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_CollisionNormal = { "CollisionNormal", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraCollisionEventPayload, CollisionNormal), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_CollisionNormal_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_CollisionNormal_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_CollisionVelocity = { "CollisionVelocity", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraCollisionEventPayload, CollisionVelocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_CollisionVelocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_CollisionVelocity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_ParticleIndex = { "ParticleIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraCollisionEventPayload, ParticleIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_ParticleIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_ParticleIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_PhysicalMaterialIndex = { "PhysicalMaterialIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraCollisionEventPayload, PhysicalMaterialIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_PhysicalMaterialIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewProp_PhysicalMaterialIndex_MetaData)) };
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UNiagaraEventReceiverEmitterAction_SpawnParticles_Statics::NewProp_NumParticles = { "NumParticles", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraEventReceiverEmitterAction_SpawnParticles, NumParticles), METADATA_PARAMS(Z_Construct_UClass_UNiagaraEventReceiverEmitterAction_SpawnParticles_Statics::NewProp_NumParticles_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraEventReceiverEmitterAction_SpawnParticles_Statics::NewProp_NumParticles_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraEvents_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraCollisionEventPayload::StaticStruct, Z_Construct_UScriptStruct_FNiagaraCollisionEventPayload_Statics::NewStructOps, TEXT("NiagaraCollisionEventPayload"), &Z_Registration_Info_UScriptStruct_NiagaraCollisionEventPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraCollisionEventPayload), 3096525896U) },
	};
