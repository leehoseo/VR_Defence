...
class UScriptStruct* FNCPoolElement::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NCPoolElement.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNCPoolElement, Z_Construct_UPackage__Script_Niagara(), TEXT("NCPoolElement"));
	}
...
class UScriptStruct* FNCPool::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NCPool.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNCPool, Z_Construct_UPackage__Script_Niagara(), TEXT("NCPool"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNCPool>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNCPool_Statics::NewProp_FreeElements = { "FreeElements", nullptr, (EPropertyFlags)0x0010008000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNCPool, FreeElements), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNCPool_Statics::NewProp_FreeElements_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNCPool_Statics::NewProp_FreeElements_MetaData)) }; // 3288955467
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraComponentPool_Statics::NewProp_WorldParticleSystemPools_ValueProp = { "WorldParticleSystemPools", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FNCPool, METADATA_PARAMS(nullptr, 0) }; // 39983965
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraComponentPool_Statics::NewProp_WorldParticleSystemPools_Key_KeyProp = { "WorldParticleSystemPools_Key", nullptr, (EPropertyFlags)0x0004008000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UNiagaraSystem_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraComponentPool_h_Statics::ScriptStructInfo[] = {
		{ FNCPoolElement::StaticStruct, Z_Construct_UScriptStruct_FNCPoolElement_Statics::NewStructOps, TEXT("NCPoolElement"), &Z_Registration_Info_UScriptStruct_NCPoolElement, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNCPoolElement), 3288955467U) },
		{ FNCPool::StaticStruct, Z_Construct_UScriptStruct_FNCPool_Statics::NewStructOps, TEXT("NCPool"), &Z_Registration_Info_UScriptStruct_NCPool, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNCPool), 39983965U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraComponentPool_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraComponentPool, UNiagaraComponentPool::StaticClass, TEXT("UNiagaraComponentPool"), &Z_Registration_Info_UClass_UNiagaraComponentPool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraComponentPool), 2384950923U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraComponentPool_h_870717728(TEXT("/Script/Niagara"),
