...
class UScriptStruct* FNiagaraScriptHighlight::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraScriptHighlight.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraScriptHighlight, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraScriptHighlight"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraScriptHighlight>()
{
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FNiagaraScriptHighlight_Statics::NewProp_DisplayName = { "DisplayName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraScriptHighlight, DisplayName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraScriptHighlight_Statics::NewProp_DisplayName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraScriptHighlight_Statics::NewProp_DisplayName_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraScriptHighlight_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraScriptHighlight::StaticStruct, Z_Construct_UScriptStruct_FNiagaraScriptHighlight_Statics::NewStructOps, TEXT("NiagaraScriptHighlight"), &Z_Registration_Info_UScriptStruct_NiagaraScriptHighlight, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraScriptHighlight), 4182291206U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraScriptHighlight_h_749967548(TEXT("/Script/Niagara"),
		nullptr, 0,
