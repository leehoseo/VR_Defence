...
class UScriptStruct* FNiagaraStackSection::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraStackSection.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraStackSection, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraStackSection"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraStackSection>()
{
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FNiagaraStackSection_Statics::NewProp_SectionDisplayName = { "SectionDisplayName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraStackSection, SectionDisplayName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraStackSection_Statics::NewProp_SectionDisplayName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraStackSection_Statics::NewProp_SectionDisplayName_MetaData)) };
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FNiagaraStackSection_Statics::NewProp_Categories_Inner = { "Categories", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraStackSection_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraStackSection::StaticStruct, Z_Construct_UScriptStruct_FNiagaraStackSection_Statics::NewStructOps, TEXT("NiagaraStackSection"), &Z_Registration_Info_UScriptStruct_NiagaraStackSection, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraStackSection), 3010814066U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraStackSection_h_863867603(TEXT("/Script/Niagara"),
		nullptr, 0,
