...
class UScriptStruct* FNiagaraGraphViewSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraGraphViewSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraGraphViewSettings, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraGraphViewSettings"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraGraphViewSettings>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNiagaraGraphViewSettings_Statics::NewProp_Zoom = { "Zoom", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraGraphViewSettings, Zoom), METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraGraphViewSettings_Statics::NewProp_Zoom_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraGraphViewSettings_Statics::NewProp_Zoom_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNiagaraGraphViewSettings_Statics::NewProp_bIsValid = { "bIsValid", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FNiagaraGraphViewSettings), &Z_Construct_UScriptStruct_FNiagaraGraphViewSettings_Statics::NewProp_bIsValid_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraGraphViewSettings_Statics::NewProp_bIsValid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraGraphViewSettings_Statics::NewProp_bIsValid_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraEditorDataBase_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraGraphViewSettings::StaticStruct, Z_Construct_UScriptStruct_FNiagaraGraphViewSettings_Statics::NewStructOps, TEXT("NiagaraGraphViewSettings"), &Z_Registration_Info_UScriptStruct_NiagaraGraphViewSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraGraphViewSettings), 2825515604U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraEditorDataBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraEditorDataBase, UNiagaraEditorDataBase::StaticClass, TEXT("UNiagaraEditorDataBase"), &Z_Registration_Info_UClass_UNiagaraEditorDataBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraEditorDataBase), 779184634U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraEditorDataBase_h_3719800600(TEXT("/Script/Niagara"),
