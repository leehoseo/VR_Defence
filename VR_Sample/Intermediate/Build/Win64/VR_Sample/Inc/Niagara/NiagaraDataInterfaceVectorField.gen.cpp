...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceVectorField_Statics::NewProp_bTileX = { "bTileX", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UNiagaraDataInterfaceVectorField), &Z_Construct_UClass_UNiagaraDataInterfaceVectorField_Statics::NewProp_bTileX_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNiagaraDataInterfaceVectorField_Statics::NewProp_bTileX_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceVectorField_Statics::NewProp_bTileX_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNiagaraDataInterfaceVectorField_Statics::NewProp_bTileZ = { "bTileZ", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UNiagaraDataInterfaceVectorField), &Z_Construct_UClass_UNiagaraDataInterfaceVectorField_Statics::NewProp_bTileZ_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNiagaraDataInterfaceVectorField_Statics::NewProp_bTileZ_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraDataInterfaceVectorField_Statics::NewProp_bTileZ_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceVectorField_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraDataInterfaceVectorField, UNiagaraDataInterfaceVectorField::StaticClass, TEXT("UNiagaraDataInterfaceVectorField"), &Z_Registration_Info_UClass_UNiagaraDataInterfaceVectorField, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraDataInterfaceVectorField), 2512873369U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraDataInterfaceVectorField_h_57474440(TEXT("/Script/Niagara"),
