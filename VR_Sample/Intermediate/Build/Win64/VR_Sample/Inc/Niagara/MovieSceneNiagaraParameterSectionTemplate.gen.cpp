...
class UScriptStruct* FMovieSceneNiagaraParameterSectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneNiagaraParameterSectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneNiagaraParameterSectionTemplate, Z_Construct_UPackage__Script_Niagara(), TEXT("MovieSceneNiagaraParameterSectionTemplate"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FMovieSceneNiagaraParameterSectionTemplate>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraParameterSectionTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneNiagaraParameterSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneNiagaraParameterSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneNiagaraParameterSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneNiagaraParameterSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneNiagaraParameterSectionTemplate), 17075919U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraParameterSectionTemplate_h_1163529973(TEXT("/Script/Niagara"),
		nullptr, 0,
