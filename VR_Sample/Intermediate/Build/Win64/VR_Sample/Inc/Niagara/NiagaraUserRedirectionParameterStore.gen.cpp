...
class UScriptStruct* FNiagaraUserRedirectionParameterStore::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraUserRedirectionParameterStore.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraUserRedirectionParameterStore, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraUserRedirectionParameterStore"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraUserRedirectionParameterStore>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraUserRedirectionParameterStore_Statics::NewProp_UserParameterRedirects_ValueProp = { "UserParameterRedirects", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FNiagaraVariable, METADATA_PARAMS(nullptr, 0) }; // 2772216506
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraUserRedirectionParameterStore_Statics::NewProp_UserParameterRedirects_Key_KeyProp = { "UserParameterRedirects_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNiagaraVariable, METADATA_PARAMS(nullptr, 0) }; // 2772216506
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FNiagaraUserRedirectionParameterStore_Statics::NewProp_UserParameterRedirects = { "UserParameterRedirects", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraUserRedirectionParameterStore, UserParameterRedirects), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraUserRedirectionParameterStore_Statics::NewProp_UserParameterRedirects_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraUserRedirectionParameterStore_Statics::NewProp_UserParameterRedirects_MetaData)) }; // 2772216506 2772216506
