...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ANiagaraLensEffectBase_Statics::NewProp_DesiredRelativeTransform = { "DesiredRelativeTransform", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANiagaraLensEffectBase, DesiredRelativeTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UClass_ANiagaraLensEffectBase_Statics::NewProp_DesiredRelativeTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANiagaraLensEffectBase_Statics::NewProp_DesiredRelativeTransform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ANiagaraLensEffectBase_Statics::NewProp_BaseAuthoredFOV = { "BaseAuthoredFOV", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANiagaraLensEffectBase, BaseAuthoredFOV), METADATA_PARAMS(Z_Construct_UClass_ANiagaraLensEffectBase_Statics::NewProp_BaseAuthoredFOV_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANiagaraLensEffectBase_Statics::NewProp_BaseAuthoredFOV_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ANiagaraLensEffectBase_Statics::NewProp_bResetWhenRetriggered = { "bResetWhenRetriggered", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ANiagaraLensEffectBase), &Z_Construct_UClass_ANiagaraLensEffectBase_Statics::NewProp_bResetWhenRetriggered_SetBit, METADATA_PARAMS(Z_Construct_UClass_ANiagaraLensEffectBase_Statics::NewProp_bResetWhenRetriggered_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANiagaraLensEffectBase_Statics::NewProp_bResetWhenRetriggered_MetaData)) };
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ANiagaraLensEffectBase_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ANiagaraLensEffectBase_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UCameraLensEffectInterface_NoRegister, (int32)VTABLE_OFFSET(ANiagaraLensEffectBase, ICameraLensEffectInterface), false },  // 1691392738
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraLensEffectBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANiagaraLensEffectBase, ANiagaraLensEffectBase::StaticClass, TEXT("ANiagaraLensEffectBase"), &Z_Registration_Info_UClass_ANiagaraLensEffectBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANiagaraLensEffectBase), 3482682467U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraLensEffectBase_h_1885214189(TEXT("/Script/Niagara"),
