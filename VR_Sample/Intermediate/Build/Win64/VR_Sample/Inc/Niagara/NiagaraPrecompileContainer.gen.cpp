...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UNiagaraPrecompileContainer_Statics::NewProp_System = { "System", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraPrecompileContainer, System), Z_Construct_UClass_UNiagaraSystem_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UNiagaraPrecompileContainer_Statics::NewProp_System_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraPrecompileContainer_Statics::NewProp_System_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_NiagaraPrecompileContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraPrecompileContainer, UNiagaraPrecompileContainer::StaticClass, TEXT("UNiagaraPrecompileContainer"), &Z_Registration_Info_UClass_UNiagaraPrecompileContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraPrecompileContainer), 3096942407U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_NiagaraPrecompileContainer_h_2112341560(TEXT("/Script/Niagara"),
