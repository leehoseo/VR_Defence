...
class UScriptStruct* FNiagaraCulledComponentInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraCulledComponentInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraCulledComponentInfo, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraCulledComponentInfo"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraCulledComponentInfo>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNiagaraCullProxyComponent_Statics::NewProp_Instances_Inner = { "Instances", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNiagaraCulledComponentInfo, METADATA_PARAMS(nullptr, 0) }; // 375531948
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNiagaraCullProxyComponent_Statics::NewProp_Instances = { "Instances", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNiagaraCullProxyComponent, Instances), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNiagaraCullProxyComponent_Statics::NewProp_Instances_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNiagaraCullProxyComponent_Statics::NewProp_Instances_MetaData)) }; // 375531948
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraCullProxyComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNiagaraCullProxyComponent, UNiagaraCullProxyComponent::StaticClass, TEXT("UNiagaraCullProxyComponent"), &Z_Registration_Info_UClass_UNiagaraCullProxyComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNiagaraCullProxyComponent), 3592937570U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Public_NiagaraCullProxyComponent_h_3539112088(TEXT("/Script/Niagara"),
