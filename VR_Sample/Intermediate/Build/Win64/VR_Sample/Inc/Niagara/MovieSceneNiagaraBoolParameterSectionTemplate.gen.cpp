...
class UScriptStruct* FMovieSceneNiagaraBoolParameterSectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneNiagaraBoolParameterSectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneNiagaraBoolParameterSectionTemplate, Z_Construct_UPackage__Script_Niagara(), TEXT("MovieSceneNiagaraBoolParameterSectionTemplate"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FMovieSceneNiagaraBoolParameterSectionTemplate>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneNiagaraBoolParameterSectionTemplate_Statics::NewProp_BoolChannel = { "BoolChannel", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneNiagaraBoolParameterSectionTemplate, BoolChannel), Z_Construct_UScriptStruct_FMovieSceneBoolChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneNiagaraBoolParameterSectionTemplate_Statics::NewProp_BoolChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneNiagaraBoolParameterSectionTemplate_Statics::NewProp_BoolChannel_MetaData)) }; // 3901483235
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraBoolParameterSectionTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneNiagaraBoolParameterSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneNiagaraBoolParameterSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneNiagaraBoolParameterSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneNiagaraBoolParameterSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneNiagaraBoolParameterSectionTemplate), 2638709403U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Private_MovieScene_Parameters_MovieSceneNiagaraBoolParameterSectionTemplate_h_2006154267(TEXT("/Script/Niagara"),
		nullptr, 0,
