...
class UScriptStruct* FNiagaraEmitterHandle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraEmitterHandle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraEmitterHandle, Z_Construct_UPackage__Script_Niagara(), TEXT("NiagaraEmitterHandle"));
	}
...
template<> NIAGARA_API UScriptStruct* StaticStruct<FNiagaraEmitterHandle>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::NewProp_Id = { "Id", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraEmitterHandle, Id), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::NewProp_Id_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::NewProp_Id_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraEmitterHandle_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraEmitterHandle::StaticStruct, Z_Construct_UScriptStruct_FNiagaraEmitterHandle_Statics::NewStructOps, TEXT("NiagaraEmitterHandle"), &Z_Registration_Info_UScriptStruct_NiagaraEmitterHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraEmitterHandle), 2358327513U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_Niagara_Classes_NiagaraEmitterHandle_h_2967977108(TEXT("/Script/Niagara"),
		nullptr, 0,
