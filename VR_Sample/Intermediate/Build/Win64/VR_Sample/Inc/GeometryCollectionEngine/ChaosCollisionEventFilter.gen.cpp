...
class UScriptStruct* FChaosCollisionEventData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ChaosCollisionEventData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FChaosCollisionEventData, Z_Construct_UPackage__Script_GeometryCollectionEngine(), TEXT("ChaosCollisionEventData"));
	}
...
template<> GEOMETRYCOLLECTIONENGINE_API UScriptStruct* StaticStruct<FChaosCollisionEventData>()
{
	...
	static UEnum* EChaosCollisionSortMethod_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EChaosCollisionSortMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_GeometryCollectionEngine_EChaosCollisionSortMethod, Z_Construct_UPackage__Script_GeometryCollectionEngine(), TEXT("EChaosCollisionSortMethod"));
		}
...
class UScriptStruct* FChaosCollisionEventRequestSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ChaosCollisionEventRequestSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings, Z_Construct_UPackage__Script_GeometryCollectionEngine(), TEXT("ChaosCollisionEventRequestSettings"));
	}
...
template<> GEOMETRYCOLLECTIONENGINE_API UScriptStruct* StaticStruct<FChaosCollisionEventRequestSettings>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MaxNumberResults = { "MaxNumberResults", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosCollisionEventRequestSettings, MaxNumberResults), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MaxNumberResults_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MaxNumberResults_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MinMass = { "MinMass", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosCollisionEventRequestSettings, MinMass), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MinMass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MinMass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MinSpeed = { "MinSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosCollisionEventRequestSettings, MinSpeed), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MinSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MinSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MinImpulse = { "MinImpulse", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosCollisionEventRequestSettings, MinImpulse), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MinImpulse_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewProp_MinImpulse_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_GeometryCollectionEngine_Public_ChaosCollisionEventFilter_h_Statics::ScriptStructInfo[] = {
		{ FChaosCollisionEventData::StaticStruct, Z_Construct_UScriptStruct_FChaosCollisionEventData_Statics::NewStructOps, TEXT("ChaosCollisionEventData"), &Z_Registration_Info_UScriptStruct_ChaosCollisionEventData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChaosCollisionEventData), 2008330674U) },
		{ FChaosCollisionEventRequestSettings::StaticStruct, Z_Construct_UScriptStruct_FChaosCollisionEventRequestSettings_Statics::NewStructOps, TEXT("ChaosCollisionEventRequestSettings"), &Z_Registration_Info_UScriptStruct_ChaosCollisionEventRequestSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChaosCollisionEventRequestSettings), 618439239U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_GeometryCollectionEngine_Public_ChaosCollisionEventFilter_h_3143852659(TEXT("/Script/GeometryCollectionEngine"),
		nullptr, 0,
