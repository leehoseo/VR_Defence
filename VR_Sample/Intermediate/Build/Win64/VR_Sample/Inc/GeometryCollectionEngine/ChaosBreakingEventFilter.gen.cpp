...
class UScriptStruct* FChaosBreakingEventData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ChaosBreakingEventData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FChaosBreakingEventData, Z_Construct_UPackage__Script_GeometryCollectionEngine(), TEXT("ChaosBreakingEventData"));
	}
...
template<> GEOMETRYCOLLECTIONENGINE_API UScriptStruct* StaticStruct<FChaosBreakingEventData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosBreakingEventData, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Location_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Location_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Velocity = { "Velocity", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosBreakingEventData, Velocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Velocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Velocity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Mass = { "Mass", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosBreakingEventData, Mass), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Mass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewProp_Mass_MetaData)) };
	...
	static UEnum* EChaosBreakingSortMethod_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EChaosBreakingSortMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_GeometryCollectionEngine_EChaosBreakingSortMethod, Z_Construct_UPackage__Script_GeometryCollectionEngine(), TEXT("EChaosBreakingSortMethod"));
		}
...
class UScriptStruct* FChaosBreakingEventRequestSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ChaosBreakingEventRequestSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FChaosBreakingEventRequestSettings, Z_Construct_UPackage__Script_GeometryCollectionEngine(), TEXT("ChaosBreakingEventRequestSettings"));
	}
...
template<> GEOMETRYCOLLECTIONENGINE_API UScriptStruct* StaticStruct<FChaosBreakingEventRequestSettings>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_GeometryCollectionEngine_Public_ChaosBreakingEventFilter_h_Statics::ScriptStructInfo[] = {
		{ FChaosBreakingEventData::StaticStruct, Z_Construct_UScriptStruct_FChaosBreakingEventData_Statics::NewStructOps, TEXT("ChaosBreakingEventData"), &Z_Registration_Info_UScriptStruct_ChaosBreakingEventData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChaosBreakingEventData), 2820980260U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_GeometryCollectionEngine_Public_ChaosBreakingEventFilter_h_2737073080(TEXT("/Script/GeometryCollectionEngine"),
		nullptr, 0,
