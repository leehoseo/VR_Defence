...
class UScriptStruct* FChaosTrailingEventData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ChaosTrailingEventData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FChaosTrailingEventData, Z_Construct_UPackage__Script_GeometryCollectionEngine(), TEXT("ChaosTrailingEventData"));
	}
...
template<> GEOMETRYCOLLECTIONENGINE_API UScriptStruct* StaticStruct<FChaosTrailingEventData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosTrailingEventData, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_Location_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_Location_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_Velocity = { "Velocity", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosTrailingEventData, Velocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_Velocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_Velocity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_Mass = { "Mass", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosTrailingEventData, Mass), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_Mass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_Mass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_ParticleIndex = { "ParticleIndex", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosTrailingEventData, ParticleIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_ParticleIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewProp_ParticleIndex_MetaData)) };
	...
	static UEnum* EChaosTrailingSortMethod_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EChaosTrailingSortMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_GeometryCollectionEngine_EChaosTrailingSortMethod, Z_Construct_UPackage__Script_GeometryCollectionEngine(), TEXT("EChaosTrailingSortMethod"));
		}
...
class UScriptStruct* FChaosTrailingEventRequestSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ChaosTrailingEventRequestSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FChaosTrailingEventRequestSettings, Z_Construct_UPackage__Script_GeometryCollectionEngine(), TEXT("ChaosTrailingEventRequestSettings"));
	}
...
template<> GEOMETRYCOLLECTIONENGINE_API UScriptStruct* StaticStruct<FChaosTrailingEventRequestSettings>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_GeometryCollectionEngine_Public_ChaosTrailingEventFilter_h_Statics::ScriptStructInfo[] = {
		{ FChaosTrailingEventData::StaticStruct, Z_Construct_UScriptStruct_FChaosTrailingEventData_Statics::NewStructOps, TEXT("ChaosTrailingEventData"), &Z_Registration_Info_UScriptStruct_ChaosTrailingEventData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChaosTrailingEventData), 2774638463U) },
		{ FChaosTrailingEventRequestSettings::StaticStruct, Z_Construct_UScriptStruct_FChaosTrailingEventRequestSettings_Statics::NewStructOps, TEXT("ChaosTrailingEventRequestSettings"), &Z_Registration_Info_UScriptStruct_ChaosTrailingEventRequestSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChaosTrailingEventRequestSettings), 4214685400U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_GeometryCollectionEngine_Public_ChaosTrailingEventFilter_h_1021578415(TEXT("/Script/GeometryCollectionEngine"),
		nullptr, 0,
