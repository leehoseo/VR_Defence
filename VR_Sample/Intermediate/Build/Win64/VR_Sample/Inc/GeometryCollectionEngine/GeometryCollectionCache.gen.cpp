...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGeometryCollectionCache_Statics::NewProp_RecordedData = { "RecordedData", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCollectionCache, RecordedData), Z_Construct_UScriptStruct_FRecordedTransformTrack, METADATA_PARAMS(Z_Construct_UClass_UGeometryCollectionCache_Statics::NewProp_RecordedData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCollectionCache_Statics::NewProp_RecordedData_MetaData)) }; // 1044036997
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGeometryCollectionCache_Statics::NewProp_SupportedCollection = { "SupportedCollection", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGeometryCollectionCache, SupportedCollection), Z_Construct_UClass_UGeometryCollection_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGeometryCollectionCache_Statics::NewProp_SupportedCollection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGeometryCollectionCache_Statics::NewProp_SupportedCollection_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_GeometryCollectionEngine_Public_GeometryCollection_GeometryCollectionCache_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGeometryCollectionCache, UGeometryCollectionCache::StaticClass, TEXT("UGeometryCollectionCache"), &Z_Registration_Info_UClass_UGeometryCollectionCache, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGeometryCollectionCache), 1710206840U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Experimental_GeometryCollectionEngine_Public_GeometryCollection_GeometryCollectionCache_h_2702941611(TEXT("/Script/GeometryCollectionEngine"),
