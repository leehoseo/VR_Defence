...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UFoliageType_InstancedStaticMesh_Statics::NewProp_Mesh = { "Mesh", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFoliageType_InstancedStaticMesh, Mesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UFoliageType_InstancedStaticMesh_Statics::NewProp_Mesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFoliageType_InstancedStaticMesh_Statics::NewProp_Mesh_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_FoliageType_InstancedStaticMesh_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFoliageType_InstancedStaticMesh, UFoliageType_InstancedStaticMesh::StaticClass, TEXT("UFoliageType_InstancedStaticMesh"), &Z_Registration_Info_UClass_UFoliageType_InstancedStaticMesh, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFoliageType_InstancedStaticMesh), 4246806414U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_FoliageType_InstancedStaticMesh_h_3858650423(TEXT("/Script/Foliage"),
