...
class UScriptStruct* FFoliageTypeObject::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FoliageTypeObject.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFoliageTypeObject, Z_Construct_UPackage__Script_Foliage(), TEXT("FoliageTypeObject"));
	}
...
template<> FOLIAGE_API UScriptStruct* StaticStruct<FFoliageTypeObject>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_FoliageTypeObject_MetaData[] = {
		{ "AllowedClasses", "FoliageType_InstancedStaticMesh,FoliageType_Actor,Blueprint" },
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_FoliageTypeObject = { "FoliageTypeObject", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFoliageTypeObject, FoliageTypeObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_FoliageTypeObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_FoliageTypeObject_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_TypeInstance = { "TypeInstance", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFoliageTypeObject, TypeInstance), Z_Construct_UClass_UFoliageType_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_TypeInstance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_TypeInstance_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_bIsAsset = { "bIsAsset", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FFoliageTypeObject), &Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_bIsAsset_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_bIsAsset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_bIsAsset_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_Type_MetaData[] = {
		{ "ModuleRelativePath", "Public/FoliageTypeObject.h" },
	};
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0044000020000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFoliageTypeObject, Type_DEPRECATED), Z_Construct_UClass_UFoliageType_InstancedStaticMesh_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewProp_Type_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_FoliageTypeObject_h_Statics::ScriptStructInfo[] = {
		{ FFoliageTypeObject::StaticStruct, Z_Construct_UScriptStruct_FFoliageTypeObject_Statics::NewStructOps, TEXT("FoliageTypeObject"), &Z_Registration_Info_UScriptStruct_FoliageTypeObject, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFoliageTypeObject), 843371198U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_FoliageTypeObject_h_4209281158(TEXT("/Script/Foliage"),
		nullptr, 0,
