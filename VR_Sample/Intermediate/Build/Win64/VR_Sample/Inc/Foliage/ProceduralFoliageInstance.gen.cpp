...
// End Cross Module References
	...
	static UEnum* ESimulationOverlap_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESimulationOverlap.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Foliage_ESimulationOverlap, Z_Construct_UPackage__Script_Foliage(), TEXT("ESimulationOverlap"));
		}
	...
	static UEnum* ESimulationQuery_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESimulationQuery.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Foliage_ESimulationQuery, Z_Construct_UPackage__Script_Foliage(), TEXT("ESimulationQuery"));
		}
...
class UScriptStruct* FProceduralFoliageInstance::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ProceduralFoliageInstance.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FProceduralFoliageInstance, Z_Construct_UPackage__Script_Foliage(), TEXT("ProceduralFoliageInstance"));
	}
...
template<> FOLIAGE_API UScriptStruct* StaticStruct<FProceduralFoliageInstance>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FProceduralFoliageInstance, Rotation), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Rotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Rotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Age = { "Age", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FProceduralFoliageInstance, Age), METADATA_PARAMS(Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Age_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Age_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Normal = { "Normal", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FProceduralFoliageInstance, Normal), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Normal_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Normal_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Scale = { "Scale", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FProceduralFoliageInstance, Scale), METADATA_PARAMS(Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Scale_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewProp_Scale_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_ProceduralFoliageInstance_h_Statics::ScriptStructInfo[] = {
		{ FProceduralFoliageInstance::StaticStruct, Z_Construct_UScriptStruct_FProceduralFoliageInstance_Statics::NewStructOps, TEXT("ProceduralFoliageInstance"), &Z_Registration_Info_UScriptStruct_ProceduralFoliageInstance, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FProceduralFoliageInstance), 3651363905U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_ProceduralFoliageInstance_h_1205687735(TEXT("/Script/Foliage"),
		nullptr, 0,
