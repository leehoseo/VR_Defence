...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AInstancedFoliageActor_AddInstances_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(InstancedFoliageActor_eventAddInstances_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AInstancedFoliageActor_AddInstances_Statics::NewProp_InFoliageType = { "InFoliageType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(InstancedFoliageActor_eventAddInstances_Parms, InFoliageType), Z_Construct_UClass_UFoliageType_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AInstancedFoliageActor_AddInstances_Statics::NewProp_InTransforms_Inner = { "InTransforms", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_AInstancedFoliageActor_AddInstances_Statics::NewProp_InTransforms = { "InTransforms", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(InstancedFoliageActor_eventAddInstances_Parms, InTransforms), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_AInstancedFoliageActor_AddInstances_Statics::NewProp_InTransforms_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_AInstancedFoliageActor_AddInstances_Statics::NewProp_InTransforms_MetaData)) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AInstancedFoliageActor_RemoveAllInstances_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(InstancedFoliageActor_eventRemoveAllInstances_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AInstancedFoliageActor_RemoveAllInstances_Statics::NewProp_InFoliageType = { "InFoliageType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(InstancedFoliageActor_eventRemoveAllInstances_Parms, InFoliageType), Z_Construct_UClass_UFoliageType_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_AInstancedFoliageActor_AddInstances, "AddInstances" }, // 366867285
#endif //WITH_EDITOR
#if WITH_EDITOR
		{ &Z_Construct_UFunction_AInstancedFoliageActor_RemoveAllInstances, "RemoveAllInstances" }, // 1886349416
#endif //WITH_EDITOR
	};
#endif //WITH_EDITOR
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_InstancedFoliageActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AInstancedFoliageActor, AInstancedFoliageActor::StaticClass, TEXT("AInstancedFoliageActor"), &Z_Registration_Info_UClass_AInstancedFoliageActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AInstancedFoliageActor), 787212327U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_InstancedFoliageActor_h_2375066646(TEXT("/Script/Foliage"),
