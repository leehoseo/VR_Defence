...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AProceduralFoliageVolume_Statics::NewProp_ProceduralComponent = { "ProceduralComponent", nullptr, (EPropertyFlags)0x00140000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralFoliageVolume, ProceduralComponent), Z_Construct_UClass_UProceduralFoliageComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AProceduralFoliageVolume_Statics::NewProp_ProceduralComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralFoliageVolume_Statics::NewProp_ProceduralComponent_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_ProceduralFoliageVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AProceduralFoliageVolume, AProceduralFoliageVolume::StaticClass, TEXT("AProceduralFoliageVolume"), &Z_Registration_Info_UClass_AProceduralFoliageVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AProceduralFoliageVolume), 3495795218U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Foliage_Public_ProceduralFoliageVolume_h_1117420523(TEXT("/Script/Foliage"),
