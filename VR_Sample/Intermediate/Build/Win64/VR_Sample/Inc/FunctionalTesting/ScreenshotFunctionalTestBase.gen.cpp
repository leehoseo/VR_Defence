...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_Notes = { "Notes", nullptr, (EPropertyFlags)0x0020080000000015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AScreenshotFunctionalTestBase, Notes), METADATA_PARAMS(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_Notes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_Notes_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotCamera = { "ScreenshotCamera", nullptr, (EPropertyFlags)0x002408000008001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AScreenshotFunctionalTestBase, ScreenshotCamera), Z_Construct_UClass_UCameraComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotCamera_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotCamera_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotOptions = { "ScreenshotOptions", nullptr, (EPropertyFlags)0x00200a0000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AScreenshotFunctionalTestBase, ScreenshotOptions), Z_Construct_UScriptStruct_FAutomationScreenshotOptions, METADATA_PARAMS(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotOptions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AScreenshotFunctionalTestBase_Statics::NewProp_ScreenshotOptions_MetaData)) }; // 1643965863
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_FunctionalTesting_Classes_ScreenshotFunctionalTestBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AScreenshotFunctionalTestBase, AScreenshotFunctionalTestBase::StaticClass, TEXT("AScreenshotFunctionalTestBase"), &Z_Registration_Info_UClass_AScreenshotFunctionalTestBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AScreenshotFunctionalTestBase), 963285925U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_FunctionalTesting_Classes_ScreenshotFunctionalTestBase_h_389071024(TEXT("/Script/FunctionalTesting"),
