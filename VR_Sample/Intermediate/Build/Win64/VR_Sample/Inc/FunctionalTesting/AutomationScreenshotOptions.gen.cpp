...
// End Cross Module References
	...
	static UEnum* EComparisonTolerance_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EComparisonTolerance.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_FunctionalTesting_EComparisonTolerance, Z_Construct_UPackage__Script_FunctionalTesting(), TEXT("EComparisonTolerance"));
		}
...
class UScriptStruct* FComparisonToleranceAmount::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ComparisonToleranceAmount.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FComparisonToleranceAmount, Z_Construct_UPackage__Script_FunctionalTesting(), TEXT("ComparisonToleranceAmount"));
	}
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FComparisonToleranceAmount_Statics::NewProp_MaxBrightness = { "MaxBrightness", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FComparisonToleranceAmount, MaxBrightness), nullptr, METADATA_PARAMS(Z_Construct_UScriptStruct_FComparisonToleranceAmount_Statics::NewProp_MaxBrightness_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComparisonToleranceAmount_Statics::NewProp_MaxBrightness_MetaData)) };
...
class UScriptStruct* FAutomationScreenshotOptions::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AutomationScreenshotOptions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAutomationScreenshotOptions, Z_Construct_UPackage__Script_FunctionalTesting(), TEXT("AutomationScreenshotOptions"));
	}
...
template<> FUNCTIONALTESTING_API UScriptStruct* StaticStruct<FAutomationScreenshotOptions>()
{
...
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_OverrideTimeTo;
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Delay_MetaData[] = {
		{ "Category", "Screenshot" },
		{ "Comment", "/**\n\x09 * The delay before we take the screenshot.\n\x09 */" },
		{ "ModuleRelativePath", "Public/AutomationScreenshotOptions.h" },
		{ "ToolTip", "The delay before we take the screenshot." },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Delay = { "Delay", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, Delay), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Delay_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Delay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_OverrideTimeTo = { "OverrideTimeTo", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, OverrideTimeTo), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_OverrideTimeTo_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_OverrideTimeTo_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_bDisableTonemapping = { "bDisableTonemapping", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAutomationScreenshotOptions), &Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_bDisableTonemapping_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_bDisableTonemapping_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_bDisableTonemapping_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_ViewSettings = { "ViewSettings", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, ViewSettings), Z_Construct_UClass_UAutomationViewSettings_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_ViewSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_ViewSettings_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_VisualizeBuffer = { "VisualizeBuffer", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, VisualizeBuffer), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_VisualizeBuffer_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_VisualizeBuffer_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Tolerance_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Tolerance = { "Tolerance", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, Tolerance), Z_Construct_UEnum_FunctionalTesting_EComparisonTolerance, METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Tolerance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_Tolerance_MetaData)) }; // 594704935
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_ToleranceAmount = { "ToleranceAmount", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, ToleranceAmount), Z_Construct_UScriptStruct_FComparisonToleranceAmount, METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_ToleranceAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_ToleranceAmount_MetaData)) }; // 2846199203
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_MaximumGlobalError = { "MaximumGlobalError", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationScreenshotOptions, MaximumGlobalError), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_MaximumGlobalError_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_MaximumGlobalError_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_bIgnoreColors = { "bIgnoreColors", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAutomationScreenshotOptions), &Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_bIgnoreColors_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_bIgnoreColors_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationScreenshotOptions_Statics::NewProp_bIgnoreColors_MetaData)) };
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_FunctionalTesting_Public_AutomationScreenshotOptions_h_656981947(TEXT("/Script/FunctionalTesting"),
		nullptr, 0,
