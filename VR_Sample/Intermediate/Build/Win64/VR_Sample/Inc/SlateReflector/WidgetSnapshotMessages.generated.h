...
template<> SLATEREFLECTOR_API UScriptStruct* StaticStruct<struct FWidgetSnapshotRequest>();
...
template<> SLATEREFLECTOR_API UScriptStruct* StaticStruct<struct FWidgetSnapshotResponse>();
