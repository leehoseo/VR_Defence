...
class UScriptStruct* FWidgetSnapshotRequest::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WidgetSnapshotRequest.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWidgetSnapshotRequest, Z_Construct_UPackage__Script_SlateReflector(), TEXT("WidgetSnapshotRequest"));
	}
...
class UScriptStruct* FWidgetSnapshotResponse::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WidgetSnapshotResponse.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWidgetSnapshotResponse, Z_Construct_UPackage__Script_SlateReflector(), TEXT("WidgetSnapshotResponse"));
	}
...
template<> SLATEREFLECTOR_API UScriptStruct* StaticStruct<FWidgetSnapshotResponse>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWidgetSnapshotResponse_Statics::NewProp_SnapshotRequestId = { "SnapshotRequestId", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWidgetSnapshotResponse, SnapshotRequestId), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FWidgetSnapshotResponse_Statics::NewProp_SnapshotRequestId_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWidgetSnapshotResponse_Statics::NewProp_SnapshotRequestId_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FWidgetSnapshotResponse_Statics::NewProp_SnapshotData_Inner = { "SnapshotData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_SlateReflector_Private_WidgetSnapshotMessages_h_Statics::ScriptStructInfo[] = {
		{ FWidgetSnapshotRequest::StaticStruct, Z_Construct_UScriptStruct_FWidgetSnapshotRequest_Statics::NewStructOps, TEXT("WidgetSnapshotRequest"), &Z_Registration_Info_UScriptStruct_WidgetSnapshotRequest, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWidgetSnapshotRequest), 719194382U) },
		{ FWidgetSnapshotResponse::StaticStruct, Z_Construct_UScriptStruct_FWidgetSnapshotResponse_Statics::NewStructOps, TEXT("WidgetSnapshotResponse"), &Z_Registration_Info_UScriptStruct_WidgetSnapshotResponse, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWidgetSnapshotResponse), 3687109224U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_SlateReflector_Private_WidgetSnapshotMessages_h_1277735642(TEXT("/Script/SlateReflector"),
		nullptr, 0,
