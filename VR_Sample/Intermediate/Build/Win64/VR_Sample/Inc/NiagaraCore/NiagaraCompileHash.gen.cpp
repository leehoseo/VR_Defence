...
class UScriptStruct* FNiagaraCompileHash::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NiagaraCompileHash.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNiagaraCompileHash, Z_Construct_UPackage__Script_NiagaraCore(), TEXT("NiagaraCompileHash"));
	}
...
template<> NIAGARACORE_API UScriptStruct* StaticStruct<FNiagaraCompileHash>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FNiagaraCompileHash_Statics::NewProp_DataHash_Inner = { "DataHash", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNiagaraCompileHash_Statics::NewProp_DataHash = { "DataHash", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNiagaraCompileHash, DataHash), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNiagaraCompileHash_Statics::NewProp_DataHash_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNiagaraCompileHash_Statics::NewProp_DataHash_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraCore_Public_NiagaraCompileHash_h_Statics::ScriptStructInfo[] = {
		{ FNiagaraCompileHash::StaticStruct, Z_Construct_UScriptStruct_FNiagaraCompileHash_Statics::NewStructOps, TEXT("NiagaraCompileHash"), &Z_Registration_Info_UScriptStruct_NiagaraCompileHash, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNiagaraCompileHash), 4261636274U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_FX_Niagara_Source_NiagaraCore_Public_NiagaraCompileHash_h_3476366864(TEXT("/Script/NiagaraCore"),
		nullptr, 0,
