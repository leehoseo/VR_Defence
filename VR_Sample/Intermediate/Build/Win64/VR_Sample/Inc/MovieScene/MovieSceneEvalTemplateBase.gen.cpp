...
class UScriptStruct* FMovieSceneEmptyStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEmptyStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEmptyStruct, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEmptyStruct"));
	}
...
class UScriptStruct* FMovieSceneEvalTemplateBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEvalTemplateBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEvalTemplateBase, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEvalTemplateBase"));
	}
