...
class UScriptStruct* FMovieSceneEvalTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEvalTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEvalTemplate, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEvalTemplate"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneEvalTemplate>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FMovieSceneEvalTemplate_Statics::NewProp_CompletionMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMovieSceneEvalTemplate_Statics::NewProp_CompletionMode = { "CompletionMode", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEvalTemplate, CompletionMode), Z_Construct_UEnum_MovieScene_EMovieSceneCompletionMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvalTemplate_Statics::NewProp_CompletionMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvalTemplate_Statics::NewProp_CompletionMode_MetaData)) }; // 189609525
#if WITH_METADATA
...
class UScriptStruct* FMovieSceneEvalTemplatePtr::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEvalTemplatePtr.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEvalTemplatePtr, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEvalTemplatePtr"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneEvalTemplatePtr>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneEvalTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneEvalTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneEvalTemplate_Statics::NewStructOps, TEXT("MovieSceneEvalTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneEvalTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneEvalTemplate), 3300220150U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneEvalTemplate_h_573523038(TEXT("/Script/MovieScene"),
		nullptr, 0,
