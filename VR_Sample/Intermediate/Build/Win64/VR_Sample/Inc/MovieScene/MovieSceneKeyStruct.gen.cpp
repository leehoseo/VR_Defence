...
class UScriptStruct* FMovieSceneKeyStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneKeyStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneKeyStruct, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneKeyStruct"));
	}
...
class UScriptStruct* FGeneratedMovieSceneKeyStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GeneratedMovieSceneKeyStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGeneratedMovieSceneKeyStruct, Z_Construct_UPackage__Script_MovieScene(), TEXT("GeneratedMovieSceneKeyStruct"));
	}
...
class UScriptStruct* FMovieSceneKeyTimeStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneKeyTimeStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneKeyTimeStruct, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneKeyTimeStruct"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneKeyTimeStruct>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneKeyStruct_h_Statics::ScriptStructInfo[] = {
		...
		{ FMovieSceneKeyTimeStruct::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneKeyTimeStruct_Statics::NewStructOps, TEXT("MovieSceneKeyTimeStruct"), &Z_Registration_Info_UScriptStruct_MovieSceneKeyTimeStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneKeyTimeStruct), 2167343855U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneKeyStruct_h_338610547(TEXT("/Script/MovieScene"),
		nullptr, 0,
