...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneHookSection_Statics::NewProp_bRequiresRangedHook = { "bRequiresRangedHook", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UMovieSceneHookSection), &Z_Construct_UClass_UMovieSceneHookSection_Statics::NewProp_bRequiresRangedHook_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneHookSection_Statics::NewProp_bRequiresRangedHook_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneHookSection_Statics::NewProp_bRequiresRangedHook_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneHookSection_Statics::NewProp_bRequiresTriggerHooks = { "bRequiresTriggerHooks", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UMovieSceneHookSection), &Z_Construct_UClass_UMovieSceneHookSection_Statics::NewProp_bRequiresTriggerHooks_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneHookSection_Statics::NewProp_bRequiresTriggerHooks_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneHookSection_Statics::NewProp_bRequiresTriggerHooks_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Sections_MovieSceneHookSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneHookSection, UMovieSceneHookSection::StaticClass, TEXT("UMovieSceneHookSection"), &Z_Registration_Info_UClass_UMovieSceneHookSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneHookSection), 1693077819U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Sections_MovieSceneHookSection_h_4188170310(TEXT("/Script/MovieScene"),
