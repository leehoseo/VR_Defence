...
class UScriptStruct* FMovieSceneTrackImplementation::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneTrackImplementation.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneTrackImplementation, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneTrackImplementation"));
	}
...
class UScriptStruct* FMovieSceneTrackImplementationPtr::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneTrackImplementationPtr.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneTrackImplementationPtr, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneTrackImplementationPtr"));
	}
