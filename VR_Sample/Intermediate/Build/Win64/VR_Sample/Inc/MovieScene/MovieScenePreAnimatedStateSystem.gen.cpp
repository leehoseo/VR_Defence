...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_MovieScenePreAnimatedStateSystem_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_UMovieSceneCachePreAnimatedStateSystem, UMovieSceneCachePreAnimatedStateSystem::StaticClass, TEXT("UMovieSceneCachePreAnimatedStateSystem"), &Z_Registration_Info_UClass_UMovieSceneCachePreAnimatedStateSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCachePreAnimatedStateSystem), 3475234947U) },
		{ Z_Construct_UClass_UMovieSceneRestorePreAnimatedStateSystem, UMovieSceneRestorePreAnimatedStateSystem::StaticClass, TEXT("UMovieSceneRestorePreAnimatedStateSystem"), &Z_Registration_Info_UClass_UMovieSceneRestorePreAnimatedStateSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneRestorePreAnimatedStateSystem), 2162977259U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_MovieScenePreAnimatedStateSystem_h_1735659512(TEXT("/Script/MovieScene"),
