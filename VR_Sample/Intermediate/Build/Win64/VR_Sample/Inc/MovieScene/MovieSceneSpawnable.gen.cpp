...
// End Cross Module References
	...
	static UEnum* ESpawnOwnership_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESpawnOwnership.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MovieScene_ESpawnOwnership, Z_Construct_UPackage__Script_MovieScene(), TEXT("ESpawnOwnership"));
		}
...
class UScriptStruct* FMovieSceneSpawnable::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneSpawnable.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneSpawnable, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneSpawnable"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneSpawnable>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_SpawnTransform = { "SpawnTransform", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSpawnable, SpawnTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_SpawnTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_SpawnTransform_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Tags_Inner = { "Tags", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Tags = { "Tags", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSpawnable, Tags), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Tags_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Tags_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Guid = { "Guid", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSpawnable, Guid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Guid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Guid_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSpawnable, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_ObjectTemplate = { "ObjectTemplate", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSpawnable, ObjectTemplate), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_ObjectTemplate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_ObjectTemplate_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_ChildPossessables_Inner = { "ChildPossessables", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_ChildPossessables = { "ChildPossessables", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSpawnable, ChildPossessables), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_ChildPossessables_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_ChildPossessables_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Ownership_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Ownership = { "Ownership", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSpawnable, Ownership), Z_Construct_UEnum_MovieScene_ESpawnOwnership, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Ownership_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_Ownership_MetaData)) }; // 599410078
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_LevelName = { "LevelName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSpawnable, LevelName), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_LevelName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewProp_LevelName_MetaData)) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSpawnable_h_Statics::EnumInfo[] = {
		{ ESpawnOwnership_StaticEnum, TEXT("ESpawnOwnership"), &Z_Registration_Info_UEnum_ESpawnOwnership, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 599410078U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSpawnable_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneSpawnable::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneSpawnable_Statics::NewStructOps, TEXT("MovieSceneSpawnable"), &Z_Registration_Info_UScriptStruct_MovieSceneSpawnable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneSpawnable), 2050082103U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSpawnable_h_304087016(TEXT("/Script/MovieScene"),
		nullptr, 0,
