...
class UScriptStruct* FMovieSceneSequenceID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneSequenceID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneSequenceID, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneSequenceID"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneSequenceID>()
{
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FMovieSceneSequenceID_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSequenceID, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSequenceID_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSequenceID_Statics::NewProp_Value_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSequenceID_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneSequenceID::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneSequenceID_Statics::NewStructOps, TEXT("MovieSceneSequenceID"), &Z_Registration_Info_UScriptStruct_MovieSceneSequenceID, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneSequenceID), 3637834519U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSequenceID_h_1588086685(TEXT("/Script/MovieScene"),
		nullptr, 0,
