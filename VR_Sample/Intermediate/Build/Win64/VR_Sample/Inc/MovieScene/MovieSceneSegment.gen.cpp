...
// End Cross Module References
	...
	static UEnum* ESectionEvaluationFlags_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESectionEvaluationFlags.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MovieScene_ESectionEvaluationFlags, Z_Construct_UPackage__Script_MovieScene(), TEXT("ESectionEvaluationFlags"));
		}
...
class UScriptStruct* FMovieSceneSegmentIdentifier::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneSegmentIdentifier.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneSegmentIdentifier"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier_Statics::NewProp_IdentifierIndex = { "IdentifierIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSegmentIdentifier, IdentifierIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier_Statics::NewProp_IdentifierIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier_Statics::NewProp_IdentifierIndex_MetaData)) };
...
class UScriptStruct* FSectionEvaluationData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SectionEvaluationData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSectionEvaluationData, Z_Construct_UPackage__Script_MovieScene(), TEXT("SectionEvaluationData"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSectionEvaluationData_Statics::NewProp_ImplIndex = { "ImplIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSectionEvaluationData, ImplIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FSectionEvaluationData_Statics::NewProp_ImplIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSectionEvaluationData_Statics::NewProp_ImplIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSectionEvaluationData_Statics::NewProp_ForcedTime = { "ForcedTime", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSectionEvaluationData, ForcedTime), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(Z_Construct_UScriptStruct_FSectionEvaluationData_Statics::NewProp_ForcedTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSectionEvaluationData_Statics::NewProp_ForcedTime_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSectionEvaluationData_Statics::NewProp_Flags_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
class UScriptStruct* FMovieSceneSegment::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneSegment.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneSegment, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneSegment"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneSegment>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneSegment_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneSegmentIdentifier::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneSegmentIdentifier_Statics::NewStructOps, TEXT("MovieSceneSegmentIdentifier"), &Z_Registration_Info_UScriptStruct_MovieSceneSegmentIdentifier, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneSegmentIdentifier), 3803255601U) },
		{ FSectionEvaluationData::StaticStruct, Z_Construct_UScriptStruct_FSectionEvaluationData_Statics::NewStructOps, TEXT("SectionEvaluationData"), &Z_Registration_Info_UScriptStruct_SectionEvaluationData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSectionEvaluationData), 3736089759U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneSegment_h_3427450101(TEXT("/Script/MovieScene"),
		nullptr, 0,
