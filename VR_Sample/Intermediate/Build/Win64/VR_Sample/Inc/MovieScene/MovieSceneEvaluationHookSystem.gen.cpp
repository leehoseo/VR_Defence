...
class UScriptStruct* FMovieSceneEvaluationHookEvent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEvaluationHookEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEvent, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEvaluationHookEvent"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEvent_Statics::NewProp_Hook = { "Hook", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEvaluationHookEvent, Hook), Z_Construct_UScriptStruct_FMovieSceneEvaluationHookComponent, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEvent_Statics::NewProp_Hook_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEvent_Statics::NewProp_Hook_MetaData)) }; // 1135046184
...
class UScriptStruct* FMovieSceneEvaluationHookEventContainer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEvaluationHookEventContainer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEventContainer, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEvaluationHookEventContainer"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneEvaluationHookEventContainer>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEventContainer_Statics::NewProp_Events_Inner = { "Events", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEvent, METADATA_PARAMS(nullptr, 0) }; // 3462747709
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEventContainer_Statics::NewProp_Events = { "Events", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEvaluationHookEventContainer, Events), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEventContainer_Statics::NewProp_Events_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEventContainer_Statics::NewProp_Events_MetaData)) }; // 3462747709
...
class UScriptStruct* FMovieSceneEvaluationInstanceKey::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEvaluationInstanceKey.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEvaluationInstanceKey, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEvaluationInstanceKey"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneEvaluationInstanceKey>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneEvaluationHookSystem_Statics::NewProp_PendingEventsByRootInstance_ValueProp = { "PendingEventsByRootInstance", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FMovieSceneEvaluationHookEventContainer, METADATA_PARAMS(nullptr, 0) }; // 2387715476
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneEvaluationHookSystem_Statics::NewProp_PendingEventsByRootInstance_Key_KeyProp = { "PendingEventsByRootInstance_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FMovieSceneEvaluationInstanceKey, METADATA_PARAMS(nullptr, 0) }; // 3741234512
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UMovieSceneEvaluationHookSystem_Statics::NewProp_PendingEventsByRootInstance = { "PendingEventsByRootInstance", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneEvaluationHookSystem, PendingEventsByRootInstance), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEvaluationHookSystem_Statics::NewProp_PendingEventsByRootInstance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEvaluationHookSystem_Statics::NewProp_PendingEventsByRootInstance_MetaData)) }; // 3741234512 2387715476
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_MovieSceneEvaluationHookSystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEvaluationHookSystem, UMovieSceneEvaluationHookSystem::StaticClass, TEXT("UMovieSceneEvaluationHookSystem"), &Z_Registration_Info_UClass_UMovieSceneEvaluationHookSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEvaluationHookSystem), 4149611783U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_MovieSceneEvaluationHookSystem_h_3399657543(TEXT("/Script/MovieScene"),
