...
class UScriptStruct* FMovieSceneTimeWarping::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneTimeWarping.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneTimeWarping, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneTimeWarping"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneTimeWarping>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneTimeWarping_Statics::NewProp_Start = { "Start", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneTimeWarping, Start), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneTimeWarping_Statics::NewProp_Start_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneTimeWarping_Statics::NewProp_Start_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneTimeWarping_Statics::NewProp_End_MetaData[] = {
		{ "ModuleRelativePath", "Public/Evaluation/MovieSceneTimeWarping.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneTimeWarping_Statics::NewProp_End = { "End", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneTimeWarping, End), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneTimeWarping_Statics::NewProp_End_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneTimeWarping_Statics::NewProp_End_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneTimeWarping_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneTimeWarping::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneTimeWarping_Statics::NewStructOps, TEXT("MovieSceneTimeWarping"), &Z_Registration_Info_UScriptStruct_MovieSceneTimeWarping, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneTimeWarping), 2081238104U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneTimeWarping_h_2292759181(TEXT("/Script/MovieScene"),
		nullptr, 0,
