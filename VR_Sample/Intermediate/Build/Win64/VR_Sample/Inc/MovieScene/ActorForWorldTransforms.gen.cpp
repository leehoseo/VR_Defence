...
#include "MovieScene/Public/ActorForWorldTransforms.h"
...
class UScriptStruct* FActorForWorldTransforms::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorForWorldTransforms.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorForWorldTransforms, Z_Construct_UPackage__Script_MovieScene(), TEXT("ActorForWorldTransforms"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FActorForWorldTransforms>()
{
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FActorForWorldTransforms_Statics::NewProp_Actor = { "Actor", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActorForWorldTransforms, Actor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FActorForWorldTransforms_Statics::NewProp_Actor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorForWorldTransforms_Statics::NewProp_Actor_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FActorForWorldTransforms_Statics::NewProp_Component = { "Component", nullptr, (EPropertyFlags)0x001400000008000d, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActorForWorldTransforms, Component), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FActorForWorldTransforms_Statics::NewProp_Component_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorForWorldTransforms_Statics::NewProp_Component_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_ActorForWorldTransforms_h_Statics::ScriptStructInfo[] = {
		{ FActorForWorldTransforms::StaticStruct, Z_Construct_UScriptStruct_FActorForWorldTransforms_Statics::NewStructOps, TEXT("ActorForWorldTransforms"), &Z_Registration_Info_UScriptStruct_ActorForWorldTransforms, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FActorForWorldTransforms), 4016920432U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_ActorForWorldTransforms_h_2183180703(TEXT("/Script/MovieScene"),
		nullptr, 0,
