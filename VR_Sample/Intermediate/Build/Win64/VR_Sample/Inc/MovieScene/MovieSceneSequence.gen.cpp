...
// End Cross Module References
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UMovieSceneSequence_FindBindingByTag_Statics::NewProp_InBindingName = { "InBindingName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequence_eventFindBindingByTag_Parms, InBindingName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequence_FindBindingByTag_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequence_eventFindBindingByTag_Parms, ReturnValue), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(nullptr, 0) }; // 3055205823
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UMovieSceneSequence_FindBindingsByTag_Statics::NewProp_InBindingName = { "InBindingName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequence_eventFindBindingsByTag_Parms, InBindingName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequence_FindBindingsByTag_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(nullptr, 0) }; // 3055205823
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMovieSceneSequence_FindBindingsByTag_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000008000582, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequence_eventFindBindingsByTag_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneSequence_FindBindingsByTag_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneSequence_FindBindingsByTag_Statics::NewProp_ReturnValue_MetaData)) }; // 3055205823
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneSequence_GetEarliestTimecodeSource_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneSequence_eventGetEarliestTimecodeSource_Parms, ReturnValue), Z_Construct_UScriptStruct_FMovieSceneTimecodeSource, METADATA_PARAMS(nullptr, 0) }; // 1052651485
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneSequence_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneSequence_FindBindingByTag, "FindBindingByTag" }, // 2969247497
		{ &Z_Construct_UFunction_UMovieSceneSequence_FindBindingsByTag, "FindBindingsByTag" }, // 2091483316
		{ &Z_Construct_UFunction_UMovieSceneSequence_GetEarliestTimecodeSource, "GetEarliestTimecodeSource" }, // 1422089690
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_DefaultCompletionMode = { "DefaultCompletionMode", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneSequence, DefaultCompletionMode), Z_Construct_UEnum_MovieScene_EMovieSceneCompletionMode, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_DefaultCompletionMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_DefaultCompletionMode_MetaData)) }; // 189609525
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_bParentContextsAreSignificant = { "bParentContextsAreSignificant", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneSequence), &Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_bParentContextsAreSignificant_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_bParentContextsAreSignificant_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_bParentContextsAreSignificant_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_bPlayableDirectly = { "bPlayableDirectly", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneSequence), &Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_bPlayableDirectly_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_bPlayableDirectly_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_bPlayableDirectly_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags = { "SequenceFlags", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneSequence, SequenceFlags), Z_Construct_UEnum_MovieScene_EMovieSceneSequenceFlags, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSequence_Statics::NewProp_SequenceFlags_MetaData)) }; // 2952807671
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSequence_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneSequence, UMovieSceneSequence::StaticClass, TEXT("UMovieSceneSequence"), &Z_Registration_Info_UClass_UMovieSceneSequence, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneSequence), 1222094427U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneSequence_h_2193328206(TEXT("/Script/MovieScene"),
