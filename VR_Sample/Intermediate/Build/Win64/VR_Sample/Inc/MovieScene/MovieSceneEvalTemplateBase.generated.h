...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<struct FMovieSceneEmptyStruct>();
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<struct FMovieSceneEvalTemplateBase>();
