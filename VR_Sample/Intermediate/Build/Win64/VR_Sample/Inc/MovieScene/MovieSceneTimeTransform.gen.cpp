...
class UScriptStruct* FMovieSceneTimeTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneTimeTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneTimeTransform, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneTimeTransform"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneTimeTransform>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneTimeTransform_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneTimeTransform::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneTimeTransform_Statics::NewStructOps, TEXT("MovieSceneTimeTransform"), &Z_Registration_Info_UScriptStruct_MovieSceneTimeTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneTimeTransform), 493976874U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneTimeTransform_h_339168964(TEXT("/Script/MovieScene"),
		nullptr, 0,
