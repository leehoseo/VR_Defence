...
class UScriptStruct* FMovieSceneBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneBinding, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneBinding"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneBinding>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_ObjectGuid = { "ObjectGuid", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneBinding, ObjectGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_ObjectGuid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_ObjectGuid_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_BindingName = { "BindingName", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneBinding, BindingName), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_BindingName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_BindingName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_Tracks_Inner = { "Tracks", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_Tracks_Inner_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewProp_Tracks_Inner_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneBinding_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneBinding::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneBinding_Statics::NewStructOps, TEXT("MovieSceneBinding"), &Z_Registration_Info_UScriptStruct_MovieSceneBinding, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneBinding), 288866123U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneBinding_h_2601021514(TEXT("/Script/MovieScene"),
		nullptr, 0,
