...
class UScriptStruct* FTestMovieSceneEvalTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TestMovieSceneEvalTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTestMovieSceneEvalTemplate, Z_Construct_UPackage__Script_MovieScene(), TEXT("TestMovieSceneEvalTemplate"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FTestMovieSceneEvalTemplate>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTestMovieSceneTrack_Statics::NewProp_bHighPassFilter = { "bHighPassFilter", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UTestMovieSceneTrack), &Z_Construct_UClass_UTestMovieSceneTrack_Statics::NewProp_bHighPassFilter_SetBit, METADATA_PARAMS(Z_Construct_UClass_UTestMovieSceneTrack_Statics::NewProp_bHighPassFilter_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTestMovieSceneTrack_Statics::NewProp_bHighPassFilter_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTestMovieSceneTrack_Statics::NewProp_SectionArray_Inner = { "SectionArray", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTestMovieSceneSequence_Statics::NewProp_MovieScene = { "MovieScene", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTestMovieSceneSequence, MovieScene), Z_Construct_UClass_UMovieScene_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UTestMovieSceneSequence_Statics::NewProp_MovieScene_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTestMovieSceneSequence_Statics::NewProp_MovieScene_MetaData)) };
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTestMovieSceneSubTrack_Statics::NewProp_SectionArray_Inner = { "SectionArray", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTestMovieSceneSubTrack_Statics::NewProp_SectionArray = { "SectionArray", nullptr, (EPropertyFlags)0x0014008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTestMovieSceneSubTrack, SectionArray), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UTestMovieSceneSubTrack_Statics::NewProp_SectionArray_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTestMovieSceneSubTrack_Statics::NewProp_SectionArray_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Private_Tests_MovieSceneTestObjects_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTestMovieSceneTrack, UTestMovieSceneTrack::StaticClass, TEXT("UTestMovieSceneTrack"), &Z_Registration_Info_UClass_UTestMovieSceneTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTestMovieSceneTrack), 2172590400U) },
		{ Z_Construct_UClass_UTestMovieSceneSection, UTestMovieSceneSection::StaticClass, TEXT("UTestMovieSceneSection"), &Z_Registration_Info_UClass_UTestMovieSceneSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTestMovieSceneSection), 1810096670U) },
		{ Z_Construct_UClass_UTestMovieSceneSequence, UTestMovieSceneSequence::StaticClass, TEXT("UTestMovieSceneSequence"), &Z_Registration_Info_UClass_UTestMovieSceneSequence, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTestMovieSceneSequence), 815310665U) },
		{ Z_Construct_UClass_UTestMovieSceneSubTrack, UTestMovieSceneSubTrack::StaticClass, TEXT("UTestMovieSceneSubTrack"), &Z_Registration_Info_UClass_UTestMovieSceneSubTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTestMovieSceneSubTrack), 3589145741U) },
		{ Z_Construct_UClass_UTestMovieSceneSubSection, UTestMovieSceneSubSection::StaticClass, TEXT("UTestMovieSceneSubSection"), &Z_Registration_Info_UClass_UTestMovieSceneSubSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTestMovieSceneSubSection), 2765127298U) },
		{ Z_Construct_UClass_UTestMovieSceneEvalHookTrack, UTestMovieSceneEvalHookTrack::StaticClass, TEXT("UTestMovieSceneEvalHookTrack"), &Z_Registration_Info_UClass_UTestMovieSceneEvalHookTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTestMovieSceneEvalHookTrack), 3088767629U) },
		{ Z_Construct_UClass_UTestMovieSceneEvalHookSection, UTestMovieSceneEvalHookSection::StaticClass, TEXT("UTestMovieSceneEvalHookSection"), &Z_Registration_Info_UClass_UTestMovieSceneEvalHookSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTestMovieSceneEvalHookSection), 1001945724U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Private_Tests_MovieSceneTestObjects_h_82224723(TEXT("/Script/MovieScene"),
