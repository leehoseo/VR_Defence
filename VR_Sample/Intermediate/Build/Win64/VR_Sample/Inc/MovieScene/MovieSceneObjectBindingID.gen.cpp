...
// End Cross Module References
	...
	static UEnum* EMovieSceneObjectBindingSpace_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMovieSceneObjectBindingSpace.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MovieScene_EMovieSceneObjectBindingSpace, Z_Construct_UPackage__Script_MovieScene(), TEXT("EMovieSceneObjectBindingSpace"));
		}
...
class UScriptStruct* FMovieSceneObjectBindingID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneObjectBindingID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneObjectBindingID"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneObjectBindingID>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_Guid = { "Guid", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneObjectBindingID, Guid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_Guid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_Guid_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_SequenceID = { "SequenceID", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneObjectBindingID, SequenceID), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_SequenceID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_SequenceID_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_ResolveParentIndex = { "ResolveParentIndex", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneObjectBindingID, ResolveParentIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_ResolveParentIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_ResolveParentIndex_MetaData)) };
#if WITH_EDITORONLY_DATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_Space = { "Space", nullptr, (EPropertyFlags)0x0040000820000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneObjectBindingID, Space_DEPRECATED), Z_Construct_UEnum_MovieScene_EMovieSceneObjectBindingSpace, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_Space_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewProp_Space_MetaData)) }; // 3772622621
#endif // WITH_EDITORONLY_DATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneObjectBindingID_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneObjectBindingID::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneObjectBindingID_Statics::NewStructOps, TEXT("MovieSceneObjectBindingID"), &Z_Registration_Info_UScriptStruct_MovieSceneObjectBindingID, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneObjectBindingID), 3055205823U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneObjectBindingID_h_136390737(TEXT("/Script/MovieScene"),
		nullptr, 0,
