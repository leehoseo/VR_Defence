...
class UScriptStruct* FMovieSceneEvaluationKey::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEvaluationKey.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEvaluationKey, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEvaluationKey"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneEvaluationKey>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneEvaluationKey_Statics::NewProp_TrackIdentifier = { "TrackIdentifier", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEvaluationKey, TrackIdentifier), Z_Construct_UScriptStruct_FMovieSceneTrackIdentifier, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvaluationKey_Statics::NewProp_TrackIdentifier_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationKey_Statics::NewProp_TrackIdentifier_MetaData)) }; // 3163761332
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneEvaluationKey_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneEvaluationKey::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneEvaluationKey_Statics::NewStructOps, TEXT("MovieSceneEvaluationKey"), &Z_Registration_Info_UScriptStruct_MovieSceneEvaluationKey, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneEvaluationKey), 2184180686U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieSceneEvaluationKey_h_457619898(TEXT("/Script/MovieScene"),
		nullptr, 0,
