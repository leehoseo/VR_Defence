...
class UScriptStruct* FMovieScenePossessable::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieScenePossessable.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieScenePossessable, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieScenePossessable"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieScenePossessable>()
{
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMovieScenePossessable_Statics::NewProp_Tags_Inner = { "Tags", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieScenePossessable_Statics::NewProp_Tags = { "Tags", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieScenePossessable, Tags), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieScenePossessable_Statics::NewProp_Tags_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScenePossessable_Statics::NewProp_Tags_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UScriptStruct_FMovieScenePossessable_Statics::NewProp_PossessedObjectClass = { "PossessedObjectClass", nullptr, (EPropertyFlags)0x0044000800000000, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieScenePossessable, PossessedObjectClass), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieScenePossessable_Statics::NewProp_PossessedObjectClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScenePossessable_Statics::NewProp_PossessedObjectClass_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieScenePossessable_h_Statics::ScriptStructInfo[] = {
		{ FMovieScenePossessable::StaticStruct, Z_Construct_UScriptStruct_FMovieScenePossessable_Statics::NewStructOps, TEXT("MovieScenePossessable"), &Z_Registration_Info_UScriptStruct_MovieScenePossessable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieScenePossessable), 4160268867U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieScenePossessable_h_3525465976(TEXT("/Script/MovieScene"),
		nullptr, 0,
