...
#include "MovieScene/Public/Channels/MovieSceneCurveChannelCommon.h"
...
class UScriptStruct* FMovieSceneTangentData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneTangentData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneTangentData, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneTangentData"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneTangentData>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Channels_MovieSceneCurveChannelCommon_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneTangentData::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneTangentData_Statics::NewStructOps, TEXT("MovieSceneTangentData"), &Z_Registration_Info_UScriptStruct_MovieSceneTangentData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneTangentData), 4060022230U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Channels_MovieSceneCurveChannelCommon_h_2967595347(TEXT("/Script/MovieScene"),
		nullptr, 0,
