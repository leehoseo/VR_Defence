...
// End Cross Module References
	...
	static UEnum* EMovieSceneBlendType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMovieSceneBlendType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MovieScene_EMovieSceneBlendType, Z_Construct_UPackage__Script_MovieScene(), TEXT("EMovieSceneBlendType"));
		}
...
class UScriptStruct* FOptionalMovieSceneBlendType::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_OptionalMovieSceneBlendType.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FOptionalMovieSceneBlendType, Z_Construct_UPackage__Script_MovieScene(), TEXT("OptionalMovieSceneBlendType"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FOptionalMovieSceneBlendType>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FOptionalMovieSceneBlendType_Statics::NewProp_BlendType = { "BlendType", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FOptionalMovieSceneBlendType, BlendType), Z_Construct_UEnum_MovieScene_EMovieSceneBlendType, METADATA_PARAMS(Z_Construct_UScriptStruct_FOptionalMovieSceneBlendType_Statics::NewProp_BlendType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOptionalMovieSceneBlendType_Statics::NewProp_BlendType_MetaData)) }; // 498637471
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOptionalMovieSceneBlendType_Statics::NewProp_bIsValid = { "bIsValid", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FOptionalMovieSceneBlendType), &Z_Construct_UScriptStruct_FOptionalMovieSceneBlendType_Statics::NewProp_bIsValid_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FOptionalMovieSceneBlendType_Statics::NewProp_bIsValid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOptionalMovieSceneBlendType_Statics::NewProp_bIsValid_MetaData)) };
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_Blending_MovieSceneBlendType_h_179245706(TEXT("/Script/MovieScene"),
		nullptr, 0,
