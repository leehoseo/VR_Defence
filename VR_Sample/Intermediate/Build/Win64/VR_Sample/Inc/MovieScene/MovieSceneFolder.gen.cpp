...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_FolderName = { "FolderName", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneFolder, FolderName), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_FolderName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_FolderName_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildFolders_Inner = { "ChildFolders", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneFolder_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildFolders = { "ChildFolders", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneFolder, ChildFolders), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildFolders_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildFolders_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks_Inner = { "ChildMasterTracks", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneTrack_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks_MetaData[] = {
		{ "Comment", "/** The master tracks contained by this folder. */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/MovieSceneFolder.h" },
		{ "ToolTip", "The master tracks contained by this folder." },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks = { "ChildMasterTracks", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneFolder, ChildMasterTracks), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildMasterTracks_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildObjectBindingStrings_Inner = { "ChildObjectBindingStrings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildObjectBindingStrings = { "ChildObjectBindingStrings", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneFolder, ChildObjectBindingStrings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildObjectBindingStrings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFolder_Statics::NewProp_ChildObjectBindingStrings_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneFolder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFolder, UMovieSceneFolder::StaticClass, TEXT("UMovieSceneFolder"), &Z_Registration_Info_UClass_UMovieSceneFolder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFolder), 2085004720U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneFolder_h_586129559(TEXT("/Script/MovieScene"),
