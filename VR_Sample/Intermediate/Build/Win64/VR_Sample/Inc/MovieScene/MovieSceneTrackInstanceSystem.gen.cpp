...
class UScriptStruct* FMovieSceneTrackInstanceEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneTrackInstanceEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneTrackInstanceEntry, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneTrackInstanceEntry"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneTrackInstanceEntry>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneTrackInstanceSystem_Statics::NewProp_Instantiator = { "Instantiator", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneTrackInstanceSystem, Instantiator), Z_Construct_UClass_UMovieSceneTrackInstanceInstantiator_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneTrackInstanceSystem_Statics::NewProp_Instantiator_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneTrackInstanceSystem_Statics::NewProp_Instantiator_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_TrackInstance_MovieSceneTrackInstanceSystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneTrackInstanceInstantiator, UMovieSceneTrackInstanceInstantiator::StaticClass, TEXT("UMovieSceneTrackInstanceInstantiator"), &Z_Registration_Info_UClass_UMovieSceneTrackInstanceInstantiator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneTrackInstanceInstantiator), 2423645676U) },
		{ Z_Construct_UClass_UMovieSceneTrackInstanceSystem, UMovieSceneTrackInstanceSystem::StaticClass, TEXT("UMovieSceneTrackInstanceSystem"), &Z_Registration_Info_UClass_UMovieSceneTrackInstanceSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneTrackInstanceSystem), 3543107619U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_TrackInstance_MovieSceneTrackInstanceSystem_h_3844120143(TEXT("/Script/MovieScene"),
