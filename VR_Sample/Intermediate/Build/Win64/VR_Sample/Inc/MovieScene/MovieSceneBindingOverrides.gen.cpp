...
class UScriptStruct* FMovieSceneBindingOverrideData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneBindingOverrideData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneBindingOverrideData, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneBindingOverrideData"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneBindingOverrideData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneBindingOverrideData_Statics::NewProp_ObjectBindingId = { "ObjectBindingId", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneBindingOverrideData, ObjectBindingId), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneBindingOverrideData_Statics::NewProp_ObjectBindingId_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneBindingOverrideData_Statics::NewProp_ObjectBindingId_MetaData)) }; // 3055205823
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneBindingOverrides_Statics::NewProp_BindingData_Inner = { "BindingData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FMovieSceneBindingOverrideData, METADATA_PARAMS(nullptr, 0) }; // 2343867782
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneBindingOverrides_Statics::NewProp_BindingData = { "BindingData", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneBindingOverrides, BindingData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneBindingOverrides_Statics::NewProp_BindingData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneBindingOverrides_Statics::NewProp_BindingData_MetaData)) }; // 2343867782
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneBindingOverrides_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneBindingOverrides, UMovieSceneBindingOverrides::StaticClass, TEXT("UMovieSceneBindingOverrides"), &Z_Registration_Info_UClass_UMovieSceneBindingOverrides, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneBindingOverrides), 86135092U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_MovieSceneBindingOverrides_h_3933014687(TEXT("/Script/MovieScene"),
