...
class UScriptStruct* FEasingComponentData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EasingComponentData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEasingComponentData, Z_Construct_UPackage__Script_MovieScene(), TEXT("EasingComponentData"));
	}
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FEasingComponentData_Statics::NewProp_Section = { "Section", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEasingComponentData, Section), Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FEasingComponentData_Statics::NewProp_Section_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEasingComponentData_Statics::NewProp_Section_MetaData)) };
...
class UScriptStruct* FMovieSceneTrackInstanceComponent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneTrackInstanceComponent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneTrackInstanceComponent, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneTrackInstanceComponent"));
	}
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMovieSceneTrackInstanceComponent_Statics::NewProp_Owner = { "Owner", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneTrackInstanceComponent, Owner), Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneTrackInstanceComponent_Statics::NewProp_Owner_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneTrackInstanceComponent_Statics::NewProp_Owner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FMovieSceneTrackInstanceComponent_Statics::NewProp_TrackInstanceClass = { "TrackInstanceClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneTrackInstanceComponent, TrackInstanceClass), Z_Construct_UClass_UMovieSceneTrackInstance_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneTrackInstanceComponent_Statics::NewProp_TrackInstanceClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneTrackInstanceComponent_Statics::NewProp_TrackInstanceClass_MetaData)) };
...
class UScriptStruct* FMovieSceneEvaluationHookComponent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEvaluationHookComponent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEvaluationHookComponent, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEvaluationHookComponent"));
	}
...
#endif
	const UECodeGen_Private::FInterfacePropertyParams Z_Construct_UScriptStruct_FMovieSceneEvaluationHookComponent_Statics::NewProp_Interface = { "Interface", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Interface, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEvaluationHookComponent, Interface), Z_Construct_UClass_UMovieSceneEvaluationHook_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEvaluationHookComponent_Statics::NewProp_Interface_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEvaluationHookComponent_Statics::NewProp_Interface_MetaData)) };
...
class UScriptStruct* FTrackInstanceInputComponent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TrackInstanceInputComponent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTrackInstanceInputComponent, Z_Construct_UPackage__Script_MovieScene(), TEXT("TrackInstanceInputComponent"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FTrackInstanceInputComponent>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FTrackInstanceInputComponent_Statics::NewProp_Section = { "Section", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackInstanceInputComponent, Section), Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackInstanceInputComponent_Statics::NewProp_Section_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackInstanceInputComponent_Statics::NewProp_Section_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FTrackInstanceInputComponent_Statics::NewProp_OutputIndex = { "OutputIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackInstanceInputComponent, OutputIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackInstanceInputComponent_Statics::NewProp_OutputIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackInstanceInputComponent_Statics::NewProp_OutputIndex_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_BuiltInComponentTypes_h_Statics::ScriptStructInfo[] = {
		{ FEasingComponentData::StaticStruct, Z_Construct_UScriptStruct_FEasingComponentData_Statics::NewStructOps, TEXT("EasingComponentData"), &Z_Registration_Info_UScriptStruct_EasingComponentData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEasingComponentData), 2545264744U) },
		{ FMovieSceneTrackInstanceComponent::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneTrackInstanceComponent_Statics::NewStructOps, TEXT("MovieSceneTrackInstanceComponent"), &Z_Registration_Info_UScriptStruct_MovieSceneTrackInstanceComponent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneTrackInstanceComponent), 425509462U) },
		{ FMovieSceneEvaluationHookComponent::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneEvaluationHookComponent_Statics::NewStructOps, TEXT("MovieSceneEvaluationHookComponent"), &Z_Registration_Info_UScriptStruct_MovieSceneEvaluationHookComponent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneEvaluationHookComponent), 1135046184U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_BuiltInComponentTypes_h_1793268105(TEXT("/Script/MovieScene"),
		nullptr, 0,
