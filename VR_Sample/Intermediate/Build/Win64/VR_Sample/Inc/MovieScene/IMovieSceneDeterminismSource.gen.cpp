...
class UScriptStruct* FMovieSceneDeterminismData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneDeterminismData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneDeterminismData, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneDeterminismData"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneDeterminismData>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_Fences_Inner = { "Fences", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FFrameTime, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_Fences = { "Fences", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneDeterminismData, Fences), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_Fences_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_Fences_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_bParentSequenceRequiresLowerFence = { "bParentSequenceRequiresLowerFence", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMovieSceneDeterminismData), &Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_bParentSequenceRequiresLowerFence_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_bParentSequenceRequiresLowerFence_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_bParentSequenceRequiresLowerFence_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_bParentSequenceRequiresUpperFence = { "bParentSequenceRequiresUpperFence", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMovieSceneDeterminismData), &Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_bParentSequenceRequiresUpperFence_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_bParentSequenceRequiresUpperFence_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneDeterminismData_Statics::NewProp_bParentSequenceRequiresUpperFence_MetaData)) };
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Compilation_IMovieSceneDeterminismSource_h_1387957886(TEXT("/Script/MovieScene"),
