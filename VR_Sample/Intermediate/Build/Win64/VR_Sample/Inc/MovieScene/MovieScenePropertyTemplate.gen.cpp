...
class UScriptStruct* FMovieScenePropertySectionData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieScenePropertySectionData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieScenePropertySectionData, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieScenePropertySectionData"));
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMovieScenePropertySectionData_Statics::NewProp_PropertyName = { "PropertyName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieScenePropertySectionData, PropertyName), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieScenePropertySectionData_Statics::NewProp_PropertyName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScenePropertySectionData_Statics::NewProp_PropertyName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMovieScenePropertySectionData_Statics::NewProp_PropertyPath = { "PropertyPath", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieScenePropertySectionData, PropertyPath), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieScenePropertySectionData_Statics::NewProp_PropertyPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScenePropertySectionData_Statics::NewProp_PropertyPath_MetaData)) };
...
class UScriptStruct* FMovieScenePropertySectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieScenePropertySectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieScenePropertySectionTemplate, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieScenePropertySectionTemplate"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieScenePropertySectionTemplate>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieScenePropertyTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieScenePropertySectionData::StaticStruct, Z_Construct_UScriptStruct_FMovieScenePropertySectionData_Statics::NewStructOps, TEXT("MovieScenePropertySectionData"), &Z_Registration_Info_UScriptStruct_MovieScenePropertySectionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieScenePropertySectionData), 2296184579U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_Evaluation_MovieScenePropertyTemplate_h_480144807(TEXT("/Script/MovieScene"),
		nullptr, 0,
