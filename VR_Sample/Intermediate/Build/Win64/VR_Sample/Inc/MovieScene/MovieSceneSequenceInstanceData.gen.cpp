...
class UScriptStruct* FMovieSceneSequenceInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneSequenceInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneSequenceInstanceData, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneSequenceInstanceData"));
	}
...
class UScriptStruct* FMovieSceneSequenceInstanceDataPtr::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneSequenceInstanceDataPtr.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneSequenceInstanceDataPtr, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneSequenceInstanceDataPtr"));
	}
