...
class UScriptStruct* FMovieScenePropertyBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieScenePropertyBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieScenePropertyBinding, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieScenePropertyBinding"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieScenePropertyBinding>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FMovieScenePropertyBinding_Statics::NewProp_PropertyPath = { "PropertyPath", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieScenePropertyBinding, PropertyPath), METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieScenePropertyBinding_Statics::NewProp_PropertyPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScenePropertyBinding_Statics::NewProp_PropertyPath_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMovieScenePropertyBinding_Statics::NewProp_bCanUseClassLookup = { "bCanUseClassLookup", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMovieScenePropertyBinding), &Z_Construct_UScriptStruct_FMovieScenePropertyBinding_Statics::NewProp_bCanUseClassLookup_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieScenePropertyBinding_Statics::NewProp_bCanUseClassLookup_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieScenePropertyBinding_Statics::NewProp_bCanUseClassLookup_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_MovieScenePropertyBinding_h_Statics::ScriptStructInfo[] = {
		{ FMovieScenePropertyBinding::StaticStruct, Z_Construct_UScriptStruct_FMovieScenePropertyBinding_Statics::NewStructOps, TEXT("MovieScenePropertyBinding"), &Z_Registration_Info_UScriptStruct_MovieScenePropertyBinding, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieScenePropertyBinding), 3550206581U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_MovieScenePropertyBinding_h_560552845(TEXT("/Script/MovieScene"),
		nullptr, 0,
