...
class UScriptStruct* FMovieSceneEntitySystemGraphNode::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEntitySystemGraphNode.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEntitySystemGraphNode, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEntitySystemGraphNode"));
	}
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMovieSceneEntitySystemGraphNode_Statics::NewProp_System = { "System", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEntitySystemGraphNode, System), Z_Construct_UClass_UMovieSceneEntitySystem_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEntitySystemGraphNode_Statics::NewProp_System_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEntitySystemGraphNode_Statics::NewProp_System_MetaData)) };
...
class UScriptStruct* FMovieSceneEntitySystemGraphNodes::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEntitySystemGraphNodes.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEntitySystemGraphNodes, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEntitySystemGraphNodes"));
	}
...
class UScriptStruct* FMovieSceneEntitySystemGraph::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEntitySystemGraph.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEntitySystemGraph, Z_Construct_UPackage__Script_MovieScene(), TEXT("MovieSceneEntitySystemGraph"));
	}
...
template<> MOVIESCENE_API UScriptStruct* StaticStruct<FMovieSceneEntitySystemGraph>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_MovieSceneEntitySystemGraphs_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneEntitySystemGraphNode::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneEntitySystemGraphNode_Statics::NewStructOps, TEXT("MovieSceneEntitySystemGraphNode"), &Z_Registration_Info_UScriptStruct_MovieSceneEntitySystemGraphNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneEntitySystemGraphNode), 1102790232U) },
		...
		{ FMovieSceneEntitySystemGraph::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneEntitySystemGraph_Statics::NewStructOps, TEXT("MovieSceneEntitySystemGraph"), &Z_Registration_Info_UScriptStruct_MovieSceneEntitySystemGraph, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneEntitySystemGraph), 1960418952U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieScene_Public_EntitySystem_MovieSceneEntitySystemGraphs_h_4156155511(TEXT("/Script/MovieScene"),
		nullptr, 0,
