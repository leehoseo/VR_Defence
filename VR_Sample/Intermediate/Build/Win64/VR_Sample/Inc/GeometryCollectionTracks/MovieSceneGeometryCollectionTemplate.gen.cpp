...
class UScriptStruct* FMovieSceneGeometryCollectionSectionTemplateParameters::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneGeometryCollectionSectionTemplateParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters, Z_Construct_UPackage__Script_GeometryCollectionTracks(), TEXT("MovieSceneGeometryCollectionSectionTemplateParameters"));
	}
...
template<> GEOMETRYCOLLECTIONTRACKS_API UScriptStruct* StaticStruct<FMovieSceneGeometryCollectionSectionTemplateParameters>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::Struct_MetaDataParams[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::NewProp_SectionStartTime_MetaData[] = {
		{ "ModuleRelativePath", "Public/MovieSceneGeometryCollectionTemplate.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::NewProp_SectionStartTime = { "SectionStartTime", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneGeometryCollectionSectionTemplateParameters, SectionStartTime), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::NewProp_SectionStartTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::NewProp_SectionStartTime_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::NewProp_SectionEndTime_MetaData[] = {
		{ "ModuleRelativePath", "Public/MovieSceneGeometryCollectionTemplate.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::NewProp_SectionEndTime = { "SectionEndTime", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneGeometryCollectionSectionTemplateParameters, SectionEndTime), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::NewProp_SectionEndTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::NewProp_SectionEndTime_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::ReturnStructParams = {
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters()
	{
		...
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_MovieSceneGeometryCollectionSectionTemplateParameters.InnerSingleton, Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::ReturnStructParams);
		}
...
class UScriptStruct* FMovieSceneGeometryCollectionSectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneGeometryCollectionSectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplate, Z_Construct_UPackage__Script_GeometryCollectionTracks(), TEXT("MovieSceneGeometryCollectionSectionTemplate"));
	}
...
template<> GEOMETRYCOLLECTIONTRACKS_API UScriptStruct* StaticStruct<FMovieSceneGeometryCollectionSectionTemplate>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplate_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/MovieSceneGeometryCollectionTemplate.h" },
	};
#endif
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplate_Statics::ReturnStructParams = {
		(UObject* (*)())Z_Construct_UPackage__Script_GeometryCollectionTracks,
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplate()
	{
		...
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_MovieSceneGeometryCollectionSectionTemplate.InnerSingleton, Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplate_Statics::ReturnStructParams);
		}
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryCollectionPlugin_Source_GeometryCollectionTracks_Public_MovieSceneGeometryCollectionTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneGeometryCollectionSectionTemplateParameters::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplateParameters_Statics::NewStructOps, TEXT("MovieSceneGeometryCollectionSectionTemplateParameters"), &Z_Registration_Info_UScriptStruct_MovieSceneGeometryCollectionSectionTemplateParameters, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneGeometryCollectionSectionTemplateParameters), 4035595746U) },
		{ FMovieSceneGeometryCollectionSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneGeometryCollectionSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneGeometryCollectionSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneGeometryCollectionSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneGeometryCollectionSectionTemplate), 3620251640U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_GeometryCollectionPlugin_Source_GeometryCollectionTracks_Public_MovieSceneGeometryCollectionTemplate_h_2080948880(TEXT("/Script/GeometryCollectionTracks"),
		nullptr, 0,
