...
class UScriptStruct* FPropertyPathSegment::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PropertyPathSegment.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPropertyPathSegment, Z_Construct_UPackage__Script_PropertyPath(), TEXT("PropertyPathSegment"));
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPropertyPathSegment, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_ArrayIndex = { "ArrayIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPropertyPathSegment, ArrayIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_ArrayIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_ArrayIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Struct = { "Struct", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPropertyPathSegment, Struct), Z_Construct_UClass_UStruct, METADATA_PARAMS(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Struct_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewProp_Struct_MetaData)) };
...
class UScriptStruct* FCachedPropertyPath::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CachedPropertyPath.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCachedPropertyPath, Z_Construct_UPackage__Script_PropertyPath(), TEXT("CachedPropertyPath"));
	}
...
template<> PROPERTYPATH_API UScriptStruct* StaticStruct<FCachedPropertyPath>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_Segments_Inner = { "Segments", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPropertyPathSegment, METADATA_PARAMS(nullptr, 0) }; // 708706794
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_Segments = { "Segments", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCachedPropertyPath, Segments), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_Segments_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewProp_Segments_MetaData)) }; // 708706794
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_PropertyPath_Public_PropertyPathHelpers_h_Statics::ScriptStructInfo[] = {
		{ FPropertyPathSegment::StaticStruct, Z_Construct_UScriptStruct_FPropertyPathSegment_Statics::NewStructOps, TEXT("PropertyPathSegment"), &Z_Registration_Info_UScriptStruct_PropertyPathSegment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPropertyPathSegment), 708706794U) },
		{ FCachedPropertyPath::StaticStruct, Z_Construct_UScriptStruct_FCachedPropertyPath_Statics::NewStructOps, TEXT("CachedPropertyPath"), &Z_Registration_Info_UScriptStruct_CachedPropertyPath, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCachedPropertyPath), 390258941U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_PropertyPath_Public_PropertyPathHelpers_h_1227201710(TEXT("/Script/PropertyPath"),
		nullptr, 0,
