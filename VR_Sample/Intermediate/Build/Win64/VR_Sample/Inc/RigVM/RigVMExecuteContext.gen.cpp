...
class UScriptStruct* FRigVMSlice::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMSlice.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMSlice, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMSlice"));
	}
...
class UScriptStruct* FRigVMRuntimeSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMRuntimeSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMRuntimeSettings, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMRuntimeSettings"));
	}
...
class UScriptStruct* FRigVMExecuteContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMExecuteContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMExecuteContext, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMExecuteContext"));
	}
...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMExecuteContext>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMExecuteContext_h_Statics::ScriptStructInfo[] = {
		...
		{ FRigVMRuntimeSettings::StaticStruct, Z_Construct_UScriptStruct_FRigVMRuntimeSettings_Statics::NewStructOps, TEXT("RigVMRuntimeSettings"), &Z_Registration_Info_UScriptStruct_RigVMRuntimeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMRuntimeSettings), 2174805179U) },
		{ FRigVMExecuteContext::StaticStruct, Z_Construct_UScriptStruct_FRigVMExecuteContext_Statics::NewStructOps, TEXT("RigVMExecuteContext"), &Z_Registration_Info_UScriptStruct_RigVMExecuteContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMExecuteContext), 1342367689U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMExecuteContext_h_2912369906(TEXT("/Script/RigVM"),
		nullptr, 0,
