...
// End Cross Module References
	...
	static UEnum* ERigVMMemoryType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERigVMMemoryType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_RigVM_ERigVMMemoryType, Z_Construct_UPackage__Script_RigVM(), TEXT("ERigVMMemoryType"));
		}
...
class UScriptStruct* FRigVMOperand::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMOperand.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMOperand, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMOperand"));
	}
...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMOperand>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_MemoryType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_MemoryType_MetaData[] = {
		{ "ModuleRelativePath", "Public/RigVMCore/RigVMMemoryCommon.h" },
	};
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_MemoryType = { "MemoryType", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigVMOperand, MemoryType), Z_Construct_UEnum_RigVM_ERigVMMemoryType, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_MemoryType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_MemoryType_MetaData)) }; // 3202734936
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFInt16PropertyParams Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterIndex = { "RegisterIndex", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigVMOperand, RegisterIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFInt16PropertyParams Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterOffset = { "RegisterOffset", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::UInt16, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigVMOperand, RegisterOffset), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewProp_RegisterOffset_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMMemoryCommon_h_Statics::ScriptStructInfo[] = {
		{ FRigVMOperand::StaticStruct, Z_Construct_UScriptStruct_FRigVMOperand_Statics::NewStructOps, TEXT("RigVMOperand"), &Z_Registration_Info_UScriptStruct_RigVMOperand, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMOperand), 4071382685U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMMemoryCommon_h_2231835809(TEXT("/Script/RigVM"),
		nullptr, 0,
