...
class UScriptStruct* FRigVMUnknownType::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMUnknownType.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMUnknownType, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMUnknownType"));
	}
...
template<> RIGVM_API UScriptStruct* StaticStruct<FRigVMUnknownType>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMUnknownType_h_Statics::ScriptStructInfo[] = {
		{ FRigVMUnknownType::StaticStruct, Z_Construct_UScriptStruct_FRigVMUnknownType_Statics::NewStructOps, TEXT("RigVMUnknownType"), &Z_Registration_Info_UScriptStruct_RigVMUnknownType, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigVMUnknownType), 2196877818U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_RigVM_Public_RigVMCore_RigVMUnknownType_h_1092971118(TEXT("/Script/RigVM"),
		nullptr, 0,
