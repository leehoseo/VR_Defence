...
class UScriptStruct* FRigVMBreakpoint::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMBreakpoint.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMBreakpoint, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMBreakpoint"));
	}
...
class UScriptStruct* FRigVMDebugInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigVMDebugInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigVMDebugInfo, Z_Construct_UPackage__Script_RigVM(), TEXT("RigVMDebugInfo"));
	}
