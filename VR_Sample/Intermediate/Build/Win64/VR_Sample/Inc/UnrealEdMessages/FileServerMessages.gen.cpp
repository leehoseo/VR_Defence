...
class UScriptStruct* FFileServerReady::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FileServerReady.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFileServerReady, Z_Construct_UPackage__Script_UnrealEdMessages(), TEXT("FileServerReady"));
	}
...
template<> UNREALEDMESSAGES_API UScriptStruct* StaticStruct<FFileServerReady>()
{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FFileServerReady_Statics::NewProp_AddressList_Inner = { "AddressList", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_UnrealEdMessages_Classes_FileServerMessages_h_Statics::ScriptStructInfo[] = {
		{ FFileServerReady::StaticStruct, Z_Construct_UScriptStruct_FFileServerReady_Statics::NewStructOps, TEXT("FileServerReady"), &Z_Registration_Info_UScriptStruct_FileServerReady, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFileServerReady), 4262123922U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_UnrealEdMessages_Classes_FileServerMessages_h_1369127755(TEXT("/Script/UnrealEdMessages"),
		nullptr, 0,
