...
class UScriptStruct* FAssetEditorRequestOpenAsset::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AssetEditorRequestOpenAsset.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAssetEditorRequestOpenAsset, Z_Construct_UPackage__Script_UnrealEdMessages(), TEXT("AssetEditorRequestOpenAsset"));
	}
...
template<> UNREALEDMESSAGES_API UScriptStruct* StaticStruct<FAssetEditorRequestOpenAsset>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_UnrealEdMessages_Classes_AssetEditorMessages_h_Statics::ScriptStructInfo[] = {
		{ FAssetEditorRequestOpenAsset::StaticStruct, Z_Construct_UScriptStruct_FAssetEditorRequestOpenAsset_Statics::NewStructOps, TEXT("AssetEditorRequestOpenAsset"), &Z_Registration_Info_UScriptStruct_AssetEditorRequestOpenAsset, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAssetEditorRequestOpenAsset), 1911891291U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Editor_UnrealEdMessages_Classes_AssetEditorMessages_h_2885489844(TEXT("/Script/UnrealEdMessages"),
		nullptr, 0,
