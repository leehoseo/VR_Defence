...
class UScriptStruct* FNamedInterface::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NamedInterface.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNamedInterface, Z_Construct_UPackage__Script_OnlineSubsystem(), TEXT("NamedInterface"));
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceName = { "InterfaceName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNamedInterface, InterfaceName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceObject = { "InterfaceObject", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNamedInterface, InterfaceObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterface_Statics::NewProp_InterfaceObject_MetaData)) };
...
class UScriptStruct* FNamedInterfaceDef::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NamedInterfaceDef.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNamedInterfaceDef, Z_Construct_UPackage__Script_OnlineSubsystem(), TEXT("NamedInterfaceDef"));
	}
...
template<> ONLINESUBSYSTEM_API UScriptStruct* StaticStruct<FNamedInterfaceDef>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceName = { "InterfaceName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNamedInterfaceDef, InterfaceName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceClassName = { "InterfaceClassName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNamedInterfaceDef, InterfaceClassName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceClassName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewProp_InterfaceClassName_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNamedInterfaces_Statics::NewProp_NamedInterfaces_Inner = { "NamedInterfaces", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNamedInterface, METADATA_PARAMS(nullptr, 0) }; // 2136438507
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNamedInterfaces_Statics::NewProp_NamedInterfaces = { "NamedInterfaces", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNamedInterfaces, NamedInterfaces), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNamedInterfaces_Statics::NewProp_NamedInterfaces_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNamedInterfaces_Statics::NewProp_NamedInterfaces_MetaData)) }; // 2136438507
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNamedInterfaces_Statics::NewProp_NamedInterfaceDefs_Inner = { "NamedInterfaceDefs", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNamedInterfaceDef, METADATA_PARAMS(nullptr, 0) }; // 3332594145
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNamedInterfaces_Statics::NewProp_NamedInterfaceDefs = { "NamedInterfaceDefs", nullptr, (EPropertyFlags)0x0040000000004000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNamedInterfaces, NamedInterfaceDefs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNamedInterfaces_Statics::NewProp_NamedInterfaceDefs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNamedInterfaces_Statics::NewProp_NamedInterfaceDefs_MetaData)) }; // 3332594145
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_Statics::ScriptStructInfo[] = {
		{ FNamedInterface::StaticStruct, Z_Construct_UScriptStruct_FNamedInterface_Statics::NewStructOps, TEXT("NamedInterface"), &Z_Registration_Info_UScriptStruct_NamedInterface, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNamedInterface), 2136438507U) },
		{ FNamedInterfaceDef::StaticStruct, Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewStructOps, TEXT("NamedInterfaceDef"), &Z_Registration_Info_UScriptStruct_NamedInterfaceDef, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNamedInterfaceDef), 3332594145U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNamedInterfaces, UNamedInterfaces::StaticClass, TEXT("UNamedInterfaces"), &Z_Registration_Info_UClass_UNamedInterfaces, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNamedInterfaces), 152747148U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_3711636098(TEXT("/Script/OnlineSubsystem"),
