...
// End Cross Module References
	...
	static UEnum* ELocationAccuracy_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELocationAccuracy.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_LocationServicesBPLibrary_ELocationAccuracy, Z_Construct_UPackage__Script_LocationServicesBPLibrary(), TEXT("ELocationAccuracy"));
		}
...
class UScriptStruct* FLocationServicesData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LocationServicesData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLocationServicesData, Z_Construct_UPackage__Script_LocationServicesBPLibrary(), TEXT("LocationServicesData"));
	}
...
template<> LOCATIONSERVICESBPLIBRARY_API UScriptStruct* StaticStruct<FLocationServicesData>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Longitude = { "Longitude", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLocationServicesData, Longitude), METADATA_PARAMS(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Longitude_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Longitude_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Latitude = { "Latitude", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLocationServicesData, Latitude), METADATA_PARAMS(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Latitude_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Latitude_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_HorizontalAccuracy = { "HorizontalAccuracy", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLocationServicesData, HorizontalAccuracy), METADATA_PARAMS(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_HorizontalAccuracy_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_HorizontalAccuracy_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_VerticalAccuracy = { "VerticalAccuracy", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLocationServicesData, VerticalAccuracy), METADATA_PARAMS(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_VerticalAccuracy_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_VerticalAccuracy_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Altitude = { "Altitude", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLocationServicesData, Altitude), METADATA_PARAMS(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Altitude_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewProp_Altitude_MetaData)) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_LocationServicesBPLibrary_LocationServicesData_OnLocationChanged__DelegateSignature_Statics::NewProp_LocationData = { "LocationData", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_LocationServicesBPLibrary_eventLocationServicesData_OnLocationChanged_Parms, LocationData), Z_Construct_UScriptStruct_FLocationServicesData, METADATA_PARAMS(nullptr, 0) }; // 2693605290
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULocationServices_AreLocationServicesEnabled_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(LocationServices_eventAreLocationServicesEnabled_Parms), &Z_Construct_UFunction_ULocationServices_AreLocationServicesEnabled_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ULocationServices_GetLastKnownLocation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LocationServices_eventGetLastKnownLocation_Parms, ReturnValue), Z_Construct_UScriptStruct_FLocationServicesData, METADATA_PARAMS(nullptr, 0) }; // 2693605290
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ULocationServices_GetLocationServicesImpl_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LocationServices_eventGetLocationServicesImpl_Parms, ReturnValue), Z_Construct_UClass_ULocationServicesImpl_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ULocationServices_InitLocationServices_Statics::NewProp_Accuracy_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULocationServices_InitLocationServices_Statics::NewProp_Accuracy = { "Accuracy", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LocationServices_eventInitLocationServices_Parms, Accuracy), Z_Construct_UEnum_LocationServicesBPLibrary_ELocationAccuracy, METADATA_PARAMS(nullptr, 0) }; // 614899844
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ULocationServices_InitLocationServices_Statics::NewProp_UpdateFrequency = { "UpdateFrequency", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LocationServices_eventInitLocationServices_Parms, UpdateFrequency), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ULocationServices_InitLocationServices_Statics::NewProp_MinDistanceFilter = { "MinDistanceFilter", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LocationServices_eventInitLocationServices_Parms, MinDistanceFilter), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULocationServices_InitLocationServices_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(LocationServices_eventInitLocationServices_Parms), &Z_Construct_UFunction_ULocationServices_InitLocationServices_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ULocationServices_IsLocationAccuracyAvailable_Statics::NewProp_Accuracy_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULocationServices_IsLocationAccuracyAvailable_Statics::NewProp_Accuracy = { "Accuracy", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LocationServices_eventIsLocationAccuracyAvailable_Parms, Accuracy), Z_Construct_UEnum_LocationServicesBPLibrary_ELocationAccuracy, METADATA_PARAMS(nullptr, 0) }; // 614899844
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULocationServices_IsLocationAccuracyAvailable_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(LocationServices_eventIsLocationAccuracyAvailable_Parms), &Z_Construct_UFunction_ULocationServices_IsLocationAccuracyAvailable_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULocationServices_StartLocationServices_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(LocationServices_eventStartLocationServices_Parms), &Z_Construct_UFunction_ULocationServices_StartLocationServices_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ULocationServices_StopLocationServices_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(LocationServices_eventStopLocationServices_Parms), &Z_Construct_UFunction_ULocationServices_StopLocationServices_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULocationServices_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULocationServices_AreLocationServicesEnabled, "AreLocationServicesEnabled" }, // 110230212
		{ &Z_Construct_UFunction_ULocationServices_GetLastKnownLocation, "GetLastKnownLocation" }, // 3982288870
		{ &Z_Construct_UFunction_ULocationServices_GetLocationServicesImpl, "GetLocationServicesImpl" }, // 1756145218
		{ &Z_Construct_UFunction_ULocationServices_InitLocationServices, "InitLocationServices" }, // 3034698798
		{ &Z_Construct_UFunction_ULocationServices_IsLocationAccuracyAvailable, "IsLocationAccuracyAvailable" }, // 704160149
		{ &Z_Construct_UFunction_ULocationServices_StartLocationServices, "StartLocationServices" }, // 4239987797
		{ &Z_Construct_UFunction_ULocationServices_StopLocationServices, "StopLocationServices" }, // 3525139476
	};
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesBPLibrary_Source_LocationServicesBPLibrary_Classes_LocationServicesBPLibrary_h_Statics::ScriptStructInfo[] = {
		{ FLocationServicesData::StaticStruct, Z_Construct_UScriptStruct_FLocationServicesData_Statics::NewStructOps, TEXT("LocationServicesData"), &Z_Registration_Info_UScriptStruct_LocationServicesData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLocationServicesData), 2693605290U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesBPLibrary_Source_LocationServicesBPLibrary_Classes_LocationServicesBPLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULocationServices, ULocationServices::StaticClass, TEXT("ULocationServices"), &Z_Registration_Info_UClass_ULocationServices, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULocationServices), 4223981175U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_LocationServicesBPLibrary_Source_LocationServicesBPLibrary_Classes_LocationServicesBPLibrary_h_3971718624(TEXT("/Script/LocationServicesBPLibrary"),
