...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfigs_ValueProp = { "ClothConfigs", nullptr, (EPropertyFlags)0x00060000000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_UClothConfigBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfigs_ValueProp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfigs_ValueProp_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfigs_Key_KeyProp = { "ClothConfigs_Key", nullptr, (EPropertyFlags)0x00020000000a0009, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfigs = { "ClothConfigs", nullptr, (EPropertyFlags)0x001400800002005d, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, ClothConfigs), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfigs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfigs_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothLodData = { "ClothLodData", nullptr, (EPropertyFlags)0x0014000820000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, ClothLodData_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothLodData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothLodData_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_LodData_Inner = { "LodData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FClothLODDataCommon, METADATA_PARAMS(nullptr, 0) }; // 3924013521
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_LodData = { "LodData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, LodData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_LodData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_LodData_MetaData)) }; // 3924013521
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_LodMap_Inner = { "LodMap", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_LodMap = { "LodMap", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, LodMap), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_LodMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_LodMap_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_UsedBoneNames_Inner = { "UsedBoneNames", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_UsedBoneNames = { "UsedBoneNames", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, UsedBoneNames), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_UsedBoneNames_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_UsedBoneNames_MetaData)) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_UsedBoneIndices_Inner = { "UsedBoneIndices", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_UsedBoneIndices = { "UsedBoneIndices", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, UsedBoneIndices), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_UsedBoneIndices_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_UsedBoneIndices_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ReferenceBoneIndex = { "ReferenceBoneIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, ReferenceBoneIndex), METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ReferenceBoneIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ReferenceBoneIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_CustomData = { "CustomData", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, CustomData), Z_Construct_UClass_UClothingAssetCustomData_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_CustomData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_CustomData_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfig = { "ClothConfig", nullptr, (EPropertyFlags)0x0010000820000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetCommon, ClothConfig_DEPRECATED), Z_Construct_UScriptStruct_FClothConfig_Legacy, METADATA_PARAMS(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfig_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetCommon_Statics::NewProp_ClothConfig_MetaData)) }; // 1905670407
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeCommon_Public_ClothingAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UClothingAssetCustomData, UClothingAssetCustomData::StaticClass, TEXT("UClothingAssetCustomData"), &Z_Registration_Info_UClass_UClothingAssetCustomData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UClothingAssetCustomData), 3914484460U) },
		{ Z_Construct_UClass_UClothingAssetCommon, UClothingAssetCommon::StaticClass, TEXT("UClothingAssetCommon"), &Z_Registration_Info_UClass_UClothingAssetCommon, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UClothingAssetCommon), 1322500131U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeCommon_Public_ClothingAsset_h_2199819702(TEXT("/Script/ClothingSystemRuntimeCommon"),
