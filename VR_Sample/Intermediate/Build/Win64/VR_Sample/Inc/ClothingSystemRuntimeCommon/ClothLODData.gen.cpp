...
class UScriptStruct* FClothLODDataCommon::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ClothLODDataCommon.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FClothLODDataCommon, Z_Construct_UPackage__Script_ClothingSystemRuntimeCommon(), TEXT("ClothLODDataCommon"));
	}
...
template<> CLOTHINGSYSTEMRUNTIMECOMMON_API UScriptStruct* StaticStruct<FClothLODDataCommon>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_CollisionData = { "CollisionData", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClothLODDataCommon, CollisionData), Z_Construct_UScriptStruct_FClothCollisionData, METADATA_PARAMS(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_CollisionData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_CollisionData_MetaData)) }; // 1478062750
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_bUseMultipleInfluences = { "bUseMultipleInfluences", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FClothLODDataCommon), &Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_bUseMultipleInfluences_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_bUseMultipleInfluences_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_bUseMultipleInfluences_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_SkinningKernelRadius = { "SkinningKernelRadius", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClothLODDataCommon, SkinningKernelRadius), METADATA_PARAMS(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_SkinningKernelRadius_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_SkinningKernelRadius_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_bSmoothTransition = { "bSmoothTransition", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FClothLODDataCommon), &Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_bSmoothTransition_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_bSmoothTransition_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_bSmoothTransition_MetaData)) };
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_ParameterMasks_Inner = { "ParameterMasks", nullptr, (EPropertyFlags)0x0000000820000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FClothParameterMask_Legacy, METADATA_PARAMS(nullptr, 0) }; // 2724315791
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_ParameterMasks = { "ParameterMasks", nullptr, (EPropertyFlags)0x0010000820000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClothLODDataCommon, ParameterMasks_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_ParameterMasks_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_ParameterMasks_MetaData)) }; // 2724315791
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_PointWeightMaps_Inner = { "PointWeightMaps", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPointWeightMap, METADATA_PARAMS(nullptr, 0) }; // 2553309909
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_PointWeightMaps = { "PointWeightMaps", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClothLODDataCommon, PointWeightMaps), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_PointWeightMaps_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewProp_PointWeightMaps_MetaData)) }; // 2553309909
#endif // WITH_EDITORONLY_DATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeCommon_Public_ClothLODData_h_Statics::ScriptStructInfo[] = {
		{ FClothLODDataCommon::StaticStruct, Z_Construct_UScriptStruct_FClothLODDataCommon_Statics::NewStructOps, TEXT("ClothLODDataCommon"), &Z_Registration_Info_UScriptStruct_ClothLODDataCommon, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClothLODDataCommon), 3924013521U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeCommon_Public_ClothLODData_h_1721298420(TEXT("/Script/ClothingSystemRuntimeCommon"),
		nullptr, 0,
