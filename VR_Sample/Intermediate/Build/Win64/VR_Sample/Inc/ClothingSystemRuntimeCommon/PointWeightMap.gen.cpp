...
// End Cross Module References
	...
	static UEnum* EWeightMapTargetCommon_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWeightMapTargetCommon.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ClothingSystemRuntimeCommon_EWeightMapTargetCommon, Z_Construct_UPackage__Script_ClothingSystemRuntimeCommon(), TEXT("EWeightMapTargetCommon"));
		}
...
class UScriptStruct* FPointWeightMap::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PointWeightMap.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPointWeightMap, Z_Construct_UPackage__Script_ClothingSystemRuntimeCommon(), TEXT("PointWeightMap"));
	}
...
template<> CLOTHINGSYSTEMRUNTIMECOMMON_API UScriptStruct* StaticStruct<FPointWeightMap>()
{
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_Values_Inner = { "Values", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_Values = { "Values", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPointWeightMap, Values), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_Values_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_Values_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPointWeightMap, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_CurrentTarget = { "CurrentTarget", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPointWeightMap, CurrentTarget), nullptr, METADATA_PARAMS(Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_CurrentTarget_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_CurrentTarget_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_bEnabled = { "bEnabled", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPointWeightMap), &Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_bEnabled_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_bEnabled_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewProp_bEnabled_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeCommon_Public_PointWeightMap_h_Statics::ScriptStructInfo[] = {
		{ FPointWeightMap::StaticStruct, Z_Construct_UScriptStruct_FPointWeightMap_Statics::NewStructOps, TEXT("PointWeightMap"), &Z_Registration_Info_UScriptStruct_PointWeightMap, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPointWeightMap), 2553309909U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeCommon_Public_PointWeightMap_h_2667779844(TEXT("/Script/ClothingSystemRuntimeCommon"),
		nullptr, 0,
