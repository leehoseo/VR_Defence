...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_OutputSubmix = { "OutputSubmix", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UResonanceAudioSettings, OutputSubmix), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_OutputSubmix_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_OutputSubmix_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_QualityMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_QualityMode = { "QualityMode", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UResonanceAudioSettings, QualityMode), Z_Construct_UEnum_ResonanceAudio_ERaQualityMode, METADATA_PARAMS(Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_QualityMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_QualityMode_MetaData)) }; // 1206899692
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_GlobalReverbPreset = { "GlobalReverbPreset", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UResonanceAudioSettings, GlobalReverbPreset), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_GlobalReverbPreset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_GlobalReverbPreset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_GlobalSourcePreset = { "GlobalSourcePreset", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UResonanceAudioSettings, GlobalSourcePreset), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_GlobalSourcePreset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UResonanceAudioSettings_Statics::NewProp_GlobalSourcePreset_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Private_ResonanceAudioSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UResonanceAudioSettings, UResonanceAudioSettings::StaticClass, TEXT("UResonanceAudioSettings"), &Z_Registration_Info_UClass_UResonanceAudioSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UResonanceAudioSettings), 1734491004U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Private_ResonanceAudioSettings_h_3818263997(TEXT("/Script/ResonanceAudio"),
