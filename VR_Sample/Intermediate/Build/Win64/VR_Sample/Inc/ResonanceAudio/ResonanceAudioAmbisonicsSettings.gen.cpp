...
// End Cross Module References
	...
	static UEnum* EResonanceRenderMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EResonanceRenderMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ResonanceAudio_EResonanceRenderMode, Z_Construct_UPackage__Script_ResonanceAudio(), TEXT("EResonanceRenderMode"));
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Public_ResonanceAudioAmbisonicsSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UResonanceAudioSoundfieldSettings, UResonanceAudioSoundfieldSettings::StaticClass, TEXT("UResonanceAudioSoundfieldSettings"), &Z_Registration_Info_UClass_UResonanceAudioSoundfieldSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UResonanceAudioSoundfieldSettings), 2379868675U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Public_ResonanceAudioAmbisonicsSettings_h_3963129592(TEXT("/Script/ResonanceAudio"),
