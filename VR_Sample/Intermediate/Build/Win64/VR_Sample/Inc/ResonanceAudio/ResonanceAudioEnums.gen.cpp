...
#include "ResonanceAudio/Private/ResonanceAudioEnums.h"
...
// End Cross Module References
	...
	static UEnum* ERaQualityMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERaQualityMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ResonanceAudio_ERaQualityMode, Z_Construct_UPackage__Script_ResonanceAudio(), TEXT("ERaQualityMode"));
		}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_ResonanceAudio_ERaQualityMode_Statics::Enum_MetaDataParams[] = {
		...
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Private/ResonanceAudioEnums.h" },
	...
	static UEnum* ERaSpatializationMethod_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERaSpatializationMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ResonanceAudio_ERaSpatializationMethod, Z_Construct_UPackage__Script_ResonanceAudio(), TEXT("ERaSpatializationMethod"));
		}
	...
	static UEnum* ERaDistanceRolloffModel_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERaDistanceRolloffModel.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ResonanceAudio_ERaDistanceRolloffModel, Z_Construct_UPackage__Script_ResonanceAudio(), TEXT("ERaDistanceRolloffModel"));
		}
	...
	static UEnum* ERaMaterialName_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERaMaterialName.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ResonanceAudio_ERaMaterialName, Z_Construct_UPackage__Script_ResonanceAudio(), TEXT("ERaMaterialName"));
		}
	...
	struct Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Private_ResonanceAudioEnums_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Private_ResonanceAudioEnums_h_Statics::EnumInfo[] = {
		{ ERaQualityMode_StaticEnum, TEXT("ERaQualityMode"), &Z_Registration_Info_UEnum_ERaQualityMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1206899692U) },
		{ ERaSpatializationMethod_StaticEnum, TEXT("ERaSpatializationMethod"), &Z_Registration_Info_UEnum_ERaSpatializationMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1144866390U) },
		{ ERaDistanceRolloffModel_StaticEnum, TEXT("ERaDistanceRolloffModel"), &Z_Registration_Info_UEnum_ERaDistanceRolloffModel, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2920628869U) },
		{ ERaMaterialName_StaticEnum, TEXT("ERaMaterialName"), &Z_Registration_Info_UEnum_ERaMaterialName, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2105143029U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Private_ResonanceAudioEnums_h_1442334658(TEXT("/Script/ResonanceAudio"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Private_ResonanceAudioEnums_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_ResonanceAudio_Source_ResonanceAudio_Private_ResonanceAudioEnums_h_Statics::EnumInfo));
