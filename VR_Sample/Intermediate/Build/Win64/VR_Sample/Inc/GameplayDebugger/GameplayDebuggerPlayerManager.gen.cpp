...
class UScriptStruct* FGameplayDebuggerPlayerData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GameplayDebuggerPlayerData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData, Z_Construct_UPackage__Script_GameplayDebugger(), TEXT("GameplayDebuggerPlayerData"));
	}
...
template<> GAMEPLAYDEBUGGER_API UScriptStruct* StaticStruct<FGameplayDebuggerPlayerData>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_Controller = { "Controller", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGameplayDebuggerPlayerData, Controller), Z_Construct_UClass_UGameplayDebuggerLocalController_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_Controller_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_Controller_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_InputComponent = { "InputComponent", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGameplayDebuggerPlayerData, InputComponent), Z_Construct_UClass_UInputComponent_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_InputComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_InputComponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_Replicator = { "Replicator", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGameplayDebuggerPlayerData, Replicator), Z_Construct_UClass_AGameplayDebuggerCategoryReplicator_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_Replicator_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData_Statics::NewProp_Replicator_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PlayerData = { "PlayerData", nullptr, (EPropertyFlags)0x0020088000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameplayDebuggerPlayerManager, PlayerData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PlayerData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PlayerData_MetaData)) }; // 2385230998
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PendingRegistrations_Inner = { "PendingRegistrations", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_AGameplayDebuggerCategoryReplicator_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PendingRegistrations = { "PendingRegistrations", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameplayDebuggerPlayerManager, PendingRegistrations), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PendingRegistrations_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_PendingRegistrations_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_EditorWorldData = { "EditorWorldData", nullptr, (EPropertyFlags)0x0020088800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameplayDebuggerPlayerManager, EditorWorldData), Z_Construct_UScriptStruct_FGameplayDebuggerPlayerData, METADATA_PARAMS(Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_EditorWorldData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGameplayDebuggerPlayerManager_Statics::NewProp_EditorWorldData_MetaData)) }; // 2385230998
#endif // WITH_EDITORONLY_DATA
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerPlayerManager_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerPlayerManager_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerPlayerManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGameplayDebuggerPlayerManager, AGameplayDebuggerPlayerManager::StaticClass, TEXT("AGameplayDebuggerPlayerManager"), &Z_Registration_Info_UClass_AGameplayDebuggerPlayerManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGameplayDebuggerPlayerManager), 688124034U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerPlayerManager_h_717590679(TEXT("/Script/GameplayDebugger"),
		Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerPlayerManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerPlayerManager_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerPlayerManager_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerPlayerManager_h_Statics::ScriptStructInfo),
		nullptr, 0);
