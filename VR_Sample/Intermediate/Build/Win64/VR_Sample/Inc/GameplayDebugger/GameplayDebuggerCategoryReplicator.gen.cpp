...
template<> GAMEPLAYDEBUGGER_API UScriptStruct* StaticStruct<FGameplayDebuggerVisLogSync>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerCategoryReplicator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGameplayDebuggerCategoryReplicator, AGameplayDebuggerCategoryReplicator::StaticClass, TEXT("AGameplayDebuggerCategoryReplicator"), &Z_Registration_Info_UClass_AGameplayDebuggerCategoryReplicator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGameplayDebuggerCategoryReplicator), 4262064612U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerCategoryReplicator_h_3987894762(TEXT("/Script/GameplayDebugger"),
