...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGameplayDebuggerLocalController_Statics::NewProp_DebugActorCandidate = { "DebugActorCandidate", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameplayDebuggerLocalController, DebugActorCandidate), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGameplayDebuggerLocalController_Statics::NewProp_DebugActorCandidate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayDebuggerLocalController_Statics::NewProp_DebugActorCandidate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UGameplayDebuggerLocalController_Statics::NewProp_HUDFont = { "HUDFont", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameplayDebuggerLocalController, HUDFont), Z_Construct_UClass_UFont_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UGameplayDebuggerLocalController_Statics::NewProp_HUDFont_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameplayDebuggerLocalController_Statics::NewProp_HUDFont_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerLocalController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerLocalController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameplayDebuggerLocalController, UGameplayDebuggerLocalController::StaticClass, TEXT("UGameplayDebuggerLocalController"), &Z_Registration_Info_UClass_UGameplayDebuggerLocalController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameplayDebuggerLocalController), 1571906625U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerLocalController_h_3444190374(TEXT("/Script/GameplayDebugger"),
		Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerLocalController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Developer_GameplayDebugger_Public_GameplayDebuggerLocalController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
