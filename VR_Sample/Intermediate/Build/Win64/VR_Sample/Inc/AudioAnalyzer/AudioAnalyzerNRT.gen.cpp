...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAudioAnalyzerNRT_Statics::NewProp_DurationInSeconds = { "DurationInSeconds", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAudioAnalyzerNRT, DurationInSeconds), METADATA_PARAMS(Z_Construct_UClass_UAudioAnalyzerNRT_Statics::NewProp_DurationInSeconds_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAudioAnalyzerNRT_Statics::NewProp_DurationInSeconds_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioAnalyzer_Classes_AudioAnalyzerNRT_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioAnalyzerNRTSettings, UAudioAnalyzerNRTSettings::StaticClass, TEXT("UAudioAnalyzerNRTSettings"), &Z_Registration_Info_UClass_UAudioAnalyzerNRTSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioAnalyzerNRTSettings), 466214617U) },
		{ Z_Construct_UClass_UAudioAnalyzerNRT, UAudioAnalyzerNRT::StaticClass, TEXT("UAudioAnalyzerNRT"), &Z_Registration_Info_UClass_UAudioAnalyzerNRT, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioAnalyzerNRT), 4048886344U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioAnalyzer_Classes_AudioAnalyzerNRT_h_1074178500(TEXT("/Script/AudioAnalyzer"),
