...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_BoundPreviewActor_MetaData[];
#endif
		static const UECodeGen_Private::FSoftObjectPropertyParams NewProp_BoundPreviewActor;
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UTemplateSequence_Statics::NewProp_MovieScene = { "MovieScene", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTemplateSequence, MovieScene), Z_Construct_UClass_UMovieScene_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_MovieScene_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_MovieScene_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorClass_MetaData[] = {
		{ "ModuleRelativePath", "Public/TemplateSequence.h" },
	};
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorClass = { "BoundActorClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTemplateSequence, BoundActorClass), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorClass_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundPreviewActor_MetaData[] = {
		{ "ModuleRelativePath", "Public/TemplateSequence.h" },
	};
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundPreviewActor = { "BoundPreviewActor", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTemplateSequence, BoundPreviewActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundPreviewActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundPreviewActor_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorComponents_ValueProp = { "BoundActorComponents", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorComponents_Key_KeyProp = { "BoundActorComponents_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorComponents = { "BoundActorComponents", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTemplateSequence, BoundActorComponents), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorComponents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundActorComponents_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UTemplateSequence_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UTemplateSequence_Statics::NewProp_BoundPreviewActor,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_TemplateSequence_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTemplateSequence, UTemplateSequence::StaticClass, TEXT("UTemplateSequence"), &Z_Registration_Info_UClass_UTemplateSequence, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTemplateSequence), 134451193U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_TemplateSequence_h_1997221934(TEXT("/Script/TemplateSequence"),
