...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTemplateSequenceSystem_Statics::Class_MetaDataParams[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTemplateSequencePropertyScalingInstantiatorSystem_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Systems/TemplateSequenceSystem.h" },
		{ "ModuleRelativePath", "Private/Systems/TemplateSequenceSystem.h" },
		{ "ObjectInitializerConstructorDeclared", "" },
	};
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTemplateSequencePropertyScalingEvaluatorSystem_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Systems/TemplateSequenceSystem.h" },
		{ "ModuleRelativePath", "Private/Systems/TemplateSequenceSystem.h" },
		{ "ObjectInitializerConstructorDeclared", "" },
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Private_Systems_TemplateSequenceSystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTemplateSequenceSystem, UTemplateSequenceSystem::StaticClass, TEXT("UTemplateSequenceSystem"), &Z_Registration_Info_UClass_UTemplateSequenceSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTemplateSequenceSystem), 2332274098U) },
		...
		{ Z_Construct_UClass_UTemplateSequencePropertyScalingEvaluatorSystem, UTemplateSequencePropertyScalingEvaluatorSystem::StaticClass, TEXT("UTemplateSequencePropertyScalingEvaluatorSystem"), &Z_Registration_Info_UClass_UTemplateSequencePropertyScalingEvaluatorSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTemplateSequencePropertyScalingEvaluatorSystem), 4056304022U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Private_Systems_TemplateSequenceSystem_h_3049013197(TEXT("/Script/TemplateSequence"),
