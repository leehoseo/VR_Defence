...
// End Cross Module References
	...
	static UEnum* ETemplateSectionPropertyScaleType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETemplateSectionPropertyScaleType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_TemplateSequence_ETemplateSectionPropertyScaleType, Z_Construct_UPackage__Script_TemplateSequence(), TEXT("ETemplateSectionPropertyScaleType"));
		}
...
class UScriptStruct* FTemplateSectionPropertyScale::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TemplateSectionPropertyScale.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTemplateSectionPropertyScale, Z_Construct_UPackage__Script_TemplateSequence(), TEXT("TemplateSectionPropertyScale"));
	}
...
template<> TEMPLATESEQUENCE_API UScriptStruct* StaticStruct<FTemplateSectionPropertyScale>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_PropertyBinding = { "PropertyBinding", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTemplateSectionPropertyScale, PropertyBinding), Z_Construct_UScriptStruct_FMovieScenePropertyBinding, METADATA_PARAMS(Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_PropertyBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_PropertyBinding_MetaData)) }; // 3550206581
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_PropertyScaleType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_PropertyScaleType = { "PropertyScaleType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTemplateSectionPropertyScale, PropertyScaleType), Z_Construct_UEnum_TemplateSequence_ETemplateSectionPropertyScaleType, METADATA_PARAMS(Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_PropertyScaleType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_PropertyScaleType_MetaData)) }; // 135413216
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_FloatChannel = { "FloatChannel", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTemplateSectionPropertyScale, FloatChannel), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_FloatChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewProp_FloatChannel_MetaData)) }; // 312122321
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UTemplateSequenceSection_Statics::NewProp_PropertyScales_Inner = { "PropertyScales", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FTemplateSectionPropertyScale, METADATA_PARAMS(nullptr, 0) }; // 504264874
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UTemplateSequenceSection_Statics::NewProp_PropertyScales = { "PropertyScales", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTemplateSequenceSection, PropertyScales), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UTemplateSequenceSection_Statics::NewProp_PropertyScales_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTemplateSequenceSection_Statics::NewProp_PropertyScales_MetaData)) }; // 504264874
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UTemplateSequenceSection_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UTemplateSequenceSection_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneEntityProvider_NoRegister, (int32)VTABLE_OFFSET(UTemplateSequenceSection, IMovieSceneEntityProvider), false },  // 1947645787
		};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_Sections_TemplateSequenceSection_h_Statics::ScriptStructInfo[] = {
		{ FTemplateSectionPropertyScale::StaticStruct, Z_Construct_UScriptStruct_FTemplateSectionPropertyScale_Statics::NewStructOps, TEXT("TemplateSectionPropertyScale"), &Z_Registration_Info_UScriptStruct_TemplateSectionPropertyScale, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTemplateSectionPropertyScale), 504264874U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_Sections_TemplateSequenceSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTemplateSequenceSection, UTemplateSequenceSection::StaticClass, TEXT("UTemplateSequenceSection"), &Z_Registration_Info_UClass_UTemplateSequenceSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTemplateSequenceSection), 503815303U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_TemplateSequence_Source_TemplateSequence_Public_Sections_TemplateSequenceSection_h_3031580330(TEXT("/Script/TemplateSequence"),
