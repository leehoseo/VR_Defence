...
void EmptyLinkFunctionForGeneratedCodeCoreUObject_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_CoreUObject()
	{
		if (!Z_Registration_Info_UPackage__Script_CoreUObject.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UScriptStruct_FARFilter,
				(UObject* (*)())Z_Construct_UScriptStruct_FAssetBundleData,
				(UObject* (*)())Z_Construct_UScriptStruct_FAssetBundleEntry,
				(UObject* (*)())Z_Construct_UScriptStruct_FAssetData,
				...
				(UObject* (*)())Z_Construct_UScriptStruct_FDirectoryPath,
				(UObject* (*)())Z_Construct_UScriptStruct_FFallbackStruct,
				(UObject* (*)())Z_Construct_UScriptStruct_FFilePath,
				...
				(UObject* (*)())Z_Construct_UScriptStruct_FPrimaryAssetId,
				(UObject* (*)())Z_Construct_UScriptStruct_FPrimaryAssetType,
				...
				(UObject* (*)())Z_Construct_UScriptStruct_FSoftClassPath,
				(UObject* (*)())Z_Construct_UScriptStruct_FSoftObjectPath,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_CoreUObject(Z_Construct_UPackage__Script_CoreUObject, TEXT("/Script/CoreUObject"), Z_Registration_Info_UPackage__Script_CoreUObject, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x2C143E42, 0xC61583A3));
