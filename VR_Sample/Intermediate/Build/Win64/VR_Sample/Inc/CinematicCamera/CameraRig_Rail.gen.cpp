...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACameraRig_Rail_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACameraRig_Rail_GetRailSplineComponent, "GetRailSplineComponent" }, // 599822637
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_CurrentPositionOnRail = { "CurrentPositionOnRail", nullptr, (EPropertyFlags)0x0010000200000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACameraRig_Rail, CurrentPositionOnRail), METADATA_PARAMS(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_CurrentPositionOnRail_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_CurrentPositionOnRail_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_bLockOrientationToRail = { "bLockOrientationToRail", nullptr, (EPropertyFlags)0x0010000200000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ACameraRig_Rail), &Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_bLockOrientationToRail_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_bLockOrientationToRail_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_bLockOrientationToRail_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_bShowRailVisualization = { "bShowRailVisualization", nullptr, (EPropertyFlags)0x0010000800002001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ACameraRig_Rail), &Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_bShowRailVisualization_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_bShowRailVisualization_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_bShowRailVisualization_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewMeshScale = { "PreviewMeshScale", nullptr, (EPropertyFlags)0x0010000800002001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACameraRig_Rail, PreviewMeshScale), METADATA_PARAMS(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewMeshScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewMeshScale_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_TransformComponent = { "TransformComponent", nullptr, (EPropertyFlags)0x0044000000090009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACameraRig_Rail, TransformComponent), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_TransformComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_TransformComponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_RailCameraMount = { "RailCameraMount", nullptr, (EPropertyFlags)0x0044000000090009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACameraRig_Rail, RailCameraMount), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_RailCameraMount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_RailCameraMount_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewMesh_Rail = { "PreviewMesh_Rail", nullptr, (EPropertyFlags)0x0044000800082008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACameraRig_Rail, PreviewMesh_Rail), Z_Construct_UClass_USplineMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewMesh_Rail_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewMesh_Rail_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewRailMeshSegments_Inner = { "PreviewRailMeshSegments", nullptr, (EPropertyFlags)0x0004000800080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_USplineMeshComponent_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewRailMeshSegments = { "PreviewRailMeshSegments", nullptr, (EPropertyFlags)0x0044008800002008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACameraRig_Rail, PreviewRailMeshSegments), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewRailMeshSegments_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewRailMeshSegments_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewRailStaticMesh = { "PreviewRailStaticMesh", nullptr, (EPropertyFlags)0x0044000800002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACameraRig_Rail, PreviewRailStaticMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewRailStaticMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewRailStaticMesh_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewMesh_Mount = { "PreviewMesh_Mount", nullptr, (EPropertyFlags)0x0044000800082008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACameraRig_Rail, PreviewMesh_Mount), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewMesh_Mount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraRig_Rail_Statics::NewProp_PreviewMesh_Mount_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_CinematicCamera_Public_CameraRig_Rail_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACameraRig_Rail, ACameraRig_Rail::StaticClass, TEXT("ACameraRig_Rail"), &Z_Registration_Info_UClass_ACameraRig_Rail, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACameraRig_Rail), 3672822695U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_CinematicCamera_Public_CameraRig_Rail_h_1575848740(TEXT("/Script/CinematicCamera"),
