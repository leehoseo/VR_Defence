...
// End Cross Module References
	...
	static UEnum* EOrientPositionSelector_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EOrientPositionSelector.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HeadMountedDisplay_EOrientPositionSelector, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("EOrientPositionSelector"));
		}
	...
	static UEnum* EHMDTrackingOrigin_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EHMDTrackingOrigin.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HeadMountedDisplay_EHMDTrackingOrigin, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("EHMDTrackingOrigin"));
		}
	...
	static UEnum* EHMDWornState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EHMDWornState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HeadMountedDisplay_EHMDWornState, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("EHMDWornState"));
		}
	...
	static UEnum* EXRDeviceConnectionResult_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EXRDeviceConnectionResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HeadMountedDisplay_EXRDeviceConnectionResult, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("EXRDeviceConnectionResult"));
		}
	...
	static UEnum* EXRSystemFlags_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EXRSystemFlags.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HeadMountedDisplay_EXRSystemFlags, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("EXRSystemFlags"));
		}
	...
	static UEnum* ESpectatorScreenMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESpectatorScreenMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HeadMountedDisplay_ESpectatorScreenMode, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("ESpectatorScreenMode"));
		}
	...
	static UEnum* EXRTrackedDeviceType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EXRTrackedDeviceType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HeadMountedDisplay_EXRTrackedDeviceType, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("EXRTrackedDeviceType"));
		}
	...
	static UEnum* EHandKeypoint_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EHandKeypoint.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HeadMountedDisplay_EHandKeypoint, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("EHandKeypoint"));
		}
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UHandKeypointConversion_Conv_HandKeypointToInt32_Statics::NewProp_input = { "input", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HandKeypointConversion_eventConv_HandKeypointToInt32_Parms, input), Z_Construct_UEnum_HeadMountedDisplay_EHandKeypoint, METADATA_PARAMS(nullptr, 0) }; // 1373102049
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UHandKeypointConversion_Conv_HandKeypointToInt32_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HandKeypointConversion_eventConv_HandKeypointToInt32_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHandKeypointConversion_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHandKeypointConversion_Conv_HandKeypointToInt32, "Conv_HandKeypointToInt32" }, // 3597555708
	};
#if WITH_METADATA
	...
	static UEnum* EXRVisualType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EXRVisualType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HeadMountedDisplay_EXRVisualType, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("EXRVisualType"));
		}
...
class UScriptStruct* FXRHMDData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_XRHMDData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FXRHMDData, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("XRHMDData"));
	}
...
template<> HEADMOUNTEDDISPLAY_API UScriptStruct* StaticStruct<FXRHMDData>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_bValid = { "bValid", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FXRHMDData), &Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_bValid_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_bValid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_bValid_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_DeviceName = { "DeviceName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRHMDData, DeviceName), METADATA_PARAMS(Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_DeviceName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_DeviceName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_ApplicationInstanceID = { "ApplicationInstanceID", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRHMDData, ApplicationInstanceID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_ApplicationInstanceID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_ApplicationInstanceID_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_TrackingStatus_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRHMDData, Position), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_Position_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_Position_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRHMDData, Rotation), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_Rotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRHMDData_Statics::NewProp_Rotation_MetaData)) };
...
class UScriptStruct* FXRMotionControllerData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_XRMotionControllerData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FXRMotionControllerData, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("XRMotionControllerData"));
	}
...
template<> HEADMOUNTEDDISPLAY_API UScriptStruct* StaticStruct<FXRMotionControllerData>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_bValid = { "bValid", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FXRMotionControllerData), &Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_bValid_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_bValid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_bValid_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_DeviceName = { "DeviceName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, DeviceName), METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_DeviceName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_DeviceName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_ApplicationInstanceID = { "ApplicationInstanceID", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, ApplicationInstanceID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_ApplicationInstanceID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_ApplicationInstanceID_MetaData)) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_DeviceVisualType = { "DeviceVisualType", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, DeviceVisualType), Z_Construct_UEnum_HeadMountedDisplay_EXRVisualType, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_DeviceVisualType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_DeviceVisualType_MetaData)) }; // 1983615324
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandIndex_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandIndex = { "HandIndex", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, HandIndex), Z_Construct_UEnum_InputCore_EControllerHand, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandIndex_MetaData)) }; // 2206298931
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_TrackingStatus_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_TrackingStatus = { "TrackingStatus", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, TrackingStatus), Z_Construct_UEnum_HeadMountedDisplay_ETrackingStatus, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_TrackingStatus_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_TrackingStatus_MetaData)) }; // 3952808582
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_GripPosition = { "GripPosition", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, GripPosition), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_GripPosition_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_GripPosition_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_GripRotation = { "GripRotation", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, GripRotation), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_GripRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_GripRotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_AimPosition = { "AimPosition", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, AimPosition), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_AimPosition_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_AimPosition_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_AimRotation = { "AimRotation", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, AimRotation), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_AimRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_AimRotation_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyPositions_Inner = { "HandKeyPositions", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyPositions = { "HandKeyPositions", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, HandKeyPositions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyPositions_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyPositions_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyRotations_Inner = { "HandKeyRotations", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyRotations = { "HandKeyRotations", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, HandKeyRotations), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyRotations_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyRotations_MetaData)) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyRadii_Inner = { "HandKeyRadii", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyRadii = { "HandKeyRadii", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRMotionControllerData, HandKeyRadii), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyRadii_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_HandKeyRadii_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_bIsGrasped = { "bIsGrasped", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FXRMotionControllerData), &Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_bIsGrasped_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_bIsGrasped_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewProp_bIsGrasped_MetaData)) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_HeadMountedDisplay_Public_HeadMountedDisplayTypes_h_Statics::EnumInfo[] = {
		...
		{ EXRTrackedDeviceType_StaticEnum, TEXT("EXRTrackedDeviceType"), &Z_Registration_Info_UEnum_EXRTrackedDeviceType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1637355276U) },
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_HeadMountedDisplay_Public_HeadMountedDisplayTypes_h_Statics::ScriptStructInfo[] = {
		{ FXRHMDData::StaticStruct, Z_Construct_UScriptStruct_FXRHMDData_Statics::NewStructOps, TEXT("XRHMDData"), &Z_Registration_Info_UScriptStruct_XRHMDData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FXRHMDData), 3834092469U) },
		{ FXRMotionControllerData::StaticStruct, Z_Construct_UScriptStruct_FXRMotionControllerData_Statics::NewStructOps, TEXT("XRMotionControllerData"), &Z_Registration_Info_UScriptStruct_XRMotionControllerData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FXRMotionControllerData), 2274276546U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_HeadMountedDisplay_Public_HeadMountedDisplayTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHandKeypointConversion, UHandKeypointConversion::StaticClass, TEXT("UHandKeypointConversion"), &Z_Registration_Info_UClass_UHandKeypointConversion, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHandKeypointConversion), 597129347U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_HeadMountedDisplay_Public_HeadMountedDisplayTypes_h_2119697862(TEXT("/Script/HeadMountedDisplay"),
