...
class UScriptStruct* FXRDeviceId::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_XRDeviceId.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FXRDeviceId, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("XRDeviceId"));
	}
...
template<> HEADMOUNTEDDISPLAY_API UScriptStruct* StaticStruct<FXRDeviceId>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FXRDeviceId_Statics::NewProp_SystemName = { "SystemName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRDeviceId, SystemName), METADATA_PARAMS(Z_Construct_UScriptStruct_FXRDeviceId_Statics::NewProp_SystemName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRDeviceId_Statics::NewProp_SystemName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FXRDeviceId_Statics::NewProp_DeviceId = { "DeviceId", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRDeviceId, DeviceId), METADATA_PARAMS(Z_Construct_UScriptStruct_FXRDeviceId_Statics::NewProp_DeviceId_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRDeviceId_Statics::NewProp_DeviceId_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_HeadMountedDisplay_Public_IIdentifiableXRDevice_h_Statics::ScriptStructInfo[] = {
		{ FXRDeviceId::StaticStruct, Z_Construct_UScriptStruct_FXRDeviceId_Statics::NewStructOps, TEXT("XRDeviceId"), &Z_Registration_Info_UScriptStruct_XRDeviceId, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FXRDeviceId), 4276011928U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_HeadMountedDisplay_Public_IIdentifiableXRDevice_h_872876212(TEXT("/Script/HeadMountedDisplay"),
		nullptr, 0,
