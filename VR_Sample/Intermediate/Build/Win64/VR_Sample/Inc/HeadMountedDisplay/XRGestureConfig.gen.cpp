...
// End Cross Module References
	...
	static UEnum* ESpatialInputGestureAxis_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESpatialInputGestureAxis.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_HeadMountedDisplay_ESpatialInputGestureAxis, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("ESpatialInputGestureAxis"));
		}
...
class UScriptStruct* FXRGestureConfig::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_XRGestureConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FXRGestureConfig, Z_Construct_UPackage__Script_HeadMountedDisplay(), TEXT("XRGestureConfig"));
	}
...
template<> HEADMOUNTEDDISPLAY_API UScriptStruct* StaticStruct<FXRGestureConfig>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bTap = { "bTap", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FXRGestureConfig), &Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bTap_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bTap_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bTap_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bHold = { "bHold", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FXRGestureConfig), &Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bHold_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bHold_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bHold_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_AxisGesture_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_AxisGesture = { "AxisGesture", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FXRGestureConfig, AxisGesture), Z_Construct_UEnum_HeadMountedDisplay_ESpatialInputGestureAxis, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_AxisGesture_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_AxisGesture_MetaData)) }; // 2419240486
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisX = { "bNavigationAxisX", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FXRGestureConfig), &Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisX_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisX_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisX_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisY = { "bNavigationAxisY", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FXRGestureConfig), &Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisY_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisY_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisY_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisZ = { "bNavigationAxisZ", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FXRGestureConfig), &Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisZ_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisZ_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewProp_bNavigationAxisZ_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_HeadMountedDisplay_Public_XRGestureConfig_h_Statics::ScriptStructInfo[] = {
		{ FXRGestureConfig::StaticStruct, Z_Construct_UScriptStruct_FXRGestureConfig_Statics::NewStructOps, TEXT("XRGestureConfig"), &Z_Registration_Info_UScriptStruct_XRGestureConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FXRGestureConfig), 4027734740U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_HeadMountedDisplay_Public_XRGestureConfig_h_3971719734(TEXT("/Script/HeadMountedDisplay"),
		nullptr, 0,
