...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_BreakKey_Statics::NewProp_InKey = { "InKey", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventBreakKey_Parms, InKey), Z_Construct_UScriptStruct_FKey, METADATA_PARAMS(nullptr, 0) }; // 2615338182
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_BreakKey_Statics::NewProp_InteractionProfile = { "InteractionProfile", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventBreakKey_Parms, InteractionProfile), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_BreakKey_Statics::NewProp_Hand = { "Hand", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventBreakKey_Parms, Hand), Z_Construct_UEnum_InputCore_EControllerHand, METADATA_PARAMS(nullptr, 0) }; // 2206298931
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_BreakKey_Statics::NewProp_MotionSource = { "MotionSource", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventBreakKey_Parms, MotionSource), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_BreakKey_Statics::NewProp_Indentifier = { "Indentifier", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventBreakKey_Parms, Indentifier), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_BreakKey_Statics::NewProp_Component = { "Component", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventBreakKey_Parms, Component), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_CalibrateExternalTrackingToHMD_Statics::NewProp_ExternalTrackingTransform = { "ExternalTrackingTransform", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventCalibrateExternalTrackingToHMD_Parms, ExternalTrackingTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_CalibrateExternalTrackingToHMD_Statics::NewProp_ExternalTrackingTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_CalibrateExternalTrackingToHMD_Statics::NewProp_ExternalTrackingTransform_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConfigureGestures_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventConfigureGestures_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConfigureGestures_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConnectRemoteXRDevice_Statics::NewProp_IpAddress = { "IpAddress", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventConnectRemoteXRDevice_Parms, IpAddress), METADATA_PARAMS(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConnectRemoteXRDevice_Statics::NewProp_IpAddress_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConnectRemoteXRDevice_Statics::NewProp_IpAddress_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConnectRemoteXRDevice_Statics::NewProp_BitRate = { "BitRate", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventConnectRemoteXRDevice_Parms, BitRate), METADATA_PARAMS(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConnectRemoteXRDevice_Statics::NewProp_BitRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConnectRemoteXRDevice_Statics::NewProp_BitRate_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConnectRemoteXRDevice_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventConnectRemoteXRDevice_Parms, ReturnValue), Z_Construct_UEnum_HeadMountedDisplay_EXRDeviceConnectionResult, METADATA_PARAMS(nullptr, 0) }; // 2679766992
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnableHMD_Statics::NewProp_bEnable = { "bEnable", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventEnableHMD_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnableHMD_Statics::NewProp_bEnable_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnableHMD_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventEnableHMD_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnableHMD_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnableLowPersistenceMode_Statics::NewProp_bEnable = { "bEnable", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventEnableLowPersistenceMode_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnableLowPersistenceMode_Statics::NewProp_bEnable_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnumerateTrackedDevices_Statics::NewProp_DeviceType = { "DeviceType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventEnumerateTrackedDevices_Parms, DeviceType), Z_Construct_UEnum_HeadMountedDisplay_EXRTrackedDeviceType, METADATA_PARAMS(nullptr, 0) }; // 1637355276
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnumerateTrackedDevices_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FXRDeviceId, METADATA_PARAMS(nullptr, 0) }; // 4276011928
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnumerateTrackedDevices_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventEnumerateTrackedDevices_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 4276011928
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_WorldContext = { "WorldContext", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms, WorldContext), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_MotionSource = { "MotionSource", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms, MotionSource), METADATA_PARAMS(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_MotionSource_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_MotionSource_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms, Time), Z_Construct_UScriptStruct_FTimespan, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_bTimeWasUsed = { "bTimeWasUsed", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_bTimeWasUsed_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_Orientation = { "Orientation", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms, Orientation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms, Position), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_bProvidedLinearVelocity = { "bProvidedLinearVelocity", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_bProvidedLinearVelocity_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_LinearVelocity = { "LinearVelocity", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms, LinearVelocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_bProvidedAngularVelocity = { "bProvidedAngularVelocity", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_bProvidedAngularVelocity_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_AngularVelocityRadPerSec = { "AngularVelocityRadPerSec", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms, AngularVelocityRadPerSec), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_bProvidedLinearAcceleration = { "bProvidedLinearAcceleration", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_bProvidedLinearAcceleration_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_LinearAcceleration = { "LinearAcceleration", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms, LinearAcceleration), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetControllerTransformForTime_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDevicePose_Statics::NewProp_XRDeviceId = { "XRDeviceId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetDevicePose_Parms, XRDeviceId), Z_Construct_UScriptStruct_FXRDeviceId, METADATA_PARAMS(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDevicePose_Statics::NewProp_XRDeviceId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDevicePose_Statics::NewProp_XRDeviceId_MetaData)) }; // 4276011928
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDevicePose_Statics::NewProp_bIsTracked = { "bIsTracked", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetDevicePose_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDevicePose_Statics::NewProp_bIsTracked_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDevicePose_Statics::NewProp_Orientation = { "Orientation", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetDevicePose_Parms, Orientation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDevicePose_Statics::NewProp_bHasPositionalTracking = { "bHasPositionalTracking", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetDevicePose_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDevicePose_Statics::NewProp_bHasPositionalTracking_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDevicePose_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetDevicePose_Parms, Position), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDeviceWorldPose_Statics::NewProp_bIsTracked = { "bIsTracked", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetDeviceWorldPose_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDeviceWorldPose_Statics::NewProp_bIsTracked_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDeviceWorldPose_Statics::NewProp_Orientation = { "Orientation", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetDeviceWorldPose_Parms, Orientation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDeviceWorldPose_Statics::NewProp_bHasPositionalTracking = { "bHasPositionalTracking", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetDeviceWorldPose_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDeviceWorldPose_Statics::NewProp_bHasPositionalTracking_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDeviceWorldPose_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetDeviceWorldPose_Parms, Position), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetHMDData_Statics::NewProp_WorldContext = { "WorldContext", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetHMDData_Parms, WorldContext), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetHMDData_Statics::NewProp_HMDData = { "HMDData", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetHMDData_Parms, HMDData), Z_Construct_UScriptStruct_FXRHMDData, METADATA_PARAMS(nullptr, 0) }; // 3834092469
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetHMDDeviceName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetHMDDeviceName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetHMDWornState_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetHMDWornState_Parms, ReturnValue), Z_Construct_UEnum_HeadMountedDisplay_EHMDWornState, METADATA_PARAMS(nullptr, 0) }; // 2177842658
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetMotionControllerData_Statics::NewProp_WorldContext = { "WorldContext", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetMotionControllerData_Parms, WorldContext), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetMotionControllerData_Statics::NewProp_Hand = { "Hand", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetMotionControllerData_Parms, Hand), Z_Construct_UEnum_InputCore_EControllerHand, METADATA_PARAMS(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetMotionControllerData_Statics::NewProp_Hand_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetMotionControllerData_Statics::NewProp_Hand_MetaData)) }; // 2206298931
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetMotionControllerData_Statics::NewProp_MotionControllerData = { "MotionControllerData", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetMotionControllerData_Parms, MotionControllerData), Z_Construct_UScriptStruct_FXRMotionControllerData, METADATA_PARAMS(nullptr, 0) }; // 2274276546
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetNumOfTrackingSensors_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetNumOfTrackingSensors_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetOrientationAndPosition_Statics::NewProp_DeviceRotation = { "DeviceRotation", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetOrientationAndPosition_Parms, DeviceRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetOrientationAndPosition_Statics::NewProp_DevicePosition = { "DevicePosition", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetOrientationAndPosition_Parms, DevicePosition), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPixelDensity_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetPixelDensity_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPlayAreaBounds_Statics::NewProp_Origin = { "Origin", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetPlayAreaBounds_Parms, Origin), Z_Construct_UEnum_HeadMountedDisplay_EHMDTrackingOrigin, METADATA_PARAMS(nullptr, 0) }; // 3606177280
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPlayAreaBounds_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetPlayAreaBounds_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPositionalTrackingCameraParameters_Statics::NewProp_CameraOrigin = { "CameraOrigin", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetPositionalTrackingCameraParameters_Parms, CameraOrigin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPositionalTrackingCameraParameters_Statics::NewProp_CameraRotation = { "CameraRotation", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetPositionalTrackingCameraParameters_Parms, CameraRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPositionalTrackingCameraParameters_Statics::NewProp_HFOV = { "HFOV", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetPositionalTrackingCameraParameters_Parms, HFOV), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPositionalTrackingCameraParameters_Statics::NewProp_VFOV = { "VFOV", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetPositionalTrackingCameraParameters_Parms, VFOV), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPositionalTrackingCameraParameters_Statics::NewProp_CameraDistance = { "CameraDistance", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetPositionalTrackingCameraParameters_Parms, CameraDistance), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPositionalTrackingCameraParameters_Statics::NewProp_NearPlane = { "NearPlane", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetPositionalTrackingCameraParameters_Parms, NearPlane), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPositionalTrackingCameraParameters_Statics::NewProp_FarPlane = { "FarPlane", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetPositionalTrackingCameraParameters_Parms, FarPlane), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetScreenPercentage_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::Function_MetaDataParams[] = {
		{ "Category", "Input|HeadMountedDisplay" },
		{ "DeprecatedFunction", "" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UHeadMountedDisplayFunctionLibrary, nullptr, "GetScreenPercentage", nullptr, nullptr, sizeof(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::HeadMountedDisplayFunctionLibrary_eventGetScreenPercentage_Parms), Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingOrigin_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingOrigin_Parms, ReturnValue), Z_Construct_UEnum_HeadMountedDisplay_EHMDTrackingOrigin, METADATA_PARAMS(nullptr, 0) }; // 3606177280
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_Origin = { "Origin", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms, Origin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_LeftFOV = { "LeftFOV", nullptr, (EPropertyFlags)0x0010040000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms, LeftFOV), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_RightFOV = { "RightFOV", nullptr, (EPropertyFlags)0x0010040000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms, RightFOV), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_TopFOV = { "TopFOV", nullptr, (EPropertyFlags)0x0010040000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms, TopFOV), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_BottomFOV = { "BottomFOV", nullptr, (EPropertyFlags)0x0010040000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms, BottomFOV), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_Distance = { "Distance", nullptr, (EPropertyFlags)0x0010040000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms, Distance), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_NearPlane = { "NearPlane", nullptr, (EPropertyFlags)0x0010040000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms, NearPlane), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_FarPlane = { "FarPlane", nullptr, (EPropertyFlags)0x0010040000000180, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms, FarPlane), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_IsActive = { "IsActive", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_IsActive_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters_Statics::NewProp_Index = { "Index", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingSensorParameters_Parms, Index), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingToWorldTransform_Statics::NewProp_WorldContext = { "WorldContext", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingToWorldTransform_Parms, WorldContext), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingToWorldTransform_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetTrackingToWorldTransform_Parms, ReturnValue), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetVersionString_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetVersionString_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetVRFocusState_Statics::NewProp_bUseFocus = { "bUseFocus", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetVRFocusState_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetVRFocusState_Statics::NewProp_bUseFocus_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetVRFocusState_Statics::NewProp_bHasFocus = { "bHasFocus", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventGetVRFocusState_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetVRFocusState_Statics::NewProp_bHasFocus_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetWorldToMetersScale_Statics::NewProp_WorldContext = { "WorldContext", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetWorldToMetersScale_Parms, WorldContext), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetWorldToMetersScale_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetWorldToMetersScale_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetXRSystemFlags_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventGetXRSystemFlags_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_HasValidTrackingPosition_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventHasValidTrackingPosition_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_HasValidTrackingPosition_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsDeviceTracking_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventIsDeviceTracking_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsDeviceTracking_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsHeadMountedDisplayConnected_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventIsHeadMountedDisplayConnected_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsHeadMountedDisplayConnected_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsHeadMountedDisplayEnabled_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventIsHeadMountedDisplayEnabled_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsHeadMountedDisplayEnabled_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsInLowPersistenceMode_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventIsInLowPersistenceMode_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsInLowPersistenceMode_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsSpectatorScreenModeControllable_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventIsSpectatorScreenModeControllable_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsSpectatorScreenModeControllable_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ResetOrientationAndPosition_Statics::NewProp_Yaw = { "Yaw", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventResetOrientationAndPosition_Parms, Yaw), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ResetOrientationAndPosition_Statics::NewProp_Options = { "Options", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventResetOrientationAndPosition_Parms, Options), Z_Construct_UEnum_HeadMountedDisplay_EOrientPositionSelector, METADATA_PARAMS(nullptr, 0) }; // 3931628698
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetClippingPlanes_Statics::NewProp_Near = { "Near", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetClippingPlanes_Parms, Near), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetClippingPlanes_Statics::NewProp_Far = { "Far", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetClippingPlanes_Parms, Far), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenMode_Statics::NewProp_Mode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenMode_Statics::NewProp_Mode = { "Mode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetSpectatorScreenMode_Parms, Mode), Z_Construct_UEnum_HeadMountedDisplay_ESpectatorScreenMode, METADATA_PARAMS(nullptr, 0) }; // 387750963
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout_Statics::NewProp_EyeRectMin = { "EyeRectMin", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetSpectatorScreenModeTexturePlusEyeLayout_Parms, EyeRectMin), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout_Statics::NewProp_EyeRectMax = { "EyeRectMax", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetSpectatorScreenModeTexturePlusEyeLayout_Parms, EyeRectMax), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout_Statics::NewProp_TextureRectMin = { "TextureRectMin", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetSpectatorScreenModeTexturePlusEyeLayout_Parms, TextureRectMin), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout_Statics::NewProp_TextureRectMax = { "TextureRectMax", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetSpectatorScreenModeTexturePlusEyeLayout_Parms, TextureRectMax), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout_Statics::NewProp_bDrawEyeFirst = { "bDrawEyeFirst", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventSetSpectatorScreenModeTexturePlusEyeLayout_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout_Statics::NewProp_bDrawEyeFirst_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout_Statics::NewProp_bClearBlack = { "bClearBlack", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventSetSpectatorScreenModeTexturePlusEyeLayout_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout_Statics::NewProp_bClearBlack_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout_Statics::NewProp_bUseAlpha = { "bUseAlpha", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(HeadMountedDisplayFunctionLibrary_eventSetSpectatorScreenModeTexturePlusEyeLayout_Parms), &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout_Statics::NewProp_bUseAlpha_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenTexture_Statics::NewProp_InTexture = { "InTexture", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetSpectatorScreenTexture_Parms, InTexture), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetTrackingOrigin_Statics::NewProp_Origin = { "Origin", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetTrackingOrigin_Parms, Origin), Z_Construct_UEnum_HeadMountedDisplay_EHMDTrackingOrigin, METADATA_PARAMS(nullptr, 0) }; // 3606177280
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetWorldToMetersScale_Statics::NewProp_WorldContext = { "WorldContext", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetWorldToMetersScale_Parms, WorldContext), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetWorldToMetersScale_Statics::NewProp_NewScale = { "NewScale", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventSetWorldToMetersScale_Parms, NewScale), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_UpdateExternalTrackingHMDPosition_Statics::NewProp_ExternalTrackingTransform = { "ExternalTrackingTransform", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(HeadMountedDisplayFunctionLibrary_eventUpdateExternalTrackingHMDPosition_Parms, ExternalTrackingTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_UpdateExternalTrackingHMDPosition_Statics::NewProp_ExternalTrackingTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_UpdateExternalTrackingHMDPosition_Statics::NewProp_ExternalTrackingTransform_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UHeadMountedDisplayFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_BreakKey, "BreakKey" }, // 856521192
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_CalibrateExternalTrackingToHMD, "CalibrateExternalTrackingToHMD" }, // 915725679
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ClearXRTimedInputActionDelegate, "ClearXRTimedInputActionDelegate" }, // 3481316686
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConfigureGestures, "ConfigureGestures" }, // 2250218226
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ConnectRemoteXRDevice, "ConnectRemoteXRDevice" }, // 3959147246
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_DisconnectRemoteXRDevice, "DisconnectRemoteXRDevice" }, // 158157394
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnableHMD, "EnableHMD" }, // 571089066
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnableLowPersistenceMode, "EnableLowPersistenceMode" }, // 377760519
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_EnumerateTrackedDevices, "EnumerateTrackedDevices" }, // 2904244997
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetControllerTransformForTime, "GetControllerTransformForTime" }, // 3560879298
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDevicePose, "GetDevicePose" }, // 203684609
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetDeviceWorldPose, "GetDeviceWorldPose" }, // 3949872976
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetHMDData, "GetHMDData" }, // 465335985
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetHMDDeviceName, "GetHMDDeviceName" }, // 3271818090
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetHMDWornState, "GetHMDWornState" }, // 2373123897
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetMotionControllerData, "GetMotionControllerData" }, // 3224791816
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetNumOfTrackingSensors, "GetNumOfTrackingSensors" }, // 3840172321
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetOrientationAndPosition, "GetOrientationAndPosition" }, // 2340431438
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPixelDensity, "GetPixelDensity" }, // 1172800648
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPlayAreaBounds, "GetPlayAreaBounds" }, // 4140208478
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetPositionalTrackingCameraParameters, "GetPositionalTrackingCameraParameters" }, // 4148424644
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetScreenPercentage, "GetScreenPercentage" }, // 693821479
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingOrigin, "GetTrackingOrigin" }, // 2834458104
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingSensorParameters, "GetTrackingSensorParameters" }, // 948483005
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetTrackingToWorldTransform, "GetTrackingToWorldTransform" }, // 1101899245
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetVersionString, "GetVersionString" }, // 1257232769
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetVRFocusState, "GetVRFocusState" }, // 633659175
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetWorldToMetersScale, "GetWorldToMetersScale" }, // 2792852526
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_GetXRSystemFlags, "GetXRSystemFlags" }, // 1654006561
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_HasValidTrackingPosition, "HasValidTrackingPosition" }, // 3372393916
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsDeviceTracking, "IsDeviceTracking" }, // 3931534990
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsHeadMountedDisplayConnected, "IsHeadMountedDisplayConnected" }, // 3206354347
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsHeadMountedDisplayEnabled, "IsHeadMountedDisplayEnabled" }, // 1652916687
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsInLowPersistenceMode, "IsInLowPersistenceMode" }, // 316329569
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_IsSpectatorScreenModeControllable, "IsSpectatorScreenModeControllable" }, // 53135988
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_ResetOrientationAndPosition, "ResetOrientationAndPosition" }, // 1300971163
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetClippingPlanes, "SetClippingPlanes" }, // 1677653342
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenMode, "SetSpectatorScreenMode" }, // 2073478433
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenModeTexturePlusEyeLayout, "SetSpectatorScreenModeTexturePlusEyeLayout" }, // 906440945
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetSpectatorScreenTexture, "SetSpectatorScreenTexture" }, // 3895208671
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetTrackingOrigin, "SetTrackingOrigin" }, // 1031338227
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetWorldToMetersScale, "SetWorldToMetersScale" }, // 3040258524
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetXRDisconnectDelegate, "SetXRDisconnectDelegate" }, // 3424724019
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_SetXRTimedInputActionDelegate, "SetXRTimedInputActionDelegate" }, // 796946502
		{ &Z_Construct_UFunction_UHeadMountedDisplayFunctionLibrary_UpdateExternalTrackingHMDPosition, "UpdateExternalTrackingHMDPosition" }, // 3960220299
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_HeadMountedDisplay_Public_HeadMountedDisplayFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHeadMountedDisplayFunctionLibrary, UHeadMountedDisplayFunctionLibrary::StaticClass, TEXT("UHeadMountedDisplayFunctionLibrary"), &Z_Registration_Info_UClass_UHeadMountedDisplayFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHeadMountedDisplayFunctionLibrary), 2804042358U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_HeadMountedDisplay_Public_HeadMountedDisplayFunctionLibrary_h_3417443366(TEXT("/Script/HeadMountedDisplay"),
