...
class UScriptStruct* FEyeTrackerGazeData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EyeTrackerGazeData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEyeTrackerGazeData, Z_Construct_UPackage__Script_EyeTracker(), TEXT("EyeTrackerGazeData"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEyeTrackerGazeData_Statics::NewProp_ConfidenceValue = { "ConfidenceValue", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEyeTrackerGazeData, ConfidenceValue), METADATA_PARAMS(Z_Construct_UScriptStruct_FEyeTrackerGazeData_Statics::NewProp_ConfidenceValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEyeTrackerGazeData_Statics::NewProp_ConfidenceValue_MetaData)) };
...
class UScriptStruct* FEyeTrackerStereoGazeData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EyeTrackerStereoGazeData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData, Z_Construct_UPackage__Script_EyeTracker(), TEXT("EyeTrackerStereoGazeData"));
	}
...
template<> EYETRACKER_API UScriptStruct* StaticStruct<FEyeTrackerStereoGazeData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_LeftEyeOrigin = { "LeftEyeOrigin", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEyeTrackerStereoGazeData, LeftEyeOrigin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_LeftEyeOrigin_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_LeftEyeOrigin_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_LeftEyeDirection = { "LeftEyeDirection", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEyeTrackerStereoGazeData, LeftEyeDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_LeftEyeDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_LeftEyeDirection_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_RightEyeOrigin = { "RightEyeOrigin", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEyeTrackerStereoGazeData, RightEyeOrigin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_RightEyeOrigin_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_RightEyeOrigin_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_RightEyeDirection = { "RightEyeDirection", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEyeTrackerStereoGazeData, RightEyeDirection), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_RightEyeDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_RightEyeDirection_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_FixationPoint = { "FixationPoint", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEyeTrackerStereoGazeData, FixationPoint), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_FixationPoint_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_FixationPoint_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_ConfidenceValue = { "ConfidenceValue", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEyeTrackerStereoGazeData, ConfidenceValue), METADATA_PARAMS(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_ConfidenceValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewProp_ConfidenceValue_MetaData)) };
	...
	static UEnum* EEyeTrackerStatus_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EEyeTrackerStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_EyeTracker_EEyeTrackerStatus, Z_Construct_UPackage__Script_EyeTracker(), TEXT("EEyeTrackerStatus"));
		}
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_EyeTracker_Public_EyeTrackerTypes_h_Statics::ScriptStructInfo[] = {
		{ FEyeTrackerGazeData::StaticStruct, Z_Construct_UScriptStruct_FEyeTrackerGazeData_Statics::NewStructOps, TEXT("EyeTrackerGazeData"), &Z_Registration_Info_UScriptStruct_EyeTrackerGazeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEyeTrackerGazeData), 373422493U) },
		{ FEyeTrackerStereoGazeData::StaticStruct, Z_Construct_UScriptStruct_FEyeTrackerStereoGazeData_Statics::NewStructOps, TEXT("EyeTrackerStereoGazeData"), &Z_Registration_Info_UScriptStruct_EyeTrackerStereoGazeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEyeTrackerStereoGazeData), 2226409933U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_EyeTracker_Public_EyeTrackerTypes_h_1410139000(TEXT("/Script/EyeTracker"),
		nullptr, 0,
