...
class UScriptStruct* FTransformNoScale::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TransformNoScale.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTransformNoScale, Z_Construct_UPackage__Script_AnimationCore(), TEXT("TransformNoScale"));
	}
...
template<> ANIMATIONCORE_API UScriptStruct* StaticStruct<FTransformNoScale>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTransformNoScale_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTransformNoScale, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FTransformNoScale_Statics::NewProp_Location_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTransformNoScale_Statics::NewProp_Location_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTransformNoScale_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTransformNoScale, Rotation), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(Z_Construct_UScriptStruct_FTransformNoScale_Statics::NewProp_Rotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTransformNoScale_Statics::NewProp_Rotation_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimationCore_Public_TransformNoScale_h_Statics::ScriptStructInfo[] = {
		{ FTransformNoScale::StaticStruct, Z_Construct_UScriptStruct_FTransformNoScale_Statics::NewStructOps, TEXT("TransformNoScale"), &Z_Registration_Info_UScriptStruct_TransformNoScale, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTransformNoScale), 6740245U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimationCore_Public_TransformNoScale_h_114453900(TEXT("/Script/AnimationCore"),
		nullptr, 0,
