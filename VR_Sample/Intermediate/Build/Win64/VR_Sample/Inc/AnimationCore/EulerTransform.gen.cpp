...
// End Cross Module References
	...
	static UEnum* EEulerRotationOrder_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EEulerRotationOrder.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AnimationCore_EEulerRotationOrder, Z_Construct_UPackage__Script_AnimationCore(), TEXT("EEulerRotationOrder"));
		}
...
class UScriptStruct* FEulerTransform::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EulerTransform.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEulerTransform, Z_Construct_UPackage__Script_AnimationCore(), TEXT("EulerTransform"));
	}
...
template<> ANIMATIONCORE_API UScriptStruct* StaticStruct<FEulerTransform>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEulerTransform_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEulerTransform, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FEulerTransform_Statics::NewProp_Location_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEulerTransform_Statics::NewProp_Location_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEulerTransform_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEulerTransform, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UScriptStruct_FEulerTransform_Statics::NewProp_Rotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEulerTransform_Statics::NewProp_Rotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FEulerTransform_Statics::NewProp_Scale = { "Scale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEulerTransform, Scale), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FEulerTransform_Statics::NewProp_Scale_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEulerTransform_Statics::NewProp_Scale_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimationCore_Public_EulerTransform_h_Statics::ScriptStructInfo[] = {
		{ FEulerTransform::StaticStruct, Z_Construct_UScriptStruct_FEulerTransform_Statics::NewStructOps, TEXT("EulerTransform"), &Z_Registration_Info_UScriptStruct_EulerTransform, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEulerTransform), 245675444U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimationCore_Public_EulerTransform_h_2919404840(TEXT("/Script/AnimationCore"),
		nullptr, 0,
