...
#include "AnimationCore/Public/AnimationDataSource.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UAnimationDataSourceRegistry_Statics::NewProp_DataSources_ValueProp = { "DataSources", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UAnimationDataSourceRegistry_Statics::NewProp_DataSources_Key_KeyProp = { "DataSources_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimationCore_Public_AnimationDataSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimationDataSourceRegistry, UAnimationDataSourceRegistry::StaticClass, TEXT("UAnimationDataSourceRegistry"), &Z_Registration_Info_UClass_UAnimationDataSourceRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimationDataSourceRegistry), 2484062687U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimationCore_Public_AnimationDataSource_h_2725647981(TEXT("/Script/AnimationCore"),
