...
class UScriptStruct* FNodeChain::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NodeChain.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNodeChain, Z_Construct_UPackage__Script_AnimationCore(), TEXT("NodeChain"));
	}
...
template<> ANIMATIONCORE_API UScriptStruct* StaticStruct<FNodeChain>()
{
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes_Inner = { "Nodes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes_MetaData[] = {
		{ "ModuleRelativePath", "Public/NodeChain.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes = { "Nodes", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNodeChain, Nodes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodeChain_Statics::NewProp_Nodes_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimationCore_Public_NodeChain_h_Statics::ScriptStructInfo[] = {
		{ FNodeChain::StaticStruct, Z_Construct_UScriptStruct_FNodeChain_Statics::NewStructOps, TEXT("NodeChain"), &Z_Registration_Info_UScriptStruct_NodeChain, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNodeChain), 947986589U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimationCore_Public_NodeChain_h_569226553(TEXT("/Script/AnimationCore"),
		nullptr, 0,
