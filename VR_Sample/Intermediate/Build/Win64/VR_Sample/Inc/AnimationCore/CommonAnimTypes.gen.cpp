...
class UScriptStruct* FAxis::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Axis.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAxis, Z_Construct_UPackage__Script_AnimationCore(), TEXT("Axis"));
	}
...
template<> ANIMATIONCORE_API UScriptStruct* StaticStruct<FAxis>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimationCore_Public_CommonAnimTypes_h_Statics::ScriptStructInfo[] = {
		{ FAxis::StaticStruct, Z_Construct_UScriptStruct_FAxis_Statics::NewStructOps, TEXT("Axis"), &Z_Registration_Info_UScriptStruct_Axis, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAxis), 322279027U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AnimationCore_Public_CommonAnimTypes_h_619928175(TEXT("/Script/AnimationCore"),
		nullptr, 0,
