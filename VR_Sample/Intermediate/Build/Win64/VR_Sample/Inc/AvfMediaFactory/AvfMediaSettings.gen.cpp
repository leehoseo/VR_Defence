...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAvfMediaSettings_Statics::NewProp_NativeAudioOut = { "NativeAudioOut", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAvfMediaSettings), &Z_Construct_UClass_UAvfMediaSettings_Statics::NewProp_NativeAudioOut_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAvfMediaSettings_Statics::NewProp_NativeAudioOut_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAvfMediaSettings_Statics::NewProp_NativeAudioOut_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AvfMedia_Source_AvfMediaFactory_Public_AvfMediaSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAvfMediaSettings, UAvfMediaSettings::StaticClass, TEXT("UAvfMediaSettings"), &Z_Registration_Info_UClass_UAvfMediaSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAvfMediaSettings), 3271115830U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_AvfMedia_Source_AvfMediaFactory_Public_AvfMediaSettings_h_3210358266(TEXT("/Script/AvfMediaFactory"),
