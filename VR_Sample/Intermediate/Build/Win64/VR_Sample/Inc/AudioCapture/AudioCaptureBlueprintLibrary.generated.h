...
static inline void FOnAudioInputDevicesObtained_DelegateWrapper(const FScriptDelegate& OnAudioInputDevicesObtained, TArray<FAudioInputDeviceInfo> const& AvailableDevices) \
{ \
...
#define FID_Engine_Plugins_Runtime_AudioCapture_Source_AudioCapture_Public_AudioCaptureBlueprintLibrary_h_67_ENHANCED_CONSTRUCTORS \
	/** Standard constructor, called after all reflected properties have been initialized */ \
	NO_API UAudioCaptureBlueprintLibrary(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get()) : Super(ObjectInitializer) { }; \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UAudioCaptureBlueprintLibrary(UAudioCaptureBlueprintLibrary&&); \
	NO_API UAudioCaptureBlueprintLibrary(const UAudioCaptureBlueprintLibrary&); \
