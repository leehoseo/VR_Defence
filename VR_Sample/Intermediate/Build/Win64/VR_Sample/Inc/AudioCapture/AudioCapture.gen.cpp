...
class UScriptStruct* FAudioCaptureDeviceInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AudioCaptureDeviceInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAudioCaptureDeviceInfo, Z_Construct_UPackage__Script_AudioCapture(), TEXT("AudioCaptureDeviceInfo"));
	}
...
template<> AUDIOCAPTURE_API UScriptStruct* StaticStruct<FAudioCaptureDeviceInfo>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAudioCapture_GetAudioCaptureDeviceInfo_Statics::NewProp_OutInfo = { "OutInfo", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioCapture_eventGetAudioCaptureDeviceInfo_Parms, OutInfo), Z_Construct_UScriptStruct_FAudioCaptureDeviceInfo, METADATA_PARAMS(nullptr, 0) }; // 1495482701
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAudioCapture_GetAudioCaptureDeviceInfo_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AudioCapture_eventGetAudioCaptureDeviceInfo_Parms), &Z_Construct_UFunction_UAudioCapture_GetAudioCaptureDeviceInfo_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAudioCapture_IsCapturingAudio_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AudioCapture_eventIsCapturingAudio_Parms), &Z_Construct_UFunction_UAudioCapture_IsCapturingAudio_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAudioCapture_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAudioCapture_GetAudioCaptureDeviceInfo, "GetAudioCaptureDeviceInfo" }, // 2639539542
		{ &Z_Construct_UFunction_UAudioCapture_IsCapturingAudio, "IsCapturingAudio" }, // 2712139642
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAudioCaptureFunctionLibrary_CreateAudioCapture_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioCaptureFunctionLibrary_eventCreateAudioCapture_Parms, ReturnValue), Z_Construct_UClass_UAudioCapture_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAudioCaptureFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAudioCaptureFunctionLibrary_CreateAudioCapture, "CreateAudioCapture" }, // 3144217187
	};
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioCapture_Source_AudioCapture_Public_AudioCapture_h_Statics::ScriptStructInfo[] = {
		{ FAudioCaptureDeviceInfo::StaticStruct, Z_Construct_UScriptStruct_FAudioCaptureDeviceInfo_Statics::NewStructOps, TEXT("AudioCaptureDeviceInfo"), &Z_Registration_Info_UScriptStruct_AudioCaptureDeviceInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAudioCaptureDeviceInfo), 1495482701U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioCapture_Source_AudioCapture_Public_AudioCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioCapture, UAudioCapture::StaticClass, TEXT("UAudioCapture"), &Z_Registration_Info_UClass_UAudioCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioCapture), 1096684661U) },
		{ Z_Construct_UClass_UAudioCaptureFunctionLibrary, UAudioCaptureFunctionLibrary::StaticClass, TEXT("UAudioCaptureFunctionLibrary"), &Z_Registration_Info_UClass_UAudioCaptureFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioCaptureFunctionLibrary), 34973408U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_AudioCapture_Source_AudioCapture_Public_AudioCapture_h_1407024592(TEXT("/Script/AudioCapture"),
