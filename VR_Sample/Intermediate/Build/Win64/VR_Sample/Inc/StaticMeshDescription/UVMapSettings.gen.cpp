...
class UScriptStruct* FUVMapSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_UVMapSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUVMapSettings, Z_Construct_UPackage__Script_StaticMeshDescription(), TEXT("UVMapSettings"));
	}
...
template<> STATICMESHDESCRIPTION_API UScriptStruct* StaticStruct<FUVMapSettings>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FUVMapSettings_Statics::NewProp_Size = { "Size", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FUVMapSettings, Size), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FUVMapSettings_Statics::NewProp_Size_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUVMapSettings_Statics::NewProp_Size_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FUVMapSettings_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FUVMapSettings, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UScriptStruct_FUVMapSettings_Statics::NewProp_Rotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUVMapSettings_Statics::NewProp_Rotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FUVMapSettings_Statics::NewProp_Scale = { "Scale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FUVMapSettings, Scale), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FUVMapSettings_Statics::NewProp_Scale_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUVMapSettings_Statics::NewProp_Scale_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_StaticMeshDescription_Public_UVMapSettings_h_Statics::ScriptStructInfo[] = {
		{ FUVMapSettings::StaticStruct, Z_Construct_UScriptStruct_FUVMapSettings_Statics::NewStructOps, TEXT("UVMapSettings"), &Z_Registration_Info_UScriptStruct_UVMapSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUVMapSettings), 2650489548U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_StaticMeshDescription_Public_UVMapSettings_h_2662160526(TEXT("/Script/StaticMeshDescription"),
		nullptr, 0,
