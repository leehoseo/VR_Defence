...
class UScriptStruct* FSolverInput::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SolverInput.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSolverInput, Z_Construct_UPackage__Script_FullBodyIK(), TEXT("SolverInput"));
	}
...
template<> FULLBODYIK_API UScriptStruct* StaticStruct<FSolverInput>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSolverInput_Statics::NewProp_AngularMotionStrength = { "AngularMotionStrength", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSolverInput, AngularMotionStrength), METADATA_PARAMS(Z_Construct_UScriptStruct_FSolverInput_Statics::NewProp_AngularMotionStrength_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSolverInput_Statics::NewProp_AngularMotionStrength_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSolverInput_Statics::NewProp_Precision = { "Precision", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSolverInput, Precision), METADATA_PARAMS(Z_Construct_UScriptStruct_FSolverInput_Statics::NewProp_Precision_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSolverInput_Statics::NewProp_Precision_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSolverInput_Statics::NewProp_MaxIterations = { "MaxIterations", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSolverInput, MaxIterations), METADATA_PARAMS(Z_Construct_UScriptStruct_FSolverInput_Statics::NewProp_MaxIterations_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSolverInput_Statics::NewProp_MaxIterations_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_FullBodyIK_Source_FullBodyIK_Public_FBIKShared_h_Statics::ScriptStructInfo[] = {
		{ FSolverInput::StaticStruct, Z_Construct_UScriptStruct_FSolverInput_Statics::NewStructOps, TEXT("SolverInput"), &Z_Registration_Info_UScriptStruct_SolverInput, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSolverInput), 3838228975U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_FullBodyIK_Source_FullBodyIK_Public_FBIKShared_h_2183071819(TEXT("/Script/FullBodyIK"),
		nullptr, 0,
