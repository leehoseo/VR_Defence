...
class UScriptStruct* FFBIKDebugOption::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FBIKDebugOption.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFBIKDebugOption, Z_Construct_UPackage__Script_FullBodyIK(), TEXT("FBIKDebugOption"));
	}
...
template<> FULLBODYIK_API UScriptStruct* StaticStruct<FFBIKDebugOption>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FFBIKDebugOption_Statics::NewProp_DrawSize = { "DrawSize", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFBIKDebugOption, DrawSize), METADATA_PARAMS(Z_Construct_UScriptStruct_FFBIKDebugOption_Statics::NewProp_DrawSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFBIKDebugOption_Statics::NewProp_DrawSize_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_FullBodyIK_Source_FullBodyIK_Public_FBIKDebugOption_h_Statics::ScriptStructInfo[] = {
		{ FFBIKDebugOption::StaticStruct, Z_Construct_UScriptStruct_FFBIKDebugOption_Statics::NewStructOps, TEXT("FBIKDebugOption"), &Z_Registration_Info_UScriptStruct_FBIKDebugOption, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFBIKDebugOption), 3108143852U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Experimental_FullBodyIK_Source_FullBodyIK_Public_FBIKDebugOption_h_980849647(TEXT("/Script/FullBodyIK"),
		nullptr, 0,
