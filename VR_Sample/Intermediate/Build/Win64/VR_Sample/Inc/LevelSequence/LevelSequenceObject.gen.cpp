...
class UScriptStruct* FLevelSequenceObject::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LevelSequenceObject.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLevelSequenceObject, Z_Construct_UPackage__Script_LevelSequence(), TEXT("LevelSequenceObject"));
	}
...
template<> LEVELSEQUENCE_API UScriptStruct* StaticStruct<FLevelSequenceObject>()
{
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FLevelSequenceObject_Statics::NewProp_CachedComponent = { "CachedComponent", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLevelSequenceObject, CachedComponent), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FLevelSequenceObject_Statics::NewProp_CachedComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLevelSequenceObject_Statics::NewProp_CachedComponent_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_LevelSequence_Public_LevelSequenceObject_h_Statics::ScriptStructInfo[] = {
		{ FLevelSequenceObject::StaticStruct, Z_Construct_UScriptStruct_FLevelSequenceObject_Statics::NewStructOps, TEXT("LevelSequenceObject"), &Z_Registration_Info_UScriptStruct_LevelSequenceObject, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLevelSequenceObject), 2617152327U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_LevelSequence_Public_LevelSequenceObject_h_2369484859(TEXT("/Script/LevelSequence"),
		nullptr, 0,
