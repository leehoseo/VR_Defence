...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_bDefaultLockEngineToDisplayRate = { "bDefaultLockEngineToDisplayRate", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ULevelSequenceProjectSettings), &Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_bDefaultLockEngineToDisplayRate_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_bDefaultLockEngineToDisplayRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_bDefaultLockEngineToDisplayRate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_DefaultDisplayRate = { "DefaultDisplayRate", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelSequenceProjectSettings, DefaultDisplayRate), METADATA_PARAMS(Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_DefaultDisplayRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_DefaultDisplayRate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_DefaultTickResolution = { "DefaultTickResolution", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelSequenceProjectSettings, DefaultTickResolution), METADATA_PARAMS(Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_DefaultTickResolution_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_DefaultTickResolution_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_DefaultClockSource_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_DefaultClockSource = { "DefaultClockSource", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelSequenceProjectSettings, DefaultClockSource), Z_Construct_UEnum_MovieScene_EUpdateClockSource, METADATA_PARAMS(Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_DefaultClockSource_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelSequenceProjectSettings_Statics::NewProp_DefaultClockSource_MetaData)) }; // 3237436252
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_LevelSequence_Private_LevelSequenceProjectSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULevelSequenceProjectSettings, ULevelSequenceProjectSettings::StaticClass, TEXT("ULevelSequenceProjectSettings"), &Z_Registration_Info_UClass_ULevelSequenceProjectSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevelSequenceProjectSettings), 2575745958U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_LevelSequence_Private_LevelSequenceProjectSettings_h_509063554(TEXT("/Script/LevelSequence"),
