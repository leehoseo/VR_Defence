...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDefaultLevelSequenceInstanceData_Statics::NewProp_TransformOriginActor = { "TransformOriginActor", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDefaultLevelSequenceInstanceData, TransformOriginActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDefaultLevelSequenceInstanceData_Statics::NewProp_TransformOriginActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDefaultLevelSequenceInstanceData_Statics::NewProp_TransformOriginActor_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UDefaultLevelSequenceInstanceData_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UDefaultLevelSequenceInstanceData_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTransformOrigin_NoRegister, (int32)VTABLE_OFFSET(UDefaultLevelSequenceInstanceData, IMovieSceneTransformOrigin), false },  // 3207423692
		};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_LevelSequence_Public_DefaultLevelSequenceInstanceData_h_101807053(TEXT("/Script/LevelSequence"),
