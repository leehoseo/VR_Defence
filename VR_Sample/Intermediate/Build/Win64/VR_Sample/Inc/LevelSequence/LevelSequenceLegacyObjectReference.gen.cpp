...
class UScriptStruct* FLevelSequenceLegacyObjectReference::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LevelSequenceLegacyObjectReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLevelSequenceLegacyObjectReference, Z_Construct_UPackage__Script_LevelSequence(), TEXT("LevelSequenceLegacyObjectReference"));
	}
...
class UScriptStruct* FLevelSequenceObjectReferenceMap::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LevelSequenceObjectReferenceMap.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLevelSequenceObjectReferenceMap, Z_Construct_UPackage__Script_LevelSequence(), TEXT("LevelSequenceObjectReferenceMap"));
	}
