...
class UScriptStruct* FMovieSceneMediaPlayerPropertySectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneMediaPlayerPropertySectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneMediaPlayerPropertySectionTemplate, Z_Construct_UPackage__Script_MediaCompositing(), TEXT("MovieSceneMediaPlayerPropertySectionTemplate"));
	}
...
template<> MEDIACOMPOSITING_API UScriptStruct* StaticStruct<FMovieSceneMediaPlayerPropertySectionTemplate>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FMovieSceneMediaPlayerPropertySectionTemplate_Statics::NewProp_MediaSource = { "MediaSource", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneMediaPlayerPropertySectionTemplate, MediaSource), Z_Construct_UClass_UMediaSource_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneMediaPlayerPropertySectionTemplate_Statics::NewProp_MediaSource_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneMediaPlayerPropertySectionTemplate_Statics::NewProp_MediaSource_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneMediaPlayerPropertySectionTemplate_Statics::NewProp_SectionStartFrame = { "SectionStartFrame", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneMediaPlayerPropertySectionTemplate, SectionStartFrame), Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneMediaPlayerPropertySectionTemplate_Statics::NewProp_SectionStartFrame_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneMediaPlayerPropertySectionTemplate_Statics::NewProp_SectionStartFrame_MetaData)) };
#if WITH_METADATA
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaCompositing_Source_MediaCompositing_Private_MovieScene_MovieSceneMediaPlayerPropertyTemplate_h_4095378030(TEXT("/Script/MediaCompositing"),
		nullptr, 0,
