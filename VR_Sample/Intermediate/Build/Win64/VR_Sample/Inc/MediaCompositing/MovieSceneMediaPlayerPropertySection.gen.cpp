...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneMediaPlayerPropertySection_Statics::NewProp_MediaSource = { "MediaSource", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneMediaPlayerPropertySection, MediaSource), Z_Construct_UClass_UMediaSource_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneMediaPlayerPropertySection_Statics::NewProp_MediaSource_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneMediaPlayerPropertySection_Statics::NewProp_MediaSource_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneMediaPlayerPropertySection_Statics::NewProp_bLoop = { "bLoop", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneMediaPlayerPropertySection), &Z_Construct_UClass_UMovieSceneMediaPlayerPropertySection_Statics::NewProp_bLoop_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneMediaPlayerPropertySection_Statics::NewProp_bLoop_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneMediaPlayerPropertySection_Statics::NewProp_bLoop_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaCompositing_Source_MediaCompositing_Public_MovieSceneMediaPlayerPropertySection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneMediaPlayerPropertySection, UMovieSceneMediaPlayerPropertySection::StaticClass, TEXT("UMovieSceneMediaPlayerPropertySection"), &Z_Registration_Info_UClass_UMovieSceneMediaPlayerPropertySection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneMediaPlayerPropertySection), 1155531301U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Media_MediaCompositing_Source_MediaCompositing_Public_MovieSceneMediaPlayerPropertySection_h_1314537823(TEXT("/Script/MediaCompositing"),
