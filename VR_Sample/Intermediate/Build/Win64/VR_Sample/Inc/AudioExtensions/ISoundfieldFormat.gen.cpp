...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_ISoundfieldFormat_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundfieldEncodingSettingsBase, USoundfieldEncodingSettingsBase::StaticClass, TEXT("USoundfieldEncodingSettingsBase"), &Z_Registration_Info_UClass_USoundfieldEncodingSettingsBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundfieldEncodingSettingsBase), 4013872436U) },
		{ Z_Construct_UClass_USoundfieldEffectSettingsBase, USoundfieldEffectSettingsBase::StaticClass, TEXT("USoundfieldEffectSettingsBase"), &Z_Registration_Info_UClass_USoundfieldEffectSettingsBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundfieldEffectSettingsBase), 1459314451U) },
		{ Z_Construct_UClass_USoundfieldEffectBase, USoundfieldEffectBase::StaticClass, TEXT("USoundfieldEffectBase"), &Z_Registration_Info_UClass_USoundfieldEffectBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundfieldEffectBase), 1862723293U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_ISoundfieldFormat_h_411772474(TEXT("/Script/AudioExtensions"),
