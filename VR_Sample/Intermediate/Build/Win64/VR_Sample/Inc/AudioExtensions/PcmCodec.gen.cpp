...
#include "AudioExtensions/Private/PcmCodec.h"
...
// End Cross Module References
	...
	static UEnum* EPcmBitDepthConversion_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPcmBitDepthConversion.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AudioExtensions_EPcmBitDepthConversion, Z_Construct_UPackage__Script_AudioExtensions(), TEXT("EPcmBitDepthConversion"));
		}
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAudioPcmEncoderSettings_Statics::NewProp_BitDepthConversion_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UAudioPcmEncoderSettings_Statics::NewProp_BitDepthConversion = { "BitDepthConversion", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAudioPcmEncoderSettings, BitDepthConversion), Z_Construct_UEnum_AudioExtensions_EPcmBitDepthConversion, METADATA_PARAMS(Z_Construct_UClass_UAudioPcmEncoderSettings_Statics::NewProp_BitDepthConversion_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAudioPcmEncoderSettings_Statics::NewProp_BitDepthConversion_MetaData)) }; // 3246530996
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Private_PcmCodec_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioPcmEncoderSettings, UAudioPcmEncoderSettings::StaticClass, TEXT("UAudioPcmEncoderSettings"), &Z_Registration_Info_UClass_UAudioPcmEncoderSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioPcmEncoderSettings), 2200706084U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Private_PcmCodec_h_2367177295(TEXT("/Script/AudioExtensions"),
