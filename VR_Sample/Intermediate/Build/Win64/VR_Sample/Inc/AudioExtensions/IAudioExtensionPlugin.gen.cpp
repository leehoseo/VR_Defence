...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_IAudioExtensionPlugin_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USpatializationPluginSourceSettingsBase, USpatializationPluginSourceSettingsBase::StaticClass, TEXT("USpatializationPluginSourceSettingsBase"), &Z_Registration_Info_UClass_USpatializationPluginSourceSettingsBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USpatializationPluginSourceSettingsBase), 4166553824U) },
		...
		{ Z_Construct_UClass_UOcclusionPluginSourceSettingsBase, UOcclusionPluginSourceSettingsBase::StaticClass, TEXT("UOcclusionPluginSourceSettingsBase"), &Z_Registration_Info_UClass_UOcclusionPluginSourceSettingsBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOcclusionPluginSourceSettingsBase), 2454578922U) },
		{ Z_Construct_UClass_UReverbPluginSourceSettingsBase, UReverbPluginSourceSettingsBase::StaticClass, TEXT("UReverbPluginSourceSettingsBase"), &Z_Registration_Info_UClass_UReverbPluginSourceSettingsBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReverbPluginSourceSettingsBase), 1056617656U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_IAudioExtensionPlugin_h_4127051429(TEXT("/Script/AudioExtensions"),
