...
#include "AudioExtensions/Public/IAudioCodec.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAudioCodecEncoderSettings_Statics::NewProp_Version = { "Version", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAudioCodecEncoderSettings, Version), METADATA_PARAMS(Z_Construct_UClass_UAudioCodecEncoderSettings_Statics::NewProp_Version_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAudioCodecEncoderSettings_Statics::NewProp_Version_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_IAudioCodec_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioCodecEncoderSettings, UAudioCodecEncoderSettings::StaticClass, TEXT("UAudioCodecEncoderSettings"), &Z_Registration_Info_UClass_UAudioCodecEncoderSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioCodecEncoderSettings), 3495527226U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_IAudioCodec_h_238696515(TEXT("/Script/AudioExtensions"),
