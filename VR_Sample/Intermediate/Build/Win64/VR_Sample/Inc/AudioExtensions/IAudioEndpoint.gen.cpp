...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_IAudioEndpoint_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioEndpointSettingsBase, UAudioEndpointSettingsBase::StaticClass, TEXT("UAudioEndpointSettingsBase"), &Z_Registration_Info_UClass_UAudioEndpointSettingsBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioEndpointSettingsBase), 1707747108U) },
		{ Z_Construct_UClass_UDummyEndpointSettings, UDummyEndpointSettings::StaticClass, TEXT("UDummyEndpointSettings"), &Z_Registration_Info_UClass_UDummyEndpointSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDummyEndpointSettings), 1520970480U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioExtensions_Public_IAudioEndpoint_h_3249567260(TEXT("/Script/AudioExtensions"),
