...
#include "AutomationTest/Public/AutomationTestExcludelist.h"
...
// End Cross Module References
	...
	static UEnum* ERHI_Flags_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERHI_Flags.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AutomationTest_ERHI_Flags, Z_Construct_UPackage__Script_AutomationTest(), TEXT("ERHI_Flags"));
		}
...
class UScriptStruct* FAutomationTestExcludeOptions::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AutomationTestExcludeOptions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAutomationTestExcludeOptions, Z_Construct_UPackage__Script_AutomationTest(), TEXT("AutomationTestExcludeOptions"));
	}
...
template<> AUTOMATIONTEST_API UScriptStruct* StaticStruct<FAutomationTestExcludeOptions>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAutomationTestExcludeOptions_Statics::NewProp_Test = { "Test", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationTestExcludeOptions, Test), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationTestExcludeOptions_Statics::NewProp_Test_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationTestExcludeOptions_Statics::NewProp_Test_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAutomationTestExcludeOptions_Statics::NewProp_Warn = { "Warn", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAutomationTestExcludeOptions), &Z_Construct_UScriptStruct_FAutomationTestExcludeOptions_Statics::NewProp_Warn_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationTestExcludeOptions_Statics::NewProp_Warn_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationTestExcludeOptions_Statics::NewProp_Warn_MetaData)) };
...
class UScriptStruct* FAutomationTestExcludelistEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AutomationTestExcludelistEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry, Z_Construct_UPackage__Script_AutomationTest(), TEXT("AutomationTestExcludelistEntry"));
	}
...
template<> AUTOMATIONTEST_API UScriptStruct* StaticStruct<FAutomationTestExcludelistEntry>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_Map = { "Map", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationTestExcludelistEntry, Map), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_Map_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_Map_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_Test = { "Test", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationTestExcludelistEntry, Test), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_Test_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_Test_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_Reason = { "Reason", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationTestExcludelistEntry, Reason), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_Reason_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_Reason_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_RHIs_ElementProp = { "RHIs", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FSetPropertyParams Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_RHIs = { "RHIs", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Set, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutomationTestExcludelistEntry, RHIs), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_RHIs_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry_Statics::NewProp_RHIs_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAutomationTestExcludelist_Statics::NewProp_ExcludeTest_Inner = { "ExcludeTest", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FAutomationTestExcludelistEntry, METADATA_PARAMS(nullptr, 0) }; // 3744138882
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AutomationTest_Public_AutomationTestExcludelist_h_Statics::EnumInfo[] = {
		{ ERHI_Flags_StaticEnum, TEXT("ERHI_Flags"), &Z_Registration_Info_UEnum_ERHI_Flags, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1075179584U) },
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AutomationTest_Public_AutomationTestExcludelist_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAutomationTestExcludelist, UAutomationTestExcludelist::StaticClass, TEXT("UAutomationTestExcludelist"), &Z_Registration_Info_UClass_UAutomationTestExcludelist, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAutomationTestExcludelist), 1971695169U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AutomationTest_Public_AutomationTestExcludelist_h_1806401751(TEXT("/Script/AutomationTest"),
