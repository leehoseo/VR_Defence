...
class UScriptStruct* FTrackedCamera::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TrackedCamera.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTrackedCamera, Z_Construct_UPackage__Script_OculusMR(), TEXT("TrackedCamera"));
	}
...
template<> OCULUSMR_API UScriptStruct* StaticStruct<FTrackedCamera>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_Index = { "Index", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, Index), METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_Index_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_Index_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_FieldOfView = { "FieldOfView", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, FieldOfView), METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_FieldOfView_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_FieldOfView_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_SizeX = { "SizeX", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, SizeX), METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_SizeX_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_SizeX_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_SizeY = { "SizeY", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, SizeY), METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_SizeY_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_SizeY_MetaData)) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_AttachedTrackedDevice = { "AttachedTrackedDevice", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, AttachedTrackedDevice), Z_Construct_UEnum_OculusHMD_ETrackedDeviceType, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_AttachedTrackedDevice_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_AttachedTrackedDevice_MetaData)) }; // 1408524775
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_CalibratedRotation = { "CalibratedRotation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, CalibratedRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_CalibratedRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_CalibratedRotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_CalibratedOffset = { "CalibratedOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, CalibratedOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_CalibratedOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_CalibratedOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UserRotation = { "UserRotation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, UserRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UserRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UserRotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UserOffset = { "UserOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, UserOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UserOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_UserOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_RawOffset = { "RawOffset", nullptr, (EPropertyFlags)0x0010000020000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedCamera, RawOffset_DEPRECATED), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_RawOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewProp_RawOffset_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOculusMR_State_Statics::NewProp_TrackedCamera = { "TrackedCamera", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOculusMR_State, TrackedCamera), Z_Construct_UScriptStruct_FTrackedCamera, METADATA_PARAMS(Z_Construct_UClass_UOculusMR_State_Statics::NewProp_TrackedCamera_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOculusMR_State_Statics::NewProp_TrackedCamera_MetaData)) }; // 818477964
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UOculusMR_State_Statics::NewProp_TrackingReferenceComponent = { "TrackingReferenceComponent", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOculusMR_State, TrackingReferenceComponent), Z_Construct_UClass_USceneComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UOculusMR_State_Statics::NewProp_TrackingReferenceComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOculusMR_State_Statics::NewProp_TrackingReferenceComponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UOculusMR_State_Statics::NewProp_ScalingFactor = { "ScalingFactor", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UOculusMR_State, ScalingFactor), METADATA_PARAMS(Z_Construct_UClass_UOculusMR_State_Statics::NewProp_ScalingFactor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOculusMR_State_Statics::NewProp_ScalingFactor_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOculusMR_State_Statics::NewProp_BindToTrackedCameraIndexRequested = { "BindToTrackedCameraIndexRequested", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UOculusMR_State), &Z_Construct_UClass_UOculusMR_State_Statics::NewProp_BindToTrackedCameraIndexRequested_SetBit, METADATA_PARAMS(Z_Construct_UClass_UOculusMR_State_Statics::NewProp_BindToTrackedCameraIndexRequested_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UOculusMR_State_Statics::NewProp_BindToTrackedCameraIndexRequested_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusVR_Source_OculusMR_Private_OculusMR_State_h_Statics::ScriptStructInfo[] = {
		{ FTrackedCamera::StaticStruct, Z_Construct_UScriptStruct_FTrackedCamera_Statics::NewStructOps, TEXT("TrackedCamera"), &Z_Registration_Info_UScriptStruct_TrackedCamera, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTrackedCamera), 818477964U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusVR_Source_OculusMR_Private_OculusMR_State_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOculusMR_State, UOculusMR_State::StaticClass, TEXT("UOculusMR_State"), &Z_Registration_Info_UClass_UOculusMR_State, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOculusMR_State), 96611597U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Oculus_OculusVR_Source_OculusMR_Private_OculusMR_State_h_1959582748(TEXT("/Script/OculusMR"),
