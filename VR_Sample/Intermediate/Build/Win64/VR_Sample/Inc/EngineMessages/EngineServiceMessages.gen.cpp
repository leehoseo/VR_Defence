...
class UScriptStruct* FEngineServicePing::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EngineServicePing.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEngineServicePing, Z_Construct_UPackage__Script_EngineMessages(), TEXT("EngineServicePing"));
	}
...
class UScriptStruct* FEngineServicePong::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EngineServicePong.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEngineServicePong, Z_Construct_UPackage__Script_EngineMessages(), TEXT("EngineServicePong"));
	}
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FEngineServicePong_Statics::NewProp_CurrentLevel = { "CurrentLevel", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEngineServicePong, CurrentLevel), METADATA_PARAMS(Z_Construct_UScriptStruct_FEngineServicePong_Statics::NewProp_CurrentLevel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEngineServicePong_Statics::NewProp_CurrentLevel_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FEngineServicePong_Statics::NewProp_EngineVersion = { "EngineVersion", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEngineServicePong, EngineVersion), METADATA_PARAMS(Z_Construct_UScriptStruct_FEngineServicePong_Statics::NewProp_EngineVersion_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEngineServicePong_Statics::NewProp_EngineVersion_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FEngineServicePong_Statics::NewProp_WorldTimeSeconds = { "WorldTimeSeconds", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEngineServicePong, WorldTimeSeconds), METADATA_PARAMS(Z_Construct_UScriptStruct_FEngineServicePong_Statics::NewProp_WorldTimeSeconds_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEngineServicePong_Statics::NewProp_WorldTimeSeconds_MetaData)) };
...
class UScriptStruct* FEngineServiceAuthDeny::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EngineServiceAuthDeny.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEngineServiceAuthDeny, Z_Construct_UPackage__Script_EngineMessages(), TEXT("EngineServiceAuthDeny"));
	}
...
class UScriptStruct* FEngineServiceAuthGrant::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EngineServiceAuthGrant.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEngineServiceAuthGrant, Z_Construct_UPackage__Script_EngineMessages(), TEXT("EngineServiceAuthGrant"));
	}
...
class UScriptStruct* FEngineServiceExecuteCommand::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EngineServiceExecuteCommand.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEngineServiceExecuteCommand, Z_Construct_UPackage__Script_EngineMessages(), TEXT("EngineServiceExecuteCommand"));
	}
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FEngineServiceExecuteCommand_Statics::NewProp_Command = { "Command", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEngineServiceExecuteCommand, Command), METADATA_PARAMS(Z_Construct_UScriptStruct_FEngineServiceExecuteCommand_Statics::NewProp_Command_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEngineServiceExecuteCommand_Statics::NewProp_Command_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FEngineServiceTerminate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EngineServiceTerminate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEngineServiceTerminate, Z_Construct_UPackage__Script_EngineMessages(), TEXT("EngineServiceTerminate"));
	}
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FEngineServiceTerminate_Statics::NewProp_UserName = { "UserName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEngineServiceTerminate, UserName), METADATA_PARAMS(Z_Construct_UScriptStruct_FEngineServiceTerminate_Statics::NewProp_UserName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEngineServiceTerminate_Statics::NewProp_UserName_MetaData)) };
...
class UScriptStruct* FEngineServiceNotification::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EngineServiceNotification.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEngineServiceNotification, Z_Construct_UPackage__Script_EngineMessages(), TEXT("EngineServiceNotification"));
	}
...
template<> ENGINEMESSAGES_API UScriptStruct* StaticStruct<FEngineServiceNotification>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_EngineMessages_Public_EngineServiceMessages_h_Statics::ScriptStructInfo[] = {
		...
		{ FEngineServicePong::StaticStruct, Z_Construct_UScriptStruct_FEngineServicePong_Statics::NewStructOps, TEXT("EngineServicePong"), &Z_Registration_Info_UScriptStruct_EngineServicePong, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEngineServicePong), 1251936621U) },
		{ FEngineServiceAuthDeny::StaticStruct, Z_Construct_UScriptStruct_FEngineServiceAuthDeny_Statics::NewStructOps, TEXT("EngineServiceAuthDeny"), &Z_Registration_Info_UScriptStruct_EngineServiceAuthDeny, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEngineServiceAuthDeny), 3283240230U) },
		{ FEngineServiceAuthGrant::StaticStruct, Z_Construct_UScriptStruct_FEngineServiceAuthGrant_Statics::NewStructOps, TEXT("EngineServiceAuthGrant"), &Z_Registration_Info_UScriptStruct_EngineServiceAuthGrant, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEngineServiceAuthGrant), 3282122974U) },
		...
		{ FEngineServiceTerminate::StaticStruct, Z_Construct_UScriptStruct_FEngineServiceTerminate_Statics::NewStructOps, TEXT("EngineServiceTerminate"), &Z_Registration_Info_UScriptStruct_EngineServiceTerminate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEngineServiceTerminate), 2853642953U) },
		{ FEngineServiceNotification::StaticStruct, Z_Construct_UScriptStruct_FEngineServiceNotification_Statics::NewStructOps, TEXT("EngineServiceNotification"), &Z_Registration_Info_UScriptStruct_EngineServiceNotification, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEngineServiceNotification), 148154821U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_EngineMessages_Public_EngineServiceMessages_h_2150769011(TEXT("/Script/EngineMessages"),
		nullptr, 0,
