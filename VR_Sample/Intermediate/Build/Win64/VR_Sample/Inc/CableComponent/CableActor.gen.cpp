...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACableActor_Statics::NewProp_CableComponent = { "CableComponent", nullptr, (EPropertyFlags)0x00140000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACableActor, CableComponent), Z_Construct_UClass_UCableComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACableActor_Statics::NewProp_CableComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACableActor_Statics::NewProp_CableComponent_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CableComponent_Source_CableComponent_Classes_CableActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACableActor, ACableActor::StaticClass, TEXT("ACableActor"), &Z_Registration_Info_UClass_ACableActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACableActor), 479886678U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_CableComponent_Source_CableComponent_Classes_CableActor_h_2218441794(TEXT("/Script/CableComponent"),
