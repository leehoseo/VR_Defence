...
// End Cross Module References
	...
	static UEnum* EHDRCaptureGamut_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EHDRCaptureGamut.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MovieSceneCapture_EHDRCaptureGamut, Z_Construct_UPackage__Script_MovieSceneCapture(), TEXT("EHDRCaptureGamut"));
		}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_MovieSceneCapture_EHDRCaptureGamut_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "Comment", "/** Used by UCompositionGraphCaptureSettings. Matches gamut oreder in TonemapCommon.usf OuputGamutMappingMatrix()*/" },
...
class UScriptStruct* FCompositionGraphCapturePasses::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CompositionGraphCapturePasses.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCompositionGraphCapturePasses, Z_Construct_UPackage__Script_MovieSceneCapture(), TEXT("CompositionGraphCapturePasses"));
	}
...
template<> MOVIESCENECAPTURE_API UScriptStruct* StaticStruct<FCompositionGraphCapturePasses>()
{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FCompositionGraphCapturePasses_Statics::NewProp_Value_Inner = { "Value", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_IncludeRenderPasses = { "IncludeRenderPasses", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCompositionGraphCaptureProtocol, IncludeRenderPasses), Z_Construct_UScriptStruct_FCompositionGraphCapturePasses, METADATA_PARAMS(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_IncludeRenderPasses_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_IncludeRenderPasses_MetaData)) }; // 1609624507
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_bCaptureFramesInHDR = { "bCaptureFramesInHDR", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UCompositionGraphCaptureProtocol), &Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_bCaptureFramesInHDR_SetBit, METADATA_PARAMS(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_bCaptureFramesInHDR_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_bCaptureFramesInHDR_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_HDRCompressionQuality = { "HDRCompressionQuality", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCompositionGraphCaptureProtocol, HDRCompressionQuality), METADATA_PARAMS(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_HDRCompressionQuality_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_HDRCompressionQuality_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_CaptureGamut = { "CaptureGamut", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCompositionGraphCaptureProtocol, CaptureGamut), Z_Construct_UEnum_MovieSceneCapture_EHDRCaptureGamut, METADATA_PARAMS(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_CaptureGamut_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_CaptureGamut_MetaData)) }; // 683866250
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_PostProcessingMaterial = { "PostProcessingMaterial", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCompositionGraphCaptureProtocol, PostProcessingMaterial), Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_PostProcessingMaterial_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_PostProcessingMaterial_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_bDisableScreenPercentage = { "bDisableScreenPercentage", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UCompositionGraphCaptureProtocol), &Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_bDisableScreenPercentage_SetBit, METADATA_PARAMS(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_bDisableScreenPercentage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_bDisableScreenPercentage_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_PostProcessingMaterialPtr = { "PostProcessingMaterialPtr", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCompositionGraphCaptureProtocol, PostProcessingMaterialPtr), Z_Construct_UClass_UMaterialInterface_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_PostProcessingMaterialPtr_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositionGraphCaptureProtocol_Statics::NewProp_PostProcessingMaterialPtr_MetaData)) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_Protocols_CompositionGraphCaptureProtocol_h_Statics::EnumInfo[] = {
		{ EHDRCaptureGamut_StaticEnum, TEXT("EHDRCaptureGamut"), &Z_Registration_Info_UEnum_EHDRCaptureGamut, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 683866250U) },
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_Protocols_CompositionGraphCaptureProtocol_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCompositionGraphCaptureProtocol, UCompositionGraphCaptureProtocol::StaticClass, TEXT("UCompositionGraphCaptureProtocol"), &Z_Registration_Info_UClass_UCompositionGraphCaptureProtocol, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompositionGraphCaptureProtocol), 15452078U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_Protocols_CompositionGraphCaptureProtocol_h_1807671880(TEXT("/Script/MovieSceneCapture"),
