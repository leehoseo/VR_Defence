...
// End Cross Module References
	...
	static UEnum* EMovieSceneCaptureProtocolState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMovieSceneCaptureProtocolState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MovieSceneCapture_EMovieSceneCaptureProtocolState, Z_Construct_UPackage__Script_MovieSceneCapture(), TEXT("EMovieSceneCaptureProtocolState"));
		}
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UMovieSceneCaptureProtocolBase_GetState_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMovieSceneCaptureProtocolBase_GetState_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneCaptureProtocolBase_eventGetState_Parms, ReturnValue), Z_Construct_UEnum_MovieSceneCapture_EMovieSceneCaptureProtocolState, METADATA_PARAMS(nullptr, 0) }; // 958607683
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMovieSceneCaptureProtocolBase_IsCapturing_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MovieSceneCaptureProtocolBase_eventIsCapturing_Parms), &Z_Construct_UFunction_UMovieSceneCaptureProtocolBase_IsCapturing_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneCaptureProtocolBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneCaptureProtocolBase_GetState, "GetState" }, // 3748900532
		{ &Z_Construct_UFunction_UMovieSceneCaptureProtocolBase_IsCapturing, "IsCapturing" }, // 1046209924
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UMovieSceneCaptureProtocolBase_Statics::NewProp_State = { "State", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCaptureProtocolBase, State), Z_Construct_UEnum_MovieSceneCapture_EMovieSceneCaptureProtocolState, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCaptureProtocolBase_Statics::NewProp_State_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCaptureProtocolBase_Statics::NewProp_State_MetaData)) }; // 958607683
...
class UScriptStruct* FFrameMetrics::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FrameMetrics.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFrameMetrics, Z_Construct_UPackage__Script_MovieSceneCapture(), TEXT("FrameMetrics"));
	}
...
template<> MOVIESCENECAPTURE_API UScriptStruct* StaticStruct<FFrameMetrics>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_TotalElapsedTime = { "TotalElapsedTime", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFrameMetrics, TotalElapsedTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_TotalElapsedTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_TotalElapsedTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_FrameDelta = { "FrameDelta", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFrameMetrics, FrameDelta), METADATA_PARAMS(Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_FrameDelta_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_FrameDelta_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_FrameNumber = { "FrameNumber", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFrameMetrics, FrameNumber), METADATA_PARAMS(Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_FrameNumber_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_FrameNumber_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_NumDroppedFrames = { "NumDroppedFrames", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFrameMetrics, NumDroppedFrames), METADATA_PARAMS(Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_NumDroppedFrames_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewProp_NumDroppedFrames_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_MovieSceneCaptureProtocolBase_h_Statics::ScriptStructInfo[] = {
		{ FFrameMetrics::StaticStruct, Z_Construct_UScriptStruct_FFrameMetrics_Statics::NewStructOps, TEXT("FrameMetrics"), &Z_Registration_Info_UScriptStruct_FrameMetrics, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFrameMetrics), 3673411575U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_MovieSceneCaptureProtocolBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCaptureProtocolBase, UMovieSceneCaptureProtocolBase::StaticClass, TEXT("UMovieSceneCaptureProtocolBase"), &Z_Registration_Info_UClass_UMovieSceneCaptureProtocolBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCaptureProtocolBase), 476460922U) },
		{ Z_Construct_UClass_UMovieSceneImageCaptureProtocolBase, UMovieSceneImageCaptureProtocolBase::StaticClass, TEXT("UMovieSceneImageCaptureProtocolBase"), &Z_Registration_Info_UClass_UMovieSceneImageCaptureProtocolBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneImageCaptureProtocolBase), 2712671348U) },
		{ Z_Construct_UClass_UMovieSceneAudioCaptureProtocolBase, UMovieSceneAudioCaptureProtocolBase::StaticClass, TEXT("UMovieSceneAudioCaptureProtocolBase"), &Z_Registration_Info_UClass_UMovieSceneAudioCaptureProtocolBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneAudioCaptureProtocolBase), 139692043U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_MovieSceneCaptureProtocolBase_h_3530665211(TEXT("/Script/MovieSceneCapture"),
