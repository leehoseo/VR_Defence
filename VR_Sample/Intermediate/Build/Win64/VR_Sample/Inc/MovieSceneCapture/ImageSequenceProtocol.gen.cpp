...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UCompressedImageSequenceProtocol_Statics::NewProp_CompressionQuality = { "CompressionQuality", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCompressedImageSequenceProtocol, CompressionQuality), METADATA_PARAMS(Z_Construct_UClass_UCompressedImageSequenceProtocol_Statics::NewProp_CompressionQuality_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompressedImageSequenceProtocol_Statics::NewProp_CompressionQuality_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UImageSequenceProtocol_EXR_Statics::NewProp_bCompressed = { "bCompressed", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UImageSequenceProtocol_EXR), &Z_Construct_UClass_UImageSequenceProtocol_EXR_Statics::NewProp_bCompressed_SetBit, METADATA_PARAMS(Z_Construct_UClass_UImageSequenceProtocol_EXR_Statics::NewProp_bCompressed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UImageSequenceProtocol_EXR_Statics::NewProp_bCompressed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UImageSequenceProtocol_EXR_Statics::NewProp_CaptureGamut = { "CaptureGamut", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UImageSequenceProtocol_EXR, CaptureGamut), Z_Construct_UEnum_MovieSceneCapture_EHDRCaptureGamut, METADATA_PARAMS(Z_Construct_UClass_UImageSequenceProtocol_EXR_Statics::NewProp_CaptureGamut_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UImageSequenceProtocol_EXR_Statics::NewProp_CaptureGamut_MetaData)) }; // 683866250
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_Protocols_ImageSequenceProtocol_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UImageSequenceProtocol, UImageSequenceProtocol::StaticClass, TEXT("UImageSequenceProtocol"), &Z_Registration_Info_UClass_UImageSequenceProtocol, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImageSequenceProtocol), 3558487336U) },
		{ Z_Construct_UClass_UCompressedImageSequenceProtocol, UCompressedImageSequenceProtocol::StaticClass, TEXT("UCompressedImageSequenceProtocol"), &Z_Registration_Info_UClass_UCompressedImageSequenceProtocol, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompressedImageSequenceProtocol), 1353442824U) },
		{ Z_Construct_UClass_UImageSequenceProtocol_BMP, UImageSequenceProtocol_BMP::StaticClass, TEXT("UImageSequenceProtocol_BMP"), &Z_Registration_Info_UClass_UImageSequenceProtocol_BMP, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImageSequenceProtocol_BMP), 255018583U) },
		{ Z_Construct_UClass_UImageSequenceProtocol_PNG, UImageSequenceProtocol_PNG::StaticClass, TEXT("UImageSequenceProtocol_PNG"), &Z_Registration_Info_UClass_UImageSequenceProtocol_PNG, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImageSequenceProtocol_PNG), 1983801576U) },
		{ Z_Construct_UClass_UImageSequenceProtocol_JPG, UImageSequenceProtocol_JPG::StaticClass, TEXT("UImageSequenceProtocol_JPG"), &Z_Registration_Info_UClass_UImageSequenceProtocol_JPG, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImageSequenceProtocol_JPG), 3063040641U) },
		{ Z_Construct_UClass_UImageSequenceProtocol_EXR, UImageSequenceProtocol_EXR::StaticClass, TEXT("UImageSequenceProtocol_EXR"), &Z_Registration_Info_UClass_UImageSequenceProtocol_EXR, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UImageSequenceProtocol_EXR), 2513137326U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_Protocols_ImageSequenceProtocol_h_994568315(TEXT("/Script/MovieSceneCapture"),
