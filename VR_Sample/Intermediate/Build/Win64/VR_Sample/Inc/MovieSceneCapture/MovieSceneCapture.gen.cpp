...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneCapture_GetAudioCaptureProtocol_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneCapture_eventGetAudioCaptureProtocol_Parms, ReturnValue), Z_Construct_UClass_UMovieSceneCaptureProtocolBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMovieSceneCapture_GetImageCaptureProtocol_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneCapture_eventGetImageCaptureProtocol_Parms, ReturnValue), Z_Construct_UClass_UMovieSceneCaptureProtocolBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UMovieSceneCapture_SetAudioCaptureProtocolType_Statics::NewProp_ProtocolType = { "ProtocolType", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneCapture_eventSetAudioCaptureProtocolType_Parms, ProtocolType), Z_Construct_UClass_UMovieSceneCaptureProtocolBase_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneCapture_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneCapture_GetAudioCaptureProtocol, "GetAudioCaptureProtocol" }, // 1041757189
		{ &Z_Construct_UFunction_UMovieSceneCapture_GetImageCaptureProtocol, "GetImageCaptureProtocol" }, // 552060375
		{ &Z_Construct_UFunction_UMovieSceneCapture_SetAudioCaptureProtocolType, "SetAudioCaptureProtocolType" }, // 1514565849
		{ &Z_Construct_UFunction_UMovieSceneCapture_SetImageCaptureProtocolType, "SetImageCaptureProtocolType" }, // 521057959
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_ImageCaptureProtocolType = { "ImageCaptureProtocolType", nullptr, (EPropertyFlags)0x0010000002004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCapture, ImageCaptureProtocolType), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_ImageCaptureProtocolType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_ImageCaptureProtocolType_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_AudioCaptureProtocolType_MetaData[] = {
		{ "Category", "CaptureSettings" },
		{ "Comment", "/** The type of capture protocol to use for audio data. Requires experimental audio mixer (launch editor via with -audiomixer). */" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_AudioCaptureProtocolType = { "AudioCaptureProtocolType", nullptr, (EPropertyFlags)0x0010000002004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCapture, AudioCaptureProtocolType), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_AudioCaptureProtocolType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_AudioCaptureProtocolType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_AudioCaptureProtocol = { "AudioCaptureProtocol", nullptr, (EPropertyFlags)0x00160000000a2009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCapture, AudioCaptureProtocol), Z_Construct_UClass_UMovieSceneAudioCaptureProtocolBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_AudioCaptureProtocol_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_AudioCaptureProtocol_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000004005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCapture, Settings), Z_Construct_UScriptStruct_FMovieSceneCaptureSettings, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_Settings_MetaData)) }; // 3614081357
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_bUseSeparateProcess = { "bUseSeparateProcess", nullptr, (EPropertyFlags)0x0010040000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneCapture), &Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_bUseSeparateProcess_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_bUseSeparateProcess_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_bUseSeparateProcess_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_bCloseEditorWhenCaptureStarts = { "bCloseEditorWhenCaptureStarts", nullptr, (EPropertyFlags)0x0010040000004005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneCapture), &Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_bCloseEditorWhenCaptureStarts_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_bCloseEditorWhenCaptureStarts_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_bCloseEditorWhenCaptureStarts_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_AdditionalCommandLineArguments = { "AdditionalCommandLineArguments", nullptr, (EPropertyFlags)0x0010040000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCapture, AdditionalCommandLineArguments), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_AdditionalCommandLineArguments_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_AdditionalCommandLineArguments_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_InheritedCommandLineArguments = { "InheritedCommandLineArguments", nullptr, (EPropertyFlags)0x0010040000002005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCapture, InheritedCommandLineArguments), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_InheritedCommandLineArguments_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCapture_Statics::NewProp_InheritedCommandLineArguments_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_MovieSceneCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCapture, UMovieSceneCapture::StaticClass, TEXT("UMovieSceneCapture"), &Z_Registration_Info_UClass_UMovieSceneCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCapture), 3353794512U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_MovieSceneCapture_h_2172434209(TEXT("/Script/MovieSceneCapture"),
