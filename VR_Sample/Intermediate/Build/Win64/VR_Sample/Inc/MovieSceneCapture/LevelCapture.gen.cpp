...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULevelCapture_Statics::NewProp_bAutoStartCapture = { "bAutoStartCapture", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ULevelCapture), &Z_Construct_UClass_ULevelCapture_Statics::NewProp_bAutoStartCapture_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULevelCapture_Statics::NewProp_bAutoStartCapture_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelCapture_Statics::NewProp_bAutoStartCapture_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_LevelCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULevelCapture, ULevelCapture::StaticClass, TEXT("ULevelCapture"), &Z_Registration_Info_UClass_ULevelCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevelCapture), 1538065398U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_LevelCapture_h_573673697(TEXT("/Script/MovieSceneCapture"),
