...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMasterAudioSubmixCaptureProtocol_Statics::NewProp_FileName = { "FileName", nullptr, (EPropertyFlags)0x0020080000004005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMasterAudioSubmixCaptureProtocol, FileName), METADATA_PARAMS(Z_Construct_UClass_UMasterAudioSubmixCaptureProtocol_Statics::NewProp_FileName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMasterAudioSubmixCaptureProtocol_Statics::NewProp_FileName_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_Protocols_AudioCaptureProtocol_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNullAudioCaptureProtocol, UNullAudioCaptureProtocol::StaticClass, TEXT("UNullAudioCaptureProtocol"), &Z_Registration_Info_UClass_UNullAudioCaptureProtocol, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNullAudioCaptureProtocol), 2621661503U) },
		{ Z_Construct_UClass_UMasterAudioSubmixCaptureProtocol, UMasterAudioSubmixCaptureProtocol::StaticClass, TEXT("UMasterAudioSubmixCaptureProtocol"), &Z_Registration_Info_UClass_UMasterAudioSubmixCaptureProtocol, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMasterAudioSubmixCaptureProtocol), 3098934975U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneCapture_Public_Protocols_AudioCaptureProtocol_h_2593377825(TEXT("/Script/MovieSceneCapture"),
