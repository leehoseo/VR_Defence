...
// End Cross Module References
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMediaSource_GetUrl_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSource_eventGetUrl_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaSource_SetMediaOptionBool_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MediaSource_eventSetMediaOptionBool_Parms), &Z_Construct_UFunction_UMediaSource_SetMediaOptionBool_Statics::NewProp_Value_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UMediaSource_SetMediaOptionFloat_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSource_eventSetMediaOptionFloat_Parms, Key), METADATA_PARAMS(Z_Construct_UFunction_UMediaSource_SetMediaOptionFloat_Statics::NewProp_Key_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaSource_SetMediaOptionFloat_Statics::NewProp_Key_MetaData)) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMediaSource_SetMediaOptionFloat_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSource_eventSetMediaOptionFloat_Parms, Value), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UMediaSource_SetMediaOptionInt64_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSource_eventSetMediaOptionInt64_Parms, Key), METADATA_PARAMS(Z_Construct_UFunction_UMediaSource_SetMediaOptionInt64_Statics::NewProp_Key_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaSource_SetMediaOptionInt64_Statics::NewProp_Key_MetaData)) };
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UMediaSource_SetMediaOptionString_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSource_eventSetMediaOptionString_Parms, Key), METADATA_PARAMS(Z_Construct_UFunction_UMediaSource_SetMediaOptionString_Statics::NewProp_Key_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaSource_SetMediaOptionString_Statics::NewProp_Key_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMediaSource_SetMediaOptionString_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSource_eventSetMediaOptionString_Parms, Value), METADATA_PARAMS(Z_Construct_UFunction_UMediaSource_SetMediaOptionString_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMediaSource_SetMediaOptionString_Statics::NewProp_Value_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaSource_Validate_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MediaSource_eventValidate_Parms), &Z_Construct_UFunction_UMediaSource_Validate_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMediaSource_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMediaSource_GetUrl, "GetUrl" }, // 1512884130
		{ &Z_Construct_UFunction_UMediaSource_SetMediaOptionBool, "SetMediaOptionBool" }, // 2098723717
		{ &Z_Construct_UFunction_UMediaSource_SetMediaOptionFloat, "SetMediaOptionFloat" }, // 2521626264
		{ &Z_Construct_UFunction_UMediaSource_SetMediaOptionInt64, "SetMediaOptionInt64" }, // 562631317
		{ &Z_Construct_UFunction_UMediaSource_SetMediaOptionString, "SetMediaOptionString" }, // 771355779
		{ &Z_Construct_UFunction_UMediaSource_Validate, "Validate" }, // 1659430437
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_MediaSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaSource, UMediaSource::StaticClass, TEXT("UMediaSource"), &Z_Registration_Info_UClass_UMediaSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaSource), 2936532885U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_MediaSource_h_4267877998(TEXT("/Script/MediaAssets"),
