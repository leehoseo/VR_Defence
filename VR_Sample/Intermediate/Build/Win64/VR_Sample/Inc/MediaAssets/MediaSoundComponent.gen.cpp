...
// End Cross Module References
	...
	static UEnum* EMediaSoundChannels_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMediaSoundChannels.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MediaAssets_EMediaSoundChannels, Z_Construct_UPackage__Script_MediaAssets(), TEXT("EMediaSoundChannels"));
		}
	...
	static UEnum* EMediaSoundComponentFFTSize_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMediaSoundComponentFFTSize.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MediaAssets_EMediaSoundComponentFFTSize, Z_Construct_UPackage__Script_MediaAssets(), TEXT("EMediaSoundComponentFFTSize"));
		}
...
class UScriptStruct* FMediaSoundComponentSpectralData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MediaSoundComponentSpectralData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMediaSoundComponentSpectralData, Z_Construct_UPackage__Script_MediaAssets(), TEXT("MediaSoundComponentSpectralData"));
	}
...
template<> MEDIAASSETS_API UScriptStruct* StaticStruct<FMediaSoundComponentSpectralData>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaSoundComponent_BP_GetAttenuationSettingsToApply_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MediaSoundComponent_eventBP_GetAttenuationSettingsToApply_Parms), &Z_Construct_UFunction_UMediaSoundComponent_BP_GetAttenuationSettingsToApply_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UMediaSoundComponent_GetEnvelopeValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSoundComponent_eventGetEnvelopeValue_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMediaSoundComponent_GetMediaPlayer_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSoundComponent_eventGetMediaPlayer_Parms, ReturnValue), Z_Construct_UClass_UMediaPlayer_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMediaSoundComponent_GetNormalizedSpectralData_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FMediaSoundComponentSpectralData, METADATA_PARAMS(nullptr, 0) }; // 2587012312
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMediaSoundComponent_GetNormalizedSpectralData_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSoundComponent_eventGetNormalizedSpectralData_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 2587012312
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMediaSoundComponent_GetSpectralData_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FMediaSoundComponentSpectralData, METADATA_PARAMS(nullptr, 0) }; // 2587012312
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMediaSoundComponent_GetSpectralData_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSoundComponent_eventGetSpectralData_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 2587012312
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaSoundComponent_SetEnableEnvelopeFollowing_Statics::NewProp_bInEnvelopeFollowing = { "bInEnvelopeFollowing", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MediaSoundComponent_eventSetEnableEnvelopeFollowing_Parms), &Z_Construct_UFunction_UMediaSoundComponent_SetEnableEnvelopeFollowing_Statics::NewProp_bInEnvelopeFollowing_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UMediaSoundComponent_SetEnableSpectralAnalysis_Statics::NewProp_bInSpectralAnalysisEnabled = { "bInSpectralAnalysisEnabled", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(MediaSoundComponent_eventSetEnableSpectralAnalysis_Parms), &Z_Construct_UFunction_UMediaSoundComponent_SetEnableSpectralAnalysis_Statics::NewProp_bInSpectralAnalysisEnabled_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMediaSoundComponent_SetEnvelopeFollowingsettings_Statics::NewProp_AttackTimeMsec = { "AttackTimeMsec", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSoundComponent_eventSetEnvelopeFollowingsettings_Parms, AttackTimeMsec), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UMediaSoundComponent_SetEnvelopeFollowingsettings_Statics::NewProp_ReleaseTimeMsec = { "ReleaseTimeMsec", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSoundComponent_eventSetEnvelopeFollowingsettings_Parms, ReleaseTimeMsec), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMediaSoundComponent_SetMediaPlayer_Statics::NewProp_NewMediaPlayer = { "NewMediaPlayer", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSoundComponent_eventSetMediaPlayer_Parms, NewMediaPlayer), Z_Construct_UClass_UMediaPlayer_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UMediaSoundComponent_SetSpectralAnalysisSettings_Statics::NewProp_InFrequenciesToAnalyze = { "InFrequenciesToAnalyze", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSoundComponent_eventSetSpectralAnalysisSettings_Parms, InFrequenciesToAnalyze), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UMediaSoundComponent_SetSpectralAnalysisSettings_Statics::NewProp_InFFTSize_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UMediaSoundComponent_SetSpectralAnalysisSettings_Statics::NewProp_InFFTSize = { "InFFTSize", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MediaSoundComponent_eventSetSpectralAnalysisSettings_Parms, InFFTSize), Z_Construct_UEnum_MediaAssets_EMediaSoundComponentFFTSize, METADATA_PARAMS(nullptr, 0) }; // 951800493
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMediaSoundComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMediaSoundComponent_BP_GetAttenuationSettingsToApply, "BP_GetAttenuationSettingsToApply" }, // 2419620585
		{ &Z_Construct_UFunction_UMediaSoundComponent_GetEnvelopeValue, "GetEnvelopeValue" }, // 205847421
		{ &Z_Construct_UFunction_UMediaSoundComponent_GetMediaPlayer, "GetMediaPlayer" }, // 4092305278
		{ &Z_Construct_UFunction_UMediaSoundComponent_GetNormalizedSpectralData, "GetNormalizedSpectralData" }, // 2643279347
		{ &Z_Construct_UFunction_UMediaSoundComponent_GetSpectralData, "GetSpectralData" }, // 883843742
		{ &Z_Construct_UFunction_UMediaSoundComponent_SetEnableEnvelopeFollowing, "SetEnableEnvelopeFollowing" }, // 4241484278
		{ &Z_Construct_UFunction_UMediaSoundComponent_SetEnableSpectralAnalysis, "SetEnableSpectralAnalysis" }, // 1704572392
		{ &Z_Construct_UFunction_UMediaSoundComponent_SetEnvelopeFollowingsettings, "SetEnvelopeFollowingsettings" }, // 2095136618
		{ &Z_Construct_UFunction_UMediaSoundComponent_SetMediaPlayer, "SetMediaPlayer" }, // 1052314465
		{ &Z_Construct_UFunction_UMediaSoundComponent_SetSpectralAnalysisSettings, "SetSpectralAnalysisSettings" }, // 3769514820
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_Channels_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_DynamicRateAdjustment = { "DynamicRateAdjustment", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMediaSoundComponent), &Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_DynamicRateAdjustment_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_DynamicRateAdjustment_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_DynamicRateAdjustment_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_RateAdjustmentFactor = { "RateAdjustmentFactor", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMediaSoundComponent, RateAdjustmentFactor), METADATA_PARAMS(Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_RateAdjustmentFactor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_RateAdjustmentFactor_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_RateAdjustmentRange = { "RateAdjustmentRange", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMediaSoundComponent, RateAdjustmentRange), Z_Construct_UScriptStruct_FFloatRange, METADATA_PARAMS(Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_RateAdjustmentRange_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_RateAdjustmentRange_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_MediaPlayer = { "MediaPlayer", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMediaSoundComponent, MediaPlayer), Z_Construct_UClass_UMediaPlayer_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_MediaPlayer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMediaSoundComponent_Statics::NewProp_MediaPlayer_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_MediaSoundComponent_h_Statics::ScriptStructInfo[] = {
		{ FMediaSoundComponentSpectralData::StaticStruct, Z_Construct_UScriptStruct_FMediaSoundComponentSpectralData_Statics::NewStructOps, TEXT("MediaSoundComponentSpectralData"), &Z_Registration_Info_UScriptStruct_MediaSoundComponentSpectralData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMediaSoundComponentSpectralData), 2587012312U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_MediaSoundComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMediaSoundComponent, UMediaSoundComponent::StaticClass, TEXT("UMediaSoundComponent"), &Z_Registration_Info_UClass_UMediaSoundComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMediaSoundComponent), 1274698109U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_MediaSoundComponent_h_3646474895(TEXT("/Script/MediaAssets"),
