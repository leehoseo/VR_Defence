...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UStreamMediaSource_Statics::NewProp_StreamUrl = { "StreamUrl", nullptr, (EPropertyFlags)0x0010010000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStreamMediaSource, StreamUrl), METADATA_PARAMS(Z_Construct_UClass_UStreamMediaSource_Statics::NewProp_StreamUrl_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStreamMediaSource_Statics::NewProp_StreamUrl_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_StreamMediaSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStreamMediaSource, UStreamMediaSource::StaticClass, TEXT("UStreamMediaSource"), &Z_Registration_Info_UClass_UStreamMediaSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStreamMediaSource), 1966398146U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_StreamMediaSource_h_2158335830(TEXT("/Script/MediaAssets"),
