...
// End Cross Module References
...
#endif
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames_ValueProp = { "PlatformPlayerNames", nullptr, (EPropertyFlags)0x0000000800000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames_Key_KeyProp = { "PlatformPlayerNames_Key", nullptr, (EPropertyFlags)0x0000000800000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames = { "PlatformPlayerNames", nullptr, (EPropertyFlags)0x0010000800002005, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBaseMediaSource, PlatformPlayerNames), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlatformPlayerNames_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlayerName = { "PlayerName", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBaseMediaSource, PlayerName), METADATA_PARAMS(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlayerName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBaseMediaSource_Statics::NewProp_PlayerName_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_BaseMediaSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBaseMediaSource, UBaseMediaSource::StaticClass, TEXT("UBaseMediaSource"), &Z_Registration_Info_UClass_UBaseMediaSource, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBaseMediaSource), 1330344202U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MediaAssets_Public_BaseMediaSource_h_800342484(TEXT("/Script/MediaAssets"),
