...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCompositeCameraShakePattern_Statics::NewProp_ChildPatterns_Inner = { "ChildPatterns", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UCameraShakePattern_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCompositeCameraShakePattern_Statics::NewProp_ChildPatterns_Inner_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositeCameraShakePattern_Statics::NewProp_ChildPatterns_Inner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCompositeCameraShakePattern_Statics::NewProp_ChildPatterns = { "ChildPatterns", nullptr, (EPropertyFlags)0x0014008000000009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCompositeCameraShakePattern, ChildPatterns), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCompositeCameraShakePattern_Statics::NewProp_ChildPatterns_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositeCameraShakePattern_Statics::NewProp_ChildPatterns_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Public_CompositeCameraShakePattern_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCompositeCameraShakePattern, UCompositeCameraShakePattern::StaticClass, TEXT("UCompositeCameraShakePattern"), &Z_Registration_Info_UClass_UCompositeCameraShakePattern, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompositeCameraShakePattern), 3028309731U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Public_CompositeCameraShakePattern_h_4180197693(TEXT("/Script/GameplayCameras"),
