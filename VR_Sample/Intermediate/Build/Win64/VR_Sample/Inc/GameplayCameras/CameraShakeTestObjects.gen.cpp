...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UConstantCameraShakePattern_Statics::NewProp_LocationOffset = { "LocationOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConstantCameraShakePattern, LocationOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UConstantCameraShakePattern_Statics::NewProp_LocationOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConstantCameraShakePattern_Statics::NewProp_LocationOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UConstantCameraShakePattern_Statics::NewProp_RotationOffset = { "RotationOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConstantCameraShakePattern, RotationOffset), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UClass_UConstantCameraShakePattern_Statics::NewProp_RotationOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConstantCameraShakePattern_Statics::NewProp_RotationOffset_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Private_Tests_CameraShakeTestObjects_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTestCameraShake, UTestCameraShake::StaticClass, TEXT("UTestCameraShake"), &Z_Registration_Info_UClass_UTestCameraShake, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTestCameraShake), 723874871U) },
		{ Z_Construct_UClass_UConstantCameraShakePattern, UConstantCameraShakePattern::StaticClass, TEXT("UConstantCameraShakePattern"), &Z_Registration_Info_UClass_UConstantCameraShakePattern, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UConstantCameraShakePattern), 3957923903U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Private_Tests_CameraShakeTestObjects_h_1341710543(TEXT("/Script/GameplayCameras"),
