...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USimpleCameraShakePattern_Statics::NewProp_Duration = { "Duration", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USimpleCameraShakePattern, Duration), METADATA_PARAMS(Z_Construct_UClass_USimpleCameraShakePattern_Statics::NewProp_Duration_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USimpleCameraShakePattern_Statics::NewProp_Duration_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USimpleCameraShakePattern_Statics::NewProp_BlendInTime = { "BlendInTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USimpleCameraShakePattern, BlendInTime), METADATA_PARAMS(Z_Construct_UClass_USimpleCameraShakePattern_Statics::NewProp_BlendInTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USimpleCameraShakePattern_Statics::NewProp_BlendInTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USimpleCameraShakePattern_Statics::NewProp_BlendOutTime = { "BlendOutTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USimpleCameraShakePattern, BlendOutTime), METADATA_PARAMS(Z_Construct_UClass_USimpleCameraShakePattern_Statics::NewProp_BlendOutTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USimpleCameraShakePattern_Statics::NewProp_BlendOutTime_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Public_SimpleCameraShakePattern_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USimpleCameraShakePattern, USimpleCameraShakePattern::StaticClass, TEXT("USimpleCameraShakePattern"), &Z_Registration_Info_UClass_USimpleCameraShakePattern, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USimpleCameraShakePattern), 3702707707U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Cameras_GameplayCameras_Source_GameplayCameras_Public_SimpleCameraShakePattern_h_3663194314(TEXT("/Script/GameplayCameras"),
