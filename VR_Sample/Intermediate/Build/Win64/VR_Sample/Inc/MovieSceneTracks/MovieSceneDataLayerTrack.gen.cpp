...
#include "MovieSceneTracks/Public/Tracks/MovieSceneDataLayerTrack.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneDataLayerTrack_Statics::NewProp_Sections = { "Sections", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneDataLayerTrack, Sections), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneDataLayerTrack_Statics::NewProp_Sections_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDataLayerTrack_Statics::NewProp_Sections_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneDataLayerTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneDataLayerTrack, UMovieSceneDataLayerTrack::StaticClass, TEXT("UMovieSceneDataLayerTrack"), &Z_Registration_Info_UClass_UMovieSceneDataLayerTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneDataLayerTrack), 3789801277U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneDataLayerTrack_h_2144994282(TEXT("/Script/MovieSceneTracks"),
