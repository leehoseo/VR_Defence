...
class UScriptStruct* FMovieSceneActorReferenceSectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneActorReferenceSectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneActorReferenceSectionTemplate"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneActorReferenceSectionTemplate>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::Struct_MetaDataParams[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::NewProp_PropertyData_MetaData[] = {
		{ "ModuleRelativePath", "Private/Evaluation/MovieSceneActorReferenceTemplate.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::NewProp_PropertyData = { "PropertyData", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneActorReferenceSectionTemplate, PropertyData), Z_Construct_UScriptStruct_FMovieScenePropertySectionData, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::NewProp_PropertyData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::NewProp_PropertyData_MetaData)) }; // 2296184579
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::NewProp_ActorReferenceData_MetaData[] = {
		{ "ModuleRelativePath", "Private/Evaluation/MovieSceneActorReferenceTemplate.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::NewProp_ActorReferenceData = { "ActorReferenceData", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneActorReferenceSectionTemplate, ActorReferenceData), Z_Construct_UScriptStruct_FMovieSceneActorReferenceData, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::NewProp_ActorReferenceData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::NewProp_ActorReferenceData_MetaData)) }; // 2092049221
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::Struct_MetaDataParams))
	};
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate()
	{
		...
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_MovieSceneActorReferenceSectionTemplate.InnerSingleton, Z_Construct_UScriptStruct_FMovieSceneActorReferenceSectionTemplate_Statics::ReturnStructParams);
		}
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneActorReferenceTemplate_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneActorReferenceTemplate_h_3750384002(TEXT("/Script/MovieSceneTracks"),
		nullptr, 0,
