...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneCameraCutTrack_Statics::NewProp_bCanBlend = { "bCanBlend", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneCameraCutTrack), &Z_Construct_UClass_UMovieSceneCameraCutTrack_Statics::NewProp_bCanBlend_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCameraCutTrack_Statics::NewProp_bCanBlend_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCameraCutTrack_Statics::NewProp_bCanBlend_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneCameraCutTrack_Statics::NewProp_Sections_Inner = { "Sections", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneCameraCutTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCameraCutTrack, UMovieSceneCameraCutTrack::StaticClass, TEXT("UMovieSceneCameraCutTrack"), &Z_Registration_Info_UClass_UMovieSceneCameraCutTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCameraCutTrack), 3754182185U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneCameraCutTrack_h_4279520740(TEXT("/Script/MovieSceneTracks"),
