...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMovieSceneFloatVectorTrack_Statics::NewProp_NumChannelsUsed = { "NumChannelsUsed", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneFloatVectorTrack, NumChannelsUsed), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFloatVectorTrack_Statics::NewProp_NumChannelsUsed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFloatVectorTrack_Statics::NewProp_NumChannelsUsed_MetaData)) };
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMovieSceneDoubleVectorTrack_Statics::NewProp_NumChannelsUsed = { "NumChannelsUsed", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneDoubleVectorTrack, NumChannelsUsed), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneDoubleVectorTrack_Statics::NewProp_NumChannelsUsed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDoubleVectorTrack_Statics::NewProp_NumChannelsUsed_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneVectorTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFloatVectorTrack, UMovieSceneFloatVectorTrack::StaticClass, TEXT("UMovieSceneFloatVectorTrack"), &Z_Registration_Info_UClass_UMovieSceneFloatVectorTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFloatVectorTrack), 1195153489U) },
		{ Z_Construct_UClass_UMovieSceneDoubleVectorTrack, UMovieSceneDoubleVectorTrack::StaticClass, TEXT("UMovieSceneDoubleVectorTrack"), &Z_Registration_Info_UClass_UMovieSceneDoubleVectorTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneDoubleVectorTrack), 3716934802U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneVectorTrack_h_3402523178(TEXT("/Script/MovieSceneTracks"),
