...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneAudioTrack_Statics::NewProp_AudioSections_Inner = { "AudioSections", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieSceneAudioTrack_Statics::NewProp_AudioSections = { "AudioSections", nullptr, (EPropertyFlags)0x0044008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneAudioTrack, AudioSections), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneAudioTrack_Statics::NewProp_AudioSections_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneAudioTrack_Statics::NewProp_AudioSections_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMovieSceneAudioTrack_Statics::NewProp_RowHeight = { "RowHeight", nullptr, (EPropertyFlags)0x0040000800000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneAudioTrack, RowHeight), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneAudioTrack_Statics::NewProp_RowHeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneAudioTrack_Statics::NewProp_RowHeight_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneAudioTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneAudioTrack, UMovieSceneAudioTrack::StaticClass, TEXT("UMovieSceneAudioTrack"), &Z_Registration_Info_UClass_UMovieSceneAudioTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneAudioTrack), 1911412333U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneAudioTrack_h_2067062630(TEXT("/Script/MovieSceneTracks"),
