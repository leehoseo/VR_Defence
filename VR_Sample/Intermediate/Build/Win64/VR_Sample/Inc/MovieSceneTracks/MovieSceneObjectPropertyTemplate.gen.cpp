...
class UScriptStruct* FMovieSceneObjectPropertyTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneObjectPropertyTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneObjectPropertyTemplate, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneObjectPropertyTemplate"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneObjectPropertyTemplate>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneObjectPropertyTemplate_Statics::NewProp_ObjectChannel = { "ObjectChannel", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneObjectPropertyTemplate, ObjectChannel), Z_Construct_UScriptStruct_FMovieSceneObjectPathChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneObjectPropertyTemplate_Statics::NewProp_ObjectChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneObjectPropertyTemplate_Statics::NewProp_ObjectChannel_MetaData)) }; // 774963505
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneObjectPropertyTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneObjectPropertyTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneObjectPropertyTemplate_Statics::NewStructOps, TEXT("MovieSceneObjectPropertyTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneObjectPropertyTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneObjectPropertyTemplate), 2773393593U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneObjectPropertyTemplate_h_1912768060(TEXT("/Script/MovieSceneTracks"),
		nullptr, 0,
