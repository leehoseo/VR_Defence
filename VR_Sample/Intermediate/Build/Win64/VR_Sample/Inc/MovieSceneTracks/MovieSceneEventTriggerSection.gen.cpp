...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneEventTriggerSection_Statics::NewProp_EventChannel = { "EventChannel", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneEventTriggerSection, EventChannel), Z_Construct_UScriptStruct_FMovieSceneEventChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEventTriggerSection_Statics::NewProp_EventChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEventTriggerSection_Statics::NewProp_EventChannel_MetaData)) }; // 1258584416
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventTriggerSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEventTriggerSection, UMovieSceneEventTriggerSection::StaticClass, TEXT("UMovieSceneEventTriggerSection"), &Z_Registration_Info_UClass_UMovieSceneEventTriggerSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEventTriggerSection), 1319845364U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventTriggerSection_h_3233411758(TEXT("/Script/MovieSceneTracks"),
