...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneObjectPropertySection_Statics::NewProp_ObjectChannel = { "ObjectChannel", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneObjectPropertySection, ObjectChannel), Z_Construct_UScriptStruct_FMovieSceneObjectPathChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneObjectPropertySection_Statics::NewProp_ObjectChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneObjectPropertySection_Statics::NewProp_ObjectChannel_MetaData)) }; // 774963505
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneObjectPropertySection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneObjectPropertySection, UMovieSceneObjectPropertySection::StaticClass, TEXT("UMovieSceneObjectPropertySection"), &Z_Registration_Info_UClass_UMovieSceneObjectPropertySection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneObjectPropertySection), 1615509320U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneObjectPropertySection_h_3308507904(TEXT("/Script/MovieSceneTracks"),
