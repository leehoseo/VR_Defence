...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneByteSection_Statics::NewProp_ByteCurve = { "ByteCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneByteSection, ByteCurve), Z_Construct_UScriptStruct_FMovieSceneByteChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneByteSection_Statics::NewProp_ByteCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneByteSection_Statics::NewProp_ByteCurve_MetaData)) }; // 2595108233
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneByteSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneByteSection, UMovieSceneByteSection::StaticClass, TEXT("UMovieSceneByteSection"), &Z_Registration_Info_UClass_UMovieSceneByteSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneByteSection), 2611538477U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneByteSection_h_2176764806(TEXT("/Script/MovieSceneTracks"),
