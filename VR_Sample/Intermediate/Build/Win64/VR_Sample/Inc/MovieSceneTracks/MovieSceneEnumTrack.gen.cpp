...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneEnumTrack_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneEnumTrack_Statics::NewProp_Enum_MetaData[] = {
		{ "ModuleRelativePath", "Public/Tracks/MovieSceneEnumTrack.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneEnumTrack_Statics::NewProp_Enum = { "Enum", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneEnumTrack, Enum), Z_Construct_UClass_UEnum, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEnumTrack_Statics::NewProp_Enum_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEnumTrack_Statics::NewProp_Enum_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneEnumTrack_Statics::ClassParams = {
		...
		0,
		0x00B000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEnumTrack_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEnumTrack_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneEnumTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEnumTrack, UMovieSceneEnumTrack::StaticClass, TEXT("UMovieSceneEnumTrack"), &Z_Registration_Info_UClass_UMovieSceneEnumTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEnumTrack), 936945733U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneEnumTrack_h_551904935(TEXT("/Script/MovieSceneTracks"),
