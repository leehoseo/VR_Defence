...
class UScriptStruct* FMovieSceneFloatVectorKeyStructBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneFloatVectorKeyStructBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneFloatVectorKeyStructBase, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneFloatVectorKeyStructBase"));
	}
...
class UScriptStruct* FMovieSceneVector2fKeyStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneVector2fKeyStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneVector2fKeyStruct, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneVector2fKeyStruct"));
	}
...
class UScriptStruct* FMovieSceneVector3fKeyStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneVector3fKeyStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneVector3fKeyStruct, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneVector3fKeyStruct"));
	}
...
class UScriptStruct* FMovieSceneVector4fKeyStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneVector4fKeyStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneVector4fKeyStruct, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneVector4fKeyStruct"));
	}
...
class UScriptStruct* FMovieSceneDoubleVectorKeyStructBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneDoubleVectorKeyStructBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneDoubleVectorKeyStructBase, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneDoubleVectorKeyStructBase"));
	}
...
class UScriptStruct* FMovieSceneVector2DKeyStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneVector2DKeyStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneVector2DKeyStruct, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneVector2DKeyStruct"));
	}
...
class UScriptStruct* FMovieSceneVector3dKeyStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneVector3dKeyStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneVector3dKeyStruct, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneVector3dKeyStruct"));
	}
...
class UScriptStruct* FMovieSceneVector4dKeyStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneVector4dKeyStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneVector4dKeyStruct, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneVector4dKeyStruct"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneVector4dKeyStruct>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneVector4dKeyStruct_Statics::NewProp_Vector = { "Vector", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneVector4dKeyStruct, Vector), Z_Construct_UScriptStruct_FVector4d, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneVector4dKeyStruct_Statics::NewProp_Vector_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneVector4dKeyStruct_Statics::NewProp_Vector_MetaData)) };
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMovieSceneFloatVectorSection_Statics::NewProp_ChannelsUsed = { "ChannelsUsed", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneFloatVectorSection, ChannelsUsed), METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFloatVectorSection_Statics::NewProp_ChannelsUsed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFloatVectorSection_Statics::NewProp_ChannelsUsed_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneVectorSection_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneFloatVectorKeyStructBase::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneFloatVectorKeyStructBase_Statics::NewStructOps, TEXT("MovieSceneFloatVectorKeyStructBase"), &Z_Registration_Info_UScriptStruct_MovieSceneFloatVectorKeyStructBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneFloatVectorKeyStructBase), 2465176971U) },
		{ FMovieSceneVector2fKeyStruct::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneVector2fKeyStruct_Statics::NewStructOps, TEXT("MovieSceneVector2fKeyStruct"), &Z_Registration_Info_UScriptStruct_MovieSceneVector2fKeyStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneVector2fKeyStruct), 2466839818U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneVectorSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFloatVectorSection, UMovieSceneFloatVectorSection::StaticClass, TEXT("UMovieSceneFloatVectorSection"), &Z_Registration_Info_UClass_UMovieSceneFloatVectorSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFloatVectorSection), 580927424U) },
		{ Z_Construct_UClass_UMovieSceneDoubleVectorSection, UMovieSceneDoubleVectorSection::StaticClass, TEXT("UMovieSceneDoubleVectorSection"), &Z_Registration_Info_UClass_UMovieSceneDoubleVectorSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneDoubleVectorSection), 2821709952U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneVectorSection_h_956253468(TEXT("/Script/MovieSceneTracks"),
