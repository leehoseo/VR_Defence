...
// End Cross Module References
	...
	static UEnum* EParticleKey_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EParticleKey.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MovieSceneTracks_EParticleKey, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("EParticleKey"));
		}
...
class UScriptStruct* FMovieSceneParticleChannel::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneParticleChannel.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneParticleChannel, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneParticleChannel"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneParticleChannel>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneParticleSection_Statics::NewProp_ParticleKeys = { "ParticleKeys", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneParticleSection, ParticleKeys), Z_Construct_UScriptStruct_FMovieSceneParticleChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneParticleSection_Statics::NewProp_ParticleKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneParticleSection_Statics::NewProp_ParticleKeys_MetaData)) }; // 2021007694
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneParticleSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneParticleSection, UMovieSceneParticleSection::StaticClass, TEXT("UMovieSceneParticleSection"), &Z_Registration_Info_UClass_UMovieSceneParticleSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneParticleSection), 1983266407U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneParticleSection_h_1946549846(TEXT("/Script/MovieSceneTracks"),
