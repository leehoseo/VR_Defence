...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneFloatPropertySystem_Statics::Class_MetaDataParams[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Systems_MovieSceneFloatPropertySystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFloatPropertySystem, UMovieSceneFloatPropertySystem::StaticClass, TEXT("UMovieSceneFloatPropertySystem"), &Z_Registration_Info_UClass_UMovieSceneFloatPropertySystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFloatPropertySystem), 153514880U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Systems_MovieSceneFloatPropertySystem_h_1262853469(TEXT("/Script/MovieSceneTracks"),
