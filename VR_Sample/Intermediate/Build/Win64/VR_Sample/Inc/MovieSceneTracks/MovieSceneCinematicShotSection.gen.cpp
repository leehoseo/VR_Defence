...
// End Cross Module References
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMovieSceneCinematicShotSection_GetShotDisplayName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneCinematicShotSection_eventGetShotDisplayName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneCinematicShotSection_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneCinematicShotSection_GetShotDisplayName, "GetShotDisplayName" }, // 2415225700
		{ &Z_Construct_UFunction_UMovieSceneCinematicShotSection_SetShotDisplayName, "SetShotDisplayName" }, // 3315694268
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCinematicShotSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCinematicShotSection, UMovieSceneCinematicShotSection::StaticClass, TEXT("UMovieSceneCinematicShotSection"), &Z_Registration_Info_UClass_UMovieSceneCinematicShotSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCinematicShotSection), 3455954453U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCinematicShotSection_h_3506967173(TEXT("/Script/MovieSceneTracks"),
