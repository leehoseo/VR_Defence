...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneCameraCutSection_GetCameraBindingID_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000008000582, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneCameraCutSection_eventGetCameraBindingID_Parms, ReturnValue), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneCameraCutSection_GetCameraBindingID_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneCameraCutSection_GetCameraBindingID_Statics::NewProp_ReturnValue_MetaData)) }; // 3055205823
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UMovieSceneCameraCutSection_SetCameraBindingID_Statics::NewProp_InCameraBindingID = { "InCameraBindingID", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MovieSceneCameraCutSection_eventSetCameraBindingID_Parms, InCameraBindingID), Z_Construct_UScriptStruct_FMovieSceneObjectBindingID, METADATA_PARAMS(Z_Construct_UFunction_UMovieSceneCameraCutSection_SetCameraBindingID_Statics::NewProp_InCameraBindingID_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UMovieSceneCameraCutSection_SetCameraBindingID_Statics::NewProp_InCameraBindingID_MetaData)) }; // 3055205823
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMovieSceneCameraCutSection_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMovieSceneCameraCutSection_GetCameraBindingID, "GetCameraBindingID" }, // 2830655862
		{ &Z_Construct_UFunction_UMovieSceneCameraCutSection_SetCameraBindingID, "SetCameraBindingID" }, // 4100828036
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneCameraCutSection_Statics::NewProp_bLockPreviousCamera = { "bLockPreviousCamera", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneCameraCutSection), &Z_Construct_UClass_UMovieSceneCameraCutSection_Statics::NewProp_bLockPreviousCamera_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCameraCutSection_Statics::NewProp_bLockPreviousCamera_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCameraCutSection_Statics::NewProp_bLockPreviousCamera_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneCameraCutSection_Statics::NewProp_bHasInitialCameraCutTransform = { "bHasInitialCameraCutTransform", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneCameraCutSection), &Z_Construct_UClass_UMovieSceneCameraCutSection_Statics::NewProp_bHasInitialCameraCutTransform_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCameraCutSection_Statics::NewProp_bHasInitialCameraCutTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCameraCutSection_Statics::NewProp_bHasInitialCameraCutTransform_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCameraCutSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCameraCutSection, UMovieSceneCameraCutSection::StaticClass, TEXT("UMovieSceneCameraCutSection"), &Z_Registration_Info_UClass_UMovieSceneCameraCutSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCameraCutSection), 2947575603U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCameraCutSection_h_960713981(TEXT("/Script/MovieSceneTracks"),
