...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneFloatVectorPropertySystem_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMovieSceneFloatVectorPropertySystem_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneFloatVectorPropertySystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFloatVectorPropertySystem_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFloatVectorPropertySystem_Statics::Class_MetaDataParams))
	};
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneDoubleVectorPropertySystem_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Systems/MovieSceneVectorPropertySystem.h" },
		{ "ModuleRelativePath", "Public/Systems/MovieSceneVectorPropertySystem.h" },
		{ "ObjectInitializerConstructorDeclared", "" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMovieSceneDoubleVectorPropertySystem_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneDoubleVectorPropertySystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneDoubleVectorPropertySystem_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDoubleVectorPropertySystem_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Systems_MovieSceneVectorPropertySystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFloatVectorPropertySystem, UMovieSceneFloatVectorPropertySystem::StaticClass, TEXT("UMovieSceneFloatVectorPropertySystem"), &Z_Registration_Info_UClass_UMovieSceneFloatVectorPropertySystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFloatVectorPropertySystem), 2711095430U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Systems_MovieSceneVectorPropertySystem_h_1550761359(TEXT("/Script/MovieSceneTracks"),
