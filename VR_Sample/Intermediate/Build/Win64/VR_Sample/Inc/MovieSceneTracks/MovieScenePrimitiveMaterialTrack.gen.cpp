...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UMovieScenePrimitiveMaterialTrack_Statics::NewProp_MaterialIndex = { "MaterialIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieScenePrimitiveMaterialTrack, MaterialIndex), METADATA_PARAMS(Z_Construct_UClass_UMovieScenePrimitiveMaterialTrack_Statics::NewProp_MaterialIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScenePrimitiveMaterialTrack_Statics::NewProp_MaterialIndex_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieScenePrimitiveMaterialTrack_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieScenePrimitiveMaterialTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieScenePrimitiveMaterialTrack, IMovieSceneTrackTemplateProducer), false },  // 2931163055
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieScenePrimitiveMaterialTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieScenePrimitiveMaterialTrack, UMovieScenePrimitiveMaterialTrack::StaticClass, TEXT("UMovieScenePrimitiveMaterialTrack"), &Z_Registration_Info_UClass_UMovieScenePrimitiveMaterialTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieScenePrimitiveMaterialTrack), 2311256513U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieScenePrimitiveMaterialTrack_h_4178602371(TEXT("/Script/MovieSceneTracks"),
