...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneStringSection_Statics::NewProp_StringCurve = { "StringCurve", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneStringSection, StringCurve), Z_Construct_UScriptStruct_FMovieSceneStringChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneStringSection_Statics::NewProp_StringCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneStringSection_Statics::NewProp_StringCurve_MetaData)) }; // 3322980286
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneStringSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneStringSection, UMovieSceneStringSection::StaticClass, TEXT("UMovieSceneStringSection"), &Z_Registration_Info_UClass_UMovieSceneStringSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneStringSection), 3967552069U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneStringSection_h_2531178470(TEXT("/Script/MovieSceneTracks"),
