...
#include "MovieSceneTracks/Public/Sections/MovieSceneDoubleSection.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneDoubleSection_Statics::NewProp_DoubleCurve = { "DoubleCurve", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneDoubleSection, DoubleCurve), Z_Construct_UScriptStruct_FMovieSceneDoubleChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneDoubleSection_Statics::NewProp_DoubleCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneDoubleSection_Statics::NewProp_DoubleCurve_MetaData)) }; // 3037015805
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneDoubleSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneDoubleSection, UMovieSceneDoubleSection::StaticClass, TEXT("UMovieSceneDoubleSection"), &Z_Registration_Info_UClass_UMovieSceneDoubleSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneDoubleSection), 4122362463U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneDoubleSection_h_4112962259(TEXT("/Script/MovieSceneTracks"),
