...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneEventRepeaterSection_Statics::NewProp_Event = { "Event", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneEventRepeaterSection, Event), Z_Construct_UScriptStruct_FMovieSceneEvent, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEventRepeaterSection_Statics::NewProp_Event_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEventRepeaterSection_Statics::NewProp_Event_MetaData)) }; // 56673498
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventRepeaterSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEventRepeaterSection, UMovieSceneEventRepeaterSection::StaticClass, TEXT("UMovieSceneEventRepeaterSection"), &Z_Registration_Info_UClass_UMovieSceneEventRepeaterSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEventRepeaterSection), 1450910450U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventRepeaterSection_h_2997384984(TEXT("/Script/MovieSceneTracks"),
