...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneCameraShakeSourceShakeSection_Statics::Class_MetaDataParams[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCameraShakeSourceShakeSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCameraShakeSourceShakeSection, UMovieSceneCameraShakeSourceShakeSection::StaticClass, TEXT("UMovieSceneCameraShakeSourceShakeSection"), &Z_Registration_Info_UClass_UMovieSceneCameraShakeSourceShakeSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCameraShakeSourceShakeSection), 3781481454U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCameraShakeSourceShakeSection_h_1964561294(TEXT("/Script/MovieSceneTracks"),
