...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPtrPropertyParams Z_Construct_UClass_UMovieSceneObjectPropertyTrack_Statics::NewProp_PropertyClass = { "PropertyClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneObjectPropertyTrack, PropertyClass), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneObjectPropertyTrack_Statics::NewProp_PropertyClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneObjectPropertyTrack_Statics::NewProp_PropertyClass_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneObjectPropertyTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneObjectPropertyTrack, UMovieSceneObjectPropertyTrack::StaticClass, TEXT("UMovieSceneObjectPropertyTrack"), &Z_Registration_Info_UClass_UMovieSceneObjectPropertyTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneObjectPropertyTrack), 3086306597U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneObjectPropertyTrack_h_2777927014(TEXT("/Script/MovieSceneTracks"),
