...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneFloatTrack_Statics::Class_MetaDataParams[] = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMovieSceneFloatTrack_Statics::ClassParams = {
		...
		0,
		0x00A800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMovieSceneFloatTrack_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneFloatTrack_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneFloatTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFloatTrack, UMovieSceneFloatTrack::StaticClass, TEXT("UMovieSceneFloatTrack"), &Z_Registration_Info_UClass_UMovieSceneFloatTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFloatTrack), 2365098367U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneFloatTrack_h_2604094972(TEXT("/Script/MovieSceneTracks"),
