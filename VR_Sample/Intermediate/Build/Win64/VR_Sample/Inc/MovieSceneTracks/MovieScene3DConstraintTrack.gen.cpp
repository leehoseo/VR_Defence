...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::NewProp_ConstraintSections_Inner = { "ConstraintSections", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::NewProp_ConstraintSections = { "ConstraintSections", nullptr, (EPropertyFlags)0x0024088000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieScene3DConstraintTrack, ConstraintSections), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::NewProp_ConstraintSections_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieScene3DConstraintTrack_Statics::NewProp_ConstraintSections_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieScene3DConstraintTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieScene3DConstraintTrack, UMovieScene3DConstraintTrack::StaticClass, TEXT("UMovieScene3DConstraintTrack"), &Z_Registration_Info_UClass_UMovieScene3DConstraintTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieScene3DConstraintTrack), 567644254U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieScene3DConstraintTrack_h_931430249(TEXT("/Script/MovieSceneTracks"),
