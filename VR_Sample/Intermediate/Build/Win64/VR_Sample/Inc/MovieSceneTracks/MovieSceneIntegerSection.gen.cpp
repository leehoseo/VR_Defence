...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneIntegerSection_Statics::NewProp_IntegerCurve = { "IntegerCurve", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneIntegerSection, IntegerCurve), Z_Construct_UScriptStruct_FMovieSceneIntegerChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneIntegerSection_Statics::NewProp_IntegerCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneIntegerSection_Statics::NewProp_IntegerCurve_MetaData)) }; // 2908704837
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneIntegerSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneIntegerSection, UMovieSceneIntegerSection::StaticClass, TEXT("UMovieSceneIntegerSection"), &Z_Registration_Info_UClass_UMovieSceneIntegerSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneIntegerSection), 1212918966U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneIntegerSection_h_4017155664(TEXT("/Script/MovieSceneTracks"),
