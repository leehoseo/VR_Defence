...
class UScriptStruct* FMovieSceneEventTriggerData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEventTriggerData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEventTriggerData, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneEventTriggerData"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneEventTriggerData>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventTriggerData_Statics::NewProp_Ptrs = { "Ptrs", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEventTriggerData, Ptrs), Z_Construct_UScriptStruct_FMovieSceneEventPtrs, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEventTriggerData_Statics::NewProp_Ptrs_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEventTriggerData_Statics::NewProp_Ptrs_MetaData)) }; // 818056346
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventTriggerData_Statics::NewProp_ObjectBindingID = { "ObjectBindingID", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEventTriggerData, ObjectBindingID), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEventTriggerData_Statics::NewProp_ObjectBindingID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEventTriggerData_Statics::NewProp_ObjectBindingID_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Systems_MovieSceneEventSystems_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEventSystem, UMovieSceneEventSystem::StaticClass, TEXT("UMovieSceneEventSystem"), &Z_Registration_Info_UClass_UMovieSceneEventSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEventSystem), 1953105725U) },
		{ Z_Construct_UClass_UMovieScenePreSpawnEventSystem, UMovieScenePreSpawnEventSystem::StaticClass, TEXT("UMovieScenePreSpawnEventSystem"), &Z_Registration_Info_UClass_UMovieScenePreSpawnEventSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieScenePreSpawnEventSystem), 2662902031U) },
		{ Z_Construct_UClass_UMovieScenePostSpawnEventSystem, UMovieScenePostSpawnEventSystem::StaticClass, TEXT("UMovieScenePostSpawnEventSystem"), &Z_Registration_Info_UClass_UMovieScenePostSpawnEventSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieScenePostSpawnEventSystem), 3942591241U) },
		{ Z_Construct_UClass_UMovieScenePostEvalEventSystem, UMovieScenePostEvalEventSystem::StaticClass, TEXT("UMovieScenePostEvalEventSystem"), &Z_Registration_Info_UClass_UMovieScenePostEvalEventSystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieScenePostEvalEventSystem), 1499528760U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Systems_MovieSceneEventSystems_h_3519582233(TEXT("/Script/MovieSceneTracks"),
