...
class UScriptStruct* FMovieSceneSlomoSectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneSlomoSectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneSlomoSectionTemplate, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneSlomoSectionTemplate"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneSlomoSectionTemplate>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneSlomoSectionTemplate_Statics::NewProp_SlomoCurve = { "SlomoCurve", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneSlomoSectionTemplate, SlomoCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneSlomoSectionTemplate_Statics::NewProp_SlomoCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneSlomoSectionTemplate_Statics::NewProp_SlomoCurve_MetaData)) }; // 312122321
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneSlomoTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneSlomoSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneSlomoSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneSlomoSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneSlomoSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneSlomoSectionTemplate), 3508518672U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneSlomoTemplate_h_3941623511(TEXT("/Script/MovieSceneTracks"),
		nullptr, 0,
