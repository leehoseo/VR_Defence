...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneCameraShakeSourceTriggerSection_Statics::NewProp_Channel = { "Channel", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneCameraShakeSourceTriggerSection, Channel), Z_Construct_UScriptStruct_FMovieSceneCameraShakeSourceTriggerChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneCameraShakeSourceTriggerSection_Statics::NewProp_Channel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneCameraShakeSourceTriggerSection_Statics::NewProp_Channel_MetaData)) }; // 3479642941
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCameraShakeSourceTriggerSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneCameraShakeSourceTriggerSection, UMovieSceneCameraShakeSourceTriggerSection::StaticClass, TEXT("UMovieSceneCameraShakeSourceTriggerSection"), &Z_Registration_Info_UClass_UMovieSceneCameraShakeSourceTriggerSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneCameraShakeSourceTriggerSection), 2915675324U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneCameraShakeSourceTriggerSection_h_569954457(TEXT("/Script/MovieSceneTracks"),
