...
class UScriptStruct* FMovieSceneCameraShakeSourceTriggerSectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneCameraShakeSourceTriggerSectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneCameraShakeSourceTriggerSectionTemplate, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneCameraShakeSourceTriggerSectionTemplate"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneCameraShakeSourceTriggerSectionTemplate>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneCameraShakeSourceTriggerSectionTemplate_Statics::NewProp_TriggerTimes_Inner = { "TriggerTimes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneCameraShakeSourceTriggerTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneCameraShakeSourceTriggerSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneCameraShakeSourceTriggerSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneCameraShakeSourceTriggerSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneCameraShakeSourceTriggerSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneCameraShakeSourceTriggerSectionTemplate), 3049761018U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneCameraShakeSourceTriggerTemplate_h_3359262887(TEXT("/Script/MovieSceneTracks"),
		nullptr, 0,
