...
class UScriptStruct* FMovieSceneSkeletalAnimRootMotionTrackParams::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneSkeletalAnimRootMotionTrackParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneSkeletalAnimRootMotionTrackParams, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneSkeletalAnimRootMotionTrackParams"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneSkeletalAnimRootMotionTrackParams>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_AnimationSections_Inner = { "AnimationSections", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bUseLegacySectionIndexBlend = { "bUseLegacySectionIndexBlend", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneSkeletalAnimationTrack), &Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bUseLegacySectionIndexBlend_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bUseLegacySectionIndexBlend_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bUseLegacySectionIndexBlend_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_RootMotionParams = { "RootMotionParams", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneSkeletalAnimationTrack, RootMotionParams), Z_Construct_UScriptStruct_FMovieSceneSkeletalAnimRootMotionTrackParams, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_RootMotionParams_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_RootMotionParams_MetaData)) }; // 63368516
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bBlendFirstChildOfRoot = { "bBlendFirstChildOfRoot", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneSkeletalAnimationTrack), &Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bBlendFirstChildOfRoot_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bBlendFirstChildOfRoot_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bBlendFirstChildOfRoot_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bShowRootMotionTrail = { "bShowRootMotionTrail", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UMovieSceneSkeletalAnimationTrack), &Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bShowRootMotionTrail_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bShowRootMotionTrail_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::NewProp_bShowRootMotionTrail_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneSkeletalAnimationTrack, IMovieSceneTrackTemplateProducer), false },  // 2931163055
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneSkeletalAnimationTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneSkeletalAnimationTrack, UMovieSceneSkeletalAnimationTrack::StaticClass, TEXT("UMovieSceneSkeletalAnimationTrack"), &Z_Registration_Info_UClass_UMovieSceneSkeletalAnimationTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneSkeletalAnimationTrack), 2402109658U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneSkeletalAnimationTrack_h_3408497303(TEXT("/Script/MovieSceneTracks"),
