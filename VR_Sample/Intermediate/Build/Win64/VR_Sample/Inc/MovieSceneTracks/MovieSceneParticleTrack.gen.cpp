...
// End Cross Module References
...
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_ParticleSections_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ParticleSections_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneParticleTrack_Statics::Class_MetaDataParams[] = {
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMovieSceneParticleTrack_Statics::NewProp_ParticleSections_Inner = { "ParticleSections", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UMovieSceneSection_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneParticleTrack_Statics::NewProp_ParticleSections_MetaData[] = {
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMovieSceneParticleTrack_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneParticleTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneParticleTrack, IMovieSceneTrackTemplateProducer), false },  // 2931163055
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneParticleTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneParticleTrack, UMovieSceneParticleTrack::StaticClass, TEXT("UMovieSceneParticleTrack"), &Z_Registration_Info_UClass_UMovieSceneParticleTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneParticleTrack), 2145454748U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneParticleTrack_h_324320984(TEXT("/Script/MovieSceneTracks"),
