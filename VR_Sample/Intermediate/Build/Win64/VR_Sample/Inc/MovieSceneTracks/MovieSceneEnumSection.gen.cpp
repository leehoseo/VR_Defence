...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneEnumSection_Statics::NewProp_EnumCurve = { "EnumCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneEnumSection, EnumCurve), Z_Construct_UScriptStruct_FMovieSceneByteChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEnumSection_Statics::NewProp_EnumCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEnumSection_Statics::NewProp_EnumCurve_MetaData)) }; // 2595108233
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEnumSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEnumSection, UMovieSceneEnumSection::StaticClass, TEXT("UMovieSceneEnumSection"), &Z_Registration_Info_UClass_UMovieSceneEnumSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEnumSection), 2040942933U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEnumSection_h_1578007359(TEXT("/Script/MovieSceneTracks"),
