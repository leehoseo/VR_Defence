...
class UScriptStruct* FMovieSceneColorKeyStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneColorKeyStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneColorKeyStruct, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneColorKeyStruct"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneColorKeyStruct>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_RedCurve = { "RedCurve", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneColorSection, RedCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_RedCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_RedCurve_MetaData)) }; // 312122321
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_GreenCurve = { "GreenCurve", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneColorSection, GreenCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_GreenCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_GreenCurve_MetaData)) }; // 312122321
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_BlueCurve = { "BlueCurve", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneColorSection, BlueCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_BlueCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_BlueCurve_MetaData)) }; // 312122321
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_AlphaCurve = { "AlphaCurve", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneColorSection, AlphaCurve), Z_Construct_UScriptStruct_FMovieSceneFloatChannel, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_AlphaCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneColorSection_Statics::NewProp_AlphaCurve_MetaData)) }; // 312122321
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneColorSection_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneColorKeyStruct::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneColorKeyStruct_Statics::NewStructOps, TEXT("MovieSceneColorKeyStruct"), &Z_Registration_Info_UScriptStruct_MovieSceneColorKeyStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneColorKeyStruct), 2121948694U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneColorSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneColorSection, UMovieSceneColorSection::StaticClass, TEXT("UMovieSceneColorSection"), &Z_Registration_Info_UClass_UMovieSceneColorSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneColorSection), 2370313180U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneColorSection_h_1075137661(TEXT("/Script/MovieSceneTracks"),
