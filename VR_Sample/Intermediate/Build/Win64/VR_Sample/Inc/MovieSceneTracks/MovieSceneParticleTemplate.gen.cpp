...
class UScriptStruct* FMovieSceneParticleSectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneParticleSectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneParticleSectionTemplate, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneParticleSectionTemplate"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneParticleSectionTemplate>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneParticleTemplate_h_Statics::ScriptStructInfo[] = {
		{ FMovieSceneParticleSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneParticleSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneParticleSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneParticleSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneParticleSectionTemplate), 1354787366U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Private_Evaluation_MovieSceneParticleTemplate_h_2008315743(TEXT("/Script/MovieSceneTracks"),
		nullptr, 0,
