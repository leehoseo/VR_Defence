...
class UScriptStruct* FMovieSceneEventParameters::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEventParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEventParameters, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneEventParameters"));
	}
...
class UScriptStruct* FEventPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EventPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEventPayload, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("EventPayload"));
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FEventPayload_Statics::NewProp_EventName = { "EventName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEventPayload, EventName), METADATA_PARAMS(Z_Construct_UScriptStruct_FEventPayload_Statics::NewProp_EventName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEventPayload_Statics::NewProp_EventName_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FMovieSceneEventSectionData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneEventSectionData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneEventSectionData, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("MovieSceneEventSectionData"));
	}
...
template<> MOVIESCENETRACKS_API UScriptStruct* StaticStruct<FMovieSceneEventSectionData>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_Times_Inner = { "Times", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FFrameNumber, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_Times = { "Times", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEventSectionData, Times), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_Times_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_Times_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyValues_Inner = { "KeyValues", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FEventPayload, METADATA_PARAMS(nullptr, 0) }; // 3577796598
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyValues = { "KeyValues", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEventSectionData, KeyValues), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyValues_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyValues_MetaData)) }; // 3577796598
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyTimes_Inner = { "KeyTimes", nullptr, (EPropertyFlags)0x0000000820000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyTimes = { "KeyTimes", nullptr, (EPropertyFlags)0x0040000820000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMovieSceneEventSectionData, KeyTimes_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyTimes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMovieSceneEventSectionData_Statics::NewProp_KeyTimes_MetaData)) };
#endif // WITH_EDITORONLY_DATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneEventSection_Statics::NewProp_Events = { "Events", nullptr, (EPropertyFlags)0x0040000020000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneEventSection, Events_DEPRECATED), Z_Construct_UScriptStruct_FNameCurve, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEventSection_Statics::NewProp_Events_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEventSection_Statics::NewProp_Events_MetaData)) }; // 2925496209
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMovieSceneEventSection_Statics::NewProp_EventData_MetaData[] = {
		{ "ModuleRelativePath", "Public/Sections/MovieSceneEventSection.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMovieSceneEventSection_Statics::NewProp_EventData = { "EventData", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMovieSceneEventSection, EventData), Z_Construct_UScriptStruct_FMovieSceneEventSectionData, METADATA_PARAMS(Z_Construct_UClass_UMovieSceneEventSection_Statics::NewProp_EventData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMovieSceneEventSection_Statics::NewProp_EventData_MetaData)) }; // 3213310525
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventSection_h_Statics::ScriptStructInfo[] = {
		...
		{ FEventPayload::StaticStruct, Z_Construct_UScriptStruct_FEventPayload_Statics::NewStructOps, TEXT("EventPayload"), &Z_Registration_Info_UScriptStruct_EventPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEventPayload), 3577796598U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventSection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEventSection, UMovieSceneEventSection::StaticClass, TEXT("UMovieSceneEventSection"), &Z_Registration_Info_UClass_UMovieSceneEventSection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEventSection), 534235762U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Sections_MovieSceneEventSection_h_377802991(TEXT("/Script/MovieSceneTracks"),
