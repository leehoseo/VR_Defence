...
// End Cross Module References
	...
	static UEnum* EFireEventsAtPosition_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EFireEventsAtPosition.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_MovieSceneTracks_EFireEventsAtPosition, Z_Construct_UPackage__Script_MovieSceneTracks(), TEXT("EFireEventsAtPosition"));
		}
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMovieSceneEventTrack_Statics::NewProp_EventPosition_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneEventTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneEventTrack, UMovieSceneEventTrack::StaticClass, TEXT("UMovieSceneEventTrack"), &Z_Registration_Info_UClass_UMovieSceneEventTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneEventTrack), 2041642567U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneEventTrack_h_1256772673(TEXT("/Script/MovieSceneTracks"),
