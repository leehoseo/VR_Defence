...
// End Cross Module References
...
#endif
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UMovieSceneFadeTrack_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UMovieSceneTrackTemplateProducer_NoRegister, (int32)VTABLE_OFFSET(UMovieSceneFadeTrack, IMovieSceneTrackTemplateProducer), false },  // 2931163055
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneFadeTrack_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMovieSceneFadeTrack, UMovieSceneFadeTrack::StaticClass, TEXT("UMovieSceneFadeTrack"), &Z_Registration_Info_UClass_UMovieSceneFadeTrack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMovieSceneFadeTrack), 1190356628U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_MovieSceneTracks_Public_Tracks_MovieSceneFadeTrack_h_2942005337(TEXT("/Script/MovieSceneTracks"),
