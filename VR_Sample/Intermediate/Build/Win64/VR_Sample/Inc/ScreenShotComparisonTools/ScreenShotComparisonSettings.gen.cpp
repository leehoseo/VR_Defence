...
class UScriptStruct* FScreenshotFallbackEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ScreenshotFallbackEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FScreenshotFallbackEntry, Z_Construct_UPackage__Script_ScreenShotComparisonTools(), TEXT("ScreenshotFallbackEntry"));
	}
...
template<> SCREENSHOTCOMPARISONTOOLS_API UScriptStruct* StaticStruct<FScreenshotFallbackEntry>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FScreenshotFallbackEntry_Statics::NewProp_Parent = { "Parent", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FScreenshotFallbackEntry, Parent), METADATA_PARAMS(Z_Construct_UScriptStruct_FScreenshotFallbackEntry_Statics::NewProp_Parent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenshotFallbackEntry_Statics::NewProp_Parent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FScreenshotFallbackEntry_Statics::NewProp_Child = { "Child", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FScreenshotFallbackEntry, Child), METADATA_PARAMS(Z_Construct_UScriptStruct_FScreenshotFallbackEntry_Statics::NewProp_Child_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FScreenshotFallbackEntry_Statics::NewProp_Child_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UScreenShotComparisonSettings_Statics::NewProp_bUseConfidentialPlatformPathsForSavedResults = { "bUseConfidentialPlatformPathsForSavedResults", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UScreenShotComparisonSettings), &Z_Construct_UClass_UScreenShotComparisonSettings_Statics::NewProp_bUseConfidentialPlatformPathsForSavedResults_SetBit, METADATA_PARAMS(Z_Construct_UClass_UScreenShotComparisonSettings_Statics::NewProp_bUseConfidentialPlatformPathsForSavedResults_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UScreenShotComparisonSettings_Statics::NewProp_bUseConfidentialPlatformPathsForSavedResults_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UScreenShotComparisonSettings_Statics::NewProp_ScreenshotFallbackPlatforms_Inner = { "ScreenshotFallbackPlatforms", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FScreenshotFallbackEntry, METADATA_PARAMS(nullptr, 0) }; // 679447212
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UScreenShotComparisonSettings_Statics::NewProp_ScreenshotFallbackPlatforms = { "ScreenshotFallbackPlatforms", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UScreenShotComparisonSettings, ScreenshotFallbackPlatforms), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UScreenShotComparisonSettings_Statics::NewProp_ScreenshotFallbackPlatforms_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UScreenShotComparisonSettings_Statics::NewProp_ScreenshotFallbackPlatforms_MetaData)) }; // 679447212
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_ScreenShotComparisonTools_Public_ScreenShotComparisonSettings_h_Statics::ScriptStructInfo[] = {
		{ FScreenshotFallbackEntry::StaticStruct, Z_Construct_UScriptStruct_FScreenshotFallbackEntry_Statics::NewStructOps, TEXT("ScreenshotFallbackEntry"), &Z_Registration_Info_UScriptStruct_ScreenshotFallbackEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FScreenshotFallbackEntry), 679447212U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_ScreenShotComparisonTools_Public_ScreenShotComparisonSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UScreenShotComparisonSettings, UScreenShotComparisonSettings::StaticClass, TEXT("UScreenShotComparisonSettings"), &Z_Registration_Info_UClass_UScreenShotComparisonSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UScreenShotComparisonSettings), 2054064595U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Developer_ScreenShotComparisonTools_Public_ScreenShotComparisonSettings_h_4109454661(TEXT("/Script/ScreenShotComparisonTools"),
