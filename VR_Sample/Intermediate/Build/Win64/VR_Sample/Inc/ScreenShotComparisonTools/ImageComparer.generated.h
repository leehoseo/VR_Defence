...
#define FID_Engine_Source_Developer_ScreenShotComparisonTools_Public_ImageComparer_h_19_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FImageTolerance_Statics; \
	static class UScriptStruct* StaticStruct();


template<> SCREENSHOTCOMPARISONTOOLS_API UScriptStruct* StaticStruct<struct FImageTolerance>();

#define FID_Engine_Source_Developer_ScreenShotComparisonTools_Public_ImageComparer_h_183_GENERATED_BODY \
...
template<> SCREENSHOTCOMPARISONTOOLS_API UScriptStruct* StaticStruct<struct FImageComparisonResult>();
