...
template<> CHAOS_API UScriptStruct* StaticStruct<struct FSolverTrailingFilterSettings>();
...
template<> CHAOS_API UScriptStruct* StaticStruct<struct FSolverCollisionFilterSettings>();
...
template<> CHAOS_API UScriptStruct* StaticStruct<struct FSolverBreakingFilterSettings>();
...
template<> CHAOS_API UScriptStruct* StaticStruct<struct FSolverRemovalFilterSettings>();
