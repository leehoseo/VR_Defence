...
// End Cross Module References
	...
	static UEnum* EActorSequenceObjectReferenceType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EActorSequenceObjectReferenceType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ActorSequence_EActorSequenceObjectReferenceType, Z_Construct_UPackage__Script_ActorSequence(), TEXT("EActorSequenceObjectReferenceType"));
		}
...
class UScriptStruct* FActorSequenceObjectReference::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorSequenceObjectReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorSequenceObjectReference, Z_Construct_UPackage__Script_ActorSequence(), TEXT("ActorSequenceObjectReference"));
	}
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FActorSequenceObjectReference_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActorSequenceObjectReference, Type), Z_Construct_UEnum_ActorSequence_EActorSequenceObjectReferenceType, METADATA_PARAMS(Z_Construct_UScriptStruct_FActorSequenceObjectReference_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorSequenceObjectReference_Statics::NewProp_Type_MetaData)) }; // 2547313720
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FActorSequenceObjectReference_Statics::NewProp_ActorId = { "ActorId", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActorSequenceObjectReference, ActorId), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FActorSequenceObjectReference_Statics::NewProp_ActorId_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorSequenceObjectReference_Statics::NewProp_ActorId_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FActorSequenceObjectReferences::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorSequenceObjectReferences.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorSequenceObjectReferences, Z_Construct_UPackage__Script_ActorSequence(), TEXT("ActorSequenceObjectReferences"));
	}
...
template<> ACTORSEQUENCE_API UScriptStruct* StaticStruct<FActorSequenceObjectReferences>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FActorSequenceObjectReferences_Statics::NewProp_Array_Inner = { "Array", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FActorSequenceObjectReference, METADATA_PARAMS(nullptr, 0) }; // 3521494817
#if WITH_METADATA
...
class UScriptStruct* FActorSequenceObjectReferenceMap::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorSequenceObjectReferenceMap.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap, Z_Construct_UPackage__Script_ActorSequence(), TEXT("ActorSequenceObjectReferenceMap"));
	}
...
template<> ACTORSEQUENCE_API UScriptStruct* StaticStruct<FActorSequenceObjectReferenceMap>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap_Statics::NewProp_BindingIds_Inner = { "BindingIds", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap_Statics::NewProp_BindingIds = { "BindingIds", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActorSequenceObjectReferenceMap, BindingIds), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap_Statics::NewProp_BindingIds_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap_Statics::NewProp_BindingIds_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap_Statics::NewProp_References_Inner = { "References", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FActorSequenceObjectReferences, METADATA_PARAMS(nullptr, 0) }; // 2880751716
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap_Statics::NewProp_References = { "References", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActorSequenceObjectReferenceMap, References), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap_Statics::NewProp_References_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap_Statics::NewProp_References_MetaData)) }; // 2880751716
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_ActorSequence_Source_ActorSequence_Public_ActorSequenceObjectReference_h_Statics::ScriptStructInfo[] = {
		...
		{ FActorSequenceObjectReferenceMap::StaticStruct, Z_Construct_UScriptStruct_FActorSequenceObjectReferenceMap_Statics::NewStructOps, TEXT("ActorSequenceObjectReferenceMap"), &Z_Registration_Info_UScriptStruct_ActorSequenceObjectReferenceMap, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FActorSequenceObjectReferenceMap), 2294047778U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_MovieScene_ActorSequence_Source_ActorSequence_Public_ActorSequenceObjectReference_h_4167358534(TEXT("/Script/ActorSequence"),
		nullptr, 0,
