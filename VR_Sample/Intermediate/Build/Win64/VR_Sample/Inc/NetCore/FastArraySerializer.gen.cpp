...
class UScriptStruct* FFastArraySerializerItem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FastArraySerializerItem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFastArraySerializerItem, Z_Construct_UPackage__Script_NetCore(), TEXT("FastArraySerializerItem"));
	}
...
template<> NETCORE_API UScriptStruct* StaticStruct<FFastArraySerializerItem>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FFastArraySerializerItem_Statics::NewProp_ReplicationID = { "ReplicationID", nullptr, (EPropertyFlags)0x0010000080000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFastArraySerializerItem, ReplicationID), METADATA_PARAMS(Z_Construct_UScriptStruct_FFastArraySerializerItem_Statics::NewProp_ReplicationID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFastArraySerializerItem_Statics::NewProp_ReplicationID_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FFastArraySerializerItem_Statics::NewProp_ReplicationKey = { "ReplicationKey", nullptr, (EPropertyFlags)0x0010000080000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFastArraySerializerItem, ReplicationKey), METADATA_PARAMS(Z_Construct_UScriptStruct_FFastArraySerializerItem_Statics::NewProp_ReplicationKey_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFastArraySerializerItem_Statics::NewProp_ReplicationKey_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FFastArraySerializerItem_Statics::NewProp_MostRecentArrayReplicationKey = { "MostRecentArrayReplicationKey", nullptr, (EPropertyFlags)0x0010000080000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFastArraySerializerItem, MostRecentArrayReplicationKey), METADATA_PARAMS(Z_Construct_UScriptStruct_FFastArraySerializerItem_Statics::NewProp_MostRecentArrayReplicationKey_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFastArraySerializerItem_Statics::NewProp_MostRecentArrayReplicationKey_MetaData)) };
	...
	static UEnum* EFastArraySerializerDeltaFlags_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EFastArraySerializerDeltaFlags.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_NetCore_EFastArraySerializerDeltaFlags, Z_Construct_UPackage__Script_NetCore(), TEXT("EFastArraySerializerDeltaFlags"));
		}
...
class UScriptStruct* FFastArraySerializer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FastArraySerializer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFastArraySerializer, Z_Construct_UPackage__Script_NetCore(), TEXT("FastArraySerializer"));
	}
...
template<> NETCORE_API UScriptStruct* StaticStruct<FFastArraySerializer>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FFastArraySerializer_Statics::NewProp_ArrayReplicationKey = { "ArrayReplicationKey", nullptr, (EPropertyFlags)0x0010000080000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFastArraySerializer, ArrayReplicationKey), METADATA_PARAMS(Z_Construct_UScriptStruct_FFastArraySerializer_Statics::NewProp_ArrayReplicationKey_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFastArraySerializer_Statics::NewProp_ArrayReplicationKey_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FFastArraySerializer_Statics::NewProp_DeltaFlags_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FFastArraySerializer_Statics::NewProp_DeltaFlags = { "DeltaFlags", nullptr, (EPropertyFlags)0x0040000080002000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFastArraySerializer, DeltaFlags), Z_Construct_UEnum_NetCore_EFastArraySerializerDeltaFlags, METADATA_PARAMS(Z_Construct_UScriptStruct_FFastArraySerializer_Statics::NewProp_DeltaFlags_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFastArraySerializer_Statics::NewProp_DeltaFlags_MetaData)) }; // 4213941022
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Classes_Net_Serialization_FastArraySerializer_h_Statics::ScriptStructInfo[] = {
		{ FFastArraySerializerItem::StaticStruct, Z_Construct_UScriptStruct_FFastArraySerializerItem_Statics::NewStructOps, TEXT("FastArraySerializerItem"), &Z_Registration_Info_UScriptStruct_FastArraySerializerItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFastArraySerializerItem), 1122850367U) },
		{ FFastArraySerializer::StaticStruct, Z_Construct_UScriptStruct_FFastArraySerializer_Statics::NewStructOps, TEXT("FastArraySerializer"), &Z_Registration_Info_UScriptStruct_FastArraySerializer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFastArraySerializer), 4021463263U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Classes_Net_Serialization_FastArraySerializer_h_4032944187(TEXT("/Script/NetCore"),
		nullptr, 0,
