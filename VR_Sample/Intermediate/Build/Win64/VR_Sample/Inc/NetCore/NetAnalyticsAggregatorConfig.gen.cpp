...
class UScriptStruct* FNetAnalyticsDataConfig::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NetAnalyticsDataConfig.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNetAnalyticsDataConfig, Z_Construct_UPackage__Script_NetCore(), TEXT("NetAnalyticsDataConfig"));
	}
...
template<> NETCORE_API UScriptStruct* StaticStruct<FNetAnalyticsDataConfig>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNetAnalyticsDataConfig_Statics::NewProp_DataName = { "DataName", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNetAnalyticsDataConfig, DataName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNetAnalyticsDataConfig_Statics::NewProp_DataName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetAnalyticsDataConfig_Statics::NewProp_DataName_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNetAnalyticsDataConfig_Statics::NewProp_bEnabled = { "bEnabled", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FNetAnalyticsDataConfig), &Z_Construct_UScriptStruct_FNetAnalyticsDataConfig_Statics::NewProp_bEnabled_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FNetAnalyticsDataConfig_Statics::NewProp_bEnabled_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetAnalyticsDataConfig_Statics::NewProp_bEnabled_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNetAnalyticsAggregatorConfig_Statics::NewProp_NetAnalyticsData_Inner = { "NetAnalyticsData", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNetAnalyticsDataConfig, METADATA_PARAMS(nullptr, 0) }; // 2816049844
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UNetAnalyticsAggregatorConfig_Statics::NewProp_NetAnalyticsData = { "NetAnalyticsData", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNetAnalyticsAggregatorConfig, NetAnalyticsData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UNetAnalyticsAggregatorConfig_Statics::NewProp_NetAnalyticsData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNetAnalyticsAggregatorConfig_Statics::NewProp_NetAnalyticsData_MetaData)) }; // 2816049844
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Classes_Net_Core_Analytics_NetAnalyticsAggregatorConfig_h_Statics::ScriptStructInfo[] = {
		{ FNetAnalyticsDataConfig::StaticStruct, Z_Construct_UScriptStruct_FNetAnalyticsDataConfig_Statics::NewStructOps, TEXT("NetAnalyticsDataConfig"), &Z_Registration_Info_UScriptStruct_NetAnalyticsDataConfig, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNetAnalyticsDataConfig), 2816049844U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Classes_Net_Core_Analytics_NetAnalyticsAggregatorConfig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNetAnalyticsAggregatorConfig, UNetAnalyticsAggregatorConfig::StaticClass, TEXT("UNetAnalyticsAggregatorConfig"), &Z_Registration_Info_UClass_UNetAnalyticsAggregatorConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetAnalyticsAggregatorConfig), 1872284952U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Classes_Net_Core_Analytics_NetAnalyticsAggregatorConfig_h_3922232547(TEXT("/Script/NetCore"),
