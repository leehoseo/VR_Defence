...
#include "Core/Public/Net/Core/Connection/NetConnectionFaultRecoveryBase.h"
...
class UScriptStruct* FNetFaultState::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NetFaultState.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNetFaultState, Z_Construct_UPackage__Script_NetCore(), TEXT("NetFaultState"));
	}
...
template<> NETCORE_API UScriptStruct* StaticStruct<FNetFaultState>()
{
...
#endif
	const UECodeGen_Private::FInt16PropertyParams Z_Construct_UScriptStruct_FNetFaultState_Statics::NewProp_EscalateQuotaFaultsPerPeriod = { "EscalateQuotaFaultsPerPeriod", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Int16, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNetFaultState, EscalateQuotaFaultsPerPeriod), METADATA_PARAMS(Z_Construct_UScriptStruct_FNetFaultState_Statics::NewProp_EscalateQuotaFaultsPerPeriod_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetFaultState_Statics::NewProp_EscalateQuotaFaultsPerPeriod_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FInt8PropertyParams Z_Construct_UScriptStruct_FNetFaultState_Statics::NewProp_EscalateQuotaFaultPercentPerPeriod = { "EscalateQuotaFaultPercentPerPeriod", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Int8, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNetFaultState, EscalateQuotaFaultPercentPerPeriod), METADATA_PARAMS(Z_Construct_UScriptStruct_FNetFaultState_Statics::NewProp_EscalateQuotaFaultPercentPerPeriod_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetFaultState_Statics::NewProp_EscalateQuotaFaultPercentPerPeriod_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FInt8PropertyParams Z_Construct_UScriptStruct_FNetFaultState_Statics::NewProp_EscalateQuotaTimePeriod = { "EscalateQuotaTimePeriod", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Int8, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNetFaultState, EscalateQuotaTimePeriod), METADATA_PARAMS(Z_Construct_UScriptStruct_FNetFaultState_Statics::NewProp_EscalateQuotaTimePeriod_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetFaultState_Statics::NewProp_EscalateQuotaTimePeriod_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Public_Net_Core_Connection_NetConnectionFaultRecoveryBase_h_Statics::ScriptStructInfo[] = {
		{ FNetFaultState::StaticStruct, Z_Construct_UScriptStruct_FNetFaultState_Statics::NewStructOps, TEXT("NetFaultState"), &Z_Registration_Info_UScriptStruct_NetFaultState, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNetFaultState), 3805551033U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Public_Net_Core_Connection_NetConnectionFaultRecoveryBase_h_3892453828(TEXT("/Script/NetCore"),
		nullptr, 0,
