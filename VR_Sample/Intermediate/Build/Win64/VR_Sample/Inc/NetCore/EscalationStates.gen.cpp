...
#include "Core/Public/Net/Core/Connection/EscalationStates.h"
...
class UScriptStruct* FEscalationState::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EscalationState.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEscalationState, Z_Construct_UPackage__Script_NetCore(), TEXT("EscalationState"));
	}
...
template<> NETCORE_API UScriptStruct* StaticStruct<FEscalationState>()
{
...
#endif
	const UECodeGen_Private::FInt16PropertyParams Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_CooloffTime = { "CooloffTime", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Int16, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEscalationState, CooloffTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_CooloffTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_CooloffTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FInt16PropertyParams Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_AutoEscalateTime = { "AutoEscalateTime", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Int16, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEscalationState, AutoEscalateTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_AutoEscalateTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_AutoEscalateTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FInt8PropertyParams Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_HighestTimePeriod = { "HighestTimePeriod", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Int8, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEscalationState, HighestTimePeriod), METADATA_PARAMS(Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_HighestTimePeriod_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_HighestTimePeriod_MetaData)) };
	const UECodeGen_Private::FInt8PropertyParams Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_AllTimePeriods_Inner = { "AllTimePeriods", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int8, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_AllTimePeriods = { "AllTimePeriods", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FEscalationState, AllTimePeriods), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_AllTimePeriods_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FEscalationState_Statics::NewProp_AllTimePeriods_MetaData)) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEscalationManagerConfig_Statics::NewProp_EscalationSeverity_Inner = { "EscalationSeverity", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEscalationManagerConfig_Statics::NewProp_EscalationSeverity = { "EscalationSeverity", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEscalationManagerConfig, EscalationSeverity), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEscalationManagerConfig_Statics::NewProp_EscalationSeverity_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEscalationManagerConfig_Statics::NewProp_EscalationSeverity_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Public_Net_Core_Connection_EscalationStates_h_Statics::ScriptStructInfo[] = {
		{ FEscalationState::StaticStruct, Z_Construct_UScriptStruct_FEscalationState_Statics::NewStructOps, TEXT("EscalationState"), &Z_Registration_Info_UScriptStruct_EscalationState, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEscalationState), 2509743253U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Public_Net_Core_Connection_EscalationStates_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEscalationManagerConfig, UEscalationManagerConfig::StaticClass, TEXT("UEscalationManagerConfig"), &Z_Registration_Info_UClass_UEscalationManagerConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEscalationManagerConfig), 1168420329U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Public_Net_Core_Connection_EscalationStates_h_3942048048(TEXT("/Script/NetCore"),
