...
#include "Core/Public/Net/Core/Connection/StateStruct.h"
...
class UScriptStruct* FStateStruct::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StateStruct.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStateStruct, Z_Construct_UPackage__Script_NetCore(), TEXT("StateStruct"));
	}
...
template<> NETCORE_API UScriptStruct* StaticStruct<FStateStruct>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FStateStruct_Statics::NewProp_StateName = { "StateName", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FStateStruct, StateName), METADATA_PARAMS(Z_Construct_UScriptStruct_FStateStruct_Statics::NewProp_StateName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStateStruct_Statics::NewProp_StateName_MetaData)) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UStatePerObjectConfig_Statics::NewProp_PerObjectConfigSection = { "PerObjectConfigSection", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStatePerObjectConfig, PerObjectConfigSection), METADATA_PARAMS(Z_Construct_UClass_UStatePerObjectConfig_Statics::NewProp_PerObjectConfigSection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStatePerObjectConfig_Statics::NewProp_PerObjectConfigSection_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UStatePerObjectConfig_Statics::NewProp_bEnabled = { "bEnabled", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UStatePerObjectConfig), &Z_Construct_UClass_UStatePerObjectConfig_Statics::NewProp_bEnabled_SetBit, METADATA_PARAMS(Z_Construct_UClass_UStatePerObjectConfig_Statics::NewProp_bEnabled_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStatePerObjectConfig_Statics::NewProp_bEnabled_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Public_Net_Core_Connection_StateStruct_h_Statics::ScriptStructInfo[] = {
		{ FStateStruct::StaticStruct, Z_Construct_UScriptStruct_FStateStruct_Statics::NewStructOps, TEXT("StateStruct"), &Z_Registration_Info_UScriptStruct_StateStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStateStruct), 61100341U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Public_Net_Core_Connection_StateStruct_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStatePerObjectConfig, UStatePerObjectConfig::StaticClass, TEXT("UStatePerObjectConfig"), &Z_Registration_Info_UClass_UStatePerObjectConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStatePerObjectConfig), 2701760456U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Net_Core_Public_Net_Core_Connection_StateStruct_h_1163875462(TEXT("/Script/NetCore"),
