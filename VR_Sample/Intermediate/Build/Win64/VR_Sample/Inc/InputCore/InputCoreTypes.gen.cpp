...
// End Cross Module References
	...
	static UEnum* EControllerHand_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EControllerHand.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_InputCore_EControllerHand, Z_Construct_UPackage__Script_InputCore(), TEXT("EControllerHand"));
		}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_InputCore_EControllerHand_Statics::Enum_MetaDataParams[] = {
		...
		{ "Special_1.Name", "EControllerHand::Special_1" },
		{ "Special_10.Name", "EControllerHand::Special_10" },
		{ "Special_11.Name", "EControllerHand::Special_11" },
		{ "Special_2.Name", "EControllerHand::Special_2" },
		{ "Special_3.Name", "EControllerHand::Special_3" },
		{ "Special_4.Name", "EControllerHand::Special_4" },
		{ "Special_5.Name", "EControllerHand::Special_5" },
		{ "Special_6.Name", "EControllerHand::Special_6" },
		{ "Special_7.Name", "EControllerHand::Special_7" },
		{ "Special_8.Name", "EControllerHand::Special_8" },
		{ "Special_9.Name", "EControllerHand::Special_9" },
...
class UScriptStruct* FKey::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Key.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKey, Z_Construct_UPackage__Script_InputCore(), TEXT("Key"));
	}
...
template<> INPUTCORE_API UScriptStruct* StaticStruct<FKey>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FKey_Statics::NewProp_KeyName = { "KeyName", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKey, KeyName), METADATA_PARAMS(Z_Construct_UScriptStruct_FKey_Statics::NewProp_KeyName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKey_Statics::NewProp_KeyName_MetaData)) };
	...
	static UEnum* ETouchIndex_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETouchIndex.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_InputCore_ETouchIndex, Z_Construct_UPackage__Script_InputCore(), TEXT("ETouchIndex"));
		}
	...
	static UEnum* EConsoleForGamepadLabels_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EConsoleForGamepadLabels.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_InputCore_EConsoleForGamepadLabels, Z_Construct_UPackage__Script_InputCore(), TEXT("EConsoleForGamepadLabels"));
		}
	...
	static UEnum* ETouchType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETouchType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_InputCore_ETouchType, Z_Construct_UPackage__Script_InputCore(), TEXT("ETouchType"));
		}
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_InputCore_Classes_InputCoreTypes_h_Statics::EnumInfo[] = {
		{ EControllerHand_StaticEnum, TEXT("EControllerHand"), &Z_Registration_Info_UEnum_EControllerHand, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2206298931U) },
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_InputCore_Classes_InputCoreTypes_h_Statics::ScriptStructInfo[] = {
		{ FKey::StaticStruct, Z_Construct_UScriptStruct_FKey_Statics::NewStructOps, TEXT("Key"), &Z_Registration_Info_UScriptStruct_Key, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FKey), 2615338182U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_InputCore_Classes_InputCoreTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInputCoreTypes, UInputCoreTypes::StaticClass, TEXT("UInputCoreTypes"), &Z_Registration_Info_UClass_UInputCoreTypes, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputCoreTypes), 880240794U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_InputCore_Classes_InputCoreTypes_h_1824716464(TEXT("/Script/InputCore"),
