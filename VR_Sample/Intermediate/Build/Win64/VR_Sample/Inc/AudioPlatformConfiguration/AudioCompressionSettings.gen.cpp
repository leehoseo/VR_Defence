...
// End Cross Module References
	...
	static UEnum* ESoundwaveSampleRateSettings_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESoundwaveSampleRateSettings.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AudioPlatformConfiguration_ESoundwaveSampleRateSettings, Z_Construct_UPackage__Script_AudioPlatformConfiguration(), TEXT("ESoundwaveSampleRateSettings"));
		}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_AudioPlatformConfiguration_ESoundwaveSampleRateSettings_Statics::Enum_MetaDataParams[] = {
		...
		{ "MatchDevice.Comment", "// Use this setting to resample soundwaves to the device's sample rate to avoid having to perform sample rate conversion at runtime.\n" },
		{ "MatchDevice.Name", "ESoundwaveSampleRateSettings::MatchDevice" },
...
class UScriptStruct* FPlatformRuntimeAudioCompressionOverrides::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PlatformRuntimeAudioCompressionOverrides.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPlatformRuntimeAudioCompressionOverrides, Z_Construct_UPackage__Script_AudioPlatformConfiguration(), TEXT("PlatformRuntimeAudioCompressionOverrides"));
	}
...
template<> AUDIOPLATFORMCONFIGURATION_API UScriptStruct* StaticStruct<FPlatformRuntimeAudioCompressionOverrides>()
{
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioPlatformConfiguration_Public_AudioCompressionSettings_h_Statics::EnumInfo[] = {
		{ ESoundwaveSampleRateSettings_StaticEnum, TEXT("ESoundwaveSampleRateSettings"), &Z_Registration_Info_UEnum_ESoundwaveSampleRateSettings, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2693280811U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioPlatformConfiguration_Public_AudioCompressionSettings_h_1338989639(TEXT("/Script/AudioPlatformConfiguration"),
		nullptr, 0,
