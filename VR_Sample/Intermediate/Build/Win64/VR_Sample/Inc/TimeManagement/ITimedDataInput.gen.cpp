...
// End Cross Module References
	...
	static UEnum* ETimedDataInputEvaluationType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETimedDataInputEvaluationType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_TimeManagement_ETimedDataInputEvaluationType, Z_Construct_UPackage__Script_TimeManagement(), TEXT("ETimedDataInputEvaluationType"));
		}
	...
	static UEnum* ETimedDataInputState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETimedDataInputState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_TimeManagement_ETimedDataInputState, Z_Construct_UPackage__Script_TimeManagement(), TEXT("ETimedDataInputState"));
		}
...
class UScriptStruct* FTimedDataChannelSampleTime::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TimedDataChannelSampleTime.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTimedDataChannelSampleTime, Z_Construct_UPackage__Script_TimeManagement(), TEXT("TimedDataChannelSampleTime"));
	}
...
class UScriptStruct* FTimedDataInputEvaluationData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TimedDataInputEvaluationData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTimedDataInputEvaluationData, Z_Construct_UPackage__Script_TimeManagement(), TEXT("TimedDataInputEvaluationData"));
	}
...
template<> TIMEMANAGEMENT_API UScriptStruct* StaticStruct<FTimedDataInputEvaluationData>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimedDataInputEvaluationData_Statics::NewProp_DistanceToNewestSampleSeconds = { "DistanceToNewestSampleSeconds", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTimedDataInputEvaluationData, DistanceToNewestSampleSeconds), METADATA_PARAMS(Z_Construct_UScriptStruct_FTimedDataInputEvaluationData_Statics::NewProp_DistanceToNewestSampleSeconds_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimedDataInputEvaluationData_Statics::NewProp_DistanceToNewestSampleSeconds_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_TimeManagement_Public_ITimedDataInput_h_Statics::ScriptStructInfo[] = {
		...
		{ FTimedDataInputEvaluationData::StaticStruct, Z_Construct_UScriptStruct_FTimedDataInputEvaluationData_Statics::NewStructOps, TEXT("TimedDataInputEvaluationData"), &Z_Registration_Info_UScriptStruct_TimedDataInputEvaluationData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTimedDataInputEvaluationData), 3239400308U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_TimeManagement_Public_ITimedDataInput_h_123550312(TEXT("/Script/TimeManagement"),
		nullptr, 0,
