...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UGenlockedTimecodeProvider_Statics::NewProp_bUseGenlockToCount = { "bUseGenlockToCount", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UGenlockedTimecodeProvider), &Z_Construct_UClass_UGenlockedTimecodeProvider_Statics::NewProp_bUseGenlockToCount_SetBit, METADATA_PARAMS(Z_Construct_UClass_UGenlockedTimecodeProvider_Statics::NewProp_bUseGenlockToCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGenlockedTimecodeProvider_Statics::NewProp_bUseGenlockToCount_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_TimeManagement_Public_GenlockedTimecodeProvider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGenlockedTimecodeProvider, UGenlockedTimecodeProvider::StaticClass, TEXT("UGenlockedTimecodeProvider"), &Z_Registration_Info_UClass_UGenlockedTimecodeProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGenlockedTimecodeProvider), 3527530868U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_TimeManagement_Public_GenlockedTimecodeProvider_h_2760132600(TEXT("/Script/TimeManagement"),
