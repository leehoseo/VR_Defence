...
void EmptyLinkFunctionForGeneratedCodeOculusHMD_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_OculusHMD()
	{
		if (!Z_Registration_Info_UPackage__Script_OculusHMD.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_UOculusEventComponent_OculusDisplayRefreshRateChangedEventDelegate__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_OculusHMD(Z_Construct_UPackage__Script_OculusHMD, TEXT("/Script/OculusHMD"), Z_Registration_Info_UPackage__Script_OculusHMD, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x35F6FACA, 0xDB6EE0CC));
