...
class UScriptStruct* FMovieSceneGeometryCacheSectionTemplateParameters::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneGeometryCacheSectionTemplateParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplateParameters, Z_Construct_UPackage__Script_GeometryCacheTracks(), TEXT("MovieSceneGeometryCacheSectionTemplateParameters"));
	}
...
class UScriptStruct* FMovieSceneGeometryCacheSectionTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MovieSceneGeometryCacheSectionTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplate, Z_Construct_UPackage__Script_GeometryCacheTracks(), TEXT("MovieSceneGeometryCacheSectionTemplate"));
	}
...
template<> GEOMETRYCACHETRACKS_API UScriptStruct* StaticStruct<FMovieSceneGeometryCacheSectionTemplate>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCacheTracks_Private_MovieSceneGeometryCacheTemplate_h_Statics::ScriptStructInfo[] = {
		...
		{ FMovieSceneGeometryCacheSectionTemplate::StaticStruct, Z_Construct_UScriptStruct_FMovieSceneGeometryCacheSectionTemplate_Statics::NewStructOps, TEXT("MovieSceneGeometryCacheSectionTemplate"), &Z_Registration_Info_UScriptStruct_MovieSceneGeometryCacheSectionTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMovieSceneGeometryCacheSectionTemplate), 4004425227U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_GeometryCache_Source_GeometryCacheTracks_Private_MovieSceneGeometryCacheTemplate_h_4256252309(TEXT("/Script/GeometryCacheTracks"),
		nullptr, 0,
