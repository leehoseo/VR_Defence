...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBTTask_GameplayTaskBase_Statics::NewProp_bWaitForGameplayTask = { "bWaitForGameplayTask", nullptr, (EPropertyFlags)0x00200c0000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UBTTask_GameplayTaskBase), &Z_Construct_UClass_UBTTask_GameplayTaskBase_Statics::NewProp_bWaitForGameplayTask_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBTTask_GameplayTaskBase_Statics::NewProp_bWaitForGameplayTask_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTTask_GameplayTaskBase_Statics::NewProp_bWaitForGameplayTask_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Tasks_BTTask_GameplayTaskBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTTask_GameplayTaskBase, UBTTask_GameplayTaskBase::StaticClass, TEXT("UBTTask_GameplayTaskBase"), &Z_Registration_Info_UClass_UBTTask_GameplayTaskBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTTask_GameplayTaskBase), 1752601385U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Tasks_BTTask_GameplayTaskBase_h_4048081015(TEXT("/Script/AIModule"),
