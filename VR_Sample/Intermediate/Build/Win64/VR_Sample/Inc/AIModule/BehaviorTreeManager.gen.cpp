...
class UScriptStruct* FBehaviorTreeTemplateInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BehaviorTreeTemplateInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBehaviorTreeTemplateInfo, Z_Construct_UPackage__Script_AIModule(), TEXT("BehaviorTreeTemplateInfo"));
	}
...
template<> AIMODULE_API UScriptStruct* StaticStruct<FBehaviorTreeTemplateInfo>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FBehaviorTreeTemplateInfo_Statics::NewProp_Asset = { "Asset", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBehaviorTreeTemplateInfo, Asset), Z_Construct_UClass_UBehaviorTree_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FBehaviorTreeTemplateInfo_Statics::NewProp_Asset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBehaviorTreeTemplateInfo_Statics::NewProp_Asset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_MaxDebuggerSteps = { "MaxDebuggerSteps", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBehaviorTreeManager, MaxDebuggerSteps), METADATA_PARAMS(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_MaxDebuggerSteps_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_MaxDebuggerSteps_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_LoadedTemplates_Inner = { "LoadedTemplates", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBehaviorTreeTemplateInfo, METADATA_PARAMS(nullptr, 0) }; // 2004527406
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_LoadedTemplates = { "LoadedTemplates", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBehaviorTreeManager, LoadedTemplates), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_LoadedTemplates_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_LoadedTemplates_MetaData)) }; // 2004527406
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_ActiveComponents_Inner = { "ActiveComponents", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UBehaviorTreeComponent_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_ActiveComponents = { "ActiveComponents", nullptr, (EPropertyFlags)0x0024088000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBehaviorTreeManager, ActiveComponents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_ActiveComponents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBehaviorTreeManager_Statics::NewProp_ActiveComponents_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BehaviorTreeManager_h_Statics::ScriptStructInfo[] = {
		{ FBehaviorTreeTemplateInfo::StaticStruct, Z_Construct_UScriptStruct_FBehaviorTreeTemplateInfo_Statics::NewStructOps, TEXT("BehaviorTreeTemplateInfo"), &Z_Registration_Info_UScriptStruct_BehaviorTreeTemplateInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBehaviorTreeTemplateInfo), 2004527406U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BehaviorTreeManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBehaviorTreeManager, UBehaviorTreeManager::StaticClass, TEXT("UBehaviorTreeManager"), &Z_Registration_Info_UClass_UBehaviorTreeManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBehaviorTreeManager), 3431218359U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BehaviorTreeManager_h_4147132155(TEXT("/Script/AIModule"),
