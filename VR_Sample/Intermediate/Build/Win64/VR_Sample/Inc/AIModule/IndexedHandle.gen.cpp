...
class UScriptStruct* FSimpleIndexedHandleBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SimpleIndexedHandleBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSimpleIndexedHandleBase, Z_Construct_UPackage__Script_AIModule(), TEXT("SimpleIndexedHandleBase"));
	}
...
class UScriptStruct* FIndexedHandleBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_IndexedHandleBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FIndexedHandleBase, Z_Construct_UPackage__Script_AIModule(), TEXT("IndexedHandleBase"));
	}
...
class UScriptStruct* FCompactIndexedHandleBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CompactIndexedHandleBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCompactIndexedHandleBase, Z_Construct_UPackage__Script_AIModule(), TEXT("CompactIndexedHandleBase"));
	}
