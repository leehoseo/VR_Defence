...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UBTDecorator_IsBBEntryOfClass_Statics::NewProp_TestClass = { "TestClass", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_IsBBEntryOfClass, TestClass), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_IsBBEntryOfClass_Statics::NewProp_TestClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_IsBBEntryOfClass_Statics::NewProp_TestClass_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Decorators_BTDecorator_IsBBEntryOfClass_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTDecorator_IsBBEntryOfClass, UBTDecorator_IsBBEntryOfClass::StaticClass, TEXT("UBTDecorator_IsBBEntryOfClass"), &Z_Registration_Info_UClass_UBTDecorator_IsBBEntryOfClass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTDecorator_IsBBEntryOfClass), 3525807371U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Decorators_BTDecorator_IsBBEntryOfClass_h_2061653974(TEXT("/Script/AIModule"),
