...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_NumLoops = { "NumLoops", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_Loop, NumLoops), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_NumLoops_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_Loop_Statics::NewProp_NumLoops_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Decorators_BTDecorator_Loop_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTDecorator_Loop, UBTDecorator_Loop::StaticClass, TEXT("UBTDecorator_Loop"), &Z_Registration_Info_UClass_UBTDecorator_Loop, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTDecorator_Loop), 2723624262U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Decorators_BTDecorator_Loop_h_2615696944(TEXT("/Script/AIModule"),
