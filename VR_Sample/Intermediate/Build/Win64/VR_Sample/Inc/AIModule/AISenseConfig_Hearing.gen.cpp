...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_HearingRange = { "HearingRange", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISenseConfig_Hearing, HearingRange), METADATA_PARAMS(Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_HearingRange_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_HearingRange_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_bUseLoSHearing_MetaData[] = {
		{ "Category", "Sense" },
		{ "Comment", "/** Warning: has significant runtime cost */" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_bUseLoSHearing = { "bUseLoSHearing", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UAISenseConfig_Hearing), &Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_bUseLoSHearing_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_bUseLoSHearing_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_bUseLoSHearing_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_DetectionByAffiliation = { "DetectionByAffiliation", nullptr, (EPropertyFlags)0x0010000000014015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISenseConfig_Hearing, DetectionByAffiliation), Z_Construct_UScriptStruct_FAISenseAffiliationFilter, METADATA_PARAMS(Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_DetectionByAffiliation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISenseConfig_Hearing_Statics::NewProp_DetectionByAffiliation_MetaData)) }; // 1034587660
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISenseConfig_Hearing_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAISenseConfig_Hearing, UAISenseConfig_Hearing::StaticClass, TEXT("UAISenseConfig_Hearing"), &Z_Registration_Info_UClass_UAISenseConfig_Hearing, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAISenseConfig_Hearing), 2118983796U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISenseConfig_Hearing_h_825668118(TEXT("/Script/AIModule"),
