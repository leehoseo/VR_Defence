...
class UScriptStruct* FSequentialIDBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SequentialIDBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSequentialIDBase, Z_Construct_UPackage__Script_AIModule(), TEXT("SequentialIDBase"));
	}
...
template<> AIMODULE_API UScriptStruct* StaticStruct<FSequentialIDBase>()
{
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FSequentialIDBase_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequentialIDBase, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequentialIDBase_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequentialIDBase_Statics::NewProp_Value_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Public_SequentialID_h_Statics::ScriptStructInfo[] = {
		{ FSequentialIDBase::StaticStruct, Z_Construct_UScriptStruct_FSequentialIDBase_Statics::NewStructOps, TEXT("SequentialIDBase"), &Z_Registration_Info_UScriptStruct_SequentialIDBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSequentialIDBase), 1678417472U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Public_SequentialID_h_1888187252(TEXT("/Script/AIModule"),
		nullptr, 0,
