...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnvQueryTest_PathfindingBatch_Statics::NewProp_ScanRangeMultiplier = { "ScanRangeMultiplier", nullptr, (EPropertyFlags)0x0010048000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryTest_PathfindingBatch, ScanRangeMultiplier), Z_Construct_UScriptStruct_FAIDataProviderFloatValue, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_PathfindingBatch_Statics::NewProp_ScanRangeMultiplier_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_PathfindingBatch_Statics::NewProp_ScanRangeMultiplier_MetaData)) }; // 2828399381
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Tests_EnvQueryTest_PathfindingBatch_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryTest_PathfindingBatch, UEnvQueryTest_PathfindingBatch::StaticClass, TEXT("UEnvQueryTest_PathfindingBatch"), &Z_Registration_Info_UClass_UEnvQueryTest_PathfindingBatch, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryTest_PathfindingBatch), 682643534U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Tests_EnvQueryTest_PathfindingBatch_h_341315849(TEXT("/Script/AIModule"),
