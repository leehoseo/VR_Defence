...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnvQueryTest_Project_Statics::NewProp_ProjectionData = { "ProjectionData", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryTest_Project, ProjectionData), Z_Construct_UScriptStruct_FEnvTraceData, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Project_Statics::NewProp_ProjectionData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Project_Statics::NewProp_ProjectionData_MetaData)) }; // 694376603
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Tests_EnvQueryTest_Project_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryTest_Project, UEnvQueryTest_Project::StaticClass, TEXT("UEnvQueryTest_Project"), &Z_Registration_Info_UClass_UEnvQueryTest_Project, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryTest_Project), 3371303467U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Tests_EnvQueryTest_Project_h_4208335224(TEXT("/Script/AIModule"),
