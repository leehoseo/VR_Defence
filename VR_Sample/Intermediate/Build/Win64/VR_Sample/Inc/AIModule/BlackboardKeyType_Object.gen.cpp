...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPtrPropertyParams Z_Construct_UClass_UBlackboardKeyType_Object_Statics::NewProp_BaseClass = { "BaseClass", nullptr, (EPropertyFlags)0x0014000000010001, UECodeGen_Private::EPropertyGenFlags::Class | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlackboardKeyType_Object, BaseClass), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UBlackboardKeyType_Object_Statics::NewProp_BaseClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlackboardKeyType_Object_Statics::NewProp_BaseClass_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Blackboard_BlackboardKeyType_Object_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBlackboardKeyType_Object, UBlackboardKeyType_Object::StaticClass, TEXT("UBlackboardKeyType_Object"), &Z_Registration_Info_UClass_UBlackboardKeyType_Object, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlackboardKeyType_Object), 3299785225U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Blackboard_BlackboardKeyType_Object_h_90735129(TEXT("/Script/AIModule"),
