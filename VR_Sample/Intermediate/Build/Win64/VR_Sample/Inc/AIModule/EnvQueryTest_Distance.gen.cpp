...
// End Cross Module References
	...
	static UEnum* EEnvTestDistance_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EEnvTestDistance.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EEnvTestDistance, Z_Construct_UPackage__Script_AIModule(), TEXT("EEnvTestDistance"));
		}
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UEnvQueryTest_Distance_Statics::NewProp_TestMode = { "TestMode", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryTest_Distance, TestMode), Z_Construct_UEnum_AIModule_EEnvTestDistance, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Distance_Statics::NewProp_TestMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Distance_Statics::NewProp_TestMode_MetaData)) }; // 82239442
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UEnvQueryTest_Distance_Statics::NewProp_DistanceTo = { "DistanceTo", nullptr, (EPropertyFlags)0x0014000000010001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryTest_Distance, DistanceTo), Z_Construct_UClass_UEnvQueryContext_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Distance_Statics::NewProp_DistanceTo_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Distance_Statics::NewProp_DistanceTo_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Tests_EnvQueryTest_Distance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryTest_Distance, UEnvQueryTest_Distance::StaticClass, TEXT("UEnvQueryTest_Distance"), &Z_Registration_Info_UClass_UEnvQueryTest_Distance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryTest_Distance), 2482100968U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Tests_EnvQueryTest_Distance_h_4274370027(TEXT("/Script/AIModule"),
