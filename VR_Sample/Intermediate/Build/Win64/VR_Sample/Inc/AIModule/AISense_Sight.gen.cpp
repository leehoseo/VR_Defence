...
class UScriptStruct* FAISightEvent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AISightEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAISightEvent, Z_Construct_UPackage__Script_AIModule(), TEXT("AISightEvent"));
	}
...
template<> AIMODULE_API UScriptStruct* StaticStruct<FAISightEvent>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_SeenActor = { "SeenActor", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAISightEvent, SeenActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_SeenActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_SeenActor_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_Observer_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Perception/AISense_Sight.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_Observer = { "Observer", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAISightEvent, Observer), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_Observer_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAISightEvent_Statics::NewProp_Observer_MetaData)) };
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTracesPerTick = { "MaxTracesPerTick", nullptr, (EPropertyFlags)0x0020080000014001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense_Sight, MaxTracesPerTick), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTracesPerTick_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTracesPerTick_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MinQueriesPerTimeSliceCheck = { "MinQueriesPerTimeSliceCheck", nullptr, (EPropertyFlags)0x0020080000014001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense_Sight, MinQueriesPerTimeSliceCheck), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MinQueriesPerTimeSliceCheck_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MinQueriesPerTimeSliceCheck_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTimeSlicePerTick = { "MaxTimeSlicePerTick", nullptr, (EPropertyFlags)0x0020080000014001, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense_Sight, MaxTimeSlicePerTick), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTimeSlicePerTick_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxTimeSlicePerTick_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_HighImportanceQueryDistanceThreshold = { "HighImportanceQueryDistanceThreshold", nullptr, (EPropertyFlags)0x0020080000014001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense_Sight, HighImportanceQueryDistanceThreshold), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_HighImportanceQueryDistanceThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_HighImportanceQueryDistanceThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxQueryImportance = { "MaxQueryImportance", nullptr, (EPropertyFlags)0x0020080000014001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense_Sight, MaxQueryImportance), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxQueryImportance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_MaxQueryImportance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISense_Sight_Statics::NewProp_SightLimitQueryImportance = { "SightLimitQueryImportance", nullptr, (EPropertyFlags)0x0020080000014001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense_Sight, SightLimitQueryImportance), METADATA_PARAMS(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_SightLimitQueryImportance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Sight_Statics::NewProp_SightLimitQueryImportance_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_Sight_h_Statics::ScriptStructInfo[] = {
		{ FAISightEvent::StaticStruct, Z_Construct_UScriptStruct_FAISightEvent_Statics::NewStructOps, TEXT("AISightEvent"), &Z_Registration_Info_UScriptStruct_AISightEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAISightEvent), 3568757703U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_Sight_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAISense_Sight, UAISense_Sight::StaticClass, TEXT("UAISense_Sight"), &Z_Registration_Info_UClass_UAISense_Sight, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAISense_Sight), 654101258U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_Sight_h_2098583118(TEXT("/Script/AIModule"),
