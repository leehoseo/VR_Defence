...
// End Cross Module References
	...
	static UEnum* ETeamAttitude_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETeamAttitude.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_ETeamAttitude, Z_Construct_UPackage__Script_AIModule(), TEXT("ETeamAttitude"));
		}
...
class UScriptStruct* FGenericTeamId::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GenericTeamId.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGenericTeamId, Z_Construct_UPackage__Script_AIModule(), TEXT("GenericTeamId"));
	}
...
template<> AIMODULE_API UScriptStruct* StaticStruct<FGenericTeamId>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_GenericTeamAgentInterface_h_Statics::ScriptStructInfo[] = {
		{ FGenericTeamId::StaticStruct, Z_Construct_UScriptStruct_FGenericTeamId_Statics::NewStructOps, TEXT("GenericTeamId"), &Z_Registration_Info_UScriptStruct_GenericTeamId, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGenericTeamId), 3091121244U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_GenericTeamAgentInterface_h_1014418976(TEXT("/Script/AIModule"),
