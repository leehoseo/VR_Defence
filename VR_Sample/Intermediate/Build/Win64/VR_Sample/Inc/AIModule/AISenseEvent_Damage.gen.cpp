...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAISenseEvent_Damage_Statics::NewProp_Event = { "Event", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISenseEvent_Damage, Event), Z_Construct_UScriptStruct_FAIDamageEvent, METADATA_PARAMS(Z_Construct_UClass_UAISenseEvent_Damage_Statics::NewProp_Event_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISenseEvent_Damage_Statics::NewProp_Event_MetaData)) }; // 2024660161
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISenseEvent_Damage_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAISenseEvent_Damage, UAISenseEvent_Damage::StaticClass, TEXT("UAISenseEvent_Damage"), &Z_Registration_Info_UClass_UAISenseEvent_Damage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAISenseEvent_Damage), 4081304519U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISenseEvent_Damage_h_4188816212(TEXT("/Script/AIModule"),
