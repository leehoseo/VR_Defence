...
// End Cross Module References
	...
	static UEnum* EAISenseNotifyType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAISenseNotifyType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EAISenseNotifyType, Z_Construct_UPackage__Script_AIModule(), TEXT("EAISenseNotifyType"));
		}
...
class UScriptStruct* FAIStimulus::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AIStimulus.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAIStimulus, Z_Construct_UPackage__Script_AIModule(), TEXT("AIStimulus"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Age = { "Age", nullptr, (EPropertyFlags)0x0020080000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIStimulus, Age), METADATA_PARAMS(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Age_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Age_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_ExpirationAge = { "ExpirationAge", nullptr, (EPropertyFlags)0x0020080000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIStimulus, ExpirationAge), METADATA_PARAMS(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_ExpirationAge_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_ExpirationAge_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Strength = { "Strength", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIStimulus, Strength), METADATA_PARAMS(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Strength_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Strength_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_StimulusLocation = { "StimulusLocation", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIStimulus, StimulusLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_StimulusLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_StimulusLocation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_ReceiverLocation = { "ReceiverLocation", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIStimulus, ReceiverLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_ReceiverLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_ReceiverLocation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Tag = { "Tag", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIStimulus, Tag), METADATA_PARAMS(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Tag_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIStimulus_Statics::NewProp_Tag_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FAISenseAffiliationFilter::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AISenseAffiliationFilter.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAISenseAffiliationFilter, Z_Construct_UPackage__Script_AIModule(), TEXT("AISenseAffiliationFilter"));
	}
...
template<> AIMODULE_API UScriptStruct* StaticStruct<FAISenseAffiliationFilter>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectEnemies = { "bDetectEnemies", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FAISenseAffiliationFilter), &Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectEnemies_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectEnemies_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectEnemies_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectNeutrals = { "bDetectNeutrals", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FAISenseAffiliationFilter), &Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectNeutrals_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectNeutrals_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewProp_bDetectNeutrals_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AIPerceptionTypes_h_Statics::ScriptStructInfo[] = {
		{ FAIStimulus::StaticStruct, Z_Construct_UScriptStruct_FAIStimulus_Statics::NewStructOps, TEXT("AIStimulus"), &Z_Registration_Info_UScriptStruct_AIStimulus, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAIStimulus), 1354403599U) },
		{ FAISenseAffiliationFilter::StaticStruct, Z_Construct_UScriptStruct_FAISenseAffiliationFilter_Statics::NewStructOps, TEXT("AISenseAffiliationFilter"), &Z_Registration_Info_UScriptStruct_AISenseAffiliationFilter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAISenseAffiliationFilter), 1034587660U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AIPerceptionTypes_h_1549344909(TEXT("/Script/AIModule"),
		nullptr, 0,
