...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTDecorator_SetTagCooldown_Statics::NewProp_CooldownDuration = { "CooldownDuration", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_SetTagCooldown, CooldownDuration), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_SetTagCooldown_Statics::NewProp_CooldownDuration_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_SetTagCooldown_Statics::NewProp_CooldownDuration_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Decorators_BTDecorator_SetTagCooldown_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTDecorator_SetTagCooldown, UBTDecorator_SetTagCooldown::StaticClass, TEXT("UBTDecorator_SetTagCooldown"), &Z_Registration_Info_UClass_UBTDecorator_SetTagCooldown, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTDecorator_SetTagCooldown), 1061944538U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Decorators_BTDecorator_SetTagCooldown_h_4064638507(TEXT("/Script/AIModule"),
