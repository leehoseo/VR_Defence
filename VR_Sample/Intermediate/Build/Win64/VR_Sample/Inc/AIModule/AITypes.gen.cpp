...
// End Cross Module References
	...
	static UEnum* EAIOptionFlag_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAIOptionFlag.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EAIOptionFlag, Z_Construct_UPackage__Script_AIModule(), TEXT("EAIOptionFlag"));
		}
	...
	static UEnum* FAIDistanceType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_FAIDistanceType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_FAIDistanceType, Z_Construct_UPackage__Script_AIModule(), TEXT("FAIDistanceType"));
		}
	...
	static UEnum* EPawnActionAbortState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPawnActionAbortState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EPawnActionAbortState, Z_Construct_UPackage__Script_AIModule(), TEXT("EPawnActionAbortState"));
		}
	...
	static UEnum* EPawnActionResult_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPawnActionResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EPawnActionResult, Z_Construct_UPackage__Script_AIModule(), TEXT("EPawnActionResult"));
		}
	...
	static UEnum* EPawnActionEventType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPawnActionEventType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EPawnActionEventType, Z_Construct_UPackage__Script_AIModule(), TEXT("EPawnActionEventType"));
		}
	...
	static UEnum* EAIRequestPriority_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAIRequestPriority.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EAIRequestPriority, Z_Construct_UPackage__Script_AIModule(), TEXT("EAIRequestPriority"));
		}
	...
	static UEnum* EAILockSource_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAILockSource.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EAILockSource, Z_Construct_UPackage__Script_AIModule(), TEXT("EAILockSource"));
		}
...
class UScriptStruct* FAIRequestID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AIRequestID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAIRequestID, Z_Construct_UPackage__Script_AIModule(), TEXT("AIRequestID"));
	}
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FAIRequestID_Statics::NewProp_RequestID = { "RequestID", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIRequestID, RequestID), METADATA_PARAMS(Z_Construct_UScriptStruct_FAIRequestID_Statics::NewProp_RequestID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIRequestID_Statics::NewProp_RequestID_MetaData)) };
...
class UScriptStruct* FAIMoveRequest::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AIMoveRequest.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAIMoveRequest, Z_Construct_UPackage__Script_AIModule(), TEXT("AIMoveRequest"));
	}
...
template<> AIMODULE_API UScriptStruct* StaticStruct<FAIMoveRequest>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAIMoveRequest_Statics::NewProp_GoalActor = { "GoalActor", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIMoveRequest, GoalActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAIMoveRequest_Statics::NewProp_GoalActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIMoveRequest_Statics::NewProp_GoalActor_MetaData)) };
	...
	static UEnum* EGenericAICheck_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EGenericAICheck.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EGenericAICheck, Z_Construct_UPackage__Script_AIModule(), TEXT("EGenericAICheck"));
		}
...
class UScriptStruct* FIntervalCountdown::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_IntervalCountdown.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FIntervalCountdown, Z_Construct_UPackage__Script_AIModule(), TEXT("IntervalCountdown"));
	}
...
template<> AIMODULE_API UScriptStruct* StaticStruct<FIntervalCountdown>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_AITypes_h_Statics::ScriptStructInfo[] = {
		{ FAIRequestID::StaticStruct, Z_Construct_UScriptStruct_FAIRequestID_Statics::NewStructOps, TEXT("AIRequestID"), &Z_Registration_Info_UScriptStruct_AIRequestID, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAIRequestID), 2930851505U) },
		{ FAIMoveRequest::StaticStruct, Z_Construct_UScriptStruct_FAIMoveRequest_Statics::NewStructOps, TEXT("AIMoveRequest"), &Z_Registration_Info_UScriptStruct_AIMoveRequest, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAIMoveRequest), 1351390513U) },
		{ FIntervalCountdown::StaticStruct, Z_Construct_UScriptStruct_FIntervalCountdown_Statics::NewStructOps, TEXT("IntervalCountdown"), &Z_Registration_Info_UScriptStruct_IntervalCountdown, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FIntervalCountdown), 1219824396U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_AITypes_h_2420124846(TEXT("/Script/AIModule"),
		nullptr, 0,
