...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTService_Statics::NewProp_Interval = { "Interval", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTService, Interval), METADATA_PARAMS(Z_Construct_UClass_UBTService_Statics::NewProp_Interval_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTService_Statics::NewProp_Interval_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBTService_Statics::NewProp_bRestartTimerOnEachActivation = { "bRestartTimerOnEachActivation", nullptr, (EPropertyFlags)0x00200c0000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UBTService), &Z_Construct_UClass_UBTService_Statics::NewProp_bRestartTimerOnEachActivation_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBTService_Statics::NewProp_bRestartTimerOnEachActivation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTService_Statics::NewProp_bRestartTimerOnEachActivation_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BTService_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTService, UBTService::StaticClass, TEXT("UBTService"), &Z_Registration_Info_UClass_UBTService, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTService), 2091547562U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_BTService_h_3656399178(TEXT("/Script/AIModule"),
