...
class UScriptStruct* FAITeamStimulusEvent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AITeamStimulusEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAITeamStimulusEvent, Z_Construct_UPackage__Script_AIModule(), TEXT("AITeamStimulusEvent"));
	}
...
template<> AIMODULE_API UScriptStruct* StaticStruct<FAITeamStimulusEvent>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAISense_Team_Statics::NewProp_RegisteredEvents_Inner = { "RegisteredEvents", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FAITeamStimulusEvent, METADATA_PARAMS(nullptr, 0) }; // 3644476566
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAISense_Team_Statics::NewProp_RegisteredEvents_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Perception/AISense_Team.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAISense_Team_Statics::NewProp_RegisteredEvents = { "RegisteredEvents", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense_Team, RegisteredEvents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAISense_Team_Statics::NewProp_RegisteredEvents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Team_Statics::NewProp_RegisteredEvents_MetaData)) }; // 3644476566
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_Team_h_Statics::ScriptStructInfo[] = {
		{ FAITeamStimulusEvent::StaticStruct, Z_Construct_UScriptStruct_FAITeamStimulusEvent_Statics::NewStructOps, TEXT("AITeamStimulusEvent"), &Z_Registration_Info_UScriptStruct_AITeamStimulusEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAITeamStimulusEvent), 3644476566U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_Team_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAISense_Team, UAISense_Team::StaticClass, TEXT("UAISense_Team"), &Z_Registration_Info_UClass_UAISense_Team, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAISense_Team), 27445280U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_Team_h_4106206729(TEXT("/Script/AIModule"),
