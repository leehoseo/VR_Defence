...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bDisablePathUpdateOnGoalLocationChange = { "bDisablePathUpdateOnGoalLocationChange", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UBTTask_MoveDirectlyToward), &Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bDisablePathUpdateOnGoalLocationChange_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bDisablePathUpdateOnGoalLocationChange_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bDisablePathUpdateOnGoalLocationChange_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bProjectVectorGoalToNavigation = { "bProjectVectorGoalToNavigation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UBTTask_MoveDirectlyToward), &Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bProjectVectorGoalToNavigation_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bProjectVectorGoalToNavigation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bProjectVectorGoalToNavigation_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bUpdatedDeprecatedProperties = { "bUpdatedDeprecatedProperties", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UBTTask_MoveDirectlyToward), &Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bUpdatedDeprecatedProperties_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bUpdatedDeprecatedProperties_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTTask_MoveDirectlyToward_Statics::NewProp_bUpdatedDeprecatedProperties_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Tasks_BTTask_MoveDirectlyToward_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTTask_MoveDirectlyToward, UBTTask_MoveDirectlyToward::StaticClass, TEXT("UBTTask_MoveDirectlyToward"), &Z_Registration_Info_UClass_UBTTask_MoveDirectlyToward, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTTask_MoveDirectlyToward), 804276890U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Tasks_BTTask_MoveDirectlyToward_h_1502804479(TEXT("/Script/AIModule"),
