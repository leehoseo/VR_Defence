...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAISense_Statics::NewProp_DefaultExpirationAge = { "DefaultExpirationAge", nullptr, (EPropertyFlags)0x0020080000024015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISense, DefaultExpirationAge), METADATA_PARAMS(Z_Construct_UClass_UAISense_Statics::NewProp_DefaultExpirationAge_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISense_Statics::NewProp_DefaultExpirationAge_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAISense_Statics::NewProp_NotifyType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAISense, UAISense::StaticClass, TEXT("UAISense"), &Z_Registration_Info_UClass_UAISense, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAISense), 2402071932U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Perception_AISense_h_983242059(TEXT("/Script/AIModule"),
