...
// End Cross Module References
	...
	static UEnum* EEnvTestDot_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EEnvTestDot.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EEnvTestDot, Z_Construct_UPackage__Script_AIModule(), TEXT("EEnvTestDot"));
		}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineA = { "LineA", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryTest_Dot, LineA), Z_Construct_UScriptStruct_FEnvDirection, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineA_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineA_MetaData)) }; // 3469612901
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineB = { "LineB", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryTest_Dot, LineB), Z_Construct_UScriptStruct_FEnvDirection, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_LineB_MetaData)) }; // 3469612901
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_TestMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_TestMode = { "TestMode", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEnvQueryTest_Dot, TestMode), Z_Construct_UEnum_AIModule_EEnvTestDot, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_TestMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_TestMode_MetaData)) }; // 1224468048
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_bAbsoluteValue = { "bAbsoluteValue", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UEnvQueryTest_Dot), &Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_bAbsoluteValue_SetBit, METADATA_PARAMS(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_bAbsoluteValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEnvQueryTest_Dot_Statics::NewProp_bAbsoluteValue_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Tests_EnvQueryTest_Dot_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEnvQueryTest_Dot, UEnvQueryTest_Dot::StaticClass, TEXT("UEnvQueryTest_Dot"), &Z_Registration_Info_UClass_UEnvQueryTest_Dot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEnvQueryTest_Dot), 1445238469U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_EnvironmentQuery_Tests_EnvQueryTest_Dot_h_353340545(TEXT("/Script/AIModule"),
