...
class UScriptStruct* FAIDataProviderValue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AIDataProviderValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAIDataProviderValue, Z_Construct_UPackage__Script_AIModule(), TEXT("AIDataProviderValue"));
	}
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAIDataProviderValue_Statics::NewProp_DataBinding = { "DataBinding", nullptr, (EPropertyFlags)0x0016000000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIDataProviderValue, DataBinding), Z_Construct_UClass_UAIDataProvider_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAIDataProviderValue_Statics::NewProp_DataBinding_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIDataProviderValue_Statics::NewProp_DataBinding_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FAIDataProviderTypedValue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AIDataProviderTypedValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAIDataProviderTypedValue, Z_Construct_UPackage__Script_AIModule(), TEXT("AIDataProviderTypedValue"));
	}
...
#endif
	const UECodeGen_Private::FClassPtrPropertyParams Z_Construct_UScriptStruct_FAIDataProviderTypedValue_Statics::NewProp_PropertyType = { "PropertyType", nullptr, (EPropertyFlags)0x0014000020000000, UECodeGen_Private::EPropertyGenFlags::Class | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAIDataProviderTypedValue, PropertyType_DEPRECATED), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FAIDataProviderTypedValue_Statics::NewProp_PropertyType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAIDataProviderTypedValue_Statics::NewProp_PropertyType_MetaData)) };
...
class UScriptStruct* FAIDataProviderStructValue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AIDataProviderStructValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAIDataProviderStructValue, Z_Construct_UPackage__Script_AIModule(), TEXT("AIDataProviderStructValue"));
	}
...
class UScriptStruct* FAIDataProviderIntValue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AIDataProviderIntValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAIDataProviderIntValue, Z_Construct_UPackage__Script_AIModule(), TEXT("AIDataProviderIntValue"));
	}
...
class UScriptStruct* FAIDataProviderFloatValue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AIDataProviderFloatValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAIDataProviderFloatValue, Z_Construct_UPackage__Script_AIModule(), TEXT("AIDataProviderFloatValue"));
	}
...
class UScriptStruct* FAIDataProviderBoolValue::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AIDataProviderBoolValue.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAIDataProviderBoolValue, Z_Construct_UPackage__Script_AIModule(), TEXT("AIDataProviderBoolValue"));
	}
...
template<> AIMODULE_API UScriptStruct* StaticStruct<FAIDataProviderBoolValue>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_DataProviders_AIDataProvider_h_Statics::ScriptStructInfo[] = {
		{ FAIDataProviderValue::StaticStruct, Z_Construct_UScriptStruct_FAIDataProviderValue_Statics::NewStructOps, TEXT("AIDataProviderValue"), &Z_Registration_Info_UScriptStruct_AIDataProviderValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAIDataProviderValue), 4140279719U) },
		{ FAIDataProviderTypedValue::StaticStruct, Z_Construct_UScriptStruct_FAIDataProviderTypedValue_Statics::NewStructOps, TEXT("AIDataProviderTypedValue"), &Z_Registration_Info_UScriptStruct_AIDataProviderTypedValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAIDataProviderTypedValue), 409940200U) },
		...
		{ FAIDataProviderIntValue::StaticStruct, Z_Construct_UScriptStruct_FAIDataProviderIntValue_Statics::NewStructOps, TEXT("AIDataProviderIntValue"), &Z_Registration_Info_UScriptStruct_AIDataProviderIntValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAIDataProviderIntValue), 3866966962U) },
		{ FAIDataProviderFloatValue::StaticStruct, Z_Construct_UScriptStruct_FAIDataProviderFloatValue_Statics::NewStructOps, TEXT("AIDataProviderFloatValue"), &Z_Registration_Info_UScriptStruct_AIDataProviderFloatValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAIDataProviderFloatValue), 2828399381U) },
		{ FAIDataProviderBoolValue::StaticStruct, Z_Construct_UScriptStruct_FAIDataProviderBoolValue_Statics::NewStructOps, TEXT("AIDataProviderBoolValue"), &Z_Registration_Info_UScriptStruct_AIDataProviderBoolValue, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAIDataProviderBoolValue), 4066187590U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_DataProviders_AIDataProvider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAIDataProvider, UAIDataProvider::StaticClass, TEXT("UAIDataProvider"), &Z_Registration_Info_UClass_UAIDataProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAIDataProvider), 3380246949U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_DataProviders_AIDataProvider_h_1086401746(TEXT("/Script/AIModule"),
