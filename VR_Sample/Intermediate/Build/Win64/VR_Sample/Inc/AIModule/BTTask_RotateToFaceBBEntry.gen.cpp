...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTTask_RotateToFaceBBEntry_Statics::NewProp_Precision = { "Precision", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTTask_RotateToFaceBBEntry, Precision), METADATA_PARAMS(Z_Construct_UClass_UBTTask_RotateToFaceBBEntry_Statics::NewProp_Precision_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTTask_RotateToFaceBBEntry_Statics::NewProp_Precision_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Tasks_BTTask_RotateToFaceBBEntry_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTTask_RotateToFaceBBEntry, UBTTask_RotateToFaceBBEntry::StaticClass, TEXT("UBTTask_RotateToFaceBBEntry"), &Z_Registration_Info_UClass_UBTTask_RotateToFaceBBEntry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTTask_RotateToFaceBBEntry), 3808481863U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Tasks_BTTask_RotateToFaceBBEntry_h_4291418952(TEXT("/Script/AIModule"),
