...
class UScriptStruct* FRecastGraphWrapper::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RecastGraphWrapper.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRecastGraphWrapper, Z_Construct_UPackage__Script_AIModule(), TEXT("RecastGraphWrapper"));
	}
...
template<> AIMODULE_API UScriptStruct* StaticStruct<FRecastGraphWrapper>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FRecastGraphWrapper_Statics::NewProp_RecastNavMeshActor = { "RecastNavMeshActor", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRecastGraphWrapper, RecastNavMeshActor), Z_Construct_UClass_ARecastNavMesh_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FRecastGraphWrapper_Statics::NewProp_RecastNavMeshActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRecastGraphWrapper_Statics::NewProp_RecastNavMeshActor_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Navigation_RecastGraphAStar_h_Statics::ScriptStructInfo[] = {
		{ FRecastGraphWrapper::StaticStruct, Z_Construct_UScriptStruct_FRecastGraphWrapper_Statics::NewStructOps, TEXT("RecastGraphWrapper"), &Z_Registration_Info_UScriptStruct_RecastGraphWrapper, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRecastGraphWrapper), 1944750447U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Navigation_RecastGraphAStar_h_4253290019(TEXT("/Script/AIModule"),
		nullptr, 0,
