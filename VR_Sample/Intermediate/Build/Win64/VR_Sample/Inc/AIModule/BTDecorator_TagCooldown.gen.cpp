...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBTDecorator_TagCooldown_Statics::NewProp_CooldownDuration = { "CooldownDuration", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBTDecorator_TagCooldown, CooldownDuration), METADATA_PARAMS(Z_Construct_UClass_UBTDecorator_TagCooldown_Statics::NewProp_CooldownDuration_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBTDecorator_TagCooldown_Statics::NewProp_CooldownDuration_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Decorators_BTDecorator_TagCooldown_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBTDecorator_TagCooldown, UBTDecorator_TagCooldown::StaticClass, TEXT("UBTDecorator_TagCooldown"), &Z_Registration_Info_UClass_UBTDecorator_TagCooldown, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBTDecorator_TagCooldown), 2485163751U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_BehaviorTree_Decorators_BTDecorator_TagCooldown_h_1020166827(TEXT("/Script/AIModule"),
