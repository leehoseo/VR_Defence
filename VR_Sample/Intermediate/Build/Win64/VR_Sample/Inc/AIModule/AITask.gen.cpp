...
// End Cross Module References
	...
	static UEnum* EAITaskPriority_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAITaskPriority.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AIModule_EAITaskPriority, Z_Construct_UPackage__Script_AIModule(), TEXT("EAITaskPriority"));
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Tasks_AITask_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAITask, UAITask::StaticClass, TEXT("UAITask"), &Z_Registration_Info_UClass_UAITask, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAITask), 3333113318U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AIModule_Classes_Tasks_AITask_h_2723670681(TEXT("/Script/AIModule"),
