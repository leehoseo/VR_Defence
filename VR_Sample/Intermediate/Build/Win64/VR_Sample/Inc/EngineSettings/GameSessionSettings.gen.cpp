...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxSpectators = { "MaxSpectators", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameSessionSettings, MaxSpectators), METADATA_PARAMS(Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxSpectators_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxSpectators_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxPlayers = { "MaxPlayers", nullptr, (EPropertyFlags)0x0010000000044001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGameSessionSettings, MaxPlayers), METADATA_PARAMS(Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxPlayers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSessionSettings_Statics::NewProp_MaxPlayers_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_EngineSettings_Classes_GameSessionSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameSessionSettings, UGameSessionSettings::StaticClass, TEXT("UGameSessionSettings"), &Z_Registration_Info_UClass_UGameSessionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSessionSettings), 2453086638U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_EngineSettings_Classes_GameSessionSettings_h_329187212(TEXT("/Script/EngineSettings"),
