...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UBodySetupCore_Statics::NewProp_BoneName = { "BoneName", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBodySetupCore, BoneName), METADATA_PARAMS(Z_Construct_UClass_UBodySetupCore_Statics::NewProp_BoneName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBodySetupCore_Statics::NewProp_BoneName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBodySetupCore_Statics::NewProp_PhysicsType = { "PhysicsType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBodySetupCore, PhysicsType), Z_Construct_UEnum_PhysicsCore_EPhysicsType, METADATA_PARAMS(Z_Construct_UClass_UBodySetupCore_Statics::NewProp_PhysicsType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBodySetupCore_Statics::NewProp_PhysicsType_MetaData)) }; // 3667393612
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_PhysicsCore_Public_BodySetupCore_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBodySetupCore, UBodySetupCore::StaticClass, TEXT("UBodySetupCore"), &Z_Registration_Info_UClass_UBodySetupCore, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBodySetupCore), 3676041875U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_PhysicsCore_Public_BodySetupCore_h_2123727011(TEXT("/Script/PhysicsCore"),
