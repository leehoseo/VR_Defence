...
// End Cross Module References
	...
	static UEnum* ECollisionTraceFlag_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECollisionTraceFlag.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PhysicsCore_ECollisionTraceFlag, Z_Construct_UPackage__Script_PhysicsCore(), TEXT("ECollisionTraceFlag"));
		}
	...
	static UEnum* EPhysicsType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPhysicsType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PhysicsCore_EPhysicsType, Z_Construct_UPackage__Script_PhysicsCore(), TEXT("EPhysicsType"));
		}
	...
	static UEnum* EBodyCollisionResponse_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EBodyCollisionResponse.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_PhysicsCore_EBodyCollisionResponse, Z_Construct_UPackage__Script_PhysicsCore(), TEXT("EBodyCollisionResponse"));
		}
