...
class UScriptStruct* FJsonObjectWrapper::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_JsonObjectWrapper.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FJsonObjectWrapper, Z_Construct_UPackage__Script_JsonUtilities(), TEXT("JsonObjectWrapper"));
	}
...
template<> JSONUTILITIES_API UScriptStruct* StaticStruct<FJsonObjectWrapper>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_JsonUtilities_Public_JsonObjectWrapper_h_Statics::ScriptStructInfo[] = {
		{ FJsonObjectWrapper::StaticStruct, Z_Construct_UScriptStruct_FJsonObjectWrapper_Statics::NewStructOps, TEXT("JsonObjectWrapper"), &Z_Registration_Info_UScriptStruct_JsonObjectWrapper, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FJsonObjectWrapper), 1666906557U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_JsonUtilities_Public_JsonObjectWrapper_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UJsonUtilitiesDummyObject, UJsonUtilitiesDummyObject::StaticClass, TEXT("UJsonUtilitiesDummyObject"), &Z_Registration_Info_UClass_UJsonUtilitiesDummyObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UJsonUtilitiesDummyObject), 2837697500U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_JsonUtilities_Public_JsonObjectWrapper_h_1579385699(TEXT("/Script/JsonUtilities"),
