...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPaperRuntimeSettings_Statics::NewProp_bEnableTerrainSplineEditing = { "bEnableTerrainSplineEditing", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPaperRuntimeSettings), &Z_Construct_UClass_UPaperRuntimeSettings_Statics::NewProp_bEnableTerrainSplineEditing_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPaperRuntimeSettings_Statics::NewProp_bEnableTerrainSplineEditing_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPaperRuntimeSettings_Statics::NewProp_bEnableTerrainSplineEditing_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPaperRuntimeSettings_Statics::NewProp_bResizeSpriteDataToMatchTextures = { "bResizeSpriteDataToMatchTextures", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPaperRuntimeSettings), &Z_Construct_UClass_UPaperRuntimeSettings_Statics::NewProp_bResizeSpriteDataToMatchTextures_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPaperRuntimeSettings_Statics::NewProp_bResizeSpriteDataToMatchTextures_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPaperRuntimeSettings_Statics::NewProp_bResizeSpriteDataToMatchTextures_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_PaperRuntimeSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPaperRuntimeSettings, UPaperRuntimeSettings::StaticClass, TEXT("UPaperRuntimeSettings"), &Z_Registration_Info_UClass_UPaperRuntimeSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPaperRuntimeSettings), 1084703134U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_PaperRuntimeSettings_h_2253048078(TEXT("/Script/Paper2D"),
