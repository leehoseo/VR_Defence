...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APaperTileMapActor_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APaperTileMapActor_Statics::NewProp_RenderComponent_MetaData[] = {
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_APaperTileMapActor_Statics::NewProp_RenderComponent = { "RenderComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APaperTileMapActor, RenderComponent), Z_Construct_UClass_UPaperTileMapComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_APaperTileMapActor_Statics::NewProp_RenderComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APaperTileMapActor_Statics::NewProp_RenderComponent_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_PaperTileMapActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APaperTileMapActor, APaperTileMapActor::StaticClass, TEXT("APaperTileMapActor"), &Z_Registration_Info_UClass_APaperTileMapActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APaperTileMapActor), 3337858778U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_PaperTileMapActor_h_4002412177(TEXT("/Script/Paper2D"),
