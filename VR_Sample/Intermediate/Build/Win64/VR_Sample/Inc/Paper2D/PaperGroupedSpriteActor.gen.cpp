...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_APaperGroupedSpriteActor_Statics::NewProp_RenderComponent = { "RenderComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APaperGroupedSpriteActor, RenderComponent), Z_Construct_UClass_UPaperGroupedSpriteComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_APaperGroupedSpriteActor_Statics::NewProp_RenderComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APaperGroupedSpriteActor_Statics::NewProp_RenderComponent_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_PaperGroupedSpriteActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APaperGroupedSpriteActor, APaperGroupedSpriteActor::StaticClass, TEXT("APaperGroupedSpriteActor"), &Z_Registration_Info_UClass_APaperGroupedSpriteActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APaperGroupedSpriteActor), 4211948876U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_PaperGroupedSpriteActor_h_2654994838(TEXT("/Script/Paper2D"),
