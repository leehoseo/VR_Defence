...
class UScriptStruct* FSpriteDrawCallRecord::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SpriteDrawCallRecord.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSpriteDrawCallRecord, Z_Construct_UPackage__Script_Paper2D(), TEXT("SpriteDrawCallRecord"));
	}
...
template<> PAPER2D_API UScriptStruct* StaticStruct<FSpriteDrawCallRecord>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSpriteDrawCallRecord_Statics::NewProp_Destination = { "Destination", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSpriteDrawCallRecord, Destination), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UScriptStruct_FSpriteDrawCallRecord_Statics::NewProp_Destination_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpriteDrawCallRecord_Statics::NewProp_Destination_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FSpriteDrawCallRecord_Statics::NewProp_BaseTexture = { "BaseTexture", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSpriteDrawCallRecord, BaseTexture), Z_Construct_UClass_UTexture_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FSpriteDrawCallRecord_Statics::NewProp_BaseTexture_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpriteDrawCallRecord_Statics::NewProp_BaseTexture_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSpriteDrawCallRecord_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSpriteDrawCallRecord, Color), Z_Construct_UScriptStruct_FColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FSpriteDrawCallRecord_Statics::NewProp_Color_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSpriteDrawCallRecord_Statics::NewProp_Color_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_SpriteDrawCall_h_Statics::ScriptStructInfo[] = {
		{ FSpriteDrawCallRecord::StaticStruct, Z_Construct_UScriptStruct_FSpriteDrawCallRecord_Statics::NewStructOps, TEXT("SpriteDrawCallRecord"), &Z_Registration_Info_UScriptStruct_SpriteDrawCallRecord, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSpriteDrawCallRecord), 4163189271U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_SpriteDrawCall_h_1524154220(TEXT("/Script/Paper2D"),
		nullptr, 0,
