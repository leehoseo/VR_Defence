...
class UScriptStruct* FIntMargin::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_IntMargin.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FIntMargin, Z_Construct_UPackage__Script_Paper2D(), TEXT("IntMargin"));
	}
...
template<> PAPER2D_API UScriptStruct* StaticStruct<FIntMargin>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Left = { "Left", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FIntMargin, Left), METADATA_PARAMS(Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Left_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Left_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Top = { "Top", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FIntMargin, Top), METADATA_PARAMS(Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Top_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Top_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Right = { "Right", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FIntMargin, Right), METADATA_PARAMS(Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Right_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Right_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Bottom = { "Bottom", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FIntMargin, Bottom), METADATA_PARAMS(Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Bottom_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FIntMargin_Statics::NewProp_Bottom_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_IntMargin_h_Statics::ScriptStructInfo[] = {
		{ FIntMargin::StaticStruct, Z_Construct_UScriptStruct_FIntMargin_Statics::NewStructOps, TEXT("IntMargin"), &Z_Registration_Info_UScriptStruct_IntMargin, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FIntMargin), 2569389401U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_IntMargin_h_830958388(TEXT("/Script/Paper2D"),
		nullptr, 0,
