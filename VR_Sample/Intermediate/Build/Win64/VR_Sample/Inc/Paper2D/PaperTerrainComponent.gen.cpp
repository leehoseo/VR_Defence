...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPaperTerrainComponent_SetTerrainColor_Statics::NewProp_NewColor = { "NewColor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PaperTerrainComponent_eventSetTerrainColor_Parms, NewColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPaperTerrainComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPaperTerrainComponent_SetTerrainColor, "SetTerrainColor" }, // 371407986
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_TerrainMaterial = { "TerrainMaterial", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPaperTerrainComponent, TerrainMaterial), Z_Construct_UClass_UPaperTerrainMaterial_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_TerrainMaterial_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_TerrainMaterial_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_bClosedSpline = { "bClosedSpline", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPaperTerrainComponent), &Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_bClosedSpline_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_bClosedSpline_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_bClosedSpline_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_bFilledSpline = { "bFilledSpline", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPaperTerrainComponent), &Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_bFilledSpline_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_bFilledSpline_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_bFilledSpline_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_AssociatedSpline = { "AssociatedSpline", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPaperTerrainComponent, AssociatedSpline), Z_Construct_UClass_UPaperTerrainSplineComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_AssociatedSpline_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_AssociatedSpline_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_TerrainColor = { "TerrainColor", nullptr, (EPropertyFlags)0x0020080200000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPaperTerrainComponent, TerrainColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_TerrainColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_TerrainColor_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_ReparamStepsPerSegment = { "ReparamStepsPerSegment", nullptr, (EPropertyFlags)0x00200c0000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPaperTerrainComponent, ReparamStepsPerSegment), METADATA_PARAMS(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_ReparamStepsPerSegment_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPaperTerrainComponent_Statics::NewProp_ReparamStepsPerSegment_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_PaperTerrainComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPaperTerrainComponent, UPaperTerrainComponent::StaticClass, TEXT("UPaperTerrainComponent"), &Z_Registration_Info_UClass_UPaperTerrainComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPaperTerrainComponent), 1760022158U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_2D_Paper2D_Source_Paper2D_Classes_PaperTerrainComponent_h_2187151717(TEXT("/Script/Paper2D"),
