...
class UScriptStruct* FUdpMockMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_UdpMockMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUdpMockMessage, Z_Construct_UPackage__Script_UdpMessaging(), TEXT("UdpMockMessage"));
	}
...
template<> UDPMESSAGING_API UScriptStruct* StaticStruct<FUdpMockMessage>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FUdpMockMessage_Statics::NewProp_Data_Inner = { "Data", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FUdpMockMessage_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FUdpMockMessage, Data), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FUdpMockMessage_Statics::NewProp_Data_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUdpMockMessage_Statics::NewProp_Data_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_UdpMessaging_Source_UdpMessaging_Private_Tests_UdpMessagingTestTypes_h_Statics::ScriptStructInfo[] = {
		{ FUdpMockMessage::StaticStruct, Z_Construct_UScriptStruct_FUdpMockMessage_Statics::NewStructOps, TEXT("UdpMockMessage"), &Z_Registration_Info_UScriptStruct_UdpMockMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUdpMockMessage), 3004696340U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Messaging_UdpMessaging_Source_UdpMessaging_Private_Tests_UdpMessagingTestTypes_h_2871376582(TEXT("/Script/UdpMessaging"),
		nullptr, 0,
