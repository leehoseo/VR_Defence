...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_AARActor_AddARComponent_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARActor_eventAddARComponent_Parms, ReturnValue), Z_Construct_UClass_UARComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_AARActor_AddARComponent_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_AARActor_AddARComponent_Statics::NewProp_ReturnValue_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AARActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AARActor_AddARComponent, "AddARComponent" }, // 1197408360
	};
#if WITH_METADATA
...
class UScriptStruct* FTrackedGeometryGroup::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TrackedGeometryGroup.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTrackedGeometryGroup, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("TrackedGeometryGroup"));
	}
...
template<> AUGMENTEDREALITY_API UScriptStruct* StaticStruct<FTrackedGeometryGroup>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FTrackedGeometryGroup_Statics::NewProp_ARActor = { "ARActor", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedGeometryGroup, ARActor), Z_Construct_UClass_AARActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedGeometryGroup_Statics::NewProp_ARActor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedGeometryGroup_Statics::NewProp_ARActor_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FTrackedGeometryGroup_Statics::NewProp_ARComponent = { "ARComponent", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedGeometryGroup, ARComponent), Z_Construct_UClass_UARComponent_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedGeometryGroup_Statics::NewProp_ARComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedGeometryGroup_Statics::NewProp_ARComponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FTrackedGeometryGroup_Statics::NewProp_TrackedGeometry = { "TrackedGeometry", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackedGeometryGroup, TrackedGeometry), Z_Construct_UClass_UARTrackedGeometry_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackedGeometryGroup_Statics::NewProp_TrackedGeometry_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackedGeometryGroup_Statics::NewProp_TrackedGeometry_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARActor_h_Statics::ScriptStructInfo[] = {
		{ FTrackedGeometryGroup::StaticStruct, Z_Construct_UScriptStruct_FTrackedGeometryGroup_Statics::NewStructOps, TEXT("TrackedGeometryGroup"), &Z_Registration_Info_UScriptStruct_TrackedGeometryGroup, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTrackedGeometryGroup), 2318234228U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AARActor, AARActor::StaticClass, TEXT("AARActor"), &Z_Registration_Info_UClass_AARActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AARActor), 2931265405U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARActor_h_2357116479(TEXT("/Script/AugmentedReality"),
