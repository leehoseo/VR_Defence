...
void EmptyLinkFunctionForGeneratedCodeAugmentedReality_init() {}
	...
	static FPackageRegistrationInfo Z_Registration_Info_UPackage__Script_AugmentedReality;
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_AugmentedReality()
	{
		if (!Z_Registration_Info_UPackage__Script_AugmentedReality.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_UARLifeCycleComponent_InstanceARActorSpawnedDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_UARLifeCycleComponent_InstanceARActorToBeDestroyedDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_UCheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy_GeoTrackingAvailabilityDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_UGetGeoLocationAsyncTaskBlueprintProxy_GetGeoLocationDelegate__DelegateSignature,
			};
			...
			UECodeGen_Private::ConstructUPackage(Z_Registration_Info_UPackage__Script_AugmentedReality.OuterSingleton, PackageParams);
		}
		return Z_Registration_Info_UPackage__Script_AugmentedReality.OuterSingleton;
	}
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_AugmentedReality(Z_Construct_UPackage__Script_AugmentedReality, TEXT("/Script/AugmentedReality"), Z_Registration_Info_UPackage__Script_AugmentedReality, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x46F991C0, 0x5F250B6F));
