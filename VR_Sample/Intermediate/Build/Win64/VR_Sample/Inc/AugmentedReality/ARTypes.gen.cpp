...
// End Cross Module References
	...
	static UEnum* EARTrackingState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARTrackingState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARTrackingState, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARTrackingState"));
		}
	...
	static UEnum* EARCaptureType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARCaptureType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARCaptureType, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARCaptureType"));
		}
	...
	static UEnum* EARLineTraceChannels_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARLineTraceChannels.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARLineTraceChannels, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARLineTraceChannels"));
		}
	...
	static UEnum* EARTrackingQuality_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARTrackingQuality.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARTrackingQuality, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARTrackingQuality"));
		}
	...
	static UEnum* EARTrackingQualityReason_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARTrackingQualityReason.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARTrackingQualityReason, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARTrackingQualityReason"));
		}
	...
	static UEnum* EARSessionStatus_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARSessionStatus.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARSessionStatus, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARSessionStatus"));
		}
	...
	static UEnum* EARWorldMappingState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARWorldMappingState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARWorldMappingState, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARWorldMappingState"));
		}
	...
	static UEnum* EARPlaneOrientation_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARPlaneOrientation.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARPlaneOrientation, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARPlaneOrientation"));
		}
	...
	static UEnum* EARObjectClassification_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARObjectClassification.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARObjectClassification, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARObjectClassification"));
		}
	...
	static UEnum* EARSpatialMeshUsageFlags_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARSpatialMeshUsageFlags.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARSpatialMeshUsageFlags, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARSpatialMeshUsageFlags"));
		}
	...
	static UEnum* EARJointTransformSpace_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARJointTransformSpace.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARJointTransformSpace, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARJointTransformSpace"));
		}
	...
	static UEnum* EARAltitudeSource_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARAltitudeSource.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARAltitudeSource, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARAltitudeSource"));
		}
...
class UScriptStruct* FARSessionStatus::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ARSessionStatus.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FARSessionStatus, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("ARSessionStatus"));
	}
...
template<> AUGMENTEDREALITY_API UScriptStruct* StaticStruct<FARSessionStatus>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FARSessionStatus_Statics::NewProp_AdditionalInfo = { "AdditionalInfo", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARSessionStatus, AdditionalInfo), METADATA_PARAMS(Z_Construct_UScriptStruct_FARSessionStatus_Statics::NewProp_AdditionalInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARSessionStatus_Statics::NewProp_AdditionalInfo_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FARSessionStatus_Statics::NewProp_Status_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FARSessionStatus_Statics::NewProp_Status = { "Status", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARSessionStatus, Status), Z_Construct_UEnum_AugmentedReality_EARSessionStatus, METADATA_PARAMS(Z_Construct_UScriptStruct_FARSessionStatus_Statics::NewProp_Status_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARSessionStatus_Statics::NewProp_Status_MetaData)) }; // 3727938175
	...
	static UEnum* EARCandidateImageOrientation_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EARCandidateImageOrientation.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_AugmentedReality_EARCandidateImageOrientation, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("EARCandidateImageOrientation"));
		}
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UARCandidateImage_GetCandidateTexture_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARCandidateImage_eventGetCandidateTexture_Parms, ReturnValue), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UARCandidateImage_GetFriendlyName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARCandidateImage_eventGetFriendlyName_Parms, ReturnValue), METADATA_PARAMS(Z_Construct_UFunction_UARCandidateImage_GetFriendlyName_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UARCandidateImage_GetFriendlyName_Statics::NewProp_ReturnValue_MetaData)) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UARCandidateImage_GetOrientation_Statics::NewProp_ReturnValue_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UARCandidateImage_GetOrientation_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARCandidateImage_eventGetOrientation_Parms, ReturnValue), Z_Construct_UEnum_AugmentedReality_EARCandidateImageOrientation, METADATA_PARAMS(nullptr, 0) }; // 2613892628
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UARCandidateImage_GetPhysicalHeight_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARCandidateImage_eventGetPhysicalHeight_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UARCandidateImage_GetPhysicalWidth_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARCandidateImage_eventGetPhysicalWidth_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UARCandidateImage_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UARCandidateImage_GetCandidateTexture, "GetCandidateTexture" }, // 2156559194
		{ &Z_Construct_UFunction_UARCandidateImage_GetFriendlyName, "GetFriendlyName" }, // 811388355
		{ &Z_Construct_UFunction_UARCandidateImage_GetOrientation, "GetOrientation" }, // 2244209983
		{ &Z_Construct_UFunction_UARCandidateImage_GetPhysicalHeight, "GetPhysicalHeight" }, // 2054556803
		{ &Z_Construct_UFunction_UARCandidateImage_GetPhysicalWidth, "GetPhysicalWidth" }, // 2724194535
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UARCandidateImage_Statics::NewProp_CandidateTexture = { "CandidateTexture", nullptr, (EPropertyFlags)0x0024080000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARCandidateImage, CandidateTexture), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UARCandidateImage_Statics::NewProp_CandidateTexture_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UARCandidateImage_Statics::NewProp_CandidateTexture_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UARCandidateImage_Statics::NewProp_Height = { "Height", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARCandidateImage, Height), METADATA_PARAMS(Z_Construct_UClass_UARCandidateImage_Statics::NewProp_Height_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UARCandidateImage_Statics::NewProp_Height_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UARCandidateImage_Statics::NewProp_Orientation_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UARCandidateObject_GetFriendlyName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARCandidateObject_eventGetFriendlyName_Parms, ReturnValue), METADATA_PARAMS(Z_Construct_UFunction_UARCandidateObject_GetFriendlyName_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UARCandidateObject_GetFriendlyName_Statics::NewProp_ReturnValue_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UARCandidateObject_SetCandidateObjectData_Statics::NewProp_InCandidateObject = { "InCandidateObject", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARCandidateObject_eventSetCandidateObjectData_Parms, InCandidateObject), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UARCandidateObject_SetCandidateObjectData_Statics::NewProp_InCandidateObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UARCandidateObject_SetCandidateObjectData_Statics::NewProp_InCandidateObject_MetaData)) };
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UARCandidateObject_SetFriendlyName_Statics::NewProp_NewName = { "NewName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARCandidateObject_eventSetFriendlyName_Parms, NewName), METADATA_PARAMS(Z_Construct_UFunction_UARCandidateObject_SetFriendlyName_Statics::NewProp_NewName_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UARCandidateObject_SetFriendlyName_Statics::NewProp_NewName_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UARCandidateObject_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UARCandidateObject_GetBoundingBox, "GetBoundingBox" }, // 2939190793
		{ &Z_Construct_UFunction_UARCandidateObject_GetCandidateObjectData, "GetCandidateObjectData" }, // 3489291206
		{ &Z_Construct_UFunction_UARCandidateObject_GetFriendlyName, "GetFriendlyName" }, // 2727140451
		{ &Z_Construct_UFunction_UARCandidateObject_SetBoundingBox, "SetBoundingBox" }, // 111923433
		{ &Z_Construct_UFunction_UARCandidateObject_SetCandidateObjectData, "SetCandidateObjectData" }, // 3223184090
		{ &Z_Construct_UFunction_UARCandidateObject_SetFriendlyName, "SetFriendlyName" }, // 317835084
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UARCandidateObject_Statics::NewProp_CandidateObjectData_Inner = { "CandidateObjectData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UARCandidateObject_Statics::NewProp_CandidateObjectData = { "CandidateObjectData", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARCandidateObject, CandidateObjectData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UARCandidateObject_Statics::NewProp_CandidateObjectData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UARCandidateObject_Statics::NewProp_CandidateObjectData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UARCandidateObject_Statics::NewProp_FriendlyName = { "FriendlyName", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARCandidateObject, FriendlyName), METADATA_PARAMS(Z_Construct_UClass_UARCandidateObject_Statics::NewProp_FriendlyName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UARCandidateObject_Statics::NewProp_FriendlyName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UARCandidateObject_Statics::NewProp_BoundingBox = { "BoundingBox", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARCandidateObject, BoundingBox), Z_Construct_UScriptStruct_FBox, METADATA_PARAMS(Z_Construct_UClass_UARCandidateObject_Statics::NewProp_BoundingBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UARCandidateObject_Statics::NewProp_BoundingBox_MetaData)) };
...
class UScriptStruct* FARVideoFormat::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ARVideoFormat.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FARVideoFormat, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("ARVideoFormat"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FARVideoFormat_Statics::NewProp_FPS = { "FPS", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARVideoFormat, FPS), METADATA_PARAMS(Z_Construct_UScriptStruct_FARVideoFormat_Statics::NewProp_FPS_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARVideoFormat_Statics::NewProp_FPS_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FARVideoFormat_Statics::NewProp_Width = { "Width", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARVideoFormat, Width), METADATA_PARAMS(Z_Construct_UScriptStruct_FARVideoFormat_Statics::NewProp_Width_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARVideoFormat_Statics::NewProp_Width_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FARVideoFormat_Statics::NewProp_Height = { "Height", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARVideoFormat, Height), METADATA_PARAMS(Z_Construct_UScriptStruct_FARVideoFormat_Statics::NewProp_Height_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARVideoFormat_Statics::NewProp_Height_MetaData)) };
...
class UScriptStruct* FARSkeletonDefinition::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ARSkeletonDefinition.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FARSkeletonDefinition, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("ARSkeletonDefinition"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_NumJoints = { "NumJoints", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARSkeletonDefinition, NumJoints), METADATA_PARAMS(Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_NumJoints_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_NumJoints_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_JointNames_Inner = { "JointNames", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_JointNames = { "JointNames", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARSkeletonDefinition, JointNames), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_JointNames_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_JointNames_MetaData)) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_ParentIndices_Inner = { "ParentIndices", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_ParentIndices = { "ParentIndices", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARSkeletonDefinition, ParentIndices), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_ParentIndices_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewProp_ParentIndices_MetaData)) };
...
class UScriptStruct* FARPose2D::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ARPose2D.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FARPose2D, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("ARPose2D"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_SkeletonDefinition = { "SkeletonDefinition", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARPose2D, SkeletonDefinition), Z_Construct_UScriptStruct_FARSkeletonDefinition, METADATA_PARAMS(Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_SkeletonDefinition_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_SkeletonDefinition_MetaData)) }; // 3438818424
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_JointLocations_Inner = { "JointLocations", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_JointLocations = { "JointLocations", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARPose2D, JointLocations), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_JointLocations_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_JointLocations_MetaData)) };
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_IsJointTracked_Inner = { "IsJointTracked", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_IsJointTracked = { "IsJointTracked", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARPose2D, IsJointTracked), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_IsJointTracked_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARPose2D_Statics::NewProp_IsJointTracked_MetaData)) };
...
class UScriptStruct* FARPose3D::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ARPose3D.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FARPose3D, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("ARPose3D"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FARPose3D_Statics::NewProp_SkeletonDefinition = { "SkeletonDefinition", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARPose3D, SkeletonDefinition), Z_Construct_UScriptStruct_FARSkeletonDefinition, METADATA_PARAMS(Z_Construct_UScriptStruct_FARPose3D_Statics::NewProp_SkeletonDefinition_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARPose3D_Statics::NewProp_SkeletonDefinition_MetaData)) }; // 3438818424
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FARPose3D_Statics::NewProp_JointTransforms = { "JointTransforms", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARPose3D, JointTransforms), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FARPose3D_Statics::NewProp_JointTransforms_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARPose3D_Statics::NewProp_JointTransforms_MetaData)) };
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FARPose3D_Statics::NewProp_IsJointTracked_Inner = { "IsJointTracked", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FARPose3D_Statics::NewProp_IsJointTracked = { "IsJointTracked", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARPose3D, IsJointTracked), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FARPose3D_Statics::NewProp_IsJointTracked_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARPose3D_Statics::NewProp_IsJointTracked_MetaData)) };
...
class UScriptStruct* FARCameraIntrinsics::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ARCameraIntrinsics.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FARCameraIntrinsics, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("ARCameraIntrinsics"));
	}
...
template<> AUGMENTEDREALITY_API UScriptStruct* StaticStruct<FARCameraIntrinsics>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARTypes_h_Statics::ScriptStructInfo[] = {
		{ FARSessionStatus::StaticStruct, Z_Construct_UScriptStruct_FARSessionStatus_Statics::NewStructOps, TEXT("ARSessionStatus"), &Z_Registration_Info_UScriptStruct_ARSessionStatus, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FARSessionStatus), 210583484U) },
		{ FARVideoFormat::StaticStruct, Z_Construct_UScriptStruct_FARVideoFormat_Statics::NewStructOps, TEXT("ARVideoFormat"), &Z_Registration_Info_UScriptStruct_ARVideoFormat, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FARVideoFormat), 145505451U) },
		{ FARSkeletonDefinition::StaticStruct, Z_Construct_UScriptStruct_FARSkeletonDefinition_Statics::NewStructOps, TEXT("ARSkeletonDefinition"), &Z_Registration_Info_UScriptStruct_ARSkeletonDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FARSkeletonDefinition), 3438818424U) },
		{ FARPose2D::StaticStruct, Z_Construct_UScriptStruct_FARPose2D_Statics::NewStructOps, TEXT("ARPose2D"), &Z_Registration_Info_UScriptStruct_ARPose2D, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FARPose2D), 3612782003U) },
		{ FARPose3D::StaticStruct, Z_Construct_UScriptStruct_FARPose3D_Statics::NewStructOps, TEXT("ARPose3D"), &Z_Registration_Info_UScriptStruct_ARPose3D, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FARPose3D), 4149675173U) },
		{ FARCameraIntrinsics::StaticStruct, Z_Construct_UScriptStruct_FARCameraIntrinsics_Statics::NewStructOps, TEXT("ARCameraIntrinsics"), &Z_Registration_Info_UScriptStruct_ARCameraIntrinsics, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FARCameraIntrinsics), 439353520U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UARTypesDummyClass, UARTypesDummyClass::StaticClass, TEXT("UARTypesDummyClass"), &Z_Registration_Info_UClass_UARTypesDummyClass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARTypesDummyClass), 4184798190U) },
		{ Z_Construct_UClass_UARCandidateImage, UARCandidateImage::StaticClass, TEXT("UARCandidateImage"), &Z_Registration_Info_UClass_UARCandidateImage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARCandidateImage), 2762471191U) },
		{ Z_Construct_UClass_UARCandidateObject, UARCandidateObject::StaticClass, TEXT("UARCandidateObject"), &Z_Registration_Info_UClass_UARCandidateObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARCandidateObject), 4165745380U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARTypes_h_1482342911(TEXT("/Script/AugmentedReality"),
