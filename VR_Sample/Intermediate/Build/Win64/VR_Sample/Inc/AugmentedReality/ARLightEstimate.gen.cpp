...
// End Cross Module References
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UARBasicLightEstimate_GetAmbientColor_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARBasicLightEstimate_eventGetAmbientColor_Parms, ReturnValue), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UARBasicLightEstimate_GetAmbientColorTemperatureKelvin_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARBasicLightEstimate_eventGetAmbientColorTemperatureKelvin_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UARBasicLightEstimate_GetAmbientIntensityLumens_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARBasicLightEstimate_eventGetAmbientIntensityLumens_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UARBasicLightEstimate_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UARBasicLightEstimate_GetAmbientColor, "GetAmbientColor" }, // 1096654658
		{ &Z_Construct_UFunction_UARBasicLightEstimate_GetAmbientColorTemperatureKelvin, "GetAmbientColorTemperatureKelvin" }, // 2439046711
		{ &Z_Construct_UFunction_UARBasicLightEstimate_GetAmbientIntensityLumens, "GetAmbientIntensityLumens" }, // 345661939
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UARBasicLightEstimate_Statics::NewProp_AmbientIntensityLumens = { "AmbientIntensityLumens", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARBasicLightEstimate, AmbientIntensityLumens), METADATA_PARAMS(Z_Construct_UClass_UARBasicLightEstimate_Statics::NewProp_AmbientIntensityLumens_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UARBasicLightEstimate_Statics::NewProp_AmbientIntensityLumens_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UARBasicLightEstimate_Statics::NewProp_AmbientColorTemperatureKelvin = { "AmbientColorTemperatureKelvin", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARBasicLightEstimate, AmbientColorTemperatureKelvin), METADATA_PARAMS(Z_Construct_UClass_UARBasicLightEstimate_Statics::NewProp_AmbientColorTemperatureKelvin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UARBasicLightEstimate_Statics::NewProp_AmbientColorTemperatureKelvin_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UARBasicLightEstimate_Statics::NewProp_AmbientColor = { "AmbientColor", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UARBasicLightEstimate, AmbientColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UClass_UARBasicLightEstimate_Statics::NewProp_AmbientColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UARBasicLightEstimate_Statics::NewProp_AmbientColor_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARLightEstimate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UARLightEstimate, UARLightEstimate::StaticClass, TEXT("UARLightEstimate"), &Z_Registration_Info_UClass_UARLightEstimate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARLightEstimate), 3323397898U) },
		{ Z_Construct_UClass_UARBasicLightEstimate, UARBasicLightEstimate::StaticClass, TEXT("UARBasicLightEstimate"), &Z_Registration_Info_UClass_UARBasicLightEstimate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARBasicLightEstimate), 52510805U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARLightEstimate_h_1280339455(TEXT("/Script/AugmentedReality"),
