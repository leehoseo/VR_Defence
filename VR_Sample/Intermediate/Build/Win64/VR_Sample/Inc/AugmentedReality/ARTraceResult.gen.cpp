...
class UScriptStruct* FARTraceResult::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ARTraceResult.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FARTraceResult, Z_Construct_UPackage__Script_AugmentedReality(), TEXT("ARTraceResult"));
	}
...
template<> AUGMENTEDREALITY_API UScriptStruct* StaticStruct<FARTraceResult>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_DistanceFromCamera = { "DistanceFromCamera", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARTraceResult, DistanceFromCamera), METADATA_PARAMS(Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_DistanceFromCamera_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_DistanceFromCamera_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_TraceChannel_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_TraceChannel = { "TraceChannel", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARTraceResult, TraceChannel), Z_Construct_UEnum_AugmentedReality_EARLineTraceChannels, METADATA_PARAMS(Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_TraceChannel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_TraceChannel_MetaData)) }; // 2496654531
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_LocalTransform = { "LocalTransform", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARTraceResult, LocalTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_LocalTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_LocalTransform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_TrackedGeometry = { "TrackedGeometry", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FARTraceResult, TrackedGeometry), Z_Construct_UClass_UARTrackedGeometry_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_TrackedGeometry_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FARTraceResult_Statics::NewProp_TrackedGeometry_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARTraceResult_h_Statics::ScriptStructInfo[] = {
		{ FARTraceResult::StaticStruct, Z_Construct_UScriptStruct_FARTraceResult_Statics::NewStructOps, TEXT("ARTraceResult"), &Z_Registration_Info_UScriptStruct_ARTraceResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FARTraceResult), 4173194508U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARTraceResult_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UARTraceResultDummy, UARTraceResultDummy::StaticClass, TEXT("UARTraceResultDummy"), &Z_Registration_Info_UClass_UARTraceResultDummy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UARTraceResultDummy), 2485654515U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AugmentedReality_Public_ARTraceResult_h_190415303(TEXT("/Script/AugmentedReality"),
