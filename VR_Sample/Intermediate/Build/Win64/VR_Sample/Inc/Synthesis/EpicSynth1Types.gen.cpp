...
// End Cross Module References
	...
	static UEnum* ESynth1OscType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynth1OscType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynth1OscType, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynth1OscType"));
		}
	...
	static UEnum* ESynthLFOType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynthLFOType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynthLFOType, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynthLFOType"));
		}
	...
	static UEnum* ESynthLFOMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynthLFOMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynthLFOMode, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynthLFOMode"));
		}
	...
	static UEnum* ESynthLFOPatchType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynthLFOPatchType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynthLFOPatchType, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynthLFOPatchType"));
		}
	...
	static UEnum* ESynthModEnvPatch_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynthModEnvPatch.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynthModEnvPatch, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynthModEnvPatch"));
		}
	...
	static UEnum* ESynthModEnvBiasPatch_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynthModEnvBiasPatch.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynthModEnvBiasPatch, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynthModEnvBiasPatch"));
		}
	...
	static UEnum* ESynthFilterType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynthFilterType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynthFilterType, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynthFilterType"));
		}
	...
	static UEnum* ESynthFilterAlgorithm_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynthFilterAlgorithm.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynthFilterAlgorithm, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynthFilterAlgorithm"));
		}
	...
	static UEnum* ESynthStereoDelayMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynthStereoDelayMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynthStereoDelayMode, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynthStereoDelayMode"));
		}
	...
	static UEnum* ESynth1PatchSource_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynth1PatchSource.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynth1PatchSource, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynth1PatchSource"));
		}
	...
	static UEnum* ESynth1PatchDestination_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynth1PatchDestination.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynth1PatchDestination, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynth1PatchDestination"));
		}
...
class UScriptStruct* FSynth1PatchCable::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Synth1PatchCable.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSynth1PatchCable, Z_Construct_UPackage__Script_Synthesis(), TEXT("Synth1PatchCable"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSynth1PatchCable_Statics::NewProp_Depth = { "Depth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSynth1PatchCable, Depth), METADATA_PARAMS(Z_Construct_UScriptStruct_FSynth1PatchCable_Statics::NewProp_Depth_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynth1PatchCable_Statics::NewProp_Depth_MetaData)) };
...
class UScriptStruct* FPatchId::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PatchId.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPatchId, Z_Construct_UPackage__Script_Synthesis(), TEXT("PatchId"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FPatchId>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPatchId_Statics::NewProp_Id = { "Id", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPatchId, Id), METADATA_PARAMS(Z_Construct_UScriptStruct_FPatchId_Statics::NewProp_Id_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPatchId_Statics::NewProp_Id_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_EpicSynth1Types_h_Statics::ScriptStructInfo[] = {
		{ FSynth1PatchCable::StaticStruct, Z_Construct_UScriptStruct_FSynth1PatchCable_Statics::NewStructOps, TEXT("Synth1PatchCable"), &Z_Registration_Info_UScriptStruct_Synth1PatchCable, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSynth1PatchCable), 2762372454U) },
		{ FPatchId::StaticStruct, Z_Construct_UScriptStruct_FPatchId_Statics::NewStructOps, TEXT("PatchId"), &Z_Registration_Info_UScriptStruct_PatchId, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPatchId), 479522648U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_EpicSynth1Types_h_1746819733(TEXT("/Script/Synthesis"),
		nullptr, 0,
