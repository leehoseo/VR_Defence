...
class UScriptStruct* FSourceEffectWaveShaperSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SourceEffectWaveShaperSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSourceEffectWaveShaperSettings, Z_Construct_UPackage__Script_Synthesis(), TEXT("SourceEffectWaveShaperSettings"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectWaveShaperSettings>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectWaveShaperSettings_Statics::NewProp_Amount = { "Amount", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectWaveShaperSettings, Amount), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectWaveShaperSettings_Statics::NewProp_Amount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectWaveShaperSettings_Statics::NewProp_Amount_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectWaveShaperSettings_Statics::NewProp_OutputGainDb = { "OutputGainDb", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectWaveShaperSettings, OutputGainDb), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectWaveShaperSettings_Statics::NewProp_OutputGainDb_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectWaveShaperSettings_Statics::NewProp_OutputGainDb_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USourceEffectWaveShaperPreset_SetSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SourceEffectWaveShaperPreset_eventSetSettings_Parms, InSettings), Z_Construct_UScriptStruct_FSourceEffectWaveShaperSettings, METADATA_PARAMS(Z_Construct_UFunction_USourceEffectWaveShaperPreset_SetSettings_Statics::NewProp_InSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USourceEffectWaveShaperPreset_SetSettings_Statics::NewProp_InSettings_MetaData)) }; // 4217657921
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectWaveShaperPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectWaveShaperPreset_SetSettings, "SetSettings" }, // 3090696737
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USourceEffectWaveShaperPreset_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USourceEffectWaveShaperPreset, Settings), Z_Construct_UScriptStruct_FSourceEffectWaveShaperSettings, METADATA_PARAMS(Z_Construct_UClass_USourceEffectWaveShaperPreset_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectWaveShaperPreset_Statics::NewProp_Settings_MetaData)) }; // 4217657921
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectWaveShaper_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USourceEffectWaveShaperPreset, USourceEffectWaveShaperPreset::StaticClass, TEXT("USourceEffectWaveShaperPreset"), &Z_Registration_Info_UClass_USourceEffectWaveShaperPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USourceEffectWaveShaperPreset), 7083557U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectWaveShaper_h_3972854923(TEXT("/Script/Synthesis"),
