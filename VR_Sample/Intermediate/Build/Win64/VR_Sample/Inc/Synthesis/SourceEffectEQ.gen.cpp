...
class UScriptStruct* FSourceEffectEQBand::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SourceEffectEQBand.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSourceEffectEQBand, Z_Construct_UPackage__Script_Synthesis(), TEXT("SourceEffectEQBand"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectEQBand>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_Frequency = { "Frequency", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectEQBand, Frequency), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_Frequency_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_Frequency_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_Bandwidth = { "Bandwidth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectEQBand, Bandwidth), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_Bandwidth_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_Bandwidth_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_GainDb = { "GainDb", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectEQBand, GainDb), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_GainDb_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_GainDb_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_bEnabled = { "bEnabled", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FSourceEffectEQBand), &Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_bEnabled_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_bEnabled_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewProp_bEnabled_MetaData)) };
...
class UScriptStruct* FSourceEffectEQSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SourceEffectEQSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSourceEffectEQSettings, Z_Construct_UPackage__Script_Synthesis(), TEXT("SourceEffectEQSettings"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectEQSettings>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSourceEffectEQSettings_Statics::NewProp_EQBands_Inner = { "EQBands", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSourceEffectEQBand, METADATA_PARAMS(nullptr, 0) }; // 2594584305
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSourceEffectEQSettings_Statics::NewProp_EQBands = { "EQBands", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectEQSettings, EQBands), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectEQSettings_Statics::NewProp_EQBands_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectEQSettings_Statics::NewProp_EQBands_MetaData)) }; // 2594584305
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectEQPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectEQPreset_SetSettings, "SetSettings" }, // 931954259
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USourceEffectEQPreset_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USourceEffectEQPreset, Settings), Z_Construct_UScriptStruct_FSourceEffectEQSettings, METADATA_PARAMS(Z_Construct_UClass_USourceEffectEQPreset_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectEQPreset_Statics::NewProp_Settings_MetaData)) }; // 2368696727
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectEQ_h_Statics::ScriptStructInfo[] = {
		{ FSourceEffectEQBand::StaticStruct, Z_Construct_UScriptStruct_FSourceEffectEQBand_Statics::NewStructOps, TEXT("SourceEffectEQBand"), &Z_Registration_Info_UScriptStruct_SourceEffectEQBand, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSourceEffectEQBand), 2594584305U) },
		{ FSourceEffectEQSettings::StaticStruct, Z_Construct_UScriptStruct_FSourceEffectEQSettings_Statics::NewStructOps, TEXT("SourceEffectEQSettings"), &Z_Registration_Info_UScriptStruct_SourceEffectEQSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSourceEffectEQSettings), 2368696727U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectEQ_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USourceEffectEQPreset, USourceEffectEQPreset::StaticClass, TEXT("USourceEffectEQPreset"), &Z_Registration_Info_UClass_USourceEffectEQPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USourceEffectEQPreset), 3493374422U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectEQ_h_3112642248(TEXT("/Script/Synthesis"),
