...
void EmptyLinkFunctionForGeneratedCodeSynthesis_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_Synthesis()
	{
		if (!Z_Registration_Info_UPackage__Script_Synthesis.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureBeginEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureBeginEventSynth2D__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureEndEvent__DelegateSignature,
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureBeginEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureBeginEventSynth2D__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureEndEvent__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_Synthesis(Z_Construct_UPackage__Script_Synthesis, TEXT("/Script/Synthesis"), Z_Registration_Info_UPackage__Script_Synthesis, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x7B16D2ED, 0xBA217A9D));
