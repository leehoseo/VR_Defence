...
// End Cross Module References
	...
	static UEnum* EStereoChannelMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EStereoChannelMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_EStereoChannelMode, Z_Construct_UPackage__Script_Synthesis(), TEXT("EStereoChannelMode"));
		}
...
class UScriptStruct* FSourceEffectMidSideSpreaderSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SourceEffectMidSideSpreaderSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings, Z_Construct_UPackage__Script_Synthesis(), TEXT("SourceEffectMidSideSpreaderSettings"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectMidSideSpreaderSettings>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_SpreadAmount = { "SpreadAmount", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectMidSideSpreaderSettings, SpreadAmount), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_SpreadAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_SpreadAmount_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_InputMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_InputMode = { "InputMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectMidSideSpreaderSettings, InputMode), Z_Construct_UEnum_Synthesis_EStereoChannelMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_InputMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_InputMode_MetaData)) }; // 622581878
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_OutputMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_OutputMode = { "OutputMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectMidSideSpreaderSettings, OutputMode), Z_Construct_UEnum_Synthesis_EStereoChannelMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_OutputMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_OutputMode_MetaData)) }; // 622581878
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_bEqualPower = { "bEqualPower", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FSourceEffectMidSideSpreaderSettings), &Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_bEqualPower_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_bEqualPower_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectMidSideSpreaderSettings_Statics::NewProp_bEqualPower_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectMidSideSpreaderPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectMidSideSpreaderPreset_SetSettings, "SetSettings" }, // 1091519218
	};
#if WITH_METADATA
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectMidSideSpreader_h_3102202035(TEXT("/Script/Synthesis"),
