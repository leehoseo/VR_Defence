...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureBeginEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/UI/Synth2DSlider.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureBeginEventSynth2D__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Synthesis, nullptr, "OnMouseCaptureBeginEventSynth2D__DelegateSignature", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureBeginEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureBeginEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams)) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureEndEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/UI/Synth2DSlider.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureEndEventSynth2D__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Synthesis, nullptr, "OnMouseCaptureEndEventSynth2D__DelegateSignature", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureEndEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureEndEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams)) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureBeginEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/UI/Synth2DSlider.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureBeginEventSynth2D__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Synthesis, nullptr, "OnControllerCaptureBeginEventSynth2D__DelegateSignature", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureBeginEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureBeginEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams)) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureEndEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/UI/Synth2DSlider.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureEndEventSynth2D__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Synthesis, nullptr, "OnControllerCaptureEndEventSynth2D__DelegateSignature", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureEndEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureEndEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Synthesis_eventOnFloatValueChangedEventSynth2D_Parms, Value), METADATA_PARAMS(nullptr, 0) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/UI/Synth2DSlider.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_Synthesis, nullptr, "OnFloatValueChangedEventSynth2D__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature_Statics::_Script_Synthesis_eventOnFloatValueChangedEventSynth2D_Parms), Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USynth2DSlider_GetValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Synth2DSlider_eventGetValue_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USynth2DSlider_GetValue_Statics::Function_MetaDataParams[] = {
		{ "Category", "Behavior" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USynth2DSlider_GetValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USynth2DSlider, nullptr, "GetValue", nullptr, nullptr, sizeof(Z_Construct_UFunction_USynth2DSlider_GetValue_Statics::Synth2DSlider_eventGetValue_Parms), Z_Construct_UFunction_USynth2DSlider_GetValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_GetValue_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54820401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USynth2DSlider_GetValue_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_GetValue_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USynth2DSlider_SetIndentHandle_Statics::NewProp_InValue = { "InValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Synth2DSlider_eventSetIndentHandle_Parms), &Z_Construct_UFunction_USynth2DSlider_SetIndentHandle_Statics::NewProp_InValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USynth2DSlider_SetIndentHandle_Statics::Function_MetaDataParams[] = {
		{ "Category", "Behavior" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USynth2DSlider_SetIndentHandle_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USynth2DSlider, nullptr, "SetIndentHandle", nullptr, nullptr, sizeof(Z_Construct_UFunction_USynth2DSlider_SetIndentHandle_Statics::Synth2DSlider_eventSetIndentHandle_Parms), Z_Construct_UFunction_USynth2DSlider_SetIndentHandle_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_SetIndentHandle_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USynth2DSlider_SetIndentHandle_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_SetIndentHandle_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_USynth2DSlider_SetLocked_Statics::NewProp_InValue = { "InValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Synth2DSlider_eventSetLocked_Parms), &Z_Construct_UFunction_USynth2DSlider_SetLocked_Statics::NewProp_InValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USynth2DSlider_SetLocked_Statics::Function_MetaDataParams[] = {
		{ "Category", "Behavior" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USynth2DSlider_SetLocked_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USynth2DSlider, nullptr, "SetLocked", nullptr, nullptr, sizeof(Z_Construct_UFunction_USynth2DSlider_SetLocked_Statics::Synth2DSlider_eventSetLocked_Parms), Z_Construct_UFunction_USynth2DSlider_SetLocked_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_SetLocked_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USynth2DSlider_SetLocked_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_SetLocked_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USynth2DSlider_SetSliderHandleColor_Statics::NewProp_InValue = { "InValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Synth2DSlider_eventSetSliderHandleColor_Parms, InValue), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USynth2DSlider_SetSliderHandleColor_Statics::Function_MetaDataParams[] = {
		{ "Category", "Appearance" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USynth2DSlider_SetSliderHandleColor_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USynth2DSlider, nullptr, "SetSliderHandleColor", nullptr, nullptr, sizeof(Z_Construct_UFunction_USynth2DSlider_SetSliderHandleColor_Statics::Synth2DSlider_eventSetSliderHandleColor_Parms), Z_Construct_UFunction_USynth2DSlider_SetSliderHandleColor_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_SetSliderHandleColor_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USynth2DSlider_SetSliderHandleColor_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_SetSliderHandleColor_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USynth2DSlider_SetStepSize_Statics::NewProp_InValue = { "InValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Synth2DSlider_eventSetStepSize_Parms, InValue), METADATA_PARAMS(nullptr, 0) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USynth2DSlider_SetStepSize_Statics::Function_MetaDataParams[] = {
		{ "Category", "Behavior" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USynth2DSlider_SetStepSize_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USynth2DSlider, nullptr, "SetStepSize", nullptr, nullptr, sizeof(Z_Construct_UFunction_USynth2DSlider_SetStepSize_Statics::Synth2DSlider_eventSetStepSize_Parms), Z_Construct_UFunction_USynth2DSlider_SetStepSize_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_SetStepSize_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USynth2DSlider_SetStepSize_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_SetStepSize_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USynth2DSlider_SetValue_Statics::NewProp_InValue = { "InValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Synth2DSlider_eventSetValue_Parms, InValue), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(nullptr, 0) };
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_USynth2DSlider_SetValue_Statics::Function_MetaDataParams[] = {
		{ "Category", "Behavior" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_USynth2DSlider_SetValue_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_USynth2DSlider, nullptr, "SetValue", nullptr, nullptr, sizeof(Z_Construct_UFunction_USynth2DSlider_SetValue_Statics::Synth2DSlider_eventSetValue_Parms), Z_Construct_UFunction_USynth2DSlider_SetValue_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_SetValue_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04820401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_USynth2DSlider_SetValue_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_USynth2DSlider_SetValue_Statics::Function_MetaDataParams)) };
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ValueX_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_ValueX;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ValueY_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_ValueY;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ValueXDelegate_MetaData[];
#endif
		static const UECodeGen_Private::FDelegatePropertyParams NewProp_ValueXDelegate;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ValueYDelegate_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_OnValueChangedX_MetaData[];
#endif
		static const UECodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnValueChangedX;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_OnValueChangedY_MetaData[];
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USynth2DSlider_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USynth2DSlider_GetValue, "GetValue" }, // 3055466517
		{ &Z_Construct_UFunction_USynth2DSlider_SetIndentHandle, "SetIndentHandle" }, // 575218951
		{ &Z_Construct_UFunction_USynth2DSlider_SetLocked, "SetLocked" }, // 3507411151
		{ &Z_Construct_UFunction_USynth2DSlider_SetSliderHandleColor, "SetSliderHandleColor" }, // 1874579754
		{ &Z_Construct_UFunction_USynth2DSlider_SetStepSize, "SetStepSize" }, // 2321317561
		{ &Z_Construct_UFunction_USynth2DSlider_SetValue, "SetValue" }, // 2299649869
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_ValueX_MetaData[] = {
		{ "Category", "Appearance" },
		{ "ClampMax", "1" },
		{ "ClampMin", "0" },
		{ "ModuleRelativePath", "Public/UI/Synth2DSlider.h" },
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_ValueX = { "ValueX", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, ValueX), METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_ValueX_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_ValueX_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_ValueY_MetaData[] = {
		{ "Category", "Appearance" },
		{ "ClampMax", "1" },
		{ "ClampMin", "0" },
		{ "ModuleRelativePath", "Public/UI/Synth2DSlider.h" },
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_ValueY = { "ValueY", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, ValueY), METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_ValueY_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_ValueY_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_ValueXDelegate_MetaData[] = {
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_WidgetStyle = { "WidgetStyle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, WidgetStyle), Z_Construct_UScriptStruct_FSynth2DSliderStyle, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_WidgetStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_WidgetStyle_MetaData)) }; // 754713063
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_SliderHandleColor_MetaData[] = {
		{ "Category", "Appearance" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_SliderHandleColor = { "SliderHandleColor", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, SliderHandleColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_SliderHandleColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_SliderHandleColor_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_IndentHandle_MetaData[] = {
		{ "Category", "Appearance" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_IndentHandle = { "IndentHandle", nullptr, (EPropertyFlags)0x0010040000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USynth2DSlider), &Z_Construct_UClass_USynth2DSlider_Statics::NewProp_IndentHandle_SetBit, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_IndentHandle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_IndentHandle_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_Locked_MetaData[] = {
		{ "Category", "Appearance" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_Locked = { "Locked", nullptr, (EPropertyFlags)0x0010040000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USynth2DSlider), &Z_Construct_UClass_USynth2DSlider_Statics::NewProp_Locked_SetBit, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_Locked_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_Locked_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_StepSize_MetaData[] = {
		{ "Category", "Appearance" },
		{ "ClampMax", "1" },
		{ "ClampMin", "0" },
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_StepSize = { "StepSize", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, StepSize), METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_StepSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_StepSize_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_IsFocusable_MetaData[] = {
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_IsFocusable = { "IsFocusable", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USynth2DSlider), &Z_Construct_UClass_USynth2DSlider_Statics::NewProp_IsFocusable_SetBit, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_IsFocusable_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_IsFocusable_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnMouseCaptureBegin_MetaData[] = {
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnMouseCaptureBegin = { "OnMouseCaptureBegin", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, OnMouseCaptureBegin), Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureBeginEventSynth2D__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnMouseCaptureBegin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnMouseCaptureBegin_MetaData)) }; // 2914598308
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnMouseCaptureEnd_MetaData[] = {
		{ "Category", "Widget Event" },
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnMouseCaptureEnd = { "OnMouseCaptureEnd", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, OnMouseCaptureEnd), Z_Construct_UDelegateFunction_Synthesis_OnMouseCaptureEndEventSynth2D__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnMouseCaptureEnd_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnMouseCaptureEnd_MetaData)) }; // 4246386259
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnControllerCaptureBegin_MetaData[] = {
		{ "Category", "Widget Event" },
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnControllerCaptureBegin = { "OnControllerCaptureBegin", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, OnControllerCaptureBegin), Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureBeginEventSynth2D__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnControllerCaptureBegin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnControllerCaptureBegin_MetaData)) }; // 829273059
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnControllerCaptureEnd_MetaData[] = {
		{ "Category", "Widget Event" },
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnControllerCaptureEnd = { "OnControllerCaptureEnd", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, OnControllerCaptureEnd), Z_Construct_UDelegateFunction_Synthesis_OnControllerCaptureEndEventSynth2D__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnControllerCaptureEnd_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnControllerCaptureEnd_MetaData)) }; // 865494705
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnValueChangedX_MetaData[] = {
		{ "Category", "Widget Event" },
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnValueChangedX = { "OnValueChangedX", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, OnValueChangedX), Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnValueChangedX_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnValueChangedX_MetaData)) }; // 2573031244
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnValueChangedY_MetaData[] = {
		{ "Category", "Widget Event" },
		{ "Comment", "/** Called when the value is changed by slider or typing. */" },
		{ "ModuleRelativePath", "Public/UI/Synth2DSlider.h" },
		{ "ToolTip", "Called when the value is changed by slider or typing." },
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnValueChangedY = { "OnValueChangedY", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynth2DSlider, OnValueChangedY), Z_Construct_UDelegateFunction_Synthesis_OnFloatValueChangedEventSynth2D__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnValueChangedY_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::NewProp_OnValueChangedY_MetaData)) }; // 2573031244
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_USynth2DSlider_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USynth2DSlider_Statics::ClassParams = {
		...
		0,
		0x00B000A0u,
		METADATA_PARAMS(Z_Construct_UClass_USynth2DSlider_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USynth2DSlider_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_Synth2DSlider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USynth2DSlider, USynth2DSlider::StaticClass, TEXT("USynth2DSlider"), &Z_Registration_Info_UClass_USynth2DSlider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USynth2DSlider), 1305042030U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_Synth2DSlider_h_3858264731(TEXT("/Script/Synthesis"),
