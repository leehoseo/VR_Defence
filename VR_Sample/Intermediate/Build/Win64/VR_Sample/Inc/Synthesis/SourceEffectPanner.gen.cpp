...
class UScriptStruct* FSourceEffectPannerSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SourceEffectPannerSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSourceEffectPannerSettings, Z_Construct_UPackage__Script_Synthesis(), TEXT("SourceEffectPannerSettings"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectPannerSettings>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USourceEffectPannerPreset_SetSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SourceEffectPannerPreset_eventSetSettings_Parms, InSettings), Z_Construct_UScriptStruct_FSourceEffectPannerSettings, METADATA_PARAMS(Z_Construct_UFunction_USourceEffectPannerPreset_SetSettings_Statics::NewProp_InSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USourceEffectPannerPreset_SetSettings_Statics::NewProp_InSettings_MetaData)) }; // 2950303505
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectPannerPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectPannerPreset_SetSettings, "SetSettings" }, // 1411775927
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USourceEffectPannerPreset_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USourceEffectPannerPreset, Settings), Z_Construct_UScriptStruct_FSourceEffectPannerSettings, METADATA_PARAMS(Z_Construct_UClass_USourceEffectPannerPreset_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectPannerPreset_Statics::NewProp_Settings_MetaData)) }; // 2950303505
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectPanner_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USourceEffectPannerPreset, USourceEffectPannerPreset::StaticClass, TEXT("USourceEffectPannerPreset"), &Z_Registration_Info_UClass_USourceEffectPannerPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USourceEffectPannerPreset), 4103117773U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectPanner_h_4060935933(TEXT("/Script/Synthesis"),
