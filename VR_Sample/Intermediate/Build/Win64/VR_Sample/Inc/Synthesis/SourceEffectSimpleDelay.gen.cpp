...
class UScriptStruct* FSourceEffectSimpleDelaySettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SourceEffectSimpleDelaySettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings, Z_Construct_UPackage__Script_Synthesis(), TEXT("SourceEffectSimpleDelaySettings"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectSimpleDelaySettings>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_SpeedOfSound = { "SpeedOfSound", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectSimpleDelaySettings, SpeedOfSound), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_SpeedOfSound_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_SpeedOfSound_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_DelayAmount = { "DelayAmount", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectSimpleDelaySettings, DelayAmount), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_DelayAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_DelayAmount_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_DryAmount = { "DryAmount", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectSimpleDelaySettings, DryAmount), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_DryAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_DryAmount_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_WetAmount = { "WetAmount", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectSimpleDelaySettings, WetAmount), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_WetAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_WetAmount_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_Feedback = { "Feedback", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectSimpleDelaySettings, Feedback), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_Feedback_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_Feedback_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_bDelayBasedOnDistance = { "bDelayBasedOnDistance", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FSourceEffectSimpleDelaySettings), &Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_bDelayBasedOnDistance_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_bDelayBasedOnDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewProp_bDelayBasedOnDistance_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USourceEffectSimpleDelayPreset_SetSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SourceEffectSimpleDelayPreset_eventSetSettings_Parms, InSettings), Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings, METADATA_PARAMS(Z_Construct_UFunction_USourceEffectSimpleDelayPreset_SetSettings_Statics::NewProp_InSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USourceEffectSimpleDelayPreset_SetSettings_Statics::NewProp_InSettings_MetaData)) }; // 2561355546
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectSimpleDelayPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectSimpleDelayPreset_SetSettings, "SetSettings" }, // 1902873367
	};
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectSimpleDelay_h_Statics::ScriptStructInfo[] = {
		{ FSourceEffectSimpleDelaySettings::StaticStruct, Z_Construct_UScriptStruct_FSourceEffectSimpleDelaySettings_Statics::NewStructOps, TEXT("SourceEffectSimpleDelaySettings"), &Z_Registration_Info_UScriptStruct_SourceEffectSimpleDelaySettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSourceEffectSimpleDelaySettings), 2561355546U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectSimpleDelay_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USourceEffectSimpleDelayPreset, USourceEffectSimpleDelayPreset::StaticClass, TEXT("USourceEffectSimpleDelayPreset"), &Z_Registration_Info_UClass_USourceEffectSimpleDelayPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USourceEffectSimpleDelayPreset), 4071314304U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectSimpleDelay_h_2883538798(TEXT("/Script/Synthesis"),
