...
class UScriptStruct* FSynth2DSliderStyle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Synth2DSliderStyle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSynth2DSliderStyle, Z_Construct_UPackage__Script_Synthesis(), TEXT("Synth2DSliderStyle"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSynth2DSliderStyle>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_NormalThumbImage = { "NormalThumbImage", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSynth2DSliderStyle, NormalThumbImage), Z_Construct_UScriptStruct_FSlateBrush, METADATA_PARAMS(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_NormalThumbImage_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_NormalThumbImage_MetaData)) }; // 852902259
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_DisabledThumbImage = { "DisabledThumbImage", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSynth2DSliderStyle, DisabledThumbImage), Z_Construct_UScriptStruct_FSlateBrush, METADATA_PARAMS(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_DisabledThumbImage_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_DisabledThumbImage_MetaData)) }; // 852902259
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_NormalBarImage = { "NormalBarImage", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSynth2DSliderStyle, NormalBarImage), Z_Construct_UScriptStruct_FSlateBrush, METADATA_PARAMS(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_NormalBarImage_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_NormalBarImage_MetaData)) }; // 852902259
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_DisabledBarImage = { "DisabledBarImage", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSynth2DSliderStyle, DisabledBarImage), Z_Construct_UScriptStruct_FSlateBrush, METADATA_PARAMS(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_DisabledBarImage_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_DisabledBarImage_MetaData)) }; // 852902259
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_BackgroundImage = { "BackgroundImage", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSynth2DSliderStyle, BackgroundImage), Z_Construct_UScriptStruct_FSlateBrush, METADATA_PARAMS(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_BackgroundImage_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_BackgroundImage_MetaData)) }; // 852902259
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_BarThickness = { "BarThickness", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSynth2DSliderStyle, BarThickness), METADATA_PARAMS(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_BarThickness_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewProp_BarThickness_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_Synth2DSliderStyle_h_Statics::ScriptStructInfo[] = {
		{ FSynth2DSliderStyle::StaticStruct, Z_Construct_UScriptStruct_FSynth2DSliderStyle_Statics::NewStructOps, TEXT("Synth2DSliderStyle"), &Z_Registration_Info_UScriptStruct_Synth2DSliderStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSynth2DSliderStyle), 754713063U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_Synth2DSliderStyle_h_572851557(TEXT("/Script/Synthesis"),
		nullptr, 0,
