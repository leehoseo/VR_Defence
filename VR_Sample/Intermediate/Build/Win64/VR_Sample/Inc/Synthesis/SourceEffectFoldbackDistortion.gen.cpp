...
class UScriptStruct* FSourceEffectFoldbackDistortionSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SourceEffectFoldbackDistortionSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings, Z_Construct_UPackage__Script_Synthesis(), TEXT("SourceEffectFoldbackDistortionSettings"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectFoldbackDistortionSettings>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings_Statics::NewProp_InputGainDb = { "InputGainDb", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectFoldbackDistortionSettings, InputGainDb), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings_Statics::NewProp_InputGainDb_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings_Statics::NewProp_InputGainDb_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings_Statics::NewProp_ThresholdDb = { "ThresholdDb", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectFoldbackDistortionSettings, ThresholdDb), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings_Statics::NewProp_ThresholdDb_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings_Statics::NewProp_ThresholdDb_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings_Statics::NewProp_OutputGainDb = { "OutputGainDb", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectFoldbackDistortionSettings, OutputGainDb), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings_Statics::NewProp_OutputGainDb_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings_Statics::NewProp_OutputGainDb_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USourceEffectFoldbackDistortionPreset_SetSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SourceEffectFoldbackDistortionPreset_eventSetSettings_Parms, InSettings), Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings, METADATA_PARAMS(Z_Construct_UFunction_USourceEffectFoldbackDistortionPreset_SetSettings_Statics::NewProp_InSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USourceEffectFoldbackDistortionPreset_SetSettings_Statics::NewProp_InSettings_MetaData)) }; // 2523648674
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectFoldbackDistortionPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectFoldbackDistortionPreset_SetSettings, "SetSettings" }, // 4056600535
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USourceEffectFoldbackDistortionPreset_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USourceEffectFoldbackDistortionPreset, Settings), Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings, METADATA_PARAMS(Z_Construct_UClass_USourceEffectFoldbackDistortionPreset_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectFoldbackDistortionPreset_Statics::NewProp_Settings_MetaData)) }; // 2523648674
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectFoldbackDistortion_h_Statics::ScriptStructInfo[] = {
		{ FSourceEffectFoldbackDistortionSettings::StaticStruct, Z_Construct_UScriptStruct_FSourceEffectFoldbackDistortionSettings_Statics::NewStructOps, TEXT("SourceEffectFoldbackDistortionSettings"), &Z_Registration_Info_UScriptStruct_SourceEffectFoldbackDistortionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSourceEffectFoldbackDistortionSettings), 2523648674U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectFoldbackDistortion_h_2783767852(TEXT("/Script/Synthesis"),
