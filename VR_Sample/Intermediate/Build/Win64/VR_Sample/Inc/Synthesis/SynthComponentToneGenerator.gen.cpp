...
// End Cross Module References
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USynthComponentToneGenerator_SetFrequency_Statics::NewProp_InFrequency = { "InFrequency", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SynthComponentToneGenerator_eventSetFrequency_Parms, InFrequency), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_USynthComponentToneGenerator_SetVolume_Statics::NewProp_InVolume = { "InVolume", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SynthComponentToneGenerator_eventSetVolume_Parms, InVolume), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USynthComponentToneGenerator_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USynthComponentToneGenerator_SetFrequency, "SetFrequency" }, // 4150293999
		{ &Z_Construct_UFunction_USynthComponentToneGenerator_SetVolume, "SetVolume" }, // 497594243
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_Volume = { "Volume", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynthComponentToneGenerator, Volume), METADATA_PARAMS(Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_Volume_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_Volume_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_DistanceRange_MetaData[] = {
		{ "Category", "Attenuation" },
		{ "Comment", "/* A distance range overwhich to apply distance attenuation using the supplied curve. */" },
		{ "ModuleRelativePath", "Classes/SynthComponents/SynthComponentToneGenerator.h" },
		{ "ToolTip", "A distance range overwhich to apply distance attenuation using the supplied curve." },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_DistanceRange = { "DistanceRange", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynthComponentToneGenerator, DistanceRange), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_DistanceRange_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_DistanceRange_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_AttenuationDbAtMaxRange = { "AttenuationDbAtMaxRange", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USynthComponentToneGenerator, AttenuationDbAtMaxRange), METADATA_PARAMS(Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_AttenuationDbAtMaxRange_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USynthComponentToneGenerator_Statics::NewProp_AttenuationDbAtMaxRange_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SynthComponents_SynthComponentToneGenerator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USynthComponentToneGenerator, USynthComponentToneGenerator::StaticClass, TEXT("USynthComponentToneGenerator"), &Z_Registration_Info_UClass_USynthComponentToneGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USynthComponentToneGenerator), 668202985U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SynthComponents_SynthComponentToneGenerator_h_151417665(TEXT("/Script/Synthesis"),
