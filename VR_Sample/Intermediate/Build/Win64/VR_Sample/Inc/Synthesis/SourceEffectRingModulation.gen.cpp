...
// End Cross Module References
	...
	static UEnum* ERingModulatorTypeSourceEffect_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERingModulatorTypeSourceEffect.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ERingModulatorTypeSourceEffect, Z_Construct_UPackage__Script_Synthesis(), TEXT("ERingModulatorTypeSourceEffect"));
		}
...
class UScriptStruct* FSourceEffectRingModulationSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SourceEffectRingModulationSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings, Z_Construct_UPackage__Script_Synthesis(), TEXT("SourceEffectRingModulationSettings"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSourceEffectRingModulationSettings>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_ModulatorType = { "ModulatorType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, ModulatorType), Z_Construct_UEnum_Synthesis_ERingModulatorTypeSourceEffect, METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_ModulatorType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_ModulatorType_MetaData)) }; // 1182609657
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Frequency = { "Frequency", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, Frequency), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Frequency_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Frequency_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Depth = { "Depth", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, Depth), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Depth_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_Depth_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_DryLevel = { "DryLevel", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, DryLevel), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_DryLevel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_DryLevel_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_WetLevel = { "WetLevel", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, WetLevel), METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_WetLevel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_WetLevel_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_AudioBusModulator = { "AudioBusModulator", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSourceEffectRingModulationSettings, AudioBusModulator), Z_Construct_UClass_UAudioBus_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_AudioBusModulator_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings_Statics::NewProp_AudioBusModulator_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_USourceEffectRingModulationPreset_SetSettings_Statics::NewProp_InSettings = { "InSettings", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SourceEffectRingModulationPreset_eventSetSettings_Parms, InSettings), Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings, METADATA_PARAMS(Z_Construct_UFunction_USourceEffectRingModulationPreset_SetSettings_Statics::NewProp_InSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_USourceEffectRingModulationPreset_SetSettings_Statics::NewProp_InSettings_MetaData)) }; // 404097994
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USourceEffectRingModulationPreset_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USourceEffectRingModulationPreset_SetSettings, "SetSettings" }, // 1581817581
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USourceEffectRingModulationPreset_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USourceEffectRingModulationPreset, Settings), Z_Construct_UScriptStruct_FSourceEffectRingModulationSettings, METADATA_PARAMS(Z_Construct_UClass_USourceEffectRingModulationPreset_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USourceEffectRingModulationPreset_Statics::NewProp_Settings_MetaData)) }; // 404097994
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectRingModulation_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USourceEffectRingModulationPreset, USourceEffectRingModulationPreset::StaticClass, TEXT("USourceEffectRingModulationPreset"), &Z_Registration_Info_UClass_USourceEffectRingModulationPreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USourceEffectRingModulationPreset), 228166172U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Classes_SourceEffects_SourceEffectRingModulation_h_1022871527(TEXT("/Script/Synthesis"),
