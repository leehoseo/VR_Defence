...
// End Cross Module References
	...
	static UEnum* ESynthSlateSizeType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynthSlateSizeType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynthSlateSizeType, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynthSlateSizeType"));
		}
	...
	static UEnum* ESynthSlateColorStyle_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESynthSlateColorStyle.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Synthesis_ESynthSlateColorStyle, Z_Construct_UPackage__Script_Synthesis(), TEXT("ESynthSlateColorStyle"));
		}
...
class UScriptStruct* FSynthSlateStyle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SynthSlateStyle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSynthSlateStyle, Z_Construct_UPackage__Script_Synthesis(), TEXT("SynthSlateStyle"));
	}
...
template<> SYNTHESIS_API UScriptStruct* StaticStruct<FSynthSlateStyle>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSynthSlateStyle_Statics::NewProp_SizeType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSynthSlateStyle_Statics::NewProp_SizeType = { "SizeType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSynthSlateStyle, SizeType), Z_Construct_UEnum_Synthesis_ESynthSlateSizeType, METADATA_PARAMS(Z_Construct_UScriptStruct_FSynthSlateStyle_Statics::NewProp_SizeType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynthSlateStyle_Statics::NewProp_SizeType_MetaData)) }; // 665278135
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSynthSlateStyle_Statics::NewProp_ColorStyle_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSynthSlateStyle_Statics::NewProp_ColorStyle = { "ColorStyle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSynthSlateStyle, ColorStyle), Z_Construct_UEnum_Synthesis_ESynthSlateColorStyle, METADATA_PARAMS(Z_Construct_UScriptStruct_FSynthSlateStyle_Statics::NewProp_ColorStyle_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSynthSlateStyle_Statics::NewProp_ColorStyle_MetaData)) }; // 359545431
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_SynthSlateStyle_h_Statics::ScriptStructInfo[] = {
		{ FSynthSlateStyle::StaticStruct, Z_Construct_UScriptStruct_FSynthSlateStyle_Statics::NewStructOps, TEXT("SynthSlateStyle"), &Z_Registration_Info_UScriptStruct_SynthSlateStyle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSynthSlateStyle), 4232735529U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Plugins_Runtime_Synthesis_Source_Synthesis_Public_UI_SynthSlateStyle_h_250080924(TEXT("/Script/Synthesis"),
		nullptr, 0,
