...
class UScriptStruct* FGameplayTagRedirect::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GameplayTagRedirect.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameplayTagRedirect, Z_Construct_UPackage__Script_GameplayTags(), TEXT("GameplayTagRedirect"));
	}
...
template<> GAMEPLAYTAGS_API UScriptStruct* StaticStruct<FGameplayTagRedirect>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_GameplayTags_Public_GameplayTagRedirectors_h_Statics::ScriptStructInfo[] = {
		{ FGameplayTagRedirect::StaticStruct, Z_Construct_UScriptStruct_FGameplayTagRedirect_Statics::NewStructOps, TEXT("GameplayTagRedirect"), &Z_Registration_Info_UScriptStruct_GameplayTagRedirect, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayTagRedirect), 1902943703U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_GameplayTags_Public_GameplayTagRedirectors_h_1824524818(TEXT("/Script/GameplayTags"),
		nullptr, 0,
