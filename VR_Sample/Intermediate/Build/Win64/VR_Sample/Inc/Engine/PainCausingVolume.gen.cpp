...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bPainCausing = { "bPainCausing", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(APainCausingVolume), &Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bPainCausing_SetBit, METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bPainCausing_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bPainCausing_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_DamagePerSec = { "DamagePerSec", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APainCausingVolume, DamagePerSec), METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_DamagePerSec_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_DamagePerSec_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_PainInterval = { "PainInterval", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APainCausingVolume, PainInterval), METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_PainInterval_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_PainInterval_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bEntryPain = { "bEntryPain", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(APainCausingVolume), &Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bEntryPain_SetBit, METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bEntryPain_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_bEntryPain_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APainCausingVolume_Statics::NewProp_BACKUP_bPainCausing = { "BACKUP_bPainCausing", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(APainCausingVolume), &Z_Construct_UClass_APainCausingVolume_Statics::NewProp_BACKUP_bPainCausing_SetBit, METADATA_PARAMS(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_BACKUP_bPainCausing_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APainCausingVolume_Statics::NewProp_BACKUP_bPainCausing_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_PainCausingVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APainCausingVolume, APainCausingVolume::StaticClass, TEXT("APainCausingVolume"), &Z_Registration_Info_UClass_APainCausingVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APainCausingVolume), 1491448133U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_PainCausingVolume_h_2285665539(TEXT("/Script/Engine"),
