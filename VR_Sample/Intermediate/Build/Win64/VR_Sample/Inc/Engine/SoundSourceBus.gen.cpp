...
// End Cross Module References
	...
	static UEnum* ESourceBusChannels_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESourceBusChannels.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ESourceBusChannels, Z_Construct_UPackage__Script_Engine(), TEXT("ESourceBusChannels"));
		}
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_USoundSourceBus_Statics::NewProp_SourceBusChannels_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_USoundSourceBus_Statics::NewProp_SourceBusChannels = { "SourceBusChannels", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundSourceBus, SourceBusChannels), Z_Construct_UEnum_Engine_ESourceBusChannels, METADATA_PARAMS(Z_Construct_UClass_USoundSourceBus_Statics::NewProp_SourceBusChannels_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundSourceBus_Statics::NewProp_SourceBusChannels_MetaData)) }; // 470156343
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundSourceBus_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundSourceBus, USoundSourceBus::StaticClass, TEXT("USoundSourceBus"), &Z_Registration_Info_UClass_USoundSourceBus, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundSourceBus), 2916169600U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundSourceBus_h_3703679425(TEXT("/Script/Engine"),
