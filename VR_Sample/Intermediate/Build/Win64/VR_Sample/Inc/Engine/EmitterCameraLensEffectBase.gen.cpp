...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::NewProp_RelativeTransform = { "RelativeTransform", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEmitterCameraLensEffectBase, RelativeTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::NewProp_RelativeTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::NewProp_RelativeTransform_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::NewProp_BaseFOV = { "BaseFOV", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEmitterCameraLensEffectBase, BaseFOV), METADATA_PARAMS(Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::NewProp_BaseFOV_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::NewProp_BaseFOV_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::NewProp_DistFromCamera = { "DistFromCamera", nullptr, (EPropertyFlags)0x0040000020000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AEmitterCameraLensEffectBase, DistFromCamera_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::NewProp_DistFromCamera_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::NewProp_DistFromCamera_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AEmitterCameraLensEffectBase_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UCameraLensEffectInterface_NoRegister, (int32)VTABLE_OFFSET(AEmitterCameraLensEffectBase, ICameraLensEffectInterface), false },  // 1691392738
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_EmitterCameraLensEffectBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AEmitterCameraLensEffectBase, AEmitterCameraLensEffectBase::StaticClass, TEXT("AEmitterCameraLensEffectBase"), &Z_Registration_Info_UClass_AEmitterCameraLensEffectBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AEmitterCameraLensEffectBase), 3547580535U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_EmitterCameraLensEffectBase_h_1768202118(TEXT("/Script/Engine"),
