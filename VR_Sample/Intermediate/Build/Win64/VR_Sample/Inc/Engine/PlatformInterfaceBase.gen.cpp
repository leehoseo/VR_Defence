...
// End Cross Module References
	...
	static UEnum* EPlatformInterfaceDataType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPlatformInterfaceDataType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EPlatformInterfaceDataType, Z_Construct_UPackage__Script_Engine(), TEXT("EPlatformInterfaceDataType"));
		}
...
class UScriptStruct* FPlatformInterfaceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PlatformInterfaceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPlatformInterfaceData, Z_Construct_UPackage__Script_Engine(), TEXT("PlatformInterfaceData"));
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_DataName = { "DataName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlatformInterfaceData, DataName), METADATA_PARAMS(Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_DataName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_DataName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlatformInterfaceData, Type), Z_Construct_UEnum_Engine_EPlatformInterfaceDataType, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_Type_MetaData)) }; // 2583233413
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_IntValue = { "IntValue", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlatformInterfaceData, IntValue), METADATA_PARAMS(Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_IntValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_IntValue_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_StringValue = { "StringValue", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlatformInterfaceData, StringValue), METADATA_PARAMS(Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_StringValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_StringValue_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_ObjectValue = { "ObjectValue", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlatformInterfaceData, ObjectValue), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_ObjectValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewProp_ObjectValue_MetaData)) };
...
class UScriptStruct* FPlatformInterfaceDelegateResult::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PlatformInterfaceDelegateResult.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPlatformInterfaceDelegateResult, Z_Construct_UPackage__Script_Engine(), TEXT("PlatformInterfaceDelegateResult"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPlatformInterfaceDelegateResult_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPlatformInterfaceDelegateResult, Data), Z_Construct_UScriptStruct_FPlatformInterfaceData, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlatformInterfaceDelegateResult_Statics::NewProp_Data_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlatformInterfaceDelegateResult_Statics::NewProp_Data_MetaData)) }; // 2420744095
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_Engine_PlatformInterfaceDelegate__DelegateSignature_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventPlatformInterfaceDelegate_Parms, Result), Z_Construct_UScriptStruct_FPlatformInterfaceDelegateResult, METADATA_PARAMS(Z_Construct_UDelegateFunction_Engine_PlatformInterfaceDelegate__DelegateSignature_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_PlatformInterfaceDelegate__DelegateSignature_Statics::NewProp_Result_MetaData)) }; // 4135438476
...
class UScriptStruct* FDelegateArray::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DelegateArray.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDelegateArray, Z_Construct_UPackage__Script_Engine(), TEXT("DelegateArray"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FDelegateArray>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPlatformInterfaceBase_Statics::NewProp_AllDelegates = { "AllDelegates", nullptr, (EPropertyFlags)0x0010008000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPlatformInterfaceBase, AllDelegates), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPlatformInterfaceBase_Statics::NewProp_AllDelegates_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPlatformInterfaceBase_Statics::NewProp_AllDelegates_MetaData)) }; // 2882773634
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_PlatformInterfaceBase_h_Statics::ScriptStructInfo[] = {
		{ FPlatformInterfaceData::StaticStruct, Z_Construct_UScriptStruct_FPlatformInterfaceData_Statics::NewStructOps, TEXT("PlatformInterfaceData"), &Z_Registration_Info_UScriptStruct_PlatformInterfaceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlatformInterfaceData), 2420744095U) },
		{ FPlatformInterfaceDelegateResult::StaticStruct, Z_Construct_UScriptStruct_FPlatformInterfaceDelegateResult_Statics::NewStructOps, TEXT("PlatformInterfaceDelegateResult"), &Z_Registration_Info_UScriptStruct_PlatformInterfaceDelegateResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlatformInterfaceDelegateResult), 4135438476U) },
		{ FDelegateArray::StaticStruct, Z_Construct_UScriptStruct_FDelegateArray_Statics::NewStructOps, TEXT("DelegateArray"), &Z_Registration_Info_UScriptStruct_DelegateArray, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDelegateArray), 2882773634U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_PlatformInterfaceBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlatformInterfaceBase, UPlatformInterfaceBase::StaticClass, TEXT("UPlatformInterfaceBase"), &Z_Registration_Info_UClass_UPlatformInterfaceBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlatformInterfaceBase), 3929166367U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_PlatformInterfaceBase_h_893810278(TEXT("/Script/Engine"),
