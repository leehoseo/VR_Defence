...
class UScriptStruct* FAnimNode_TransitionResult::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_TransitionResult.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_TransitionResult, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_TransitionResult"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNode_TransitionResult>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::NewProp_bCanEnterTransition = { "bCanEnterTransition", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNode_TransitionResult), &Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::NewProp_bCanEnterTransition_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::NewProp_bCanEnterTransition_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::NewProp_bCanEnterTransition_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_TransitionResult_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_TransitionResult::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_TransitionResult_Statics::NewStructOps, TEXT("AnimNode_TransitionResult"), &Z_Registration_Info_UScriptStruct_AnimNode_TransitionResult, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_TransitionResult), 2834215532U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_TransitionResult_h_2299820320(TEXT("/Script/Engine"),
		nullptr, 0,
