...
// End Cross Module References
	...
	static UEnum* EWorldPositionIncludedOffsets_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EWorldPositionIncludedOffsets.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EWorldPositionIncludedOffsets, Z_Construct_UPackage__Script_Engine(), TEXT("EWorldPositionIncludedOffsets"));
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionWorldPosition_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionWorldPosition, UMaterialExpressionWorldPosition::StaticClass, TEXT("UMaterialExpressionWorldPosition"), &Z_Registration_Info_UClass_UMaterialExpressionWorldPosition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionWorldPosition), 2604656942U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionWorldPosition_h_1037951401(TEXT("/Script/Engine"),
