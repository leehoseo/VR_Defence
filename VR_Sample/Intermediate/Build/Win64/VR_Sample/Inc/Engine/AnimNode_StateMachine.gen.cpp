...
class UScriptStruct* FAnimationActiveTransitionEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimationActiveTransitionEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimationActiveTransitionEntry, Z_Construct_UPackage__Script_Engine(), TEXT("AnimationActiveTransitionEntry"));
	}
...
class UScriptStruct* FAnimationPotentialTransition::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimationPotentialTransition.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimationPotentialTransition, Z_Construct_UPackage__Script_Engine(), TEXT("AnimationPotentialTransition"));
	}
...
class UScriptStruct* FAnimNode_StateMachine::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_StateMachine.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_StateMachine, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_StateMachine"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNode_StateMachine>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNode_StateMachine_Statics::NewProp_StateMachineIndexInClass = { "StateMachineIndexInClass", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_StateMachine, StateMachineIndexInClass), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_StateMachine_Statics::NewProp_StateMachineIndexInClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_StateMachine_Statics::NewProp_StateMachineIndexInClass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNode_StateMachine_Statics::NewProp_MaxTransitionsPerFrame = { "MaxTransitionsPerFrame", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_StateMachine, MaxTransitionsPerFrame), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_StateMachine_Statics::NewProp_MaxTransitionsPerFrame_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_StateMachine_Statics::NewProp_MaxTransitionsPerFrame_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_StateMachine_h_Statics::ScriptStructInfo[] = {
		...
		{ FAnimNode_StateMachine::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_StateMachine_Statics::NewStructOps, TEXT("AnimNode_StateMachine"), &Z_Registration_Info_UScriptStruct_AnimNode_StateMachine, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_StateMachine), 1375648042U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_StateMachine_h_893536015(TEXT("/Script/Engine"),
		nullptr, 0,
