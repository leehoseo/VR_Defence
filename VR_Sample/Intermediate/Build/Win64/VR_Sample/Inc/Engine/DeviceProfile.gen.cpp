...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_BaseProfileName = { "BaseProfileName", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDeviceProfile, BaseProfileName), METADATA_PARAMS(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_BaseProfileName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_BaseProfileName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_Parent = { "Parent", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDeviceProfile, Parent), Z_Construct_UClass_UDeviceProfile_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_Parent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_Parent_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars_Inner = { "CVars", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars = { "CVars", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDeviceProfile, CVars), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_CVars_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_MatchingRules_Inner = { "MatchingRules", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FDPMatchingRulestruct, METADATA_PARAMS(nullptr, 0) }; // 3584970404
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDeviceProfile_Statics::NewProp_MatchingRules = { "MatchingRules", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDeviceProfile, MatchingRules), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_MatchingRules_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDeviceProfile_Statics::NewProp_MatchingRules_MetaData)) }; // 3584970404
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_DeviceProfiles_DeviceProfile_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDeviceProfile, UDeviceProfile::StaticClass, TEXT("UDeviceProfile"), &Z_Registration_Info_UClass_UDeviceProfile, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDeviceProfile), 3674383091U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_DeviceProfiles_DeviceProfile_h_262739909(TEXT("/Script/Engine"),
