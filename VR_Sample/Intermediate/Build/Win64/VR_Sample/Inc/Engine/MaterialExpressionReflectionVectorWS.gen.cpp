...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionReflectionVectorWS_Statics::NewProp_CustomWorldNormal = { "CustomWorldNormal", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionReflectionVectorWS, CustomWorldNormal), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionReflectionVectorWS_Statics::NewProp_CustomWorldNormal_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionReflectionVectorWS_Statics::NewProp_CustomWorldNormal_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionReflectionVectorWS_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionReflectionVectorWS, UMaterialExpressionReflectionVectorWS::StaticClass, TEXT("UMaterialExpressionReflectionVectorWS"), &Z_Registration_Info_UClass_UMaterialExpressionReflectionVectorWS, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionReflectionVectorWS), 3287763658U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionReflectionVectorWS_h_3441846393(TEXT("/Script/Engine"),
