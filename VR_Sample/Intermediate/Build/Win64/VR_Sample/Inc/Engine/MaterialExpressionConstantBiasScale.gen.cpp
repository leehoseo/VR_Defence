...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionConstantBiasScale_Statics::NewProp_Scale = { "Scale", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionConstantBiasScale, Scale), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionConstantBiasScale_Statics::NewProp_Scale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionConstantBiasScale_Statics::NewProp_Scale_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionConstantBiasScale_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionConstantBiasScale, UMaterialExpressionConstantBiasScale::StaticClass, TEXT("UMaterialExpressionConstantBiasScale"), &Z_Registration_Info_UClass_UMaterialExpressionConstantBiasScale, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionConstantBiasScale), 2643949794U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionConstantBiasScale_h_310603953(TEXT("/Script/Engine"),
