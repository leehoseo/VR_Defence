...
class UScriptStruct* FCullDistanceSizePair::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CullDistanceSizePair.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCullDistanceSizePair, Z_Construct_UPackage__Script_Engine(), TEXT("CullDistanceSizePair"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FCullDistanceSizePair>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_CullDistances_Inner = { "CullDistances", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FCullDistanceSizePair, METADATA_PARAMS(nullptr, 0) }; // 1788470435
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_CullDistances = { "CullDistances", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACullDistanceVolume, CullDistances), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_CullDistances_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_CullDistances_MetaData)) }; // 1788470435
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_bEnabled = { "bEnabled", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACullDistanceVolume), &Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_bEnabled_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_bEnabled_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACullDistanceVolume_Statics::NewProp_bEnabled_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CullDistanceVolume_h_Statics::ScriptStructInfo[] = {
		{ FCullDistanceSizePair::StaticStruct, Z_Construct_UScriptStruct_FCullDistanceSizePair_Statics::NewStructOps, TEXT("CullDistanceSizePair"), &Z_Registration_Info_UScriptStruct_CullDistanceSizePair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCullDistanceSizePair), 1788470435U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CullDistanceVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACullDistanceVolume, ACullDistanceVolume::StaticClass, TEXT("ACullDistanceVolume"), &Z_Registration_Info_UClass_ACullDistanceVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACullDistanceVolume), 2244312852U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CullDistanceVolume_h_3198047068(TEXT("/Script/Engine"),
