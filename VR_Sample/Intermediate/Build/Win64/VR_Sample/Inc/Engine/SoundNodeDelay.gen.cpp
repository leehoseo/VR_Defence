...
// End Cross Module References
	...
	IMPLEMENT_CLASS_NO_AUTO_REGISTRATION(USoundNodeDelay);
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DelayMin_MetaData[];
#endif
		static const UECodeGen_Private::FFloatPropertyParams NewProp_DelayMin;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DelayMax_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundNodeDelay_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/** \n * Defines a delay\n */" },
		{ "DisplayName", "Delay" },
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMin_MetaData[] = {
		{ "Category", "Delay" },
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMin = { "DelayMin", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeDelay, DelayMin), METADATA_PARAMS(Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMin_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMax_MetaData[] = {
		{ "Category", "Delay" },
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMax = { "DelayMax", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeDelay, DelayMax), METADATA_PARAMS(Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMax_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeDelay_Statics::NewProp_DelayMax_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USoundNodeDelay_Statics::ClassParams = {
		...
		0,
		0x000810A0u,
		METADATA_PARAMS(Z_Construct_UClass_USoundNodeDelay_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeDelay_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDelay_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDelay_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundNodeDelay, USoundNodeDelay::StaticClass, TEXT("USoundNodeDelay"), &Z_Registration_Info_UClass_USoundNodeDelay, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundNodeDelay), 1149304131U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDelay_h_1300653159(TEXT("/Script/Engine"),
		Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDelay_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDelay_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
