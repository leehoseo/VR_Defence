...
class UScriptStruct* FAnimNode_Root::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_Root.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_Root, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_Root"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNode_Root>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_Root_Statics::NewProp_Result = { "Result", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_Root, Result), Z_Construct_UScriptStruct_FPoseLink, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_Root_Statics::NewProp_Result_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_Root_Statics::NewProp_Result_MetaData)) }; // 2393943538
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_Root_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_Root::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_Root_Statics::NewStructOps, TEXT("AnimNode_Root"), &Z_Registration_Info_UScriptStruct_AnimNode_Root, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_Root), 2101473208U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_Root_h_2764146019(TEXT("/Script/Engine"),
		nullptr, 0,
