...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAISystemBase_Statics::NewProp_AISystemClassName = { "AISystemClassName", nullptr, (EPropertyFlags)0x0040000002044001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISystemBase, AISystemClassName), Z_Construct_UScriptStruct_FSoftClassPath, METADATA_PARAMS(Z_Construct_UClass_UAISystemBase_Statics::NewProp_AISystemClassName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISystemBase_Statics::NewProp_AISystemClassName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UAISystemBase_Statics::NewProp_AISystemModuleName = { "AISystemModuleName", nullptr, (EPropertyFlags)0x0040000002044001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAISystemBase, AISystemModuleName), METADATA_PARAMS(Z_Construct_UClass_UAISystemBase_Statics::NewProp_AISystemModuleName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISystemBase_Statics::NewProp_AISystemModuleName_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAISystemBase_Statics::NewProp_bInstantiateAISystemOnClient = { "bInstantiateAISystemOnClient", nullptr, (EPropertyFlags)0x0040000002044000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAISystemBase), &Z_Construct_UClass_UAISystemBase_Statics::NewProp_bInstantiateAISystemOnClient_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAISystemBase_Statics::NewProp_bInstantiateAISystemOnClient_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAISystemBase_Statics::NewProp_bInstantiateAISystemOnClient_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_AI_AISystemBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAISystemBase, UAISystemBase::StaticClass, TEXT("UAISystemBase"), &Z_Registration_Info_UClass_UAISystemBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAISystemBase), 2771932976U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_AI_AISystemBase_h_2284543819(TEXT("/Script/Engine"),
