...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_CapsuleComponent = { "CapsuleComponent", nullptr, (EPropertyFlags)0x0044000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANavigationObjectBase, CapsuleComponent), Z_Construct_UClass_UCapsuleComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_CapsuleComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_CapsuleComponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_GoodSprite = { "GoodSprite", nullptr, (EPropertyFlags)0x0044000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANavigationObjectBase, GoodSprite), Z_Construct_UClass_UBillboardComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_GoodSprite_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_GoodSprite_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_BadSprite = { "BadSprite", nullptr, (EPropertyFlags)0x0044000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ANavigationObjectBase, BadSprite), Z_Construct_UClass_UBillboardComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_BadSprite_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_BadSprite_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_bIsPIEPlayerStart = { "bIsPIEPlayerStart", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ANavigationObjectBase), &Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_bIsPIEPlayerStart_SetBit, METADATA_PARAMS(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_bIsPIEPlayerStart_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ANavigationObjectBase_Statics::NewProp_bIsPIEPlayerStart_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_NavigationObjectBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ANavigationObjectBase, ANavigationObjectBase::StaticClass, TEXT("ANavigationObjectBase"), &Z_Registration_Info_UClass_ANavigationObjectBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ANavigationObjectBase), 1392081147U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_NavigationObjectBase_h_665949891(TEXT("/Script/Engine"),
