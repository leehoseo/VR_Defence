...
class UScriptStruct* FPhysicalSurfaceName::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PhysicalSurfaceName.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPhysicalSurfaceName, Z_Construct_UPackage__Script_Engine(), TEXT("PhysicalSurfaceName"));
	}
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FPhysicalSurfaceName_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPhysicalSurfaceName, Type), Z_Construct_UEnum_PhysicsCore_EPhysicalSurface, METADATA_PARAMS(Z_Construct_UScriptStruct_FPhysicalSurfaceName_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicalSurfaceName_Statics::NewProp_Type_MetaData)) }; // 455643187
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPhysicalSurfaceName_Statics::NewProp_Name_MetaData[] = {
		{ "ModuleRelativePath", "Classes/PhysicsEngine/PhysicsSettings.h" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPhysicalSurfaceName_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPhysicalSurfaceName, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FPhysicalSurfaceName_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicalSurfaceName_Statics::NewProp_Name_MetaData)) };
...
class UScriptStruct* FChaosPhysicsSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ChaosPhysicsSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FChaosPhysicsSettings, Z_Construct_UPackage__Script_Engine(), TEXT("ChaosPhysicsSettings"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FChaosPhysicsSettings>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FChaosPhysicsSettings_Statics::NewProp_DefaultThreadingModel_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FChaosPhysicsSettings_Statics::NewProp_DefaultThreadingModel = { "DefaultThreadingModel", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosPhysicsSettings, DefaultThreadingModel), Z_Construct_UEnum_Chaos_EChaosThreadingMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosPhysicsSettings_Statics::NewProp_DefaultThreadingModel_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosPhysicsSettings_Statics::NewProp_DefaultThreadingModel_MetaData)) }; // 3938345797
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FChaosPhysicsSettings_Statics::NewProp_DedicatedThreadTickMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FChaosPhysicsSettings_Statics::NewProp_DedicatedThreadBufferMode = { "DedicatedThreadBufferMode", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChaosPhysicsSettings, DedicatedThreadBufferMode), Z_Construct_UEnum_Chaos_EChaosBufferMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FChaosPhysicsSettings_Statics::NewProp_DedicatedThreadBufferMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChaosPhysicsSettings_Statics::NewProp_DedicatedThreadBufferMode_MetaData)) }; // 1786541048
	...
	static UEnum* ESettingsDOF_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESettingsDOF.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ESettingsDOF, Z_Construct_UPackage__Script_Engine(), TEXT("ESettingsDOF"));
		}
	...
	static UEnum* ESettingsLockedAxis_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESettingsLockedAxis.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ESettingsLockedAxis, Z_Construct_UPackage__Script_Engine(), TEXT("ESettingsLockedAxis"));
		}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_PhysicErrorCorrection = { "PhysicErrorCorrection", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, PhysicErrorCorrection), Z_Construct_UScriptStruct_FRigidBodyErrorCorrection, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_PhysicErrorCorrection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_PhysicErrorCorrection_MetaData)) }; // 47471422
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_LockedAxis_MetaData[] = {
		{ "ModuleRelativePath", "Classes/PhysicsEngine/PhysicsSettings.h" },
	};
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_LockedAxis = { "LockedAxis", nullptr, (EPropertyFlags)0x0010000020004000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, LockedAxis_DEPRECATED), Z_Construct_UEnum_Engine_ESettingsLockedAxis, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_LockedAxis_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_LockedAxis_MetaData)) }; // 2733538474
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_DefaultDegreesOfFreedom = { "DefaultDegreesOfFreedom", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, DefaultDegreesOfFreedom), Z_Construct_UEnum_Engine_ESettingsDOF, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_DefaultDegreesOfFreedom_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_DefaultDegreesOfFreedom_MetaData)) }; // 2813334596
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSuppressFaceRemapTable = { "bSuppressFaceRemapTable", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSuppressFaceRemapTable_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSuppressFaceRemapTable_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSuppressFaceRemapTable_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSupportUVFromHitResults = { "bSupportUVFromHitResults", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSupportUVFromHitResults_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSupportUVFromHitResults_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSupportUVFromHitResults_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableActiveActors = { "bDisableActiveActors", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableActiveActors_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableActiveActors_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableActiveActors_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableKinematicStaticPairs = { "bDisableKinematicStaticPairs", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableKinematicStaticPairs_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableKinematicStaticPairs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableKinematicStaticPairs_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableCCD = { "bDisableCCD", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableCCD_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableCCD_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bDisableCCD_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bEnableEnhancedDeterminism_MetaData[] = {
		{ "Category", "Simulation" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bEnableEnhancedDeterminism = { "bEnableEnhancedDeterminism", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bEnableEnhancedDeterminism_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bEnableEnhancedDeterminism_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bEnableEnhancedDeterminism_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSimulateAnimPhysicsAfterReset = { "bSimulateAnimPhysicsAfterReset", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSimulateAnimPhysicsAfterReset_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSimulateAnimPhysicsAfterReset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSimulateAnimPhysicsAfterReset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MinPhysicsDeltaTime = { "MinPhysicsDeltaTime", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, MinPhysicsDeltaTime), METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MinPhysicsDeltaTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MinPhysicsDeltaTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MaxPhysicsDeltaTime = { "MaxPhysicsDeltaTime", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, MaxPhysicsDeltaTime), METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MaxPhysicsDeltaTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MaxPhysicsDeltaTime_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSubstepping = { "bSubstepping", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSubstepping_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSubstepping_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSubstepping_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSubsteppingAsync = { "bSubsteppingAsync", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSubsteppingAsync_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSubsteppingAsync_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bSubsteppingAsync_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bTickPhysicsAsync = { "bTickPhysicsAsync", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UPhysicsSettings), &Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bTickPhysicsAsync_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bTickPhysicsAsync_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bTickPhysicsAsync_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_AsyncFixedTimeStepSize = { "AsyncFixedTimeStepSize", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, AsyncFixedTimeStepSize), METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_AsyncFixedTimeStepSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_AsyncFixedTimeStepSize_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MaxSubstepDeltaTime = { "MaxSubstepDeltaTime", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, MaxSubstepDeltaTime), METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MaxSubstepDeltaTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MaxSubstepDeltaTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MaxSubsteps = { "MaxSubsteps", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, MaxSubsteps), METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MaxSubsteps_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_MaxSubsteps_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_InitialAverageFrameRate = { "InitialAverageFrameRate", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, InitialAverageFrameRate), METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_InitialAverageFrameRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_InitialAverageFrameRate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_PhysXTreeRebuildRate = { "PhysXTreeRebuildRate", nullptr, (EPropertyFlags)0x0010040000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, PhysXTreeRebuildRate), METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_PhysXTreeRebuildRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_PhysXTreeRebuildRate_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_PhysicalSurfaces_Inner = { "PhysicalSurfaces", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPhysicalSurfaceName, METADATA_PARAMS(nullptr, 0) }; // 4025820436
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_PhysicalSurfaces = { "PhysicalSurfaces", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, PhysicalSurfaces), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_PhysicalSurfaces_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_PhysicalSurfaces_MetaData)) }; // 4025820436
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_ChaosSettings = { "ChaosSettings", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsSettings, ChaosSettings), Z_Construct_UScriptStruct_FChaosPhysicsSettings, METADATA_PARAMS(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_ChaosSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_ChaosSettings_MetaData)) }; // 1818004025
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UPhysicsSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UPhysicsSettings_Statics::NewProp_bEnableEnhancedDeterminism,
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsSettings_h_Statics::ScriptStructInfo[] = {
		{ FPhysicalSurfaceName::StaticStruct, Z_Construct_UScriptStruct_FPhysicalSurfaceName_Statics::NewStructOps, TEXT("PhysicalSurfaceName"), &Z_Registration_Info_UScriptStruct_PhysicalSurfaceName, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPhysicalSurfaceName), 4025820436U) },
		{ FChaosPhysicsSettings::StaticStruct, Z_Construct_UScriptStruct_FChaosPhysicsSettings_Statics::NewStructOps, TEXT("ChaosPhysicsSettings"), &Z_Registration_Info_UScriptStruct_ChaosPhysicsSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FChaosPhysicsSettings), 1818004025U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPhysicsSettings, UPhysicsSettings::StaticClass, TEXT("UPhysicsSettings"), &Z_Registration_Info_UClass_UPhysicsSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPhysicsSettings), 3447737141U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsSettings_h_1483777513(TEXT("/Script/Engine"),
