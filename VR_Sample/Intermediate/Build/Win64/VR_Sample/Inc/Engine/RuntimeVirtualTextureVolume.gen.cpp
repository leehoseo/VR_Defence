...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_VirtualTextureComponent = { "VirtualTextureComponent", nullptr, (EPropertyFlags)0x00140000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARuntimeVirtualTextureVolume, VirtualTextureComponent), Z_Construct_UClass_URuntimeVirtualTextureComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_VirtualTextureComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_VirtualTextureComponent_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_Box = { "Box", nullptr, (EPropertyFlags)0x0014000800082008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ARuntimeVirtualTextureVolume, Box), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_Box_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ARuntimeVirtualTextureVolume_Statics::NewProp_Box_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_RuntimeVirtualTextureVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ARuntimeVirtualTextureVolume, ARuntimeVirtualTextureVolume::StaticClass, TEXT("ARuntimeVirtualTextureVolume"), &Z_Registration_Info_UClass_ARuntimeVirtualTextureVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ARuntimeVirtualTextureVolume), 2528532824U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_RuntimeVirtualTextureVolume_h_852790635(TEXT("/Script/Engine"),
