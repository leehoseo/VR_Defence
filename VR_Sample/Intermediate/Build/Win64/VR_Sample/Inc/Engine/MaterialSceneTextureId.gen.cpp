...
// End Cross Module References
	static FEnumRegistrationInfo Z_Registration_Info_UEnum_ESceneTextureId;
	static UEnum* ESceneTextureId_StaticEnum()
	{
		if (!Z_Registration_Info_UEnum_ESceneTextureId.OuterSingleton)
		{
			Z_Registration_Info_UEnum_ESceneTextureId.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ESceneTextureId, Z_Construct_UPackage__Script_Engine(), TEXT("ESceneTextureId"));
		}
		return Z_Registration_Info_UEnum_ESceneTextureId.OuterSingleton;
	}
	template<> ENGINE_API UEnum* StaticEnum<ESceneTextureId>()
	{
		return ESceneTextureId_StaticEnum();
	}
	struct Z_Construct_UEnum_Engine_ESceneTextureId_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_Engine_ESceneTextureId_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_Engine_ESceneTextureId_Statics::Enum_MetaDataParams[] = {
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_Engine_ESceneTextureId_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_Engine,
		nullptr,
		"ESceneTextureId",
		"ESceneTextureId",
		Z_Construct_UEnum_Engine_ESceneTextureId_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_ESceneTextureId_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::Regular,
		METADATA_PARAMS(Z_Construct_UEnum_Engine_ESceneTextureId_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_Engine_ESceneTextureId_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_Engine_ESceneTextureId()
	{
		if (!Z_Registration_Info_UEnum_ESceneTextureId.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESceneTextureId.InnerSingleton, Z_Construct_UEnum_Engine_ESceneTextureId_Statics::EnumParams);
		}
		return Z_Registration_Info_UEnum_ESceneTextureId.InnerSingleton;
	}
	struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialSceneTextureId_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialSceneTextureId_h_Statics::EnumInfo[] = {
		{ ESceneTextureId_StaticEnum, TEXT("ESceneTextureId"), &Z_Registration_Info_UEnum_ESceneTextureId, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2463287604U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialSceneTextureId_h_2365227433(TEXT("/Script/Engine"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialSceneTextureId_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialSceneTextureId_h_Statics::EnumInfo));
