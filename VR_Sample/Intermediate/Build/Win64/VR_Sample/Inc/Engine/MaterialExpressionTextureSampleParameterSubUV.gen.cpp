...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UMaterialExpressionTextureSampleParameterSubUV_Statics::NewProp_bBlend = { "bBlend", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UMaterialExpressionTextureSampleParameterSubUV), &Z_Construct_UClass_UMaterialExpressionTextureSampleParameterSubUV_Statics::NewProp_bBlend_SetBit, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionTextureSampleParameterSubUV_Statics::NewProp_bBlend_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionTextureSampleParameterSubUV_Statics::NewProp_bBlend_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionTextureSampleParameterSubUV_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionTextureSampleParameterSubUV, UMaterialExpressionTextureSampleParameterSubUV::StaticClass, TEXT("UMaterialExpressionTextureSampleParameterSubUV"), &Z_Registration_Info_UClass_UMaterialExpressionTextureSampleParameterSubUV, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionTextureSampleParameterSubUV), 1187731637U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionTextureSampleParameterSubUV_h_1724121069(TEXT("/Script/Engine"),
