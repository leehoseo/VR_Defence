...
class UScriptStruct* FStringCurveKey::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StringCurveKey.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStringCurveKey, Z_Construct_UPackage__Script_Engine(), TEXT("StringCurveKey"));
	}
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FStringCurveKey, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewProp_Value_MetaData)) };
...
class UScriptStruct* FStringCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StringCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStringCurve, Z_Construct_UPackage__Script_Engine(), TEXT("StringCurve"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FStringCurve>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_Keys = { "Keys", nullptr, (EPropertyFlags)0x0010000000000041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FStringCurve, Keys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_Keys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStringCurve_Statics::NewProp_Keys_MetaData)) }; // 2690185615
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_StringCurve_h_Statics::ScriptStructInfo[] = {
		{ FStringCurveKey::StaticStruct, Z_Construct_UScriptStruct_FStringCurveKey_Statics::NewStructOps, TEXT("StringCurveKey"), &Z_Registration_Info_UScriptStruct_StringCurveKey, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStringCurveKey), 2690185615U) },
		{ FStringCurve::StaticStruct, Z_Construct_UScriptStruct_FStringCurve_Statics::NewStructOps, TEXT("StringCurve"), &Z_Registration_Info_UScriptStruct_StringCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStringCurve), 995798380U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_StringCurve_h_1142349108(TEXT("/Script/Engine"),
		nullptr, 0,
