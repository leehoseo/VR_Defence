...
#include "Engine/Public/Elements/Component/ComponentElementSelectionInterface.h"
...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UComponentElementSelectionInterface_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UComponentElementSelectionInterface_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UTypedElementSelectionInterface_NoRegister, (int32)VTABLE_OFFSET(UComponentElementSelectionInterface, ITypedElementSelectionInterface), false },  // 331894261
		};
	const FCppClassTypeInfoStatic Z_Construct_UClass_UComponentElementSelectionInterface_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UComponentElementSelectionInterface_Statics::ClassParams = {
		...
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UComponentElementSelectionInterface_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UComponentElementSelectionInterface_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Component_ComponentElementSelectionInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UComponentElementSelectionInterface, UComponentElementSelectionInterface::StaticClass, TEXT("UComponentElementSelectionInterface"), &Z_Registration_Info_UClass_UComponentElementSelectionInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UComponentElementSelectionInterface), 1487940260U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Component_ComponentElementSelectionInterface_h_248051315(TEXT("/Script/Engine"),
