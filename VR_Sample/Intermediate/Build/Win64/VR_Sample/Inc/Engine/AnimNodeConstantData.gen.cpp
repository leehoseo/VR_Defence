...
#include "Engine/Public/Animation/AnimNodeConstantData.h"
...
class UScriptStruct* FAnimNodeConstantData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNodeConstantData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNodeConstantData, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNodeConstantData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNodeConstantData>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNodeConstantData_Statics::NewProp_NodeIndex = { "NodeIndex", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNodeConstantData, NodeIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNodeConstantData_Statics::NewProp_NodeIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNodeConstantData_Statics::NewProp_NodeIndex_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimNodeConstantData_h_Statics::ScriptStructInfo[] = {
		{ FAnimNodeConstantData::StaticStruct, Z_Construct_UScriptStruct_FAnimNodeConstantData_Statics::NewStructOps, TEXT("AnimNodeConstantData"), &Z_Registration_Info_UScriptStruct_AnimNodeConstantData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNodeConstantData), 2386520400U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimNodeConstantData_h_288940616(TEXT("/Script/Engine"),
		nullptr, 0,
