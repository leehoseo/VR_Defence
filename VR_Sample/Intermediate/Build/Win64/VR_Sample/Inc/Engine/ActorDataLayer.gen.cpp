...
class UScriptStruct* FActorDataLayer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorDataLayer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorDataLayer, Z_Construct_UPackage__Script_Engine(), TEXT("ActorDataLayer"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FActorDataLayer>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FActorDataLayer_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActorDataLayer, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FActorDataLayer_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorDataLayer_Statics::NewProp_Name_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_DataLayer_ActorDataLayer_h_Statics::ScriptStructInfo[] = {
		{ FActorDataLayer::StaticStruct, Z_Construct_UScriptStruct_FActorDataLayer_Statics::NewStructOps, TEXT("ActorDataLayer"), &Z_Registration_Info_UScriptStruct_ActorDataLayer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FActorDataLayer), 3962210771U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_DataLayer_ActorDataLayer_h_814970173(TEXT("/Script/Engine"),
		nullptr, 0,
