...
#include "Engine/Public/AssetCompilingManager.h"
...
class UScriptStruct* FAssetCompileData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AssetCompileData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAssetCompileData, Z_Construct_UPackage__Script_Engine(), TEXT("AssetCompileData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAssetCompileData>()
{
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FAssetCompileData_Statics::NewProp_Asset = { "Asset", nullptr, (EPropertyFlags)0x0014000000000004, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAssetCompileData, Asset), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAssetCompileData_Statics::NewProp_Asset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetCompileData_Statics::NewProp_Asset_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_AssetCompilingManager_h_Statics::ScriptStructInfo[] = {
		{ FAssetCompileData::StaticStruct, Z_Construct_UScriptStruct_FAssetCompileData_Statics::NewStructOps, TEXT("AssetCompileData"), &Z_Registration_Info_UScriptStruct_AssetCompileData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAssetCompileData), 347638110U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_AssetCompilingManager_h_2866212277(TEXT("/Script/Engine"),
		nullptr, 0,
