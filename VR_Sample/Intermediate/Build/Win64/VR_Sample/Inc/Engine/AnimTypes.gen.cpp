...
// End Cross Module References
	...
	static UEnum* EBoneAxis_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EBoneAxis.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EBoneAxis, Z_Construct_UPackage__Script_Engine(), TEXT("EBoneAxis"));
		}
	...
	static UEnum* EBoneControlSpace_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EBoneControlSpace.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EBoneControlSpace, Z_Construct_UPackage__Script_Engine(), TEXT("EBoneControlSpace"));
		}
	...
	static UEnum* EBoneRotationSource_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EBoneRotationSource.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EBoneRotationSource, Z_Construct_UPackage__Script_Engine(), TEXT("EBoneRotationSource"));
		}
	...
	static UEnum* EMontageNotifyTickType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMontageNotifyTickType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EMontageNotifyTickType, Z_Construct_UPackage__Script_Engine(), TEXT("EMontageNotifyTickType"));
		}
	...
	static UEnum* ENotifyFilterType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENotifyFilterType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ENotifyFilterType, Z_Construct_UPackage__Script_Engine(), TEXT("ENotifyFilterType"));
		}
...
class UScriptStruct* FPerBoneBlendWeight::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PerBoneBlendWeight.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPerBoneBlendWeight, Z_Construct_UPackage__Script_Engine(), TEXT("PerBoneBlendWeight"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPerBoneBlendWeight_Statics::NewProp_SourceIndex = { "SourceIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPerBoneBlendWeight, SourceIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FPerBoneBlendWeight_Statics::NewProp_SourceIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerBoneBlendWeight_Statics::NewProp_SourceIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPerBoneBlendWeight_Statics::NewProp_BlendWeight = { "BlendWeight", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPerBoneBlendWeight, BlendWeight), METADATA_PARAMS(Z_Construct_UScriptStruct_FPerBoneBlendWeight_Statics::NewProp_BlendWeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerBoneBlendWeight_Statics::NewProp_BlendWeight_MetaData)) };
...
class UScriptStruct* FPerBoneBlendWeights::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PerBoneBlendWeights.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPerBoneBlendWeights, Z_Construct_UPackage__Script_Engine(), TEXT("PerBoneBlendWeights"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPerBoneBlendWeights>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPerBoneBlendWeights_Statics::NewProp_BoneBlendWeights_Inner = { "BoneBlendWeights", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPerBoneBlendWeight, METADATA_PARAMS(nullptr, 0) }; // 4165084729
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPerBoneBlendWeights_Statics::NewProp_BoneBlendWeights = { "BoneBlendWeights", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPerBoneBlendWeights, BoneBlendWeights), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPerBoneBlendWeights_Statics::NewProp_BoneBlendWeights_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerBoneBlendWeights_Statics::NewProp_BoneBlendWeights_MetaData)) }; // 4165084729
...
class UScriptStruct* FAnimNotifyEvent::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNotifyEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNotifyEvent, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNotifyEvent"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNotifyEvent>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_DisplayTime = { "DisplayTime", nullptr, (EPropertyFlags)0x0010000020000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, DisplayTime_DEPRECATED), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_DisplayTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_DisplayTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_TriggerTimeOffset = { "TriggerTimeOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, TriggerTimeOffset), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_TriggerTimeOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_TriggerTimeOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_EndTriggerTimeOffset = { "EndTriggerTimeOffset", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, EndTriggerTimeOffset), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_EndTriggerTimeOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_EndTriggerTimeOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_Notify = { "Notify", nullptr, (EPropertyFlags)0x001600000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, Notify), Z_Construct_UClass_UAnimNotify_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_Notify_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_Notify_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyStateClass = { "NotifyStateClass", nullptr, (EPropertyFlags)0x001600000008000d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, NotifyStateClass), Z_Construct_UClass_UAnimNotifyState_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyStateClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyStateClass_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_Duration_MetaData[] = {
		{ "ModuleRelativePath", "Public/Animation/AnimTypes.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_Duration = { "Duration", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, Duration), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_Duration_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_Duration_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_EndLink = { "EndLink", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, EndLink), Z_Construct_UScriptStruct_FAnimLinkableElement, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_EndLink_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_EndLink_MetaData)) }; // 2516378546
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bConvertedFromBranchingPoint = { "bConvertedFromBranchingPoint", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNotifyEvent), &Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bConvertedFromBranchingPoint_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bConvertedFromBranchingPoint_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bConvertedFromBranchingPoint_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_MontageTickType = { "MontageTickType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, MontageTickType), Z_Construct_UEnum_Engine_EMontageNotifyTickType, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_MontageTickType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_MontageTickType_MetaData)) }; // 1915572903
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyTriggerChance = { "NotifyTriggerChance", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, NotifyTriggerChance), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyTriggerChance_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyTriggerChance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyFilterType = { "NotifyFilterType", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, NotifyFilterType), Z_Construct_UEnum_Engine_ENotifyFilterType, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyFilterType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyFilterType_MetaData)) }; // 2995808221
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyFilterLOD = { "NotifyFilterLOD", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, NotifyFilterLOD), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyFilterLOD_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_NotifyFilterLOD_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bTriggerOnDedicatedServer = { "bTriggerOnDedicatedServer", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNotifyEvent), &Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bTriggerOnDedicatedServer_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bTriggerOnDedicatedServer_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bTriggerOnDedicatedServer_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bTriggerOnFollower = { "bTriggerOnFollower", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAnimNotifyEvent), &Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bTriggerOnFollower_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bTriggerOnFollower_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_bTriggerOnFollower_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_Guid = { "Guid", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, Guid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_Guid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_Guid_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_TrackIndex = { "TrackIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyEvent, TrackIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_TrackIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewProp_TrackIndex_MetaData)) };
...
class UScriptStruct* FAnimSyncMarker::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimSyncMarker.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimSyncMarker, Z_Construct_UPackage__Script_Engine(), TEXT("AnimSyncMarker"));
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_MarkerName = { "MarkerName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimSyncMarker, MarkerName), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_MarkerName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_MarkerName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimSyncMarker, Time), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_Time_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_Time_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_TrackIndex = { "TrackIndex", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimSyncMarker, TrackIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_TrackIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_TrackIndex_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_Guid_MetaData[] = {
		{ "ModuleRelativePath", "Public/Animation/AnimTypes.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_Guid = { "Guid", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimSyncMarker, Guid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_Guid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewProp_Guid_MetaData)) };
#endif // WITH_EDITORONLY_DATA
...
class UScriptStruct* FAnimNotifyTrack::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNotifyTrack.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNotifyTrack, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNotifyTrack"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNotifyTrack>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNotifyTrack_Statics::NewProp_TrackColor = { "TrackColor", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNotifyTrack, TrackColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNotifyTrack_Statics::NewProp_TrackColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNotifyTrack_Statics::NewProp_TrackColor_MetaData)) };
	...
	static UEnum* EAdditiveAnimationType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAdditiveAnimationType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAdditiveAnimationType, Z_Construct_UPackage__Script_Engine(), TEXT("EAdditiveAnimationType"));
		}
	...
	static UEnum* ECurveBlendOption_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECurveBlendOption.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ECurveBlendOption, Z_Construct_UPackage__Script_Engine(), TEXT("ECurveBlendOption"));
		}
...
class UScriptStruct* FMarkerSyncData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MarkerSyncData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMarkerSyncData, Z_Construct_UPackage__Script_Engine(), TEXT("MarkerSyncData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FMarkerSyncData>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMarkerSyncData_Statics::NewProp_AuthoredSyncMarkers_Inner = { "AuthoredSyncMarkers", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FAnimSyncMarker, METADATA_PARAMS(nullptr, 0) }; // 3348822121
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FMarkerSyncData_Statics::NewProp_AuthoredSyncMarkers = { "AuthoredSyncMarkers", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMarkerSyncData, AuthoredSyncMarkers), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FMarkerSyncData_Statics::NewProp_AuthoredSyncMarkers_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMarkerSyncData_Statics::NewProp_AuthoredSyncMarkers_MetaData)) }; // 3348822121
	...
	static UEnum* EAnimInterpolationType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAnimInterpolationType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAnimInterpolationType, Z_Construct_UPackage__Script_Engine(), TEXT("EAnimInterpolationType"));
		}
	...
	static UEnum* EAxisOption_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAxisOption.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAxisOption, Z_Construct_UPackage__Script_Engine(), TEXT("EAxisOption"));
		}
	...
	static UEnum* EComponentType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EComponentType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EComponentType, Z_Construct_UPackage__Script_Engine(), TEXT("EComponentType"));
		}
...
class UScriptStruct* FTrackToSkeletonMap::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TrackToSkeletonMap.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTrackToSkeletonMap, Z_Construct_UPackage__Script_Engine(), TEXT("TrackToSkeletonMap"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FTrackToSkeletonMap_Statics::NewProp_BoneTreeIndex = { "BoneTreeIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTrackToSkeletonMap, BoneTreeIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FTrackToSkeletonMap_Statics::NewProp_BoneTreeIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTrackToSkeletonMap_Statics::NewProp_BoneTreeIndex_MetaData)) };
...
class UScriptStruct* FRawAnimSequenceTrack::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RawAnimSequenceTrack.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRawAnimSequenceTrack, Z_Construct_UPackage__Script_Engine(), TEXT("RawAnimSequenceTrack"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FRawAnimSequenceTrack>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRawAnimSequenceTrack_Statics::NewProp_PosKeys_Inner = { "PosKeys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector3f, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRawAnimSequenceTrack_Statics::NewProp_RotKeys = { "RotKeys", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRawAnimSequenceTrack, RotKeys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FRawAnimSequenceTrack_Statics::NewProp_RotKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRawAnimSequenceTrack_Statics::NewProp_RotKeys_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRawAnimSequenceTrack_Statics::NewProp_ScaleKeys_Inner = { "ScaleKeys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector3f, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetPositionalKeys_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RawAnimSequenceTrackExtensions_eventGetPositionalKeys_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetRotationalKeys_Statics::NewProp_Track = { "Track", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RawAnimSequenceTrackExtensions_eventGetRotationalKeys_Parms, Track), Z_Construct_UScriptStruct_FRawAnimSequenceTrack, METADATA_PARAMS(Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetRotationalKeys_Statics::NewProp_Track_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetRotationalKeys_Statics::NewProp_Track_MetaData)) }; // 2163747966
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetRotationalKeys_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetRotationalKeys_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RawAnimSequenceTrackExtensions_eventGetRotationalKeys_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetScaleKeys_Statics::NewProp_Track = { "Track", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RawAnimSequenceTrackExtensions_eventGetScaleKeys_Parms, Track), Z_Construct_UScriptStruct_FRawAnimSequenceTrack, METADATA_PARAMS(Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetScaleKeys_Statics::NewProp_Track_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetScaleKeys_Statics::NewProp_Track_MetaData)) }; // 2163747966
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetScaleKeys_Statics::NewProp_ReturnValue_Inner = { "ReturnValue", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetScaleKeys_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(RawAnimSequenceTrackExtensions_eventGetScaleKeys_Parms, ReturnValue), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_URawAnimSequenceTrackExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetPositionalKeys, "GetPositionalKeys" }, // 1917677779
		{ &Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetRotationalKeys, "GetRotationalKeys" }, // 3086176478
		{ &Z_Construct_UFunction_URawAnimSequenceTrackExtensions_GetScaleKeys, "GetScaleKeys" }, // 3570250895
	};
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimTypes_h_Statics::ScriptStructInfo[] = {
		{ FPerBoneBlendWeight::StaticStruct, Z_Construct_UScriptStruct_FPerBoneBlendWeight_Statics::NewStructOps, TEXT("PerBoneBlendWeight"), &Z_Registration_Info_UScriptStruct_PerBoneBlendWeight, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPerBoneBlendWeight), 4165084729U) },
		{ FPerBoneBlendWeights::StaticStruct, Z_Construct_UScriptStruct_FPerBoneBlendWeights_Statics::NewStructOps, TEXT("PerBoneBlendWeights"), &Z_Registration_Info_UScriptStruct_PerBoneBlendWeights, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPerBoneBlendWeights), 367627084U) },
		{ FAnimNotifyEvent::StaticStruct, Z_Construct_UScriptStruct_FAnimNotifyEvent_Statics::NewStructOps, TEXT("AnimNotifyEvent"), &Z_Registration_Info_UScriptStruct_AnimNotifyEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNotifyEvent), 3070810809U) },
		{ FAnimSyncMarker::StaticStruct, Z_Construct_UScriptStruct_FAnimSyncMarker_Statics::NewStructOps, TEXT("AnimSyncMarker"), &Z_Registration_Info_UScriptStruct_AnimSyncMarker, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimSyncMarker), 3348822121U) },
		{ FAnimNotifyTrack::StaticStruct, Z_Construct_UScriptStruct_FAnimNotifyTrack_Statics::NewStructOps, TEXT("AnimNotifyTrack"), &Z_Registration_Info_UScriptStruct_AnimNotifyTrack, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNotifyTrack), 1754935847U) },
		{ FMarkerSyncData::StaticStruct, Z_Construct_UScriptStruct_FMarkerSyncData_Statics::NewStructOps, TEXT("MarkerSyncData"), &Z_Registration_Info_UScriptStruct_MarkerSyncData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMarkerSyncData), 1811268998U) },
		{ FTrackToSkeletonMap::StaticStruct, Z_Construct_UScriptStruct_FTrackToSkeletonMap_Statics::NewStructOps, TEXT("TrackToSkeletonMap"), &Z_Registration_Info_UScriptStruct_TrackToSkeletonMap, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTrackToSkeletonMap), 335720836U) },
		{ FRawAnimSequenceTrack::StaticStruct, Z_Construct_UScriptStruct_FRawAnimSequenceTrack_Statics::NewStructOps, TEXT("RawAnimSequenceTrack"), &Z_Registration_Info_UScriptStruct_RawAnimSequenceTrack, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRawAnimSequenceTrack), 2163747966U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimTypes_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URawAnimSequenceTrackExtensions, URawAnimSequenceTrackExtensions::StaticClass, TEXT("URawAnimSequenceTrackExtensions"), &Z_Registration_Info_UClass_URawAnimSequenceTrackExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URawAnimSequenceTrackExtensions), 1253275345U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimTypes_h_1295832463(TEXT("/Script/Engine"),
