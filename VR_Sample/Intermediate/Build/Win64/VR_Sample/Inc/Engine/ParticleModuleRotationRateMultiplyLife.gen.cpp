...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UParticleModuleRotationRateMultiplyLife_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UParticleModuleRotationRateMultiplyLife_Statics::NewProp_LifeMultiplier_MetaData[] = {
		{ "Category", "Rotation" },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleRotationRateMultiplyLife_Statics::NewProp_LifeMultiplier = { "LifeMultiplier", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleRotationRateMultiplyLife, LifeMultiplier), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleRotationRateMultiplyLife_Statics::NewProp_LifeMultiplier_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleRotationRateMultiplyLife_Statics::NewProp_LifeMultiplier_MetaData)) }; // 3468229032
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleRotationRateMultiplyLife_Statics::ClassParams = {
		...
		0,
		0x008810A0u,
		METADATA_PARAMS(Z_Construct_UClass_UParticleModuleRotationRateMultiplyLife_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleRotationRateMultiplyLife_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_RotationRate_ParticleModuleRotationRateMultiplyLife_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_RotationRate_ParticleModuleRotationRateMultiplyLife_h_894235251(TEXT("/Script/Engine"),
