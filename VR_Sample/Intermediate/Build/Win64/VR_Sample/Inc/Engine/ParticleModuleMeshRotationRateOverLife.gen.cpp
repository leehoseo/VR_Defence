...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleMeshRotationRateOverLife_Statics::NewProp_RotRate = { "RotRate", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleMeshRotationRateOverLife, RotRate), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleMeshRotationRateOverLife_Statics::NewProp_RotRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleMeshRotationRateOverLife_Statics::NewProp_RotRate_MetaData)) }; // 3599899551
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_RotationRate_ParticleModuleMeshRotationRateOverLife_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleMeshRotationRateOverLife, UParticleModuleMeshRotationRateOverLife::StaticClass, TEXT("UParticleModuleMeshRotationRateOverLife"), &Z_Registration_Info_UClass_UParticleModuleMeshRotationRateOverLife, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleMeshRotationRateOverLife), 4233797380U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_RotationRate_ParticleModuleMeshRotationRateOverLife_h_3510939015(TEXT("/Script/Engine"),
