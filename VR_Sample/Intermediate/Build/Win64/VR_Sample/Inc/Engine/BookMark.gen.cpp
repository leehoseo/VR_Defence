...
class UScriptStruct* FBookmarkJumpToSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BookmarkJumpToSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBookmarkJumpToSettings, Z_Construct_UPackage__Script_Engine(), TEXT("BookmarkJumpToSettings"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBookmarkJumpToSettings>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBookMark_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBookMark, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UBookMark_Statics::NewProp_Location_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBookMark_Statics::NewProp_Location_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBookMark_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBookMark, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UClass_UBookMark_Statics::NewProp_Rotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBookMark_Statics::NewProp_Rotation_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UBookMark_Statics::NewProp_HiddenLevels_Inner = { "HiddenLevels", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_BookMark_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBookMark, UBookMark::StaticClass, TEXT("UBookMark"), &Z_Registration_Info_UClass_UBookMark, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBookMark), 2070290886U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_BookMark_h_4117686772(TEXT("/Script/Engine"),
