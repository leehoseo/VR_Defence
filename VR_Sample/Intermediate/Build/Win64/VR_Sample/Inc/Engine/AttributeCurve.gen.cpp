...
#include "Engine/Classes/Animation/AttributeCurve.h"
...
class UScriptStruct* FAttributeKey::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AttributeKey.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAttributeKey, Z_Construct_UPackage__Script_Engine(), TEXT("AttributeKey"));
	}
...
class UScriptStruct* FAttributeCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AttributeCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAttributeCurve, Z_Construct_UPackage__Script_Engine(), TEXT("AttributeCurve"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAttributeCurve>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAttributeCurve_Statics::NewProp_Keys_Inner = { "Keys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FAttributeKey, METADATA_PARAMS(nullptr, 0) }; // 2468506236
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAttributeCurve_Statics::NewProp_bShouldInterpolate = { "bShouldInterpolate", nullptr, (EPropertyFlags)0x0020080000002001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAttributeCurve), &Z_Construct_UScriptStruct_FAttributeCurve_Statics::NewProp_bShouldInterpolate_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAttributeCurve_Statics::NewProp_bShouldInterpolate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAttributeCurve_Statics::NewProp_bShouldInterpolate_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AttributeCurve_h_Statics::ScriptStructInfo[] = {
		{ FAttributeKey::StaticStruct, Z_Construct_UScriptStruct_FAttributeKey_Statics::NewStructOps, TEXT("AttributeKey"), &Z_Registration_Info_UScriptStruct_AttributeKey, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAttributeKey), 2468506236U) },
		{ FAttributeCurve::StaticStruct, Z_Construct_UScriptStruct_FAttributeCurve_Statics::NewStructOps, TEXT("AttributeCurve"), &Z_Registration_Info_UScriptStruct_AttributeCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAttributeCurve), 886937896U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AttributeCurve_h_211306846(TEXT("/Script/Engine"),
		nullptr, 0,
