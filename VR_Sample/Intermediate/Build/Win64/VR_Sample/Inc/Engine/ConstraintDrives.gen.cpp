...
// End Cross Module References
	...
	static UEnum* EAngularDriveMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAngularDriveMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAngularDriveMode, Z_Construct_UPackage__Script_Engine(), TEXT("EAngularDriveMode"));
		}
...
class UScriptStruct* FConstraintDrive::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ConstraintDrive.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FConstraintDrive, Z_Construct_UPackage__Script_Engine(), TEXT("ConstraintDrive"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FConstraintDrive_Statics::NewProp_Stiffness = { "Stiffness", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintDrive, Stiffness), METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintDrive_Statics::NewProp_Stiffness_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintDrive_Statics::NewProp_Stiffness_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FConstraintDrive_Statics::NewProp_Damping = { "Damping", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintDrive, Damping), METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintDrive_Statics::NewProp_Damping_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintDrive_Statics::NewProp_Damping_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FConstraintDrive_Statics::NewProp_MaxForce = { "MaxForce", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FConstraintDrive, MaxForce), METADATA_PARAMS(Z_Construct_UScriptStruct_FConstraintDrive_Statics::NewProp_MaxForce_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FConstraintDrive_Statics::NewProp_MaxForce_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FLinearDriveConstraint::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LinearDriveConstraint.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLinearDriveConstraint, Z_Construct_UPackage__Script_Engine(), TEXT("LinearDriveConstraint"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLinearDriveConstraint_Statics::NewProp_YDrive = { "YDrive", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLinearDriveConstraint, YDrive), Z_Construct_UScriptStruct_FConstraintDrive, METADATA_PARAMS(Z_Construct_UScriptStruct_FLinearDriveConstraint_Statics::NewProp_YDrive_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLinearDriveConstraint_Statics::NewProp_YDrive_MetaData)) }; // 3263093575
#if WITH_METADATA
...
class UScriptStruct* FAngularDriveConstraint::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AngularDriveConstraint.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAngularDriveConstraint, Z_Construct_UPackage__Script_Engine(), TEXT("AngularDriveConstraint"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAngularDriveConstraint>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAngularDriveConstraint_Statics::NewProp_AngularVelocityTarget_MetaData[] = {
		{ "Category", "AngularMotor" },
		{ "Comment", "/** Target angular velocity relative to the body reference frame. */" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/ConstraintDrives.h" },
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_ConstraintDrives_h_Statics::ScriptStructInfo[] = {
		{ FConstraintDrive::StaticStruct, Z_Construct_UScriptStruct_FConstraintDrive_Statics::NewStructOps, TEXT("ConstraintDrive"), &Z_Registration_Info_UScriptStruct_ConstraintDrive, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConstraintDrive), 3263093575U) },
		{ FLinearDriveConstraint::StaticStruct, Z_Construct_UScriptStruct_FLinearDriveConstraint_Statics::NewStructOps, TEXT("LinearDriveConstraint"), &Z_Registration_Info_UScriptStruct_LinearDriveConstraint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLinearDriveConstraint), 2512210963U) },
		{ FAngularDriveConstraint::StaticStruct, Z_Construct_UScriptStruct_FAngularDriveConstraint_Statics::NewStructOps, TEXT("AngularDriveConstraint"), &Z_Registration_Info_UScriptStruct_AngularDriveConstraint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAngularDriveConstraint), 1548971370U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_ConstraintDrives_h_1551736470(TEXT("/Script/Engine"),
		nullptr, 0,
