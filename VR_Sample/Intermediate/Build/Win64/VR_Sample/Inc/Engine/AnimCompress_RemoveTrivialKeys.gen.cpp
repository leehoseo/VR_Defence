...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimCompress_RemoveTrivialKeys_Statics::NewProp_MaxAngleDiff = { "MaxAngleDiff", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimCompress_RemoveTrivialKeys, MaxAngleDiff), METADATA_PARAMS(Z_Construct_UClass_UAnimCompress_RemoveTrivialKeys_Statics::NewProp_MaxAngleDiff_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimCompress_RemoveTrivialKeys_Statics::NewProp_MaxAngleDiff_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimCompress_RemoveTrivialKeys_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimCompress_RemoveTrivialKeys, UAnimCompress_RemoveTrivialKeys::StaticClass, TEXT("UAnimCompress_RemoveTrivialKeys"), &Z_Registration_Info_UClass_UAnimCompress_RemoveTrivialKeys, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimCompress_RemoveTrivialKeys), 2268346353U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimCompress_RemoveTrivialKeys_h_3468829421(TEXT("/Script/Engine"),
