...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleMeshRotation_Statics::NewProp_StartRotation = { "StartRotation", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleMeshRotation, StartRotation), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleMeshRotation_Statics::NewProp_StartRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleMeshRotation_Statics::NewProp_StartRotation_MetaData)) }; // 3599899551
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleMeshRotation_Statics::NewProp_bInheritParent = { "bInheritParent", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleMeshRotation), &Z_Construct_UClass_UParticleModuleMeshRotation_Statics::NewProp_bInheritParent_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleMeshRotation_Statics::NewProp_bInheritParent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleMeshRotation_Statics::NewProp_bInheritParent_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Rotation_ParticleModuleMeshRotation_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleMeshRotation, UParticleModuleMeshRotation::StaticClass, TEXT("UParticleModuleMeshRotation"), &Z_Registration_Info_UClass_UParticleModuleMeshRotation, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleMeshRotation), 2058007594U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Rotation_ParticleModuleMeshRotation_h_3817204172(TEXT("/Script/Engine"),
