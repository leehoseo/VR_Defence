...
class UScriptStruct* FSocketReference::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SocketReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSocketReference, Z_Construct_UPackage__Script_Engine(), TEXT("SocketReference"));
	}
...
class UScriptStruct* FBoneSocketTarget::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BoneSocketTarget.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBoneSocketTarget, Z_Construct_UPackage__Script_Engine(), TEXT("BoneSocketTarget"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBoneSocketTarget>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FBoneSocketTarget_Statics::NewProp_bUseSocket = { "bUseSocket", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FBoneSocketTarget), &Z_Construct_UScriptStruct_FBoneSocketTarget_Statics::NewProp_bUseSocket_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FBoneSocketTarget_Statics::NewProp_bUseSocket_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBoneSocketTarget_Statics::NewProp_bUseSocket_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBoneSocketTarget_Statics::NewProp_SocketReference = { "SocketReference", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBoneSocketTarget, SocketReference), Z_Construct_UScriptStruct_FSocketReference, METADATA_PARAMS(Z_Construct_UScriptStruct_FBoneSocketTarget_Statics::NewProp_SocketReference_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBoneSocketTarget_Statics::NewProp_SocketReference_MetaData)) }; // 2892306744
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_BoneSocketReference_h_Statics::ScriptStructInfo[] = {
		{ FSocketReference::StaticStruct, Z_Construct_UScriptStruct_FSocketReference_Statics::NewStructOps, TEXT("SocketReference"), &Z_Registration_Info_UScriptStruct_SocketReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSocketReference), 2892306744U) },
		{ FBoneSocketTarget::StaticStruct, Z_Construct_UScriptStruct_FBoneSocketTarget_Statics::NewStructOps, TEXT("BoneSocketTarget"), &Z_Registration_Info_UScriptStruct_BoneSocketTarget, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBoneSocketTarget), 1746801377U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_BoneSocketReference_h_590617005(TEXT("/Script/Engine"),
		nullptr, 0,
