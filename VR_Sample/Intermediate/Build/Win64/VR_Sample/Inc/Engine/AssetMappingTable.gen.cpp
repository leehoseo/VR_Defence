...
class UScriptStruct* FAssetMapping::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AssetMapping.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAssetMapping, Z_Construct_UPackage__Script_Engine(), TEXT("AssetMapping"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAssetMapping>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAssetMapping_Statics::NewProp_TargetAsset = { "TargetAsset", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAssetMapping, TargetAsset), Z_Construct_UClass_UAnimationAsset_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAssetMapping_Statics::NewProp_TargetAsset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetMapping_Statics::NewProp_TargetAsset_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAssetMappingTable_Statics::NewProp_MappedAssets_Inner = { "MappedAssets", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FAssetMapping, METADATA_PARAMS(nullptr, 0) }; // 1244453917
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAssetMappingTable_Statics::NewProp_MappedAssets = { "MappedAssets", nullptr, (EPropertyFlags)0x0040000000020041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAssetMappingTable, MappedAssets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAssetMappingTable_Statics::NewProp_MappedAssets_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAssetMappingTable_Statics::NewProp_MappedAssets_MetaData)) }; // 1244453917
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AssetMappingTable_h_Statics::ScriptStructInfo[] = {
		{ FAssetMapping::StaticStruct, Z_Construct_UScriptStruct_FAssetMapping_Statics::NewStructOps, TEXT("AssetMapping"), &Z_Registration_Info_UScriptStruct_AssetMapping, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAssetMapping), 1244453917U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AssetMappingTable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAssetMappingTable, UAssetMappingTable::StaticClass, TEXT("UAssetMappingTable"), &Z_Registration_Info_UClass_UAssetMappingTable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAssetMappingTable), 3572741893U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AssetMappingTable_h_322362136(TEXT("/Script/Engine"),
