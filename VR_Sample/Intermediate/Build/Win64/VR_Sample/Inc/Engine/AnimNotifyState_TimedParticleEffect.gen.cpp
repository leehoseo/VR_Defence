...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PSTemplate = { "PSTemplate", nullptr, (EPropertyFlags)0x0014000000000011, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimNotifyState_TimedParticleEffect, PSTemplate), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PSTemplate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PSTemplate_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_bDestroyAtEnd = { "bDestroyAtEnd", nullptr, (EPropertyFlags)0x0010000000000011, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAnimNotifyState_TimedParticleEffect), &Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_bDestroyAtEnd_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_bDestroyAtEnd_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_bDestroyAtEnd_MetaData)) };
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PreviousPSTemplates_Inner = { "PreviousPSTemplates", nullptr, (EPropertyFlags)0x0004000800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PreviousPSTemplates = { "PreviousPSTemplates", nullptr, (EPropertyFlags)0x0014000800002010, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimNotifyState_TimedParticleEffect, PreviousPSTemplates), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PreviousPSTemplates_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PreviousPSTemplates_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PreviousSocketNames_Inner = { "PreviousSocketNames", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PreviousSocketNames = { "PreviousSocketNames", nullptr, (EPropertyFlags)0x0010000800002010, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimNotifyState_TimedParticleEffect, PreviousSocketNames), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PreviousSocketNames_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect_Statics::NewProp_PreviousSocketNames_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNotifies_AnimNotifyState_TimedParticleEffect_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimNotifyState_TimedParticleEffect, UAnimNotifyState_TimedParticleEffect::StaticClass, TEXT("UAnimNotifyState_TimedParticleEffect"), &Z_Registration_Info_UClass_UAnimNotifyState_TimedParticleEffect, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimNotifyState_TimedParticleEffect), 242940146U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNotifies_AnimNotifyState_TimedParticleEffect_h_3523217090(TEXT("/Script/Engine"),
