...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_USoundNodeSwitch_Statics::NewProp_IntParameterName = { "IntParameterName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeSwitch, IntParameterName), METADATA_PARAMS(Z_Construct_UClass_USoundNodeSwitch_Statics::NewProp_IntParameterName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeSwitch_Statics::NewProp_IntParameterName_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeSwitch_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundNodeSwitch, USoundNodeSwitch::StaticClass, TEXT("USoundNodeSwitch"), &Z_Registration_Info_UClass_USoundNodeSwitch, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundNodeSwitch), 550467553U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeSwitch_h_2016803502(TEXT("/Script/Engine"),
