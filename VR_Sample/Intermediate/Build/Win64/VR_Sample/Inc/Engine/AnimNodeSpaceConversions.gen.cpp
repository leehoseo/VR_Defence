...
class UScriptStruct* FAnimNode_ConvertComponentToLocalSpace::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_ConvertComponentToLocalSpace.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_ConvertComponentToLocalSpace, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_ConvertComponentToLocalSpace"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_ConvertComponentToLocalSpace_Statics::NewProp_ComponentPose = { "ComponentPose", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_ConvertComponentToLocalSpace, ComponentPose), Z_Construct_UScriptStruct_FComponentSpacePoseLink, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_ConvertComponentToLocalSpace_Statics::NewProp_ComponentPose_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_ConvertComponentToLocalSpace_Statics::NewProp_ComponentPose_MetaData)) }; // 4052600424
...
class UScriptStruct* FAnimNode_ConvertLocalToComponentSpace::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_ConvertLocalToComponentSpace.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_ConvertLocalToComponentSpace, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_ConvertLocalToComponentSpace"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNode_ConvertLocalToComponentSpace>()
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNodeSpaceConversions_h_1834144355(TEXT("/Script/Engine"),
		nullptr, 0,
