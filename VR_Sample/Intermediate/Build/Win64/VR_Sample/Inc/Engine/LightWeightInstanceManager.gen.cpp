...
#include "Engine/Classes/GameFramework/LightWeightInstanceManager.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_ALightWeightInstanceManager_Statics::NewProp_RepresentedClass = { "RepresentedClass", nullptr, (EPropertyFlags)0x0024080000010021, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALightWeightInstanceManager, RepresentedClass), Z_Construct_UClass_AActor_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_ALightWeightInstanceManager_Statics::NewProp_RepresentedClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALightWeightInstanceManager_Statics::NewProp_RepresentedClass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ALightWeightInstanceManager_Statics::NewProp_InstanceTransforms = { "InstanceTransforms", "OnRep_Transforms", (EPropertyFlags)0x0020080100000821, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALightWeightInstanceManager, InstanceTransforms), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ALightWeightInstanceManager_Statics::NewProp_InstanceTransforms_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALightWeightInstanceManager_Statics::NewProp_InstanceTransforms_MetaData)) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ALightWeightInstanceManager_Statics::NewProp_FreeIndices_Inner = { "FreeIndices", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_LightWeightInstanceManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActorInstanceHandleInterface, UActorInstanceHandleInterface::StaticClass, TEXT("UActorInstanceHandleInterface"), &Z_Registration_Info_UClass_UActorInstanceHandleInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorInstanceHandleInterface), 1360676962U) },
		{ Z_Construct_UClass_ALightWeightInstanceManager, ALightWeightInstanceManager::StaticClass, TEXT("ALightWeightInstanceManager"), &Z_Registration_Info_UClass_ALightWeightInstanceManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALightWeightInstanceManager), 836707308U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_LightWeightInstanceManager_h_1086938590(TEXT("/Script/Engine"),
