...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionStep_Statics::NewProp_X = { "X", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionStep, X), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionStep_Statics::NewProp_X_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionStep_Statics::NewProp_X_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionStep_Statics::NewProp_ConstY = { "ConstY", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionStep, ConstY), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionStep_Statics::NewProp_ConstY_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionStep_Statics::NewProp_ConstY_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionStep_Statics::NewProp_ConstX = { "ConstX", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionStep, ConstX), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionStep_Statics::NewProp_ConstX_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionStep_Statics::NewProp_ConstX_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionStep_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionStep, UMaterialExpressionStep::StaticClass, TEXT("UMaterialExpressionStep"), &Z_Registration_Info_UClass_UMaterialExpressionStep, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionStep), 2802182022U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionStep_h_3111075075(TEXT("/Script/Engine"),
