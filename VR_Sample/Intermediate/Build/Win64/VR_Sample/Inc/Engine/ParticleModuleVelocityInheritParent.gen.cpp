...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleVelocityInheritParent_Statics::NewProp_Scale = { "Scale", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleVelocityInheritParent, Scale), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleVelocityInheritParent_Statics::NewProp_Scale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleVelocityInheritParent_Statics::NewProp_Scale_MetaData)) }; // 3599899551
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Velocity_ParticleModuleVelocityInheritParent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleVelocityInheritParent, UParticleModuleVelocityInheritParent::StaticClass, TEXT("UParticleModuleVelocityInheritParent"), &Z_Registration_Info_UClass_UParticleModuleVelocityInheritParent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleVelocityInheritParent), 2709278661U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Velocity_ParticleModuleVelocityInheritParent_h_3882572248(TEXT("/Script/Engine"),
