...
#include "Engine/Classes/Materials/MaterialExpressionPinBase.h"
...
class UScriptStruct* FCompositeReroute::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CompositeReroute.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCompositeReroute, Z_Construct_UPackage__Script_Engine(), TEXT("CompositeReroute"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FCompositeReroute>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FCompositeReroute_Statics::NewProp_Expression = { "Expression", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCompositeReroute, Expression), Z_Construct_UClass_UMaterialExpressionReroute_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FCompositeReroute_Statics::NewProp_Expression_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCompositeReroute_Statics::NewProp_Expression_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionPinBase_Statics::NewProp_ReroutePins_Inner = { "ReroutePins", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FCompositeReroute, METADATA_PARAMS(nullptr, 0) }; // 1792227528
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMaterialExpressionPinBase_Statics::NewProp_ReroutePins = { "ReroutePins", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionPinBase, ReroutePins), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionPinBase_Statics::NewProp_ReroutePins_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionPinBase_Statics::NewProp_ReroutePins_MetaData)) }; // 1792227528
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterialExpressionPinBase_Statics::NewProp_PinDirection = { "PinDirection", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionPinBase, PinDirection), Z_Construct_UEnum_Engine_EEdGraphPinDirection, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionPinBase_Statics::NewProp_PinDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionPinBase_Statics::NewProp_PinDirection_MetaData)) }; // 1668123198
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionPinBase_h_Statics::ScriptStructInfo[] = {
		{ FCompositeReroute::StaticStruct, Z_Construct_UScriptStruct_FCompositeReroute_Statics::NewStructOps, TEXT("CompositeReroute"), &Z_Registration_Info_UScriptStruct_CompositeReroute, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCompositeReroute), 1792227528U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionPinBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionPinBase, UMaterialExpressionPinBase::StaticClass, TEXT("UMaterialExpressionPinBase"), &Z_Registration_Info_UClass_UMaterialExpressionPinBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionPinBase), 3091436613U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionPinBase_h_3099343383(TEXT("/Script/Engine"),
