...
class UScriptStruct* FStreamingRenderAssetPrimitiveInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StreamingRenderAssetPrimitiveInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo, Z_Construct_UPackage__Script_Engine(), TEXT("StreamingRenderAssetPrimitiveInfo"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FStreamingRenderAssetPrimitiveInfo>()
{
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_PackedRelativeBox = { "PackedRelativeBox", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FStreamingRenderAssetPrimitiveInfo, PackedRelativeBox), METADATA_PARAMS(Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_PackedRelativeBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_PackedRelativeBox_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_bAllowInvalidTexelFactorWhenUnregistered = { "bAllowInvalidTexelFactorWhenUnregistered", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FStreamingRenderAssetPrimitiveInfo), &Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_bAllowInvalidTexelFactorWhenUnregistered_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_bAllowInvalidTexelFactorWhenUnregistered_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStreamingRenderAssetPrimitiveInfo_Statics::NewProp_bAllowInvalidTexelFactorWhenUnregistered_MetaData)) };
...
class UScriptStruct* FStreamingTextureBuildInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StreamingTextureBuildInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStreamingTextureBuildInfo, Z_Construct_UPackage__Script_Engine(), TEXT("StreamingTextureBuildInfo"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FStreamingTextureBuildInfo>()
{
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FStreamingTextureBuildInfo_Statics::NewProp_PackedRelativeBox = { "PackedRelativeBox", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FStreamingTextureBuildInfo, PackedRelativeBox), METADATA_PARAMS(Z_Construct_UScriptStruct_FStreamingTextureBuildInfo_Statics::NewProp_PackedRelativeBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStreamingTextureBuildInfo_Statics::NewProp_PackedRelativeBox_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FStreamingTextureBuildInfo_Statics::NewProp_TexelFactor = { "TexelFactor", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FStreamingTextureBuildInfo, TexelFactor), METADATA_PARAMS(Z_Construct_UScriptStruct_FStreamingTextureBuildInfo_Statics::NewProp_TexelFactor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStreamingTextureBuildInfo_Statics::NewProp_TexelFactor_MetaData)) };
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_TextureStreamingTypes_h_4277279759(TEXT("/Script/Engine"),
		nullptr, 0,
