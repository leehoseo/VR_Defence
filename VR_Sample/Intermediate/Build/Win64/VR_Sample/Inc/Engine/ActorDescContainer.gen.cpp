...
#include "Engine/Public/WorldPartition/ActorDescContainer.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UActorDescContainer_Statics::NewProp_World = { "World", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UActorDescContainer, World), Z_Construct_UClass_UWorld_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UActorDescContainer_Statics::NewProp_World_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UActorDescContainer_Statics::NewProp_World_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_ActorDescContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActorDescContainer, UActorDescContainer::StaticClass, TEXT("UActorDescContainer"), &Z_Registration_Info_UClass_UActorDescContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorDescContainer), 3702234850U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_ActorDescContainer_h_81670346(TEXT("/Script/Engine"),
