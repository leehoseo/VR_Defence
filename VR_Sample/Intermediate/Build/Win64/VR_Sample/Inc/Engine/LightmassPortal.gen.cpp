...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ALightmassPortal_Statics::NewProp_PortalComponent = { "PortalComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALightmassPortal, PortalComponent), Z_Construct_UClass_ULightmassPortalComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ALightmassPortal_Statics::NewProp_PortalComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALightmassPortal_Statics::NewProp_PortalComponent_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Lightmass_LightmassPortal_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALightmassPortal, ALightmassPortal::StaticClass, TEXT("ALightmassPortal"), &Z_Registration_Info_UClass_ALightmassPortal, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALightmassPortal), 4122665125U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Lightmass_LightmassPortal_h_1383654665(TEXT("/Script/Engine"),
