...
#include "Engine/Public/Animation/AnimSubsystemInstance.h"
...
class UScriptStruct* FAnimSubsystemInstance::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimSubsystemInstance.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimSubsystemInstance, Z_Construct_UPackage__Script_Engine(), TEXT("AnimSubsystemInstance"));
	}
