...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USystemTimeTimecodeProvider, FrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_FrameRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_FrameRate_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_bGenerateFullFrame = { "bGenerateFullFrame", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USystemTimeTimecodeProvider), &Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_bGenerateFullFrame_SetBit, METADATA_PARAMS(Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_bGenerateFullFrame_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_bGenerateFullFrame_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_bUseHighPerformanceClock = { "bUseHighPerformanceClock", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USystemTimeTimecodeProvider), &Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_bUseHighPerformanceClock_SetBit, METADATA_PARAMS(Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_bUseHighPerformanceClock_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USystemTimeTimecodeProvider_Statics::NewProp_bUseHighPerformanceClock_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_SystemTimeTimecodeProvider_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USystemTimeTimecodeProvider, USystemTimeTimecodeProvider::StaticClass, TEXT("USystemTimeTimecodeProvider"), &Z_Registration_Info_UClass_USystemTimeTimecodeProvider, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USystemTimeTimecodeProvider), 2450136077U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_SystemTimeTimecodeProvider_h_2895448752(TEXT("/Script/Engine"),
