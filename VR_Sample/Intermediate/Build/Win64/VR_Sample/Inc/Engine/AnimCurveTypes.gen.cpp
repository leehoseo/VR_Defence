...
// End Cross Module References
	...
	static UEnum* EAnimAssetCurveFlags_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAnimAssetCurveFlags.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAnimAssetCurveFlags, Z_Construct_UPackage__Script_Engine(), TEXT("EAnimAssetCurveFlags"));
		}
...
class UScriptStruct* FAnimCurveParam::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimCurveParam.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimCurveParam, Z_Construct_UPackage__Script_Engine(), TEXT("AnimCurveParam"));
	}
...
class UScriptStruct* FAnimCurveBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimCurveBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimCurveBase, Z_Construct_UPackage__Script_Engine(), TEXT("AnimCurveBase"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimCurveBase_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimCurveBase, Color), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimCurveBase_Statics::NewProp_Color_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimCurveBase_Statics::NewProp_Color_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
class UScriptStruct* FFloatCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FloatCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFloatCurve, Z_Construct_UPackage__Script_Engine(), TEXT("FloatCurve"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFloatCurve_Statics::NewProp_FloatCurve = { "FloatCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFloatCurve, FloatCurve), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(Z_Construct_UScriptStruct_FFloatCurve_Statics::NewProp_FloatCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFloatCurve_Statics::NewProp_FloatCurve_MetaData)) }; // 133266933
...
class UScriptStruct* FVectorCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_VectorCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVectorCurve, Z_Construct_UPackage__Script_Engine(), TEXT("VectorCurve"));
	}
...
class UScriptStruct* FTransformCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TransformCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTransformCurve, Z_Construct_UPackage__Script_Engine(), TEXT("TransformCurve"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTransformCurve_Statics::NewProp_TranslationCurve = { "TranslationCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTransformCurve, TranslationCurve), Z_Construct_UScriptStruct_FVectorCurve, METADATA_PARAMS(Z_Construct_UScriptStruct_FTransformCurve_Statics::NewProp_TranslationCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTransformCurve_Statics::NewProp_TranslationCurve_MetaData)) }; // 1232643761
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTransformCurve_Statics::NewProp_RotationCurve = { "RotationCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTransformCurve, RotationCurve), Z_Construct_UScriptStruct_FVectorCurve, METADATA_PARAMS(Z_Construct_UScriptStruct_FTransformCurve_Statics::NewProp_RotationCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTransformCurve_Statics::NewProp_RotationCurve_MetaData)) }; // 1232643761
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FTransformCurve_Statics::NewProp_ScaleCurve_MetaData[] = {
		{ "ModuleRelativePath", "Public/Animation/AnimCurveTypes.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTransformCurve_Statics::NewProp_ScaleCurve = { "ScaleCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTransformCurve, ScaleCurve), Z_Construct_UScriptStruct_FVectorCurve, METADATA_PARAMS(Z_Construct_UScriptStruct_FTransformCurve_Statics::NewProp_ScaleCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTransformCurve_Statics::NewProp_ScaleCurve_MetaData)) }; // 1232643761
...
class UScriptStruct* FCachedFloatCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CachedFloatCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCachedFloatCurve, Z_Construct_UPackage__Script_Engine(), TEXT("CachedFloatCurve"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FCachedFloatCurve>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FCachedFloatCurve_Statics::NewProp_CurveName = { "CurveName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCachedFloatCurve, CurveName), METADATA_PARAMS(Z_Construct_UScriptStruct_FCachedFloatCurve_Statics::NewProp_CurveName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedFloatCurve_Statics::NewProp_CurveName_MetaData)) };
	...
	static UEnum* ERawCurveTrackTypes_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERawCurveTrackTypes.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ERawCurveTrackTypes, Z_Construct_UPackage__Script_Engine(), TEXT("ERawCurveTrackTypes"));
		}
...
class UScriptStruct* FRawCurveTracks::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RawCurveTracks.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRawCurveTracks, Z_Construct_UPackage__Script_Engine(), TEXT("RawCurveTracks"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FRawCurveTracks>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_FloatCurves_Inner = { "FloatCurves", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FFloatCurve, METADATA_PARAMS(nullptr, 0) }; // 1360235911
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_FloatCurves = { "FloatCurves", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRawCurveTracks, FloatCurves), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_FloatCurves_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_FloatCurves_MetaData)) }; // 1360235911
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_VectorCurves_Inner = { "VectorCurves", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVectorCurve, METADATA_PARAMS(nullptr, 0) }; // 1232643761
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_VectorCurves = { "VectorCurves", nullptr, (EPropertyFlags)0x0010000800002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRawCurveTracks, VectorCurves), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_VectorCurves_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_VectorCurves_MetaData)) }; // 1232643761
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_TransformCurves_Inner = { "TransformCurves", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FTransformCurve, METADATA_PARAMS(nullptr, 0) }; // 2876600492
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_TransformCurves = { "TransformCurves", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRawCurveTracks, TransformCurves), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_TransformCurves_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewProp_TransformCurves_MetaData)) }; // 2876600492
#endif // WITH_EDITORONLY_DATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimCurveTypes_h_Statics::ScriptStructInfo[] = {
		{ FAnimCurveParam::StaticStruct, Z_Construct_UScriptStruct_FAnimCurveParam_Statics::NewStructOps, TEXT("AnimCurveParam"), &Z_Registration_Info_UScriptStruct_AnimCurveParam, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimCurveParam), 2595590683U) },
		{ FAnimCurveBase::StaticStruct, Z_Construct_UScriptStruct_FAnimCurveBase_Statics::NewStructOps, TEXT("AnimCurveBase"), &Z_Registration_Info_UScriptStruct_AnimCurveBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimCurveBase), 2632605584U) },
		{ FFloatCurve::StaticStruct, Z_Construct_UScriptStruct_FFloatCurve_Statics::NewStructOps, TEXT("FloatCurve"), &Z_Registration_Info_UScriptStruct_FloatCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFloatCurve), 1360235911U) },
		{ FVectorCurve::StaticStruct, Z_Construct_UScriptStruct_FVectorCurve_Statics::NewStructOps, TEXT("VectorCurve"), &Z_Registration_Info_UScriptStruct_VectorCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVectorCurve), 1232643761U) },
		{ FTransformCurve::StaticStruct, Z_Construct_UScriptStruct_FTransformCurve_Statics::NewStructOps, TEXT("TransformCurve"), &Z_Registration_Info_UScriptStruct_TransformCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTransformCurve), 2876600492U) },
		{ FCachedFloatCurve::StaticStruct, Z_Construct_UScriptStruct_FCachedFloatCurve_Statics::NewStructOps, TEXT("CachedFloatCurve"), &Z_Registration_Info_UScriptStruct_CachedFloatCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCachedFloatCurve), 3199561244U) },
		{ FRawCurveTracks::StaticStruct, Z_Construct_UScriptStruct_FRawCurveTracks_Statics::NewStructOps, TEXT("RawCurveTracks"), &Z_Registration_Info_UScriptStruct_RawCurveTracks, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRawCurveTracks), 4285545408U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimCurveTypes_h_3363560639(TEXT("/Script/Engine"),
		nullptr, 0,
