...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_MaxSpeed = { "MaxSpeed", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFloatingPawnMovement, MaxSpeed), METADATA_PARAMS(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_MaxSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_MaxSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Acceleration = { "Acceleration", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFloatingPawnMovement, Acceleration), METADATA_PARAMS(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Acceleration_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Acceleration_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Deceleration = { "Deceleration", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFloatingPawnMovement, Deceleration), METADATA_PARAMS(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Deceleration_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_Deceleration_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_TurningBoost = { "TurningBoost", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UFloatingPawnMovement, TurningBoost), METADATA_PARAMS(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_TurningBoost_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_TurningBoost_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_bPositionCorrected = { "bPositionCorrected", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UFloatingPawnMovement), &Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_bPositionCorrected_SetBit, METADATA_PARAMS(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_bPositionCorrected_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UFloatingPawnMovement_Statics::NewProp_bPositionCorrected_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_FloatingPawnMovement_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UFloatingPawnMovement, UFloatingPawnMovement::StaticClass, TEXT("UFloatingPawnMovement"), &Z_Registration_Info_UClass_UFloatingPawnMovement, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UFloatingPawnMovement), 1611569413U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_FloatingPawnMovement_h_1683807712(TEXT("/Script/Engine"),
