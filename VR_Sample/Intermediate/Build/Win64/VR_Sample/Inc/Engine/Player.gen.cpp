...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPlayer_Statics::NewProp_CurrentNetSpeed = { "CurrentNetSpeed", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPlayer, CurrentNetSpeed), METADATA_PARAMS(Z_Construct_UClass_UPlayer_Statics::NewProp_CurrentNetSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPlayer_Statics::NewProp_CurrentNetSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredInternetSpeed = { "ConfiguredInternetSpeed", nullptr, (EPropertyFlags)0x0010000000044000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPlayer, ConfiguredInternetSpeed), METADATA_PARAMS(Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredInternetSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredInternetSpeed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredLanSpeed = { "ConfiguredLanSpeed", nullptr, (EPropertyFlags)0x0010000000044000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPlayer, ConfiguredLanSpeed), METADATA_PARAMS(Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredLanSpeed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPlayer_Statics::NewProp_ConfiguredLanSpeed_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Player_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPlayer, UPlayer::StaticClass, TEXT("UPlayer"), &Z_Registration_Info_UClass_UPlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlayer), 3156633422U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Player_h_1453372045(TEXT("/Script/Engine"),
