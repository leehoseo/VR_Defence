...
class UScriptStruct* FDistanceDatum::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DistanceDatum.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDistanceDatum, Z_Construct_UPackage__Script_Engine(), TEXT("DistanceDatum"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FDistanceDatum>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundNodeDistanceCrossFade_Statics::NewProp_CrossFadeInput_Inner = { "CrossFadeInput", nullptr, (EPropertyFlags)0x0000000000000008, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FDistanceDatum, METADATA_PARAMS(nullptr, 0) }; // 3907505207
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDistanceCrossFade_h_Statics::ScriptStructInfo[] = {
		{ FDistanceDatum::StaticStruct, Z_Construct_UScriptStruct_FDistanceDatum_Statics::NewStructOps, TEXT("DistanceDatum"), &Z_Registration_Info_UScriptStruct_DistanceDatum, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDistanceDatum), 3907505207U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDistanceCrossFade_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundNodeDistanceCrossFade, USoundNodeDistanceCrossFade::StaticClass, TEXT("USoundNodeDistanceCrossFade"), &Z_Registration_Info_UClass_USoundNodeDistanceCrossFade, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundNodeDistanceCrossFade), 2393215558U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDistanceCrossFade_h_3587538473(TEXT("/Script/Engine"),
