...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCompositeDataTable_Statics::NewProp_ParentTables = { "ParentTables", nullptr, (EPropertyFlags)0x0024080000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCompositeDataTable, ParentTables), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCompositeDataTable_Statics::NewProp_ParentTables_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositeDataTable_Statics::NewProp_ParentTables_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCompositeDataTable_Statics::NewProp_OldParentTables = { "OldParentTables", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCompositeDataTable, OldParentTables), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCompositeDataTable_Statics::NewProp_OldParentTables_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCompositeDataTable_Statics::NewProp_OldParentTables_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CompositeDataTable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCompositeDataTable, UCompositeDataTable::StaticClass, TEXT("UCompositeDataTable"), &Z_Registration_Info_UClass_UCompositeDataTable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCompositeDataTable), 1297562908U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CompositeDataTable_h_4046340231(TEXT("/Script/Engine"),
