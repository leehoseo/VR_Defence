...
class UScriptStruct* FChildActorAttachedActorInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ChildActorAttachedActorInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FChildActorAttachedActorInfo, Z_Construct_UPackage__Script_Engine(), TEXT("ChildActorAttachedActorInfo"));
	}
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FChildActorAttachedActorInfo_Statics::NewProp_Actor = { "Actor", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChildActorAttachedActorInfo, Actor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FChildActorAttachedActorInfo_Statics::NewProp_Actor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChildActorAttachedActorInfo_Statics::NewProp_Actor_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FChildActorAttachedActorInfo_Statics::NewProp_SocketName = { "SocketName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChildActorAttachedActorInfo, SocketName), METADATA_PARAMS(Z_Construct_UScriptStruct_FChildActorAttachedActorInfo_Statics::NewProp_SocketName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChildActorAttachedActorInfo_Statics::NewProp_SocketName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChildActorAttachedActorInfo_Statics::NewProp_RelativeTransform = { "RelativeTransform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChildActorAttachedActorInfo, RelativeTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FChildActorAttachedActorInfo_Statics::NewProp_RelativeTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChildActorAttachedActorInfo_Statics::NewProp_RelativeTransform_MetaData)) };
...
class UScriptStruct* FChildActorComponentInstanceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ChildActorComponentInstanceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FChildActorComponentInstanceData, Z_Construct_UPackage__Script_Engine(), TEXT("ChildActorComponentInstanceData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FChildActorComponentInstanceData>()
{
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FChildActorComponentInstanceData_Statics::NewProp_ChildActorClass = { "ChildActorClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChildActorComponentInstanceData, ChildActorClass), Z_Construct_UClass_AActor_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FChildActorComponentInstanceData_Statics::NewProp_ChildActorClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChildActorComponentInstanceData_Statics::NewProp_ChildActorClass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FChildActorComponentInstanceData_Statics::NewProp_ChildActorName = { "ChildActorName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FChildActorComponentInstanceData, ChildActorName), METADATA_PARAMS(Z_Construct_UScriptStruct_FChildActorComponentInstanceData_Statics::NewProp_ChildActorName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FChildActorComponentInstanceData_Statics::NewProp_ChildActorName_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FChildActorComponentInstanceData_Statics::NewProp_AttachedActors_Inner = { "AttachedActors", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FChildActorAttachedActorInfo, METADATA_PARAMS(nullptr, 0) }; // 2544436690
#if WITH_METADATA
	...
	static UEnum* EChildActorComponentTreeViewVisualizationMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EChildActorComponentTreeViewVisualizationMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EChildActorComponentTreeViewVisualizationMode, Z_Construct_UPackage__Script_Engine(), TEXT("EChildActorComponentTreeViewVisualizationMode"));
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UChildActorComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UChildActorComponent_SetChildActorClass, "SetChildActorClass" }, // 2712216064
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UChildActorComponent_Statics::NewProp_ChildActorClass = { "ChildActorClass", nullptr, (EPropertyFlags)0x0044000000000015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UChildActorComponent, ChildActorClass), Z_Construct_UClass_AActor_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UChildActorComponent_Statics::NewProp_ChildActorClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UChildActorComponent_Statics::NewProp_ChildActorClass_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_ChildActorComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChildActorComponent, UChildActorComponent::StaticClass, TEXT("UChildActorComponent"), &Z_Registration_Info_UClass_UChildActorComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChildActorComponent), 126144411U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_ChildActorComponent_h_311885728(TEXT("/Script/Engine"),
