...
class UScriptStruct* FCharacterNetworkSerializationPackedBits::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CharacterNetworkSerializationPackedBits.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCharacterNetworkSerializationPackedBits, Z_Construct_UPackage__Script_Engine(), TEXT("CharacterNetworkSerializationPackedBits"));
	}
...
class UScriptStruct* FCharacterServerMovePackedBits::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CharacterServerMovePackedBits.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCharacterServerMovePackedBits, Z_Construct_UPackage__Script_Engine(), TEXT("CharacterServerMovePackedBits"));
	}
...
class UScriptStruct* FCharacterMoveResponsePackedBits::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CharacterMoveResponsePackedBits.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCharacterMoveResponsePackedBits, Z_Construct_UPackage__Script_Engine(), TEXT("CharacterMoveResponsePackedBits"));
	}
