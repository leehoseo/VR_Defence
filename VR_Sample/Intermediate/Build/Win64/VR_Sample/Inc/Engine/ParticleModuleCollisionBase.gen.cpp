...
// End Cross Module References
	...
	static UEnum* EParticleCollisionComplete_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EParticleCollisionComplete.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EParticleCollisionComplete, Z_Construct_UPackage__Script_Engine(), TEXT("EParticleCollisionComplete"));
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Collision_ParticleModuleCollisionBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleCollisionBase, UParticleModuleCollisionBase::StaticClass, TEXT("UParticleModuleCollisionBase"), &Z_Registration_Info_UClass_UParticleModuleCollisionBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleCollisionBase), 1865431822U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Collision_ParticleModuleCollisionBase_h_1040842112(TEXT("/Script/Engine"),
