...
class UScriptStruct* FAnimNode_SingleNode::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_SingleNode.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_SingleNode, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_SingleNode"));
	}
...
class UScriptStruct* FAnimSingleNodeInstanceProxy::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimSingleNodeInstanceProxy.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimSingleNodeInstanceProxy, Z_Construct_UPackage__Script_Engine(), TEXT("AnimSingleNodeInstanceProxy"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimSingleNodeInstanceProxy>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimSingleNodeInstanceProxy_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_SingleNode::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_SingleNode_Statics::NewStructOps, TEXT("AnimNode_SingleNode"), &Z_Registration_Info_UScriptStruct_AnimNode_SingleNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_SingleNode), 598776787U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimSingleNodeInstanceProxy_h_1713291522(TEXT("/Script/Engine"),
		nullptr, 0,
