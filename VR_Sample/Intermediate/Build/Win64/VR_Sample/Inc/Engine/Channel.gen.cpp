...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UChannel_Statics::NewProp_Connection = { "Connection", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UChannel, Connection), Z_Construct_UClass_UNetConnection_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UChannel_Statics::NewProp_Connection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UChannel_Statics::NewProp_Connection_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Channel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChannel, UChannel::StaticClass, TEXT("UChannel"), &Z_Registration_Info_UClass_UChannel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChannel), 2801445206U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Channel_h_254046462(TEXT("/Script/Engine"),
