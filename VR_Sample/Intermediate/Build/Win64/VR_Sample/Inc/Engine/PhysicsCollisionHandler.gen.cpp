...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactThreshold = { "ImpactThreshold", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsCollisionHandler, ImpactThreshold), METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactReFireDelay = { "ImpactReFireDelay", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsCollisionHandler, ImpactReFireDelay), METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactReFireDelay_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_ImpactReFireDelay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_DefaultImpactSound = { "DefaultImpactSound", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsCollisionHandler, DefaultImpactSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_DefaultImpactSound_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_DefaultImpactSound_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_LastImpactSoundTime = { "LastImpactSoundTime", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsCollisionHandler, LastImpactSoundTime), METADATA_PARAMS(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_LastImpactSoundTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsCollisionHandler_Statics::NewProp_LastImpactSoundTime_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsCollisionHandler_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPhysicsCollisionHandler, UPhysicsCollisionHandler::StaticClass, TEXT("UPhysicsCollisionHandler"), &Z_Registration_Info_UClass_UPhysicsCollisionHandler, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPhysicsCollisionHandler), 1078837334U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsCollisionHandler_h_2768616766(TEXT("/Script/Engine"),
