...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleAccelerationOverLifetime_Statics::NewProp_AccelOverLife = { "AccelOverLife", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleAccelerationOverLifetime, AccelOverLife), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleAccelerationOverLifetime_Statics::NewProp_AccelOverLife_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleAccelerationOverLifetime_Statics::NewProp_AccelOverLife_MetaData)) }; // 3599899551
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Acceleration_ParticleModuleAccelerationOverLifetime_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleAccelerationOverLifetime, UParticleModuleAccelerationOverLifetime::StaticClass, TEXT("UParticleModuleAccelerationOverLifetime"), &Z_Registration_Info_UClass_UParticleModuleAccelerationOverLifetime, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleAccelerationOverLifetime), 2211205118U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Acceleration_ParticleModuleAccelerationOverLifetime_h_2921181215(TEXT("/Script/Engine"),
