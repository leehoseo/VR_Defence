...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleRotationOverLifetime_Statics::NewProp_RotationOverLife = { "RotationOverLife", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleRotationOverLifetime, RotationOverLife), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleRotationOverLifetime_Statics::NewProp_RotationOverLife_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleRotationOverLifetime_Statics::NewProp_RotationOverLife_MetaData)) }; // 3468229032
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Rotation_ParticleModuleRotationOverLifetime_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleRotationOverLifetime, UParticleModuleRotationOverLifetime::StaticClass, TEXT("UParticleModuleRotationOverLifetime"), &Z_Registration_Info_UClass_UParticleModuleRotationOverLifetime, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleRotationOverLifetime), 3256324722U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Rotation_ParticleModuleRotationOverLifetime_h_215229410(TEXT("/Script/Engine"),
