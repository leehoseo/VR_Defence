...
class UScriptStruct* FBlueprintInputKeyDelegateBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlueprintInputKeyDelegateBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlueprintInputKeyDelegateBinding, Z_Construct_UPackage__Script_Engine(), TEXT("BlueprintInputKeyDelegateBinding"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBlueprintInputKeyDelegateBinding>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBlueprintInputKeyDelegateBinding_Statics::NewProp_InputChord = { "InputChord", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlueprintInputKeyDelegateBinding, InputChord), Z_Construct_UScriptStruct_FInputChord, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlueprintInputKeyDelegateBinding_Statics::NewProp_InputChord_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlueprintInputKeyDelegateBinding_Statics::NewProp_InputChord_MetaData)) }; // 3880295606
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FBlueprintInputKeyDelegateBinding_Statics::NewProp_InputKeyEvent = { "InputKeyEvent", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlueprintInputKeyDelegateBinding, InputKeyEvent), Z_Construct_UEnum_Engine_EInputEvent, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlueprintInputKeyDelegateBinding_Statics::NewProp_InputKeyEvent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlueprintInputKeyDelegateBinding_Statics::NewProp_InputKeyEvent_MetaData)) }; // 1054153585
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInputKeyDelegateBinding_Statics::NewProp_InputKeyDelegateBindings_Inner = { "InputKeyDelegateBindings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBlueprintInputKeyDelegateBinding, METADATA_PARAMS(nullptr, 0) }; // 2217874791
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInputKeyDelegateBinding_Statics::NewProp_InputKeyDelegateBindings = { "InputKeyDelegateBindings", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInputKeyDelegateBinding, InputKeyDelegateBindings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInputKeyDelegateBinding_Statics::NewProp_InputKeyDelegateBindings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInputKeyDelegateBinding_Statics::NewProp_InputKeyDelegateBindings_MetaData)) }; // 2217874791
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InputKeyDelegateBinding_h_Statics::ScriptStructInfo[] = {
		{ FBlueprintInputKeyDelegateBinding::StaticStruct, Z_Construct_UScriptStruct_FBlueprintInputKeyDelegateBinding_Statics::NewStructOps, TEXT("BlueprintInputKeyDelegateBinding"), &Z_Registration_Info_UScriptStruct_BlueprintInputKeyDelegateBinding, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlueprintInputKeyDelegateBinding), 2217874791U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InputKeyDelegateBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInputKeyDelegateBinding, UInputKeyDelegateBinding::StaticClass, TEXT("UInputKeyDelegateBinding"), &Z_Registration_Info_UClass_UInputKeyDelegateBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputKeyDelegateBinding), 3317482311U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InputKeyDelegateBinding_h_896436732(TEXT("/Script/Engine"),
