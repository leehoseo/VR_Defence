...
#include "Engine/Public/Elements/Actor/ActorElementSelectionInterface.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorElementSelectionInterface_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UActorElementSelectionInterface_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UTypedElementSelectionInterface_NoRegister, (int32)VTABLE_OFFSET(UActorElementSelectionInterface, ITypedElementSelectionInterface), false },  // 331894261
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Actor_ActorElementSelectionInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActorElementSelectionInterface, UActorElementSelectionInterface::StaticClass, TEXT("UActorElementSelectionInterface"), &Z_Registration_Info_UClass_UActorElementSelectionInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorElementSelectionInterface), 4186111988U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Actor_ActorElementSelectionInterface_h_1254996409(TEXT("/Script/Engine"),
