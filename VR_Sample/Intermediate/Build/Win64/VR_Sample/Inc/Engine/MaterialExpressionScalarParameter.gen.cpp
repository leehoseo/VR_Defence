...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionScalarParameter_Statics::NewProp_SliderMin = { "SliderMin", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionScalarParameter, SliderMin), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionScalarParameter_Statics::NewProp_SliderMin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionScalarParameter_Statics::NewProp_SliderMin_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionScalarParameter_Statics::NewProp_SliderMax = { "SliderMax", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionScalarParameter, SliderMax), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionScalarParameter_Statics::NewProp_SliderMax_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionScalarParameter_Statics::NewProp_SliderMax_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionScalarParameter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionScalarParameter, UMaterialExpressionScalarParameter::StaticClass, TEXT("UMaterialExpressionScalarParameter"), &Z_Registration_Info_UClass_UMaterialExpressionScalarParameter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionScalarParameter), 1484217498U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionScalarParameter_h_1044053986(TEXT("/Script/Engine"),
