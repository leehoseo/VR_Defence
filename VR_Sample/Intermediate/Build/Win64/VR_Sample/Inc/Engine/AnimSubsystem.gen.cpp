...
#include "Engine/Public/Animation/AnimSubsystem.h"
...
class UScriptStruct* FAnimSubsystem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimSubsystem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimSubsystem, Z_Construct_UPackage__Script_Engine(), TEXT("AnimSubsystem"));
	}
