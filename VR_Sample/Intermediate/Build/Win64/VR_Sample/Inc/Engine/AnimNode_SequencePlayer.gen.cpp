...
class UScriptStruct* FAnimNode_SequencePlayerBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_SequencePlayerBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_SequencePlayerBase, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_SequencePlayerBase"));
	}
...
class UScriptStruct* FAnimNode_SequencePlayer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_SequencePlayer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_SequencePlayer, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_SequencePlayer"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNode_SequencePlayer>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics::NewProp_Sequence = { "Sequence", nullptr, (EPropertyFlags)0x0024080800000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_SequencePlayer, Sequence), Z_Construct_UClass_UAnimSequenceBase_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics::NewProp_Sequence_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics::NewProp_Sequence_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics::NewProp_PlayRateScaleBiasClamp = { "PlayRateScaleBiasClamp", nullptr, (EPropertyFlags)0x0020080820000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_SequencePlayer, PlayRateScaleBiasClamp_DEPRECATED), Z_Construct_UScriptStruct_FInputScaleBiasClamp, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics::NewProp_PlayRateScaleBiasClamp_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics::NewProp_PlayRateScaleBiasClamp_MetaData)) }; // 3749118956
#if WITH_METADATA
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics::ReturnStructParams = {
		...
		IF_WITH_EDITORONLY_DATA(Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics::PropPointers, nullptr),
		IF_WITH_EDITORONLY_DATA(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics::PropPointers), 0),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000201),
...
class UScriptStruct* FAnimNode_SequencePlayer_Standalone::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_SequencePlayer_Standalone.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Standalone, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_SequencePlayer_Standalone"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNode_SequencePlayer_Standalone>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_SequencePlayer_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_SequencePlayerBase::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_SequencePlayerBase_Statics::NewStructOps, TEXT("AnimNode_SequencePlayerBase"), &Z_Registration_Info_UScriptStruct_AnimNode_SequencePlayerBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_SequencePlayerBase), 1781492463U) },
		{ FAnimNode_SequencePlayer::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics::NewStructOps, TEXT("AnimNode_SequencePlayer"), &Z_Registration_Info_UScriptStruct_AnimNode_SequencePlayer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_SequencePlayer), 630849428U) },
		{ FAnimNode_SequencePlayer_Standalone::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Standalone_Statics::NewStructOps, TEXT("AnimNode_SequencePlayer_Standalone"), &Z_Registration_Info_UScriptStruct_AnimNode_SequencePlayer_Standalone, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_SequencePlayer_Standalone), 3647089U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_SequencePlayer_h_3308956451(TEXT("/Script/Engine"),
		nullptr, 0,
