...
class UScriptStruct* FDummySpacerCameraTypes::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DummySpacerCameraTypes.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDummySpacerCameraTypes, Z_Construct_UPackage__Script_Engine(), TEXT("DummySpacerCameraTypes"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FDummySpacerCameraTypes>()
{
	...
	static UEnum* ECameraAlphaBlendMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECameraAlphaBlendMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ECameraAlphaBlendMode, Z_Construct_UPackage__Script_Engine(), TEXT("ECameraAlphaBlendMode"));
		}
