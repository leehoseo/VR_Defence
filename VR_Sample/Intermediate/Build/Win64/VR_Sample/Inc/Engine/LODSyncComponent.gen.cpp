...
class UScriptStruct* FLODMappingData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LODMappingData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLODMappingData, Z_Construct_UPackage__Script_Engine(), TEXT("LODMappingData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FLODMappingData>()
{
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FLODMappingData_Statics::NewProp_Mapping_Inner = { "Mapping", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FLODMappingData_Statics::NewProp_Mapping = { "Mapping", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLODMappingData, Mapping), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FLODMappingData_Statics::NewProp_Mapping_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLODMappingData_Statics::NewProp_Mapping_MetaData)) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FLODMappingData_Statics::NewProp_InverseMapping_Inner = { "InverseMapping", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	static UEnum* ESyncOption_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ESyncOption.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ESyncOption, Z_Construct_UPackage__Script_Engine(), TEXT("ESyncOption"));
		}
...
class UScriptStruct* FComponentSync::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ComponentSync.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FComponentSync, Z_Construct_UPackage__Script_Engine(), TEXT("ComponentSync"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FComponentSync>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FComponentSync_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FComponentSync, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FComponentSync_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FComponentSync_Statics::NewProp_Name_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FComponentSync_Statics::NewProp_SyncOption_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_ULODSyncComponent_GetLODSyncDebugText_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(LODSyncComponent_eventGetLODSyncDebugText_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULODSyncComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULODSyncComponent_GetLODSyncDebugText, "GetLODSyncDebugText" }, // 542425560
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_NumLODs = { "NumLODs", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULODSyncComponent, NumLODs), METADATA_PARAMS(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_NumLODs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_NumLODs_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_ForcedLOD = { "ForcedLOD", nullptr, (EPropertyFlags)0x0010000200000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULODSyncComponent, ForcedLOD), METADATA_PARAMS(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_ForcedLOD_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_ForcedLOD_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_MinLOD = { "MinLOD", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULODSyncComponent, MinLOD), METADATA_PARAMS(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_MinLOD_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_MinLOD_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_ComponentsToSync_Inner = { "ComponentsToSync", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FComponentSync, METADATA_PARAMS(nullptr, 0) }; // 3431233965
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_ComponentsToSync = { "ComponentsToSync", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULODSyncComponent, ComponentsToSync), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_ComponentsToSync_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_ComponentsToSync_MetaData)) }; // 3431233965
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CustomLODMapping_ValueProp = { "CustomLODMapping", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FLODMappingData, METADATA_PARAMS(nullptr, 0) }; // 2279661068
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CustomLODMapping_Key_KeyProp = { "CustomLODMapping_Key", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CustomLODMapping = { "CustomLODMapping", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULODSyncComponent, CustomLODMapping), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CustomLODMapping_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CustomLODMapping_MetaData)) }; // 2279661068
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CurrentLOD_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Components/LODSyncComponent.h" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CurrentLOD = { "CurrentLOD", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULODSyncComponent, CurrentLOD), METADATA_PARAMS(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CurrentLOD_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CurrentLOD_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CurrentNumLODs = { "CurrentNumLODs", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULODSyncComponent, CurrentNumLODs), METADATA_PARAMS(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CurrentNumLODs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_CurrentNumLODs_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_DriveComponents_Inner = { "DriveComponents", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_DriveComponents = { "DriveComponents", nullptr, (EPropertyFlags)0x0044008000002008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULODSyncComponent, DriveComponents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_DriveComponents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_DriveComponents_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_SubComponents_Inner = { "SubComponents", nullptr, (EPropertyFlags)0x0004000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_SubComponents = { "SubComponents", nullptr, (EPropertyFlags)0x0044008000002008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULODSyncComponent, SubComponents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_SubComponents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULODSyncComponent_Statics::NewProp_SubComponents_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_LODSyncComponent_h_Statics::ScriptStructInfo[] = {
		{ FLODMappingData::StaticStruct, Z_Construct_UScriptStruct_FLODMappingData_Statics::NewStructOps, TEXT("LODMappingData"), &Z_Registration_Info_UScriptStruct_LODMappingData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLODMappingData), 2279661068U) },
		{ FComponentSync::StaticStruct, Z_Construct_UScriptStruct_FComponentSync_Statics::NewStructOps, TEXT("ComponentSync"), &Z_Registration_Info_UScriptStruct_ComponentSync, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FComponentSync), 3431233965U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_LODSyncComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULODSyncComponent, ULODSyncComponent::StaticClass, TEXT("ULODSyncComponent"), &Z_Registration_Info_UClass_ULODSyncComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULODSyncComponent), 813467662U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_LODSyncComponent_h_2093438347(TEXT("/Script/Engine"),
