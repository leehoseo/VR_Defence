...
// End Cross Module References
	...
	static UEnum* ModulationParamMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ModulationParamMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ModulationParamMode, Z_Construct_UPackage__Script_Engine(), TEXT("ModulationParamMode"));
		}
...
class UScriptStruct* FModulatorContinuousParams::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ModulatorContinuousParams.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FModulatorContinuousParams, Z_Construct_UPackage__Script_Engine(), TEXT("ModulatorContinuousParams"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FModulatorContinuousParams>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundNodeModulatorContinuous_Statics::NewProp_PitchModulationParams = { "PitchModulationParams", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeModulatorContinuous, PitchModulationParams), Z_Construct_UScriptStruct_FModulatorContinuousParams, METADATA_PARAMS(Z_Construct_UClass_USoundNodeModulatorContinuous_Statics::NewProp_PitchModulationParams_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModulatorContinuous_Statics::NewProp_PitchModulationParams_MetaData)) }; // 2251984059
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundNodeModulatorContinuous_Statics::NewProp_VolumeModulationParams = { "VolumeModulationParams", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeModulatorContinuous, VolumeModulationParams), Z_Construct_UScriptStruct_FModulatorContinuousParams, METADATA_PARAMS(Z_Construct_UClass_USoundNodeModulatorContinuous_Statics::NewProp_VolumeModulationParams_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModulatorContinuous_Statics::NewProp_VolumeModulationParams_MetaData)) }; // 2251984059
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeModulatorContinuous_h_Statics::ScriptStructInfo[] = {
		{ FModulatorContinuousParams::StaticStruct, Z_Construct_UScriptStruct_FModulatorContinuousParams_Statics::NewStructOps, TEXT("ModulatorContinuousParams"), &Z_Registration_Info_UScriptStruct_ModulatorContinuousParams, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FModulatorContinuousParams), 2251984059U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeModulatorContinuous_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundNodeModulatorContinuous, USoundNodeModulatorContinuous::StaticClass, TEXT("USoundNodeModulatorContinuous"), &Z_Registration_Info_UClass_USoundNodeModulatorContinuous, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundNodeModulatorContinuous), 4154863121U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeModulatorContinuous_h_614223156(TEXT("/Script/Engine"),
