...
class UScriptStruct* FActiveHapticFeedbackEffect::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActiveHapticFeedbackEffect.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActiveHapticFeedbackEffect, Z_Construct_UPackage__Script_Engine(), TEXT("ActiveHapticFeedbackEffect"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FActiveHapticFeedbackEffect>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FActiveHapticFeedbackEffect_Statics::NewProp_HapticEffect = { "HapticEffect", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActiveHapticFeedbackEffect, HapticEffect), Z_Construct_UClass_UHapticFeedbackEffect_Base_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FActiveHapticFeedbackEffect_Statics::NewProp_HapticEffect_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActiveHapticFeedbackEffect_Statics::NewProp_HapticEffect_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Haptics_HapticFeedbackEffect_Base_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHapticFeedbackEffect_Base, UHapticFeedbackEffect_Base::StaticClass, TEXT("UHapticFeedbackEffect_Base"), &Z_Registration_Info_UClass_UHapticFeedbackEffect_Base, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHapticFeedbackEffect_Base), 958656943U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Haptics_HapticFeedbackEffect_Base_h_467508640(TEXT("/Script/Engine"),
