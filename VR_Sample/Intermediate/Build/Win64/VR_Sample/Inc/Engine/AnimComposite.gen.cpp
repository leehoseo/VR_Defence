...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UAnimComposite_Statics::NewProp_AnimationTrack = { "AnimationTrack", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimComposite, AnimationTrack), Z_Construct_UScriptStruct_FAnimTrack, METADATA_PARAMS(Z_Construct_UClass_UAnimComposite_Statics::NewProp_AnimationTrack_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimComposite_Statics::NewProp_AnimationTrack_MetaData)) }; // 2960039080
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimComposite_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimComposite, UAnimComposite::StaticClass, TEXT("UAnimComposite"), &Z_Registration_Info_UClass_UAnimComposite, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimComposite), 1377506933U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimComposite_h_4059552979(TEXT("/Script/Engine"),
