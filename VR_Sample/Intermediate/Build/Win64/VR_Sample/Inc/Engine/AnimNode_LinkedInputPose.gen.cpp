...
class UScriptStruct* FAnimNode_LinkedInputPose::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_LinkedInputPose.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_LinkedInputPose, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_LinkedInputPose"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNode_LinkedInputPose>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimNode_LinkedInputPose_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_LinkedInputPose, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_LinkedInputPose_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_LinkedInputPose_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_LinkedInputPose_Statics::NewProp_InputPose = { "InputPose", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_LinkedInputPose, InputPose), Z_Construct_UScriptStruct_FPoseLink, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_LinkedInputPose_Statics::NewProp_InputPose_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_LinkedInputPose_Statics::NewProp_InputPose_MetaData)) }; // 2393943538
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_LinkedInputPose_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_LinkedInputPose::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_LinkedInputPose_Statics::NewStructOps, TEXT("AnimNode_LinkedInputPose"), &Z_Registration_Info_UScriptStruct_AnimNode_LinkedInputPose, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_LinkedInputPose), 2141038966U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_LinkedInputPose_h_591733492(TEXT("/Script/Engine"),
		nullptr, 0,
