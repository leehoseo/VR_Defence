...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_AGameState_Statics::NewProp_MatchState = { "MatchState", "OnRep_MatchState", (EPropertyFlags)0x0020080100020835, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameState, MatchState), METADATA_PARAMS(Z_Construct_UClass_AGameState_Statics::NewProp_MatchState_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGameState_Statics::NewProp_MatchState_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_AGameState_Statics::NewProp_PreviousMatchState = { "PreviousMatchState", nullptr, (EPropertyFlags)0x0020080000020815, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameState, PreviousMatchState), METADATA_PARAMS(Z_Construct_UClass_AGameState_Statics::NewProp_PreviousMatchState_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGameState_Statics::NewProp_PreviousMatchState_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_AGameState_Statics::NewProp_ElapsedTime = { "ElapsedTime", "OnRep_ElapsedTime", (EPropertyFlags)0x0010000100000034, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGameState, ElapsedTime), METADATA_PARAMS(Z_Construct_UClass_AGameState_Statics::NewProp_ElapsedTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGameState_Statics::NewProp_ElapsedTime_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_GameState_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGameState, AGameState::StaticClass, TEXT("AGameState"), &Z_Registration_Info_UClass_AGameState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGameState), 1320004354U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_GameState_h_1016834562(TEXT("/Script/Engine"),
