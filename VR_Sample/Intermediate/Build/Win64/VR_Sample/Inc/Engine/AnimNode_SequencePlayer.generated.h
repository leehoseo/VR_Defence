...
template<> ENGINE_API UScriptStruct* StaticStruct<struct FAnimNode_SequencePlayerBase>();

#define FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_SequencePlayer_h_86_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Statics; \
	static class UScriptStruct* StaticStruct(); \
	typedef FAnimNode_SequencePlayerBase Super;


template<> ENGINE_API UScriptStruct* StaticStruct<struct FAnimNode_SequencePlayer>();

#define FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_SequencePlayer_h_171_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FAnimNode_SequencePlayer_Standalone_Statics; \
	static class UScriptStruct* StaticStruct(); \
	typedef FAnimNode_SequencePlayerBase Super;


template<> ENGINE_API UScriptStruct* StaticStruct<struct FAnimNode_SequencePlayer_Standalone>();
