...
class UScriptStruct* FDialogueContextMapping::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DialogueContextMapping.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDialogueContextMapping, Z_Construct_UPackage__Script_Engine(), TEXT("DialogueContextMapping"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FDialogueContextMapping>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_Context = { "Context", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDialogueContextMapping, Context), Z_Construct_UScriptStruct_FDialogueContext, METADATA_PARAMS(Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_Context_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_Context_MetaData)) }; // 1679063042
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_SoundWave = { "SoundWave", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDialogueContextMapping, SoundWave), Z_Construct_UClass_USoundWave_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_SoundWave_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_SoundWave_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_LocalizationKeyFormat = { "LocalizationKeyFormat", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDialogueContextMapping, LocalizationKeyFormat), METADATA_PARAMS(Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_LocalizationKeyFormat_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_LocalizationKeyFormat_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_Proxy = { "Proxy", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDialogueContextMapping, Proxy), Z_Construct_UClass_UDialogueSoundWaveProxy_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_Proxy_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewProp_Proxy_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UDialogueWave_Statics::NewProp_bMature = { "bMature", nullptr, (EPropertyFlags)0x0010010000000015, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UDialogueWave), &Z_Construct_UClass_UDialogueWave_Statics::NewProp_bMature_SetBit, METADATA_PARAMS(Z_Construct_UClass_UDialogueWave_Statics::NewProp_bMature_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueWave_Statics::NewProp_bMature_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDialogueWave_Statics::NewProp_SpokenText = { "SpokenText", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDialogueWave, SpokenText), METADATA_PARAMS(Z_Construct_UClass_UDialogueWave_Statics::NewProp_SpokenText_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueWave_Statics::NewProp_SpokenText_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDialogueWave_Statics::NewProp_VoiceActorDirection = { "VoiceActorDirection", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDialogueWave, VoiceActorDirection), METADATA_PARAMS(Z_Construct_UClass_UDialogueWave_Statics::NewProp_VoiceActorDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDialogueWave_Statics::NewProp_VoiceActorDirection_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDialogueWave_Statics::NewProp_ContextMappings_Inner = { "ContextMappings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FDialogueContextMapping, METADATA_PARAMS(nullptr, 0) }; // 3236813303
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_DialogueWave_h_Statics::ScriptStructInfo[] = {
		{ FDialogueContextMapping::StaticStruct, Z_Construct_UScriptStruct_FDialogueContextMapping_Statics::NewStructOps, TEXT("DialogueContextMapping"), &Z_Registration_Info_UScriptStruct_DialogueContextMapping, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDialogueContextMapping), 3236813303U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_DialogueWave_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDialogueWave, UDialogueWave::StaticClass, TEXT("UDialogueWave"), &Z_Registration_Info_UClass_UDialogueWave, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDialogueWave), 1101249927U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_DialogueWave_h_3522878259(TEXT("/Script/Engine"),
