...
#include "Engine/Public/WorldPartition/WorldPartitionActorCluster.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeWorldPartitionActorCluster() {}
...
class UScriptStruct* FActorContainerID::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActorContainerID.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActorContainerID, Z_Construct_UPackage__Script_Engine(), TEXT("ActorContainerID"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FActorContainerID>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FActorContainerID_Statics::Struct_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/WorldPartition/WorldPartitionActorCluster.h" },
	};
#endif
...
#endif
	const UECodeGen_Private::FFInt64PropertyParams Z_Construct_UScriptStruct_FActorContainerID_Statics::NewProp_ID = { "ID", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt64, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActorContainerID, ID), METADATA_PARAMS(Z_Construct_UScriptStruct_FActorContainerID_Statics::NewProp_ID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActorContainerID_Statics::NewProp_ID_MetaData)) };
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionActorCluster_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionActorCluster_h_Statics::ScriptStructInfo[] = {
		{ FActorContainerID::StaticStruct, Z_Construct_UScriptStruct_FActorContainerID_Statics::NewStructOps, TEXT("ActorContainerID"), &Z_Registration_Info_UScriptStruct_ActorContainerID, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FActorContainerID), 3032495807U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionActorCluster_h_2640059273(TEXT("/Script/Engine"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionActorCluster_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionActorCluster_h_Statics::ScriptStructInfo),
		nullptr, 0);
