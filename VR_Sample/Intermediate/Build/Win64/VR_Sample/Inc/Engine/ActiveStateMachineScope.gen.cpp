...
#include "Engine/Public/Animation/ActiveStateMachineScope.h"
...
class UScriptStruct* FEncounteredStateMachineStack::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EncounteredStateMachineStack.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEncounteredStateMachineStack, Z_Construct_UPackage__Script_Engine(), TEXT("EncounteredStateMachineStack"));
	}
