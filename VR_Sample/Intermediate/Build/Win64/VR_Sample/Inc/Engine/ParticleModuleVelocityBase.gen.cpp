...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleVelocityBase_Statics::NewProp_bInWorldSpace = { "bInWorldSpace", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleVelocityBase), &Z_Construct_UClass_UParticleModuleVelocityBase_Statics::NewProp_bInWorldSpace_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleVelocityBase_Statics::NewProp_bInWorldSpace_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleVelocityBase_Statics::NewProp_bInWorldSpace_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Velocity_ParticleModuleVelocityBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleVelocityBase, UParticleModuleVelocityBase::StaticClass, TEXT("UParticleModuleVelocityBase"), &Z_Registration_Info_UClass_UParticleModuleVelocityBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleVelocityBase), 3005257856U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Velocity_ParticleModuleVelocityBase_h_41854330(TEXT("/Script/Engine"),
