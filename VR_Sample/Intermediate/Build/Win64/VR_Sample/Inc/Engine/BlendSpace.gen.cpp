...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAnalysisProperties_Statics::NewProp_Function = { "Function", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnalysisProperties, Function), METADATA_PARAMS(Z_Construct_UClass_UAnalysisProperties_Statics::NewProp_Function_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnalysisProperties_Statics::NewProp_Function_MetaData)) };
	...
	static UEnum* EBlendSpaceAxis_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EBlendSpaceAxis.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EBlendSpaceAxis, Z_Construct_UPackage__Script_Engine(), TEXT("EBlendSpaceAxis"));
		}
	...
	static UEnum* EPreferredTriangulationDirection_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPreferredTriangulationDirection.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EPreferredTriangulationDirection, Z_Construct_UPackage__Script_Engine(), TEXT("EPreferredTriangulationDirection"));
		}
...
class UScriptStruct* FInterpolationParameter::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InterpolationParameter.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInterpolationParameter, Z_Construct_UPackage__Script_Engine(), TEXT("InterpolationParameter"));
	}
...
class UScriptStruct* FBlendParameter::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlendParameter.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlendParameter, Z_Construct_UPackage__Script_Engine(), TEXT("BlendParameter"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBlendParameter>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FBlendParameter_Statics::NewProp_bSnapToGrid = { "bSnapToGrid", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FBlendParameter), &Z_Construct_UScriptStruct_FBlendParameter_Statics::NewProp_bSnapToGrid_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlendParameter_Statics::NewProp_bSnapToGrid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlendParameter_Statics::NewProp_bSnapToGrid_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FBlendSample::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlendSample.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlendSample, Z_Construct_UPackage__Script_Engine(), TEXT("BlendSample"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBlendSample>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FBlendSample_Statics::NewProp_bIsValid = { "bIsValid", nullptr, (EPropertyFlags)0x0010000800002000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FBlendSample), &Z_Construct_UScriptStruct_FBlendSample_Statics::NewProp_bIsValid_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlendSample_Statics::NewProp_bIsValid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlendSample_Statics::NewProp_bIsValid_MetaData)) };
#endif // WITH_EDITORONLY_DATA
...
class UScriptStruct* FBlendSpaceSegment::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlendSpaceSegment.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlendSpaceSegment, Z_Construct_UPackage__Script_Engine(), TEXT("BlendSpaceSegment"));
	}
...
class UScriptStruct* FBlendSpaceTriangleEdgeInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlendSpaceTriangleEdgeInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlendSpaceTriangleEdgeInfo, Z_Construct_UPackage__Script_Engine(), TEXT("BlendSpaceTriangleEdgeInfo"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBlendSpaceTriangleEdgeInfo_Statics::NewProp_Normal = { "Normal", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlendSpaceTriangleEdgeInfo, Normal), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlendSpaceTriangleEdgeInfo_Statics::NewProp_Normal_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlendSpaceTriangleEdgeInfo_Statics::NewProp_Normal_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FBlendSpaceTriangleEdgeInfo_Statics::NewProp_NeighbourTriangleIndex = { "NeighbourTriangleIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlendSpaceTriangleEdgeInfo, NeighbourTriangleIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FBlendSpaceTriangleEdgeInfo_Statics::NewProp_NeighbourTriangleIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlendSpaceTriangleEdgeInfo_Statics::NewProp_NeighbourTriangleIndex_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FBlendSpaceTriangle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlendSpaceTriangle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlendSpaceTriangle, Z_Construct_UPackage__Script_Engine(), TEXT("BlendSpaceTriangle"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBlendSpaceTriangle_Statics::NewProp_EdgeInfo = { "EdgeInfo", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, CPP_ARRAY_DIM(EdgeInfo, FBlendSpaceTriangle), STRUCT_OFFSET(FBlendSpaceTriangle, EdgeInfo), Z_Construct_UScriptStruct_FBlendSpaceTriangleEdgeInfo, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlendSpaceTriangle_Statics::NewProp_EdgeInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlendSpaceTriangle_Statics::NewProp_EdgeInfo_MetaData)) }; // 611472479
...
class UScriptStruct* FWeightedBlendSample::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WeightedBlendSample.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeightedBlendSample, Z_Construct_UPackage__Script_Engine(), TEXT("WeightedBlendSample"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FWeightedBlendSample_Statics::NewProp_SampleIndex = { "SampleIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWeightedBlendSample, SampleIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FWeightedBlendSample_Statics::NewProp_SampleIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWeightedBlendSample_Statics::NewProp_SampleIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FWeightedBlendSample_Statics::NewProp_SampleWeight = { "SampleWeight", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWeightedBlendSample, SampleWeight), METADATA_PARAMS(Z_Construct_UScriptStruct_FWeightedBlendSample_Statics::NewProp_SampleWeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWeightedBlendSample_Statics::NewProp_SampleWeight_MetaData)) };
...
class UScriptStruct* FBlendSpaceData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlendSpaceData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlendSpaceData, Z_Construct_UPackage__Script_Engine(), TEXT("BlendSpaceData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBlendSpaceData>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewProp_Segments_Inner = { "Segments", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBlendSpaceSegment, METADATA_PARAMS(nullptr, 0) }; // 1373862984
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewProp_Segments_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Animation/BlendSpace.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewProp_Segments = { "Segments", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlendSpaceData, Segments), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewProp_Segments_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewProp_Segments_MetaData)) }; // 1373862984
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewProp_Triangles_Inner = { "Triangles", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBlendSpaceTriangle, METADATA_PARAMS(nullptr, 0) }; // 1603685907
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewProp_Triangles_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Animation/BlendSpace.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewProp_Triangles = { "Triangles", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBlendSpaceData, Triangles), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewProp_Triangles_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewProp_Triangles_MetaData)) }; // 1603685907
...
class UScriptStruct* FEditorElement::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EditorElement.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEditorElement, Z_Construct_UPackage__Script_Engine(), TEXT("EditorElement"));
	}
...
class UScriptStruct* FGridBlendSample::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GridBlendSample.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGridBlendSample, Z_Construct_UPackage__Script_Engine(), TEXT("GridBlendSample"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FGridBlendSample_Statics::NewProp_BlendWeight = { "BlendWeight", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGridBlendSample, BlendWeight), METADATA_PARAMS(Z_Construct_UScriptStruct_FGridBlendSample_Statics::NewProp_BlendWeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGridBlendSample_Statics::NewProp_BlendWeight_MetaData)) };
...
class UScriptStruct* FPerBoneInterpolation::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PerBoneInterpolation.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPerBoneInterpolation, Z_Construct_UPackage__Script_Engine(), TEXT("PerBoneInterpolation"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPerBoneInterpolation>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPerBoneInterpolation_Statics::NewProp_BoneReference = { "BoneReference", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPerBoneInterpolation, BoneReference), Z_Construct_UScriptStruct_FBoneReference, METADATA_PARAMS(Z_Construct_UScriptStruct_FPerBoneInterpolation_Statics::NewProp_BoneReference_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerBoneInterpolation_Statics::NewProp_BoneReference_MetaData)) }; // 831728502
#if WITH_METADATA
	...
	static UEnum* ENotifyTriggerMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENotifyTriggerMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ENotifyTriggerMode, Z_Construct_UPackage__Script_Engine(), TEXT("ENotifyTriggerMode"));
		}
	...
	struct Z_Construct_UClass_UBlendSpace_Statics
	{
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bRotationBlendInMeshSpace_MetaData[];
#endif
		static void NewProp_bRotationBlendInMeshSpace_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bRotationBlendInMeshSpace;
#if WITH_METADATA
		...
		static const UECodeGen_Private::FStructPropertyParams NewProp_PerBoneBlend_Inner;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_PerBoneBlend_MetaData[];
#endif
		static const UECodeGen_Private::FArrayPropertyParams NewProp_PerBoneBlend;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBlendSpace_Statics::NewProp_bRotationBlendInMeshSpace_MetaData[] = {
		{ "Comment", "/**\n\x09* When you use per bone sample smoothing, this makes blending happen in mesh space and can happen if this \n\x09* contains additive animation samples. This is more performance intensive than blending in local space.\n\x09*/" },
		{ "ModuleRelativePath", "Classes/Animation/BlendSpace.h" },
		{ "ToolTip", "When you use per bone sample smoothing, this makes blending happen in mesh space and can happen if this\ncontains additive animation samples. This is more performance intensive than blending in local space." },
	};
#endif
	void Z_Construct_UClass_UBlendSpace_Statics::NewProp_bRotationBlendInMeshSpace_SetBit(void* Obj)
	{
		((UBlendSpace*)Obj)->bRotationBlendInMeshSpace = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_bRotationBlendInMeshSpace = { "bRotationBlendInMeshSpace", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBlendSpace), &Z_Construct_UClass_UBlendSpace_Statics::NewProp_bRotationBlendInMeshSpace_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_bRotationBlendInMeshSpace_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_bRotationBlendInMeshSpace_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_InterpolationParam = { "InterpolationParam", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, CPP_ARRAY_DIM(InterpolationParam, UBlendSpace), STRUCT_OFFSET(UBlendSpace, InterpolationParam), Z_Construct_UScriptStruct_FInterpolationParameter, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_InterpolationParam_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_InterpolationParam_MetaData)) }; // 3183802963
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_bTargetWeightInterpolationEaseInOut = { "bTargetWeightInterpolationEaseInOut", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBlendSpace), &Z_Construct_UClass_UBlendSpace_Statics::NewProp_bTargetWeightInterpolationEaseInOut_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_bTargetWeightInterpolationEaseInOut_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_bTargetWeightInterpolationEaseInOut_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_PreviewBasePose = { "PreviewBasePose", nullptr, (EPropertyFlags)0x0014000800000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, PreviewBasePose), Z_Construct_UClass_UAnimSequence_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_PreviewBasePose_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_PreviewBasePose_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_AnimLength = { "AnimLength", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, AnimLength), METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_AnimLength_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_AnimLength_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_NotifyTriggerMode = { "NotifyTriggerMode", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, NotifyTriggerMode), Z_Construct_UEnum_Engine_ENotifyTriggerMode, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_NotifyTriggerMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_NotifyTriggerMode_MetaData)) }; // 1825645775
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_bInterpolateUsingGrid = { "bInterpolateUsingGrid", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UBlendSpace), &Z_Construct_UClass_UBlendSpace_Statics::NewProp_bInterpolateUsingGrid_SetBit, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_bInterpolateUsingGrid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_bInterpolateUsingGrid_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_PreferredTriangulationDirection_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_PreferredTriangulationDirection = { "PreferredTriangulationDirection", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, PreferredTriangulationDirection), Z_Construct_UEnum_Engine_EPreferredTriangulationDirection, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_PreferredTriangulationDirection_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_PreferredTriangulationDirection_MetaData)) }; // 2397903895
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_PerBoneBlend_Inner = { "PerBoneBlend", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPerBoneInterpolation, METADATA_PARAMS(nullptr, 0) }; // 659066533
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBlendSpace_Statics::NewProp_PerBoneBlend_MetaData[] = {
		{ "Category", "SampleSmoothing" },
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_PerBoneBlend = { "PerBoneBlend", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, PerBoneBlend), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_PerBoneBlend_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_PerBoneBlend_MetaData)) }; // 659066533
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_SampleIndexWithMarkers = { "SampleIndexWithMarkers", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, SampleIndexWithMarkers), METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_SampleIndexWithMarkers_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_SampleIndexWithMarkers_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_SampleData_Inner = { "SampleData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBlendSample, METADATA_PARAMS(nullptr, 0) }; // 425319858
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_SampleData = { "SampleData", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, SampleData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_SampleData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_SampleData_MetaData)) }; // 425319858
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_GridSamples_Inner = { "GridSamples", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FEditorElement, METADATA_PARAMS(nullptr, 0) }; // 2863186232
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_GridSamples = { "GridSamples", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, GridSamples), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_GridSamples_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_GridSamples_MetaData)) }; // 2863186232
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_BlendSpaceData = { "BlendSpaceData", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, BlendSpaceData), Z_Construct_UScriptStruct_FBlendSpaceData, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_BlendSpaceData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_BlendSpaceData_MetaData)) }; // 1439101909
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_AxisToScaleAnimation = { "AxisToScaleAnimation", nullptr, (EPropertyFlags)0x0020080000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, AxisToScaleAnimation), Z_Construct_UEnum_Engine_EBlendSpaceAxis, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_AxisToScaleAnimation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_AxisToScaleAnimation_MetaData)) }; // 1438673726
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_DimensionIndices_Inner = { "DimensionIndices", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UBlendSpace_Statics::NewProp_DimensionIndices = { "DimensionIndices", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBlendSpace, DimensionIndices), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UBlendSpace_Statics::NewProp_DimensionIndices_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBlendSpace_Statics::NewProp_DimensionIndices_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UBlendSpace_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBlendSpace_Statics::NewProp_bRotationBlendInMeshSpace,
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBlendSpace_Statics::NewProp_PerBoneBlend_Inner,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBlendSpace_Statics::NewProp_PerBoneBlend,
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_BlendSpace_h_Statics::ScriptStructInfo[] = {
		{ FInterpolationParameter::StaticStruct, Z_Construct_UScriptStruct_FInterpolationParameter_Statics::NewStructOps, TEXT("InterpolationParameter"), &Z_Registration_Info_UScriptStruct_InterpolationParameter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInterpolationParameter), 3183802963U) },
		{ FBlendParameter::StaticStruct, Z_Construct_UScriptStruct_FBlendParameter_Statics::NewStructOps, TEXT("BlendParameter"), &Z_Registration_Info_UScriptStruct_BlendParameter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlendParameter), 594915546U) },
		{ FBlendSample::StaticStruct, Z_Construct_UScriptStruct_FBlendSample_Statics::NewStructOps, TEXT("BlendSample"), &Z_Registration_Info_UScriptStruct_BlendSample, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlendSample), 425319858U) },
		{ FBlendSpaceSegment::StaticStruct, Z_Construct_UScriptStruct_FBlendSpaceSegment_Statics::NewStructOps, TEXT("BlendSpaceSegment"), &Z_Registration_Info_UScriptStruct_BlendSpaceSegment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlendSpaceSegment), 1373862984U) },
		...
		{ FBlendSpaceTriangle::StaticStruct, Z_Construct_UScriptStruct_FBlendSpaceTriangle_Statics::NewStructOps, TEXT("BlendSpaceTriangle"), &Z_Registration_Info_UScriptStruct_BlendSpaceTriangle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlendSpaceTriangle), 1603685907U) },
		{ FWeightedBlendSample::StaticStruct, Z_Construct_UScriptStruct_FWeightedBlendSample_Statics::NewStructOps, TEXT("WeightedBlendSample"), &Z_Registration_Info_UScriptStruct_WeightedBlendSample, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWeightedBlendSample), 2637512286U) },
		{ FBlendSpaceData::StaticStruct, Z_Construct_UScriptStruct_FBlendSpaceData_Statics::NewStructOps, TEXT("BlendSpaceData"), &Z_Registration_Info_UScriptStruct_BlendSpaceData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBlendSpaceData), 1439101909U) },
		{ FEditorElement::StaticStruct, Z_Construct_UScriptStruct_FEditorElement_Statics::NewStructOps, TEXT("EditorElement"), &Z_Registration_Info_UScriptStruct_EditorElement, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FEditorElement), 2863186232U) },
		{ FGridBlendSample::StaticStruct, Z_Construct_UScriptStruct_FGridBlendSample_Statics::NewStructOps, TEXT("GridBlendSample"), &Z_Registration_Info_UScriptStruct_GridBlendSample, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGridBlendSample), 20321044U) },
		{ FPerBoneInterpolation::StaticStruct, Z_Construct_UScriptStruct_FPerBoneInterpolation_Statics::NewStructOps, TEXT("PerBoneInterpolation"), &Z_Registration_Info_UScriptStruct_PerBoneInterpolation, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPerBoneInterpolation), 659066533U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_BlendSpace_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnalysisProperties, UAnalysisProperties::StaticClass, TEXT("UAnalysisProperties"), &Z_Registration_Info_UClass_UAnalysisProperties, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnalysisProperties), 2697444770U) },
		{ Z_Construct_UClass_UBlendSpace, UBlendSpace::StaticClass, TEXT("UBlendSpace"), &Z_Registration_Info_UClass_UBlendSpace, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBlendSpace), 222657778U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_BlendSpace_h_1064113114(TEXT("/Script/Engine"),
