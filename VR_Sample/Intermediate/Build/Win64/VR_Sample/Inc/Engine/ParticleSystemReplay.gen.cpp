...
class UScriptStruct* FParticleEmitterReplayFrame::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ParticleEmitterReplayFrame.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FParticleEmitterReplayFrame, Z_Construct_UPackage__Script_Engine(), TEXT("ParticleEmitterReplayFrame"));
	}
...
class UScriptStruct* FParticleSystemReplayFrame::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ParticleSystemReplayFrame.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FParticleSystemReplayFrame, Z_Construct_UPackage__Script_Engine(), TEXT("ParticleSystemReplayFrame"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FParticleSystemReplayFrame>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UParticleSystemReplay_Statics::NewProp_ClipIDNumber = { "ClipIDNumber", nullptr, (EPropertyFlags)0x0010000000202001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleSystemReplay, ClipIDNumber), METADATA_PARAMS(Z_Construct_UClass_UParticleSystemReplay_Statics::NewProp_ClipIDNumber_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleSystemReplay_Statics::NewProp_ClipIDNumber_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_ParticleSystemReplay_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleSystemReplay, UParticleSystemReplay::StaticClass, TEXT("UParticleSystemReplay"), &Z_Registration_Info_UClass_UParticleSystemReplay, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleSystemReplay), 3553672398U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_ParticleSystemReplay_h_1600313417(TEXT("/Script/Engine"),
