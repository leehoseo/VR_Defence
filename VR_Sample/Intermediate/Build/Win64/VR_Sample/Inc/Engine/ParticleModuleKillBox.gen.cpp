...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_LowerLeftCorner = { "LowerLeftCorner", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleKillBox, LowerLeftCorner), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_LowerLeftCorner_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_LowerLeftCorner_MetaData)) }; // 3599899551
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_UpperRightCorner = { "UpperRightCorner", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleKillBox, UpperRightCorner), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_UpperRightCorner_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_UpperRightCorner_MetaData)) }; // 3599899551
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bAbsolute = { "bAbsolute", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleKillBox), &Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bAbsolute_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bAbsolute_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bAbsolute_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bKillInside = { "bKillInside", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleKillBox), &Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bKillInside_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bKillInside_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bKillInside_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bAxisAlignedAndFixedSize = { "bAxisAlignedAndFixedSize", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleKillBox), &Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bAxisAlignedAndFixedSize_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bAxisAlignedAndFixedSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillBox_Statics::NewProp_bAxisAlignedAndFixedSize_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Kill_ParticleModuleKillBox_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleKillBox, UParticleModuleKillBox::StaticClass, TEXT("UParticleModuleKillBox"), &Z_Registration_Info_UClass_UParticleModuleKillBox, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleKillBox), 2232857030U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Kill_ParticleModuleKillBox_h_3072561276(TEXT("/Script/Engine"),
