...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_TerminalVelocity = { "TerminalVelocity", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APhysicsVolume, TerminalVelocity), METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_TerminalVelocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_TerminalVelocity_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_Priority = { "Priority", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APhysicsVolume, Priority), METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_Priority_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_Priority_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_FluidFriction = { "FluidFriction", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(APhysicsVolume, FluidFriction), METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_FluidFriction_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_FluidFriction_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bWaterVolume = { "bWaterVolume", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(APhysicsVolume), &Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bWaterVolume_SetBit, METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bWaterVolume_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bWaterVolume_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact = { "bPhysicsOnContact", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(APhysicsVolume), &Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact_SetBit, METADATA_PARAMS(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APhysicsVolume_Statics::NewProp_bPhysicsOnContact_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_PhysicsVolume_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_APhysicsVolume, APhysicsVolume::StaticClass, TEXT("APhysicsVolume"), &Z_Registration_Info_UClass_APhysicsVolume, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APhysicsVolume), 1780238417U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_PhysicsVolume_h_3793754946(TEXT("/Script/Engine"),
