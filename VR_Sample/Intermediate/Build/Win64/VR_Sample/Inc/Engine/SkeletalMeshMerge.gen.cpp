...
class UScriptStruct* FSkelMeshMergeSectionMapping::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SkelMeshMergeSectionMapping.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping, Z_Construct_UPackage__Script_Engine(), TEXT("SkelMeshMergeSectionMapping"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FSkelMeshMergeSectionMapping>()
{
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_Statics::NewProp_SectionIDs_Inner = { "SectionIDs", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
class UScriptStruct* FSkelMeshMergeMeshUVTransforms::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SkelMeshMergeMeshUVTransforms.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSkelMeshMergeMeshUVTransforms, Z_Construct_UPackage__Script_Engine(), TEXT("SkelMeshMergeMeshUVTransforms"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FSkelMeshMergeMeshUVTransforms>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSkelMeshMergeMeshUVTransforms_Statics::NewProp_UVTransforms_Inner = { "UVTransforms", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSkelMeshMergeMeshUVTransforms_Statics::NewProp_UVTransforms = { "UVTransforms", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSkelMeshMergeMeshUVTransforms, UVTransforms), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FSkelMeshMergeMeshUVTransforms_Statics::NewProp_UVTransforms_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSkelMeshMergeMeshUVTransforms_Statics::NewProp_UVTransforms_MetaData)) };
...
class UScriptStruct* FSkelMeshMergeUVTransformMapping::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SkelMeshMergeUVTransformMapping.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping, Z_Construct_UPackage__Script_Engine(), TEXT("SkelMeshMergeUVTransformMapping"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FSkelMeshMergeUVTransformMapping>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping_Statics::NewProp_UVTransformsPerMesh_Inner = { "UVTransformsPerMesh", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSkelMeshMergeMeshUVTransforms, METADATA_PARAMS(nullptr, 0) }; // 2871876234
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping_Statics::NewProp_UVTransformsPerMesh = { "UVTransformsPerMesh", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSkelMeshMergeUVTransformMapping, UVTransformsPerMesh), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping_Statics::NewProp_UVTransformsPerMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping_Statics::NewProp_UVTransformsPerMesh_MetaData)) }; // 2871876234
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_SkeletalMeshMerge_h_Statics::ScriptStructInfo[] = {
		{ FSkelMeshMergeSectionMapping::StaticStruct, Z_Construct_UScriptStruct_FSkelMeshMergeSectionMapping_Statics::NewStructOps, TEXT("SkelMeshMergeSectionMapping"), &Z_Registration_Info_UScriptStruct_SkelMeshMergeSectionMapping, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSkelMeshMergeSectionMapping), 3410626418U) },
		...
		{ FSkelMeshMergeUVTransformMapping::StaticStruct, Z_Construct_UScriptStruct_FSkelMeshMergeUVTransformMapping_Statics::NewStructOps, TEXT("SkelMeshMergeUVTransformMapping"), &Z_Registration_Info_UScriptStruct_SkelMeshMergeUVTransformMapping, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSkelMeshMergeUVTransformMapping), 353513247U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_SkeletalMeshMerge_h_1845096035(TEXT("/Script/Engine"),
		nullptr, 0,
