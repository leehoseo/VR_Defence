...
// End Cross Module References
	...
	static UEnum* FNavigationSystemRunMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_FNavigationSystemRunMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_FNavigationSystemRunMode, Z_Construct_UPackage__Script_Engine(), TEXT("FNavigationSystemRunMode"));
		}
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_AI_NavigationSystemBase_h_Statics::EnumInfo[] = {
		{ FNavigationSystemRunMode_StaticEnum, TEXT("FNavigationSystemRunMode"), &Z_Registration_Info_UEnum_FNavigationSystemRunMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 628240996U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_AI_NavigationSystemBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNavigationSystemBase, UNavigationSystemBase::StaticClass, TEXT("UNavigationSystemBase"), &Z_Registration_Info_UClass_UNavigationSystemBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNavigationSystemBase), 1472707717U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_AI_NavigationSystemBase_h_2178683262(TEXT("/Script/Engine"),
