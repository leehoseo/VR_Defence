...
class UScriptStruct* FKShapeElem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KShapeElem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKShapeElem, Z_Construct_UPackage__Script_Engine(), TEXT("KShapeElem"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FKShapeElem>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bIsGenerated = { "bIsGenerated", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FKShapeElem), &Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bIsGenerated_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bIsGenerated_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bIsGenerated_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKShapeElem, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bContributeToMass = { "bContributeToMass", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(FKShapeElem), &Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bContributeToMass_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bContributeToMass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_bContributeToMass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_CollisionEnabled = { "CollisionEnabled", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKShapeElem, CollisionEnabled), Z_Construct_UEnum_Engine_ECollisionEnabled, METADATA_PARAMS(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_CollisionEnabled_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKShapeElem_Statics::NewProp_CollisionEnabled_MetaData)) }; // 1718742452
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_ShapeElem_h_Statics::ScriptStructInfo[] = {
		{ FKShapeElem::StaticStruct, Z_Construct_UScriptStruct_FKShapeElem_Statics::NewStructOps, TEXT("KShapeElem"), &Z_Registration_Info_UScriptStruct_KShapeElem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FKShapeElem), 1771999482U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_ShapeElem_h_1944993000(TEXT("/Script/Engine"),
		nullptr, 0,
