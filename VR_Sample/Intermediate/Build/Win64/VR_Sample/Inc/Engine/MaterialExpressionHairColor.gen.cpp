...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionHairColor_Statics::NewProp_Redness = { "Redness", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionHairColor, Redness), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionHairColor_Statics::NewProp_Redness_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionHairColor_Statics::NewProp_Redness_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionHairColor_Statics::NewProp_DyeColor = { "DyeColor", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionHairColor, DyeColor), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionHairColor_Statics::NewProp_DyeColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionHairColor_Statics::NewProp_DyeColor_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionHairColor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionHairColor, UMaterialExpressionHairColor::StaticClass, TEXT("UMaterialExpressionHairColor"), &Z_Registration_Info_UClass_UMaterialExpressionHairColor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionHairColor), 1927023572U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionHairColor_h_1465101189(TEXT("/Script/Engine"),
