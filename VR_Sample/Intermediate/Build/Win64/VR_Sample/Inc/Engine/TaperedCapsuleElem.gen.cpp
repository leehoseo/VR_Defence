...
class UScriptStruct* FKTaperedCapsuleElem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KTaperedCapsuleElem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKTaperedCapsuleElem, Z_Construct_UPackage__Script_Engine(), TEXT("KTaperedCapsuleElem"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FKTaperedCapsuleElem>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_TaperedCapsuleElem_h_Statics::ScriptStructInfo[] = {
		{ FKTaperedCapsuleElem::StaticStruct, Z_Construct_UScriptStruct_FKTaperedCapsuleElem_Statics::NewStructOps, TEXT("KTaperedCapsuleElem"), &Z_Registration_Info_UScriptStruct_KTaperedCapsuleElem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FKTaperedCapsuleElem), 3098003176U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_TaperedCapsuleElem_h_1278522105(TEXT("/Script/Engine"),
		nullptr, 0,
