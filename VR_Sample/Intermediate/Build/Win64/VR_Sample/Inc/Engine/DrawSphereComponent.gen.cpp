...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDrawSphereComponent_Statics::Class_MetaDataParams[] = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UDrawSphereComponent_Statics::ClassParams = {
		...
		0,
		0x00A830A4u,
		METADATA_PARAMS(Z_Construct_UClass_UDrawSphereComponent_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UDrawSphereComponent_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_DrawSphereComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDrawSphereComponent, UDrawSphereComponent::StaticClass, TEXT("UDrawSphereComponent"), &Z_Registration_Info_UClass_UDrawSphereComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDrawSphereComponent), 4265658395U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_DrawSphereComponent_h_144211687(TEXT("/Script/Engine"),
