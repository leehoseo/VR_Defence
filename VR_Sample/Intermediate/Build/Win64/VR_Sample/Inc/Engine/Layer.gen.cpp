...
class UScriptStruct* FLayerActorStats::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LayerActorStats.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLayerActorStats, Z_Construct_UPackage__Script_Engine(), TEXT("LayerActorStats"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FLayerActorStats>()
{
...
#endif
	const UECodeGen_Private::FClassPtrPropertyParams Z_Construct_UScriptStruct_FLayerActorStats_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLayerActorStats, Type), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FLayerActorStats_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLayerActorStats_Statics::NewProp_Type_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FLayerActorStats_Statics::NewProp_Total = { "Total", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLayerActorStats, Total), METADATA_PARAMS(Z_Construct_UScriptStruct_FLayerActorStats_Statics::NewProp_Total_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLayerActorStats_Statics::NewProp_Total_MetaData)) };
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_ULayer_Statics::NewProp_LayerName = { "LayerName", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULayer, LayerName), METADATA_PARAMS(Z_Construct_UClass_ULayer_Statics::NewProp_LayerName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULayer_Statics::NewProp_LayerName_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULayer_Statics::NewProp_bIsVisible = { "bIsVisible", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ULayer), &Z_Construct_UClass_ULayer_Statics::NewProp_bIsVisible_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULayer_Statics::NewProp_bIsVisible_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULayer_Statics::NewProp_bIsVisible_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULayer_Statics::NewProp_ActorStats_Inner = { "ActorStats", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FLayerActorStats, METADATA_PARAMS(nullptr, 0) }; // 2295443577
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULayer_Statics::NewProp_ActorStats = { "ActorStats", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULayer, ActorStats), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULayer_Statics::NewProp_ActorStats_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULayer_Statics::NewProp_ActorStats_MetaData)) }; // 2295443577
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Layers_Layer_h_Statics::ScriptStructInfo[] = {
		{ FLayerActorStats::StaticStruct, Z_Construct_UScriptStruct_FLayerActorStats_Statics::NewStructOps, TEXT("LayerActorStats"), &Z_Registration_Info_UScriptStruct_LayerActorStats, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLayerActorStats), 2295443577U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Layers_Layer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULayer, ULayer::StaticClass, TEXT("ULayer"), &Z_Registration_Info_UClass_ULayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULayer), 2234652849U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Layers_Layer_h_2247866936(TEXT("/Script/Engine"),
