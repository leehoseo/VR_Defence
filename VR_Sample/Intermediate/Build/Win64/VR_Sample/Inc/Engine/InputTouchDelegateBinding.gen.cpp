...
class UScriptStruct* FBlueprintInputTouchDelegateBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlueprintInputTouchDelegateBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlueprintInputTouchDelegateBinding, Z_Construct_UPackage__Script_Engine(), TEXT("BlueprintInputTouchDelegateBinding"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBlueprintInputTouchDelegateBinding>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInputTouchDelegateBinding_Statics::NewProp_InputTouchDelegateBindings_Inner = { "InputTouchDelegateBindings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBlueprintInputTouchDelegateBinding, METADATA_PARAMS(nullptr, 0) }; // 823094843
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInputTouchDelegateBinding_Statics::NewProp_InputTouchDelegateBindings = { "InputTouchDelegateBindings", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInputTouchDelegateBinding, InputTouchDelegateBindings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInputTouchDelegateBinding_Statics::NewProp_InputTouchDelegateBindings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInputTouchDelegateBinding_Statics::NewProp_InputTouchDelegateBindings_MetaData)) }; // 823094843
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InputTouchDelegateBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInputTouchDelegateBinding, UInputTouchDelegateBinding::StaticClass, TEXT("UInputTouchDelegateBinding"), &Z_Registration_Info_UClass_UInputTouchDelegateBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputTouchDelegateBinding), 1037088943U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InputTouchDelegateBinding_h_2706141399(TEXT("/Script/Engine"),
