...
class UScriptStruct* FBookmark2DJumpToSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Bookmark2DJumpToSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBookmark2DJumpToSettings, Z_Construct_UPackage__Script_Engine(), TEXT("Bookmark2DJumpToSettings"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBookmark2DJumpToSettings>()
{
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBookMark2D_Statics::NewProp_Zoom2D = { "Zoom2D", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBookMark2D, Zoom2D), METADATA_PARAMS(Z_Construct_UClass_UBookMark2D_Statics::NewProp_Zoom2D_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBookMark2D_Statics::NewProp_Zoom2D_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_BookMark2D_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBookMark2D, UBookMark2D::StaticClass, TEXT("UBookMark2D"), &Z_Registration_Info_UClass_UBookMark2D, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBookMark2D), 3413347351U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_BookMark2D_h_3854646942(TEXT("/Script/Engine"),
