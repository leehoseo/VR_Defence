...
class UScriptStruct* FCachedAnimStateData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CachedAnimStateData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCachedAnimStateData, Z_Construct_UPackage__Script_Engine(), TEXT("CachedAnimStateData"));
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FCachedAnimStateData_Statics::NewProp_StateName = { "StateName", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCachedAnimStateData, StateName), METADATA_PARAMS(Z_Construct_UScriptStruct_FCachedAnimStateData_Statics::NewProp_StateName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedAnimStateData_Statics::NewProp_StateName_MetaData)) };
...
class UScriptStruct* FCachedAnimStateArray::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CachedAnimStateArray.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCachedAnimStateArray, Z_Construct_UPackage__Script_Engine(), TEXT("CachedAnimStateArray"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FCachedAnimStateArray>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCachedAnimStateArray_Statics::NewProp_States_Inner = { "States", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FCachedAnimStateData, METADATA_PARAMS(nullptr, 0) }; // 986757423
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCachedAnimStateArray_Statics::NewProp_States = { "States", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCachedAnimStateArray, States), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCachedAnimStateArray_Statics::NewProp_States_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedAnimStateArray_Statics::NewProp_States_MetaData)) }; // 986757423
...
class UScriptStruct* FCachedAnimAssetPlayerData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CachedAnimAssetPlayerData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCachedAnimAssetPlayerData, Z_Construct_UPackage__Script_Engine(), TEXT("CachedAnimAssetPlayerData"));
	}
...
class UScriptStruct* FCachedAnimRelevancyData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CachedAnimRelevancyData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCachedAnimRelevancyData, Z_Construct_UPackage__Script_Engine(), TEXT("CachedAnimRelevancyData"));
	}
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FCachedAnimRelevancyData_Statics::NewProp_StateName = { "StateName", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCachedAnimRelevancyData, StateName), METADATA_PARAMS(Z_Construct_UScriptStruct_FCachedAnimRelevancyData_Statics::NewProp_StateName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedAnimRelevancyData_Statics::NewProp_StateName_MetaData)) };
...
class UScriptStruct* FCachedAnimTransitionData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CachedAnimTransitionData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCachedAnimTransitionData, Z_Construct_UPackage__Script_Engine(), TEXT("CachedAnimTransitionData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FCachedAnimTransitionData>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FCachedAnimTransitionData_Statics::NewProp_FromStateName = { "FromStateName", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCachedAnimTransitionData, FromStateName), METADATA_PARAMS(Z_Construct_UScriptStruct_FCachedAnimTransitionData_Statics::NewProp_FromStateName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCachedAnimTransitionData_Statics::NewProp_FromStateName_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_CachedAnimData_h_Statics::ScriptStructInfo[] = {
		{ FCachedAnimStateData::StaticStruct, Z_Construct_UScriptStruct_FCachedAnimStateData_Statics::NewStructOps, TEXT("CachedAnimStateData"), &Z_Registration_Info_UScriptStruct_CachedAnimStateData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCachedAnimStateData), 986757423U) },
		{ FCachedAnimStateArray::StaticStruct, Z_Construct_UScriptStruct_FCachedAnimStateArray_Statics::NewStructOps, TEXT("CachedAnimStateArray"), &Z_Registration_Info_UScriptStruct_CachedAnimStateArray, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCachedAnimStateArray), 49398906U) },
		{ FCachedAnimAssetPlayerData::StaticStruct, Z_Construct_UScriptStruct_FCachedAnimAssetPlayerData_Statics::NewStructOps, TEXT("CachedAnimAssetPlayerData"), &Z_Registration_Info_UScriptStruct_CachedAnimAssetPlayerData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCachedAnimAssetPlayerData), 2467493008U) },
		{ FCachedAnimRelevancyData::StaticStruct, Z_Construct_UScriptStruct_FCachedAnimRelevancyData_Statics::NewStructOps, TEXT("CachedAnimRelevancyData"), &Z_Registration_Info_UScriptStruct_CachedAnimRelevancyData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCachedAnimRelevancyData), 3015040233U) },
		{ FCachedAnimTransitionData::StaticStruct, Z_Construct_UScriptStruct_FCachedAnimTransitionData_Statics::NewStructOps, TEXT("CachedAnimTransitionData"), &Z_Registration_Info_UScriptStruct_CachedAnimTransitionData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCachedAnimTransitionData), 3872380851U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_CachedAnimData_h_3821548738(TEXT("/Script/Engine"),
		nullptr, 0,
