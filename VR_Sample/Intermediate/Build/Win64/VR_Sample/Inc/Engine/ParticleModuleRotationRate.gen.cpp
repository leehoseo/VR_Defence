...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleRotationRate_Statics::NewProp_StartRotationRate = { "StartRotationRate", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleRotationRate, StartRotationRate), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleRotationRate_Statics::NewProp_StartRotationRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleRotationRate_Statics::NewProp_StartRotationRate_MetaData)) }; // 3468229032
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_RotationRate_ParticleModuleRotationRate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleRotationRate, UParticleModuleRotationRate::StaticClass, TEXT("UParticleModuleRotationRate"), &Z_Registration_Info_UClass_UParticleModuleRotationRate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleRotationRate), 2435120856U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_RotationRate_ParticleModuleRotationRate_h_4175803818(TEXT("/Script/Engine"),
