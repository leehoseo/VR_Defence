...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionBlackBody_Statics::NewProp_Temp = { "Temp", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionBlackBody, Temp), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionBlackBody_Statics::NewProp_Temp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionBlackBody_Statics::NewProp_Temp_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionBlackBody_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionBlackBody, UMaterialExpressionBlackBody::StaticClass, TEXT("UMaterialExpressionBlackBody"), &Z_Registration_Info_UClass_UMaterialExpressionBlackBody, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionBlackBody), 1916935795U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionBlackBody_h_2345856115(TEXT("/Script/Engine"),
