...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_MaxCurveError = { "MaxCurveError", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimCurveCompressionCodec_CompressedRichCurve, MaxCurveError), METADATA_PARAMS(Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_MaxCurveError_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_MaxCurveError_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_UseAnimSequenceSampleRate = { "UseAnimSequenceSampleRate", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAnimCurveCompressionCodec_CompressedRichCurve), &Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_UseAnimSequenceSampleRate_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_UseAnimSequenceSampleRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_UseAnimSequenceSampleRate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_ErrorSampleRate = { "ErrorSampleRate", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimCurveCompressionCodec_CompressedRichCurve, ErrorSampleRate), METADATA_PARAMS(Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_ErrorSampleRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve_Statics::NewProp_ErrorSampleRate_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimCurveCompressionCodec_CompressedRichCurve_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimCurveCompressionCodec_CompressedRichCurve, UAnimCurveCompressionCodec_CompressedRichCurve::StaticClass, TEXT("UAnimCurveCompressionCodec_CompressedRichCurve"), &Z_Registration_Info_UClass_UAnimCurveCompressionCodec_CompressedRichCurve, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimCurveCompressionCodec_CompressedRichCurve), 445506032U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimCurveCompressionCodec_CompressedRichCurve_h_1195741587(TEXT("/Script/Engine"),
