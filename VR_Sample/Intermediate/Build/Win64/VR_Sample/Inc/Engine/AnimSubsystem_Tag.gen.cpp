...
#include "Engine/Public/Animation/AnimSubsystem_Tag.h"
...
class UScriptStruct* FAnimSubsystem_Tag::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimSubsystem_Tag.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimSubsystem_Tag, Z_Construct_UPackage__Script_Engine(), TEXT("AnimSubsystem_Tag"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimSubsystem_Tag>()
{
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimSubsystem_Tag_Statics::NewProp_NodeIndices_ValueProp = { "NodeIndices", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimSubsystem_Tag_Statics::NewProp_NodeIndices_Key_KeyProp = { "NodeIndices_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FAnimSubsystem_Tag_Statics::NewProp_NodeIndices = { "NodeIndices", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimSubsystem_Tag, NodeIndices), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimSubsystem_Tag_Statics::NewProp_NodeIndices_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimSubsystem_Tag_Statics::NewProp_NodeIndices_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimSubsystem_Tag_h_Statics::ScriptStructInfo[] = {
		{ FAnimSubsystem_Tag::StaticStruct, Z_Construct_UScriptStruct_FAnimSubsystem_Tag_Statics::NewStructOps, TEXT("AnimSubsystem_Tag"), &Z_Registration_Info_UScriptStruct_AnimSubsystem_Tag, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimSubsystem_Tag), 1921223314U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimSubsystem_Tag_h_1061771425(TEXT("/Script/Engine"),
		nullptr, 0,
