...
#include "Engine/Public/Animation/AnimNodeData.h"
...
// End Cross Module References
	...
	static UEnum* EAnimNodeDataFlags_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAnimNodeDataFlags.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAnimNodeDataFlags, Z_Construct_UPackage__Script_Engine(), TEXT("EAnimNodeDataFlags"));
		}
...
class UScriptStruct* FAnimNodeData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNodeData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNodeData, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNodeData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNodeData>()
{
...
#endif
	const UECodeGen_Private::FInterfacePropertyParams Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_AnimClassInterface = { "AnimClassInterface", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Interface, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNodeData, AnimClassInterface), Z_Construct_UClass_UAnimClassInterface_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_AnimClassInterface_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_AnimClassInterface_MetaData)) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_Entries_Inner = { "Entries", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_Entries = { "Entries", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNodeData, Entries), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_Entries_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_Entries_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_NodeIndex = { "NodeIndex", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNodeData, NodeIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_NodeIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_NodeIndex_MetaData)) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_Flags_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_Flags = { "Flags", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNodeData, Flags), Z_Construct_UEnum_Engine_EAnimNodeDataFlags, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_Flags_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_Flags_MetaData)) }; // 1214220031
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAnimNodeData_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewProp_Flags_Underlying,
...
class UScriptStruct* FAnimNodeStructData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNodeStructData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNodeStructData, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNodeStructData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNodeStructData>()
{
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNodeStructData_Statics::NewProp_NameToIndexMap_ValueProp = { "NameToIndexMap", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimNodeStructData_Statics::NewProp_NameToIndexMap_Key_KeyProp = { "NameToIndexMap_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimNodeStructData_Statics::NewProp_NumProperties = { "NumProperties", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNodeStructData, NumProperties), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNodeStructData_Statics::NewProp_NumProperties_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNodeStructData_Statics::NewProp_NumProperties_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimNodeData_h_Statics::ScriptStructInfo[] = {
		{ FAnimNodeData::StaticStruct, Z_Construct_UScriptStruct_FAnimNodeData_Statics::NewStructOps, TEXT("AnimNodeData"), &Z_Registration_Info_UScriptStruct_AnimNodeData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNodeData), 3703795851U) },
		{ FAnimNodeStructData::StaticStruct, Z_Construct_UScriptStruct_FAnimNodeStructData_Statics::NewStructOps, TEXT("AnimNodeStructData"), &Z_Registration_Info_UScriptStruct_AnimNodeStructData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNodeStructData), 2453106156U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimNodeData_h_2398013588(TEXT("/Script/Engine"),
		nullptr, 0,
