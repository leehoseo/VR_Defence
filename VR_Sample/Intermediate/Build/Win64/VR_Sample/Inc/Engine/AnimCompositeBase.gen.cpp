...
class UScriptStruct* FRootMotionExtractionStep::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RootMotionExtractionStep.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRootMotionExtractionStep, Z_Construct_UPackage__Script_Engine(), TEXT("RootMotionExtractionStep"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRootMotionExtractionStep_Statics::NewProp_EndPosition = { "EndPosition", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRootMotionExtractionStep, EndPosition), METADATA_PARAMS(Z_Construct_UScriptStruct_FRootMotionExtractionStep_Statics::NewProp_EndPosition_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRootMotionExtractionStep_Statics::NewProp_EndPosition_MetaData)) };
...
class UScriptStruct* FAnimSegment::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimSegment.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimSegment, Z_Construct_UPackage__Script_Engine(), TEXT("AnimSegment"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_StartPos = { "StartPos", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimSegment, StartPos), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_StartPos_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_StartPos_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_AnimStartTime = { "AnimStartTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimSegment, AnimStartTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_AnimStartTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_AnimStartTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_AnimEndTime = { "AnimEndTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimSegment, AnimEndTime), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_AnimEndTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_AnimEndTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_LoopingCount = { "LoopingCount", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimSegment, LoopingCount), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_LoopingCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimSegment_Statics::NewProp_LoopingCount_MetaData)) };
...
class UScriptStruct* FAnimTrack::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimTrack.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimTrack, Z_Construct_UPackage__Script_Engine(), TEXT("AnimTrack"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimTrack>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimTrack_Statics::NewProp_AnimSegments_Inner = { "AnimSegments", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FAnimSegment, METADATA_PARAMS(nullptr, 0) }; // 1441228115
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimCompositeBase_h_Statics::ScriptStructInfo[] = {
		{ FRootMotionExtractionStep::StaticStruct, Z_Construct_UScriptStruct_FRootMotionExtractionStep_Statics::NewStructOps, TEXT("RootMotionExtractionStep"), &Z_Registration_Info_UScriptStruct_RootMotionExtractionStep, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRootMotionExtractionStep), 3471126098U) },
		{ FAnimSegment::StaticStruct, Z_Construct_UScriptStruct_FAnimSegment_Statics::NewStructOps, TEXT("AnimSegment"), &Z_Registration_Info_UScriptStruct_AnimSegment, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimSegment), 1441228115U) },
		{ FAnimTrack::StaticStruct, Z_Construct_UScriptStruct_FAnimTrack_Statics::NewStructOps, TEXT("AnimTrack"), &Z_Registration_Info_UScriptStruct_AnimTrack, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimTrack), 2960039080U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimCompositeBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimCompositeBase, UAnimCompositeBase::StaticClass, TEXT("UAnimCompositeBase"), &Z_Registration_Info_UClass_UAnimCompositeBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimCompositeBase), 3371698959U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimCompositeBase_h_973165114(TEXT("/Script/Engine"),
