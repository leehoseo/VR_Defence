...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionSphericalParticleOpacity_Statics::NewProp_Density = { "Density", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionSphericalParticleOpacity, Density), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionSphericalParticleOpacity_Statics::NewProp_Density_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionSphericalParticleOpacity_Statics::NewProp_Density_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionSphericalParticleOpacity_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionSphericalParticleOpacity, UMaterialExpressionSphericalParticleOpacity::StaticClass, TEXT("UMaterialExpressionSphericalParticleOpacity"), &Z_Registration_Info_UClass_UMaterialExpressionSphericalParticleOpacity, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionSphericalParticleOpacity), 2388219288U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionSphericalParticleOpacity_h_4007579367(TEXT("/Script/Engine"),
