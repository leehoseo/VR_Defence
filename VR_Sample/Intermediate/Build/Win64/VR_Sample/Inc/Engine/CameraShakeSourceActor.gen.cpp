...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACameraShakeSourceActor_Statics::NewProp_CameraShakeSourceComponent = { "CameraShakeSourceComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACameraShakeSourceActor, CameraShakeSourceComponent), Z_Construct_UClass_UCameraShakeSourceComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACameraShakeSourceActor_Statics::NewProp_CameraShakeSourceComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACameraShakeSourceActor_Statics::NewProp_CameraShakeSourceComponent_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraShakeSourceActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACameraShakeSourceActor, ACameraShakeSourceActor::StaticClass, TEXT("ACameraShakeSourceActor"), &Z_Registration_Info_UClass_ACameraShakeSourceActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACameraShakeSourceActor), 76730220U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraShakeSourceActor_h_3210411344(TEXT("/Script/Engine"),
