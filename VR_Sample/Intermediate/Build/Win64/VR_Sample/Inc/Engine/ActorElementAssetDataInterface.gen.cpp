...
#include "Engine/Public/Elements/Actor/ActorElementAssetDataInterface.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UActorElementAssetDataInterface_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UActorElementAssetDataInterface_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UTypedElementAssetDataInterface_NoRegister, (int32)VTABLE_OFFSET(UActorElementAssetDataInterface, ITypedElementAssetDataInterface), false },  // 2548155006
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Actor_ActorElementAssetDataInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UActorElementAssetDataInterface, UActorElementAssetDataInterface::StaticClass, TEXT("UActorElementAssetDataInterface"), &Z_Registration_Info_UClass_UActorElementAssetDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UActorElementAssetDataInterface), 2035866671U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Actor_ActorElementAssetDataInterface_h_2787408122(TEXT("/Script/Engine"),
