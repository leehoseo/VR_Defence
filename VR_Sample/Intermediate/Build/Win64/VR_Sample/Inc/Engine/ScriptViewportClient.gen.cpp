...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UScriptViewportClient_Statics::Class_MetaDataParams[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_ScriptViewportClient_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UScriptViewportClient, UScriptViewportClient::StaticClass, TEXT("UScriptViewportClient"), &Z_Registration_Info_UClass_UScriptViewportClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UScriptViewportClient), 1280371126U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_ScriptViewportClient_h_344310327(TEXT("/Script/Engine"),
