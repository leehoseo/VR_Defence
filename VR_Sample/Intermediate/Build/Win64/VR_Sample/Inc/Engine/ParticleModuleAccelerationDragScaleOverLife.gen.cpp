...
// End Cross Module References
...
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_DragScale;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DragScaleRaw_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::NewProp_DragScale_MetaData[] = {
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::NewProp_DragScale = { "DragScale", nullptr, (EPropertyFlags)0x0014000020080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleAccelerationDragScaleOverLife, DragScale_DEPRECATED), Z_Construct_UClass_UDistributionFloat_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::NewProp_DragScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::NewProp_DragScale_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::NewProp_DragScaleRaw_MetaData[] = {
		{ "Category", "Drag" },
		{ "Comment", "/** Per-particle drag scale. Evaluted using particle relative time. */" },
		{ "ModuleRelativePath", "Classes/Particles/Acceleration/ParticleModuleAccelerationDragScaleOverLife.h" },
		{ "ToolTip", "Per-particle drag scale. Evaluted using particle relative time." },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::NewProp_DragScaleRaw = { "DragScaleRaw", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleAccelerationDragScaleOverLife, DragScaleRaw), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::NewProp_DragScaleRaw_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::NewProp_DragScaleRaw_MetaData)) }; // 3468229032
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::ClassParams = {
		...
		0,
		0x008810A0u,
		METADATA_PARAMS(Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Acceleration_ParticleModuleAccelerationDragScaleOverLife_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleAccelerationDragScaleOverLife, UParticleModuleAccelerationDragScaleOverLife::StaticClass, TEXT("UParticleModuleAccelerationDragScaleOverLife"), &Z_Registration_Info_UClass_UParticleModuleAccelerationDragScaleOverLife, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleAccelerationDragScaleOverLife), 1292986594U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Acceleration_ParticleModuleAccelerationDragScaleOverLife_h_941239148(TEXT("/Script/Engine"),
