...
class UScriptStruct* FBlueprintComponentDelegateBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlueprintComponentDelegateBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlueprintComponentDelegateBinding, Z_Construct_UPackage__Script_Engine(), TEXT("BlueprintComponentDelegateBinding"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBlueprintComponentDelegateBinding>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UComponentDelegateBinding_Statics::NewProp_ComponentDelegateBindings_Inner = { "ComponentDelegateBindings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBlueprintComponentDelegateBinding, METADATA_PARAMS(nullptr, 0) }; // 197272273
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UComponentDelegateBinding_Statics::NewProp_ComponentDelegateBindings = { "ComponentDelegateBindings", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UComponentDelegateBinding, ComponentDelegateBindings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UComponentDelegateBinding_Statics::NewProp_ComponentDelegateBindings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UComponentDelegateBinding_Statics::NewProp_ComponentDelegateBindings_MetaData)) }; // 197272273
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_ComponentDelegateBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UComponentDelegateBinding, UComponentDelegateBinding::StaticClass, TEXT("UComponentDelegateBinding"), &Z_Registration_Info_UClass_UComponentDelegateBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UComponentDelegateBinding), 500599291U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_ComponentDelegateBinding_h_1679314489(TEXT("/Script/Engine"),
