...
class UScriptStruct* FAutoCompleteNode::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AutoCompleteNode.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAutoCompleteNode, Z_Construct_UPackage__Script_Engine(), TEXT("AutoCompleteNode"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAutoCompleteNode>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAutoCompleteNode_Statics::NewProp_IndexChar = { "IndexChar", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAutoCompleteNode, IndexChar), METADATA_PARAMS(Z_Construct_UScriptStruct_FAutoCompleteNode_Statics::NewProp_IndexChar_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAutoCompleteNode_Statics::NewProp_IndexChar_MetaData)) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAutoCompleteNode_Statics::NewProp_AutoCompleteListIndices_Inner = { "AutoCompleteListIndices", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UConsole_Statics::NewProp_ConsoleTargetPlayer = { "ConsoleTargetPlayer", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConsole, ConsoleTargetPlayer), Z_Construct_UClass_ULocalPlayer_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UConsole_Statics::NewProp_ConsoleTargetPlayer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConsole_Statics::NewProp_ConsoleTargetPlayer_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_Black_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Engine/Console.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_Black = { "DefaultTexture_Black", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConsole, DefaultTexture_Black), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_Black_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_Black_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_White_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Engine/Console.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_White = { "DefaultTexture_White", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConsole, DefaultTexture_White), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_White_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConsole_Statics::NewProp_DefaultTexture_White_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UConsole_Statics::NewProp_HistoryBuffer_Inner = { "HistoryBuffer", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UConsole_Statics::NewProp_HistoryBuffer = { "HistoryBuffer", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UConsole, HistoryBuffer), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UConsole_Statics::NewProp_HistoryBuffer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UConsole_Statics::NewProp_HistoryBuffer_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Console_h_Statics::ScriptStructInfo[] = {
		{ FAutoCompleteNode::StaticStruct, Z_Construct_UScriptStruct_FAutoCompleteNode_Statics::NewStructOps, TEXT("AutoCompleteNode"), &Z_Registration_Info_UScriptStruct_AutoCompleteNode, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAutoCompleteNode), 1329700412U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Console_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UConsole, UConsole::StaticClass, TEXT("UConsole"), &Z_Registration_Info_UClass_UConsole, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UConsole), 2775704458U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Console_h_2599729549(TEXT("/Script/Engine"),
