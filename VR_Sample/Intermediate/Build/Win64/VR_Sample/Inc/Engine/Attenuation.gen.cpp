...
// End Cross Module References
	...
	static UEnum* EAttenuationDistanceModel_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAttenuationDistanceModel.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAttenuationDistanceModel, Z_Construct_UPackage__Script_Engine(), TEXT("EAttenuationDistanceModel"));
		}
	...
	static UEnum* EAttenuationShape_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAttenuationShape.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAttenuationShape, Z_Construct_UPackage__Script_Engine(), TEXT("EAttenuationShape"));
		}
	...
	static UEnum* ENaturalSoundFalloffMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ENaturalSoundFalloffMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ENaturalSoundFalloffMode, Z_Construct_UPackage__Script_Engine(), TEXT("ENaturalSoundFalloffMode"));
		}
...
class UScriptStruct* FBaseAttenuationSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BaseAttenuationSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBaseAttenuationSettings, Z_Construct_UPackage__Script_Engine(), TEXT("BaseAttenuationSettings"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBaseAttenuationSettings>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_DistanceAlgorithm_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_AttenuationShape = { "AttenuationShape", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBaseAttenuationSettings, AttenuationShape), Z_Construct_UEnum_Engine_EAttenuationShape, METADATA_PARAMS(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_AttenuationShape_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_AttenuationShape_MetaData)) }; // 2008528497
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_dBAttenuationAtMax = { "dBAttenuationAtMax", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBaseAttenuationSettings, dBAttenuationAtMax), METADATA_PARAMS(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_dBAttenuationAtMax_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_dBAttenuationAtMax_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_FalloffMode_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_FalloffMode = { "FalloffMode", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBaseAttenuationSettings, FalloffMode), Z_Construct_UEnum_Engine_ENaturalSoundFalloffMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_FalloffMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_FalloffMode_MetaData)) }; // 4013291133
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_ConeOffset = { "ConeOffset", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBaseAttenuationSettings, ConeOffset), METADATA_PARAMS(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_ConeOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_ConeOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_ConeSphereRadius = { "ConeSphereRadius", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBaseAttenuationSettings, ConeSphereRadius), METADATA_PARAMS(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_ConeSphereRadius_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_ConeSphereRadius_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_CustomAttenuationCurve = { "CustomAttenuationCurve", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBaseAttenuationSettings, CustomAttenuationCurve), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_CustomAttenuationCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewProp_CustomAttenuationCurve_MetaData)) }; // 1196190759
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Attenuation_h_Statics::ScriptStructInfo[] = {
		{ FBaseAttenuationSettings::StaticStruct, Z_Construct_UScriptStruct_FBaseAttenuationSettings_Statics::NewStructOps, TEXT("BaseAttenuationSettings"), &Z_Registration_Info_UScriptStruct_BaseAttenuationSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBaseAttenuationSettings), 590365588U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Attenuation_h_2731393743(TEXT("/Script/Engine"),
		nullptr, 0,
