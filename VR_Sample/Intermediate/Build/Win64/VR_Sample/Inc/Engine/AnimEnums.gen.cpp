...
// End Cross Module References
	...
	static UEnum* ERootMotionRootLock_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERootMotionRootLock.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ERootMotionRootLock, Z_Construct_UPackage__Script_Engine(), TEXT("ERootMotionRootLock"));
		}
	...
	static UEnum* ERootMotionMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERootMotionMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ERootMotionMode, Z_Construct_UPackage__Script_Engine(), TEXT("ERootMotionMode"));
		}
	...
	static UEnum* EAdditiveBasePoseType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAdditiveBasePoseType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAdditiveBasePoseType, Z_Construct_UPackage__Script_Engine(), TEXT("EAdditiveBasePoseType"));
		}
	...
	static UEnum* AnimationCompressionFormat_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_AnimationCompressionFormat.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_AnimationCompressionFormat, Z_Construct_UPackage__Script_Engine(), TEXT("AnimationCompressionFormat"));
		}
