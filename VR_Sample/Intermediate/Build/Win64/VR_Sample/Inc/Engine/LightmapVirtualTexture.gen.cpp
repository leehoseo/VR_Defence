...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FInt8PropertyParams Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::NewProp_TypeToLayer_Inner = { "TypeToLayer", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int8, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::NewProp_TypeToLayer = { "TypeToLayer", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULightMapVirtualTexture2D, TypeToLayer), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::NewProp_TypeToLayer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULightMapVirtualTexture2D_Statics::NewProp_TypeToLayer_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_LightmapVirtualTexture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULightMapVirtualTexture2D, ULightMapVirtualTexture2D::StaticClass, TEXT("ULightMapVirtualTexture2D"), &Z_Registration_Info_UClass_ULightMapVirtualTexture2D, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULightMapVirtualTexture2D), 2647785528U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_LightmapVirtualTexture_h_891063224(TEXT("/Script/Engine"),
