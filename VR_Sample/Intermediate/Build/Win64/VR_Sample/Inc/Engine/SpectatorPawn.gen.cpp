...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ASpectatorPawn_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_ASpectatorPawn_Statics::ClassParams = {
		...
		0,
		0x009002A4u,
		METADATA_PARAMS(Z_Construct_UClass_ASpectatorPawn_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_ASpectatorPawn_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_SpectatorPawn_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASpectatorPawn, ASpectatorPawn::StaticClass, TEXT("ASpectatorPawn"), &Z_Registration_Info_UClass_ASpectatorPawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpectatorPawn), 3491661033U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_SpectatorPawn_h_3776050709(TEXT("/Script/Engine"),
