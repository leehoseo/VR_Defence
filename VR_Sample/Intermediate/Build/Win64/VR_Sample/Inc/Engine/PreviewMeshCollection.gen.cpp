...
class UScriptStruct* FPreviewMeshCollectionEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PreviewMeshCollectionEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPreviewMeshCollectionEntry, Z_Construct_UPackage__Script_Engine(), TEXT("PreviewMeshCollectionEntry"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPreviewMeshCollectionEntry>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPreviewMeshCollection_Statics::NewProp_Skeleton = { "Skeleton", nullptr, (EPropertyFlags)0x0014010000020001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPreviewMeshCollection, Skeleton), Z_Construct_UClass_USkeleton_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UPreviewMeshCollection_Statics::NewProp_Skeleton_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPreviewMeshCollection_Statics::NewProp_Skeleton_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPreviewMeshCollection_Statics::NewProp_SkeletalMeshes_Inner = { "SkeletalMeshes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPreviewMeshCollectionEntry, METADATA_PARAMS(nullptr, 0) }; // 1908483879
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPreviewMeshCollection_Statics::NewProp_SkeletalMeshes = { "SkeletalMeshes", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPreviewMeshCollection, SkeletalMeshes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPreviewMeshCollection_Statics::NewProp_SkeletalMeshes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPreviewMeshCollection_Statics::NewProp_SkeletalMeshes_MetaData)) }; // 1908483879
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_PreviewMeshCollection_h_Statics::ScriptStructInfo[] = {
		{ FPreviewMeshCollectionEntry::StaticStruct, Z_Construct_UScriptStruct_FPreviewMeshCollectionEntry_Statics::NewStructOps, TEXT("PreviewMeshCollectionEntry"), &Z_Registration_Info_UScriptStruct_PreviewMeshCollectionEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPreviewMeshCollectionEntry), 1908483879U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_PreviewMeshCollection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPreviewMeshCollection, UPreviewMeshCollection::StaticClass, TEXT("UPreviewMeshCollection"), &Z_Registration_Info_UClass_UPreviewMeshCollection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPreviewMeshCollection), 1206477102U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_PreviewMeshCollection_h_2657266347(TEXT("/Script/Engine"),
