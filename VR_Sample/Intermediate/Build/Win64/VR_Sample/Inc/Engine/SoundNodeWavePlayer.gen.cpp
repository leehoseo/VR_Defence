...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWaveAssetPtr = { "SoundWaveAssetPtr", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeWavePlayer, SoundWaveAssetPtr), Z_Construct_UClass_USoundWave_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWaveAssetPtr_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWaveAssetPtr_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWave_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Sound/SoundNodeWavePlayer.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWave = { "SoundWave", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeWavePlayer, SoundWave), Z_Construct_UClass_USoundWave_NoRegister, METADATA_PARAMS(Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWave_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeWavePlayer_Statics::NewProp_SoundWave_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeWavePlayer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundNodeWavePlayer, USoundNodeWavePlayer::StaticClass, TEXT("USoundNodeWavePlayer"), &Z_Registration_Info_UClass_USoundNodeWavePlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundNodeWavePlayer), 1116848863U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeWavePlayer_h_4261334284(TEXT("/Script/Engine"),
