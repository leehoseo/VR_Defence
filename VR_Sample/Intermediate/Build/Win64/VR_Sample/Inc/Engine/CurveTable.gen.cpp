...
// End Cross Module References
	...
	static UEnum* ECurveTableMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECurveTableMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ECurveTableMode, Z_Construct_UPackage__Script_Engine(), TEXT("ECurveTableMode"));
		}
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UCurveTable_Statics::NewProp_AssetImportData = { "AssetImportData", nullptr, (EPropertyFlags)0x00160008000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCurveTable, AssetImportData), Z_Construct_UClass_UAssetImportData_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UCurveTable_Statics::NewProp_AssetImportData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCurveTable_Statics::NewProp_AssetImportData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UCurveTable_Statics::NewProp_ImportPath = { "ImportPath", nullptr, (EPropertyFlags)0x0010000820000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCurveTable, ImportPath_DEPRECATED), METADATA_PARAMS(Z_Construct_UClass_UCurveTable_Statics::NewProp_ImportPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCurveTable_Statics::NewProp_ImportPath_MetaData)) };
...
class UScriptStruct* FCurveTableRowHandle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CurveTableRowHandle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCurveTableRowHandle, Z_Construct_UPackage__Script_Engine(), TEXT("CurveTableRowHandle"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FCurveTableRowHandle>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FCurveTableRowHandle_Statics::NewProp_CurveTable = { "CurveTable", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurveTableRowHandle, CurveTable), Z_Construct_UClass_UCurveTable_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FCurveTableRowHandle_Statics::NewProp_CurveTable_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveTableRowHandle_Statics::NewProp_CurveTable_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FCurveTableRowHandle_Statics::NewProp_RowName = { "RowName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurveTableRowHandle, RowName), METADATA_PARAMS(Z_Construct_UScriptStruct_FCurveTableRowHandle_Statics::NewProp_RowName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveTableRowHandle_Statics::NewProp_RowName_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CurveTable_h_Statics::ScriptStructInfo[] = {
		{ FCurveTableRowHandle::StaticStruct, Z_Construct_UScriptStruct_FCurveTableRowHandle_Statics::NewStructOps, TEXT("CurveTableRowHandle"), &Z_Registration_Info_UScriptStruct_CurveTableRowHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCurveTableRowHandle), 3299330132U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CurveTable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCurveTable, UCurveTable::StaticClass, TEXT("UCurveTable"), &Z_Registration_Info_UClass_UCurveTable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCurveTable), 4012403534U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CurveTable_h_181584285(TEXT("/Script/Engine"),
