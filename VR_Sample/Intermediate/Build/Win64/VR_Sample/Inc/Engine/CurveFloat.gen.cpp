...
class UScriptStruct* FRuntimeFloatCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RuntimeFloatCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRuntimeFloatCurve, Z_Construct_UPackage__Script_Engine(), TEXT("RuntimeFloatCurve"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FRuntimeFloatCurve>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRuntimeFloatCurve_Statics::NewProp_EditorCurveData = { "EditorCurveData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRuntimeFloatCurve, EditorCurveData), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(Z_Construct_UScriptStruct_FRuntimeFloatCurve_Statics::NewProp_EditorCurveData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRuntimeFloatCurve_Statics::NewProp_EditorCurveData_MetaData)) }; // 133266933
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FRuntimeFloatCurve_Statics::NewProp_ExternalCurve = { "ExternalCurve", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRuntimeFloatCurve, ExternalCurve), Z_Construct_UClass_UCurveFloat_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FRuntimeFloatCurve_Statics::NewProp_ExternalCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRuntimeFloatCurve_Statics::NewProp_ExternalCurve_MetaData)) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCurveFloat_GetFloatValue_Statics::NewProp_InTime = { "InTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CurveFloat_eventGetFloatValue_Parms, InTime), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCurveFloat_GetFloatValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CurveFloat_eventGetFloatValue_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCurveFloat_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCurveFloat_GetFloatValue, "GetFloatValue" }, // 217538515
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCurveFloat_Statics::NewProp_FloatCurve = { "FloatCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCurveFloat, FloatCurve), Z_Construct_UScriptStruct_FRichCurve, METADATA_PARAMS(Z_Construct_UClass_UCurveFloat_Statics::NewProp_FloatCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCurveFloat_Statics::NewProp_FloatCurve_MetaData)) }; // 133266933
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCurveFloat_Statics::NewProp_bIsEventCurve = { "bIsEventCurve", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UCurveFloat), &Z_Construct_UClass_UCurveFloat_Statics::NewProp_bIsEventCurve_SetBit, METADATA_PARAMS(Z_Construct_UClass_UCurveFloat_Statics::NewProp_bIsEventCurve_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCurveFloat_Statics::NewProp_bIsEventCurve_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_CurveFloat_h_Statics::ScriptStructInfo[] = {
		{ FRuntimeFloatCurve::StaticStruct, Z_Construct_UScriptStruct_FRuntimeFloatCurve_Statics::NewStructOps, TEXT("RuntimeFloatCurve"), &Z_Registration_Info_UScriptStruct_RuntimeFloatCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRuntimeFloatCurve), 1196190759U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_CurveFloat_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCurveFloat, UCurveFloat::StaticClass, TEXT("UCurveFloat"), &Z_Registration_Info_UClass_UCurveFloat, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCurveFloat), 3908546715U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_CurveFloat_h_633775698(TEXT("/Script/Engine"),
