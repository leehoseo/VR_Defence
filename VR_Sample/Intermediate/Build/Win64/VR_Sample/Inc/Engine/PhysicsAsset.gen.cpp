...
class UScriptStruct* FPhysicsAssetSolverSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PhysicsAssetSolverSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings, Z_Construct_UPackage__Script_Engine(), TEXT("PhysicsAssetSolverSettings"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPhysicsAssetSolverSettings>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_PositionIterations_MetaData[] = {
		...
		{ "Comment", "/**\n\x09 * The number of position iterations to run. The position solve is responsible for depenetration and friction.\n\x09 * Increasing this will improve simulation stability, but increase the cost.\n\x09*/" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/PhysicsAsset.h" },
		{ "ToolTip", "The number of position iterations to run. The position solve is responsible for depenetration and friction.\nIncreasing this will improve simulation stability, but increase the cost." },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_PositionIterations = { "PositionIterations", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPhysicsAssetSolverSettings, PositionIterations), METADATA_PARAMS(Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_PositionIterations_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_PositionIterations_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_VelocityIterations_MetaData[] = {
		{ "Category", "SolverSettings" },
		{ "Comment", "/**\n\x09 * The number of velocity iterations to run. The velocity solve is responsible for restitution.\n\x09*/" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/PhysicsAsset.h" },
		{ "ToolTip", "The number of velocity iterations to run. The velocity solve is responsible for restitution." },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_VelocityIterations = { "VelocityIterations", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPhysicsAssetSolverSettings, VelocityIterations), METADATA_PARAMS(Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_VelocityIterations_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_VelocityIterations_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_MaxDepenetrationVelocity_MetaData[] = {
		{ "Category", "SolverSettings" },
		{ "ClampMin", "0" },
		{ "Comment", "/**\n\x09 * When bodies are penetrating, this is the maximum velocity delta that can be applied in one frame.\n\x09*/" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/PhysicsAsset.h" },
		{ "ToolTip", "When bodies are penetrating, this is the maximum velocity delta that can be applied in one frame." },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_MaxDepenetrationVelocity = { "MaxDepenetrationVelocity", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPhysicsAssetSolverSettings, MaxDepenetrationVelocity), METADATA_PARAMS(Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_MaxDepenetrationVelocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings_Statics::NewProp_MaxDepenetrationVelocity_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FSolverIterations::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SolverIterations.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSolverIterations, Z_Construct_UPackage__Script_Engine(), TEXT("SolverIterations"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FSolverIterations>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_SolverPushOutIterations = { "SolverPushOutIterations", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSolverIterations, SolverPushOutIterations), METADATA_PARAMS(Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_SolverPushOutIterations_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_SolverPushOutIterations_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_JointPushOutIterations = { "JointPushOutIterations", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSolverIterations, JointPushOutIterations), METADATA_PARAMS(Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_JointPushOutIterations_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSolverIterations_Statics::NewProp_JointPushOutIterations_MetaData)) };
#if WITH_METADATA
	...
	static UEnum* EPhysicsAssetSolverType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPhysicsAssetSolverType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EPhysicsAssetSolverType, Z_Construct_UPackage__Script_Engine(), TEXT("EPhysicsAssetSolverType"));
		}
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UPhysicsAsset_GetConstraintByBoneNames_Statics::NewProp_Bone1Name = { "Bone1Name", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PhysicsAsset_eventGetConstraintByBoneNames_Parms, Bone1Name), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UPhysicsAsset_GetConstraintByBoneNames_Statics::NewProp_Bone2Name = { "Bone2Name", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PhysicsAsset_eventGetConstraintByBoneNames_Parms, Bone2Name), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPhysicsAsset_GetConstraintByBoneNames_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PhysicsAsset_eventGetConstraintByBoneNames_Parms, ReturnValue), Z_Construct_UScriptStruct_FConstraintInstanceAccessor, METADATA_PARAMS(nullptr, 0) }; // 3007182115
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UPhysicsAsset_GetConstraintByName_Statics::NewProp_ConstraintName = { "ConstraintName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PhysicsAsset_eventGetConstraintByName_Parms, ConstraintName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPhysicsAsset_GetConstraintByName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PhysicsAsset_eventGetConstraintByName_Parms, ReturnValue), Z_Construct_UScriptStruct_FConstraintInstanceAccessor, METADATA_PARAMS(nullptr, 0) }; // 3007182115
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UPhysicsAsset_GetConstraints_Statics::NewProp_bIncludesTerminated = { "bIncludesTerminated", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(PhysicsAsset_eventGetConstraints_Parms), &Z_Construct_UFunction_UPhysicsAsset_GetConstraints_Statics::NewProp_bIncludesTerminated_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPhysicsAsset_GetConstraints_Statics::NewProp_OutConstraints_Inner = { "OutConstraints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FConstraintInstanceAccessor, METADATA_PARAMS(nullptr, 0) }; // 3007182115
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UPhysicsAsset_GetConstraints_Statics::NewProp_OutConstraints = { "OutConstraints", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(PhysicsAsset_eventGetConstraints_Parms, OutConstraints), EArrayPropertyFlags::None, METADATA_PARAMS(nullptr, 0) }; // 3007182115
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UPhysicsAsset_GetConstraintByBoneNames, "GetConstraintByBoneNames" }, // 1454272028
#endif //WITH_EDITOR
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UPhysicsAsset_GetConstraintByName, "GetConstraintByName" }, // 1187271617
#endif //WITH_EDITOR
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UPhysicsAsset_GetConstraints, "GetConstraints" }, // 3322722174
#endif //WITH_EDITOR
	};
#endif //WITH_EDITOR
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_PhysicalAnimationProfiles = { "PhysicalAnimationProfiles", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, PhysicalAnimationProfiles), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_PhysicalAnimationProfiles_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_PhysicalAnimationProfiles_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ConstraintProfiles_Inner = { "ConstraintProfiles", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ConstraintProfiles = { "ConstraintProfiles", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, ConstraintProfiles), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ConstraintProfiles_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ConstraintProfiles_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_CurrentPhysicalAnimationProfileName = { "CurrentPhysicalAnimationProfileName", nullptr, (EPropertyFlags)0x0010000800002000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, CurrentPhysicalAnimationProfileName), METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_CurrentPhysicalAnimationProfileName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_CurrentPhysicalAnimationProfileName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_CurrentConstraintProfileName = { "CurrentConstraintProfileName", nullptr, (EPropertyFlags)0x0010000800002000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, CurrentConstraintProfileName), METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_CurrentConstraintProfileName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_CurrentConstraintProfileName_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_BoundsBodies_Inner = { "BoundsBodies", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_BoundsBodies = { "BoundsBodies", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, BoundsBodies), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_BoundsBodies_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_BoundsBodies_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SkeletalBodySetups_Inner = { "SkeletalBodySetups", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_USkeletalBodySetup_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SkeletalBodySetups_Inner_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SkeletalBodySetups_Inner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ConstraintSetup_Inner = { "ConstraintSetup", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UPhysicsConstraintTemplate_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ConstraintSetup_Inner_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ConstraintSetup_Inner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ConstraintSetup = { "ConstraintSetup", nullptr, (EPropertyFlags)0x0014008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, ConstraintSetup), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ConstraintSetup_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ConstraintSetup_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverSettings = { "SolverSettings", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, SolverSettings), Z_Construct_UScriptStruct_FPhysicsAssetSolverSettings, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverSettings_MetaData)) }; // 543111600
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverIterations_MetaData[] = {
		{ "Comment", "/** \n\x09 * Solver settings for RBAN simulations with the legacy RBAN solver.\n\x09 * These are only used for the legacy solver and are hidden by default.\n\x09 * They will eventually be deprecated and removed.\n\x09*/// (EditAnywhere, Category = LegacySolverSettings, Config)\n" },
		{ "ModuleRelativePath", "Classes/PhysicsEngine/PhysicsAsset.h" },
		{ "ToolTip", "Solver settings for RBAN simulations with the legacy RBAN solver.\nThese are only used for the legacy solver and are hidden by default.\nThey will eventually be deprecated and removed.\n       // (EditAnywhere, Category = LegacySolverSettings, Config)" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverIterations = { "SolverIterations", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, SolverIterations), Z_Construct_UScriptStruct_FSolverIterations, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverIterations_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverIterations_MetaData)) }; // 3521938234
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_SolverType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_bNotForDedicatedServer = { "bNotForDedicatedServer", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UPhysicsAsset), &Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_bNotForDedicatedServer_SetBit, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_bNotForDedicatedServer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_bNotForDedicatedServer_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ThumbnailInfo = { "ThumbnailInfo", nullptr, (EPropertyFlags)0x00160000000a0009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, ThumbnailInfo), Z_Construct_UClass_UThumbnailInfo_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ThumbnailInfo_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_ThumbnailInfo_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_BodySetup_Inner = { "BodySetup", nullptr, (EPropertyFlags)0x0006000020080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UBodySetup_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_BodySetup_Inner_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_BodySetup_Inner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_BodySetup = { "BodySetup", nullptr, (EPropertyFlags)0x0044008020000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPhysicsAsset, BodySetup_DEPRECATED), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_BodySetup_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPhysicsAsset_Statics::NewProp_BodySetup_MetaData)) };
...
class UScriptStruct* FPhysicalAnimationProfile::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PhysicalAnimationProfile.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPhysicalAnimationProfile, Z_Construct_UPackage__Script_Engine(), TEXT("PhysicalAnimationProfile"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPhysicalAnimationProfile>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPhysicalAnimationProfile_Statics::NewProp_ProfileName = { "ProfileName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPhysicalAnimationProfile, ProfileName), METADATA_PARAMS(Z_Construct_UScriptStruct_FPhysicalAnimationProfile_Statics::NewProp_ProfileName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicalAnimationProfile_Statics::NewProp_ProfileName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPhysicalAnimationProfile_Statics::NewProp_PhysicalAnimationData = { "PhysicalAnimationData", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPhysicalAnimationProfile, PhysicalAnimationData), Z_Construct_UScriptStruct_FPhysicalAnimationData, METADATA_PARAMS(Z_Construct_UScriptStruct_FPhysicalAnimationProfile_Statics::NewProp_PhysicalAnimationData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPhysicalAnimationProfile_Statics::NewProp_PhysicalAnimationData_MetaData)) }; // 388640284
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_CurrentPhysicalAnimationProfile = { "CurrentPhysicalAnimationProfile", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USkeletalBodySetup, CurrentPhysicalAnimationProfile), Z_Construct_UScriptStruct_FPhysicalAnimationProfile, METADATA_PARAMS(Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_CurrentPhysicalAnimationProfile_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_CurrentPhysicalAnimationProfile_MetaData)) }; // 3685297869
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_bSkipScaleFromAnimation = { "bSkipScaleFromAnimation", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USkeletalBodySetup), &Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_bSkipScaleFromAnimation_SetBit, METADATA_PARAMS(Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_bSkipScaleFromAnimation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_bSkipScaleFromAnimation_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_PhysicalAnimationData_Inner = { "PhysicalAnimationData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPhysicalAnimationProfile, METADATA_PARAMS(nullptr, 0) }; // 3685297869
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_PhysicalAnimationData = { "PhysicalAnimationData", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USkeletalBodySetup, PhysicalAnimationData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_PhysicalAnimationData_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USkeletalBodySetup_Statics::NewProp_PhysicalAnimationData_MetaData)) }; // 3685297869
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsAsset_h_Statics::ScriptStructInfo[] = {
		...
		{ FSolverIterations::StaticStruct, Z_Construct_UScriptStruct_FSolverIterations_Statics::NewStructOps, TEXT("SolverIterations"), &Z_Registration_Info_UScriptStruct_SolverIterations, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSolverIterations), 3521938234U) },
		{ FPhysicalAnimationProfile::StaticStruct, Z_Construct_UScriptStruct_FPhysicalAnimationProfile_Statics::NewStructOps, TEXT("PhysicalAnimationProfile"), &Z_Registration_Info_UScriptStruct_PhysicalAnimationProfile, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPhysicalAnimationProfile), 3685297869U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPhysicsAsset, UPhysicsAsset::StaticClass, TEXT("UPhysicsAsset"), &Z_Registration_Info_UClass_UPhysicsAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPhysicsAsset), 3175307396U) },
		{ Z_Construct_UClass_USkeletalBodySetup, USkeletalBodySetup::StaticClass, TEXT("USkeletalBodySetup"), &Z_Registration_Info_UClass_USkeletalBodySetup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USkeletalBodySetup), 3029329446U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_PhysicsAsset_h_3604595771(TEXT("/Script/Engine"),
