...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UObjectElementAssetDataInterface_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_UObjectElementAssetDataInterface_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UTypedElementAssetDataInterface_NoRegister, (int32)VTABLE_OFFSET(UObjectElementAssetDataInterface, ITypedElementAssetDataInterface), false },  // 2548155006
		};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Object_ObjectElementAssetDataInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UObjectElementAssetDataInterface, UObjectElementAssetDataInterface::StaticClass, TEXT("UObjectElementAssetDataInterface"), &Z_Registration_Info_UClass_UObjectElementAssetDataInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UObjectElementAssetDataInterface), 843204769U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Elements_Object_ObjectElementAssetDataInterface_h_1960663462(TEXT("/Script/Engine"),
