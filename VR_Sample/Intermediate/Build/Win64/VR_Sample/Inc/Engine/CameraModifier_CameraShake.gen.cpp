...
class UScriptStruct* FPooledCameraShakes::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PooledCameraShakes.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPooledCameraShakes, Z_Construct_UPackage__Script_Engine(), TEXT("PooledCameraShakes"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPooledCameraShakes>()
{
	...
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPooledCameraShakes_Statics::NewProp_PooledShakes_Inner = { "PooledShakes", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UCameraShakeBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPooledCameraShakes_Statics::NewProp_PooledShakes = { "PooledShakes", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPooledCameraShakes, PooledShakes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPooledCameraShakes_Statics::NewProp_PooledShakes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPooledCameraShakes_Statics::NewProp_PooledShakes_MetaData)) };
...
class UScriptStruct* FActiveCameraShakeInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ActiveCameraShakeInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FActiveCameraShakeInfo, Z_Construct_UPackage__Script_Engine(), TEXT("ActiveCameraShakeInfo"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FActiveCameraShakeInfo>()
{
...
#endif
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UScriptStruct_FActiveCameraShakeInfo_Statics::NewProp_ShakeSource = { "ShakeSource", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FActiveCameraShakeInfo, ShakeSource), Z_Construct_UClass_UCameraShakeSourceComponent_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FActiveCameraShakeInfo_Statics::NewProp_ShakeSource_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActiveCameraShakeInfo_Statics::NewProp_ShakeSource_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FActiveCameraShakeInfo_Statics::NewProp_bIsCustomInitialized = { "bIsCustomInitialized", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FActiveCameraShakeInfo), &Z_Construct_UScriptStruct_FActiveCameraShakeInfo_Statics::NewProp_bIsCustomInitialized_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FActiveCameraShakeInfo_Statics::NewProp_bIsCustomInitialized_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FActiveCameraShakeInfo_Statics::NewProp_bIsCustomInitialized_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCameraModifier_CameraShake_Statics::NewProp_ActiveShakes = { "ActiveShakes", nullptr, (EPropertyFlags)0x0020088000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCameraModifier_CameraShake, ActiveShakes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCameraModifier_CameraShake_Statics::NewProp_ActiveShakes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraModifier_CameraShake_Statics::NewProp_ActiveShakes_MetaData)) }; // 1029691771
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCameraModifier_CameraShake_Statics::NewProp_ExpiredPooledShakesMap_ValueProp = { "ExpiredPooledShakesMap", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FPooledCameraShakes, METADATA_PARAMS(nullptr, 0) }; // 3969538960
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UCameraModifier_CameraShake_Statics::NewProp_ExpiredPooledShakesMap_Key_KeyProp = { "ExpiredPooledShakesMap_Key", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UCameraShakeBase_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UCameraModifier_CameraShake_Statics::NewProp_ExpiredPooledShakesMap = { "ExpiredPooledShakesMap", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCameraModifier_CameraShake, ExpiredPooledShakesMap), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCameraModifier_CameraShake_Statics::NewProp_ExpiredPooledShakesMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraModifier_CameraShake_Statics::NewProp_ExpiredPooledShakesMap_MetaData)) }; // 3969538960
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraModifier_CameraShake_h_Statics::ScriptStructInfo[] = {
		{ FPooledCameraShakes::StaticStruct, Z_Construct_UScriptStruct_FPooledCameraShakes_Statics::NewStructOps, TEXT("PooledCameraShakes"), &Z_Registration_Info_UScriptStruct_PooledCameraShakes, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPooledCameraShakes), 3969538960U) },
		{ FActiveCameraShakeInfo::StaticStruct, Z_Construct_UScriptStruct_FActiveCameraShakeInfo_Statics::NewStructOps, TEXT("ActiveCameraShakeInfo"), &Z_Registration_Info_UScriptStruct_ActiveCameraShakeInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FActiveCameraShakeInfo), 1029691771U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraModifier_CameraShake_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCameraModifier_CameraShake, UCameraModifier_CameraShake::StaticClass, TEXT("UCameraModifier_CameraShake"), &Z_Registration_Info_UClass_UCameraModifier_CameraShake, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraModifier_CameraShake), 1146444215U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraModifier_CameraShake_h_2559560689(TEXT("/Script/Engine"),
