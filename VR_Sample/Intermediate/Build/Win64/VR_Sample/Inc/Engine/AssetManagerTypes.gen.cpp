...
// End Cross Module References
	...
	static UEnum* EPrimaryAssetCookRule_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPrimaryAssetCookRule.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EPrimaryAssetCookRule, Z_Construct_UPackage__Script_Engine(), TEXT("EPrimaryAssetCookRule"));
		}
...
class UScriptStruct* FPrimaryAssetRules::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PrimaryAssetRules.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPrimaryAssetRules, Z_Construct_UPackage__Script_Engine(), TEXT("PrimaryAssetRules"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPrimaryAssetRules>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetRules_Statics::NewProp_bApplyRecursively = { "bApplyRecursively", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPrimaryAssetRules), &Z_Construct_UScriptStruct_FPrimaryAssetRules_Statics::NewProp_bApplyRecursively_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetRules_Statics::NewProp_bApplyRecursively_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetRules_Statics::NewProp_bApplyRecursively_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FPrimaryAssetRules_Statics::NewProp_CookRule_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetRules_Statics::NewProp_CookRule = { "CookRule", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPrimaryAssetRules, CookRule), Z_Construct_UEnum_Engine_EPrimaryAssetCookRule, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetRules_Statics::NewProp_CookRule_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetRules_Statics::NewProp_CookRule_MetaData)) }; // 3489627192
...
class UScriptStruct* FPrimaryAssetTypeInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PrimaryAssetTypeInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo, Z_Construct_UPackage__Script_Engine(), TEXT("PrimaryAssetTypeInfo"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPrimaryAssetTypeInfo>()
{
...
#endif
	const UECodeGen_Private::FSoftClassPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_AssetBaseClass = { "AssetBaseClass", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::SoftClass, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPrimaryAssetTypeInfo, AssetBaseClass), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_AssetBaseClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_AssetBaseClass_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPtrPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_AssetBaseClassLoaded = { "AssetBaseClassLoaded", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Class | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPrimaryAssetTypeInfo, AssetBaseClassLoaded), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_AssetBaseClassLoaded_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_AssetBaseClassLoaded_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bHasBlueprintClasses = { "bHasBlueprintClasses", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPrimaryAssetTypeInfo), &Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bHasBlueprintClasses_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bHasBlueprintClasses_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bHasBlueprintClasses_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bIsEditorOnly = { "bIsEditorOnly", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPrimaryAssetTypeInfo), &Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bIsEditorOnly_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bIsEditorOnly_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bIsEditorOnly_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_Directories_Inner = { "Directories", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FDirectoryPath, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_Directories = { "Directories", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPrimaryAssetTypeInfo, Directories), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_Directories_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_Directories_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_SpecificAssets_Inner = { "SpecificAssets", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSoftObjectPath, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_SpecificAssets = { "SpecificAssets", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPrimaryAssetTypeInfo, SpecificAssets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_SpecificAssets_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_SpecificAssets_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_Rules = { "Rules", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPrimaryAssetTypeInfo, Rules), Z_Construct_UScriptStruct_FPrimaryAssetRules, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_Rules_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_Rules_MetaData)) }; // 2388562469
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_AssetScanPaths_Inner = { "AssetScanPaths", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_AssetScanPaths = { "AssetScanPaths", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPrimaryAssetTypeInfo, AssetScanPaths), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_AssetScanPaths_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_AssetScanPaths_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bIsDynamicAsset = { "bIsDynamicAsset", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPrimaryAssetTypeInfo), &Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bIsDynamicAsset_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bIsDynamicAsset_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewProp_bIsDynamicAsset_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FAssetManagerSearchRules::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AssetManagerSearchRules.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAssetManagerSearchRules, Z_Construct_UPackage__Script_Engine(), TEXT("AssetManagerSearchRules"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAssetManagerSearchRules>()
{
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_AssetScanPaths_Inner = { "AssetScanPaths", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_AssetScanPaths = { "AssetScanPaths", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAssetManagerSearchRules, AssetScanPaths), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_AssetScanPaths_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_AssetScanPaths_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_IncludePatterns_Inner = { "IncludePatterns", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_IncludePatterns = { "IncludePatterns", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAssetManagerSearchRules, IncludePatterns), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_IncludePatterns_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_IncludePatterns_MetaData)) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_ExcludePatterns_Inner = { "ExcludePatterns", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bHasBlueprintClasses = { "bHasBlueprintClasses", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAssetManagerSearchRules), &Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bHasBlueprintClasses_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bHasBlueprintClasses_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bHasBlueprintClasses_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bForceSynchronousScan = { "bForceSynchronousScan", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAssetManagerSearchRules), &Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bForceSynchronousScan_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bForceSynchronousScan_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bForceSynchronousScan_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bSkipVirtualPathExpansion = { "bSkipVirtualPathExpansion", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAssetManagerSearchRules), &Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bSkipVirtualPathExpansion_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bSkipVirtualPathExpansion_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bSkipVirtualPathExpansion_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bSkipManagerIncludeCheck = { "bSkipManagerIncludeCheck", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAssetManagerSearchRules), &Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bSkipManagerIncludeCheck_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bSkipManagerIncludeCheck_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewProp_bSkipManagerIncludeCheck_MetaData)) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_AssetManagerTypes_h_Statics::EnumInfo[] = {
		{ EPrimaryAssetCookRule_StaticEnum, TEXT("EPrimaryAssetCookRule"), &Z_Registration_Info_UEnum_EPrimaryAssetCookRule, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3489627192U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_AssetManagerTypes_h_Statics::ScriptStructInfo[] = {
		{ FPrimaryAssetRules::StaticStruct, Z_Construct_UScriptStruct_FPrimaryAssetRules_Statics::NewStructOps, TEXT("PrimaryAssetRules"), &Z_Registration_Info_UScriptStruct_PrimaryAssetRules, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPrimaryAssetRules), 2388562469U) },
		{ FPrimaryAssetTypeInfo::StaticStruct, Z_Construct_UScriptStruct_FPrimaryAssetTypeInfo_Statics::NewStructOps, TEXT("PrimaryAssetTypeInfo"), &Z_Registration_Info_UScriptStruct_PrimaryAssetTypeInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPrimaryAssetTypeInfo), 892240520U) },
		{ FAssetManagerSearchRules::StaticStruct, Z_Construct_UScriptStruct_FAssetManagerSearchRules_Statics::NewStructOps, TEXT("AssetManagerSearchRules"), &Z_Registration_Info_UScriptStruct_AssetManagerSearchRules, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAssetManagerSearchRules), 4163146459U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_AssetManagerTypes_h_783393140(TEXT("/Script/Engine"),
		nullptr, 0,
