...
#include "Engine/Public/ISMPartition/ISMPartitionClient.h"
...
class UScriptStruct* FISMClientHandle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ISMClientHandle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FISMClientHandle, Z_Construct_UPackage__Script_Engine(), TEXT("ISMClientHandle"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FISMClientHandle>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FISMClientHandle_Statics::NewProp_Index = { "Index", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FISMClientHandle, Index), METADATA_PARAMS(Z_Construct_UScriptStruct_FISMClientHandle_Statics::NewProp_Index_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FISMClientHandle_Statics::NewProp_Index_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FISMClientHandle_Statics::NewProp_Guid_MetaData[] = {
		{ "ModuleRelativePath", "Public/ISMPartition/ISMPartitionClient.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FISMClientHandle_Statics::NewProp_Guid = { "Guid", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FISMClientHandle, Guid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FISMClientHandle_Statics::NewProp_Guid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FISMClientHandle_Statics::NewProp_Guid_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_ISMPartition_ISMPartitionClient_h_Statics::ScriptStructInfo[] = {
		{ FISMClientHandle::StaticStruct, Z_Construct_UScriptStruct_FISMClientHandle_Statics::NewStructOps, TEXT("ISMClientHandle"), &Z_Registration_Info_UScriptStruct_ISMClientHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FISMClientHandle), 959298216U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_ISMPartition_ISMPartitionClient_h_1575508374(TEXT("/Script/Engine"),
		nullptr, 0,
