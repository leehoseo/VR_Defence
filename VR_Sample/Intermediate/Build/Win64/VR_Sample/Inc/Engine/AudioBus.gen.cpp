...
// End Cross Module References
	...
	static UEnum* EAudioBusChannels_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAudioBusChannels.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAudioBusChannels, Z_Construct_UPackage__Script_Engine(), TEXT("EAudioBusChannels"));
		}
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAudioBus_Statics::NewProp_AudioBusChannels_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_AudioBus_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioBus, UAudioBus::StaticClass, TEXT("UAudioBus"), &Z_Registration_Info_UClass_UAudioBus, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioBus), 3292664486U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_AudioBus_h_1084500940(TEXT("/Script/Engine"),
