...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UChildConnection_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UChildConnection_Statics::NewProp_Parent_MetaData[] = {
		{ "ModuleRelativePath", "Classes/Engine/ChildConnection.h" },
	};
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UChildConnection_Statics::NewProp_Parent = { "Parent", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UChildConnection, Parent), Z_Construct_UClass_UNetConnection_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UChildConnection_Statics::NewProp_Parent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UChildConnection_Statics::NewProp_Parent_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UChildConnection_Statics::ClassParams = {
		...
		0,
		0x000800ACu,
		METADATA_PARAMS(Z_Construct_UClass_UChildConnection_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UChildConnection_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_ChildConnection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UChildConnection, UChildConnection::StaticClass, TEXT("UChildConnection"), &Z_Registration_Info_UClass_UChildConnection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UChildConnection), 942252892U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_ChildConnection_h_2276096409(TEXT("/Script/Engine"),
