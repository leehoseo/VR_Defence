...
class UScriptStruct* FClientReceiveData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ClientReceiveData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FClientReceiveData, Z_Construct_UPackage__Script_Engine(), TEXT("ClientReceiveData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FClientReceiveData>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageType = { "MessageType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClientReceiveData, MessageType), METADATA_PARAMS(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageType_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageIndex = { "MessageIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClientReceiveData, MessageIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageString = { "MessageString", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClientReceiveData, MessageString), METADATA_PARAMS(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageString_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_MessageString_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_RelatedPlayerState_1 = { "RelatedPlayerState_1", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClientReceiveData, RelatedPlayerState_1), Z_Construct_UClass_APlayerState_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_RelatedPlayerState_1_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_RelatedPlayerState_1_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_RelatedPlayerState_2 = { "RelatedPlayerState_2", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClientReceiveData, RelatedPlayerState_2), Z_Construct_UClass_APlayerState_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_RelatedPlayerState_2_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_RelatedPlayerState_2_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_OptionalObject = { "OptionalObject", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClientReceiveData, OptionalObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_OptionalObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewProp_OptionalObject_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_LocalMessage_h_Statics::ScriptStructInfo[] = {
		{ FClientReceiveData::StaticStruct, Z_Construct_UScriptStruct_FClientReceiveData_Statics::NewStructOps, TEXT("ClientReceiveData"), &Z_Registration_Info_UScriptStruct_ClientReceiveData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClientReceiveData), 2785210311U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_LocalMessage_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULocalMessage, ULocalMessage::StaticClass, TEXT("ULocalMessage"), &Z_Registration_Info_UClass_ULocalMessage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULocalMessage), 1100845765U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_LocalMessage_h_2219836599(TEXT("/Script/Engine"),
