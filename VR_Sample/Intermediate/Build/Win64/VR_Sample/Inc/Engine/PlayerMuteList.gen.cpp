...
// End Cross Module References
	...
	static UEnum* EVoiceBlockReasons_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EVoiceBlockReasons.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EVoiceBlockReasons, Z_Construct_UPackage__Script_Engine(), TEXT("EVoiceBlockReasons"));
		}
...
class UScriptStruct* FPlayerMuteList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PlayerMuteList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPlayerMuteList, Z_Construct_UPackage__Script_Engine(), TEXT("PlayerMuteList"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPlayerMuteList>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPlayerMuteList_Statics::NewProp_bHasVoiceHandshakeCompleted = { "bHasVoiceHandshakeCompleted", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPlayerMuteList), &Z_Construct_UScriptStruct_FPlayerMuteList_Statics::NewProp_bHasVoiceHandshakeCompleted_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPlayerMuteList_Statics::NewProp_bHasVoiceHandshakeCompleted_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPlayerMuteList_Statics::NewProp_bHasVoiceHandshakeCompleted_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_PlayerMuteList_h_Statics::ScriptStructInfo[] = {
		{ FPlayerMuteList::StaticStruct, Z_Construct_UScriptStruct_FPlayerMuteList_Statics::NewStructOps, TEXT("PlayerMuteList"), &Z_Registration_Info_UScriptStruct_PlayerMuteList, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlayerMuteList), 664296309U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_PlayerMuteList_h_813781362(TEXT("/Script/Engine"),
		nullptr, 0,
