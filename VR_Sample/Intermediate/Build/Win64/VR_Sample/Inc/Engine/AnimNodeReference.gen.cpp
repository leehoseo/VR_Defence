...
#include "Engine/Classes/Animation/AnimNodeReference.h"
...
// End Cross Module References
	...
	static UEnum* EAnimNodeReferenceConversionResult_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAnimNodeReferenceConversionResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAnimNodeReferenceConversionResult, Z_Construct_UPackage__Script_Engine(), TEXT("EAnimNodeReferenceConversionResult"));
		}
...
class UScriptStruct* FAnimNodeReference::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNodeReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNodeReference, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNodeReference"));
	}
