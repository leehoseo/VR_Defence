...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_SocketName = { "SocketName", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSocket, SocketName), METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_SocketName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_SocketName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_RelativeLocation = { "RelativeLocation", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSocket, RelativeLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_RelativeLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_RelativeLocation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_RelativeRotation = { "RelativeRotation", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSocket, RelativeRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_RelativeRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_RelativeRotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_RelativeScale = { "RelativeScale", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSocket, RelativeScale), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_RelativeScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_RelativeScale_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_Tag = { "Tag", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSocket, Tag), METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_Tag_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_Tag_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_PreviewStaticMesh = { "PreviewStaticMesh", nullptr, (EPropertyFlags)0x0014040800000001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UStaticMeshSocket, PreviewStaticMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_PreviewStaticMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_PreviewStaticMesh_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_bSocketCreatedAtImport_MetaData[] = {
		{ "Comment", "/* Weather the socket was imported with the asset or create in the editor. Importer will remove/modify only imported socket and will not touch any editor created socket. */" },
		{ "ModuleRelativePath", "Classes/Engine/StaticMeshSocket.h" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_bSocketCreatedAtImport = { "bSocketCreatedAtImport", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UStaticMeshSocket), &Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_bSocketCreatedAtImport_SetBit, METADATA_PARAMS(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_bSocketCreatedAtImport_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UStaticMeshSocket_Statics::NewProp_bSocketCreatedAtImport_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_StaticMeshSocket_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UStaticMeshSocket, UStaticMeshSocket::StaticClass, TEXT("UStaticMeshSocket"), &Z_Registration_Info_UClass_UStaticMeshSocket, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UStaticMeshSocket), 1456205379U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_StaticMeshSocket_h_3732661010(TEXT("/Script/Engine"),
