...
#include "Engine/Classes/Animation/AnimationAssetExtensions.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimationAssetExtensions_GetSkeleton_Statics::NewProp_InAsset = { "InAsset", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationAssetExtensions_eventGetSkeleton_Parms, InAsset), Z_Construct_UClass_UAnimationAsset_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimationAssetExtensions_GetSkeleton_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationAssetExtensions_eventGetSkeleton_Parms, ReturnValue), Z_Construct_UClass_USkeleton_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAnimationAssetExtensions_GetSkeleton, "GetSkeleton" }, // 3114024745
#endif //WITH_EDITOR
	};
#endif //WITH_EDITOR
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimationAssetExtensions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimationAssetExtensions, UAnimationAssetExtensions::StaticClass, TEXT("UAnimationAssetExtensions"), &Z_Registration_Info_UClass_UAnimationAssetExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimationAssetExtensions), 3359743198U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimationAssetExtensions_h_2915251150(TEXT("/Script/Engine"),
