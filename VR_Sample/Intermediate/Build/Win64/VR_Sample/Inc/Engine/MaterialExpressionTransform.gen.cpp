...
// End Cross Module References
	...
	static UEnum* EMaterialVectorCoordTransformSource_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMaterialVectorCoordTransformSource.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EMaterialVectorCoordTransformSource, Z_Construct_UPackage__Script_Engine(), TEXT("EMaterialVectorCoordTransformSource"));
		}
	...
	static UEnum* EMaterialVectorCoordTransform_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMaterialVectorCoordTransform.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EMaterialVectorCoordTransform, Z_Construct_UPackage__Script_Engine(), TEXT("EMaterialVectorCoordTransform"));
		}
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterialExpressionTransform_Statics::NewProp_TransformType = { "TransformType", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionTransform, TransformType), Z_Construct_UEnum_Engine_EMaterialVectorCoordTransform, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionTransform_Statics::NewProp_TransformType_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionTransform_Statics::NewProp_TransformType_MetaData)) }; // 3513284635
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionTransform_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionTransform, UMaterialExpressionTransform::StaticClass, TEXT("UMaterialExpressionTransform"), &Z_Registration_Info_UClass_UMaterialExpressionTransform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionTransform), 3396737480U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionTransform_h_251535962(TEXT("/Script/Engine"),
