...
// End Cross Module References
	...
	static UEnum* ECameraShakeAttenuation_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECameraShakeAttenuation.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ECameraShakeAttenuation, Z_Construct_UPackage__Script_Engine(), TEXT("ECameraShakeAttenuation"));
		}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCameraShakeSourceComponent_GetAttenuationFactor_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CameraShakeSourceComponent_eventGetAttenuationFactor_Parms, Location), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_UCameraShakeSourceComponent_GetAttenuationFactor_Statics::NewProp_Location_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UCameraShakeSourceComponent_GetAttenuationFactor_Statics::NewProp_Location_MetaData)) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCameraShakeSourceComponent_GetAttenuationFactor_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CameraShakeSourceComponent_eventGetAttenuationFactor_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UCameraShakeSourceComponent_StartCameraShake_Statics::NewProp_InCameraShake = { "InCameraShake", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CameraShakeSourceComponent_eventStartCameraShake_Parms, InCameraShake), Z_Construct_UClass_UCameraShakeBase_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCameraShakeSourceComponent_StartCameraShake_Statics::NewProp_Scale = { "Scale", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CameraShakeSourceComponent_eventStartCameraShake_Parms, Scale), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UCameraShakeSourceComponent_StartCameraShake_Statics::NewProp_PlaySpace = { "PlaySpace", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CameraShakeSourceComponent_eventStartCameraShake_Parms, PlaySpace), Z_Construct_UEnum_Engine_ECameraShakePlaySpace, METADATA_PARAMS(nullptr, 0) }; // 1413967709
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCameraShakeSourceComponent_StartCameraShake_Statics::NewProp_UserPlaySpaceRot = { "UserPlaySpaceRot", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CameraShakeSourceComponent_eventStartCameraShake_Parms, UserPlaySpaceRot), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UCameraShakeSourceComponent_StopAllCameraShakes_Statics::NewProp_bImmediately = { "bImmediately", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(CameraShakeSourceComponent_eventStopAllCameraShakes_Parms), &Z_Construct_UFunction_UCameraShakeSourceComponent_StopAllCameraShakes_Statics::NewProp_bImmediately_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UCameraShakeSourceComponent_StopAllCameraShakesOfType_Statics::NewProp_bImmediately = { "bImmediately", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(CameraShakeSourceComponent_eventStopAllCameraShakesOfType_Parms), &Z_Construct_UFunction_UCameraShakeSourceComponent_StopAllCameraShakesOfType_Statics::NewProp_bImmediately_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCameraShakeSourceComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCameraShakeSourceComponent_GetAttenuationFactor, "GetAttenuationFactor" }, // 3522303940
		{ &Z_Construct_UFunction_UCameraShakeSourceComponent_Start, "Start" }, // 1366339885
		{ &Z_Construct_UFunction_UCameraShakeSourceComponent_StartCameraShake, "StartCameraShake" }, // 4104820892
		{ &Z_Construct_UFunction_UCameraShakeSourceComponent_StopAllCameraShakes, "StopAllCameraShakes" }, // 1903712627
		{ &Z_Construct_UFunction_UCameraShakeSourceComponent_StopAllCameraShakesOfType, "StopAllCameraShakesOfType" }, // 399318529
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_Attenuation_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_InnerAttenuationRadius = { "InnerAttenuationRadius", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCameraShakeSourceComponent, InnerAttenuationRadius), METADATA_PARAMS(Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_InnerAttenuationRadius_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_InnerAttenuationRadius_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_OuterAttenuationRadius = { "OuterAttenuationRadius", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCameraShakeSourceComponent, OuterAttenuationRadius), METADATA_PARAMS(Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_OuterAttenuationRadius_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_OuterAttenuationRadius_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_CameraShake = { "CameraShake", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCameraShakeSourceComponent, CameraShake), Z_Construct_UClass_UCameraShakeBase_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_CameraShake_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_CameraShake_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_bAutoStart = { "bAutoStart", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UCameraShakeSourceComponent), &Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_bAutoStart_SetBit, METADATA_PARAMS(Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_bAutoStart_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_bAutoStart_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_EditorSpriteTextureScale = { "EditorSpriteTextureScale", nullptr, (EPropertyFlags)0x0010000800002000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCameraShakeSourceComponent, EditorSpriteTextureScale), METADATA_PARAMS(Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_EditorSpriteTextureScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCameraShakeSourceComponent_Statics::NewProp_EditorSpriteTextureScale_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraShakeSourceComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCameraShakeSourceComponent, UCameraShakeSourceComponent::StaticClass, TEXT("UCameraShakeSourceComponent"), &Z_Registration_Info_UClass_UCameraShakeSourceComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCameraShakeSourceComponent), 3618890880U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Camera_CameraShakeSourceComponent_h_462427591(TEXT("/Script/Engine"),
