...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEngineMessage_Statics::NewProp_FailedPlaceMessage = { "FailedPlaceMessage", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEngineMessage, FailedPlaceMessage), METADATA_PARAMS(Z_Construct_UClass_UEngineMessage_Statics::NewProp_FailedPlaceMessage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEngineMessage_Statics::NewProp_FailedPlaceMessage_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEngineMessage_Statics::NewProp_MaxedOutMessage = { "MaxedOutMessage", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEngineMessage, MaxedOutMessage), METADATA_PARAMS(Z_Construct_UClass_UEngineMessage_Statics::NewProp_MaxedOutMessage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEngineMessage_Statics::NewProp_MaxedOutMessage_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEngineMessage_Statics::NewProp_EnteredMessage = { "EnteredMessage", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEngineMessage, EnteredMessage), METADATA_PARAMS(Z_Construct_UClass_UEngineMessage_Statics::NewProp_EnteredMessage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEngineMessage_Statics::NewProp_EnteredMessage_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEngineMessage_Statics::NewProp_LeftMessage = { "LeftMessage", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEngineMessage, LeftMessage), METADATA_PARAMS(Z_Construct_UClass_UEngineMessage_Statics::NewProp_LeftMessage_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEngineMessage_Statics::NewProp_LeftMessage_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UEngineMessage_Statics::NewProp_GlobalNameChange_MetaData[] = {
		{ "Comment", "/** Message when a player changes his name. */" },
		{ "ModuleRelativePath", "Classes/GameFramework/EngineMessage.h" },
		{ "ToolTip", "Message when a player changes his name." },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UEngineMessage_Statics::NewProp_GlobalNameChange = { "GlobalNameChange", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEngineMessage, GlobalNameChange), METADATA_PARAMS(Z_Construct_UClass_UEngineMessage_Statics::NewProp_GlobalNameChange_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEngineMessage_Statics::NewProp_GlobalNameChange_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_EngineMessage_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEngineMessage, UEngineMessage::StaticClass, TEXT("UEngineMessage"), &Z_Registration_Info_UClass_UEngineMessage, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEngineMessage), 3596870324U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_EngineMessage_h_1609249351(TEXT("/Script/Engine"),
