...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bAbsolute = { "bAbsolute", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleKillHeight), &Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bAbsolute_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bAbsolute_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bAbsolute_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bFloor = { "bFloor", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleKillHeight), &Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bFloor_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bFloor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bFloor_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bApplyPSysScale = { "bApplyPSysScale", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleKillHeight), &Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bApplyPSysScale_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bApplyPSysScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleKillHeight_Statics::NewProp_bApplyPSysScale_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Kill_ParticleModuleKillHeight_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleKillHeight, UParticleModuleKillHeight::StaticClass, TEXT("UParticleModuleKillHeight"), &Z_Registration_Info_UClass_UParticleModuleKillHeight, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleKillHeight), 728076004U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Kill_ParticleModuleKillHeight_h_3020107088(TEXT("/Script/Engine"),
