...
class UScriptStruct* FHapticFeedbackDetails_Curve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HapticFeedbackDetails_Curve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve, Z_Construct_UPackage__Script_Engine(), TEXT("HapticFeedbackDetails_Curve"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FHapticFeedbackDetails_Curve>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::Struct_MetaDataParams[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::NewProp_Frequency_MetaData[] = {
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::NewProp_Frequency = { "Frequency", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHapticFeedbackDetails_Curve, Frequency), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::NewProp_Frequency_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::NewProp_Frequency_MetaData)) }; // 1196190759
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::NewProp_Amplitude_MetaData[] = {
		{ "Category", "HapticDetails" },
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::Struct_MetaDataParams))
	};
	UScriptStruct* Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve()
	{
		...
		{
			UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_HapticFeedbackDetails_Curve.InnerSingleton, Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::ReturnStructParams);
		}
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_HapticDetails_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHapticFeedbackEffect_Curve_Statics::Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UHapticFeedbackEffect_Curve_Statics::NewProp_HapticDetails_MetaData[] = {
		{ "Category", "HapticFeedbackEffect" },
		{ "ModuleRelativePath", "Classes/Haptics/HapticFeedbackEffect_Curve.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UHapticFeedbackEffect_Curve_Statics::NewProp_HapticDetails = { "HapticDetails", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UHapticFeedbackEffect_Curve, HapticDetails), Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve, METADATA_PARAMS(Z_Construct_UClass_UHapticFeedbackEffect_Curve_Statics::NewProp_HapticDetails_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UHapticFeedbackEffect_Curve_Statics::NewProp_HapticDetails_MetaData)) }; // 2082559311
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UHapticFeedbackEffect_Curve_Statics::ClassParams = {
		...
		0,
		0x000800A0u,
		METADATA_PARAMS(Z_Construct_UClass_UHapticFeedbackEffect_Curve_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UHapticFeedbackEffect_Curve_Statics::Class_MetaDataParams))
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Haptics_HapticFeedbackEffect_Curve_h_Statics::ScriptStructInfo[] = {
		{ FHapticFeedbackDetails_Curve::StaticStruct, Z_Construct_UScriptStruct_FHapticFeedbackDetails_Curve_Statics::NewStructOps, TEXT("HapticFeedbackDetails_Curve"), &Z_Registration_Info_UScriptStruct_HapticFeedbackDetails_Curve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHapticFeedbackDetails_Curve), 2082559311U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Haptics_HapticFeedbackEffect_Curve_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UHapticFeedbackEffect_Curve, UHapticFeedbackEffect_Curve::StaticClass, TEXT("UHapticFeedbackEffect_Curve"), &Z_Registration_Info_UClass_UHapticFeedbackEffect_Curve, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UHapticFeedbackEffect_Curve), 2759386213U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Haptics_HapticFeedbackEffect_Curve_h_861423099(TEXT("/Script/Engine"),
