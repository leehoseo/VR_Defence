...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_USoundNodeGroupControl_Statics::NewProp_GroupSizes_Inner = { "GroupSizes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeGroupControl_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundNodeGroupControl, USoundNodeGroupControl::StaticClass, TEXT("USoundNodeGroupControl"), &Z_Registration_Info_UClass_USoundNodeGroupControl, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundNodeGroupControl), 3420313145U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeGroupControl_h_3123806653(TEXT("/Script/Engine"),
