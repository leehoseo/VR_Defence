...
class UScriptStruct* FKeyHandleMap::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KeyHandleMap.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKeyHandleMap, Z_Construct_UPackage__Script_Engine(), TEXT("KeyHandleMap"));
	}
...
class UScriptStruct* FKeyHandleLookupTable::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KeyHandleLookupTable.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKeyHandleLookupTable, Z_Construct_UPackage__Script_Engine(), TEXT("KeyHandleLookupTable"));
	}
