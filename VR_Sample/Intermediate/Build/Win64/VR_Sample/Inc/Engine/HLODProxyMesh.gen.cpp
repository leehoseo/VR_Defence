...
class UScriptStruct* FHLODProxyMesh::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HLODProxyMesh.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHLODProxyMesh, Z_Construct_UPackage__Script_Engine(), TEXT("HLODProxyMesh"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FHLODProxyMesh>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_StaticMesh = { "StaticMesh", nullptr, (EPropertyFlags)0x0044000000020001, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHLODProxyMesh, StaticMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_StaticMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_StaticMesh_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0040000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHLODProxyMesh, Key), METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_Key_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewProp_Key_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_HLOD_HLODProxyMesh_h_Statics::ScriptStructInfo[] = {
		{ FHLODProxyMesh::StaticStruct, Z_Construct_UScriptStruct_FHLODProxyMesh_Statics::NewStructOps, TEXT("HLODProxyMesh"), &Z_Registration_Info_UScriptStruct_HLODProxyMesh, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHLODProxyMesh), 3845090792U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_HLOD_HLODProxyMesh_h_1048050435(TEXT("/Script/Engine"),
		nullptr, 0,
