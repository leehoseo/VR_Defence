...
// End Cross Module References
	...
	static UEnum* EParticleAxisLock_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EParticleAxisLock.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EParticleAxisLock, Z_Construct_UPackage__Script_Engine(), TEXT("EParticleAxisLock"));
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Orientation_ParticleModuleOrientationAxisLock_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleOrientationAxisLock, UParticleModuleOrientationAxisLock::StaticClass, TEXT("UParticleModuleOrientationAxisLock"), &Z_Registration_Info_UClass_UParticleModuleOrientationAxisLock, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleOrientationAxisLock), 1398423601U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Orientation_ParticleModuleOrientationAxisLock_h_146902922(TEXT("/Script/Engine"),
