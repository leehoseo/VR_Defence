...
// End Cross Module References
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UTexture2D_Blueprint_GetSizeX_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Texture2D_eventBlueprint_GetSizeX_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UTexture2D_Blueprint_GetSizeY_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Texture2D_eventBlueprint_GetSizeY_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTexture2D_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTexture2D_Blueprint_GetSizeX, "Blueprint_GetSizeX" }, // 1392486201
		{ &Z_Construct_UFunction_UTexture2D_Blueprint_GetSizeY, "Blueprint_GetSizeY" }, // 2603991126
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTexture2D_Statics::NewProp_bTemporarilyDisableStreaming = { "bTemporarilyDisableStreaming", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UTexture2D), &Z_Construct_UClass_UTexture2D_Statics::NewProp_bTemporarilyDisableStreaming_SetBit, METADATA_PARAMS(Z_Construct_UClass_UTexture2D_Statics::NewProp_bTemporarilyDisableStreaming_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTexture2D_Statics::NewProp_bTemporarilyDisableStreaming_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UTexture2D_Statics::NewProp_bHasBeenPaintedInEditor = { "bHasBeenPaintedInEditor", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UTexture2D), &Z_Construct_UClass_UTexture2D_Statics::NewProp_bHasBeenPaintedInEditor_SetBit, METADATA_PARAMS(Z_Construct_UClass_UTexture2D_Statics::NewProp_bHasBeenPaintedInEditor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTexture2D_Statics::NewProp_bHasBeenPaintedInEditor_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UTexture2D_Statics::NewProp_AddressX = { "AddressX", nullptr, (EPropertyFlags)0x0010050000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTexture2D, AddressX), Z_Construct_UEnum_Engine_TextureAddress, METADATA_PARAMS(Z_Construct_UClass_UTexture2D_Statics::NewProp_AddressX_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTexture2D_Statics::NewProp_AddressX_MetaData)) }; // 1007474672
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UTexture2D_Statics::NewProp_AddressY = { "AddressY", nullptr, (EPropertyFlags)0x0010050000000005, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTexture2D, AddressY), Z_Construct_UEnum_Engine_TextureAddress, METADATA_PARAMS(Z_Construct_UClass_UTexture2D_Statics::NewProp_AddressY_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTexture2D_Statics::NewProp_AddressY_MetaData)) }; // 1007474672
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Texture2D_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTexture2D, UTexture2D::StaticClass, TEXT("UTexture2D"), &Z_Registration_Info_UClass_UTexture2D, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTexture2D), 4136995363U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_Texture2D_h_3693004063(TEXT("/Script/Engine"),
