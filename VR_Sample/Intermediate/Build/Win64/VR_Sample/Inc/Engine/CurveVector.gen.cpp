...
class UScriptStruct* FRuntimeVectorCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RuntimeVectorCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRuntimeVectorCurve, Z_Construct_UPackage__Script_Engine(), TEXT("RuntimeVectorCurve"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FRuntimeVectorCurve>()
{
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UCurveVector_GetVectorValue_Statics::NewProp_InTime = { "InTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CurveVector_eventGetVectorValue_Parms, InTime), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UCurveVector_GetVectorValue_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(CurveVector_eventGetVectorValue_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCurveVector_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCurveVector_GetVectorValue, "GetVectorValue" }, // 2744562455
	};
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_CurveVector_h_Statics::ScriptStructInfo[] = {
		{ FRuntimeVectorCurve::StaticStruct, Z_Construct_UScriptStruct_FRuntimeVectorCurve_Statics::NewStructOps, TEXT("RuntimeVectorCurve"), &Z_Registration_Info_UScriptStruct_RuntimeVectorCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRuntimeVectorCurve), 3334677111U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_CurveVector_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCurveVector, UCurveVector::StaticClass, TEXT("UCurveVector"), &Z_Registration_Info_UClass_UCurveVector, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCurveVector), 846767879U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_CurveVector_h_3674792300(TEXT("/Script/Engine"),
