...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleVelocity_Statics::NewProp_StartVelocity = { "StartVelocity", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleVelocity, StartVelocity), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleVelocity_Statics::NewProp_StartVelocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleVelocity_Statics::NewProp_StartVelocity_MetaData)) }; // 3599899551
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleVelocity_Statics::NewProp_StartVelocityRadial = { "StartVelocityRadial", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleVelocity, StartVelocityRadial), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleVelocity_Statics::NewProp_StartVelocityRadial_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleVelocity_Statics::NewProp_StartVelocityRadial_MetaData)) }; // 3468229032
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Velocity_ParticleModuleVelocity_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleVelocity, UParticleModuleVelocity::StaticClass, TEXT("UParticleModuleVelocity"), &Z_Registration_Info_UClass_UParticleModuleVelocity, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleVelocity), 3817080110U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Velocity_ParticleModuleVelocity_h_1417110789(TEXT("/Script/Engine"),
