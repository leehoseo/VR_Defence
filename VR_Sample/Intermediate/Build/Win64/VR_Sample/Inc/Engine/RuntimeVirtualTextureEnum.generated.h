...
#define CURRENT_FILE_ID FID_Engine_Source_Runtime_Engine_Public_VT_RuntimeVirtualTextureEnum_h
...
#define FOREACH_ENUM_ERUNTIMEVIRTUALTEXTUREMATERIALTYPE(op) \
	...
	op(ERuntimeVirtualTextureMaterialType::BaseColor_Normal_Roughness) \
