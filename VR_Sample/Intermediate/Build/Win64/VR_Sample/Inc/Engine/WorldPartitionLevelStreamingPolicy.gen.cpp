...
#include "Engine/Public/WorldPartition/WorldPartitionLevelStreamingPolicy.h"
...
// End Cross Module References
...
#endif
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UWorldPartitionLevelStreamingPolicy_Statics::NewProp_ActorToCellRemapping_ValueProp = { "ActorToCellRemapping", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UWorldPartitionLevelStreamingPolicy_Statics::NewProp_ActorToCellRemapping = { "ActorToCellRemapping", nullptr, (EPropertyFlags)0x0040000800000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWorldPartitionLevelStreamingPolicy, ActorToCellRemapping), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UWorldPartitionLevelStreamingPolicy_Statics::NewProp_ActorToCellRemapping_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldPartitionLevelStreamingPolicy_Statics::NewProp_ActorToCellRemapping_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UWorldPartitionLevelStreamingPolicy_Statics::NewProp_SubObjectsToCellRemapping_ValueProp = { "SubObjectsToCellRemapping", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UWorldPartitionLevelStreamingPolicy_Statics::NewProp_SubObjectsToCellRemapping = { "SubObjectsToCellRemapping", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWorldPartitionLevelStreamingPolicy, SubObjectsToCellRemapping), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UWorldPartitionLevelStreamingPolicy_Statics::NewProp_SubObjectsToCellRemapping_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldPartitionLevelStreamingPolicy_Statics::NewProp_SubObjectsToCellRemapping_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionLevelStreamingPolicy_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWorldPartitionLevelStreamingPolicy, UWorldPartitionLevelStreamingPolicy::StaticClass, TEXT("UWorldPartitionLevelStreamingPolicy"), &Z_Registration_Info_UClass_UWorldPartitionLevelStreamingPolicy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWorldPartitionLevelStreamingPolicy), 2154806283U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_WorldPartitionLevelStreamingPolicy_h_2458208647(TEXT("/Script/Engine"),
