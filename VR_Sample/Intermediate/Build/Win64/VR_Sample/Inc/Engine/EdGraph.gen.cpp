...
class UScriptStruct* FGraphReference::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GraphReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGraphReference, Z_Construct_UPackage__Script_Engine(), TEXT("GraphReference"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FGraphReference>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FGraphReference_Statics::NewProp_GraphBlueprint = { "GraphBlueprint", nullptr, (EPropertyFlags)0x0024080000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGraphReference, GraphBlueprint), Z_Construct_UClass_UBlueprint_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FGraphReference_Statics::NewProp_GraphBlueprint_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGraphReference_Statics::NewProp_GraphBlueprint_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UEdGraph_Statics::NewProp_Schema = { "Schema", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEdGraph, Schema), Z_Construct_UClass_UEdGraphSchema_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_UEdGraph_Statics::NewProp_Schema_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEdGraph_Statics::NewProp_Schema_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UEdGraph_Statics::NewProp_Nodes_Inner = { "Nodes", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UEdGraphNode_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEdGraph_Statics::NewProp_Nodes = { "Nodes", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEdGraph, Nodes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEdGraph_Statics::NewProp_Nodes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEdGraph_Statics::NewProp_Nodes_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEdGraph_Statics::NewProp_bEditable = { "bEditable", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UEdGraph), &Z_Construct_UClass_UEdGraph_Statics::NewProp_bEditable_SetBit, METADATA_PARAMS(Z_Construct_UClass_UEdGraph_Statics::NewProp_bEditable_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEdGraph_Statics::NewProp_bEditable_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UEdGraph_Statics::NewProp_bAllowRenaming = { "bAllowRenaming", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UEdGraph), &Z_Construct_UClass_UEdGraph_Statics::NewProp_bAllowRenaming_SetBit, METADATA_PARAMS(Z_Construct_UClass_UEdGraph_Statics::NewProp_bAllowRenaming_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEdGraph_Statics::NewProp_bAllowRenaming_MetaData)) };
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UEdGraph_Statics::NewProp_SubGraphs_Inner = { "SubGraphs", nullptr, (EPropertyFlags)0x0004000800000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UEdGraph_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UEdGraph_Statics::NewProp_SubGraphs = { "SubGraphs", nullptr, (EPropertyFlags)0x0014000800000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEdGraph, SubGraphs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UEdGraph_Statics::NewProp_SubGraphs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEdGraph_Statics::NewProp_SubGraphs_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEdGraph_Statics::NewProp_GraphGuid = { "GraphGuid", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEdGraph, GraphGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UClass_UEdGraph_Statics::NewProp_GraphGuid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEdGraph_Statics::NewProp_GraphGuid_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UEdGraph_Statics::NewProp_InterfaceGuid = { "InterfaceGuid", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UEdGraph, InterfaceGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UClass_UEdGraph_Statics::NewProp_InterfaceGuid_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UEdGraph_Statics::NewProp_InterfaceGuid_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_EdGraph_EdGraph_h_Statics::ScriptStructInfo[] = {
		{ FGraphReference::StaticStruct, Z_Construct_UScriptStruct_FGraphReference_Statics::NewStructOps, TEXT("GraphReference"), &Z_Registration_Info_UScriptStruct_GraphReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGraphReference), 3036491820U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_EdGraph_EdGraph_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UEdGraph, UEdGraph::StaticClass, TEXT("UEdGraph"), &Z_Registration_Info_UClass_UEdGraph, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEdGraph), 3144384828U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_EdGraph_EdGraph_h_861778309(TEXT("/Script/Engine"),
