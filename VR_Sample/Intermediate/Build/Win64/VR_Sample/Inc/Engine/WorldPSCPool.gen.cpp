...
// End Cross Module References
	...
	static UEnum* EPSCPoolMethod_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPSCPoolMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EPSCPoolMethod, Z_Construct_UPackage__Script_Engine(), TEXT("EPSCPoolMethod"));
		}
...
class UScriptStruct* FPSCPoolElem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PSCPoolElem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPSCPoolElem, Z_Construct_UPackage__Script_Engine(), TEXT("PSCPoolElem"));
	}
...
class UScriptStruct* FPSCPool::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PSCPool.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPSCPool, Z_Construct_UPackage__Script_Engine(), TEXT("PSCPool"));
	}
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPSCPool_Statics::NewProp_FreeElements = { "FreeElements", nullptr, (EPropertyFlags)0x0010008000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPSCPool, FreeElements), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPSCPool_Statics::NewProp_FreeElements_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPSCPool_Statics::NewProp_FreeElements_MetaData)) }; // 879916878
...
class UScriptStruct* FWorldPSCPool::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WorldPSCPool.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWorldPSCPool, Z_Construct_UPackage__Script_Engine(), TEXT("WorldPSCPool"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FWorldPSCPool>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FWorldPSCPool_Statics::NewProp_WorldParticleSystemPools_ValueProp = { "WorldParticleSystemPools", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, Z_Construct_UScriptStruct_FPSCPool, METADATA_PARAMS(nullptr, 0) }; // 797879085
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FWorldPSCPool_Statics::NewProp_WorldParticleSystemPools_Key_KeyProp = { "WorldParticleSystemPools_Key", nullptr, (EPropertyFlags)0x0004008000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FWorldPSCPool_Statics::NewProp_WorldParticleSystemPools = { "WorldParticleSystemPools", nullptr, (EPropertyFlags)0x0040008000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWorldPSCPool, WorldParticleSystemPools), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FWorldPSCPool_Statics::NewProp_WorldParticleSystemPools_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWorldPSCPool_Statics::NewProp_WorldParticleSystemPools_MetaData)) }; // 797879085
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_WorldPSCPool_h_Statics::ScriptStructInfo[] = {
		{ FPSCPoolElem::StaticStruct, Z_Construct_UScriptStruct_FPSCPoolElem_Statics::NewStructOps, TEXT("PSCPoolElem"), &Z_Registration_Info_UScriptStruct_PSCPoolElem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPSCPoolElem), 879916878U) },
		{ FPSCPool::StaticStruct, Z_Construct_UScriptStruct_FPSCPool_Statics::NewStructOps, TEXT("PSCPool"), &Z_Registration_Info_UScriptStruct_PSCPool, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPSCPool), 797879085U) },
		{ FWorldPSCPool::StaticStruct, Z_Construct_UScriptStruct_FWorldPSCPool_Statics::NewStructOps, TEXT("WorldPSCPool"), &Z_Registration_Info_UScriptStruct_WorldPSCPool, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWorldPSCPool), 2415641401U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_WorldPSCPool_h_145526914(TEXT("/Script/Engine"),
		nullptr, 0,
