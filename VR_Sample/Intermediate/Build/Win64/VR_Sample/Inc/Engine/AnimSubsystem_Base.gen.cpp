...
#include "Engine/Public/Animation/AnimSubsystem_Base.h"
...
class UScriptStruct* FAnimSubsystem_Base::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimSubsystem_Base.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimSubsystem_Base, Z_Construct_UPackage__Script_Engine(), TEXT("AnimSubsystem_Base"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimSubsystem_Base>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimSubsystem_Base_Statics::NewProp_ExposedValueHandlers_Inner = { "ExposedValueHandlers", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FExposedValueHandler, METADATA_PARAMS(nullptr, 0) }; // 2438862648
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FAnimSubsystem_Base_Statics::NewProp_ExposedValueHandlers = { "ExposedValueHandlers", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimSubsystem_Base, ExposedValueHandlers), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimSubsystem_Base_Statics::NewProp_ExposedValueHandlers_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimSubsystem_Base_Statics::NewProp_ExposedValueHandlers_MetaData)) }; // 2438862648
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimSubsystem_Base_h_Statics::ScriptStructInfo[] = {
		{ FAnimSubsystem_Base::StaticStruct, Z_Construct_UScriptStruct_FAnimSubsystem_Base_Statics::NewStructOps, TEXT("AnimSubsystem_Base"), &Z_Registration_Info_UScriptStruct_AnimSubsystem_Base, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimSubsystem_Base), 3864104251U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_AnimSubsystem_Base_h_1408654930(TEXT("/Script/Engine"),
		nullptr, 0,
