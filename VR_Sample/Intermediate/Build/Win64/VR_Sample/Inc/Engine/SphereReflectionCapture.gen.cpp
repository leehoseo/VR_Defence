...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ASphereReflectionCapture_Statics::NewProp_DrawCaptureRadius = { "DrawCaptureRadius", nullptr, (EPropertyFlags)0x0044000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASphereReflectionCapture, DrawCaptureRadius), Z_Construct_UClass_UDrawSphereComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASphereReflectionCapture_Statics::NewProp_DrawCaptureRadius_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASphereReflectionCapture_Statics::NewProp_DrawCaptureRadius_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_SphereReflectionCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASphereReflectionCapture, ASphereReflectionCapture::StaticClass, TEXT("ASphereReflectionCapture"), &Z_Registration_Info_UClass_ASphereReflectionCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASphereReflectionCapture), 3303455882U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_SphereReflectionCapture_h_1598611846(TEXT("/Script/Engine"),
