...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFInt64PropertyParams Z_Construct_UClass_UVirtualTextureBuilder_Statics::NewProp_BuildHash = { "BuildHash", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::UInt64, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVirtualTextureBuilder, BuildHash), METADATA_PARAMS(Z_Construct_UClass_UVirtualTextureBuilder_Statics::NewProp_BuildHash_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualTextureBuilder_Statics::NewProp_BuildHash_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_VirtualTextureBuilder_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVirtualTextureBuilder, UVirtualTextureBuilder::StaticClass, TEXT("UVirtualTextureBuilder"), &Z_Registration_Info_UClass_UVirtualTextureBuilder, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVirtualTextureBuilder), 4076629230U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_VirtualTextureBuilder_h_3382436518(TEXT("/Script/Engine"),
