...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DataAsset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDataAsset, UDataAsset::StaticClass, TEXT("UDataAsset"), &Z_Registration_Info_UClass_UDataAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDataAsset), 810166323U) },
		{ Z_Construct_UClass_UPrimaryDataAsset, UPrimaryDataAsset::StaticClass, TEXT("UPrimaryDataAsset"), &Z_Registration_Info_UClass_UPrimaryDataAsset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPrimaryDataAsset), 515357571U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DataAsset_h_4221629293(TEXT("/Script/Engine"),
