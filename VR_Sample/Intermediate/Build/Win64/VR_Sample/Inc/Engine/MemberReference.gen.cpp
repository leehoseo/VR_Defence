...
class UScriptStruct* FMemberReference::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MemberReference.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMemberReference, Z_Construct_UPackage__Script_Engine(), TEXT("MemberReference"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FMemberReference>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberScope = { "MemberScope", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FMemberReference, MemberScope), METADATA_PARAMS(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberScope_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_MemberScope_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext = { "bSelfContext", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMemberReference), &Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bSelfContext_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bWasDeprecated = { "bWasDeprecated", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMemberReference), &Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bWasDeprecated_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bWasDeprecated_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMemberReference_Statics::NewProp_bWasDeprecated_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_MemberReference_h_Statics::ScriptStructInfo[] = {
		{ FMemberReference::StaticStruct, Z_Construct_UScriptStruct_FMemberReference_Statics::NewStructOps, TEXT("MemberReference"), &Z_Registration_Info_UScriptStruct_MemberReference, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMemberReference), 3380895081U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_MemberReference_h_2272275956(TEXT("/Script/Engine"),
		nullptr, 0,
