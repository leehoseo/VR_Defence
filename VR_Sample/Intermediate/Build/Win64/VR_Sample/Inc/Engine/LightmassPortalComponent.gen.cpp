...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ULightmassPortalComponent_Statics::NewProp_PreviewBox = { "PreviewBox", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULightmassPortalComponent, PreviewBox), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ULightmassPortalComponent_Statics::NewProp_PreviewBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULightmassPortalComponent_Statics::NewProp_PreviewBox_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_LightmassPortalComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULightmassPortalComponent, ULightmassPortalComponent::StaticClass, TEXT("ULightmassPortalComponent"), &Z_Registration_Info_UClass_ULightmassPortalComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULightmassPortalComponent), 3661476417U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_LightmassPortalComponent_h_1440602724(TEXT("/Script/Engine"),
