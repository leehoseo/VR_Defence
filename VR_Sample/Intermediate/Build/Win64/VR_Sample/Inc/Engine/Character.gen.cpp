...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_Engine_MovementModeChangedSignature__DelegateSignature_Statics::NewProp_Character = { "Character", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventMovementModeChangedSignature_Parms, Character), Z_Construct_UClass_ACharacter_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UDelegateFunction_Engine_MovementModeChangedSignature__DelegateSignature_Statics::NewProp_PrevMovementMode = { "PrevMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventMovementModeChangedSignature_Parms, PrevMovementMode), Z_Construct_UEnum_Engine_EMovementMode, METADATA_PARAMS(nullptr, 0) }; // 1544502984
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UDelegateFunction_Engine_MovementModeChangedSignature__DelegateSignature_Statics::NewProp_PreviousCustomMode = { "PreviousCustomMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventMovementModeChangedSignature_Parms, PreviousCustomMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_Engine_CharacterMovementUpdatedSignature__DelegateSignature_Statics::NewProp_DeltaSeconds = { "DeltaSeconds", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventCharacterMovementUpdatedSignature_Parms, DeltaSeconds), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_Engine_CharacterMovementUpdatedSignature__DelegateSignature_Statics::NewProp_OldLocation = { "OldLocation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventCharacterMovementUpdatedSignature_Parms, OldLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_Engine_CharacterMovementUpdatedSignature__DelegateSignature_Statics::NewProp_OldVelocity = { "OldVelocity", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventCharacterMovementUpdatedSignature_Parms, OldVelocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_Engine_LandedSignature__DelegateSignature_Statics::NewProp_Hit = { "Hit", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventLandedSignature_Parms, Hit), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(Z_Construct_UDelegateFunction_Engine_LandedSignature__DelegateSignature_Statics::NewProp_Hit_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_LandedSignature__DelegateSignature_Statics::NewProp_Hit_MetaData)) }; // 1416937132
...
class UScriptStruct* FRepRootMotionMontage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RepRootMotionMontage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRepRootMotionMontage, Z_Construct_UPackage__Script_Engine(), TEXT("RepRootMotionMontage"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FRepRootMotionMontage>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bIsActive = { "bIsActive", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRepRootMotionMontage), &Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bIsActive_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bIsActive_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bIsActive_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRepRootMotionMontage, Position), METADATA_PARAMS(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_Position_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_Position_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRepRootMotionMontage, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_Rotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_Rotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_MovementBase = { "MovementBase", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRepRootMotionMontage, MovementBase), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_MovementBase_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_MovementBase_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bRelativePosition = { "bRelativePosition", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRepRootMotionMontage), &Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bRelativePosition_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bRelativePosition_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bRelativePosition_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bRelativeRotation = { "bRelativeRotation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FRepRootMotionMontage), &Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bRelativeRotation_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bRelativeRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_bRelativeRotation_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_AuthoritativeRootMotion = { "AuthoritativeRootMotion", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRepRootMotionMontage, AuthoritativeRootMotion), Z_Construct_UScriptStruct_FRootMotionSourceGroup, METADATA_PARAMS(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_AuthoritativeRootMotion_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_AuthoritativeRootMotion_MetaData)) }; // 319014244
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_Acceleration = { "Acceleration", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRepRootMotionMontage, Acceleration), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_Acceleration_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_Acceleration_MetaData)) }; // 2472546252
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_LinearVelocity = { "LinearVelocity", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRepRootMotionMontage, LinearVelocity), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_LinearVelocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewProp_LinearVelocity_MetaData)) }; // 2472546252
...
class UScriptStruct* FSimulatedRootMotionReplicatedMove::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SimulatedRootMotionReplicatedMove.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSimulatedRootMotionReplicatedMove, Z_Construct_UPackage__Script_Engine(), TEXT("SimulatedRootMotionReplicatedMove"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSimulatedRootMotionReplicatedMove_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSimulatedRootMotionReplicatedMove, Time), METADATA_PARAMS(Z_Construct_UScriptStruct_FSimulatedRootMotionReplicatedMove_Statics::NewProp_Time_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimulatedRootMotionReplicatedMove_Statics::NewProp_Time_MetaData)) };
#if WITH_METADATA
...
class UScriptStruct* FBasedMovementInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BasedMovementInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBasedMovementInfo, Z_Construct_UPackage__Script_Engine(), TEXT("BasedMovementInfo"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBasedMovementInfo>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_MovementBase = { "MovementBase", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBasedMovementInfo, MovementBase), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_MovementBase_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_MovementBase_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_BoneName = { "BoneName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBasedMovementInfo, BoneName), METADATA_PARAMS(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_BoneName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_BoneName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_Location = { "Location", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBasedMovementInfo, Location), Z_Construct_UScriptStruct_FVector_NetQuantize100, METADATA_PARAMS(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_Location_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_Location_MetaData)) }; // 3121577039
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_Rotation = { "Rotation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBasedMovementInfo, Rotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_Rotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_Rotation_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bServerHasBaseComponent = { "bServerHasBaseComponent", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FBasedMovementInfo), &Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bServerHasBaseComponent_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bServerHasBaseComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bServerHasBaseComponent_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bRelativeRotation = { "bRelativeRotation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FBasedMovementInfo), &Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bRelativeRotation_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bRelativeRotation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bRelativeRotation_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bServerHasVelocity = { "bServerHasVelocity", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FBasedMovementInfo), &Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bServerHasVelocity_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bServerHasVelocity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewProp_bServerHasVelocity_MetaData)) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_CacheInitialMeshOffset_Statics::NewProp_MeshRelativeLocation = { "MeshRelativeLocation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventCacheInitialMeshOffset_Parms, MeshRelativeLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_CacheInitialMeshOffset_Statics::NewProp_MeshRelativeRotation = { "MeshRelativeRotation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventCacheInitialMeshOffset_Parms, MeshRelativeRotation), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_CanCrouch_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventCanCrouch_Parms), &Z_Construct_UFunction_ACharacter_CanCrouch_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_CanJump_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventCanJump_Parms), &Z_Construct_UFunction_ACharacter_CanJump_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_CanJumpInternal_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventCanJumpInternal_Parms), &Z_Construct_UFunction_ACharacter_CanJumpInternal_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ClientAckGoodMove_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAckGoodMove_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustPosition_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustPosition_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustPosition_Statics::NewProp_NewLoc = { "NewLoc", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustPosition_Parms, NewLoc), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustPosition_Statics::NewProp_NewVel = { "NewVel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustPosition_Parms, NewVel), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustPosition_Statics::NewProp_bHasBase = { "bHasBase", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventClientAdjustPosition_Parms), &Z_Construct_UFunction_ACharacter_ClientAdjustPosition_Statics::NewProp_bHasBase_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustPosition_Statics::NewProp_bBaseRelativePosition = { "bBaseRelativePosition", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventClientAdjustPosition_Parms), &Z_Construct_UFunction_ACharacter_ClientAdjustPosition_Statics::NewProp_bBaseRelativePosition_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustPosition_Statics::NewProp_ServerMovementMode = { "ServerMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustPosition_Parms, ServerMovementMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionPosition_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_ServerMontageTrackPosition = { "ServerMontageTrackPosition", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionPosition_Parms, ServerMontageTrackPosition), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_ServerLoc = { "ServerLoc", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionPosition_Parms, ServerLoc), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_ServerRotation = { "ServerRotation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionPosition_Parms, ServerRotation), Z_Construct_UScriptStruct_FVector_NetQuantizeNormal, METADATA_PARAMS(nullptr, 0) }; // 2339297813
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_ServerVelZ = { "ServerVelZ", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionPosition_Parms, ServerVelZ), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_ServerBase = { "ServerBase", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionPosition_Parms, ServerBase), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_ServerBase_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_ServerBase_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_ServerBoneName = { "ServerBoneName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionPosition_Parms, ServerBoneName), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_bHasBase = { "bHasBase", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventClientAdjustRootMotionPosition_Parms), &Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_bHasBase_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_bBaseRelativePosition = { "bBaseRelativePosition", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventClientAdjustRootMotionPosition_Parms), &Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_bBaseRelativePosition_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition_Statics::NewProp_ServerMovementMode = { "ServerMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionPosition_Parms, ServerMovementMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionSourcePosition_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_ServerRootMotion = { "ServerRootMotion", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionSourcePosition_Parms, ServerRootMotion), Z_Construct_UScriptStruct_FRootMotionSourceGroup, METADATA_PARAMS(nullptr, 0) }; // 319014244
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_bHasAnimRootMotion = { "bHasAnimRootMotion", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventClientAdjustRootMotionSourcePosition_Parms), &Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_bHasAnimRootMotion_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_ServerMontageTrackPosition = { "ServerMontageTrackPosition", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionSourcePosition_Parms, ServerMontageTrackPosition), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_ServerLoc = { "ServerLoc", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionSourcePosition_Parms, ServerLoc), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_ServerRotation = { "ServerRotation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionSourcePosition_Parms, ServerRotation), Z_Construct_UScriptStruct_FVector_NetQuantizeNormal, METADATA_PARAMS(nullptr, 0) }; // 2339297813
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_ServerVelZ = { "ServerVelZ", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionSourcePosition_Parms, ServerVelZ), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_bHasBase = { "bHasBase", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventClientAdjustRootMotionSourcePosition_Parms), &Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_bHasBase_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_bBaseRelativePosition = { "bBaseRelativePosition", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventClientAdjustRootMotionSourcePosition_Parms), &Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_bBaseRelativePosition_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition_Statics::NewProp_ServerMovementMode = { "ServerMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientAdjustRootMotionSourcePosition_Parms, ServerMovementMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientVeryShortAdjustPosition_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_NewLoc = { "NewLoc", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientVeryShortAdjustPosition_Parms, NewLoc), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_NewBase = { "NewBase", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientVeryShortAdjustPosition_Parms, NewBase), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_NewBase_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_NewBase_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_NewBaseBoneName = { "NewBaseBoneName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientVeryShortAdjustPosition_Parms, NewBaseBoneName), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_bHasBase = { "bHasBase", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventClientVeryShortAdjustPosition_Parms), &Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_bHasBase_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_bBaseRelativePosition = { "bBaseRelativePosition", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventClientVeryShortAdjustPosition_Parms), &Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_bBaseRelativePosition_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition_Statics::NewProp_ServerMovementMode = { "ServerMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventClientVeryShortAdjustPosition_Parms, ServerMovementMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_Crouch_Statics::NewProp_bClientSimulation = { "bClientSimulation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventCrouch_Parms), &Z_Construct_UFunction_ACharacter_Crouch_Statics::NewProp_bClientSimulation_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_GetAnimRootMotionTranslationScale_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventGetAnimRootMotionTranslationScale_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_GetBaseRotationOffsetRotator_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventGetBaseRotationOffsetRotator_Parms, ReturnValue), Z_Construct_UScriptStruct_FRotator, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_GetBaseTranslationOffset_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventGetBaseTranslationOffset_Parms, ReturnValue), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACharacter_GetCurrentMontage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventGetCurrentMontage_Parms, ReturnValue), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_HasAnyRootMotion_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventHasAnyRootMotion_Parms), &Z_Construct_UFunction_ACharacter_HasAnyRootMotion_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_IsJumpProvidingForce_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventIsJumpProvidingForce_Parms), &Z_Construct_UFunction_ACharacter_IsJumpProvidingForce_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_IsPlayingNetworkedRootMotionMontage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventIsPlayingNetworkedRootMotionMontage_Parms), &Z_Construct_UFunction_ACharacter_IsPlayingNetworkedRootMotionMontage_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_IsPlayingRootMotion_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventIsPlayingRootMotion_Parms), &Z_Construct_UFunction_ACharacter_IsPlayingRootMotion_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_K2_OnEndCrouch_Statics::NewProp_HalfHeightAdjust = { "HalfHeightAdjust", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventK2_OnEndCrouch_Parms, HalfHeightAdjust), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_K2_OnEndCrouch_Statics::NewProp_ScaledHalfHeightAdjust = { "ScaledHalfHeightAdjust", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventK2_OnEndCrouch_Parms, ScaledHalfHeightAdjust), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_K2_OnMovementModeChanged_Statics::NewProp_PrevMovementMode = { "PrevMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventK2_OnMovementModeChanged_Parms, PrevMovementMode), Z_Construct_UEnum_Engine_EMovementMode, METADATA_PARAMS(nullptr, 0) }; // 1544502984
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_K2_OnMovementModeChanged_Statics::NewProp_NewMovementMode = { "NewMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventK2_OnMovementModeChanged_Parms, NewMovementMode), Z_Construct_UEnum_Engine_EMovementMode, METADATA_PARAMS(nullptr, 0) }; // 1544502984
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_K2_OnMovementModeChanged_Statics::NewProp_PrevCustomMode = { "PrevCustomMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventK2_OnMovementModeChanged_Parms, PrevCustomMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_K2_OnMovementModeChanged_Statics::NewProp_NewCustomMode = { "NewCustomMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventK2_OnMovementModeChanged_Parms, NewCustomMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_K2_OnStartCrouch_Statics::NewProp_HalfHeightAdjust = { "HalfHeightAdjust", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventK2_OnStartCrouch_Parms, HalfHeightAdjust), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_K2_OnStartCrouch_Statics::NewProp_ScaledHalfHeightAdjust = { "ScaledHalfHeightAdjust", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventK2_OnStartCrouch_Parms, ScaledHalfHeightAdjust), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_K2_UpdateCustomMovement_Statics::NewProp_DeltaTime = { "DeltaTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventK2_UpdateCustomMovement_Parms, DeltaTime), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_LaunchCharacter_Statics::NewProp_LaunchVelocity = { "LaunchVelocity", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventLaunchCharacter_Parms, LaunchVelocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_LaunchCharacter_Statics::NewProp_bXYOverride = { "bXYOverride", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventLaunchCharacter_Parms), &Z_Construct_UFunction_ACharacter_LaunchCharacter_Statics::NewProp_bXYOverride_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_LaunchCharacter_Statics::NewProp_bZOverride = { "bZOverride", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventLaunchCharacter_Parms), &Z_Construct_UFunction_ACharacter_LaunchCharacter_Statics::NewProp_bZOverride_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_OnLanded_Statics::NewProp_Hit = { "Hit", nullptr, (EPropertyFlags)0x0010008008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventOnLanded_Parms, Hit), Z_Construct_UScriptStruct_FHitResult, METADATA_PARAMS(Z_Construct_UFunction_ACharacter_OnLanded_Statics::NewProp_Hit_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ACharacter_OnLanded_Statics::NewProp_Hit_MetaData)) }; // 1416937132
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_OnLaunched_Statics::NewProp_LaunchVelocity = { "LaunchVelocity", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventOnLaunched_Parms, LaunchVelocity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_OnLaunched_Statics::NewProp_bXYOverride = { "bXYOverride", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventOnLaunched_Parms), &Z_Construct_UFunction_ACharacter_OnLaunched_Statics::NewProp_bXYOverride_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_OnLaunched_Statics::NewProp_bZOverride = { "bZOverride", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventOnLaunched_Parms), &Z_Construct_UFunction_ACharacter_OnLaunched_Statics::NewProp_bZOverride_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_OnWalkingOffLedge_Statics::NewProp_PreviousLocation = { "PreviousLocation", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventOnWalkingOffLedge_Parms, PreviousLocation), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(Z_Construct_UFunction_ACharacter_OnWalkingOffLedge_Statics::NewProp_PreviousLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ACharacter_OnWalkingOffLedge_Statics::NewProp_PreviousLocation_MetaData)) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_OnWalkingOffLedge_Statics::NewProp_TimeDelta = { "TimeDelta", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventOnWalkingOffLedge_Parms, TimeDelta), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACharacter_PlayAnimMontage_Statics::NewProp_AnimMontage = { "AnimMontage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventPlayAnimMontage_Parms, AnimMontage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_PlayAnimMontage_Statics::NewProp_InPlayRate = { "InPlayRate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventPlayAnimMontage_Parms, InPlayRate), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ACharacter_PlayAnimMontage_Statics::NewProp_StartSectionName = { "StartSectionName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventPlayAnimMontage_Parms, StartSectionName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_PlayAnimMontage_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventPlayAnimMontage_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMove_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_InAccel = { "InAccel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMove_Parms, InAccel), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(nullptr, 0) }; // 2472546252
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_ClientLoc = { "ClientLoc", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMove_Parms, ClientLoc), Z_Construct_UScriptStruct_FVector_NetQuantize100, METADATA_PARAMS(nullptr, 0) }; // 3121577039
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_CompressedMoveFlags = { "CompressedMoveFlags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMove_Parms, CompressedMoveFlags), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_ClientRoll = { "ClientRoll", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMove_Parms, ClientRoll), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_View = { "View", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMove_Parms, View), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_ClientMovementBase = { "ClientMovementBase", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMove_Parms, ClientMovementBase), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_ClientMovementBase_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_ClientMovementBase_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_ClientBaseBoneName = { "ClientBaseBoneName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMove_Parms, ClientBaseBoneName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMove_Statics::NewProp_ClientMovementMode = { "ClientMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMove_Parms, ClientMovementMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_TimeStamp0 = { "TimeStamp0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, TimeStamp0), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_InAccel0 = { "InAccel0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, InAccel0), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(nullptr, 0) }; // 2472546252
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_PendingFlags = { "PendingFlags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, PendingFlags), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_View0 = { "View0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, View0), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_InAccel = { "InAccel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, InAccel), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(nullptr, 0) }; // 2472546252
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_ClientLoc = { "ClientLoc", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, ClientLoc), Z_Construct_UScriptStruct_FVector_NetQuantize100, METADATA_PARAMS(nullptr, 0) }; // 3121577039
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_NewFlags = { "NewFlags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, NewFlags), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_ClientRoll = { "ClientRoll", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, ClientRoll), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_View = { "View", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, View), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_ClientMovementBase = { "ClientMovementBase", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, ClientMovementBase), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_ClientMovementBase_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_ClientMovementBase_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_ClientBaseBoneName = { "ClientBaseBoneName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, ClientBaseBoneName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDual_Statics::NewProp_ClientMovementMode = { "ClientMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDual_Parms, ClientMovementMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_TimeStamp0 = { "TimeStamp0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, TimeStamp0), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_InAccel0 = { "InAccel0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, InAccel0), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(nullptr, 0) }; // 2472546252
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_PendingFlags = { "PendingFlags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, PendingFlags), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_View0 = { "View0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, View0), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_InAccel = { "InAccel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, InAccel), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(nullptr, 0) }; // 2472546252
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_ClientLoc = { "ClientLoc", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, ClientLoc), Z_Construct_UScriptStruct_FVector_NetQuantize100, METADATA_PARAMS(nullptr, 0) }; // 3121577039
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_NewFlags = { "NewFlags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, NewFlags), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_ClientRoll = { "ClientRoll", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, ClientRoll), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_View = { "View", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, View), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_ClientMovementBase = { "ClientMovementBase", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, ClientMovementBase), Z_Construct_UClass_UPrimitiveComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_ClientMovementBase_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_ClientMovementBase_MetaData)) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_ClientBaseBoneName = { "ClientBaseBoneName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, ClientBaseBoneName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion_Statics::NewProp_ClientMovementMode = { "ClientMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualHybridRootMotion_Parms, ClientMovementMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_TimeStamp0 = { "TimeStamp0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, TimeStamp0), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_InAccel0 = { "InAccel0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, InAccel0), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(nullptr, 0) }; // 2472546252
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_PendingFlags = { "PendingFlags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, PendingFlags), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_View0 = { "View0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, View0), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_InAccel = { "InAccel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, InAccel), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(nullptr, 0) }; // 2472546252
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_ClientLoc = { "ClientLoc", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, ClientLoc), Z_Construct_UScriptStruct_FVector_NetQuantize100, METADATA_PARAMS(nullptr, 0) }; // 3121577039
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_NewFlags = { "NewFlags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, NewFlags), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_ClientRoll = { "ClientRoll", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, ClientRoll), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_View = { "View", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, View), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase_Statics::NewProp_ClientMovementMode = { "ClientMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveDualNoBase_Parms, ClientMovementMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveNoBase_Statics::NewProp_TimeStamp = { "TimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveNoBase_Parms, TimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveNoBase_Statics::NewProp_InAccel = { "InAccel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveNoBase_Parms, InAccel), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(nullptr, 0) }; // 2472546252
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveNoBase_Statics::NewProp_ClientLoc = { "ClientLoc", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveNoBase_Parms, ClientLoc), Z_Construct_UScriptStruct_FVector_NetQuantize100, METADATA_PARAMS(nullptr, 0) }; // 3121577039
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveNoBase_Statics::NewProp_CompressedMoveFlags = { "CompressedMoveFlags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveNoBase_Parms, CompressedMoveFlags), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveNoBase_Statics::NewProp_ClientRoll = { "ClientRoll", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveNoBase_Parms, ClientRoll), nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UFunction_ACharacter_ServerMoveNoBase_Statics::NewProp_View = { "View", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveNoBase_Parms, View), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveNoBase_Statics::NewProp_ClientMovementMode = { "ClientMovementMode", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveNoBase_Parms, ClientMovementMode), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveOld_Statics::NewProp_OldTimeStamp = { "OldTimeStamp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveOld_Parms, OldTimeStamp), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_ACharacter_ServerMoveOld_Statics::NewProp_OldAccel = { "OldAccel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveOld_Parms, OldAccel), Z_Construct_UScriptStruct_FVector_NetQuantize10, METADATA_PARAMS(nullptr, 0) }; // 2472546252
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_ACharacter_ServerMoveOld_Statics::NewProp_OldMoveFlags = { "OldMoveFlags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventServerMoveOld_Parms, OldMoveFlags), nullptr, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_ACharacter_StopAnimMontage_Statics::NewProp_AnimMontage = { "AnimMontage", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Character_eventStopAnimMontage_Parms, AnimMontage), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ACharacter_UnCrouch_Statics::NewProp_bClientSimulation = { "bClientSimulation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(Character_eventUnCrouch_Parms), &Z_Construct_UFunction_ACharacter_UnCrouch_Statics::NewProp_bClientSimulation_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACharacter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACharacter_CacheInitialMeshOffset, "CacheInitialMeshOffset" }, // 2076302470
		{ &Z_Construct_UFunction_ACharacter_CanCrouch, "CanCrouch" }, // 2303520910
		{ &Z_Construct_UFunction_ACharacter_CanJump, "CanJump" }, // 3672095836
		{ &Z_Construct_UFunction_ACharacter_CanJumpInternal, "CanJumpInternal" }, // 286954932
		{ &Z_Construct_UFunction_ACharacter_ClientAckGoodMove, "ClientAckGoodMove" }, // 3241464078
		{ &Z_Construct_UFunction_ACharacter_ClientAdjustPosition, "ClientAdjustPosition" }, // 2559755448
		{ &Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionPosition, "ClientAdjustRootMotionPosition" }, // 3820674116
		{ &Z_Construct_UFunction_ACharacter_ClientAdjustRootMotionSourcePosition, "ClientAdjustRootMotionSourcePosition" }, // 2011890211
		...
		{ &Z_Construct_UFunction_ACharacter_ClientMoveResponsePacked, "ClientMoveResponsePacked" }, // 877557319
		{ &Z_Construct_UFunction_ACharacter_ClientVeryShortAdjustPosition, "ClientVeryShortAdjustPosition" }, // 699651567
		{ &Z_Construct_UFunction_ACharacter_Crouch, "Crouch" }, // 3892858653
		{ &Z_Construct_UFunction_ACharacter_GetAnimRootMotionTranslationScale, "GetAnimRootMotionTranslationScale" }, // 2644371647
		{ &Z_Construct_UFunction_ACharacter_GetBaseRotationOffsetRotator, "GetBaseRotationOffsetRotator" }, // 2059222267
		{ &Z_Construct_UFunction_ACharacter_GetBaseTranslationOffset, "GetBaseTranslationOffset" }, // 1527113523
		{ &Z_Construct_UFunction_ACharacter_GetCurrentMontage, "GetCurrentMontage" }, // 2653469420
		{ &Z_Construct_UFunction_ACharacter_HasAnyRootMotion, "HasAnyRootMotion" }, // 2802366289
		{ &Z_Construct_UFunction_ACharacter_IsJumpProvidingForce, "IsJumpProvidingForce" }, // 1517423402
		{ &Z_Construct_UFunction_ACharacter_IsPlayingNetworkedRootMotionMontage, "IsPlayingNetworkedRootMotionMontage" }, // 755259555
		{ &Z_Construct_UFunction_ACharacter_IsPlayingRootMotion, "IsPlayingRootMotion" }, // 574565110
		{ &Z_Construct_UFunction_ACharacter_Jump, "Jump" }, // 2621732335
		{ &Z_Construct_UFunction_ACharacter_K2_OnEndCrouch, "K2_OnEndCrouch" }, // 4058799267
		{ &Z_Construct_UFunction_ACharacter_K2_OnMovementModeChanged, "K2_OnMovementModeChanged" }, // 724373229
		{ &Z_Construct_UFunction_ACharacter_K2_OnStartCrouch, "K2_OnStartCrouch" }, // 3814265156
		{ &Z_Construct_UFunction_ACharacter_K2_UpdateCustomMovement, "K2_UpdateCustomMovement" }, // 3164426651
		{ &Z_Construct_UFunction_ACharacter_LaunchCharacter, "LaunchCharacter" }, // 811010412
		{ &Z_Construct_UFunction_ACharacter_OnJumped, "OnJumped" }, // 3518914689
		{ &Z_Construct_UFunction_ACharacter_OnLanded, "OnLanded" }, // 2059841644
		{ &Z_Construct_UFunction_ACharacter_OnLaunched, "OnLaunched" }, // 1154167772
		...
		{ &Z_Construct_UFunction_ACharacter_OnWalkingOffLedge, "OnWalkingOffLedge" }, // 3683080439
		{ &Z_Construct_UFunction_ACharacter_PlayAnimMontage, "PlayAnimMontage" }, // 1535790693
		{ &Z_Construct_UFunction_ACharacter_RootMotionDebugClientPrintOnScreen, "RootMotionDebugClientPrintOnScreen" }, // 2470105356
		{ &Z_Construct_UFunction_ACharacter_ServerMove, "ServerMove" }, // 2501275200
		{ &Z_Construct_UFunction_ACharacter_ServerMoveDual, "ServerMoveDual" }, // 2700163294
		{ &Z_Construct_UFunction_ACharacter_ServerMoveDualHybridRootMotion, "ServerMoveDualHybridRootMotion" }, // 2801881717
		{ &Z_Construct_UFunction_ACharacter_ServerMoveDualNoBase, "ServerMoveDualNoBase" }, // 2798963367
		{ &Z_Construct_UFunction_ACharacter_ServerMoveNoBase, "ServerMoveNoBase" }, // 3114104466
		{ &Z_Construct_UFunction_ACharacter_ServerMoveOld, "ServerMoveOld" }, // 2587815711
		{ &Z_Construct_UFunction_ACharacter_ServerMovePacked, "ServerMovePacked" }, // 938028142
		{ &Z_Construct_UFunction_ACharacter_StopAnimMontage, "StopAnimMontage" }, // 2340204979
		{ &Z_Construct_UFunction_ACharacter_StopJumping, "StopJumping" }, // 1229135822
		{ &Z_Construct_UFunction_ACharacter_UnCrouch, "UnCrouch" }, // 3993368310
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_Mesh = { "Mesh", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, Mesh), Z_Construct_UClass_USkeletalMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_Mesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_Mesh_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_CharacterMovement = { "CharacterMovement", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, CharacterMovement), Z_Construct_UClass_UCharacterMovementComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_CharacterMovement_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_CharacterMovement_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_CapsuleComponent = { "CapsuleComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, CapsuleComponent), Z_Construct_UClass_UCapsuleComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_CapsuleComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_CapsuleComponent_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_ArrowComponent = { "ArrowComponent", nullptr, (EPropertyFlags)0x0044000800080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, ArrowComponent), Z_Construct_UClass_UArrowComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_ArrowComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_ArrowComponent_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_BasedMovement = { "BasedMovement", nullptr, (EPropertyFlags)0x0020088000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, BasedMovement), Z_Construct_UScriptStruct_FBasedMovementInfo, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_BasedMovement_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_BasedMovement_MetaData)) }; // 2458221877
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_ReplicatedBasedMovement = { "ReplicatedBasedMovement", "OnRep_ReplicatedBasedMovement", (EPropertyFlags)0x0020088100000020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, ReplicatedBasedMovement), Z_Construct_UScriptStruct_FBasedMovementInfo, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_ReplicatedBasedMovement_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_ReplicatedBasedMovement_MetaData)) }; // 2458221877
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_BaseRotationOffset = { "BaseRotationOffset", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, BaseRotationOffset), Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_BaseRotationOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_BaseRotationOffset_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_ReplayLastTransformUpdateTimeStamp = { "ReplayLastTransformUpdateTimeStamp", "OnRep_ReplayLastTransformUpdateTimeStamp", (EPropertyFlags)0x0020080100000020, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, ReplayLastTransformUpdateTimeStamp), METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_ReplayLastTransformUpdateTimeStamp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_ReplayLastTransformUpdateTimeStamp_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bInBaseReplication = { "bInBaseReplication", nullptr, (EPropertyFlags)0x0020080000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bInBaseReplication_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bInBaseReplication_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bInBaseReplication_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_CrouchedEyeHeight = { "CrouchedEyeHeight", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, CrouchedEyeHeight), METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_CrouchedEyeHeight_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_CrouchedEyeHeight_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bIsCrouched = { "bIsCrouched", "OnRep_IsCrouched", (EPropertyFlags)0x0010000100000034, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bIsCrouched_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bIsCrouched_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bIsCrouched_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bProxyIsJumpForceApplied = { "bProxyIsJumpForceApplied", nullptr, (EPropertyFlags)0x0010000000002020, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bProxyIsJumpForceApplied_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bProxyIsJumpForceApplied_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bProxyIsJumpForceApplied_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bPressedJump = { "bPressedJump", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bPressedJump_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bPressedJump_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bPressedJump_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bClientUpdating = { "bClientUpdating", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bClientUpdating_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bClientUpdating_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bClientUpdating_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bClientWasFalling = { "bClientWasFalling", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bClientWasFalling_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bClientWasFalling_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bClientWasFalling_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bClientResimulateRootMotion = { "bClientResimulateRootMotion", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bClientResimulateRootMotion_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bClientResimulateRootMotion_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bClientResimulateRootMotion_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bClientResimulateRootMotionSources = { "bClientResimulateRootMotionSources", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bClientResimulateRootMotionSources_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bClientResimulateRootMotionSources_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bClientResimulateRootMotionSources_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACharacter_Statics::NewProp_bSimGravityDisabled_MetaData[] = {
		{ "Comment", "/** Disable simulated gravity (set when character encroaches geometry on client, to keep him from falling through floors) */" },
		{ "ModuleRelativePath", "Classes/GameFramework/Character.h" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bClientCheckEncroachmentOnNetUpdate = { "bClientCheckEncroachmentOnNetUpdate", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bClientCheckEncroachmentOnNetUpdate_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bClientCheckEncroachmentOnNetUpdate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bClientCheckEncroachmentOnNetUpdate_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bServerMoveIgnoreRootMotion = { "bServerMoveIgnoreRootMotion", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bServerMoveIgnoreRootMotion_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bServerMoveIgnoreRootMotion_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bServerMoveIgnoreRootMotion_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_bWasJumping = { "bWasJumping", nullptr, (EPropertyFlags)0x0010000000022815, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ACharacter), &Z_Construct_UClass_ACharacter_Statics::NewProp_bWasJumping_SetBit, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_bWasJumping_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_bWasJumping_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_JumpForceTimeRemaining = { "JumpForceTimeRemaining", nullptr, (EPropertyFlags)0x0010000000022815, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, JumpForceTimeRemaining), METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_JumpForceTimeRemaining_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_JumpForceTimeRemaining_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_ProxyJumpForceStartedTime = { "ProxyJumpForceStartedTime", nullptr, (EPropertyFlags)0x0010000000022815, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, ProxyJumpForceStartedTime), METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_ProxyJumpForceStartedTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_ProxyJumpForceStartedTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_JumpMaxHoldTime = { "JumpMaxHoldTime", nullptr, (EPropertyFlags)0x0010000000000025, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, JumpMaxHoldTime), METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_JumpMaxHoldTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_JumpMaxHoldTime_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_JumpMaxCount = { "JumpMaxCount", nullptr, (EPropertyFlags)0x0010000000000025, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, JumpMaxCount), METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_JumpMaxCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_JumpMaxCount_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_JumpCurrentCount = { "JumpCurrentCount", nullptr, (EPropertyFlags)0x0010000000020815, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, JumpCurrentCount), METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_JumpCurrentCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_JumpCurrentCount_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_JumpCurrentCountPreJump = { "JumpCurrentCountPreJump", nullptr, (EPropertyFlags)0x0010000000020815, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, JumpCurrentCountPreJump), METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_JumpCurrentCountPreJump_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_JumpCurrentCountPreJump_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_OnReachedJumpApex = { "OnReachedJumpApex", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, OnReachedJumpApex), Z_Construct_UDelegateFunction_Engine_CharacterReachedApexSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_OnReachedJumpApex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_OnReachedJumpApex_MetaData)) }; // 4115536723
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_OnCharacterMovementUpdated = { "OnCharacterMovementUpdated", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, OnCharacterMovementUpdated), Z_Construct_UDelegateFunction_Engine_CharacterMovementUpdatedSignature__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_OnCharacterMovementUpdated_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_OnCharacterMovementUpdated_MetaData)) }; // 4066196209
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_SavedRootMotion = { "SavedRootMotion", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, SavedRootMotion), Z_Construct_UScriptStruct_FRootMotionSourceGroup, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_SavedRootMotion_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_SavedRootMotion_MetaData)) }; // 319014244
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_ClientRootMotionParams = { "ClientRootMotionParams", nullptr, (EPropertyFlags)0x0010000000002000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, ClientRootMotionParams), Z_Construct_UScriptStruct_FRootMotionMovementParams, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_ClientRootMotionParams_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_ClientRootMotionParams_MetaData)) }; // 1082694049
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_RootMotionRepMoves_Inner = { "RootMotionRepMoves", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSimulatedRootMotionReplicatedMove, METADATA_PARAMS(nullptr, 0) }; // 83749100
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_RootMotionRepMoves = { "RootMotionRepMoves", nullptr, (EPropertyFlags)0x0010008000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, RootMotionRepMoves), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_RootMotionRepMoves_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_RootMotionRepMoves_MetaData)) }; // 83749100
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ACharacter_Statics::NewProp_RepRootMotion = { "RepRootMotion", "OnRep_RootMotion", (EPropertyFlags)0x0010008100000020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACharacter, RepRootMotion), Z_Construct_UScriptStruct_FRepRootMotionMontage, METADATA_PARAMS(Z_Construct_UClass_ACharacter_Statics::NewProp_RepRootMotion_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACharacter_Statics::NewProp_RepRootMotion_MetaData)) }; // 206557000
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_Character_h_Statics::ScriptStructInfo[] = {
		{ FRepRootMotionMontage::StaticStruct, Z_Construct_UScriptStruct_FRepRootMotionMontage_Statics::NewStructOps, TEXT("RepRootMotionMontage"), &Z_Registration_Info_UScriptStruct_RepRootMotionMontage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRepRootMotionMontage), 206557000U) },
		{ FSimulatedRootMotionReplicatedMove::StaticStruct, Z_Construct_UScriptStruct_FSimulatedRootMotionReplicatedMove_Statics::NewStructOps, TEXT("SimulatedRootMotionReplicatedMove"), &Z_Registration_Info_UScriptStruct_SimulatedRootMotionReplicatedMove, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSimulatedRootMotionReplicatedMove), 83749100U) },
		{ FBasedMovementInfo::StaticStruct, Z_Construct_UScriptStruct_FBasedMovementInfo_Statics::NewStructOps, TEXT("BasedMovementInfo"), &Z_Registration_Info_UScriptStruct_BasedMovementInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBasedMovementInfo), 2458221877U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_Character_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACharacter, ACharacter::StaticClass, TEXT("ACharacter"), &Z_Registration_Info_UClass_ACharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACharacter), 621216032U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_Character_h_3334922346(TEXT("/Script/Engine"),
