...
class UScriptStruct* FTextSizingParameters::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TextSizingParameters.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTextSizingParameters, Z_Construct_UPackage__Script_Engine(), TEXT("TextSizingParameters"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawX = { "DrawX", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTextSizingParameters, DrawX), METADATA_PARAMS(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawX_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawX_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawY = { "DrawY", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTextSizingParameters, DrawY), METADATA_PARAMS(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawY_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawY_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawXL = { "DrawXL", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTextSizingParameters, DrawXL), METADATA_PARAMS(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawXL_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawXL_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawYL = { "DrawYL", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTextSizingParameters, DrawYL), METADATA_PARAMS(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawYL_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_DrawYL_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_Scaling = { "Scaling", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTextSizingParameters, Scaling), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_Scaling_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_Scaling_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_SpacingAdjust = { "SpacingAdjust", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTextSizingParameters, SpacingAdjust), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_SpacingAdjust_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewProp_SpacingAdjust_MetaData)) };
...
class UScriptStruct* FWrappedStringElement::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_WrappedStringElement.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWrappedStringElement, Z_Construct_UPackage__Script_Engine(), TEXT("WrappedStringElement"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FWrappedStringElement>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FWrappedStringElement_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FWrappedStringElement, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FWrappedStringElement_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FWrappedStringElement_Statics::NewProp_Value_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_CanvasTypes_h_Statics::ScriptStructInfo[] = {
		{ FTextSizingParameters::StaticStruct, Z_Construct_UScriptStruct_FTextSizingParameters_Statics::NewStructOps, TEXT("TextSizingParameters"), &Z_Registration_Info_UScriptStruct_TextSizingParameters, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTextSizingParameters), 3265000845U) },
		{ FWrappedStringElement::StaticStruct, Z_Construct_UScriptStruct_FWrappedStringElement_Statics::NewStructOps, TEXT("WrappedStringElement"), &Z_Registration_Info_UScriptStruct_WrappedStringElement, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWrappedStringElement), 2207738U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_CanvasTypes_h_4099389789(TEXT("/Script/Engine"),
		nullptr, 0,
