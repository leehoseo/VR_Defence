...
// End Cross Module References
	...
	static UEnum* ECloudStorageDelegate_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECloudStorageDelegate.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ECloudStorageDelegate, Z_Construct_UPackage__Script_Engine(), TEXT("ECloudStorageDelegate"));
		}
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_Engine_ECloudStorageDelegate_Statics::Enum_MetaDataParams[] = {
		...
		{ "CSD_KeyValueReadComplete.Comment", "// @todo: Fill in the result descriptions for these guys (and the other PI subclasses)\n" },
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UCloudStorageBase_Statics::NewProp_LocalCloudFiles_Inner = { "LocalCloudFiles", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCloudStorageBase_Statics::NewProp_LocalCloudFiles = { "LocalCloudFiles", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UCloudStorageBase, LocalCloudFiles), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCloudStorageBase_Statics::NewProp_LocalCloudFiles_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCloudStorageBase_Statics::NewProp_LocalCloudFiles_MetaData)) };
#if WITH_METADATA
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CloudStorageBase_h_Statics::EnumInfo[] = {
		{ ECloudStorageDelegate_StaticEnum, TEXT("ECloudStorageDelegate"), &Z_Registration_Info_UEnum_ECloudStorageDelegate, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2139669200U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CloudStorageBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCloudStorageBase, UCloudStorageBase::StaticClass, TEXT("UCloudStorageBase"), &Z_Registration_Info_UClass_UCloudStorageBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCloudStorageBase), 913459423U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_CloudStorageBase_h_3341351042(TEXT("/Script/Engine"),
