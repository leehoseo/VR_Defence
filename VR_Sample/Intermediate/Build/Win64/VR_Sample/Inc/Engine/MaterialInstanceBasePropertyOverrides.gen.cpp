...
class UScriptStruct* FMaterialInstanceBasePropertyOverrides::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MaterialInstanceBasePropertyOverrides.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMaterialInstanceBasePropertyOverrides, Z_Construct_UPackage__Script_Engine(), TEXT("MaterialInstanceBasePropertyOverrides"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FMaterialInstanceBasePropertyOverrides>()
{
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialInstanceBasePropertyOverrides_h_2402172032(TEXT("/Script/Engine"),
		nullptr, 0,
