...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULevelActorContainer_Statics::NewProp_Actors = { "Actors", nullptr, (EPropertyFlags)0x0014000000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelActorContainer, Actors), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULevelActorContainer_Statics::NewProp_Actors_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelActorContainer_Statics::NewProp_Actors_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_LevelActorContainer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULevelActorContainer, ULevelActorContainer::StaticClass, TEXT("ULevelActorContainer"), &Z_Registration_Info_UClass_ULevelActorContainer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevelActorContainer), 2065637847U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_LevelActorContainer_h_2470333111(TEXT("/Script/Engine"),
