...
// End Cross Module References
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAutoDestroySubsystem_OnActorEndPlay_Statics::NewProp_Actor = { "Actor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AutoDestroySubsystem_eventOnActorEndPlay_Parms, Actor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAutoDestroySubsystem_OnActorEndPlay_Statics::NewProp_EndPlayReason = { "EndPlayReason", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AutoDestroySubsystem_eventOnActorEndPlay_Parms, EndPlayReason), Z_Construct_UEnum_Engine_EEndPlayReason, METADATA_PARAMS(nullptr, 0) }; // 2713016423
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAutoDestroySubsystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAutoDestroySubsystem_OnActorEndPlay, "OnActorEndPlay" }, // 297894246
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAutoDestroySubsystem_Statics::NewProp_ActorsToPoll = { "ActorsToPoll", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAutoDestroySubsystem, ActorsToPoll), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAutoDestroySubsystem_Statics::NewProp_ActorsToPoll_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAutoDestroySubsystem_Statics::NewProp_ActorsToPoll_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_AutoDestroySubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAutoDestroySubsystem, UAutoDestroySubsystem::StaticClass, TEXT("UAutoDestroySubsystem"), &Z_Registration_Info_UClass_UAutoDestroySubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAutoDestroySubsystem), 570937342U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_AutoDestroySubsystem_h_2797633261(TEXT("/Script/Engine"),
