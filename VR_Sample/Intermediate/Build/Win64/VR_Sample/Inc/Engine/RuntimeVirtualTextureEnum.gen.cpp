...
// End Cross Module References
	...
	static UEnum* ERuntimeVirtualTextureMaterialType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERuntimeVirtualTextureMaterialType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ERuntimeVirtualTextureMaterialType, Z_Construct_UPackage__Script_Engine(), TEXT("ERuntimeVirtualTextureMaterialType"));
		}
	...
	static UEnum* ERuntimeVirtualTextureMainPassType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERuntimeVirtualTextureMainPassType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ERuntimeVirtualTextureMainPassType, Z_Construct_UPackage__Script_Engine(), TEXT("ERuntimeVirtualTextureMainPassType"));
		}
