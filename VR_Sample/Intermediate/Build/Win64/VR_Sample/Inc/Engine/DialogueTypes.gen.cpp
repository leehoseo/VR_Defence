...
// End Cross Module References
	...
	static UEnum* EGrammaticalGender_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EGrammaticalGender.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EGrammaticalGender, Z_Construct_UPackage__Script_Engine(), TEXT("EGrammaticalGender"));
		}
	...
	static UEnum* EGrammaticalNumber_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EGrammaticalNumber.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EGrammaticalNumber, Z_Construct_UPackage__Script_Engine(), TEXT("EGrammaticalNumber"));
		}
...
class UScriptStruct* FDialogueContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DialogueContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDialogueContext, Z_Construct_UPackage__Script_Engine(), TEXT("DialogueContext"));
	}
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FDialogueContext_Statics::NewProp_Speaker = { "Speaker", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDialogueContext, Speaker), Z_Construct_UClass_UDialogueVoice_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FDialogueContext_Statics::NewProp_Speaker_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDialogueContext_Statics::NewProp_Speaker_MetaData)) };
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FDialogueContext_Statics::NewProp_Targets_Inner = { "Targets", nullptr, (EPropertyFlags)0x0004000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UDialogueVoice_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FDialogueContext_Statics::NewProp_Targets = { "Targets", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDialogueContext, Targets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FDialogueContext_Statics::NewProp_Targets_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDialogueContext_Statics::NewProp_Targets_MetaData)) };
...
class UScriptStruct* FDialogueWaveParameter::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DialogueWaveParameter.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDialogueWaveParameter, Z_Construct_UPackage__Script_Engine(), TEXT("DialogueWaveParameter"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FDialogueWaveParameter>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_DialogueTypes_h_Statics::ScriptStructInfo[] = {
		{ FDialogueContext::StaticStruct, Z_Construct_UScriptStruct_FDialogueContext_Statics::NewStructOps, TEXT("DialogueContext"), &Z_Registration_Info_UScriptStruct_DialogueContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDialogueContext), 1679063042U) },
		{ FDialogueWaveParameter::StaticStruct, Z_Construct_UScriptStruct_FDialogueWaveParameter_Statics::NewStructOps, TEXT("DialogueWaveParameter"), &Z_Registration_Info_UScriptStruct_DialogueWaveParameter, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDialogueWaveParameter), 118817405U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_DialogueTypes_h_1436310800(TEXT("/Script/Engine"),
		nullptr, 0,
