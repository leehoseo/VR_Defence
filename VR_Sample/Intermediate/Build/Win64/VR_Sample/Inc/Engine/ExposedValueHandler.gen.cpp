...
#include "Engine/Public/Animation/ExposedValueHandler.h"
...
// End Cross Module References
	...
	static UEnum* EPostCopyOperation_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EPostCopyOperation.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EPostCopyOperation, Z_Construct_UPackage__Script_Engine(), TEXT("EPostCopyOperation"));
		}
...
class UScriptStruct* FExposedValueCopyRecord::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ExposedValueCopyRecord.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FExposedValueCopyRecord, Z_Construct_UPackage__Script_Engine(), TEXT("ExposedValueCopyRecord"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CopyIndex = { "CopyIndex", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueCopyRecord, CopyIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CopyIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_CopyIndex_MetaData)) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_PostCopyOperation = { "PostCopyOperation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueCopyRecord, PostCopyOperation), Z_Construct_UEnum_Engine_EPostCopyOperation, METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_PostCopyOperation_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewProp_PostCopyOperation_MetaData)) }; // 872811142
...
class UScriptStruct* FExposedValueHandler::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ExposedValueHandler.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FExposedValueHandler, Z_Construct_UPackage__Script_Engine(), TEXT("ExposedValueHandler"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FExposedValueHandler>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewProp_CopyRecords_Inner = { "CopyRecords", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FExposedValueCopyRecord, METADATA_PARAMS(nullptr, 0) }; // 2612570468
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewProp_CopyRecords = { "CopyRecords", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueHandler, CopyRecords), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewProp_CopyRecords_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewProp_CopyRecords_MetaData)) }; // 2612570468
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewProp_Function = { "Function", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueHandler, Function), Z_Construct_UClass_UFunction, METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewProp_Function_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewProp_Function_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewProp_BoundFunction = { "BoundFunction", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FExposedValueHandler, BoundFunction), METADATA_PARAMS(Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewProp_BoundFunction_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewProp_BoundFunction_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_ExposedValueHandler_h_Statics::ScriptStructInfo[] = {
		{ FExposedValueCopyRecord::StaticStruct, Z_Construct_UScriptStruct_FExposedValueCopyRecord_Statics::NewStructOps, TEXT("ExposedValueCopyRecord"), &Z_Registration_Info_UScriptStruct_ExposedValueCopyRecord, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FExposedValueCopyRecord), 2612570468U) },
		{ FExposedValueHandler::StaticStruct, Z_Construct_UScriptStruct_FExposedValueHandler_Statics::NewStructOps, TEXT("ExposedValueHandler"), &Z_Registration_Info_UScriptStruct_ExposedValueHandler, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FExposedValueHandler), 2438862648U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_ExposedValueHandler_h_1041239648(TEXT("/Script/Engine"),
		nullptr, 0,
