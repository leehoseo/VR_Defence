...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_UniqueNameIndex = { "UniqueNameIndex", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserDefinedEnum, UniqueNameIndex), METADATA_PARAMS(Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_UniqueNameIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_UniqueNameIndex_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_EnumDescription = { "EnumDescription", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserDefinedEnum, EnumDescription), METADATA_PARAMS(Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_EnumDescription_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_EnumDescription_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_DisplayNameMap_ValueProp = { "DisplayNameMap", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_DisplayNameMap_Key_KeyProp = { "DisplayNameMap_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_DisplayNameMap = { "DisplayNameMap", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UUserDefinedEnum, DisplayNameMap), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_DisplayNameMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UUserDefinedEnum_Statics::NewProp_DisplayNameMap_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_UserDefinedEnum_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UUserDefinedEnum, UUserDefinedEnum::StaticClass, TEXT("UUserDefinedEnum"), &Z_Registration_Info_UClass_UUserDefinedEnum, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUserDefinedEnum), 3544635653U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_UserDefinedEnum_h_459404993(TEXT("/Script/Engine"),
