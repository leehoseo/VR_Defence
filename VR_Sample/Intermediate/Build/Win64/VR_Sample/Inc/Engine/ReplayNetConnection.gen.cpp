...
#include "Engine/Public/ReplayNetConnection.h"
...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UReplayNetConnection_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "ReplayNetConnection.h" },
		{ "ModuleRelativePath", "Public/ReplayNetConnection.h" },
		{ "ObjectInitializerConstructorDeclared", "" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UReplayNetConnection_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UReplayNetConnection_Statics::ClassParams = {
		...
		0,
		0x001000ACu,
		METADATA_PARAMS(Z_Construct_UClass_UReplayNetConnection_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UReplayNetConnection_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_ReplayNetConnection_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UReplayNetConnection, UReplayNetConnection::StaticClass, TEXT("UReplayNetConnection"), &Z_Registration_Info_UClass_UReplayNetConnection, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReplayNetConnection), 2614759398U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_ReplayNetConnection_h_1246409976(TEXT("/Script/Engine"),
