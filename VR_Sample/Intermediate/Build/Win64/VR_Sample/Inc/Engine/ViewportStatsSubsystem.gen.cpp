...
// End Cross Module References
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UDelegateFunction_Engine_ViewportDisplayCallback__DelegateSignature_Statics::NewProp_OutText = { "OutText", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventViewportDisplayCallback_Parms, OutText), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_Engine_ViewportDisplayCallback__DelegateSignature_Statics::NewProp_OutColor = { "OutColor", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventViewportDisplayCallback_Parms, OutColor), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_Engine_ViewportDisplayCallback__DelegateSignature_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(_Script_Engine_eventViewportDisplayCallback_Parms), &Z_Construct_UDelegateFunction_Engine_ViewportDisplayCallback__DelegateSignature_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UViewportStatsSubsystem_AddTimedDisplay_Statics::NewProp_Text = { "Text", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ViewportStatsSubsystem_eventAddTimedDisplay_Parms, Text), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UViewportStatsSubsystem_AddTimedDisplay_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ViewportStatsSubsystem_eventAddTimedDisplay_Parms, Color), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UViewportStatsSubsystem_AddTimedDisplay_Statics::NewProp_Duration = { "Duration", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ViewportStatsSubsystem_eventAddTimedDisplay_Parms, Duration), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UViewportStatsSubsystem_AddTimedDisplay_Statics::NewProp_DisplayOffset = { "DisplayOffset", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ViewportStatsSubsystem_eventAddTimedDisplay_Parms, DisplayOffset), Z_Construct_UScriptStruct_FVector2D, METADATA_PARAMS(Z_Construct_UFunction_UViewportStatsSubsystem_AddTimedDisplay_Statics::NewProp_DisplayOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UViewportStatsSubsystem_AddTimedDisplay_Statics::NewProp_DisplayOffset_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UViewportStatsSubsystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UViewportStatsSubsystem_AddDisplayDelegate, "AddDisplayDelegate" }, // 2032937534
		{ &Z_Construct_UFunction_UViewportStatsSubsystem_AddTimedDisplay, "AddTimedDisplay" }, // 200644632
		{ &Z_Construct_UFunction_UViewportStatsSubsystem_RemoveDisplayDelegate, "RemoveDisplayDelegate" }, // 4281748685
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_ViewportStatsSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UViewportStatsSubsystem, UViewportStatsSubsystem::StaticClass, TEXT("UViewportStatsSubsystem"), &Z_Registration_Info_UClass_UViewportStatsSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UViewportStatsSubsystem), 969681183U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_ViewportStatsSubsystem_h_4060243507(TEXT("/Script/Engine"),
