...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimNotifyState_Trail_OverridePSTemplate_Statics::NewProp_MeshComp = { "MeshComp", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimNotifyState_Trail_eventOverridePSTemplate_Parms, MeshComp), Z_Construct_UClass_USkeletalMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UAnimNotifyState_Trail_OverridePSTemplate_Statics::NewProp_MeshComp_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimNotifyState_Trail_OverridePSTemplate_Statics::NewProp_MeshComp_MetaData)) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimNotifyState_Trail_OverridePSTemplate_Statics::NewProp_Animation = { "Animation", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimNotifyState_Trail_eventOverridePSTemplate_Parms, Animation), Z_Construct_UClass_UAnimSequenceBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimNotifyState_Trail_OverridePSTemplate_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimNotifyState_Trail_eventOverridePSTemplate_Parms, ReturnValue), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimNotifyState_Trail_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAnimNotifyState_Trail_OverridePSTemplate, "OverridePSTemplate" }, // 2624457700
	};
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_PSTemplate = { "PSTemplate", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimNotifyState_Trail, PSTemplate), Z_Construct_UClass_UParticleSystem_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_PSTemplate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_PSTemplate_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderGeometry = { "bRenderGeometry", nullptr, (EPropertyFlags)0x0010000800002011, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UAnimNotifyState_Trail), &Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderGeometry_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderGeometry_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderGeometry_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderSpawnPoints = { "bRenderSpawnPoints", nullptr, (EPropertyFlags)0x0010000800002011, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UAnimNotifyState_Trail), &Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderSpawnPoints_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderSpawnPoints_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderSpawnPoints_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderTangents = { "bRenderTangents", nullptr, (EPropertyFlags)0x0010000800002011, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UAnimNotifyState_Trail), &Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderTangents_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderTangents_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderTangents_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderTessellation = { "bRenderTessellation", nullptr, (EPropertyFlags)0x0010000800002011, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UAnimNotifyState_Trail), &Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderTessellation_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderTessellation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimNotifyState_Trail_Statics::NewProp_bRenderTessellation_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNotifies_AnimNotifyState_Trail_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimNotifyState_Trail, UAnimNotifyState_Trail::StaticClass, TEXT("UAnimNotifyState_Trail"), &Z_Registration_Info_UClass_UAnimNotifyState_Trail, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimNotifyState_Trail), 2193586188U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNotifies_AnimNotifyState_Trail_h_3522293485(TEXT("/Script/Engine"),
