...
class UScriptStruct* FDebugCameraControllerSettingsViewModeIndex::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DebugCameraControllerSettingsViewModeIndex.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex, Z_Construct_UPackage__Script_Engine(), TEXT("DebugCameraControllerSettingsViewModeIndex"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FDebugCameraControllerSettingsViewModeIndex>()
{
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::NewProp_ViewModeIndex = { "ViewModeIndex", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDebugCameraControllerSettingsViewModeIndex, ViewModeIndex), Z_Construct_UEnum_Engine_EViewModeIndex, METADATA_PARAMS(Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::NewProp_ViewModeIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::NewProp_ViewModeIndex_MetaData)) }; // 1334751312
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UDebugCameraControllerSettings_Statics::NewProp_CycleViewModes_Inner = { "CycleViewModes", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex, METADATA_PARAMS(nullptr, 0) }; // 3193572171
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDebugCameraControllerSettings_Statics::NewProp_CycleViewModes = { "CycleViewModes", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDebugCameraControllerSettings, CycleViewModes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UDebugCameraControllerSettings_Statics::NewProp_CycleViewModes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDebugCameraControllerSettings_Statics::NewProp_CycleViewModes_MetaData)) }; // 3193572171
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DebugCameraControllerSettings_h_Statics::ScriptStructInfo[] = {
		{ FDebugCameraControllerSettingsViewModeIndex::StaticStruct, Z_Construct_UScriptStruct_FDebugCameraControllerSettingsViewModeIndex_Statics::NewStructOps, TEXT("DebugCameraControllerSettingsViewModeIndex"), &Z_Registration_Info_UScriptStruct_DebugCameraControllerSettingsViewModeIndex, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDebugCameraControllerSettingsViewModeIndex), 3193572171U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DebugCameraControllerSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDebugCameraControllerSettings, UDebugCameraControllerSettings::StaticClass, TEXT("UDebugCameraControllerSettings"), &Z_Registration_Info_UClass_UDebugCameraControllerSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDebugCameraControllerSettings), 2271818735U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DebugCameraControllerSettings_h_3901196162(TEXT("/Script/Engine"),
