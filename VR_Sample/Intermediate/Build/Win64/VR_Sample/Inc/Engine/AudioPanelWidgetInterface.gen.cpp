...
#include "Engine/Public/Audio/AudioPanelWidgetInterface.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UFunction_UAudioPanelWidgetInterface_GetEditorName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioPanelWidgetInterface_eventGetEditorName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UAudioPanelWidgetInterface_GetIconBrushName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioPanelWidgetInterface_eventGetIconBrushName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAudioPanelWidgetInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAudioPanelWidgetInterface_GetEditorName, "GetEditorName" }, // 2688326388
		{ &Z_Construct_UFunction_UAudioPanelWidgetInterface_GetIconBrushName, "GetIconBrushName" }, // 2868570956
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Audio_AudioPanelWidgetInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioPanelWidgetInterface, UAudioPanelWidgetInterface::StaticClass, TEXT("UAudioPanelWidgetInterface"), &Z_Registration_Info_UClass_UAudioPanelWidgetInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioPanelWidgetInterface), 1755218139U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Audio_AudioPanelWidgetInterface_h_2519967419(TEXT("/Script/Engine"),
