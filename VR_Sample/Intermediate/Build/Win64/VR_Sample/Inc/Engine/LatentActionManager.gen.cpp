...
class UScriptStruct* FLatentActionInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LatentActionInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLatentActionInfo, Z_Construct_UPackage__Script_Engine(), TEXT("LatentActionInfo"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_Linkage = { "Linkage", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLatentActionInfo, Linkage), METADATA_PARAMS(Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_Linkage_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_Linkage_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_UUID = { "UUID", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLatentActionInfo, UUID), METADATA_PARAMS(Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_UUID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_UUID_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_ExecutionFunction = { "ExecutionFunction", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLatentActionInfo, ExecutionFunction), METADATA_PARAMS(Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_ExecutionFunction_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_ExecutionFunction_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_CallbackTarget = { "CallbackTarget", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FLatentActionInfo, CallbackTarget), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_CallbackTarget_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewProp_CallbackTarget_MetaData)) };
...
class UScriptStruct* FLatentActionManager::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LatentActionManager.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLatentActionManager, Z_Construct_UPackage__Script_Engine(), TEXT("LatentActionManager"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FLatentActionManager>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_LatentActionManager_h_Statics::ScriptStructInfo[] = {
		{ FLatentActionInfo::StaticStruct, Z_Construct_UScriptStruct_FLatentActionInfo_Statics::NewStructOps, TEXT("LatentActionInfo"), &Z_Registration_Info_UScriptStruct_LatentActionInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLatentActionInfo), 4072181092U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_LatentActionManager_h_3213036025(TEXT("/Script/Engine"),
		nullptr, 0,
