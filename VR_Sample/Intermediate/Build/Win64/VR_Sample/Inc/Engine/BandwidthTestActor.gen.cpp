...
class UScriptStruct* FBandwidthTestItem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BandwidthTestItem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBandwidthTestItem, Z_Construct_UPackage__Script_Engine(), TEXT("BandwidthTestItem"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBandwidthTestItem>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FBandwidthTestItem_Statics::NewProp_Kilobyte_Inner = { "Kilobyte", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FBandwidthTestItem_Statics::NewProp_Kilobyte = { "Kilobyte", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBandwidthTestItem, Kilobyte), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FBandwidthTestItem_Statics::NewProp_Kilobyte_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBandwidthTestItem_Statics::NewProp_Kilobyte_MetaData)) };
...
class UScriptStruct* FBandwidthTestGenerator::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BandwidthTestGenerator.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBandwidthTestGenerator, Z_Construct_UPackage__Script_Engine(), TEXT("BandwidthTestGenerator"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBandwidthTestGenerator>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FBandwidthTestGenerator_Statics::NewProp_ReplicatedBuffers_Inner = { "ReplicatedBuffers", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBandwidthTestItem, METADATA_PARAMS(nullptr, 0) }; // 1590321338
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ABandwidthTestActor_Statics::NewProp_BandwidthGenerator = { "BandwidthGenerator", nullptr, (EPropertyFlags)0x0010000000000020, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ABandwidthTestActor, BandwidthGenerator), Z_Construct_UScriptStruct_FBandwidthTestGenerator, METADATA_PARAMS(Z_Construct_UClass_ABandwidthTestActor_Statics::NewProp_BandwidthGenerator_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ABandwidthTestActor_Statics::NewProp_BandwidthGenerator_MetaData)) }; // 1650227219
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Net_BandwidthTestActor_h_Statics::ScriptStructInfo[] = {
		{ FBandwidthTestItem::StaticStruct, Z_Construct_UScriptStruct_FBandwidthTestItem_Statics::NewStructOps, TEXT("BandwidthTestItem"), &Z_Registration_Info_UScriptStruct_BandwidthTestItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBandwidthTestItem), 1590321338U) },
		{ FBandwidthTestGenerator::StaticStruct, Z_Construct_UScriptStruct_FBandwidthTestGenerator_Statics::NewStructOps, TEXT("BandwidthTestGenerator"), &Z_Registration_Info_UScriptStruct_BandwidthTestGenerator, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBandwidthTestGenerator), 1650227219U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Net_BandwidthTestActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ABandwidthTestActor, ABandwidthTestActor::StaticClass, TEXT("ABandwidthTestActor"), &Z_Registration_Info_UClass_ABandwidthTestActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABandwidthTestActor), 135872015U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Net_BandwidthTestActor_h_1180166097(TEXT("/Script/Engine"),
