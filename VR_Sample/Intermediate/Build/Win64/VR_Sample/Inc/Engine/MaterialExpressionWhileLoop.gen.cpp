...
#include "Engine/Classes/Materials/MaterialExpressionWhileLoop.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionWhileLoop_Statics::NewProp_LoopBody = { "LoopBody", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionWhileLoop, LoopBody), Z_Construct_UScriptStruct_FExpressionExecOutput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionWhileLoop_Statics::NewProp_LoopBody_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionWhileLoop_Statics::NewProp_LoopBody_MetaData)) }; // 1743494397
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionWhileLoop_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionWhileLoop, UMaterialExpressionWhileLoop::StaticClass, TEXT("UMaterialExpressionWhileLoop"), &Z_Registration_Info_UClass_UMaterialExpressionWhileLoop, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionWhileLoop), 4034243436U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionWhileLoop_h_2494011901(TEXT("/Script/Engine"),
