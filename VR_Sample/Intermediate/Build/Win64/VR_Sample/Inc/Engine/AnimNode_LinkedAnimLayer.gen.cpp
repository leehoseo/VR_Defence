...
class UScriptStruct* FAnimNode_LinkedAnimLayer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_LinkedAnimLayer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_LinkedAnimLayer, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNode_LinkedAnimLayer"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNode_LinkedAnimLayer>()
{
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FAnimNode_LinkedAnimLayer_Statics::NewProp_Interface = { "Interface", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_LinkedAnimLayer, Interface), Z_Construct_UClass_UAnimLayerInterface_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_LinkedAnimLayer_Statics::NewProp_Interface_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_LinkedAnimLayer_Statics::NewProp_Interface_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimNode_LinkedAnimLayer_Statics::NewProp_Layer = { "Layer", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNode_LinkedAnimLayer, Layer), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNode_LinkedAnimLayer_Statics::NewProp_Layer_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_LinkedAnimLayer_Statics::NewProp_Layer_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_LinkedAnimLayer_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_LinkedAnimLayer::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_LinkedAnimLayer_Statics::NewStructOps, TEXT("AnimNode_LinkedAnimLayer"), &Z_Registration_Info_UScriptStruct_AnimNode_LinkedAnimLayer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_LinkedAnimLayer), 2806449518U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNode_LinkedAnimLayer_h_3916309268(TEXT("/Script/Engine"),
		nullptr, 0,
