...
#include "Engine/Public/ISMPartition/ISMPartitionInstanceManager.h"
...
class UScriptStruct* FISMClientInstanceManagerData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ISMClientInstanceManagerData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FISMClientInstanceManagerData, Z_Construct_UPackage__Script_Engine(), TEXT("ISMClientInstanceManagerData"));
	}
