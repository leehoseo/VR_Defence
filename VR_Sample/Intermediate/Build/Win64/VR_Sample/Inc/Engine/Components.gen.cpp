...
class UScriptStruct* FMeshUVChannelInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MeshUVChannelInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMeshUVChannelInfo, Z_Construct_UPackage__Script_Engine(), TEXT("MeshUVChannelInfo"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FMeshUVChannelInfo>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMeshUVChannelInfo_Statics::NewProp_bInitialized = { "bInitialized", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMeshUVChannelInfo), &Z_Construct_UScriptStruct_FMeshUVChannelInfo_Statics::NewProp_bInitialized_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMeshUVChannelInfo_Statics::NewProp_bInitialized_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMeshUVChannelInfo_Statics::NewProp_bInitialized_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FMeshUVChannelInfo_Statics::NewProp_bOverrideDensities = { "bOverrideDensities", nullptr, (EPropertyFlags)0x0010040000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FMeshUVChannelInfo), &Z_Construct_UScriptStruct_FMeshUVChannelInfo_Statics::NewProp_bOverrideDensities_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FMeshUVChannelInfo_Statics::NewProp_bOverrideDensities_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMeshUVChannelInfo_Statics::NewProp_bOverrideDensities_MetaData)) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Components_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Components_h_Statics::ScriptStructInfo[] = {
		{ FMeshUVChannelInfo::StaticStruct, Z_Construct_UScriptStruct_FMeshUVChannelInfo_Statics::NewStructOps, TEXT("MeshUVChannelInfo"), &Z_Registration_Info_UScriptStruct_MeshUVChannelInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMeshUVChannelInfo), 1724361571U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Components_h_994580983(TEXT("/Script/Engine"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Components_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Components_h_Statics::ScriptStructInfo),
		nullptr, 0);
