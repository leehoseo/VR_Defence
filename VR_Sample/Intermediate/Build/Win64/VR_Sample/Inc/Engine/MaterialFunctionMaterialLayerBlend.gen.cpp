...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialFunctionMaterialLayerBlend_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialFunctionMaterialLayerBlend, UMaterialFunctionMaterialLayerBlend::StaticClass, TEXT("UMaterialFunctionMaterialLayerBlend"), &Z_Registration_Info_UClass_UMaterialFunctionMaterialLayerBlend, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialFunctionMaterialLayerBlend), 1059769497U) },
		{ Z_Construct_UClass_UMaterialFunctionMaterialLayerBlendInstance, UMaterialFunctionMaterialLayerBlendInstance::StaticClass, TEXT("UMaterialFunctionMaterialLayerBlendInstance"), &Z_Registration_Info_UClass_UMaterialFunctionMaterialLayerBlendInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialFunctionMaterialLayerBlendInstance), 2720858438U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialFunctionMaterialLayerBlend_h_4266738080(TEXT("/Script/Engine"),
