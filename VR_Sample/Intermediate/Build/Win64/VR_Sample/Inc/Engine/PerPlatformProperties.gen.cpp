...
class UScriptStruct* FPerPlatformInt::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PerPlatformInt.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPerPlatformInt, Z_Construct_UPackage__Script_Engine(), TEXT("PerPlatformInt"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPerPlatformInt_Statics::NewProp_Default = { "Default", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPerPlatformInt, Default), METADATA_PARAMS(Z_Construct_UScriptStruct_FPerPlatformInt_Statics::NewProp_Default_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerPlatformInt_Statics::NewProp_Default_MetaData)) };
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FPerPlatformInt_Statics::NewProp_PerPlatform_ValueProp = { "PerPlatform", nullptr, (EPropertyFlags)0x0000000800000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPerPlatformInt_Statics::NewProp_PerPlatform_Key_KeyProp = { "PerPlatform_Key", nullptr, (EPropertyFlags)0x0000000800000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
class UScriptStruct* FFreezablePerPlatformInt::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FreezablePerPlatformInt.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFreezablePerPlatformInt, Z_Construct_UPackage__Script_Engine(), TEXT("FreezablePerPlatformInt"));
	}
...
class UScriptStruct* FPerPlatformFloat::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PerPlatformFloat.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPerPlatformFloat, Z_Construct_UPackage__Script_Engine(), TEXT("PerPlatformFloat"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPerPlatformFloat_Statics::NewProp_Default = { "Default", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPerPlatformFloat, Default), METADATA_PARAMS(Z_Construct_UScriptStruct_FPerPlatformFloat_Statics::NewProp_Default_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerPlatformFloat_Statics::NewProp_Default_MetaData)) };
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FPerPlatformFloat_Statics::NewProp_PerPlatform_ValueProp = { "PerPlatform", nullptr, (EPropertyFlags)0x0000000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPerPlatformFloat_Statics::NewProp_PerPlatform_Key_KeyProp = { "PerPlatform_Key", nullptr, (EPropertyFlags)0x0000000800000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMapPropertyParams Z_Construct_UScriptStruct_FPerPlatformFloat_Statics::NewProp_PerPlatform = { "PerPlatform", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPerPlatformFloat, PerPlatform), EMapPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPerPlatformFloat_Statics::NewProp_PerPlatform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerPlatformFloat_Statics::NewProp_PerPlatform_MetaData)) };
#endif // WITH_EDITORONLY_DATA
...
class UScriptStruct* FPerPlatformBool::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PerPlatformBool.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPerPlatformBool, Z_Construct_UPackage__Script_Engine(), TEXT("PerPlatformBool"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPerPlatformBool>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPerPlatformBool_Statics::NewProp_Default = { "Default", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FPerPlatformBool), &Z_Construct_UScriptStruct_FPerPlatformBool_Statics::NewProp_Default_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FPerPlatformBool_Statics::NewProp_Default_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPerPlatformBool_Statics::NewProp_Default_MetaData)) };
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FPerPlatformBool_Statics::NewProp_PerPlatform_ValueProp = { "PerPlatform", nullptr, (EPropertyFlags)0x0000000800000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPerPlatformBool_Statics::NewProp_PerPlatform_Key_KeyProp = { "PerPlatform_Key", nullptr, (EPropertyFlags)0x0000000800000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_PerPlatformProperties_h_Statics::ScriptStructInfo[] = {
		{ FPerPlatformInt::StaticStruct, Z_Construct_UScriptStruct_FPerPlatformInt_Statics::NewStructOps, TEXT("PerPlatformInt"), &Z_Registration_Info_UScriptStruct_PerPlatformInt, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPerPlatformInt), 2532678630U) },
		...
		{ FPerPlatformFloat::StaticStruct, Z_Construct_UScriptStruct_FPerPlatformFloat_Statics::NewStructOps, TEXT("PerPlatformFloat"), &Z_Registration_Info_UScriptStruct_PerPlatformFloat, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPerPlatformFloat), 1815855046U) },
		{ FPerPlatformBool::StaticStruct, Z_Construct_UScriptStruct_FPerPlatformBool_Statics::NewStructOps, TEXT("PerPlatformBool"), &Z_Registration_Info_UScriptStruct_PerPlatformBool, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPerPlatformBool), 2849240639U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_PerPlatformProperties_h_4156418(TEXT("/Script/Engine"),
		nullptr, 0,
