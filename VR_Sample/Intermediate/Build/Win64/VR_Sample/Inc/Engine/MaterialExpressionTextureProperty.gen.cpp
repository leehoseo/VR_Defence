...
// End Cross Module References
	...
	static UEnum* EMaterialExposedTextureProperty_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMaterialExposedTextureProperty.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EMaterialExposedTextureProperty, Z_Construct_UPackage__Script_Engine(), TEXT("EMaterialExposedTextureProperty"));
		}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionTextureProperty_Statics::NewProp_TextureObject = { "TextureObject", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionTextureProperty, TextureObject), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionTextureProperty_Statics::NewProp_TextureObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionTextureProperty_Statics::NewProp_TextureObject_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionTextureProperty_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionTextureProperty, UMaterialExpressionTextureProperty::StaticClass, TEXT("UMaterialExpressionTextureProperty"), &Z_Registration_Info_UClass_UMaterialExpressionTextureProperty, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionTextureProperty), 1797664785U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionTextureProperty_h_1209378038(TEXT("/Script/Engine"),
