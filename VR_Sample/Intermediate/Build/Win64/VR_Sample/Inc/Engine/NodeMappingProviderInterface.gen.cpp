...
class UScriptStruct* FNodeItem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NodeItem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNodeItem, Z_Construct_UPackage__Script_Engine(), TEXT("NodeItem"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FNodeItem>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_ParentName = { "ParentName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNodeItem, ParentName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_ParentName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_ParentName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNodeItem, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNodeItem_Statics::NewProp_Transform_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_NodeMappingProviderInterface_h_Statics::ScriptStructInfo[] = {
		{ FNodeItem::StaticStruct, Z_Construct_UScriptStruct_FNodeItem_Statics::NewStructOps, TEXT("NodeItem"), &Z_Registration_Info_UScriptStruct_NodeItem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNodeItem), 2295013684U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_NodeMappingProviderInterface_h_3764094144(TEXT("/Script/Engine"),
