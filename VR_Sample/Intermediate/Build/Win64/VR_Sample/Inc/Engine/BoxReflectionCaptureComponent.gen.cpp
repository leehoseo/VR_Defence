...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_BoxTransitionDistance = { "BoxTransitionDistance", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBoxReflectionCaptureComponent, BoxTransitionDistance), METADATA_PARAMS(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_BoxTransitionDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_BoxTransitionDistance_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewInfluenceBox = { "PreviewInfluenceBox", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBoxReflectionCaptureComponent, PreviewInfluenceBox), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewInfluenceBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewInfluenceBox_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewCaptureBox = { "PreviewCaptureBox", nullptr, (EPropertyFlags)0x0014000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBoxReflectionCaptureComponent, PreviewCaptureBox), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewCaptureBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBoxReflectionCaptureComponent_Statics::NewProp_PreviewCaptureBox_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_BoxReflectionCaptureComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBoxReflectionCaptureComponent, UBoxReflectionCaptureComponent::StaticClass, TEXT("UBoxReflectionCaptureComponent"), &Z_Registration_Info_UClass_UBoxReflectionCaptureComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBoxReflectionCaptureComponent), 2537478739U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Components_BoxReflectionCaptureComponent_h_3931076031(TEXT("/Script/Engine"),
