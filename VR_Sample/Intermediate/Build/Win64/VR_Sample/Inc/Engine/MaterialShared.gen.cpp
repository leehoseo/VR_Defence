...
// End Cross Module References
	...
	static UEnum* EMaterialDomain_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMaterialDomain.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EMaterialDomain, Z_Construct_UPackage__Script_Engine(), TEXT("EMaterialDomain"));
		}
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialShared_h_Statics::EnumInfo[] = {
		{ EMaterialDomain_StaticEnum, TEXT("EMaterialDomain"), &Z_Registration_Info_UEnum_EMaterialDomain, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1832179819U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_MaterialShared_h_1214022862(TEXT("/Script/Engine"),
		nullptr, 0,
		nullptr, 0,
