...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ULocalPlayer_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n *\x09""Each player that is active on the current client has a LocalPlayer. It stays active across maps\n *\x09There may be several spawned in the case of splitscreen/coop.\n *\x09There may be 0 spawned on servers.\n */" },
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_ULocalPlayer_Statics::NewProp_PendingLevelPlayerControllerClass = { "PendingLevelPlayerControllerClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULocalPlayer, PendingLevelPlayerControllerClass), Z_Construct_UClass_APlayerController_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_PendingLevelPlayerControllerClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_PendingLevelPlayerControllerClass_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULocalPlayer_Statics::NewProp_bSentSplitJoin = { "bSentSplitJoin", nullptr, (EPropertyFlags)0x0010000000022001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(ULocalPlayer), &Z_Construct_UClass_ULocalPlayer_Statics::NewProp_bSentSplitJoin_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_bSentSplitJoin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULocalPlayer_Statics::NewProp_bSentSplitJoin_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_LocalPlayer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULocalPlayer, ULocalPlayer::StaticClass, TEXT("ULocalPlayer"), &Z_Registration_Info_UClass_ULocalPlayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULocalPlayer), 1503794429U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_LocalPlayer_h_1077288363(TEXT("/Script/Engine"),
