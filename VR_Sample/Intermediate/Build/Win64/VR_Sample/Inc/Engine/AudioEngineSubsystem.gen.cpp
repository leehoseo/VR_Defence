...
#include "Engine/Public/Subsystems/AudioEngineSubsystem.h"
...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Subsystems_AudioEngineSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioSubsystemCollectionRoot, UAudioSubsystemCollectionRoot::StaticClass, TEXT("UAudioSubsystemCollectionRoot"), &Z_Registration_Info_UClass_UAudioSubsystemCollectionRoot, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioSubsystemCollectionRoot), 623858741U) },
		{ Z_Construct_UClass_UAudioEngineSubsystem, UAudioEngineSubsystem::StaticClass, TEXT("UAudioEngineSubsystem"), &Z_Registration_Info_UClass_UAudioEngineSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioEngineSubsystem), 1864616711U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Subsystems_AudioEngineSubsystem_h_2153937339(TEXT("/Script/Engine"),
