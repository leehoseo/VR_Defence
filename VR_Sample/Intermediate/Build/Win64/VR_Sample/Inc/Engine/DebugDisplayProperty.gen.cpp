...
class UScriptStruct* FDebugDisplayProperty::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_DebugDisplayProperty.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDebugDisplayProperty, Z_Construct_UPackage__Script_Engine(), TEXT("DebugDisplayProperty"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FDebugDisplayProperty>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FDebugDisplayProperty_Statics::NewProp_Obj = { "Obj", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDebugDisplayProperty, Obj), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FDebugDisplayProperty_Statics::NewProp_Obj_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDebugDisplayProperty_Statics::NewProp_Obj_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FDebugDisplayProperty_Statics::NewProp_WithinClass = { "WithinClass", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FDebugDisplayProperty, WithinClass), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FDebugDisplayProperty_Statics::NewProp_WithinClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FDebugDisplayProperty_Statics::NewProp_WithinClass_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DebugDisplayProperty_h_Statics::ScriptStructInfo[] = {
		{ FDebugDisplayProperty::StaticStruct, Z_Construct_UScriptStruct_FDebugDisplayProperty_Statics::NewStructOps, TEXT("DebugDisplayProperty"), &Z_Registration_Info_UScriptStruct_DebugDisplayProperty, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDebugDisplayProperty), 3351974886U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_DebugDisplayProperty_h_2908539468(TEXT("/Script/Engine"),
		nullptr, 0,
