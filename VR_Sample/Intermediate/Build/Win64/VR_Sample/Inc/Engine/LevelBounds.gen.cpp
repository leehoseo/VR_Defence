...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ALevelBounds_Statics::NewProp_BoxComponent = { "BoxComponent", nullptr, (EPropertyFlags)0x0014000000080009, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ALevelBounds, BoxComponent), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ALevelBounds_Statics::NewProp_BoxComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALevelBounds_Statics::NewProp_BoxComponent_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ALevelBounds_Statics::NewProp_bAutoUpdateBounds = { "bAutoUpdateBounds", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ALevelBounds), &Z_Construct_UClass_ALevelBounds_Statics::NewProp_bAutoUpdateBounds_SetBit, METADATA_PARAMS(Z_Construct_UClass_ALevelBounds_Statics::NewProp_bAutoUpdateBounds_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALevelBounds_Statics::NewProp_bAutoUpdateBounds_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_LevelBounds_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALevelBounds, ALevelBounds::StaticClass, TEXT("ALevelBounds"), &Z_Registration_Info_UClass_ALevelBounds, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALevelBounds), 2673087419U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_LevelBounds_h_3431234540(TEXT("/Script/Engine"),
