...
// End Cross Module References
	...
	static UEnum* AnimationKeyFormat_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_AnimationKeyFormat.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_AnimationKeyFormat, Z_Construct_UPackage__Script_Engine(), TEXT("AnimationKeyFormat"));
		}
...
class UScriptStruct* FAnimationErrorStats::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimationErrorStats.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimationErrorStats, Z_Construct_UPackage__Script_Engine(), TEXT("AnimationErrorStats"));
	}
