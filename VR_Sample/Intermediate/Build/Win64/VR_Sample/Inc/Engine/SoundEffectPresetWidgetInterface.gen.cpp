...
#include "Engine/Public/Audio/SoundEffectPresetWidgetInterface.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_USoundEffectPresetWidgetInterface_GetClass_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0014000000000580, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundEffectPresetWidgetInterface_eventGetClass_Parms, ReturnValue), Z_Construct_UClass_USoundEffectPreset_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USoundEffectPresetWidgetInterface_OnConstructed_Statics::NewProp_Preset = { "Preset", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundEffectPresetWidgetInterface_eventOnConstructed_Parms, Preset), Z_Construct_UClass_USoundEffectPreset_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_USoundEffectPresetWidgetInterface_OnPropertyChanged_Statics::NewProp_Preset = { "Preset", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundEffectPresetWidgetInterface_eventOnPropertyChanged_Parms, Preset), Z_Construct_UClass_USoundEffectPreset_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_USoundEffectPresetWidgetInterface_OnPropertyChanged_Statics::NewProp_PropertyName = { "PropertyName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SoundEffectPresetWidgetInterface_eventOnPropertyChanged_Parms, PropertyName), METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_USoundEffectPresetWidgetInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_USoundEffectPresetWidgetInterface_GetClass, "GetClass" }, // 1028681168
		{ &Z_Construct_UFunction_USoundEffectPresetWidgetInterface_OnConstructed, "OnConstructed" }, // 3127358531
		{ &Z_Construct_UFunction_USoundEffectPresetWidgetInterface_OnPropertyChanged, "OnPropertyChanged" }, // 676896395
	};
#if WITH_METADATA
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Audio_SoundEffectPresetWidgetInterface_h_496764845(TEXT("/Script/Engine"),
