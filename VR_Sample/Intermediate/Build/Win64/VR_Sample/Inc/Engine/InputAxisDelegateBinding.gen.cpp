...
template<> ENGINE_API UScriptStruct* StaticStruct<FBlueprintInputAxisDelegateBinding>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UInputAxisDelegateBinding_Statics::NewProp_InputAxisDelegateBindings_Inner = { "InputAxisDelegateBindings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FBlueprintInputAxisDelegateBinding, METADATA_PARAMS(nullptr, 0) }; // 659544207
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InputAxisDelegateBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInputAxisDelegateBinding, UInputAxisDelegateBinding::StaticClass, TEXT("UInputAxisDelegateBinding"), &Z_Registration_Info_UClass_UInputAxisDelegateBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputAxisDelegateBinding), 3112302942U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InputAxisDelegateBinding_h_1413818242(TEXT("/Script/Engine"),
