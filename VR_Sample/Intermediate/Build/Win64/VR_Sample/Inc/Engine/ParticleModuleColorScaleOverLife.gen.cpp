...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_ColorScaleOverLife = { "ColorScaleOverLife", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleColorScaleOverLife, ColorScaleOverLife), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_ColorScaleOverLife_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_ColorScaleOverLife_MetaData)) }; // 3599899551
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_AlphaScaleOverLife = { "AlphaScaleOverLife", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleColorScaleOverLife, AlphaScaleOverLife), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_AlphaScaleOverLife_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_AlphaScaleOverLife_MetaData)) }; // 3468229032
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_bEmitterTime = { "bEmitterTime", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleColorScaleOverLife), &Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_bEmitterTime_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_bEmitterTime_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleColorScaleOverLife_Statics::NewProp_bEmitterTime_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Color_ParticleModuleColorScaleOverLife_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleColorScaleOverLife, UParticleModuleColorScaleOverLife::StaticClass, TEXT("UParticleModuleColorScaleOverLife"), &Z_Registration_Info_UClass_UParticleModuleColorScaleOverLife, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleColorScaleOverLife), 3719660004U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Color_ParticleModuleColorScaleOverLife_h_4051534477(TEXT("/Script/Engine"),
