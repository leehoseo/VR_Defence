...
class UScriptStruct* FNode::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Node.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNode, Z_Construct_UPackage__Script_Engine(), TEXT("Node"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FNode>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNode_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNode, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FNode_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNode_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNode_Statics::NewProp_ParentName = { "ParentName", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNode, ParentName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNode_Statics::NewProp_ParentName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNode_Statics::NewProp_ParentName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNode_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNode, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FNode_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNode_Statics::NewProp_Transform_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FNode_Statics::NewProp_bAdvanced = { "bAdvanced", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FNode), &Z_Construct_UScriptStruct_FNode_Statics::NewProp_bAdvanced_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FNode_Statics::NewProp_bAdvanced_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNode_Statics::NewProp_bAdvanced_MetaData)) };
	...
	static UEnum* EControlConstraint_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EControlConstraint.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EControlConstraint, Z_Construct_UPackage__Script_Engine(), TEXT("EControlConstraint"));
		}
	...
	static UEnum* EConstraintTransform_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EConstraintTransform.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EConstraintTransform, Z_Construct_UPackage__Script_Engine(), TEXT("EConstraintTransform"));
		}
...
class UScriptStruct* FRigTransformConstraint::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_RigTransformConstraint.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FRigTransformConstraint, Z_Construct_UPackage__Script_Engine(), TEXT("RigTransformConstraint"));
	}
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FRigTransformConstraint_Statics::NewProp_TranformType = { "TranformType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigTransformConstraint, TranformType), Z_Construct_UEnum_Engine_EConstraintTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FRigTransformConstraint_Statics::NewProp_TranformType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigTransformConstraint_Statics::NewProp_TranformType_MetaData)) }; // 3911294752
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FRigTransformConstraint_Statics::NewProp_Weight = { "Weight", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FRigTransformConstraint, Weight), METADATA_PARAMS(Z_Construct_UScriptStruct_FRigTransformConstraint_Statics::NewProp_Weight_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FRigTransformConstraint_Statics::NewProp_Weight_MetaData)) };
...
class UScriptStruct* FTransformBaseConstraint::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TransformBaseConstraint.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTransformBaseConstraint, Z_Construct_UPackage__Script_Engine(), TEXT("TransformBaseConstraint"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FTransformBaseConstraint>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTransformBaseConstraint_Statics::NewProp_TransformConstraints_Inner = { "TransformConstraints", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FRigTransformConstraint, METADATA_PARAMS(nullptr, 0) }; // 348428506
#if WITH_METADATA
...
class UScriptStruct* FTransformBase::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TransformBase.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTransformBase, Z_Construct_UPackage__Script_Engine(), TEXT("TransformBase"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FTransformBase>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URig_Statics::NewProp_TransformBases_Inner = { "TransformBases", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FTransformBase, METADATA_PARAMS(nullptr, 0) }; // 243190397
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_URig_Statics::NewProp_TransformBases = { "TransformBases", nullptr, (EPropertyFlags)0x0040000000000041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(URig, TransformBases), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_URig_Statics::NewProp_TransformBases_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_URig_Statics::NewProp_TransformBases_MetaData)) }; // 243190397
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_URig_Statics::NewProp_Nodes_Inner = { "Nodes", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNode, METADATA_PARAMS(nullptr, 0) }; // 2051394337
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_Rig_h_Statics::ScriptStructInfo[] = {
		{ FNode::StaticStruct, Z_Construct_UScriptStruct_FNode_Statics::NewStructOps, TEXT("Node"), &Z_Registration_Info_UScriptStruct_Node, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNode), 2051394337U) },
		{ FRigTransformConstraint::StaticStruct, Z_Construct_UScriptStruct_FRigTransformConstraint_Statics::NewStructOps, TEXT("RigTransformConstraint"), &Z_Registration_Info_UScriptStruct_RigTransformConstraint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FRigTransformConstraint), 348428506U) },
		{ FTransformBaseConstraint::StaticStruct, Z_Construct_UScriptStruct_FTransformBaseConstraint_Statics::NewStructOps, TEXT("TransformBaseConstraint"), &Z_Registration_Info_UScriptStruct_TransformBaseConstraint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTransformBaseConstraint), 1341321860U) },
		{ FTransformBase::StaticStruct, Z_Construct_UScriptStruct_FTransformBase_Statics::NewStructOps, TEXT("TransformBase"), &Z_Registration_Info_UScriptStruct_TransformBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTransformBase), 243190397U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_Rig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_URig, URig::StaticClass, TEXT("URig"), &Z_Registration_Info_UClass_URig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URig), 2852907594U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_Rig_h_1177518705(TEXT("/Script/Engine"),
