...
class UScriptStruct* FCustomPrimitiveData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CustomPrimitiveData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCustomPrimitiveData, Z_Construct_UPackage__Script_Engine(), TEXT("CustomPrimitiveData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FCustomPrimitiveData>()
{
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCustomPrimitiveData_Statics::NewProp_Data_Inner = { "Data", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCustomPrimitiveData_Statics::NewProp_Data = { "Data", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCustomPrimitiveData, Data), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCustomPrimitiveData_Statics::NewProp_Data_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCustomPrimitiveData_Statics::NewProp_Data_MetaData)) };
	...
	static UEnum* EMaterialProperty_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMaterialProperty.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EMaterialProperty, Z_Construct_UPackage__Script_Engine(), TEXT("EMaterialProperty"));
		}
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_SceneTypes_h_Statics::EnumInfo[] = {
		{ EMaterialProperty_StaticEnum, TEXT("EMaterialProperty"), &Z_Registration_Info_UEnum_EMaterialProperty, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3344984107U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_SceneTypes_h_Statics::ScriptStructInfo[] = {
		{ FCustomPrimitiveData::StaticStruct, Z_Construct_UScriptStruct_FCustomPrimitiveData_Statics::NewStructOps, TEXT("CustomPrimitiveData"), &Z_Registration_Info_UScriptStruct_CustomPrimitiveData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCustomPrimitiveData), 3872471425U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_SceneTypes_h_2090473181(TEXT("/Script/Engine"),
		nullptr, 0,
