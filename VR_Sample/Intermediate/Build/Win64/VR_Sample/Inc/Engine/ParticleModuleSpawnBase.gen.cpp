...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bProcessSpawnRate_MetaData[];
#endif
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bProcessBurstList_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UParticleModuleSpawnBase_Statics::Class_MetaDataParams[] = {
		{ "DisplayName", "Spawn" },
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UParticleModuleSpawnBase_Statics::NewProp_bProcessSpawnRate_MetaData[] = {
		{ "Category", "Spawn" },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Spawn_ParticleModuleSpawnBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleSpawnBase, UParticleModuleSpawnBase::StaticClass, TEXT("UParticleModuleSpawnBase"), &Z_Registration_Info_UClass_UParticleModuleSpawnBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleSpawnBase), 2218056354U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Spawn_ParticleModuleSpawnBase_h_353486780(TEXT("/Script/Engine"),
