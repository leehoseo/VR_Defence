...
// End Cross Module References
	...
	static UEnum* EParticleDetailMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EParticleDetailMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EParticleDetailMode, Z_Construct_UPackage__Script_Engine(), TEXT("EParticleDetailMode"));
		}
	...
	static UEnum* EParticleSignificanceLevel_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EParticleSignificanceLevel.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EParticleSignificanceLevel, Z_Construct_UPackage__Script_Engine(), TEXT("EParticleSignificanceLevel"));
		}
	...
	static UEnum* EParticleSystemInsignificanceReaction_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EParticleSystemInsignificanceReaction.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EParticleSystemInsignificanceReaction, Z_Construct_UPackage__Script_Engine(), TEXT("EParticleSystemInsignificanceReaction"));
		}
