...
class UScriptStruct* FSourceEffectChainEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SourceEffectChainEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSourceEffectChainEntry, Z_Construct_UPackage__Script_Engine(), TEXT("SourceEffectChainEntry"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FSourceEffectChainEntry>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USoundEffectSourcePresetChain_Statics::NewProp_Chain_Inner = { "Chain", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSourceEffectChainEntry, METADATA_PARAMS(nullptr, 0) }; // 2580117266
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundEffectSource_h_Statics::ScriptStructInfo[] = {
		{ FSourceEffectChainEntry::StaticStruct, Z_Construct_UScriptStruct_FSourceEffectChainEntry_Statics::NewStructOps, TEXT("SourceEffectChainEntry"), &Z_Registration_Info_UScriptStruct_SourceEffectChainEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSourceEffectChainEntry), 2580117266U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundEffectSource_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundEffectSourcePreset, USoundEffectSourcePreset::StaticClass, TEXT("USoundEffectSourcePreset"), &Z_Registration_Info_UClass_USoundEffectSourcePreset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundEffectSourcePreset), 3207070779U) },
		{ Z_Construct_UClass_USoundEffectSourcePresetChain, USoundEffectSourcePresetChain::StaticClass, TEXT("USoundEffectSourcePresetChain"), &Z_Registration_Info_UClass_USoundEffectSourcePresetChain, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundEffectSourcePresetChain), 2828190710U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundEffectSource_h_1745544705(TEXT("/Script/Engine"),
