...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_Codecs_Inner = { "Codecs", nullptr, (EPropertyFlags)0x0006000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UAnimBoneCompressionCodec_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_Codecs_Inner_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_Codecs_Inner_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_Codecs = { "Codecs", nullptr, (EPropertyFlags)0x0014008000000009, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimBoneCompressionSettings, Codecs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_Codecs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_Codecs_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_ErrorThreshold = { "ErrorThreshold", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAnimBoneCompressionSettings, ErrorThreshold), METADATA_PARAMS(Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_ErrorThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_ErrorThreshold_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_bForceBelowThreshold = { "bForceBelowThreshold", nullptr, (EPropertyFlags)0x0010000800000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAnimBoneCompressionSettings), &Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_bForceBelowThreshold_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_bForceBelowThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAnimBoneCompressionSettings_Statics::NewProp_bForceBelowThreshold_MetaData)) };
#endif // WITH_EDITORONLY_DATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimBoneCompressionSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimBoneCompressionSettings, UAnimBoneCompressionSettings::StaticClass, TEXT("UAnimBoneCompressionSettings"), &Z_Registration_Info_UClass_UAnimBoneCompressionSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimBoneCompressionSettings), 1065283152U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimBoneCompressionSettings_h_50529784(TEXT("/Script/Engine"),
