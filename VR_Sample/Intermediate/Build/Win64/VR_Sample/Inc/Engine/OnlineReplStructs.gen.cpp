...
class UScriptStruct* FUniqueNetIdRepl::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_UniqueNetIdRepl.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FUniqueNetIdRepl, Z_Construct_UPackage__Script_Engine(), TEXT("UniqueNetIdRepl"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FUniqueNetIdRepl>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FUniqueNetIdRepl_Statics::NewProp_ReplicationBytes = { "ReplicationBytes", nullptr, (EPropertyFlags)0x0020080000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FUniqueNetIdRepl, ReplicationBytes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FUniqueNetIdRepl_Statics::NewProp_ReplicationBytes_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FUniqueNetIdRepl_Statics::NewProp_ReplicationBytes_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_OnlineReplStructs_h_Statics::ScriptStructInfo[] = {
		{ FUniqueNetIdRepl::StaticStruct, Z_Construct_UScriptStruct_FUniqueNetIdRepl_Statics::NewStructOps, TEXT("UniqueNetIdRepl"), &Z_Registration_Info_UScriptStruct_UniqueNetIdRepl, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FUniqueNetIdRepl), 3508419189U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_OnlineReplStructs_h_3115414019(TEXT("/Script/Engine"),
		nullptr, 0,
