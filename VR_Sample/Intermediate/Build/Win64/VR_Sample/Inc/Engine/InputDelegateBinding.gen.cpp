...
class UScriptStruct* FBlueprintInputDelegateBinding::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BlueprintInputDelegateBinding.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBlueprintInputDelegateBinding, Z_Construct_UPackage__Script_Engine(), TEXT("BlueprintInputDelegateBinding"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBlueprintInputDelegateBinding>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InputDelegateBinding_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInputDelegateBinding, UInputDelegateBinding::StaticClass, TEXT("UInputDelegateBinding"), &Z_Registration_Info_UClass_UInputDelegateBinding, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInputDelegateBinding), 269079692U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InputDelegateBinding_h_1005443169(TEXT("/Script/Engine"),
