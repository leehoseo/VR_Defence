...
#include "Engine/Private/LevelInstance/LevelInstanceEditorObject.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ULevelInstanceEditorObject_Statics::NewProp_bMovedActors = { "bMovedActors", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ULevelInstanceEditorObject), &Z_Construct_UClass_ULevelInstanceEditorObject_Statics::NewProp_bMovedActors_SetBit, METADATA_PARAMS(Z_Construct_UClass_ULevelInstanceEditorObject_Statics::NewProp_bMovedActors_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelInstanceEditorObject_Statics::NewProp_bMovedActors_MetaData)) };
	const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_ULevelInstanceEditorObject_Statics::NewProp_OtherPackagesToSave_Inner = { "OtherPackagesToSave", nullptr, (EPropertyFlags)0x0004000800000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UClass_UPackage, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULevelInstanceEditorObject_Statics::NewProp_OtherPackagesToSave = { "OtherPackagesToSave", nullptr, (EPropertyFlags)0x0014000800000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ULevelInstanceEditorObject, OtherPackagesToSave), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULevelInstanceEditorObject_Statics::NewProp_OtherPackagesToSave_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULevelInstanceEditorObject_Statics::NewProp_OtherPackagesToSave_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Private_LevelInstance_LevelInstanceEditorObject_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULevelInstanceEditorObject, ULevelInstanceEditorObject::StaticClass, TEXT("ULevelInstanceEditorObject"), &Z_Registration_Info_UClass_ULevelInstanceEditorObject, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULevelInstanceEditorObject), 1474860040U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Private_LevelInstance_LevelInstanceEditorObject_h_4174821746(TEXT("/Script/Engine"),
