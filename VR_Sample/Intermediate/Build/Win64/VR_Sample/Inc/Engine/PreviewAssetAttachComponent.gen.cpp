...
class UScriptStruct* FPreviewAttachedObjectPair::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PreviewAttachedObjectPair.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPreviewAttachedObjectPair, Z_Construct_UPackage__Script_Engine(), TEXT("PreviewAttachedObjectPair"));
	}
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FPreviewAttachedObjectPair_Statics::NewProp_Object = { "Object", nullptr, (EPropertyFlags)0x0044000020000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPreviewAttachedObjectPair, Object_DEPRECATED), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FPreviewAttachedObjectPair_Statics::NewProp_Object_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPreviewAttachedObjectPair_Statics::NewProp_Object_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FPreviewAttachedObjectPair_Statics::NewProp_AttachedTo = { "AttachedTo", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPreviewAttachedObjectPair, AttachedTo), METADATA_PARAMS(Z_Construct_UScriptStruct_FPreviewAttachedObjectPair_Statics::NewProp_AttachedTo_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPreviewAttachedObjectPair_Statics::NewProp_AttachedTo_MetaData)) };
...
class UScriptStruct* FPreviewAssetAttachContainer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PreviewAssetAttachContainer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPreviewAssetAttachContainer, Z_Construct_UPackage__Script_Engine(), TEXT("PreviewAssetAttachContainer"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPreviewAssetAttachContainer>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPreviewAssetAttachContainer_Statics::NewProp_AttachedObjects_Inner = { "AttachedObjects", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPreviewAttachedObjectPair, METADATA_PARAMS(nullptr, 0) }; // 4279591619
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FPreviewAssetAttachContainer_Statics::NewProp_AttachedObjects = { "AttachedObjects", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPreviewAssetAttachContainer, AttachedObjects), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FPreviewAssetAttachContainer_Statics::NewProp_AttachedObjects_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPreviewAssetAttachContainer_Statics::NewProp_AttachedObjects_MetaData)) }; // 4279591619
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_PreviewAssetAttachComponent_h_Statics::ScriptStructInfo[] = {
		{ FPreviewAttachedObjectPair::StaticStruct, Z_Construct_UScriptStruct_FPreviewAttachedObjectPair_Statics::NewStructOps, TEXT("PreviewAttachedObjectPair"), &Z_Registration_Info_UScriptStruct_PreviewAttachedObjectPair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPreviewAttachedObjectPair), 4279591619U) },
		{ FPreviewAssetAttachContainer::StaticStruct, Z_Construct_UScriptStruct_FPreviewAssetAttachContainer_Statics::NewStructOps, TEXT("PreviewAssetAttachContainer"), &Z_Registration_Info_UScriptStruct_PreviewAssetAttachContainer, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPreviewAssetAttachContainer), 22110311U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_PreviewAssetAttachComponent_h_3571657273(TEXT("/Script/Engine"),
		nullptr, 0,
