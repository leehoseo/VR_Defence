...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleColorOverLife_Statics::NewProp_ColorOverLife = { "ColorOverLife", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleColorOverLife, ColorOverLife), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleColorOverLife_Statics::NewProp_ColorOverLife_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleColorOverLife_Statics::NewProp_ColorOverLife_MetaData)) }; // 3599899551
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleColorOverLife_Statics::NewProp_AlphaOverLife = { "AlphaOverLife", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleColorOverLife, AlphaOverLife), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleColorOverLife_Statics::NewProp_AlphaOverLife_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleColorOverLife_Statics::NewProp_AlphaOverLife_MetaData)) }; // 3468229032
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleColorOverLife_Statics::NewProp_bClampAlpha = { "bClampAlpha", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleColorOverLife), &Z_Construct_UClass_UParticleModuleColorOverLife_Statics::NewProp_bClampAlpha_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleColorOverLife_Statics::NewProp_bClampAlpha_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleColorOverLife_Statics::NewProp_bClampAlpha_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Color_ParticleModuleColorOverLife_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleColorOverLife, UParticleModuleColorOverLife::StaticClass, TEXT("UParticleModuleColorOverLife"), &Z_Registration_Info_UClass_UParticleModuleColorOverLife, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleColorOverLife), 3957548567U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Color_ParticleModuleColorOverLife_h_2271985851(TEXT("/Script/Engine"),
