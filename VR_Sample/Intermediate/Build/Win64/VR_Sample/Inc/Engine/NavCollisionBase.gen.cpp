...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bIsDynamicObstacle_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNavCollisionBase_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNavCollisionBase_Statics::NewProp_bIsDynamicObstacle_MetaData[] = {
		{ "Category", "Navigation" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNavCollisionBase_Statics::NewProp_bIsDynamicObstacle = { "bIsDynamicObstacle", nullptr, (EPropertyFlags)0x0020080000004001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UNavCollisionBase), &Z_Construct_UClass_UNavCollisionBase_Statics::NewProp_bIsDynamicObstacle_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNavCollisionBase_Statics::NewProp_bIsDynamicObstacle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNavCollisionBase_Statics::NewProp_bIsDynamicObstacle_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UNavCollisionBase_Statics::ClassParams = {
		...
		0,
		0x001000A5u,
		METADATA_PARAMS(Z_Construct_UClass_UNavCollisionBase_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UNavCollisionBase_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_AI_Navigation_NavCollisionBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNavCollisionBase, UNavCollisionBase::StaticClass, TEXT("UNavCollisionBase"), &Z_Registration_Info_UClass_UNavCollisionBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNavCollisionBase), 2716362383U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_AI_Navigation_NavCollisionBase_h_4084977868(TEXT("/Script/Engine"),
