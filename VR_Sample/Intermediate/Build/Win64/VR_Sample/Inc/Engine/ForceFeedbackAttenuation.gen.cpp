...
class UScriptStruct* FForceFeedbackAttenuationSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ForceFeedbackAttenuationSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FForceFeedbackAttenuationSettings, Z_Construct_UPackage__Script_Engine(), TEXT("ForceFeedbackAttenuationSettings"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FForceFeedbackAttenuationSettings>()
{
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_ForceFeedbackAttenuation_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UForceFeedbackAttenuation, UForceFeedbackAttenuation::StaticClass, TEXT("UForceFeedbackAttenuation"), &Z_Registration_Info_UClass_UForceFeedbackAttenuation, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UForceFeedbackAttenuation), 1456615820U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_GameFramework_ForceFeedbackAttenuation_h_2216597736(TEXT("/Script/Engine"),
