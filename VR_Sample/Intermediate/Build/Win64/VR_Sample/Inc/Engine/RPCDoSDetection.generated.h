...
#define FID_Engine_Source_Runtime_Engine_Public_Net_RPCDoSDetection_h_158_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FRPCDoSState_Statics; \
	ENGINE_API static class UScriptStruct* StaticStruct();


template<> ENGINE_API UScriptStruct* StaticStruct<struct FRPCDoSState>();

#define FID_Engine_Source_Runtime_Engine_Public_Net_RPCDoSDetection_h_285_GENERATED_BODY \
	friend struct Z_Construct_UScriptStruct_FRPCDoSStateConfig_Statics; \
	ENGINE_API static class UScriptStruct* StaticStruct(); \
	typedef FRPCDoSState Super;


template<> ENGINE_API UScriptStruct* StaticStruct<struct FRPCDoSStateConfig>();
