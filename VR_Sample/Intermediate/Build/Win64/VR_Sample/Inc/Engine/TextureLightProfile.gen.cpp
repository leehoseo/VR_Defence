...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UTextureLightProfile_Statics::NewProp_TextureMultiplier = { "TextureMultiplier", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTextureLightProfile, TextureMultiplier), METADATA_PARAMS(Z_Construct_UClass_UTextureLightProfile_Statics::NewProp_TextureMultiplier_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTextureLightProfile_Statics::NewProp_TextureMultiplier_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_TextureLightProfile_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTextureLightProfile, UTextureLightProfile::StaticClass, TEXT("UTextureLightProfile"), &Z_Registration_Info_UClass_UTextureLightProfile, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTextureLightProfile), 3240497161U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_TextureLightProfile_h_3954597998(TEXT("/Script/Engine"),
