...
template<> ENGINE_API UScriptStruct* StaticStruct<struct FAnimNode_ConvertComponentToLocalSpace>();
...
template<> ENGINE_API UScriptStruct* StaticStruct<struct FAnimNode_ConvertLocalToComponentSpace>();
