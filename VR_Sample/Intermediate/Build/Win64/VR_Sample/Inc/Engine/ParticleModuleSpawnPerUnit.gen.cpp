...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleSpawnPerUnit_Statics::NewProp_SpawnPerUnit = { "SpawnPerUnit", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleSpawnPerUnit, SpawnPerUnit), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleSpawnPerUnit_Statics::NewProp_SpawnPerUnit_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleSpawnPerUnit_Statics::NewProp_SpawnPerUnit_MetaData)) }; // 3468229032
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Spawn_ParticleModuleSpawnPerUnit_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleSpawnPerUnit, UParticleModuleSpawnPerUnit::StaticClass, TEXT("UParticleModuleSpawnPerUnit"), &Z_Registration_Info_UClass_UParticleModuleSpawnPerUnit, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleSpawnPerUnit), 3352720653U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Spawn_ParticleModuleSpawnPerUnit_h_1989221951(TEXT("/Script/Engine"),
