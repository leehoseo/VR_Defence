...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ASplineMeshActor_Statics::NewProp_SplineMeshComponent = { "SplineMeshComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASplineMeshActor, SplineMeshComponent), Z_Construct_UClass_USplineMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ASplineMeshActor_Statics::NewProp_SplineMeshComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASplineMeshActor_Statics::NewProp_SplineMeshComponent_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_SplineMeshActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ASplineMeshActor, ASplineMeshActor::StaticClass, TEXT("ASplineMeshActor"), &Z_Registration_Info_UClass_ASplineMeshActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASplineMeshActor), 3314980510U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_SplineMeshActor_h_422135636(TEXT("/Script/Engine"),
