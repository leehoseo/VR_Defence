...
// End Cross Module References
	...
	static UEnum* EAdManagerDelegate_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAdManagerDelegate.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAdManagerDelegate, Z_Construct_UPackage__Script_Engine(), TEXT("EAdManagerDelegate"));
		}
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UInGameAdManager_Statics::NewProp_bShouldPauseWhileAdOpen = { "bShouldPauseWhileAdOpen", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UInGameAdManager), &Z_Construct_UClass_UInGameAdManager_Statics::NewProp_bShouldPauseWhileAdOpen_SetBit, METADATA_PARAMS(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_bShouldPauseWhileAdOpen_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_bShouldPauseWhileAdOpen_MetaData)) };
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClickedBannerDelegates_Inner = { "ClickedBannerDelegates", nullptr, (EPropertyFlags)0x0000000000080000, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UDelegateFunction_Engine_OnUserClickedBanner__DelegateSignature, METADATA_PARAMS(nullptr, 0) }; // 108421686
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClickedBannerDelegates = { "ClickedBannerDelegates", nullptr, (EPropertyFlags)0x0010008000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInGameAdManager, ClickedBannerDelegates), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClickedBannerDelegates_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClickedBannerDelegates_MetaData)) }; // 108421686
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClosedAdDelegates = { "ClosedAdDelegates", nullptr, (EPropertyFlags)0x0010008000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UInGameAdManager, ClosedAdDelegates), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClosedAdDelegates_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UInGameAdManager_Statics::NewProp_ClosedAdDelegates_MetaData)) }; // 4161361598
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InGameAdManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInGameAdManager, UInGameAdManager::StaticClass, TEXT("UInGameAdManager"), &Z_Registration_Info_UClass_UInGameAdManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInGameAdManager), 2375766702U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_InGameAdManager_h_1436354062(TEXT("/Script/Engine"),
