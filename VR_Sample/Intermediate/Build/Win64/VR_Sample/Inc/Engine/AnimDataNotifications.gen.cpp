...
#include "Engine/Classes/Animation/AnimData/AnimDataNotifications.h"
...
// End Cross Module References
	...
	static UEnum* EAnimDataModelNotifyType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAnimDataModelNotifyType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAnimDataModelNotifyType, Z_Construct_UPackage__Script_Engine(), TEXT("EAnimDataModelNotifyType"));
		}
...
class UScriptStruct* FEmptyPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_EmptyPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FEmptyPayload, Z_Construct_UPackage__Script_Engine(), TEXT("EmptyPayload"));
	}
...
class UScriptStruct* FBracketPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BracketPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBracketPayload, Z_Construct_UPackage__Script_Engine(), TEXT("BracketPayload"));
	}
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FBracketPayload_Statics::NewProp_Description = { "Description", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FBracketPayload, Description), METADATA_PARAMS(Z_Construct_UScriptStruct_FBracketPayload_Statics::NewProp_Description_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FBracketPayload_Statics::NewProp_Description_MetaData)) };
...
class UScriptStruct* FAnimationTrackPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimationTrackPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimationTrackPayload, Z_Construct_UPackage__Script_Engine(), TEXT("AnimationTrackPayload"));
	}
...
class UScriptStruct* FAnimationTrackAddedPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimationTrackAddedPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimationTrackAddedPayload, Z_Construct_UPackage__Script_Engine(), TEXT("AnimationTrackAddedPayload"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimationTrackAddedPayload>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAnimationTrackAddedPayload_Statics::NewProp_TrackIndex_MetaData[] = {
		{ "Category", "Payload" },
		{ "Comment", "/** Index of the track (bone) which was added */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimData/AnimDataNotifications.h" },
		{ "ToolTip", "Index of the track (bone) which was added" },
	};
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAnimationTrackAddedPayload_Statics::NewProp_TrackIndex = { "TrackIndex", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimationTrackAddedPayload, TrackIndex), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimationTrackAddedPayload_Statics::NewProp_TrackIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimationTrackAddedPayload_Statics::NewProp_TrackIndex_MetaData)) };
...
class UScriptStruct* FSequenceLengthChangedPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SequenceLengthChangedPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSequenceLengthChangedPayload, Z_Construct_UPackage__Script_Engine(), TEXT("SequenceLengthChangedPayload"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FSequenceLengthChangedPayload>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_PreviousLength_MetaData[] = {
		{ "Category", "Payload" },
		{ "Comment", "/** Previous playable length for the Model */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimData/AnimDataNotifications.h" },
		{ "ToolTip", "Previous playable length for the Model" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_PreviousLength = { "PreviousLength", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceLengthChangedPayload, PreviousLength), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_PreviousLength_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_PreviousLength_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_T0_MetaData[] = {
		{ "Category", "Payload" },
		{ "Comment", "/** Time at which the change in length has been made */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimData/AnimDataNotifications.h" },
		{ "ToolTip", "Time at which the change in length has been made" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_T0 = { "T0", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceLengthChangedPayload, T0), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_T0_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_T0_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_T1_MetaData[] = {
		{ "Category", "Payload" },
		{ "Comment", "/** Length of time which is inserted or removed starting at T0 */" },
		{ "ModuleRelativePath", "Classes/Animation/AnimData/AnimDataNotifications.h" },
		{ "ToolTip", "Length of time which is inserted or removed starting at T0" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_T1 = { "T1", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSequenceLengthChangedPayload, T1), METADATA_PARAMS(Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_T1_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewProp_T1_MetaData)) };
...
class UScriptStruct* FFrameRateChangedPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FrameRateChangedPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FFrameRateChangedPayload, Z_Construct_UPackage__Script_Engine(), TEXT("FrameRateChangedPayload"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FFrameRateChangedPayload_Statics::NewProp_PreviousFrameRate = { "PreviousFrameRate", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FFrameRateChangedPayload, PreviousFrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(Z_Construct_UScriptStruct_FFrameRateChangedPayload_Statics::NewProp_PreviousFrameRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FFrameRateChangedPayload_Statics::NewProp_PreviousFrameRate_MetaData)) };
...
class UScriptStruct* FCurvePayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CurvePayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCurvePayload, Z_Construct_UPackage__Script_Engine(), TEXT("CurvePayload"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FCurvePayload_Statics::NewProp_Identifier = { "Identifier", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurvePayload, Identifier), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UScriptStruct_FCurvePayload_Statics::NewProp_Identifier_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurvePayload_Statics::NewProp_Identifier_MetaData)) }; // 3166900084
...
class UScriptStruct* FCurveScaledPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CurveScaledPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCurveScaledPayload, Z_Construct_UPackage__Script_Engine(), TEXT("CurveScaledPayload"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCurveScaledPayload_Statics::NewProp_Factor = { "Factor", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurveScaledPayload, Factor), METADATA_PARAMS(Z_Construct_UScriptStruct_FCurveScaledPayload_Statics::NewProp_Factor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveScaledPayload_Statics::NewProp_Factor_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCurveScaledPayload_Statics::NewProp_Origin = { "Origin", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurveScaledPayload, Origin), METADATA_PARAMS(Z_Construct_UScriptStruct_FCurveScaledPayload_Statics::NewProp_Origin_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveScaledPayload_Statics::NewProp_Origin_MetaData)) };
...
class UScriptStruct* FCurveRenamedPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CurveRenamedPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCurveRenamedPayload, Z_Construct_UPackage__Script_Engine(), TEXT("CurveRenamedPayload"));
	}
...
class UScriptStruct* FCurveFlagsChangedPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CurveFlagsChangedPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCurveFlagsChangedPayload, Z_Construct_UPackage__Script_Engine(), TEXT("CurveFlagsChangedPayload"));
	}
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FCurveFlagsChangedPayload_Statics::NewProp_OldFlags = { "OldFlags", nullptr, (EPropertyFlags)0x0010000000000014, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCurveFlagsChangedPayload, OldFlags), METADATA_PARAMS(Z_Construct_UScriptStruct_FCurveFlagsChangedPayload_Statics::NewProp_OldFlags_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCurveFlagsChangedPayload_Statics::NewProp_OldFlags_MetaData)) };
...
class UScriptStruct* FAttributePayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AttributePayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAttributePayload, Z_Construct_UPackage__Script_Engine(), TEXT("AttributePayload"));
	}
...
class UScriptStruct* FAnimDataModelNotifPayload::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimDataModelNotifPayload.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimDataModelNotifPayload, Z_Construct_UPackage__Script_Engine(), TEXT("AnimDataModelNotifPayload"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimDataModelNotifPayload>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_CopyPayload_Statics::NewProp_Payload = { "Payload", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataModelNotifiesExtensions_eventCopyPayload_Parms, Payload), Z_Construct_UScriptStruct_FAnimDataModelNotifPayload, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_CopyPayload_Statics::NewProp_Payload_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_CopyPayload_Statics::NewProp_Payload_MetaData)) }; // 950089453
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_CopyPayload_Statics::NewProp_ExpectedStruct = { "ExpectedStruct", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataModelNotifiesExtensions_eventCopyPayload_Parms, ExpectedStruct), Z_Construct_UClass_UScriptStruct, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_CopyPayload_Statics::NewProp_OutPayload = { "OutPayload", nullptr, (EPropertyFlags)0x0010000008000180, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataModelNotifiesExtensions_eventCopyPayload_Parms, OutPayload), Z_Construct_UScriptStruct_FEmptyPayload, METADATA_PARAMS(nullptr, 0) }; // 1281910360
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_GetPayload_Statics::NewProp_Payload = { "Payload", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataModelNotifiesExtensions_eventGetPayload_Parms, Payload), Z_Construct_UScriptStruct_FAnimDataModelNotifPayload, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_GetPayload_Statics::NewProp_Payload_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_GetPayload_Statics::NewProp_Payload_MetaData)) }; // 950089453
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_GetPayload_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000008000582, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataModelNotifiesExtensions_eventGetPayload_Parms, ReturnValue), Z_Construct_UScriptStruct_FEmptyPayload, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_GetPayload_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_GetPayload_Statics::NewProp_ReturnValue_MetaData)) }; // 1281910360
...
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_CopyPayload, "CopyPayload" }, // 3762525710
#endif //WITH_EDITOR
#if WITH_EDITOR
		{ &Z_Construct_UFunction_UAnimationDataModelNotifiesExtensions_GetPayload, "GetPayload" }, // 2012528473
#endif //WITH_EDITOR
	};
#endif //WITH_EDITOR
#if WITH_METADATA
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UDelegateFunction_Engine_AnimDataModelModifiedDynamicEvent__DelegateSignature_Statics::NewProp_NotifType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UDelegateFunction_Engine_AnimDataModelModifiedDynamicEvent__DelegateSignature_Statics::NewProp_NotifType = { "NotifType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventAnimDataModelModifiedDynamicEvent_Parms, NotifType), Z_Construct_UEnum_Engine_EAnimDataModelNotifyType, METADATA_PARAMS(nullptr, 0) }; // 1014550892
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_Engine_AnimDataModelModifiedDynamicEvent__DelegateSignature_Statics::NewProp_Model = { "Model", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventAnimDataModelModifiedDynamicEvent_Parms, Model), Z_Construct_UClass_UAnimDataModel_NoRegister, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UDelegateFunction_Engine_AnimDataModelModifiedDynamicEvent__DelegateSignature_Statics::NewProp_Payload = { "Payload", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_Engine_eventAnimDataModelModifiedDynamicEvent_Parms, Payload), Z_Construct_UScriptStruct_FAnimDataModelNotifPayload, METADATA_PARAMS(Z_Construct_UDelegateFunction_Engine_AnimDataModelModifiedDynamicEvent__DelegateSignature_Statics::NewProp_Payload_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_Engine_AnimDataModelModifiedDynamicEvent__DelegateSignature_Statics::NewProp_Payload_MetaData)) }; // 950089453
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimData_AnimDataNotifications_h_Statics::ScriptStructInfo[] = {
		...
		{ FBracketPayload::StaticStruct, Z_Construct_UScriptStruct_FBracketPayload_Statics::NewStructOps, TEXT("BracketPayload"), &Z_Registration_Info_UScriptStruct_BracketPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBracketPayload), 564872751U) },
		{ FAnimationTrackPayload::StaticStruct, Z_Construct_UScriptStruct_FAnimationTrackPayload_Statics::NewStructOps, TEXT("AnimationTrackPayload"), &Z_Registration_Info_UScriptStruct_AnimationTrackPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimationTrackPayload), 446829925U) },
		{ FAnimationTrackAddedPayload::StaticStruct, Z_Construct_UScriptStruct_FAnimationTrackAddedPayload_Statics::NewStructOps, TEXT("AnimationTrackAddedPayload"), &Z_Registration_Info_UScriptStruct_AnimationTrackAddedPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimationTrackAddedPayload), 3212334305U) },
		{ FSequenceLengthChangedPayload::StaticStruct, Z_Construct_UScriptStruct_FSequenceLengthChangedPayload_Statics::NewStructOps, TEXT("SequenceLengthChangedPayload"), &Z_Registration_Info_UScriptStruct_SequenceLengthChangedPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSequenceLengthChangedPayload), 2692514945U) },
		{ FFrameRateChangedPayload::StaticStruct, Z_Construct_UScriptStruct_FFrameRateChangedPayload_Statics::NewStructOps, TEXT("FrameRateChangedPayload"), &Z_Registration_Info_UScriptStruct_FrameRateChangedPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFrameRateChangedPayload), 872183708U) },
		{ FCurvePayload::StaticStruct, Z_Construct_UScriptStruct_FCurvePayload_Statics::NewStructOps, TEXT("CurvePayload"), &Z_Registration_Info_UScriptStruct_CurvePayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCurvePayload), 279838753U) },
		{ FCurveScaledPayload::StaticStruct, Z_Construct_UScriptStruct_FCurveScaledPayload_Statics::NewStructOps, TEXT("CurveScaledPayload"), &Z_Registration_Info_UScriptStruct_CurveScaledPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCurveScaledPayload), 722395301U) },
		{ FCurveRenamedPayload::StaticStruct, Z_Construct_UScriptStruct_FCurveRenamedPayload_Statics::NewStructOps, TEXT("CurveRenamedPayload"), &Z_Registration_Info_UScriptStruct_CurveRenamedPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCurveRenamedPayload), 2712975006U) },
		{ FCurveFlagsChangedPayload::StaticStruct, Z_Construct_UScriptStruct_FCurveFlagsChangedPayload_Statics::NewStructOps, TEXT("CurveFlagsChangedPayload"), &Z_Registration_Info_UScriptStruct_CurveFlagsChangedPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCurveFlagsChangedPayload), 295935354U) },
		{ FAttributePayload::StaticStruct, Z_Construct_UScriptStruct_FAttributePayload_Statics::NewStructOps, TEXT("AttributePayload"), &Z_Registration_Info_UScriptStruct_AttributePayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAttributePayload), 4190583636U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimData_AnimDataNotifications_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimationDataModelNotifiesExtensions, UAnimationDataModelNotifiesExtensions::StaticClass, TEXT("UAnimationDataModelNotifiesExtensions"), &Z_Registration_Info_UClass_UAnimationDataModelNotifiesExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimationDataModelNotifiesExtensions), 820491374U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimData_AnimDataNotifications_h_2701768376(TEXT("/Script/Engine"),
