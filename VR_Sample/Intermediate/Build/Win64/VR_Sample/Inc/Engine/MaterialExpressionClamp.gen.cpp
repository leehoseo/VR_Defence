...
// End Cross Module References
	...
	static UEnum* EClampMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EClampMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EClampMode, Z_Construct_UPackage__Script_Engine(), TEXT("EClampMode"));
		}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionClamp_Statics::NewProp_Min = { "Min", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionClamp, Min), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionClamp_Statics::NewProp_Min_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionClamp_Statics::NewProp_Min_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionClamp_Statics::NewProp_Max = { "Max", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionClamp, Max), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionClamp_Statics::NewProp_Max_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionClamp_Statics::NewProp_Max_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionClamp_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionClamp, UMaterialExpressionClamp::StaticClass, TEXT("UMaterialExpressionClamp"), &Z_Registration_Info_UClass_UMaterialExpressionClamp, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionClamp), 1828802610U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionClamp_h_2792806188(TEXT("/Script/Engine"),
