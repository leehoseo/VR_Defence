...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_ExponentIn = { "ExponentIn", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionFresnel, ExponentIn), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_ExponentIn_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_ExponentIn_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_BaseReflectFractionIn = { "BaseReflectFractionIn", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionFresnel, BaseReflectFractionIn), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_BaseReflectFractionIn_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_BaseReflectFractionIn_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_Normal = { "Normal", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionFresnel, Normal), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_Normal_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionFresnel_Statics::NewProp_Normal_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionFresnel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionFresnel, UMaterialExpressionFresnel::StaticClass, TEXT("UMaterialExpressionFresnel"), &Z_Registration_Info_UClass_UMaterialExpressionFresnel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionFresnel), 913867851U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionFresnel_h_618896482(TEXT("/Script/Engine"),
