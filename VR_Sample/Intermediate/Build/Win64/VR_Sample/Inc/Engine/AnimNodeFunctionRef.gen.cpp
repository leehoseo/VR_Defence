...
#include "Engine/Classes/Animation/AnimNodeFunctionRef.h"
...
class UScriptStruct* FAnimNodeFunctionRef::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNodeFunctionRef.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNodeFunctionRef, Z_Construct_UPackage__Script_Engine(), TEXT("AnimNodeFunctionRef"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FAnimNodeFunctionRef>()
{
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_ClassName = { "ClassName", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNodeFunctionRef, ClassName), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_ClassName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_ClassName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_FunctionName = { "FunctionName", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNodeFunctionRef, FunctionName), METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_FunctionName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_FunctionName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPtrPropertyParams Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_Class = { "Class", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Class | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNodeFunctionRef, Class), Z_Construct_UClass_UObject_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_Class_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_Class_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_Function = { "Function", nullptr, (EPropertyFlags)0x0044000000002000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAnimNodeFunctionRef, Function), Z_Construct_UClass_UFunction, METADATA_PARAMS(Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_Function_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewProp_Function_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNodeFunctionRef_h_Statics::ScriptStructInfo[] = {
		{ FAnimNodeFunctionRef::StaticStruct, Z_Construct_UScriptStruct_FAnimNodeFunctionRef_Statics::NewStructOps, TEXT("AnimNodeFunctionRef"), &Z_Registration_Info_UScriptStruct_AnimNodeFunctionRef, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNodeFunctionRef), 29004804U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimNodeFunctionRef_h_57103675(TEXT("/Script/Engine"),
		nullptr, 0,
