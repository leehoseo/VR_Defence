...
// End Cross Module References
	...
	static UEnum* BeamModifierType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_BeamModifierType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_BeamModifierType, Z_Construct_UPackage__Script_Engine(), TEXT("BeamModifierType"));
		}
...
class UScriptStruct* FBeamModifierOptions::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_BeamModifierOptions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FBeamModifierOptions, Z_Construct_UPackage__Script_Engine(), TEXT("BeamModifierOptions"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FBeamModifierOptions>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_Position = { "Position", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleBeamModifier, Position), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_Position_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_Position_MetaData)) }; // 3599899551
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_TangentOptions = { "TangentOptions", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleBeamModifier, TangentOptions), Z_Construct_UScriptStruct_FBeamModifierOptions, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_TangentOptions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_TangentOptions_MetaData)) }; // 1892753461
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_Tangent = { "Tangent", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleBeamModifier, Tangent), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_Tangent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_Tangent_MetaData)) }; // 3599899551
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_StrengthOptions = { "StrengthOptions", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleBeamModifier, StrengthOptions), Z_Construct_UScriptStruct_FBeamModifierOptions, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_StrengthOptions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_StrengthOptions_MetaData)) }; // 1892753461
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_Strength = { "Strength", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleBeamModifier, Strength), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_Strength_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleBeamModifier_Statics::NewProp_Strength_MetaData)) }; // 3468229032
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Beam_ParticleModuleBeamModifier_h_Statics::ScriptStructInfo[] = {
		{ FBeamModifierOptions::StaticStruct, Z_Construct_UScriptStruct_FBeamModifierOptions_Statics::NewStructOps, TEXT("BeamModifierOptions"), &Z_Registration_Info_UScriptStruct_BeamModifierOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FBeamModifierOptions), 1892753461U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Beam_ParticleModuleBeamModifier_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleBeamModifier, UParticleModuleBeamModifier::StaticClass, TEXT("UParticleModuleBeamModifier"), &Z_Registration_Info_UClass_UParticleModuleBeamModifier, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleBeamModifier), 335672675U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Beam_ParticleModuleBeamModifier_h_1192734917(TEXT("/Script/Engine"),
