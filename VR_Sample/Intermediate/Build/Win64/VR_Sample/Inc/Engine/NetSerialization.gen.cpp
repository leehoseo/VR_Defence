...
class UScriptStruct* FVector_NetQuantize::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Vector_NetQuantize.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVector_NetQuantize, Z_Construct_UPackage__Script_Engine(), TEXT("Vector_NetQuantize"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FVector_NetQuantize>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FVector_NetQuantize_Statics::Struct_MetaDataParams[] = {
		...
		{ "HasNativeBreak", "Engine.KismetMathLibrary.BreakVector_NetQuantize" },
		{ "HasNativeMake", "Engine.KismetMathLibrary.MakeVector_NetQuantize" },
...
class UScriptStruct* FVector_NetQuantize10::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Vector_NetQuantize10.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVector_NetQuantize10, Z_Construct_UPackage__Script_Engine(), TEXT("Vector_NetQuantize10"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FVector_NetQuantize10>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FVector_NetQuantize10_Statics::Struct_MetaDataParams[] = {
		...
		{ "HasNativeBreak", "Engine.KismetMathLibrary.BreakVector_NetQuantize10" },
		{ "HasNativeMake", "Engine.KismetMathLibrary.MakeVector_NetQuantize10" },
		{ "ModuleRelativePath", "Classes/Engine/NetSerialization.h" },
...
class UScriptStruct* FVector_NetQuantize100::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Vector_NetQuantize100.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVector_NetQuantize100, Z_Construct_UPackage__Script_Engine(), TEXT("Vector_NetQuantize100"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FVector_NetQuantize100>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FVector_NetQuantize100_Statics::Struct_MetaDataParams[] = {
		...
		{ "HasNativeBreak", "Engine.KismetMathLibrary.BreakVector_NetQuantize100" },
		{ "HasNativeMake", "Engine.KismetMathLibrary.MakeVector_NetQuantize100" },
		{ "ModuleRelativePath", "Classes/Engine/NetSerialization.h" },
...
class UScriptStruct* FVector_NetQuantizeNormal::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Vector_NetQuantizeNormal.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVector_NetQuantizeNormal, Z_Construct_UPackage__Script_Engine(), TEXT("Vector_NetQuantizeNormal"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FVector_NetQuantizeNormal>()
{
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FVector_NetQuantizeNormal_Statics::Struct_MetaDataParams[] = {
		...
		{ "HasNativeBreak", "Engine.KismetMathLibrary.BreakVector_NetQuantizeNormal" },
		{ "HasNativeMake", "Engine.KismetMathLibrary.MakeVector_NetQuantizeNormal" },
		{ "ModuleRelativePath", "Classes/Engine/NetSerialization.h" },
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_NetSerialization_h_Statics::ScriptStructInfo[] = {
		{ FVector_NetQuantize::StaticStruct, Z_Construct_UScriptStruct_FVector_NetQuantize_Statics::NewStructOps, TEXT("Vector_NetQuantize"), &Z_Registration_Info_UScriptStruct_Vector_NetQuantize, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVector_NetQuantize), 1408259225U) },
		{ FVector_NetQuantize10::StaticStruct, Z_Construct_UScriptStruct_FVector_NetQuantize10_Statics::NewStructOps, TEXT("Vector_NetQuantize10"), &Z_Registration_Info_UScriptStruct_Vector_NetQuantize10, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVector_NetQuantize10), 2472546252U) },
		{ FVector_NetQuantize100::StaticStruct, Z_Construct_UScriptStruct_FVector_NetQuantize100_Statics::NewStructOps, TEXT("Vector_NetQuantize100"), &Z_Registration_Info_UScriptStruct_Vector_NetQuantize100, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVector_NetQuantize100), 3121577039U) },
		{ FVector_NetQuantizeNormal::StaticStruct, Z_Construct_UScriptStruct_FVector_NetQuantizeNormal_Statics::NewStructOps, TEXT("Vector_NetQuantizeNormal"), &Z_Registration_Info_UScriptStruct_Vector_NetQuantizeNormal, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVector_NetQuantizeNormal), 2339297813U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_NetSerialization_h_2731323624(TEXT("/Script/Engine"),
		nullptr, 0,
