...
class UScriptStruct* FNetworkEmulationProfileDescription::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NetworkEmulationProfileDescription.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNetworkEmulationProfileDescription, Z_Construct_UPackage__Script_Engine(), TEXT("NetworkEmulationProfileDescription"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FNetworkEmulationProfileDescription>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FNetworkEmulationProfileDescription_Statics::NewProp_ProfileName = { "ProfileName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNetworkEmulationProfileDescription, ProfileName), METADATA_PARAMS(Z_Construct_UScriptStruct_FNetworkEmulationProfileDescription_Statics::NewProp_ProfileName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetworkEmulationProfileDescription_Statics::NewProp_ProfileName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FNetworkEmulationProfileDescription_Statics::NewProp_ToolTip = { "ToolTip", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNetworkEmulationProfileDescription, ToolTip), METADATA_PARAMS(Z_Construct_UScriptStruct_FNetworkEmulationProfileDescription_Statics::NewProp_ToolTip_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNetworkEmulationProfileDescription_Statics::NewProp_ToolTip_MetaData)) };
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_MaxRepArraySize_MetaData[];
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_MaxRepArraySize;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_MaxRepArrayMemory_MetaData[];
#endif
		static const UECodeGen_Private::FIntPropertyParams NewProp_MaxRepArrayMemory;
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bVerifyPeer = { "bVerifyPeer", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UNetworkSettings), &Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bVerifyPeer_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bVerifyPeer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bVerifyPeer_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bEnableMultiplayerWorldOriginRebasing = { "bEnableMultiplayerWorldOriginRebasing", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UNetworkSettings), &Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bEnableMultiplayerWorldOriginRebasing_SetBit, METADATA_PARAMS(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bEnableMultiplayerWorldOriginRebasing_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_bEnableMultiplayerWorldOriginRebasing_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArraySize_MetaData[] = {
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArraySize = { "MaxRepArraySize", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNetworkSettings, MaxRepArraySize), METADATA_PARAMS(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArraySize_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArraySize_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArrayMemory_MetaData[] = {
		{ "Category", "replication" },
		{ "ClampMax", "65535" },
		{ "ClampMin", "1" },
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArrayMemory = { "MaxRepArrayMemory", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UNetworkSettings, MaxRepArrayMemory), METADATA_PARAMS(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArrayMemory_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArrayMemory_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UNetworkSettings_Statics::NewProp_NetworkEmulationProfiles_Inner = { "NetworkEmulationProfiles", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNetworkEmulationProfileDescription, METADATA_PARAMS(nullptr, 0) }; // 221963904
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UNetworkSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArraySize,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UNetworkSettings_Statics::NewProp_MaxRepArrayMemory,
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_NetworkSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UNetworkSettings, UNetworkSettings::StaticClass, TEXT("UNetworkSettings"), &Z_Registration_Info_UClass_UNetworkSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNetworkSettings), 2313074913U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_NetworkSettings_h_2741701208(TEXT("/Script/Engine"),
