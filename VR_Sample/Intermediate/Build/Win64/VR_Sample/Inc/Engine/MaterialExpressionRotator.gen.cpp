...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_Coordinate = { "Coordinate", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionRotator, Coordinate), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_Coordinate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_Coordinate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionRotator, Time), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_Time_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_Time_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_CenterY = { "CenterY", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionRotator, CenterY), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_CenterY_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_CenterY_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_Speed = { "Speed", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionRotator, Speed), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_Speed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionRotator_Statics::NewProp_Speed_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionRotator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionRotator, UMaterialExpressionRotator::StaticClass, TEXT("UMaterialExpressionRotator"), &Z_Registration_Info_UClass_UMaterialExpressionRotator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionRotator), 2313862149U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionRotator_h_2237992212(TEXT("/Script/Engine"),
