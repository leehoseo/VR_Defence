...
class UScriptStruct* FKAggregateGeom::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KAggregateGeom.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKAggregateGeom, Z_Construct_UPackage__Script_Engine(), TEXT("KAggregateGeom"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FKAggregateGeom>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_SphereElems_Inner = { "SphereElems", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKSphereElem, METADATA_PARAMS(nullptr, 0) }; // 3913292171
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_SphereElems = { "SphereElems", nullptr, (EPropertyFlags)0x0010000000000041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKAggregateGeom, SphereElems), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_SphereElems_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_SphereElems_MetaData)) }; // 3913292171
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_BoxElems_Inner = { "BoxElems", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKBoxElem, METADATA_PARAMS(nullptr, 0) }; // 609277831
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_BoxElems = { "BoxElems", nullptr, (EPropertyFlags)0x0010000000000041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKAggregateGeom, BoxElems), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_BoxElems_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_BoxElems_MetaData)) }; // 609277831
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_SphylElems_Inner = { "SphylElems", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKSphylElem, METADATA_PARAMS(nullptr, 0) }; // 2619342482
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_SphylElems = { "SphylElems", nullptr, (EPropertyFlags)0x0010000000000041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKAggregateGeom, SphylElems), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_SphylElems_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_SphylElems_MetaData)) }; // 2619342482
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_ConvexElems_Inner = { "ConvexElems", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKConvexElem, METADATA_PARAMS(nullptr, 0) }; // 3351838121
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_ConvexElems = { "ConvexElems", nullptr, (EPropertyFlags)0x0010000000000041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKAggregateGeom, ConvexElems), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_ConvexElems_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_ConvexElems_MetaData)) }; // 3351838121
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_TaperedCapsuleElems_Inner = { "TaperedCapsuleElems", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FKTaperedCapsuleElem, METADATA_PARAMS(nullptr, 0) }; // 3098003176
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_TaperedCapsuleElems = { "TaperedCapsuleElems", nullptr, (EPropertyFlags)0x0010000000000041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKAggregateGeom, TaperedCapsuleElems), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_TaperedCapsuleElems_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewProp_TaperedCapsuleElems_MetaData)) }; // 3098003176
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_AggregateGeom_h_Statics::ScriptStructInfo[] = {
		{ FKAggregateGeom::StaticStruct, Z_Construct_UScriptStruct_FKAggregateGeom_Statics::NewStructOps, TEXT("KAggregateGeom"), &Z_Registration_Info_UScriptStruct_KAggregateGeom, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FKAggregateGeom), 3537038980U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_AggregateGeom_h_2725165037(TEXT("/Script/Engine"),
		nullptr, 0,
