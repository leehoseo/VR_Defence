...
// End Cross Module References
	...
	static UEnum* EParticleCameraOffsetUpdateMethod_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EParticleCameraOffsetUpdateMethod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EParticleCameraOffsetUpdateMethod, Z_Construct_UPackage__Script_Engine(), TEXT("EParticleCameraOffsetUpdateMethod"));
		}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleCameraOffset_Statics::NewProp_CameraOffset = { "CameraOffset", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleCameraOffset, CameraOffset), Z_Construct_UScriptStruct_FRawDistributionFloat, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleCameraOffset_Statics::NewProp_CameraOffset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleCameraOffset_Statics::NewProp_CameraOffset_MetaData)) }; // 3468229032
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParticleModuleCameraOffset_Statics::NewProp_bSpawnTimeOnly = { "bSpawnTimeOnly", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(UParticleModuleCameraOffset), &Z_Construct_UClass_UParticleModuleCameraOffset_Statics::NewProp_bSpawnTimeOnly_SetBit, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleCameraOffset_Statics::NewProp_bSpawnTimeOnly_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleCameraOffset_Statics::NewProp_bSpawnTimeOnly_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UParticleModuleCameraOffset_Statics::NewProp_UpdateMethod = { "UpdateMethod", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleCameraOffset, UpdateMethod), Z_Construct_UEnum_Engine_EParticleCameraOffsetUpdateMethod, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleCameraOffset_Statics::NewProp_UpdateMethod_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleCameraOffset_Statics::NewProp_UpdateMethod_MetaData)) }; // 4280708374
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Camera_ParticleModuleCameraOffset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleCameraOffset, UParticleModuleCameraOffset::StaticClass, TEXT("UParticleModuleCameraOffset"), &Z_Registration_Info_UClass_UParticleModuleCameraOffset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleCameraOffset), 4198699090U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Camera_ParticleModuleCameraOffset_h_3555303876(TEXT("/Script/Engine"),
