...
class UScriptStruct* FSingleAnimationPlayData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SingleAnimationPlayData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSingleAnimationPlayData, Z_Construct_UPackage__Script_Engine(), TEXT("SingleAnimationPlayData"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FSingleAnimationPlayData>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_AnimToPlay = { "AnimToPlay", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSingleAnimationPlayData, AnimToPlay), Z_Construct_UClass_UAnimationAsset_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_AnimToPlay_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_AnimToPlay_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPlayRate = { "SavedPlayRate", nullptr, (EPropertyFlags)0x0010040000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSingleAnimationPlayData, SavedPlayRate), METADATA_PARAMS(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPlayRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewProp_SavedPlayRate_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_SingleAnimationPlayData_h_Statics::ScriptStructInfo[] = {
		{ FSingleAnimationPlayData::StaticStruct, Z_Construct_UScriptStruct_FSingleAnimationPlayData_Statics::NewStructOps, TEXT("SingleAnimationPlayData"), &Z_Registration_Info_UScriptStruct_SingleAnimationPlayData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSingleAnimationPlayData), 3164007416U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_SingleAnimationPlayData_h_3518279777(TEXT("/Script/Engine"),
		nullptr, 0,
