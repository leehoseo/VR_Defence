...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USoundNodeLooping_Statics::NewProp_bLoopIndefinitely = { "bLoopIndefinitely", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool , RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(uint8), sizeof(USoundNodeLooping), &Z_Construct_UClass_USoundNodeLooping_Statics::NewProp_bLoopIndefinitely_SetBit, METADATA_PARAMS(Z_Construct_UClass_USoundNodeLooping_Statics::NewProp_bLoopIndefinitely_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeLooping_Statics::NewProp_bLoopIndefinitely_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeLooping_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundNodeLooping, USoundNodeLooping::StaticClass, TEXT("USoundNodeLooping"), &Z_Registration_Info_UClass_USoundNodeLooping, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundNodeLooping), 2438476861U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeLooping_h_3056479381(TEXT("/Script/Engine"),
