...
#include "Engine/Classes/Materials/MaterialExpressionDBufferTexture.h"
...
// End Cross Module References
	...
	static UEnum* EDBufferTextureId_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EDBufferTextureId.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EDBufferTextureId, Z_Construct_UPackage__Script_Engine(), TEXT("EDBufferTextureId"));
		}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionDBufferTexture_Statics::NewProp_Coordinates = { "Coordinates", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionDBufferTexture, Coordinates), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionDBufferTexture_Statics::NewProp_Coordinates_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionDBufferTexture_Statics::NewProp_Coordinates_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionDBufferTexture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionDBufferTexture, UMaterialExpressionDBufferTexture::StaticClass, TEXT("UMaterialExpressionDBufferTexture"), &Z_Registration_Info_UClass_UMaterialExpressionDBufferTexture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionDBufferTexture), 3376878887U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionDBufferTexture_h_2165577134(TEXT("/Script/Engine"),
