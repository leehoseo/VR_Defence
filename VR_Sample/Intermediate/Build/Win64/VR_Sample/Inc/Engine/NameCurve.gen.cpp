...
class UScriptStruct* FNameCurveKey::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NameCurveKey.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNameCurveKey, Z_Construct_UPackage__Script_Engine(), TEXT("NameCurveKey"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNameCurveKey, Time), METADATA_PARAMS(Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Time_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Time_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Value = { "Value", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FNameCurveKey, Value), METADATA_PARAMS(Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Value_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewProp_Value_MetaData)) };
...
class UScriptStruct* FNameCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_NameCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FNameCurve, Z_Construct_UPackage__Script_Engine(), TEXT("NameCurve"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FNameCurve>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNameCurve_Statics::NewProp_Keys_Inner = { "Keys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FNameCurveKey, METADATA_PARAMS(nullptr, 0) }; // 98784543
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_NameCurve_h_Statics::ScriptStructInfo[] = {
		{ FNameCurveKey::StaticStruct, Z_Construct_UScriptStruct_FNameCurveKey_Statics::NewStructOps, TEXT("NameCurveKey"), &Z_Registration_Info_UScriptStruct_NameCurveKey, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNameCurveKey), 98784543U) },
		{ FNameCurve::StaticStruct, Z_Construct_UScriptStruct_FNameCurve_Statics::NewStructOps, TEXT("NameCurve"), &Z_Registration_Info_UScriptStruct_NameCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNameCurve), 2925496209U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_NameCurve_h_1604645488(TEXT("/Script/Engine"),
		nullptr, 0,
