...
class UScriptStruct* FKConvexElem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KConvexElem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKConvexElem, Z_Construct_UPackage__Script_Engine(), TEXT("KConvexElem"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FKConvexElem>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_VertexData = { "VertexData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKConvexElem, VertexData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_VertexData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_VertexData_MetaData)) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_IndexData_Inner = { "IndexData", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_IndexData_MetaData[] = {
		{ "ModuleRelativePath", "Classes/PhysicsEngine/ConvexElem.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_IndexData = { "IndexData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKConvexElem, IndexData), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_IndexData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_IndexData_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_ElemBox = { "ElemBox", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKConvexElem, ElemBox), Z_Construct_UScriptStruct_FBox, METADATA_PARAMS(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_ElemBox_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_ElemBox_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_Transform = { "Transform", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKConvexElem, Transform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_Transform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKConvexElem_Statics::NewProp_Transform_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_ConvexElem_h_Statics::ScriptStructInfo[] = {
		{ FKConvexElem::StaticStruct, Z_Construct_UScriptStruct_FKConvexElem_Statics::NewStructOps, TEXT("KConvexElem"), &Z_Registration_Info_UScriptStruct_KConvexElem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FKConvexElem), 3351838121U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_ConvexElem_h_374324520(TEXT("/Script/Engine"),
		nullptr, 0,
