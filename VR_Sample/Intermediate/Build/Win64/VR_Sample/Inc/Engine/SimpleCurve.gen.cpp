...
class UScriptStruct* FSimpleCurveKey::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SimpleCurveKey.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSimpleCurveKey, Z_Construct_UPackage__Script_Engine(), TEXT("SimpleCurveKey"));
	}
...
class UScriptStruct* FSimpleCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SimpleCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSimpleCurve, Z_Construct_UPackage__Script_Engine(), TEXT("SimpleCurve"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FSimpleCurve>()
{
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSimpleCurve_Statics::NewProp_InterpMode = { "InterpMode", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSimpleCurve, InterpMode), Z_Construct_UEnum_Engine_ERichCurveInterpMode, METADATA_PARAMS(Z_Construct_UScriptStruct_FSimpleCurve_Statics::NewProp_InterpMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimpleCurve_Statics::NewProp_InterpMode_MetaData)) }; // 931686469
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FSimpleCurve_Statics::NewProp_Keys_Inner = { "Keys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FSimpleCurveKey, METADATA_PARAMS(nullptr, 0) }; // 2032283610
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FSimpleCurve_Statics::NewProp_Keys = { "Keys", nullptr, (EPropertyFlags)0x0010000000000041, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FSimpleCurve, Keys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FSimpleCurve_Statics::NewProp_Keys_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSimpleCurve_Statics::NewProp_Keys_MetaData)) }; // 2032283610
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_SimpleCurve_h_Statics::ScriptStructInfo[] = {
		{ FSimpleCurveKey::StaticStruct, Z_Construct_UScriptStruct_FSimpleCurveKey_Statics::NewStructOps, TEXT("SimpleCurveKey"), &Z_Registration_Info_UScriptStruct_SimpleCurveKey, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSimpleCurveKey), 2032283610U) },
		{ FSimpleCurve::StaticStruct, Z_Construct_UScriptStruct_FSimpleCurve_Statics::NewStructOps, TEXT("SimpleCurve"), &Z_Registration_Info_UScriptStruct_SimpleCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSimpleCurve), 1512339183U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Curves_SimpleCurve_h_884995775(TEXT("/Script/Engine"),
		nullptr, 0,
