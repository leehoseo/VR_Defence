...
// End Cross Module References
	...
	static UEnum* EParticleScreenAlignment_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EParticleScreenAlignment.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EParticleScreenAlignment, Z_Construct_UPackage__Script_Engine(), TEXT("EParticleScreenAlignment"));
		}
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_ParticleSpriteEmitter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleSpriteEmitter, UParticleSpriteEmitter::StaticClass, TEXT("UParticleSpriteEmitter"), &Z_Registration_Info_UClass_UParticleSpriteEmitter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleSpriteEmitter), 2303773625U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_ParticleSpriteEmitter_h_7114031(TEXT("/Script/Engine"),
