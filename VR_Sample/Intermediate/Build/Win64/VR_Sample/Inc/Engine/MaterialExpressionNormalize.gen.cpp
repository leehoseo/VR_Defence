...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionNormalize_Statics::NewProp_VectorInput = { "VectorInput", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionNormalize, VectorInput), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionNormalize_Statics::NewProp_VectorInput_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionNormalize_Statics::NewProp_VectorInput_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionNormalize_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionNormalize, UMaterialExpressionNormalize::StaticClass, TEXT("UMaterialExpressionNormalize"), &Z_Registration_Info_UClass_UMaterialExpressionNormalize, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionNormalize), 1983854274U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionNormalize_h_2922929057(TEXT("/Script/Engine"),
