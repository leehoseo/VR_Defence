...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_Coordinate = { "Coordinate", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionBumpOffset, Coordinate), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_Coordinate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_Coordinate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_Height = { "Height", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionBumpOffset, Height), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_Height_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_Height_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_HeightRatioInput = { "HeightRatioInput", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionBumpOffset, HeightRatioInput), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_HeightRatioInput_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_HeightRatioInput_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_HeightRatio = { "HeightRatio", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionBumpOffset, HeightRatio), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_HeightRatio_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_HeightRatio_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_ReferencePlane = { "ReferencePlane", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionBumpOffset, ReferencePlane), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_ReferencePlane_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_ReferencePlane_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FUInt32PropertyParams Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_ConstCoordinate = { "ConstCoordinate", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionBumpOffset, ConstCoordinate), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_ConstCoordinate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionBumpOffset_Statics::NewProp_ConstCoordinate_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionBumpOffset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionBumpOffset, UMaterialExpressionBumpOffset::StaticClass, TEXT("UMaterialExpressionBumpOffset"), &Z_Registration_Info_UClass_UMaterialExpressionBumpOffset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionBumpOffset), 43259075U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionBumpOffset_h_2393632602(TEXT("/Script/Engine"),
