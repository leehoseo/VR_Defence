...
#include "Engine/Classes/Materials/MaterialExpressionAbsorptionMediumMaterialOutput.h"
...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput_Statics::Class_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Classes/Materials/MaterialExpressionAbsorptionMediumMaterialOutput.h" },
		{ "ToolTip", "Material output expression for setting absorption properties of solid refractive glass (for the Path Tracer Only)." },
	};
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput_Statics::NewProp_TransmittanceColor_MetaData[] = {
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput_Statics::NewProp_TransmittanceColor = { "TransmittanceColor", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionAbsorptionMediumMaterialOutput, TransmittanceColor), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput_Statics::NewProp_TransmittanceColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput_Statics::NewProp_TransmittanceColor_MetaData)) };
	...
	const FCppClassTypeInfoStatic Z_Construct_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput_Statics::StaticCppClassTypeInfo = {
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput_Statics::ClassParams = {
		...
		0,
		0x000820A0u,
		METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionAbsorptionMediumMaterialOutput_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionAbsorptionMediumMaterialOutput_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput, UMaterialExpressionAbsorptionMediumMaterialOutput::StaticClass, TEXT("UMaterialExpressionAbsorptionMediumMaterialOutput"), &Z_Registration_Info_UClass_UMaterialExpressionAbsorptionMediumMaterialOutput, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionAbsorptionMediumMaterialOutput), 629103805U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionAbsorptionMediumMaterialOutput_h_1352895676(TEXT("/Script/Engine"),
		Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionAbsorptionMediumMaterialOutput_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionAbsorptionMediumMaterialOutput_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
