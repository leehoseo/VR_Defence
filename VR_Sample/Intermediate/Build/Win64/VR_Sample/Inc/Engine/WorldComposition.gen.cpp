...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FDoublePropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreamingTimeThreshold = { "TilesStreamingTimeThreshold", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Double, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWorldComposition, TilesStreamingTimeThreshold), METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreamingTimeThreshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_TilesStreamingTimeThreshold_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_bRebaseOriginIn3DSpace = { "bRebaseOriginIn3DSpace", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UWorldComposition), &Z_Construct_UClass_UWorldComposition_Statics::NewProp_bRebaseOriginIn3DSpace_SetBit, METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_bRebaseOriginIn3DSpace_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_bRebaseOriginIn3DSpace_MetaData)) };
#if WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLockTilesLocation = { "bLockTilesLocation", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UWorldComposition), &Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLockTilesLocation_SetBit, METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLockTilesLocation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_bLockTilesLocation_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UWorldComposition_Statics::NewProp_RebaseOriginDistance = { "RebaseOriginDistance", nullptr, (EPropertyFlags)0x0010000000004000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UWorldComposition, RebaseOriginDistance), METADATA_PARAMS(Z_Construct_UClass_UWorldComposition_Statics::NewProp_RebaseOriginDistance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UWorldComposition_Statics::NewProp_RebaseOriginDistance_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_WorldComposition_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWorldComposition, UWorldComposition::StaticClass, TEXT("UWorldComposition"), &Z_Registration_Info_UClass_UWorldComposition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWorldComposition), 3028709454U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_WorldComposition_h_961867254(TEXT("/Script/Engine"),
