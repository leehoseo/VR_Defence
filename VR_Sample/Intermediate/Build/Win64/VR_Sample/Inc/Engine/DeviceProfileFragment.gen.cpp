...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UDeviceProfileFragment_Statics::NewProp_CVars_Inner = { "CVars", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UDeviceProfileFragment_Statics::NewProp_CVars_MetaData[] = {
		{ "ModuleRelativePath", "Classes/DeviceProfiles/DeviceProfileFragment.h" },
	};
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UDeviceProfileFragment_Statics::NewProp_CVars = { "CVars", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UDeviceProfileFragment, CVars), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UDeviceProfileFragment_Statics::NewProp_CVars_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UDeviceProfileFragment_Statics::NewProp_CVars_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_DeviceProfiles_DeviceProfileFragment_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UDeviceProfileFragment, UDeviceProfileFragment::StaticClass, TEXT("UDeviceProfileFragment"), &Z_Registration_Info_UClass_UDeviceProfileFragment, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDeviceProfileFragment), 2544304841U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_DeviceProfiles_DeviceProfileFragment_h_496878745(TEXT("/Script/Engine"),
