...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_FrictionScale_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTireType_Statics::Class_MetaDataParams[] = {
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UTireType_Statics::NewProp_FrictionScale_MetaData[] = {
		{ "Category", "Deprecated" },
		{ "ModuleRelativePath", "Classes/Vehicles/TireType.h" },
	};
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UTireType_Statics::NewProp_FrictionScale = { "FrictionScale", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UTireType, FrictionScale), METADATA_PARAMS(Z_Construct_UClass_UTireType_Statics::NewProp_FrictionScale_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UTireType_Statics::NewProp_FrictionScale_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UTireType_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UTireType_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UTireType_Statics::Class_MetaDataParams))
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Vehicles_TireType_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UTireType, UTireType::StaticClass, TEXT("UTireType"), &Z_Registration_Info_UClass_UTireType, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTireType), 1165405037U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Vehicles_TireType_h_1077742142(TEXT("/Script/Engine"),
