...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMaterialExpressionMapARPassthroughCameraUV_Statics::NewProp_Coordinates = { "Coordinates", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionMapARPassthroughCameraUV, Coordinates), Z_Construct_UScriptStruct_FExpressionInput, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionMapARPassthroughCameraUV_Statics::NewProp_Coordinates_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionMapARPassthroughCameraUV_Statics::NewProp_Coordinates_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionMapARPassthroughCameraUV_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionMapARPassthroughCameraUV, UMaterialExpressionMapARPassthroughCameraUV::StaticClass, TEXT("UMaterialExpressionMapARPassthroughCameraUV"), &Z_Registration_Info_UClass_UMaterialExpressionMapARPassthroughCameraUV, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionMapARPassthroughCameraUV), 972154206U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionMapARPassthroughCameraUV_h_3456163657(TEXT("/Script/Engine"),
