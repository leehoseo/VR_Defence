...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_USoundNodeDoppler_Statics::NewProp_bUseSmoothing = { "bUseSmoothing", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(USoundNodeDoppler), &Z_Construct_UClass_USoundNodeDoppler_Statics::NewProp_bUseSmoothing_SetBit, METADATA_PARAMS(Z_Construct_UClass_USoundNodeDoppler_Statics::NewProp_bUseSmoothing_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeDoppler_Statics::NewProp_bUseSmoothing_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDoppler_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundNodeDoppler, USoundNodeDoppler::StaticClass, TEXT("USoundNodeDoppler"), &Z_Registration_Info_UClass_USoundNodeDoppler, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundNodeDoppler), 460442510U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeDoppler_h_2998258305(TEXT("/Script/Engine"),
