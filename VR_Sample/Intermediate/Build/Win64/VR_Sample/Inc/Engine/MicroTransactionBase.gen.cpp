...
// End Cross Module References
	...
	static UEnum* EMicroTransactionDelegate_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMicroTransactionDelegate.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EMicroTransactionDelegate, Z_Construct_UPackage__Script_Engine(), TEXT("EMicroTransactionDelegate"));
		}
	...
	static UEnum* EMicroTransactionResult_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EMicroTransactionResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EMicroTransactionResult, Z_Construct_UPackage__Script_Engine(), TEXT("EMicroTransactionResult"));
		}
...
class UScriptStruct* FPurchaseInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PurchaseInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPurchaseInfo, Z_Construct_UPackage__Script_Engine(), TEXT("PurchaseInfo"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FPurchaseInfo>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_Identifier = { "Identifier", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPurchaseInfo, Identifier), METADATA_PARAMS(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_Identifier_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_Identifier_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayName = { "DisplayName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPurchaseInfo, DisplayName), METADATA_PARAMS(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayDescription = { "DisplayDescription", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPurchaseInfo, DisplayDescription), METADATA_PARAMS(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayDescription_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayDescription_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayPrice = { "DisplayPrice", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FPurchaseInfo, DisplayPrice), METADATA_PARAMS(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayPrice_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewProp_DisplayPrice_MetaData)) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_AvailableProducts_Inner = { "AvailableProducts", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FPurchaseInfo, METADATA_PARAMS(nullptr, 0) }; // 2099810748
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_AvailableProducts = { "AvailableProducts", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMicroTransactionBase, AvailableProducts), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_AvailableProducts_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_AvailableProducts_MetaData)) }; // 2099810748
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_LastError = { "LastError", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMicroTransactionBase, LastError), METADATA_PARAMS(Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_LastError_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_LastError_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_LastErrorSolution = { "LastErrorSolution", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMicroTransactionBase, LastErrorSolution), METADATA_PARAMS(Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_LastErrorSolution_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMicroTransactionBase_Statics::NewProp_LastErrorSolution_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_MicroTransactionBase_h_Statics::ScriptStructInfo[] = {
		{ FPurchaseInfo::StaticStruct, Z_Construct_UScriptStruct_FPurchaseInfo_Statics::NewStructOps, TEXT("PurchaseInfo"), &Z_Registration_Info_UScriptStruct_PurchaseInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPurchaseInfo), 2099810748U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_MicroTransactionBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMicroTransactionBase, UMicroTransactionBase::StaticClass, TEXT("UMicroTransactionBase"), &Z_Registration_Info_UClass_UMicroTransactionBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMicroTransactionBase), 3305951462U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Engine_MicroTransactionBase_h_1559567733(TEXT("/Script/Engine"),
