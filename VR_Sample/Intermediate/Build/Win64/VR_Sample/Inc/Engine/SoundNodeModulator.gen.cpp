...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMin = { "PitchMin", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeModulator, PitchMin), METADATA_PARAMS(Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMin_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMax = { "PitchMax", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeModulator, PitchMax), METADATA_PARAMS(Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMax_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_PitchMax_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_VolumeMin = { "VolumeMin", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(USoundNodeModulator, VolumeMin), METADATA_PARAMS(Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_VolumeMin_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USoundNodeModulator_Statics::NewProp_VolumeMin_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeModulator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USoundNodeModulator, USoundNodeModulator::StaticClass, TEXT("USoundNodeModulator"), &Z_Registration_Info_UClass_USoundNodeModulator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoundNodeModulator), 3576184956U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Sound_SoundNodeModulator_h_2030147413(TEXT("/Script/Engine"),
