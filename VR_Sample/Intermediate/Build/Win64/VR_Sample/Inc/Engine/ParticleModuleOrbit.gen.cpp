...
// End Cross Module References
	...
	static UEnum* EOrbitChainMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EOrbitChainMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EOrbitChainMode, Z_Construct_UPackage__Script_Engine(), TEXT("EOrbitChainMode"));
		}
...
class UScriptStruct* FOrbitOptions::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_OrbitOptions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FOrbitOptions, Z_Construct_UPackage__Script_Engine(), TEXT("OrbitOptions"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FOrbitOptions>()
{
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_ChainMode = { "ChainMode", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleOrbit, ChainMode), Z_Construct_UEnum_Engine_EOrbitChainMode, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_ChainMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_ChainMode_MetaData)) }; // 3847122489
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_OffsetAmount = { "OffsetAmount", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleOrbit, OffsetAmount), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_OffsetAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_OffsetAmount_MetaData)) }; // 3599899551
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_OffsetOptions = { "OffsetOptions", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleOrbit, OffsetOptions), Z_Construct_UScriptStruct_FOrbitOptions, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_OffsetOptions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_OffsetOptions_MetaData)) }; // 1651033870
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_RotationAmount = { "RotationAmount", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleOrbit, RotationAmount), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_RotationAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_RotationAmount_MetaData)) }; // 3599899551
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_RotationOptions = { "RotationOptions", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleOrbit, RotationOptions), Z_Construct_UScriptStruct_FOrbitOptions, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_RotationOptions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_RotationOptions_MetaData)) }; // 1651033870
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_RotationRateAmount = { "RotationRateAmount", nullptr, (EPropertyFlags)0x0010008000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UParticleModuleOrbit, RotationRateAmount), Z_Construct_UScriptStruct_FRawDistributionVector, METADATA_PARAMS(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_RotationRateAmount_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UParticleModuleOrbit_Statics::NewProp_RotationRateAmount_MetaData)) }; // 3599899551
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Orbit_ParticleModuleOrbit_h_Statics::ScriptStructInfo[] = {
		{ FOrbitOptions::StaticStruct, Z_Construct_UScriptStruct_FOrbitOptions_Statics::NewStructOps, TEXT("OrbitOptions"), &Z_Registration_Info_UScriptStruct_OrbitOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOrbitOptions), 1651033870U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Orbit_ParticleModuleOrbit_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UParticleModuleOrbit, UParticleModuleOrbit::StaticClass, TEXT("UParticleModuleOrbit"), &Z_Registration_Info_UClass_UParticleModuleOrbit, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParticleModuleOrbit), 3470860126U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Particles_Orbit_ParticleModuleOrbit_h_734537428(TEXT("/Script/Engine"),
