...
#include "Engine/Classes/Animation/AnimData/IAnimationDataController.h"
...
// End Cross Module References
	...
	DEFINE_FUNCTION(IAnimationDataController::execGetModel)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		*(UAnimDataModel**)Z_Param__Result=P_THIS->GetModel();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(IAnimationDataController::execSetModel)
	{
		P_GET_OBJECT(UAnimDataModel,Z_Param_InModel);
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	void UAnimationDataController::StaticRegisterNativesUAnimationDataController()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetModel", &IAnimationDataController::execGetModel },
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_AddAttribute_Statics::NewProp_AttributeIdentifier = { "AttributeIdentifier", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventAddAttribute_Parms, AttributeIdentifier), Z_Construct_UScriptStruct_FAnimationAttributeIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_AddAttribute_Statics::NewProp_AttributeIdentifier_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_AddAttribute_Statics::NewProp_AttributeIdentifier_MetaData)) }; // 4209166089
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_AddAttribute_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventAddAttribute_Parms), &Z_Construct_UFunction_UAnimationDataController_AddAttribute_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_AddAttribute_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventAddAttribute_Parms), &Z_Construct_UFunction_UAnimationDataController_AddAttribute_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UAnimationDataController_AddBoneTrack_Statics::NewProp_BoneName = { "BoneName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventAddBoneTrack_Parms, BoneName), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_AddBoneTrack_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventAddBoneTrack_Parms), &Z_Construct_UFunction_UAnimationDataController_AddBoneTrack_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAnimationDataController_AddBoneTrack_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventAddBoneTrack_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAnimationDataController_AddBoneTrack_Statics::Function_MetaDataParams[] = {
		...
		{ "Comment", "/**\n\x09* Adds a new bone animation track for the provided name. Broadcasts a EAnimDataModelNotifyType::TrackAdded notify if successful.\n\x09*\n\x09* @param\x09""BoneName\x09\x09\x09""Bone name for which a track should be added\n\x09* @param\x09""bShouldTransact\x09\x09Whether or not any undo-redo changes should be generated\n\x09*\n\x09* @return\x09The index at which the bone track was added, INDEX_NONE if adding it failed\n\x09*/" },
		{ "CPP_Default_bShouldTransact", "true" },
		{ "ModuleRelativePath", "Classes/Animation/AnimData/IAnimationDataController.h" },
		{ "ToolTip", "Adds a new bone animation track for the provided name. Broadcasts a EAnimDataModelNotifyType::TrackAdded notify if successful.\n\n@param        BoneName                        Bone name for which a track should be added\n@param        bShouldTransact         Whether or not any undo-redo changes should be generated\n\n@return       The index at which the bone track was added, INDEX_NONE if adding it failed" },
	};
#endif
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_AddCurve_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventAddCurve_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_AddCurve_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_AddCurve_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAnimationDataController_AddCurve_Statics::NewProp_CurveFlags = { "CurveFlags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventAddCurve_Parms, CurveFlags), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_AddCurve_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventAddCurve_Parms), &Z_Construct_UFunction_UAnimationDataController_AddCurve_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_AddCurve_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventAddCurve_Parms), &Z_Construct_UFunction_UAnimationDataController_AddCurve_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_CloseBracket_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventCloseBracket_Parms), &Z_Construct_UFunction_UAnimationDataController_CloseBracket_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute_Statics::NewProp_AttributeIdentifier = { "AttributeIdentifier", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventDuplicateAttribute_Parms, AttributeIdentifier), Z_Construct_UScriptStruct_FAnimationAttributeIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute_Statics::NewProp_AttributeIdentifier_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute_Statics::NewProp_AttributeIdentifier_MetaData)) }; // 4209166089
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute_Statics::NewProp_NewAttributeIdentifier = { "NewAttributeIdentifier", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventDuplicateAttribute_Parms, NewAttributeIdentifier), Z_Construct_UScriptStruct_FAnimationAttributeIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute_Statics::NewProp_NewAttributeIdentifier_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute_Statics::NewProp_NewAttributeIdentifier_MetaData)) }; // 4209166089
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventDuplicateAttribute_Parms), &Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventDuplicateAttribute_Parms), &Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_DuplicateCurve_Statics::NewProp_CopyCurveId = { "CopyCurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventDuplicateCurve_Parms, CopyCurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_DuplicateCurve_Statics::NewProp_CopyCurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_DuplicateCurve_Statics::NewProp_CopyCurveId_MetaData)) }; // 3166900084
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_DuplicateCurve_Statics::NewProp_NewCurveId = { "NewCurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventDuplicateCurve_Parms, NewCurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_DuplicateCurve_Statics::NewProp_NewCurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_DuplicateCurve_Statics::NewProp_NewCurveId_MetaData)) }; // 3166900084
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_DuplicateCurve_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventDuplicateCurve_Parms), &Z_Construct_UFunction_UAnimationDataController_DuplicateCurve_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_DuplicateCurve_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventDuplicateCurve_Parms), &Z_Construct_UFunction_UAnimationDataController_DuplicateCurve_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimationDataController_FindOrAddCurveNamesOnSkeleton_Statics::NewProp_Skeleton = { "Skeleton", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventFindOrAddCurveNamesOnSkeleton_Parms, Skeleton), Z_Construct_UClass_USkeleton_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UAnimationDataController_FindOrAddCurveNamesOnSkeleton_Statics::NewProp_SupportedCurveType = { "SupportedCurveType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventFindOrAddCurveNamesOnSkeleton_Parms, SupportedCurveType), Z_Construct_UEnum_Engine_ERawCurveTrackTypes, METADATA_PARAMS(nullptr, 0) }; // 1535854795
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_FindOrAddCurveNamesOnSkeleton_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventFindOrAddCurveNamesOnSkeleton_Parms), &Z_Construct_UFunction_UAnimationDataController_FindOrAddCurveNamesOnSkeleton_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	struct Z_Construct_UFunction_UAnimationDataController_GetModel_Statics
	{
		struct AnimationDataController_eventGetModel_Parms
		{
			UAnimDataModel* ReturnValue;
		};
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventGetModel_Parms, ReturnValue), Z_Construct_UClass_UAnimDataModel_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::Function_MetaDataParams[] = {
		{ "Category", "AnimationData" },
		{ "Comment", "/**\n\x09* @return\x09\x09The AnimDataModel instance this controller is currently targeting\n\x09*/" },
		{ "ModuleRelativePath", "Classes/Animation/AnimData/IAnimationDataController.h" },
		{ "ToolTip", "@return               The AnimDataModel instance this controller is currently targeting" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UAnimationDataController, nullptr, "GetModel", nullptr, nullptr, sizeof(Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::AnimationDataController_eventGetModel_Parms), Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UAnimationDataController_GetModel()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UAnimationDataController_GetModel_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UAnimationDataController_InsertBoneTrack_Statics::NewProp_BoneName = { "BoneName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventInsertBoneTrack_Parms, BoneName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAnimationDataController_InsertBoneTrack_Statics::NewProp_DesiredIndex = { "DesiredIndex", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventInsertBoneTrack_Parms, DesiredIndex), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_InsertBoneTrack_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventInsertBoneTrack_Parms), &Z_Construct_UFunction_UAnimationDataController_InsertBoneTrack_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAnimationDataController_InsertBoneTrack_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventInsertBoneTrack_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UAnimationDataController_InsertBoneTrack_Statics::Function_MetaDataParams[] = {
		{ "Category", "AnimationData" },
		{ "Comment", "/**\n\x09* Inserts a new bone animation track for the provided name, at the provided index. Broadcasts a EAnimDataModelNotifyType::TrackAdded notify if successful.\n\x09* The bone name is verified with the AnimModel's outer target USkeleton to ensure the bone exists.\n\x09*\n\x09* @param\x09""BoneName\x09\x09\x09""Bone name for which a track should be inserted\n\x09* @param\x09""DesiredIndex\x09\x09Index at which the track should be inserted\n\x09* @param\x09""bShouldTransact\x09\x09Whether or not any undo-redo changes should be generated\n\x09*\n\x09* @return\x09The index at which the bone track was inserted, INDEX_NONE if the insertion failed\n\x09*/" },
		{ "CPP_Default_bShouldTransact", "true" },
		{ "ModuleRelativePath", "Classes/Animation/AnimData/IAnimationDataController.h" },
		{ "ToolTip", "Inserts a new bone animation track for the provided name, at the provided index. Broadcasts a EAnimDataModelNotifyType::TrackAdded notify if successful.\nThe bone name is verified with the AnimModel's outer target USkeleton to ensure the bone exists.\n\n@param        BoneName                        Bone name for which a track should be inserted\n@param        DesiredIndex            Index at which the track should be inserted\n@param        bShouldTransact         Whether or not any undo-redo changes should be generated\n\n@return       The index at which the bone track was inserted, INDEX_NONE if the insertion failed" },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_OpenBracket_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventOpenBracket_Parms), &Z_Construct_UFunction_UAnimationDataController_OpenBracket_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributes_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveAllAttributes_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributes_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributes_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveAllAttributes_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributesForBone_Statics::NewProp_BoneName = { "BoneName", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveAllAttributesForBone_Parms, BoneName), METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributesForBone_Statics::NewProp_BoneName_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributesForBone_Statics::NewProp_BoneName_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributesForBone_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveAllAttributesForBone_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributesForBone_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributesForBone_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveAllAttributesForBone_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAllBoneTracks_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveAllBoneTracks_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveAllBoneTracks_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAllCurvesOfType_Statics::NewProp_SupportedCurveType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAllCurvesOfType_Statics::NewProp_SupportedCurveType = { "SupportedCurveType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveAllCurvesOfType_Parms, SupportedCurveType), Z_Construct_UEnum_Engine_ERawCurveTrackTypes, METADATA_PARAMS(nullptr, 0) }; // 1535854795
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAllCurvesOfType_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveAllCurvesOfType_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveAllCurvesOfType_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAttribute_Statics::NewProp_AttributeIdentifier = { "AttributeIdentifier", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveAttribute_Parms, AttributeIdentifier), Z_Construct_UScriptStruct_FAnimationAttributeIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_RemoveAttribute_Statics::NewProp_AttributeIdentifier_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_RemoveAttribute_Statics::NewProp_AttributeIdentifier_MetaData)) }; // 4209166089
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAttribute_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveAttribute_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveAttribute_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAttribute_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveAttribute_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveAttribute_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAttributeKey_Statics::NewProp_AttributeIdentifier = { "AttributeIdentifier", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveAttributeKey_Parms, AttributeIdentifier), Z_Construct_UScriptStruct_FAnimationAttributeIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_RemoveAttributeKey_Statics::NewProp_AttributeIdentifier_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_RemoveAttributeKey_Statics::NewProp_AttributeIdentifier_MetaData)) }; // 4209166089
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAttributeKey_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveAttributeKey_Parms, Time), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAttributeKey_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveAttributeKey_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveAttributeKey_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveAttributeKey_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveAttributeKey_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveAttributeKey_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveBoneTrack_Statics::NewProp_BoneName = { "BoneName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveBoneTrack_Parms, BoneName), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveBoneTrack_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveBoneTrack_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveBoneTrack_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveBoneTrack_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveBoneTrack_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveBoneTrack_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveCurve_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveCurve_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_RemoveCurve_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_RemoveCurve_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveCurve_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveCurve_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveCurve_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveCurve_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveCurve_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveCurve_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveCurveKey_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveCurveKey_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_RemoveCurveKey_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_RemoveCurveKey_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveCurveKey_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveCurveKey_Parms, Time), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveCurveKey_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveCurveKey_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveCurveKey_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveCurveKey_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveCurveKey_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveCurveKey_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveTransformCurveKey_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveTransformCurveKey_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_RemoveTransformCurveKey_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_RemoveTransformCurveKey_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveTransformCurveKey_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRemoveTransformCurveKey_Parms, Time), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveTransformCurveKey_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveTransformCurveKey_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveTransformCurveKey_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RemoveTransformCurveKey_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRemoveTransformCurveKey_Parms), &Z_Construct_UFunction_UAnimationDataController_RemoveTransformCurveKey_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_RenameCurve_Statics::NewProp_CurveToRenameId = { "CurveToRenameId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRenameCurve_Parms, CurveToRenameId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_RenameCurve_Statics::NewProp_CurveToRenameId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_RenameCurve_Statics::NewProp_CurveToRenameId_MetaData)) }; // 3166900084
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_RenameCurve_Statics::NewProp_NewCurveId = { "NewCurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventRenameCurve_Parms, NewCurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_RenameCurve_Statics::NewProp_NewCurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_RenameCurve_Statics::NewProp_NewCurveId_MetaData)) }; // 3166900084
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RenameCurve_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRenameCurve_Parms), &Z_Construct_UFunction_UAnimationDataController_RenameCurve_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_RenameCurve_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventRenameCurve_Parms), &Z_Construct_UFunction_UAnimationDataController_RenameCurve_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_Resize_Statics::NewProp_Length = { "Length", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventResize_Parms, Length), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_Resize_Statics::NewProp_T0 = { "T0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventResize_Parms, T0), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_Resize_Statics::NewProp_T1 = { "T1", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventResize_Parms, T1), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_Resize_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventResize_Parms), &Z_Construct_UFunction_UAnimationDataController_Resize_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_ResizePlayLength_Statics::NewProp_NewLength = { "NewLength", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventResizePlayLength_Parms, NewLength), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_ResizePlayLength_Statics::NewProp_T0 = { "T0", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventResizePlayLength_Parms, T0), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_ResizePlayLength_Statics::NewProp_T1 = { "T1", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventResizePlayLength_Parms, T1), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_ResizePlayLength_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventResizePlayLength_Parms), &Z_Construct_UFunction_UAnimationDataController_ResizePlayLength_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_ScaleCurve_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventScaleCurve_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_ScaleCurve_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_ScaleCurve_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_ScaleCurve_Statics::NewProp_Origin = { "Origin", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventScaleCurve_Parms, Origin), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_ScaleCurve_Statics::NewProp_Factor = { "Factor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventScaleCurve_Parms, Factor), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_ScaleCurve_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventScaleCurve_Parms), &Z_Construct_UFunction_UAnimationDataController_ScaleCurve_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_ScaleCurve_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventScaleCurve_Parms), &Z_Construct_UFunction_UAnimationDataController_ScaleCurve_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_BoneName = { "BoneName", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetBoneTrackKeys_Parms, BoneName), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_PositionalKeys_Inner = { "PositionalKeys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_PositionalKeys = { "PositionalKeys", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetBoneTrackKeys_Parms, PositionalKeys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_PositionalKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_PositionalKeys_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_RotationalKeys_Inner = { "RotationalKeys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FQuat, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_RotationalKeys = { "RotationalKeys", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetBoneTrackKeys_Parms, RotationalKeys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_RotationalKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_RotationalKeys_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_ScalingKeys_Inner = { "ScalingKeys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_ScalingKeys = { "ScalingKeys", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetBoneTrackKeys_Parms, ScalingKeys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_ScalingKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_ScalingKeys_MetaData)) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetBoneTrackKeys_Parms), &Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetBoneTrackKeys_Parms), &Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveColor_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetCurveColor_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetCurveColor_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetCurveColor_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveColor_Statics::NewProp_Color = { "Color", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetCurveColor_Parms, Color), Z_Construct_UScriptStruct_FLinearColor, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveColor_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveColor_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveColor_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveColor_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveColor_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveColor_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveFlag_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetCurveFlag_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetCurveFlag_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetCurveFlag_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveFlag_Statics::NewProp_Flag = { "Flag", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetCurveFlag_Parms, Flag), Z_Construct_UEnum_Engine_EAnimAssetCurveFlags, METADATA_PARAMS(nullptr, 0) }; // 1645145010
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveFlag_Statics::NewProp_bState = { "bState", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveFlag_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveFlag_Statics::NewProp_bState_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveFlag_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveFlag_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveFlag_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveFlag_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveFlag_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveFlag_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveFlags_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetCurveFlags_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetCurveFlags_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetCurveFlags_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveFlags_Statics::NewProp_Flags = { "Flags", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetCurveFlags_Parms, Flags), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveFlags_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveFlags_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveFlags_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveFlags_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveFlags_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveFlags_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveKey_Statics::NewProp_Key = { "Key", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetCurveKey_Parms, Key), Z_Construct_UScriptStruct_FRichCurveKey, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetCurveKey_Statics::NewProp_Key_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetCurveKey_Statics::NewProp_Key_MetaData)) }; // 3659647756
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveKey_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveKey_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveKey_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveKey_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveKey_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveKey_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetCurveKeys_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_CurveKeys_Inner = { "CurveKeys", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FRichCurveKey, METADATA_PARAMS(nullptr, 0) }; // 3659647756
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_CurveKeys = { "CurveKeys", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetCurveKeys_Parms, CurveKeys), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_CurveKeys_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_CurveKeys_MetaData)) }; // 3659647756
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveKeys_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetCurveKeys_Parms), &Z_Construct_UFunction_UAnimationDataController_SetCurveKeys_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetFrameRate_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetFrameRate_Parms, FrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetFrameRate_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetFrameRate_Parms), &Z_Construct_UFunction_UAnimationDataController_SetFrameRate_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	struct Z_Construct_UFunction_UAnimationDataController_SetModel_Statics
	{
		...
		static const UECodeGen_Private::FObjectPropertyParams NewProp_InModel;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimationDataController_SetModel_Statics::NewProp_InModel = { "InModel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetModel_Parms, InModel), Z_Construct_UClass_UAnimDataModel_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_SetPlayLength_Statics::NewProp_Length = { "Length", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetPlayLength_Parms, Length), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetPlayLength_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetPlayLength_Parms), &Z_Construct_UFunction_UAnimationDataController_SetPlayLength_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKey_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetTransformCurveKey_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKey_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKey_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKey_Statics::NewProp_Time = { "Time", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetTransformCurveKey_Parms, Time), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKey_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetTransformCurveKey_Parms), &Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKey_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKey_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetTransformCurveKey_Parms), &Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKey_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKeys_Statics::NewProp_CurveId = { "CurveId", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventSetTransformCurveKeys_Parms, CurveId), Z_Construct_UScriptStruct_FAnimationCurveIdentifier, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKeys_Statics::NewProp_CurveId_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKeys_Statics::NewProp_CurveId_MetaData)) }; // 3166900084
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKeys_Statics::NewProp_TransformValues_Inner = { "TransformValues", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKeys_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetTransformCurveKeys_Parms), &Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKeys_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKeys_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventSetTransformCurveKeys_Parms), &Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKeys_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAnimationDataController_UpdateCurveNamesFromSkeleton_Statics::NewProp_Skeleton = { "Skeleton", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventUpdateCurveNamesFromSkeleton_Parms, Skeleton), Z_Construct_UClass_USkeleton_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UAnimationDataController_UpdateCurveNamesFromSkeleton_Statics::NewProp_Skeleton_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UAnimationDataController_UpdateCurveNamesFromSkeleton_Statics::NewProp_Skeleton_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UAnimationDataController_UpdateCurveNamesFromSkeleton_Statics::NewProp_SupportedCurveType_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UAnimationDataController_UpdateCurveNamesFromSkeleton_Statics::NewProp_SupportedCurveType = { "SupportedCurveType", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AnimationDataController_eventUpdateCurveNamesFromSkeleton_Parms, SupportedCurveType), Z_Construct_UEnum_Engine_ERawCurveTrackTypes, METADATA_PARAMS(nullptr, 0) }; // 1535854795
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAnimationDataController_UpdateCurveNamesFromSkeleton_Statics::NewProp_bShouldTransact = { "bShouldTransact", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AnimationDataController_eventUpdateCurveNamesFromSkeleton_Parms), &Z_Construct_UFunction_UAnimationDataController_UpdateCurveNamesFromSkeleton_Statics::NewProp_bShouldTransact_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAnimationDataController_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAnimationDataController_AddAttribute, "AddAttribute" }, // 3761451991
		{ &Z_Construct_UFunction_UAnimationDataController_AddBoneTrack, "AddBoneTrack" }, // 55934948
		{ &Z_Construct_UFunction_UAnimationDataController_AddCurve, "AddCurve" }, // 3713149161
		{ &Z_Construct_UFunction_UAnimationDataController_CloseBracket, "CloseBracket" }, // 2646088986
		{ &Z_Construct_UFunction_UAnimationDataController_DuplicateAttribute, "DuplicateAttribute" }, // 472177027
		{ &Z_Construct_UFunction_UAnimationDataController_DuplicateCurve, "DuplicateCurve" }, // 2116119170
		{ &Z_Construct_UFunction_UAnimationDataController_FindOrAddCurveNamesOnSkeleton, "FindOrAddCurveNamesOnSkeleton" }, // 993885961
		{ &Z_Construct_UFunction_UAnimationDataController_GetModel, "GetModel" }, // 2689449074
		{ &Z_Construct_UFunction_UAnimationDataController_InsertBoneTrack, "InsertBoneTrack" }, // 3581282156
		{ &Z_Construct_UFunction_UAnimationDataController_OpenBracket, "OpenBracket" }, // 820130426
		{ &Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributes, "RemoveAllAttributes" }, // 1591575247
		{ &Z_Construct_UFunction_UAnimationDataController_RemoveAllAttributesForBone, "RemoveAllAttributesForBone" }, // 4189949406
		{ &Z_Construct_UFunction_UAnimationDataController_RemoveAllBoneTracks, "RemoveAllBoneTracks" }, // 3039627555
		{ &Z_Construct_UFunction_UAnimationDataController_RemoveAllCurvesOfType, "RemoveAllCurvesOfType" }, // 1460183761
		{ &Z_Construct_UFunction_UAnimationDataController_RemoveAttribute, "RemoveAttribute" }, // 1177080154
		{ &Z_Construct_UFunction_UAnimationDataController_RemoveAttributeKey, "RemoveAttributeKey" }, // 3305264951
		{ &Z_Construct_UFunction_UAnimationDataController_RemoveBoneTrack, "RemoveBoneTrack" }, // 662731134
		{ &Z_Construct_UFunction_UAnimationDataController_RemoveCurve, "RemoveCurve" }, // 660798171
		{ &Z_Construct_UFunction_UAnimationDataController_RemoveCurveKey, "RemoveCurveKey" }, // 909714155
		{ &Z_Construct_UFunction_UAnimationDataController_RemoveTransformCurveKey, "RemoveTransformCurveKey" }, // 163618620
		{ &Z_Construct_UFunction_UAnimationDataController_RenameCurve, "RenameCurve" }, // 2798311252
		{ &Z_Construct_UFunction_UAnimationDataController_Resize, "Resize" }, // 3827134115
		{ &Z_Construct_UFunction_UAnimationDataController_ResizePlayLength, "ResizePlayLength" }, // 2372866
		{ &Z_Construct_UFunction_UAnimationDataController_ScaleCurve, "ScaleCurve" }, // 4245814885
		{ &Z_Construct_UFunction_UAnimationDataController_SetBoneTrackKeys, "SetBoneTrackKeys" }, // 3553950286
		{ &Z_Construct_UFunction_UAnimationDataController_SetCurveColor, "SetCurveColor" }, // 1669820002
		{ &Z_Construct_UFunction_UAnimationDataController_SetCurveFlag, "SetCurveFlag" }, // 2503620326
		{ &Z_Construct_UFunction_UAnimationDataController_SetCurveFlags, "SetCurveFlags" }, // 833957181
		{ &Z_Construct_UFunction_UAnimationDataController_SetCurveKey, "SetCurveKey" }, // 3578310765
		{ &Z_Construct_UFunction_UAnimationDataController_SetCurveKeys, "SetCurveKeys" }, // 2701648474
		{ &Z_Construct_UFunction_UAnimationDataController_SetFrameRate, "SetFrameRate" }, // 2327870816
		{ &Z_Construct_UFunction_UAnimationDataController_SetModel, "SetModel" }, // 2296647569
		{ &Z_Construct_UFunction_UAnimationDataController_SetPlayLength, "SetPlayLength" }, // 2801025779
		{ &Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKey, "SetTransformCurveKey" }, // 3113569407
		{ &Z_Construct_UFunction_UAnimationDataController_SetTransformCurveKeys, "SetTransformCurveKeys" }, // 1563336564
		{ &Z_Construct_UFunction_UAnimationDataController_UpdateCurveNamesFromSkeleton, "UpdateCurveNamesFromSkeleton" }, // 152347118
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimData_IAnimationDataController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAnimationDataController, UAnimationDataController::StaticClass, TEXT("UAnimationDataController"), &Z_Registration_Info_UClass_UAnimationDataController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimationDataController), 3071473638U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_AnimData_IAnimationDataController_h_804998631(TEXT("/Script/Engine"),
