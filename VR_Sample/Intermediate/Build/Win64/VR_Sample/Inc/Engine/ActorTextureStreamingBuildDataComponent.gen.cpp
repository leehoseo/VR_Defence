...
#include "Engine/Public/Streaming/ActorTextureStreamingBuildDataComponent.h"
...
class UScriptStruct* FStreamableTexture::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_StreamableTexture.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FStreamableTexture, Z_Construct_UPackage__Script_Engine(), TEXT("StreamableTexture"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FStreamableTexture>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FStreamableTexture_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FStreamableTexture, Name), METADATA_PARAMS(Z_Construct_UScriptStruct_FStreamableTexture_Statics::NewProp_Name_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStreamableTexture_Statics::NewProp_Name_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FStreamableTexture_Statics::NewProp_Guid_MetaData[] = {
		{ "ModuleRelativePath", "Public/Streaming/ActorTextureStreamingBuildDataComponent.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FStreamableTexture_Statics::NewProp_Guid = { "Guid", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FStreamableTexture, Guid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FStreamableTexture_Statics::NewProp_Guid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FStreamableTexture_Statics::NewProp_Guid_MetaData)) };
...
#endif
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UActorTextureStreamingBuildDataComponent_Statics::NewProp_StreamableTextures_Inner = { "StreamableTextures", nullptr, (EPropertyFlags)0x0000000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FStreamableTexture, METADATA_PARAMS(nullptr, 0) }; // 1266227244
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UActorTextureStreamingBuildDataComponent_Statics::NewProp_StreamableTextures = { "StreamableTextures", nullptr, (EPropertyFlags)0x0040000800000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UActorTextureStreamingBuildDataComponent, StreamableTextures), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UActorTextureStreamingBuildDataComponent_Statics::NewProp_StreamableTextures_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UActorTextureStreamingBuildDataComponent_Statics::NewProp_StreamableTextures_MetaData)) }; // 1266227244
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Streaming_ActorTextureStreamingBuildDataComponent_h_Statics::ScriptStructInfo[] = {
		{ FStreamableTexture::StaticStruct, Z_Construct_UScriptStruct_FStreamableTexture_Statics::NewStructOps, TEXT("StreamableTexture"), &Z_Registration_Info_UScriptStruct_StreamableTexture, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FStreamableTexture), 1266227244U) },
	};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Streaming_ActorTextureStreamingBuildDataComponent_h_1865914192(TEXT("/Script/Engine"),
