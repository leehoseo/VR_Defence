...
#include "Engine/Public/WorldPartition/HLOD/HLODSubActor.h"
...
class UScriptStruct* FHLODSubActorDesc::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HLODSubActorDesc.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHLODSubActorDesc, Z_Construct_UPackage__Script_Engine(), TEXT("HLODSubActorDesc"));
	}
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHLODSubActorDesc_Statics::NewProp_ContainerID = { "ContainerID", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHLODSubActorDesc, ContainerID), Z_Construct_UScriptStruct_FActorContainerID, METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODSubActorDesc_Statics::NewProp_ContainerID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODSubActorDesc_Statics::NewProp_ContainerID_MetaData)) }; // 3032495807
...
class UScriptStruct* FHLODSubActor::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_HLODSubActor.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FHLODSubActor, Z_Construct_UPackage__Script_Engine(), TEXT("HLODSubActor"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FHLODSubActor>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorGuid = { "ActorGuid", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHLODSubActor, ActorGuid), Z_Construct_UScriptStruct_FGuid, METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorGuid_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorGuid_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorPackage_MetaData[] = {
		{ "ModuleRelativePath", "Public/WorldPartition/HLOD/HLODSubActor.h" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorPackage = { "ActorPackage", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHLODSubActor, ActorPackage), METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorPackage_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorPackage_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorPath_MetaData[] = {
		{ "ModuleRelativePath", "Public/WorldPartition/HLOD/HLODSubActor.h" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorPath = { "ActorPath", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHLODSubActor, ActorPath), METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ActorPath_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ContainerID_MetaData[] = {
		{ "ModuleRelativePath", "Public/WorldPartition/HLOD/HLODSubActor.h" },
	};
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ContainerID = { "ContainerID", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHLODSubActor, ContainerID), Z_Construct_UScriptStruct_FActorContainerID, METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ContainerID_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ContainerID_MetaData)) }; // 3032495807
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ContainerTransform = { "ContainerTransform", nullptr, (EPropertyFlags)0x0010000800000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FHLODSubActor, ContainerTransform), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ContainerTransform_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewProp_ContainerTransform_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_HLOD_HLODSubActor_h_Statics::ScriptStructInfo[] = {
		{ FHLODSubActorDesc::StaticStruct, Z_Construct_UScriptStruct_FHLODSubActorDesc_Statics::NewStructOps, TEXT("HLODSubActorDesc"), &Z_Registration_Info_UScriptStruct_HLODSubActorDesc, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHLODSubActorDesc), 4024909252U) },
		{ FHLODSubActor::StaticStruct, Z_Construct_UScriptStruct_FHLODSubActor_Statics::NewStructOps, TEXT("HLODSubActor"), &Z_Registration_Info_UScriptStruct_HLODSubActor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FHLODSubActor), 2045593302U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_WorldPartition_HLOD_HLODSubActor_h_1448497576(TEXT("/Script/Engine"),
		nullptr, 0,
