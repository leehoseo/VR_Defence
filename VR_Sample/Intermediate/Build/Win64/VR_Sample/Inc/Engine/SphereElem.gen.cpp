...
class UScriptStruct* FKSphereElem::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_KSphereElem.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FKSphereElem, Z_Construct_UPackage__Script_Engine(), TEXT("KSphereElem"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FKSphereElem>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKSphereElem_Statics::NewProp_TM = { "TM", nullptr, (EPropertyFlags)0x0010000820000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FKSphereElem, TM_DEPRECATED), Z_Construct_UScriptStruct_FMatrix, METADATA_PARAMS(Z_Construct_UScriptStruct_FKSphereElem_Statics::NewProp_TM_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FKSphereElem_Statics::NewProp_TM_MetaData)) };
#endif // WITH_EDITORONLY_DATA
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_SphereElem_h_Statics::ScriptStructInfo[] = {
		{ FKSphereElem::StaticStruct, Z_Construct_UScriptStruct_FKSphereElem_Statics::NewStructOps, TEXT("KSphereElem"), &Z_Registration_Info_UScriptStruct_KSphereElem, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FKSphereElem), 3913292171U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_PhysicsEngine_SphereElem_h_334180998(TEXT("/Script/Engine"),
		nullptr, 0,
