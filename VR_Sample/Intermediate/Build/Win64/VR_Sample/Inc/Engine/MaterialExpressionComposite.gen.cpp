...
#include "Engine/Classes/Materials/MaterialExpressionComposite.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMaterialExpressionComposite_Statics::NewProp_InputExpressions = { "InputExpressions", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionComposite, InputExpressions), Z_Construct_UClass_UMaterialExpressionPinBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionComposite_Statics::NewProp_InputExpressions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionComposite_Statics::NewProp_InputExpressions_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_UMaterialExpressionComposite_Statics::NewProp_OutputExpressions = { "OutputExpressions", nullptr, (EPropertyFlags)0x0014000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionComposite, OutputExpressions), Z_Construct_UClass_UMaterialExpressionPinBase_NoRegister, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionComposite_Statics::NewProp_OutputExpressions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionComposite_Statics::NewProp_OutputExpressions_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionComposite_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMaterialExpressionComposite, UMaterialExpressionComposite::StaticClass, TEXT("UMaterialExpressionComposite"), &Z_Registration_Info_UClass_UMaterialExpressionComposite, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMaterialExpressionComposite), 286810577U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionComposite_h_144834584(TEXT("/Script/Engine"),
