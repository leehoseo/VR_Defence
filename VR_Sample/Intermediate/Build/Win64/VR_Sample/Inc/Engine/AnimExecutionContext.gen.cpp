...
#include "Engine/Classes/Animation/AnimExecutionContext.h"
...
// End Cross Module References
	...
	static UEnum* EAnimExecutionContextConversionResult_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EAnimExecutionContextConversionResult.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_EAnimExecutionContextConversionResult, Z_Construct_UPackage__Script_Engine(), TEXT("EAnimExecutionContextConversionResult"));
		}
...
class UScriptStruct* FAnimExecutionContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimExecutionContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimExecutionContext, Z_Construct_UPackage__Script_Engine(), TEXT("AnimExecutionContext"));
	}
...
class UScriptStruct* FAnimInitializationContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimInitializationContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimInitializationContext, Z_Construct_UPackage__Script_Engine(), TEXT("AnimInitializationContext"));
	}
...
class UScriptStruct* FAnimUpdateContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimUpdateContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimUpdateContext, Z_Construct_UPackage__Script_Engine(), TEXT("AnimUpdateContext"));
	}
...
class UScriptStruct* FAnimPoseContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimPoseContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimPoseContext, Z_Construct_UPackage__Script_Engine(), TEXT("AnimPoseContext"));
	}
...
class UScriptStruct* FAnimComponentSpacePoseContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimComponentSpacePoseContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimComponentSpacePoseContext, Z_Construct_UPackage__Script_Engine(), TEXT("AnimComponentSpacePoseContext"));
	}
