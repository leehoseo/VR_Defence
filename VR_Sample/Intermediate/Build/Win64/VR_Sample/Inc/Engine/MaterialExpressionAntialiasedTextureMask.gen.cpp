...
// End Cross Module References
	...
	static UEnum* ETextureColorChannel_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETextureColorChannel.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ETextureColorChannel, Z_Construct_UPackage__Script_Engine(), TEXT("ETextureColorChannel"));
		}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Threshold = { "Threshold", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionAntialiasedTextureMask, Threshold), METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Threshold_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Threshold_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Channel = { "Channel", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMaterialExpressionAntialiasedTextureMask, Channel), Z_Construct_UEnum_Engine_ETextureColorChannel, METADATA_PARAMS(Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Channel_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMaterialExpressionAntialiasedTextureMask_Statics::NewProp_Channel_MetaData)) }; // 3335087961
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Materials_MaterialExpressionAntialiasedTextureMask_h_582951162(TEXT("/Script/Engine"),
