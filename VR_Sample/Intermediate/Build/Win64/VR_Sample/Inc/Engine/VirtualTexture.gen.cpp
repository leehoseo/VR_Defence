...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_Settings = { "Settings", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UVirtualTexture2D, Settings), Z_Construct_UScriptStruct_FVirtualTextureBuildSettings, METADATA_PARAMS(Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_Settings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_Settings_MetaData)) }; // 2376145579
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_bContinuousUpdate = { "bContinuousUpdate", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UVirtualTexture2D), &Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_bContinuousUpdate_SetBit, METADATA_PARAMS(Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_bContinuousUpdate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_bContinuousUpdate_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_bSinglePhysicalSpace = { "bSinglePhysicalSpace", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UVirtualTexture2D), &Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_bSinglePhysicalSpace_SetBit, METADATA_PARAMS(Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_bSinglePhysicalSpace_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UVirtualTexture2D_Statics::NewProp_bSinglePhysicalSpace_MetaData)) };
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_VirtualTexture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVirtualTexture, UVirtualTexture::StaticClass, TEXT("UVirtualTexture"), &Z_Registration_Info_UClass_UVirtualTexture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVirtualTexture), 3504614190U) },
		{ Z_Construct_UClass_ULightMapVirtualTexture, ULightMapVirtualTexture::StaticClass, TEXT("ULightMapVirtualTexture"), &Z_Registration_Info_UClass_ULightMapVirtualTexture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULightMapVirtualTexture), 1077262434U) },
		{ Z_Construct_UClass_URuntimeVirtualTextureStreamingProxy, URuntimeVirtualTextureStreamingProxy::StaticClass, TEXT("URuntimeVirtualTextureStreamingProxy"), &Z_Registration_Info_UClass_URuntimeVirtualTextureStreamingProxy, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(URuntimeVirtualTextureStreamingProxy), 3331935110U) },
		{ Z_Construct_UClass_UVirtualTexture2D, UVirtualTexture2D::StaticClass, TEXT("UVirtualTexture2D"), &Z_Registration_Info_UClass_UVirtualTexture2D, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVirtualTexture2D), 3975339373U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_VirtualTexture_h_760897185(TEXT("/Script/Engine"),
