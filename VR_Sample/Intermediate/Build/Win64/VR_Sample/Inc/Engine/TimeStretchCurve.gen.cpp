...
// End Cross Module References
	...
	static UEnum* ETimeStretchCurveMapping_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ETimeStretchCurveMapping.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_Engine_ETimeStretchCurveMapping, Z_Construct_UPackage__Script_Engine(), TEXT("ETimeStretchCurveMapping"));
		}
...
class UScriptStruct* FTimeStretchCurveMarker::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TimeStretchCurveMarker.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTimeStretchCurveMarker, Z_Construct_UPackage__Script_Engine(), TEXT("TimeStretchCurveMarker"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::NewProp_Alpha = { "Alpha", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTimeStretchCurveMarker, Alpha), METADATA_PARAMS(Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::NewProp_Alpha_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::NewProp_Alpha_MetaData)) };
...
class UScriptStruct* FTimeStretchCurve::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TimeStretchCurve.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTimeStretchCurve, Z_Construct_UPackage__Script_Engine(), TEXT("TimeStretchCurve"));
	}
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_SamplingRate = { "SamplingRate", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTimeStretchCurve, SamplingRate), METADATA_PARAMS(Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_SamplingRate_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_SamplingRate_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_CurveValueMinPrecision = { "CurveValueMinPrecision", nullptr, (EPropertyFlags)0x0040000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FTimeStretchCurve, CurveValueMinPrecision), METADATA_PARAMS(Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_CurveValueMinPrecision_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_CurveValueMinPrecision_MetaData)) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewProp_Markers_Inner = { "Markers", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FTimeStretchCurveMarker, METADATA_PARAMS(nullptr, 0) }; // 1705029834
#if WITH_METADATA
...
class UScriptStruct* FTimeStretchCurveInstance::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_TimeStretchCurveInstance.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FTimeStretchCurveInstance, Z_Construct_UPackage__Script_Engine(), TEXT("TimeStretchCurveInstance"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FTimeStretchCurveInstance>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::NewProp_bHasValidData = { "bHasValidData", nullptr, (EPropertyFlags)0x0040000000002000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FTimeStretchCurveInstance), &Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::NewProp_bHasValidData_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::NewProp_bHasValidData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::NewProp_bHasValidData_MetaData)) };
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_TimeStretchCurve_h_Statics::ScriptStructInfo[] = {
		{ FTimeStretchCurveMarker::StaticStruct, Z_Construct_UScriptStruct_FTimeStretchCurveMarker_Statics::NewStructOps, TEXT("TimeStretchCurveMarker"), &Z_Registration_Info_UScriptStruct_TimeStretchCurveMarker, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTimeStretchCurveMarker), 1705029834U) },
		{ FTimeStretchCurve::StaticStruct, Z_Construct_UScriptStruct_FTimeStretchCurve_Statics::NewStructOps, TEXT("TimeStretchCurve"), &Z_Registration_Info_UScriptStruct_TimeStretchCurve, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTimeStretchCurve), 447144289U) },
		{ FTimeStretchCurveInstance::StaticStruct, Z_Construct_UScriptStruct_FTimeStretchCurveInstance_Statics::NewStructOps, TEXT("TimeStretchCurveInstance"), &Z_Registration_Info_UScriptStruct_TimeStretchCurveInstance, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FTimeStretchCurveInstance), 1712788986U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_Animation_TimeStretchCurve_h_4283065499(TEXT("/Script/Engine"),
		nullptr, 0,
