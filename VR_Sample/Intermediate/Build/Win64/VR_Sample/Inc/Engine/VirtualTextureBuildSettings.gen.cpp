...
class UScriptStruct* FVirtualTextureBuildSettings::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_VirtualTextureBuildSettings.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVirtualTextureBuildSettings, Z_Construct_UPackage__Script_Engine(), TEXT("VirtualTextureBuildSettings"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FVirtualTextureBuildSettings>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bEnableCompressZlib_MetaData[];
#endif
		static void NewProp_bEnableCompressZlib_SetBit(void* Obj);
		static const UECodeGen_Private::FBoolPropertyParams NewProp_bEnableCompressZlib;
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_TileSize = { "TileSize", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FVirtualTextureBuildSettings, TileSize), METADATA_PARAMS(Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_TileSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_TileSize_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_TileBorderSize = { "TileBorderSize", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FVirtualTextureBuildSettings, TileBorderSize), METADATA_PARAMS(Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_TileBorderSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_TileBorderSize_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressCrunch_MetaData[] = {
		{ "ModuleRelativePath", "Classes/VT/VirtualTextureBuildSettings.h" },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressCrunch = { "bEnableCompressCrunch", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FVirtualTextureBuildSettings), &Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressCrunch_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressCrunch_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressCrunch_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressZlib_MetaData[] = {
		{ "ModuleRelativePath", "Classes/VT/VirtualTextureBuildSettings.h" },
	};
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressZlib = { "bEnableCompressZlib", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FVirtualTextureBuildSettings), &Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressZlib_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressZlib_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressZlib_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressCrunch,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewProp_bEnableCompressZlib,
	};
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_VirtualTextureBuildSettings_h_Statics::ScriptStructInfo[] = {
		{ FVirtualTextureBuildSettings::StaticStruct, Z_Construct_UScriptStruct_FVirtualTextureBuildSettings_Statics::NewStructOps, TEXT("VirtualTextureBuildSettings"), &Z_Registration_Info_UScriptStruct_VirtualTextureBuildSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVirtualTextureBuildSettings), 2376145579U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Classes_VT_VirtualTextureBuildSettings_h_3045221923(TEXT("/Script/Engine"),
		nullptr, 0,
