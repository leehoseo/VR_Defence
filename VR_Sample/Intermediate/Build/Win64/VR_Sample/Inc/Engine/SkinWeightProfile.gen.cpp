...
class UScriptStruct* FSkinWeightProfileInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SkinWeightProfileInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSkinWeightProfileInfo, Z_Construct_UPackage__Script_Engine(), TEXT("SkinWeightProfileInfo"));
	}
...
template<> ENGINE_API UScriptStruct* StaticStruct<FSkinWeightProfileInfo>()
{
...
#if WITH_EDITORONLY_DATA
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Statics::NewProp_PerLODSourceFiles_ValueProp = { "PerLODSourceFiles", nullptr, (EPropertyFlags)0x0000000800020001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 1, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Statics::NewProp_PerLODSourceFiles_Key_KeyProp = { "PerLODSourceFiles_Key", nullptr, (EPropertyFlags)0x0000000800020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_SkinWeightProfile_h_Statics::ScriptStructInfo[] = {
		{ FSkinWeightProfileInfo::StaticStruct, Z_Construct_UScriptStruct_FSkinWeightProfileInfo_Statics::NewStructOps, TEXT("SkinWeightProfileInfo"), &Z_Registration_Info_UScriptStruct_SkinWeightProfileInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSkinWeightProfileInfo), 1000585986U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_Engine_Public_Animation_SkinWeightProfile_h_1542086521(TEXT("/Script/Engine"),
		nullptr, 0,
