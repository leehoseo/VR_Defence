...
class UScriptStruct* FClothVertBoneData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_ClothVertBoneData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FClothVertBoneData, Z_Construct_UPackage__Script_ClothingSystemRuntimeInterface(), TEXT("ClothVertBoneData"));
	}
...
template<> CLOTHINGSYSTEMRUNTIMEINTERFACE_API UScriptStruct* StaticStruct<FClothVertBoneData>()
{
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FClothVertBoneData_Statics::NewProp_NumInfluences = { "NumInfluences", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FClothVertBoneData, NumInfluences), METADATA_PARAMS(Z_Construct_UScriptStruct_FClothVertBoneData_Statics::NewProp_NumInfluences_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FClothVertBoneData_Statics::NewProp_NumInfluences_MetaData)) };
#if WITH_METADATA
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeInterface_Public_ClothVertBoneData_h_Statics::ScriptStructInfo[] = {
		{ FClothVertBoneData::StaticStruct, Z_Construct_UScriptStruct_FClothVertBoneData_Statics::NewStructOps, TEXT("ClothVertBoneData"), &Z_Registration_Info_UScriptStruct_ClothVertBoneData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FClothVertBoneData), 3010309394U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeInterface_Public_ClothVertBoneData_h_3564316055(TEXT("/Script/ClothingSystemRuntimeInterface"),
		nullptr, 0,
