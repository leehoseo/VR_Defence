...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UClothingAssetBase_Statics::NewProp_ImportedFilePath = { "ImportedFilePath", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UClothingAssetBase, ImportedFilePath), METADATA_PARAMS(Z_Construct_UClass_UClothingAssetBase_Statics::NewProp_ImportedFilePath_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UClothingAssetBase_Statics::NewProp_ImportedFilePath_MetaData)) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeInterface_Public_ClothingAssetBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UClothingAssetBase, UClothingAssetBase::StaticClass, TEXT("UClothingAssetBase"), &Z_Registration_Info_UClass_UClothingAssetBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UClothingAssetBase), 340273754U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeInterface_Public_ClothingAssetBase_h_3496882109(TEXT("/Script/ClothingSystemRuntimeInterface"),
