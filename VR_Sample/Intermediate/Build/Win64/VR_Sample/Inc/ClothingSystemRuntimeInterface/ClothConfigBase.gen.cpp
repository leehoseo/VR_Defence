...
// End Cross Module References
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeInterface_Public_ClothConfigBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UClothConfigBase, UClothConfigBase::StaticClass, TEXT("UClothConfigBase"), &Z_Registration_Info_UClass_UClothConfigBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UClothConfigBase), 926856368U) },
		{ Z_Construct_UClass_UDEPRECATED_ClothSharedSimConfigBase, UDEPRECATED_ClothSharedSimConfigBase::StaticClass, TEXT("UDEPRECATED_ClothSharedSimConfigBase"), &Z_Registration_Info_UClass_UDEPRECATED_ClothSharedSimConfigBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UDEPRECATED_ClothSharedSimConfigBase), 2264021910U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_ClothingSystemRuntimeInterface_Public_ClothConfigBase_h_1485671803(TEXT("/Script/ClothingSystemRuntimeInterface"),
