...
#include "AudioLinkEngine/Public/IAudioLinkBlueprintInterface.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UAudioLinkBlueprintInterface_IsLinkPlaying_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AudioLinkBlueprintInterface_eventIsLinkPlaying_Parms), &Z_Construct_UFunction_UAudioLinkBlueprintInterface_IsLinkPlaying_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UAudioLinkBlueprintInterface_PlayLink_Statics::NewProp_StartTime = { "StartTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioLinkBlueprintInterface_eventPlayLink_Parms, StartTime), METADATA_PARAMS(nullptr, 0) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UAudioLinkBlueprintInterface_SetLinkSound_Statics::NewProp_NewSound = { "NewSound", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AudioLinkBlueprintInterface_eventSetLinkSound_Parms, NewSound), Z_Construct_UClass_USoundBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAudioLinkBlueprintInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAudioLinkBlueprintInterface_IsLinkPlaying, "IsLinkPlaying" }, // 3084911684
		{ &Z_Construct_UFunction_UAudioLinkBlueprintInterface_PlayLink, "PlayLink" }, // 227992344
		{ &Z_Construct_UFunction_UAudioLinkBlueprintInterface_SetLinkSound, "SetLinkSound" }, // 2315642270
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioLink_AudioLinkEngine_Public_IAudioLinkBlueprintInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAudioLinkBlueprintInterface, UAudioLinkBlueprintInterface::StaticClass, TEXT("UAudioLinkBlueprintInterface"), &Z_Registration_Info_UClass_UAudioLinkBlueprintInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAudioLinkBlueprintInterface), 530494138U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Engine_Source_Runtime_AudioLink_AudioLinkEngine_Public_IAudioLinkBlueprintInterface_h_2270282868(TEXT("/Script/AudioLinkEngine"),
